...
(function ($) {
  ...
  LanguageCategoryDisplay.prototype = {
    ...
    render: function () {
      ...
      this.options.showRegions.forEach(
        function (regionCode) {
    ...
    renderRegion: function ($region, languages, itemsPerColumn, columnsPerRow) {
      ...
      if (this.options.columns === 1) {
        ...
        rows.push(
          $("<div>").addClass("row uls-language-block").append(columns)
        );
      } else {
