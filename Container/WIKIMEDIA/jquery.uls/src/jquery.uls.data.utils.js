...
(function ($) {
  ...
  $.uls.data.getRegions = function (language) {
    ...
    return (
      ($.uls.data.languages[language] && $.uls.data.languages[language][1]) ||
      "UNKNOWN"
    );
  };
  ...
  $.uls.data.getAutonym = function (language) {
    ...
    return (
      ($.uls.data.languages[language] && $.uls.data.languages[language][2]) ||
      language
    );
  };
