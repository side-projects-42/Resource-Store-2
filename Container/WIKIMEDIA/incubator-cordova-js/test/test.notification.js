describe("notification", function () {
  ...
  describe("when alerting", function () {
    ...
    it("passes the provided params to the exec method", function () {
      ...
      expect(exec).toHaveBeenCalledWith(cb, null, "Notification", "alert", [
        "hammertime",
        "STOP!",
        "GO",
      ]);
  ...
  describe("when confirming", function () {
    ...
    it("passes the provided params to the exec method", function () {
      ...
      expect(exec).toHaveBeenCalledWith(cb, null, "Notification", "confirm", [
        "and thats the way it is",
        "It's like that",
        "Yes,Yes",
      ]);
  ...
  it("causes the device to vibrate", function () {
    ...
    expect(exec).toHaveBeenCalledWith(null, null, "Notification", "vibrate", [
      1000,
    ]);
  });
  ...
  it("causes the device to beep", function () {
    ...
    //It's over 9000!
    expect(exec).toHaveBeenCalledWith(null, null, "Notification", "beep", [
      9001,
    ]);
  });
});
