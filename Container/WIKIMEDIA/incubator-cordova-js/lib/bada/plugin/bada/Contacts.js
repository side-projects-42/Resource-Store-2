...
function _wacToPg(contact) {
  ...
  if (contact.emails && contact.emails.length > 0) {
    ...
    for (i = 0, j = contact.emails.length; i < j; i += 1) {
      ...
      if (contact.emails[i].types && contact.emails[i].types.length > 0) {
  ...
  if (contact.addresses && contact.addresses.length > 0) {
    ...
    for (i = 0, j = contact.addresses.length; i < j; i += 1) {
      ...
      if (contact.addresses[i].types && contact.addresses[i].types.length > 0) {
