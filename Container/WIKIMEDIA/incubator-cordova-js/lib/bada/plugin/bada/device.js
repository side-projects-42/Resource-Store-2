...
Device.prototype.getDeviceInfo = function (success, fail, args) {
  ...
  info.getPropertyValue(
    ...
    fail,
    { aspect: "Device", property: "version" }
  );
  info.getPropertyValue(
    function (value) {
    ...
    fail,
    { aspect: "OperatingSystem", property: "name" }
  );
  info.getPropertyValue(
    function (value) {
    ...
    fail,
    { aspect: "OperatingSystem", property: "version" }
  );
  info.getPropertyValue(
    function (value) {
    ...
    fail,
    { aspect: "OperatingSystem", property: "vendor" }
  );
};
