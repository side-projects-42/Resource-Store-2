...
module.exports = {
        ...
        .then(
          function (storageFile) {
            var mediaEncodingProfile =
              new Windows.Media.MediaProperties.MediaEncodingProfile.createMp3(
              ...
              mediaCapture.stopRecordAsync().then(
                function (result) {
                  storageFile.getBasicPropertiesAsync().then(
                    ...
                    function () {
                      errorCallback(
                        new CaptureError(CaptureError.CAPTURE_NO_MEDIA_FILES)
                      );
                    }
                  );
                },
            ...
            mediaCapture
              .startRecordToStorageFileAsync(mediaEncodingProfile, storageFile)
              .then(
                function () {
  ...
  captureVideo: function (successCallback, errorCallback, options) {
    ...
    cameraCaptureUI
      .captureFileAsync(Windows.Media.Capture.CameraCaptureUIMode.video)
      .then(
        function (file) {
          file
            .moveAsync(
