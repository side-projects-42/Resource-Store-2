(function ($) {
  ...
  QUnit.test("Webfonts loading and application test", function (assert) {
    var webfonts,
      expectedFontFace,
      myanmarFontName,
      expectedFontFamilyValue,
    ...
    webfonts.reset();
    assert.strictEqual(
      $myanmarElement.css("font-family"),
      fallbackFonts,
    ...
    assert.strictEqual(
      $inputElement.css("font-family"),
      fallbackFonts,
      "The web font on the test <input> was reset"
    );
    assert.deepEqual(
      $textareaElement.css("font-family"),
      fallbackFonts,
      "The web font on the test <textarea> was reset"
    );
    assert.deepEqual(
      $buttonElement.css("font-family"),
      fallbackFonts,
  ...
  QUnit.test("Webfonts on mixed language html", function (assert) {
    var testHTML =
        '<div lang="hi" id="#parent" ><p>Hindi text</p>' +
      ...
      $qunitFixture = $("#qunit-fixture");
    $qunitFixture.append($(testHTML)).webfonts(webfontOptions);
    assert.strictEqual(
    ...
    testHTML =
      '<div lang="en" id="#parent" ><p>English text</p>' +
    ...
    assert.strictEqual(
      $qunitFixture.find("div[lang=en]").css("font-family").replace(/ /g, ""),
      "sans-serif",
      "English div font is fallbackFonts"
    );
    assert.strictEqual(
      $qunitFixture
        .find("textarea[lang=en]")
        .css("font-family")
        .replace(/ /g, ""),
      "monospace",
    ...
    testHTML =
      '<div style="font-family: serif;"><p>Hindi text</p>' +
      '<div lang="ml"></div>' +
      '<div lang="en"></div>' +
      '<div><textarea lang="en"></textarea></div>' +
      "</div>";
  ...
  QUnit.test("Webfonts apply/reset with inline css", function (assert) {
    ...
    assert.strictEqual(
      $qunitFixture.find("span[lang=gu]").css("font-family").replace(/ /g, ""),
      ("GujaratiFont, " + fallbackFonts).replace(/ /g, ""),
      "Gujarati span gets Gujarati font after applying webfonts"
    );

    assert.strictEqual(
      $qunitFixture.find("span[lang=gu]").hasClass("webfonts-changed"),
      true,
  ...
  QUnit.test("Overridable option test", function (assert) {
    var testHTML, fallbackFonts, webfontOptions, $qunitFixture;
    testHTML =
      '<div lang=my class="overridabletest">' +
