...
define(["jquery"], function ($) {
  ...
  function addUpload(username, monument, photo, completed) {
    ...
    var insertSQL =
      "INSERT INTO completed_uploads ( username, monument, photo, timestamp, completed ) VALUES ( ?, ?, ?, ?, ? );";
    var promise = execute(insertSQL, [
      username,
  ...
  function requestUploads(completed) {
    var querySQL =
      "SELECT * FROM completed_uploads WHERE completed = ? ORDER BY timestamp DESC";
