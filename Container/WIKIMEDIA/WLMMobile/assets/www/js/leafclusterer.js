 ...
 */
define(["../leaflet/leaflet-src"], function () {
  function LeafClusterer(map, opt_markers, opt_opts) {
    ...
    if (typeof opt_opts === "object" && opt_opts !== null) {
      ...
      if (
        typeof opt_opts.styles === "object" &&
        opt_opts.styles !== null &&
        opt_opts.styles.length !== 0
      ) {
    ...
    this.redraw_ = function (isForce) {
      ...
      if (zoom_ >= mz || this.getTotalMarkers() === 1) {
        ...
        if (clusterMarker_ === null) {
          clusterMarker_ = new ClusterMarker_(
            center_,
            this.getTotalMarkers(),
            leafClusterer_.getStyles_(),
            leafClusterer_.getGridSize_() / 2
          );
  ...
  ClusterMarker_ = L.Class.extend({
    ...
    reset: function (opts) {
      ...
      if (
        (typeof opts.count === "number" && opts.count != this.count_) ||
        styles_updated
      ) {
  ...
  window.LeafClusterer = LeafClusterer;
});
