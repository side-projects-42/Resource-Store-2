...
PhoneGapCommandResult = function (status, callbackId, args, cast) {
  ...
  if (
    safeStatus === PhoneGap.callbackStatus.NO_RESULT ||
    ...
    if (commandResult.status === PhoneGap.callbackStatus.OK) {
      try {
        if (PhoneGap.callbacks[callbackId].success) {
          result = PhoneGap.callbacks[callbackId].success(
            commandResult.message
          );
        }
      } catch (e) {
        console.log(
          "Error in success callback: " + callbackId + " = " + e.message
        );
      }
    }
...
if (!PhoneGap.hasResource("accelerometer")) {
  ...
  Accelerometer.prototype.getCurrentAcceleration = function (
    ...
    var onSuccess = function (result) {
      ...
      self.lastAcceleration = new Acceleration(
        accResult.x,
        accResult.y,
        accResult.z
      );
...
if (!PhoneGap.hasResource("contact")) {
  ...
  Contacts.prototype.find = function (fields, successCB, errorCB, options) {
    ...
    if (
      ...
      PhoneGap.exec(onSuccess, errorCB, "Contacts", "search", {
        fields: fields,
        options: options,
      });
    }
    ...
    */
      setItem: function (key, value) {
        ...
        window.external.Notify(
          "DOMStorage/" + this._type + "/set/" + key + "/" + value
        );
      },
...
if (!PhoneGap.hasResource("media")) {
  ...
  Media.prototype.play = function () {
    PhoneGap.exec(null, null, "Media", "startPlayingAudio", {
      id: this.id,
      src: this.src,
    });
  };
  ...
  Media.prototype.stop = function () {
    return PhoneGap.exec(null, null, "Media", "stopPlayingAudio", {
      id: this.id,
    });
  };
  ...
  Media.prototype.seekTo = function (milliseconds) {
    PhoneGap.exec(null, null, "Media", "seekToAudio", {
      id: this.id,
  ...
  Media.prototype.getCurrentPosition = function (success, fail) {
    PhoneGap.exec(success, fail, "Media", "getCurrentPositionAudio", {
      id: this.id,
    });
  };
  ...
  Media.prototype.startRecord = function () {
    PhoneGap.exec(null, null, "Media", "startRecordingAudio", {
      id: this.id,
      src: this.src,
    });
  };
