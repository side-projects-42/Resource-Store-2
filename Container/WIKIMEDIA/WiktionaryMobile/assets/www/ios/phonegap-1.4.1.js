...
if (typeof PhoneGap === "undefined") {
        ...
        while (PhoneGap._constructors.length > 0) {
          ...
          try {
            ...
            if (typeof console["log"] == "function") {
              console.log(
                "Failed to run constructor: " + console.processMessage(e)
              );
            } else {
  ...
  PhoneGap.exec = function () {
    if (!PhoneGap.available) {
      alert(
        "ERROR: Attempting to call PhoneGap.exec()" +
  ...
  PhoneGap.fireEvent = function (type, target, data) {
    ...
    if (target.dispatchEvent === undefined) {
      // ie window.dispatchEvent is undefined in iOS 3.x
      target = document;
    }
...
if (!PhoneGap.hasResource("debugconsole")) {
  ...
  DebugConsole.prototype.log = function (message, maxDepth) {
    ...
    else this.winConsole.log(message);
  };
  ...
  DebugConsole.prototype.warn = function (message, maxDepth) {
    ...
    else this.winConsole.error(message);
  };
  ...
  Accelerometer.installDeviceMotionHandler = function () {
    ...
    window.addEventListener = function () {
      if (arguments[0] === devicemotionEvent) {
        ...
        if (self.deviceMotionListenerCount == 1) {
          // start
          self.deviceMotionWatchId = navigator.accelerometer.watchAcceleration(
            accelWin,
            accelFail,
            { frequency: 500 }
          );
    ...
    window.removeEventListener = function () {
      if (arguments[0] === devicemotionEvent) {
        --self.deviceMotionListenerCount;
        if (self.deviceMotionListenerCount == 0) {
          // stop
...
if (!PhoneGap.hasResource("contact")) {
  ...
  Contact.prototype.display = function (errorCB, options) {
    if (this.id == null) {
      ...
      PhoneGap.exec(null, errorCB, "com.phonegap.contacts", "displayContact", [
        this.id,
        options,
      ]);
    }
...
if (!PhoneGap.hasResource("file")) {
  ...
  FileMgr.prototype.testFileExists = function (
    fileName,
    successCallback,
    errorCallback
  ) {
  ...
  FileMgr.prototype.testDirectoryExists = function (
    dirName,
    successCallback,
    errorCallback
  ) {
  ...
  FileMgr.prototype.getFreeDiskSpace = function (
    successCallback,
    errorCallback
  ) {
    PhoneGap.exec(
...
*/
  ...
  LocalFileSystem.prototype._castDate = function (pluginResult) {
    if (pluginResult.message.modificationTime) {
      ...
      metadataObj.modificationTime = new Date(
        pluginResult.message.modificationTime
      );
   ...
   * @param {Function} errorCallback is called with a FileError
   */
  DirectoryEntry.prototype.copyTo = function (
    parent,
    newName,
    successCallback,
    errorCallback
   ...
   * @param {Function} errorCallback is called with a FileError
   */
  DirectoryEntry.prototype.getParent = function (
    successCallback,
    errorCallback
  ) {
    PhoneGap.exec(
   ...
   * @param {Function} errorCallback is called with a FileError
   */
  DirectoryEntry.prototype.moveTo = function (
    parent,
    newName,
    successCallback,
    errorCallback
   ...
   * @param {Function} errorCallback is called with a FileError
   */
  FileEntry.prototype.copyTo = function (
    parent,
    newName,
    successCallback,
    errorCallback
   ...
   * @param {Function} errorCallback is called with a FileError
   */
  FileEntry.prototype.moveTo = function (
    parent,
    newName,
    successCallback,
    errorCallback
 ...
 */
  ...
  Geolocation.prototype.getCurrentPosition = function (
    ...
    var onTimeout = function () {
      self.setError(
        new PositionError(PositionError.TIMEOUT, "Geolocation Error: Timeout.")
      );
    };
  ...
  Geolocation.prototype.start = function (positionOptions) {
    PhoneGap.exec(null, null, "com.phonegap.geolocation", "startLocation", [
      positionOptions,
    ]);
...
if (!PhoneGap.hasResource("compass")) {
   ...
   */
  Compass.prototype.getCurrentHeading = function (
    successCallback,
    errorCallback,
    options
  ) {
   ...
   * such as timeout and the frequency of the watch.
   */
  Compass.prototype.watchHeading = function (
    successCallback,
    errorCallback,
    options
  ) {
   ...
   */
  Compass.prototype.watchHeadingFilter = function (
    successCallback,
    errorCallback,
    options
  ) {
...
if (!PhoneGap.hasResource("media")) {
  ...
  Media.prototype.play = function (options) {
    PhoneGap.exec(null, null, "com.phonegap.media", "play", [
      this.id,
      this.src,
      options,
    ]);
  ...
  Media.prototype.stop = function () {
    PhoneGap.exec(null, null, "com.phonegap.media", "stop", [
      this.id,
      this.src,
    ]);
  };
  ...
  Media.prototype.pause = function () {
    PhoneGap.exec(null, null, "com.phonegap.media", "pause", [
      this.id,
      this.src,
    ]);
  };
  ...
  Media.prototype.seekTo = function (milliseconds) {
    PhoneGap.exec(null, null, "com.phonegap.media", "seekTo", [
      this.id,
      this.src,
      milliseconds,
    ]);
  ...
  Media.prototype.prepare = function (successCB, errorCB) {
    PhoneGap.exec(successCB, errorCB, "com.phonegap.media", "prepare", [
      this.id,
      this.src,
    ]);
  };
  ...
  Media.prototype.startRecord = function () {
    PhoneGap.exec(null, null, "com.phonegap.media", "startAudioRecord", [
      this.id,
      this.src,
    ]);
  };
  ...
  Media.prototype.stopRecord = function () {
    PhoneGap.exec(null, null, "com.phonegap.media", "stopAudioRecord", [
      this.id,
      this.src,
    ]);
  };
  ...
  Media.prototype.release = function () {
    PhoneGap.exec(null, null, "com.phonegap.media", "release", [
      this.id,
      this.src,
    ]);
  };
...
if (!PhoneGap.hasResource("notification")) {
  ...
  Notification.prototype.alert = function (
    ...
    PhoneGap.exec(
      ...
      "alert",
      [message, { title: _title, buttonLabel: _buttonLabel }]
    );
  };
...
if (!PhoneGap.hasResource("orientation")) {
   ...
   */
  Orientation.prototype.watchOrientation = function (
    successCallback,
    errorCallback
  ) {
    // Invoke the appropriate callback with a new Position object every time the implementation
...
if (!PhoneGap.hasResource("splashscreen")) {
  ...
  PhoneGap.addConstructor(function () {
    if (typeof navigator.splashscreen == "undefined")
      navigator.splashscreen = new SplashScreen();
  });
}
