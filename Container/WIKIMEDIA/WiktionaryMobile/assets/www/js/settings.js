window.appSettings = (function () {
  ...
  function showSettings(callback) {
    ...
    if (fontSizes.length == 0) {
      fontSizes = [
        {
          value: "75%",
          name: mw.message("settings-font-size-smaller").plain(),
        },
        {
          value: "100%",
          name: mw.message("settings-font-size-normal").plain(),
        },
        {
          value: "125%",
          name: mw.message("settings-font-size-larger").plain(),
        },
      ];
    }
  ...
  function renderSettings() {
    ...
    $("#contentLanguageSelector")
      .val(currentContentLanguage)
      .change(onContentLanguageChanged);
    ...
    $("#fontSizeSelector")
      .val(preferencesDB.get("fontSize"))
