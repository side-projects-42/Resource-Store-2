if (
  ...
  Cache.prototype.getCachedPathForURI = function (uri, success, fail) {
    return PhoneGap.exec(success, fail, "URLCache", "getCachedPathForURI", [
      uri,
    ]);
  };
