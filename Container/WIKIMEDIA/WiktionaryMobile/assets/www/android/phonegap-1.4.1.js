        ...
        // If error, then display error
          ...
          if (fail) {
            try {
              ...
              console.log(
                "Error in error callback: " + callbackId + " = " + e1
              );
            }
...
if (!PhoneGap.hasResource("compass")) {
  ...
  Compass.prototype.watchHeading = function (
    ...
    PhoneGap.exec(
      function (timeout) {
        if (timeout < frequency + 10000) {
          PhoneGap.exec(null, null, "Compass", "setTimeout", [
            frequency + 10000,
          ]);
        }
      },
...
if (!PhoneGap.hasResource("contact")) {
  ...
  Contacts.prototype.find = function (fields, successCB, errorCB, options) {
    ...
    if (
      ...
      PhoneGap.exec(successCB, errorCB, "Contacts", "search", [
        fields,
        options,
      ]);
    }
...
if (!PhoneGap.hasResource("filetransfer")) {
  ...
  FileTransfer.prototype.download = function (
    ...
    PhoneGap.exec(successCallback, errorCallback, "FileTransfer", "download", [
      source,
      target,
    ]);
  };
...
if (!PhoneGap.hasResource("geolocation")) {
  ...
  Geolocation.prototype.watchPosition = function (
    ...
    PhoneGap.exec(null, null, "Geolocation", "start", [
      id,
      enableHighAccuracy,
      timeout,
      maximumAge,
  ...
  Geolocation.prototype.success = function (
    ...
    try {
      if (lat === "undefined" || lng === "undefined") {
        navigator._geo.listeners[id].fail(
          new PositionError(
...
if (!PhoneGap.hasResource("storage")) {
  ...
  var DroidDB_openDatabase = function (name, version, display_name, size) {
    PhoneGap.exec(null, null, "Storage", "openDatabase", [
      name,
      version,
      display_name,
      size,
    ...
    try {
      ...
      this.setItem = function (key, val) {
        ...
        this.db.transaction(function (transaction) {
          ...
          transaction.executeSql(
            "REPLACE INTO storage (id, body) values(?,?)",
            [key, val]
          );
        });
      };
