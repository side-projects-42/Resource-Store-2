(function ($) {
  ...
  function IME(element, textEntry, options) {
    ...
    if (this.options.showSelector) {
      this.options.selectorInside =
        options.selectorInside !== undefined
