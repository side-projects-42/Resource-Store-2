  ...
  define("cordova/exec", function (require, exports, module) {
    ...
    function androidExec(success, fail, service, action, args) {
      ...
      try {
        ...
        if (jsToNativeBridgeMode == jsToNativeModes.LOCATION_CHANGE) {
          ...
          result =
            "" + _cordovaExec.exec(service, action, callbackId, argsJson);
        } else {
          result = prompt(
            argsJson,
    ...
    androidExec.setJsToNativeBridgeMode = function (mode) {
      if (mode == jsToNativeModes.JS_OBJECT && !window._cordovaExec) {
        console.log(
          "Falling back on PROMPT mode since _cordovaExec is missing."
        );
        ...
        xmlhttp.onreadystatechange = function () {
          ...
          if (xmlhttp.readyState === 4) {
            ...
            // 503 == server stopped.
              ...
              console.log(
                "JSCallback Error: Request failed with status " + xmlhttp.status
              );
