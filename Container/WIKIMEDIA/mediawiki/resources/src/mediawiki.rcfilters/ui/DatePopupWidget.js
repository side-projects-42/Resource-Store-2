...
DatePopupWidget = function MwRcfiltersUiDatePopupWidget(model, config) {
	...
	this.hoursValuePicker = new ValuePickerWidget(this.model, {
	...
	this.hoursValuePicker.selectWidget.$element.attr(
		"aria-label",
		mw.msg("rcfilters-hours-title")
	);

	this.daysValuePicker = new ValuePickerWidget(this.model, {
	...
	this.daysValuePicker.selectWidget.$element.attr(
		"aria-label",
		mw.msg("rcfilters-days-title")
	);
	...
	this.$element
		...
		.append(
			this.$label.addClass("mw-rcfilters-ui-datePopupWidget-title"),
