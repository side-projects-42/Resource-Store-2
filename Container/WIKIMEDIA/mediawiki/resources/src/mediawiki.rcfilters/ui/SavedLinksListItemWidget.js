 ...
 */
var SavedLinksListItemWidget = function MwRcfiltersUiSavedLinksListWidget(
	model,
	config
) {
	config = config || {};
	...
	// Parent
	SavedLinksListItemWidget.parent.call(
		this,
		$.extend(
			{
	...
	this.$element
		...
		.addClass(
			"mw-rcfilters-ui-savedLinksListItemWidget-query-" +
				this.model.getID()
		)
		.append(
			$("<div>")
					...
					$("<div>")
						...
						.append(
							$("<div>")
								...
								.addClass(
									"mw-rcfilters-ui-savedLinksListItemWidget-content"
								)
								.append(
									this.$label.addClass(
							...
							$("<div>")
								.addClass("mw-rcfilters-ui-cell")
								.addClass(
									"mw-rcfilters-ui-savedLinksListItemWidget-icon"
								)
								.append(this.$icon),
							this.buttonMenu.$element.addClass(
...
SavedLinksListItemWidget.prototype.toggleEdit = function (isEdit) {
	...
	if (this.editing !== isEdit) {
		this.$element.toggleClass(
			"mw-rcfilters-ui-savedLinksListItemWidget-edit",
			isEdit
		);
		this.editInput.setValue(this.getLabel());
