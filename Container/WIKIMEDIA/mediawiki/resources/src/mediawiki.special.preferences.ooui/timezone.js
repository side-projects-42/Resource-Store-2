...
(function () {
	mw.hook("htmlform.enhance").add(function ($root) {
		...
		timezoneWidget =
			mw.widgets.SelectWithInputWidget.static.infuse($target);
		...
		function updateTimezoneSelection() {
			...
			if (type === "other") {
				...
				if (type === "guess") {
					...
					if (
						!timeZone ||
						timezoneWidget.dropdowninput.getValue() !== newValue
					) {
			...
			$localtimeHolder.text(
				mw.language.convertNumber(minutesToHours(localTime))
			);
		}
