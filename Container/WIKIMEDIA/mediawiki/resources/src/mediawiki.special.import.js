...
$(function () {
	...
	function updateImportSubprojectList() {
		...
		subprojectDropdownInput.dropdownWidget
			.getMenu()
			.getItems()
		...
		firstItem =
			subprojectDropdownInput.dropdownWidget.menu.findFirstSelectableItem();
	...
	sources.forEach(function (name) {
		...
		$radios
			...
			.after(namespace.$element.closest(".oo-ui-fieldLayout"));
