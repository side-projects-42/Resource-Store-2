	...
	var pluralTestcases = {
		...
		he: [
			...
			[
				...
				["one", "other"],
				"other",
				"Hebrew plural test- 2 is other with 2 forms",
			],
			[
				2,
				["one", "dual", "other"],
				"dual",
				"Hebrew plural test- 2 is dual with 3 forms",
			],
		],
		hu: [
		...
		ar: [
			[
				...
				"zero",
				"Arabic plural test - 0 is zero",
			],
			[
				1,
				["zero", "one", "two", "few", "many", "other"],
				"one",
				"Arabic plural test - 1 is one",
			],
			[
				2,
				["zero", "one", "two", "few", "many", "other"],
				"two",
				"Arabic plural test - 2 is two",
			],
			[
				3,
				["zero", "one", "two", "few", "many", "other"],
				"few",
				"Arabic plural test - 3 is few",
			],
			[
				9,
				["zero", "one", "two", "few", "many", "other"],
				"few",
				"Arabic plural test - 9 is few",
			],
			[
				"9",
				["zero", "one", "two", "few", "many", "other"],
			...
			[
				...
				["zero", "one", "two", "few", "many", "other"],
				"few",
				"Arabic plural test - 110 is few",
			],
			[
				11,
				["zero", "one", "two", "few", "many", "other"],
				"many",
				"Arabic plural test - 11 is many",
			],
			[
				15,
				["zero", "one", "two", "few", "many", "other"],
				"many",
				"Arabic plural test - 15 is many",
			],
			[
				99,
				["zero", "one", "two", "few", "many", "other"],
				"many",
				"Arabic plural test - 99 is many",
			],
			[
				9999,
				["zero", "one", "two", "few", "many", "other"],
				"many",
				"Arabic plural test - 9999 is many",
			],
			[
				100,
				["zero", "one", "two", "few", "many", "other"],
				"other",
				"Arabic plural test - 100 is other",
			],
			[
				102,
				["zero", "one", "two", "few", "many", "other"],
				"other",
				"Arabic plural test - 102 is other",
			],
			[
				1000,
				["zero", "one", "two", "few", "many", "other"],
				"other",
				"Arabic plural test - 1000 is other",
			],
			[
				1.7,
				["zero", "one", "two", "few", "many", "other"],
				"other",
				"Arabic plural test - 1.7 is other",
			],
		],
	};
