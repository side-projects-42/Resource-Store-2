(function () {
	...
	function addChars($input, charstr) {
		...
		for (c = 0, len = charstr.length; c < len; c += 1) {
			$input.val(x($input, c)).trigger("change");
		}
	}
	...
	byteLimitTest({
		...
		$input: $("<input>").attr("type", "text").byteLimit(),
		sample: simpleSample,
		expected: simpleSample,
	});
	...
	byteLimitTest({
		...
		$input: $("<input>").attr("type", "text").byteLimit(10),
		sample: simpleSample,
		expected: "1234567890",
	});
	...
	byteLimitTest({
		...
		$input: $("<input>").attr("type", "text").byteLimit(14),
		sample: mbSample,
	...
	byteLimitTest({
		...
		$input: $("<input>").attr("type", "text").byteLimit(3),
		sample: poop,
		expected: "",
	});
	...
	byteLimitTest({
		...
		$input: $("<input>").attr("type", "text").byteLimit(12),
		sample: mbSample,
