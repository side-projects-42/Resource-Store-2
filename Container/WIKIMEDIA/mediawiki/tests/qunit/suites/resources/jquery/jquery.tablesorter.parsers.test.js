(function () {
	...
	ipv4 = [
		...
		[
			"45.238.27.109Postfix",
			false,
			45238027109,
			"An IP address with a connected postfix",
		],
		[
			"45.238.27.109 postfix",
			false,
			45238027109,
			"An IP address with a separated postfix",
		],
	];
	...
	simpleMDYDatesInMDY = [
		...
		[
			...
			true,
			20100117,
			"Numeric middle endian date with padding on month",
		],
		[
			"01/07/2010",
			true,
			20100107,
			"Numeric middle endian date with padding on day",
		],
		[
			"01/07/0010",
			true,
			20100107,
			"Numeric middle endian date with padding on year",
		],
		[
			"5.12.1990",
			true,
			19900512,
			"Numeric middle endian date with . separator",
		],
	];
	parserTest(
	...
	ISODates = [
		...
		[
			"2000-01-01T12:60:30Z",
			true,
			946728000000,
			"Date with invalid minutes",
		],
		[
			"2000-01-01T12:30:61Z",
			true,
			946729800000,
			"Date with invalid amount of seconds, drops seconds",
		],
		["2000-01-01T23:59:59Z", true, 946771199000, "Edges of time"],
		[
			"2000-01-01T12:30:30.111Z",
			true,
			946729830111,
			"Date with milliseconds",
		],
		[
			"2000-01-01T12:30:30.11111Z",
			true,
			946729830111,
			"Date with too high precision",
		],
		[
			"2000-01-01T12:30:30,111Z",
			true,
			946729830111,
			"Date with milliseconds and , separator",
		],
		["2000-01-01T12:30:30+01:00", true, 946726230000, "Date time in UTC+1"],
		[
			"2000-01-01T12:30:30+01:30",
			true,
			946724430000,
			"Date time in UTC+1:30",
		],
		...
		[
			"2000-01-01T12:30:30.111+01:00",
			true,
			946726230111,
			"Date time and milliseconds in UTC+1",
		],
		...
		[
			...
			true,
			946684800000,
			"Date with separate postfix",
		],
		[
			"2 Postfix",
			false,
			-62104060800000,
			"One digit with separate postfix",
		],
		...
		[
			...
			false,
			-55855785600000,
			"Three digit with separate prefix and postfix",
		],
		...
		[
			...
			true,
			-62104060800000,
			"Year with one digit and leading zero",
		],
		[
			" 2-01",
			true,
			-62104060800000,
			"Year with one digit and leading space",
		],
		...
		[
			"2000-01-01 12:30:30Z",
			true,
			946729830000,
			"Date and time with no T marker",
		],
		["2000-01-01T12:30:60Z", true, 946729860000, "Date with leap second"],
		[
			"2000-01-01T12:30:30-23:59",
			true,
			946816170000,
			"Date time in UTC-23:59",
		],
		[
			"2000-01-01T12:30:30+23:59",
			true,
