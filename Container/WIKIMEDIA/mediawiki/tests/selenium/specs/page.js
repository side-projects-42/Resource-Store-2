...
describe("Page", function () {
	...
	it("should be previewable", function () {
		...
		assert(
			!EditPage.conflictingContent.isDisplayed(),
			"no edit conflict happened"
		);
	...
	it("should be restorable", function () {
		...
		// check
		assert.strictEqual(
			RestorePage.displayedContent.getText(),
			name +
