    ...
    module.exports = {
      ...
      less: function (str) {
        ...
        require("less").render(str, function (err, css) {
          if (err) throw err;
          ret =
            '<style type="text/css">' + css.replace(/\n/g, "\\n") + "</style>";
        });
        return ret;
      },
          ...
          try {
            ...
            try {
              ...
              try {
                ...
                throw new Error(
                  "Cannot find markdown library, install markdown, discount, or marked."
                );
              }
            }
          }
              ...
              case "\n":
                switch (state()) {
                  ...
                  default:
                    ...
                    key = key.trim();
                    if ("" == key) return;
                    tok.attrs[key.replace(/^['"]|['"]$/g, "")] =
                      "" == val ? true : interpolate(val);
                    key = val = "";
                }
                break;
              case "=":
  ...
  require.register("parser.js", function (module, exports, require) {
    ...
    Parser.prototype = {
      ...
      parseExtends: function () {
        ...
        if (!this.filename)
          throw new Error(
            'the "filename" option is required to extend templates'
          );
