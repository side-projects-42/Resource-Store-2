  ...
  (p.defaults = {}),
    m(p.prototype, {
      spin: function (a) {
        ...
        var b = this,
          c = b.opts,
          d = (b.el = l(g(0, { className: c.className }), {
            position: "relative",
            zIndex: c.zIndex,
          })),
          ...
          i;
        a &&
          (a.insertBefore(d, a.firstChild || null),
          (i = n(a)),
          (h = n(d)),
          l(d, {
            left:
              (c.left == "auto"
                ? i.x - h.x + (a.offsetWidth >> 1)
                : c.left + e) + "px",
            top:
              (c.top == "auto"
                ? i.y - h.y + (a.offsetHeight >> 1)
                : c.top + e) + "px",
          })),
      ...
      lines: function (a, b) {
        ...
        for (; c < b.lines; c++)
          (d = l(g(), {
            ...
            animation:
              f &&
              j(b.opacity, b.trail, c, b.lines) +
                " " +
                1 / b.speed +
                "s linear infinite",
          })),
            b.shadow && h(d, l(e("#000", "0 0 4px #000"), { top: "2px" })),
          ...
          (p.prototype.lines = function (b, c) {
            ...
            function k(b, e, g) {
              h(
                i,
                h(
                  l(f(), { rotation: (360 / c.lines) * b + "deg", left: ~~e }),
                  h(
                    l(a("roundrect", { arcsize: 1 }), {
                      width: d,
                      height: c.width,
                      left: c.radius,
                      top: -c.width >> 1,
                    ...
                    a("fill", { color: c.color, opacity: c.opacity }),
                    a("stroke", { opacity: 0 })
                  )
                )
              );
            ...
            var d = c.length + c.width,
              ...
              i = l(f(), { position: "absolute", top: g, left: g }),
              j;
            if (c.shadow)
              for (j = 1; j <= c.lines; j++)
                k(
    ...
    return (
      this.each(function () {
        ...
        c.spinner && (c.spinner.stop(), delete c.spinner),
          a !== !1 &&
            (c.spinner = new Spinner(
              $.extend({ color: b.css("color") }, a)
            ).spin(this));
      }),
      this
    );
