  ...
  function (require, module, exports, __dirname, __filename) {
    ...
    ************************************/
      ...
      var moment,
        ...
        proxyGettersAndSetters =
          "Month|Date|Hours|Minutes|Seconds|Milliseconds".split("|"),
    ...
    ************************************/
      ...
      function loadLang(key, values) {
        ...
        for (i = 0; i < 12; i++) {
          ...
          parse[i] = new RegExp(
            "^" +
              (values.months[i] || values.months(m, "")) +
              "|^" +
              (values.monthsShort[i] || values.monthsShort(m, "")).replace(
                ".",
                ""
              ),
            "i"
    ...
    ************************************/
      ...
      function makeDateFromStringAndFormat(string, format) {
        ...
        for (i = 0; i < tokens.length; i++) {
          parsedInput = (getParseRegexForToken(tokens[i]).exec(string) ||
            [])[0];
          if (parsedInput) {
            string = string.slice(
      ...
      function makeDateFromStringAndArray(string, formats) {
        ...
        for (i = 0; i < formats.length; i++) {
          ...
          formattedInputParts =
            formatMoment(new Moment(currentDate), formats[i]).match(
              parseMultipleFormatChunker
            ) || [];
    ...
    ************************************/
      ...
      moment.humanizeDuration = function (num, type, withSuffix) {
        return moment
          .duration(num, type === true ? null : type)
          .humanize(type === true ? true : withSuffix);
      };
      ...
      moment.lang = function (key, values) {
        ...
        if (languages[key]) {
          ...
          for (i = 0; i < langConfigProperties.length; i++) {
            moment[langConfigProperties[i]] =
              languages[key][langConfigProperties[i]];
          }
    ...
    ************************************/
      ...
      moment.fn = Moment.prototype = {
        ...
        isValid: function () {
          if (this._a) {
            ...
            return !compareArrays(
              this._a,
              (this._a[7] ? moment.utc(this._a) : moment(this._a)).toArray()
            );
          }
        ...
        format: function (inputString) {
          return formatMoment(
            this,
            inputString ? inputString : moment.defaultFormat
          );
        },
          ...
          var diff = this.diff(moment().sod(), "days", true),
            ...
            format =
              diff < -6
                ...
                : allElse;
          return this.format(
            typeof format === "function" ? format.apply(this) : format
          );
        },
        ...
        isDST: function () {
          return (
            this.zone() < moment([this.year()]).zone() ||
        ...
        endOf: function (val) {
          return this.startOf(val)
            .add(val.replace(/s?$/, "s"), 1)
            .subtract("ms", 1);
        },
      ...
      for (i = 0; i < proxyGettersAndSetters.length; i++) {
        makeGetterAndSetter(
          proxyGettersAndSetters[i].toLowerCase(),
