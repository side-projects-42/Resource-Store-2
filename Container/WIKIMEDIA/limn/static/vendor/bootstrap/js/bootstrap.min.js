    ...
    (c.prototype = {
      ...
      toggle: function (b) {
        ...
        return (
          ...
          f ||
            ((f = c.attr("href")), (f = f && f.replace(/.*(?=#[^\s]*$)/, ""))),
          (e = a(f)),
          e.length || (e = c.parent()),
          (g = e.hasClass("open")),
          d(),
          g || e.toggleClass("open"),
          !1
        );
      },
    }),
        ...
        !this.isShown && this.$backdrop
          ? (this.$backdrop.removeClass("in"),
            a.support.transition && this.$element.hasClass("fade")
              ? this.$backdrop.one(a.support.transition.end, a.proxy(f, this))
              : f.call(this))
          : b && b();
    }
    function f() {
    ...
    (b.prototype = a.extend({}, a.fn.tooltip.Constructor.prototype, {
      ...
      setContent: function () {
        ...
        a.find(".popover-title")[this.isHTML(b) ? "html" : "text"](b),
          a.find(".popover-content > *")[this.isHTML(c) ? "html" : "text"](c),
    ...
    (b.prototype = {
        ...
        return (
          ...
          this.query
            ? ((d = a.grep(this.source, function (a) {
              ...
              (d = this.sorter(d)),
              d.length
                ? this.render(d.slice(0, this.options.items)).show()
                : this.shown
                ? this.hide()
                : this)
            : this.shown
      ...
      listen: function () {
        this.$element
          ...
          (a.browser.webkit || a.browser.msie) &&
