 ...
 */ window.Modernizr = (function (a, b, c) {
  ...
  (r.flexbox = function () {
    ...
    (r.smil = function () {
      return (
        !!b.createElementNS &&
        /SVG/.test(n.call(b.createElementNS(q.svg, "animate")))
      );
    }),
    (r.svgclippaths = function () {
      return (
        !!b.createElementNS &&
        /SVG/.test(n.call(b.createElementNS(q.svg, "clipPath")))
      );
    });
  for (var J in r)
    A(r, J) &&
      ((v = J.toLowerCase()), (e[v] = r[J]()), u.push((e[v] ? "" : "no-") + v));
  e.input || I(),
    ...
    (g.className =
      g.className.replace(/\bno-js\b/, "") + (f ? " js " + u.join(" ") : ""));
  return e;
})(this, this.document);
