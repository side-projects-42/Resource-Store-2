---
path: '/projects/newrelic/nr1-nerdpack-layout-4-column'
date: '05/01/2020'
title: 'New Relic One Nerdpack Layout 4 Column'
projectConfig: 'src/data/projects/newrelic-nr1-nerdpack-layout-4-column.json'
---
...
<div className="responsive-video">
  ...
  >
    ...
    >
      <iframe
        src="https://fast.wistia.net/embed/iframe/vg6jkqxhrl?videoFoam=true"
        title="Nerdpack Layouts Templates Walkthrough Video"
...
Go to the project's [README](https://github.com/newrelic/nr1-nerdpack-layout-4-column#readme) for setup and usage details.
...
This is how you extend New Relic One Nerdpack Layout 4 Column in following way.
