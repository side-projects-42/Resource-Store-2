---
path: '/projects/newrelic/nr1-vividcortex'
date: '05/01/2020'
title: 'New Relic One VividCortex'
projectConfig: 'src/data/projects/newrelic-nr1-vividcortex.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/nr1-vividcortex#readme) for setup and usage details.
...
This is how you extend New Relic One VividCortex in following way.
