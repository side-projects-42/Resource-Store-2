---
path: '/projects/newrelic/newrelic-module-util-java'
date: '08/04/2020'
title: 'New Relic Module Util Java'
projectConfig: 'src/data/projects/newrelic-module-util-java.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/newrelic-module-util-java#readme) for setup and usage details.
