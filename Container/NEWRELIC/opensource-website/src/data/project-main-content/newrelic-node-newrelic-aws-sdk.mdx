---
path: '/projects/newrelic/node-newrelic-aws-sdk'
date: '05/01/2020'
title: 'New Relic AWS SDK (Node)'
projectConfig: 'src/data/projects/newrelic-node-newrelic-aws-sdk.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/node-newrelic-aws-sdk#readme) for setup and usage details.
...
This is how you extend New Relic AWS SDK (Node) in following way.
