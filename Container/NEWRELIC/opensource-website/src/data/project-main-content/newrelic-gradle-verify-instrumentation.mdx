---
path: '/projects/newrelic/newrelic-gradle-verify-instrumentation'
date: '08/04/2020'
title: 'New Relic Gradle Verify Instrumentation'
projectConfig: 'src/data/projects/newrelic-gradle-verify-instrumentation.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/newrelic-gradle-verify-instrumentation#readme) for setup and usage details.
...
This is how you extend AWS Lambda OpenTracing Java SDK in following way.
```js
