---
path: '/projects/newrelic/nri-mongodb'
date: '05/01/2020'
title: 'New Relic Infrastructure MongoDB Integration'
projectConfig: 'src/data/projects/newrelic-nri-mongodb.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/nri-mongodb#readme) for setup and usage details.
...
This is how you extend New Relic Infrastructure MongoDB Integration in following way.
