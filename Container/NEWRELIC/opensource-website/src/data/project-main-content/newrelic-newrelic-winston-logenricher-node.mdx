...
Go to the project's [README](https://github.com/newrelic/newrelic-winston-logenricher-node#readme) for setup and usage details.
...
This is how you extend New Relic Winston Log Enricher in following way.
