---
path: '/projects/newrelic-experimental/NewRelicReactNativeModule'
date: '09/24/2020'
title: 'New Relic React Native Module'
projectConfig: 'src/data/projects/newrelic-experimental-NewRelicReactNativeModule.json'
---

## Getting Started

Go to the project's [README](https://github.com/newrelic-experimental/NewRelicReactNativeModule#readme) for setup and usage details.
...
This is how you extend New Relic React Native Module in following way.
