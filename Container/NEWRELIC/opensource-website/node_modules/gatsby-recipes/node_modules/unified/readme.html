...
<body>
<h1 id="unifiedlogosite"><a href="https://unifiedjs.com"><img src="https://raw.githubusercontent.com/unifiedjs/unified/39917ea/logo.svg?sanitize=true" alt="unified" /></a></h1>
<p><a href="https://github.com/unifiedjs/unified/actions"><img src="https://github.com/unifiedjs/unified/workflows/CI/badge.svg" alt="GitHub CI" /></a> <a href="https://travis-ci.org/unifiedjs/unified"><img src="https://img.shields.io/travis/unifiedjs/unified.svg" alt="Build" /></a> <a href="https://codecov.io/github/unifiedjs/unified"><img src="https://img.shields.io/codecov/c/github/unifiedjs/unified.svg" alt="Coverage" /></a> <a href="https://www.npmjs.com/package/unified"><img src="https://img.shields.io/npm/dm/unified.svg" alt="Downloads" /></a> <a href="https://bundlephobia.com/result?p=unified"><img src="https://img.shields.io/bundlephobia/minzip/unified.svg" alt="Size" /></a> <a href="https://opencollective.com/unified"><img src="https://opencollective.com/unified/sponsors/badge.svg" alt="Sponsors" /></a> <a href="https://opencollective.com/unified"><img src="https://opencollective.com/unified/backers/badge.svg" alt="Backers" /></a> <a href="https://spectrum.chat/unified"><img src="https://img.shields.io/badge/chat-spectrum-7b16ff.svg" alt="Chat" /></a></p>
<p><strong>unified</strong> is an interface for processing text using syntax trees. It’s what powers <a href="https://github.com/remarkjs/remark"><strong>remark</strong></a>, <a href="https://github.com/retextjs/retext"><strong>retext</strong></a>, and <a href="https://github.com/rehypejs/rehype"><strong>rehype</strong></a>, and allows for processing between formats.</p>
<h2 id="intro">Intro</h2>
<p><strong>unified</strong> enables new exciting projects like <a href="https://www.gatsbyjs.org">Gatsby</a> to pull in Markdown, <a href="https://mdxjs.com">MDX</a> to embed <a href="https://reactjs.org/docs/jsx-in-depth.html">JSX</a>, and <a href="https://prettier.io">Prettier</a> to format it. It’s used in about 300k projects on GitHub and has about 10m downloads each month on npm: you’re probably using it. Some notable users are <a href="https://nodejs.org">Node.js</a>, <a href="https://zeit.co">ZEIT</a>, <a href="https://www.netlify.com">Netlify</a>, <a href="https://github.com">GitHub</a>, <a href="https://www.mozilla.org">Mozilla</a>, <a href="https://wordpress.com">WordPress</a>, <a href="https://www.adobe.com">Adobe</a>, <a href="https://www.facebook.com">Facebook</a>, <a href="https://www.google.com">Google</a>, and many more.</p>
<ul>
<li>To read about what we are up to, follow us on <a href="https://medium.com/unifiedjs">Medium</a> and <a href="https://twitter.com/unifiedjs">Twitter</a></li>
<li>For a less technical and more practical introduction to unified, visit <a href="https://unifiedjs.com"><code>unifiedjs.com</code></a> and try its introductory <a href="https://unifiedjs.com/#guides">Guides</a></li>
<li>Browse <a href="https://github.com/unifiedjs/awesome-unified">awesome unified</a> to find out more about the ecosystem</li>
<li>Questions? Get help on <a href="https://spectrum.chat/unified">our Spectrum community</a>!</li>
<li>Check out <a href="#contribute">Contribute</a> below to find out how to help out, or become a backer or sponsor on <a href="https://opencollective.com/unified">Open Collective</a></li>
</ul>
...
<td width="20%" align="center">
<a href="https://www.netlify.com"><img src="https://avatars1.githubusercontent.com/u/7892489?s=400&v=4"></a> <br><br>🥇 <a href="https://www.netlify.com">Netlify</a>
</td>
<td width="20%" align="center">
...
<p><a href="https://medium.com/unifiedjs/collectively-evolving-through-crowdsourcing-22c359ea95cc"><strong>Read more about the unified collective on Medium »</strong></a></p>
...
<p>This package comes with types. If you’re using TypeScript, make sure to also install <a href="https://www.npmjs.com/package/@types/unist"><code>@types/unist</code></a> and <a href="https://www.npmjs.com/package/@types/vfile"><code>@types/vfile</code></a>.</p>
<h2 id="use">Use</h2>
...
<p>The following projects process different <a href="#syntax-trees"><em>syntax tree</em></a> formats. They parse text to a syntax tree and compile that back to text. These processors can be used as is, or their parser and stringifier can be mixed and matched with <strong>unified</strong> and plugins to process between different syntaxes.</p>
<ul>
...
<p>See <a href="https://github.com/remarkjs/remark/blob/master/doc/plugins.md#list-of-plugins"><strong>remark</strong></a>, <a href="https://github.com/rehypejs/rehype/blob/master/doc/plugins.md#list-of-plugins"><strong>rehype</strong></a>, and <a href="https://github.com/retextjs/retext/blob/master/doc/plugins.md#list-of-plugins"><strong>retext</strong></a> for their lists of plugins.</p>
<h6 id="file">File</h6>
...
<a class="sourceLine" id="cb6-14" title="14">  .<span class="at">use</span>(</a>
<a class="sourceLine" id="cb6-15" title="15">    remark2retext<span class="op">,</span></a>
<a class="sourceLine" id="cb6-16" title="16">    <span class="at">unified</span>()</a>
<a class="sourceLine" id="cb6-17" title="17">      .<span class="at">use</span>(english)</a>
<a class="sourceLine" id="cb6-18" title="18">      .<span class="at">use</span>(equality)</a>
<a class="sourceLine" id="cb6-19" title="19">  )</a>
<a class="sourceLine" id="cb6-20" title="20">  .<span class="at">use</span>(remark2rehype)</a>
<a class="sourceLine" id="cb6-21" title="21">  .<span class="at">use</span>(html)</a>
<a class="sourceLine" id="cb6-22" title="22">  .<span class="at">process</span>(<span class="st">&#39;*Emphasis* and _stress_, you guys!&#39;</span><span class="op">,</span> <span class="kw">function</span>(err<span class="op">,</span> file) <span class="op">{</span></a>
<a class="sourceLine" id="cb6-23" title="23">    <span class="va">console</span>.<span class="at">error</span>(<span class="at">report</span>(err <span class="op">||</span> file))</a>
<a class="sourceLine" id="cb6-24" title="24">    <span class="va">console</span>.<span class="at">log</span>(<span class="at">String</span>(file))</a>
...
<a class="sourceLine" id="cb9-7" title="7">  <span class="kw">var</span> doc <span class="op">=</span> <span class="at">remark</span>()</a>
<a class="sourceLine" id="cb9-8" title="8">    .<span class="at">processSync</span>(buf)</a>
<a class="sourceLine" id="cb9-9" title="9">    .<span class="at">toString</span>()</a>
<a class="sourceLine" id="cb9-10" title="10"></a>
<a class="sourceLine" id="cb9-11" title="11">  <span class="va">process</span>.<span class="va">stdout</span>.<span class="at">write</span>(doc)</a>
...
<a class="sourceLine" id="cb10-5" title="5">  .<span class="at">use</span>(plugin<span class="op">,</span> <span class="op">{}</span>)</a>
<a class="sourceLine" id="cb10-6" title="6">  <span class="co">// Plugins:</span></a>
<a class="sourceLine" id="cb10-7" title="7">  .<span class="at">use</span>([plugin<span class="op">,</span> pluginB])</a>
<a class="sourceLine" id="cb10-8" title="8">  <span class="co">// Two plugins, the second with options:</span></a>
<a class="sourceLine" id="cb10-9" title="9">  .<span class="at">use</span>([plugin<span class="op">,</span> [pluginB<span class="op">,</span> <span class="op">{}</span>]])</a>
<a class="sourceLine" id="cb10-10" title="10">  <span class="co">// Preset with plugins and settings:</span></a>
<a class="sourceLine" id="cb10-11" title="11">  .<span class="at">use</span>(<span class="op">{</span><span class="dt">plugins</span><span class="op">:</span> [plugin<span class="op">,</span> [pluginB<span class="op">,</span> <span class="op">{}</span>]]<span class="op">,</span> <span class="dt">settings</span><span class="op">:</span> <span class="op">{</span><span class="dt">position</span><span class="op">:</span> <span class="kw">false</span><span class="op">}}</span>)</a>
<a class="sourceLine" id="cb10-12" title="12">  <span class="co">// Settings only:</span></a>
<a class="sourceLine" id="cb10-13" title="13">  .<span class="at">use</span>(<span class="op">{</span><span class="dt">settings</span><span class="op">:</span> <span class="op">{</span><span class="dt">position</span><span class="op">:</span> <span class="kw">false</span><span class="op">}}</span>)</a>
<a class="sourceLine" id="cb10-14" title="14"></a>
<a class="sourceLine" id="cb10-15" title="15"><span class="kw">function</span> <span class="at">plugin</span>() <span class="op">{}</span></a>
<a class="sourceLine" id="cb10-16" title="16"><span class="kw">function</span> <span class="at">pluginB</span>() <span class="op">{}</span></a></code></pre></div>
...
<a class="sourceLine" id="cb11-4" title="4"><span class="kw">var</span> tree <span class="op">=</span> <span class="at">unified</span>()</a>
<a class="sourceLine" id="cb11-5" title="5">  .<span class="at">use</span>(markdown)</a>
<a class="sourceLine" id="cb11-6" title="6">  .<span class="at">parse</span>(<span class="st">&#39;# Hello world!&#39;</span>)</a>
<a class="sourceLine" id="cb11-7" title="7"></a>
<a class="sourceLine" id="cb11-8" title="8"><span class="va">console</span>.<span class="at">log</span>(tree)</a></code></pre></div>
<p>Yields:</p>
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="op">{</span> <span class="dt">type</span><span class="op">:</span> <span class="st">&#39;root&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb12-2" title="2">  <span class="dt">children</span><span class="op">:</span></a>
<a class="sourceLine" id="cb12-3" title="3">   [ <span class="op">{</span> <span class="dt">type</span><span class="op">:</span> <span class="st">&#39;heading&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb12-4" title="4">       <span class="dt">depth</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span></a>
<a class="sourceLine" id="cb12-5" title="5">       <span class="dt">children</span><span class="op">:</span> [Array]<span class="op">,</span></a>
<a class="sourceLine" id="cb12-6" title="6">       <span class="dt">position</span><span class="op">:</span> [Position] <span class="op">}</span> ]<span class="op">,</span></a>
<a class="sourceLine" id="cb12-7" title="7">  <span class="dt">position</span><span class="op">:</span></a>
<a class="sourceLine" id="cb12-8" title="8">   <span class="op">{</span> <span class="dt">start</span><span class="op">:</span> <span class="op">{</span> <span class="dt">line</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="dt">column</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="dt">offset</span><span class="op">:</span> <span class="dv">0</span> <span class="op">},</span></a>
<a class="sourceLine" id="cb12-9" title="9">     <span class="dt">end</span><span class="op">:</span> <span class="op">{</span> <span class="dt">line</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="dt">column</span><span class="op">:</span> <span class="dv">15</span><span class="op">,</span> <span class="dt">offset</span><span class="op">:</span> <span class="dv">14</span> <span class="op">}</span> <span class="op">}</span> <span class="op">}</span></a></code></pre></div>
...
<p>Stringify a <a href="#syntax-trees"><em>syntax tree</em></a> to text.</p>
<h6 id="parameters-2">Parameters</h6>
<ul>
<li><code>node</code> (<a href="https://github.com/syntax-tree/unist#node"><code>Node</code></a>) — <a href="#syntax-trees"><em>Syntax tree</em></a> to stringify</li>
...
<p><code>string</code> (see notes) — Textual representation of the <a href="#syntax-trees"><em>syntax tree</em></a></p>
...
<p>Be aware that <a href="#processorcompiler"><em>compiler</em></a>s typically, but not always, return <code>string</code>. Some compilers, such as the one configured with <a href="https://github.com/rhysd/rehype-react"><code>rehype-react</code></a>, return other values (in this case, a React tree). When using TypeScript, cast the type on your side.</p>
<h6 id="example-3">Example</h6>
<p>The below example shows how <code>stringify</code> can be used to stringify a syntax tree.</p>
...
<a class="sourceLine" id="cb13-7" title="7"><span class="kw">var</span> doc <span class="op">=</span> <span class="at">unified</span>()</a>
<a class="sourceLine" id="cb13-8" title="8">  .<span class="at">use</span>(html)</a>
<a class="sourceLine" id="cb13-9" title="9">  .<span class="at">stringify</span>(tree)</a>
<a class="sourceLine" id="cb13-10" title="10"></a>
<a class="sourceLine" id="cb13-11" title="11"><span class="va">console</span>.<span class="at">log</span>(doc)</a></code></pre></div>
<p>Yields:</p>
...
<p>Yields:</p>
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb16-1" title="1"><span class="op">{</span> <span class="dt">type</span><span class="op">:</span> <span class="st">&#39;root&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-2" title="2">  <span class="dt">children</span><span class="op">:</span></a>
<a class="sourceLine" id="cb16-3" title="3">   [ <span class="op">{</span> <span class="dt">type</span><span class="op">:</span> <span class="st">&#39;paragraph&#39;</span><span class="op">,</span> <span class="dt">children</span><span class="op">:</span> [Array] <span class="op">},</span></a>
<a class="sourceLine" id="cb16-4" title="4">     <span class="op">{</span> <span class="dt">type</span><span class="op">:</span> <span class="st">&#39;definition&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-5" title="5">       <span class="dt">identifier</span><span class="op">:</span> <span class="st">&#39;1&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-6" title="6">       <span class="dt">title</span><span class="op">:</span> <span class="kw">undefined</span><span class="op">,</span></a>
<a class="sourceLine" id="cb16-7" title="7">       <span class="dt">url</span><span class="op">:</span> <span class="kw">undefined</span> <span class="op">}</span> ] <span class="op">}</span></a></code></pre></div>
...
<p>The parsed, transformed, and stringified value is exposed on <a href="https://github.com/vfile/vfile#vfilecontents"><code>file.contents</code></a>.</p>
...
<p>Be aware that <a href="#processorcompiler"><em>compiler</em></a>s typically, but not always, return <code>string</code>. Some compilers, such as the one configured with <a href="https://github.com/rhysd/rehype-react"><code>rehype-react</code></a>, return other values (in this case, a React tree). When using TypeScript, cast the type of <a href="https://github.com/vfile/vfile#vfilecontents"><code>file.contents</code></a> on your side.</p>
...
<a class="sourceLine" id="cb25-5" title="5"><span class="va">module</span>.<span class="at">exports</span> <span class="op">=</span> <span class="at">unified</span>()</a>
<a class="sourceLine" id="cb25-6" title="6">  .<span class="at">use</span>(parse)</a>
<a class="sourceLine" id="cb25-7" title="7">  .<span class="at">use</span>(stringify)</a>
<a class="sourceLine" id="cb25-8" title="8">  .<span class="at">freeze</span>()</a></code></pre></div>
...
<p>The below example, <code>b.js</code>, shows a similar looking example that operates on the frozen rehype interface because it does not call <code>rehype</code>. If this behaviour was allowed it would result in unexpected behaviour so an error is thrown. <strong>This is invalid</strong>:</p>
...
<p><strong>Attachers</strong> are materialised <a href="#plugin"><em>plugin</em></a>s. An attacher is a function that can receive options and <a href="#configuration"><em>configures</em></a> the processor.</p>
...
<p>See <a href="https://github.com/unifiedjs/.github/blob/master/contributing.md"><code>contributing.md</code></a> in <a href="https://github.com/unifiedjs/.github"><code>unifiedjs/.github</code></a> for ways to get started. See <a href="https://github.com/unifiedjs/.github/blob/master/support.md"><code>support.md</code></a> for ways to get help. Ideas for new plugins and tools can be posted in <a href="https://github.com/unifiedjs/ideas"><code>unifiedjs/ideas</code></a>.</p>
...
<p>This project has a <a href="https://github.com/unifiedjs/.github/blob/master/code-of-conduct.md">Code of Conduct</a>. By interacting with this repository, organisation, or community you agree to abide by its terms.</p>
