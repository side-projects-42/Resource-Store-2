...
function configFilesPath() {
  ...
  if (!(endsWith(configFilePath, '.yaml', true) || endsWith(configFilePath, '.yml', true) || endsWith(configFilePath, '.split', true))) throw new Error("Invalid extension specified for Splits mock file. Accepted extensions are \".yml\" and \".yaml\". Your specified file is ".concat(configFilePath));
  if (!fs.existsSync(configFilePath)) throw new Error("Split configuration not found in ".concat(configFilePath, " - Please review your Split file location."));
