...
var SplitClient_1 = require("./SplitClient");
...
var SplitFactory = /** @class */ (function (_super) {
    ...
    function SplitFactory(props) {
        ...
        if (propFactory) {
            ...
            if (config) {
                ...
                factory = utils_1.getSplitFactory(config);
            }
        }
    ...
    SplitFactory.prototype.componentWillUnmount = function () {
        ...
        if (!this.isFactoryExternal && this.state.factory) {
            utils_1.destroySplitFactory(this.state.factory);
        }
    };
    SplitFactory.prototype.render = function () {
        var _a = this.state, factory = _a.factory, client = _a.client;
        return (react_1.default.createElement(SplitClient_1.SplitComponent, __assign({}, this.props, { factory: factory, client: client })));
    };
