...
var SplitComponent = /** @class */ (function (_super) {
    ...
    function SplitComponent(props) {
        ...
        _this.state = __assign(__assign({ factory: factory,
            client: client }, utils_1.getStatus(client)), { lastUpdate: 0 });
        return _this;
    }
    ...
    SplitComponent.getDerivedStateFromProps = function (props, state) {
        ...
        var status = utils_1.getStatus(client);
    ...
    SplitComponent.prototype.subscribeToEvents = function (client) {
        if (client) {
            var status_1 = utils_1.getStatus(client);
            if (!status_1.isReady)
...
function SplitClient(props) {
    return (react_1.default.createElement(SplitContext_1.default.Consumer, null, function (splitContext) {
        ...
        var client = factory ? utils_1.getSplitSharedClient(factory, props.splitKey, props.trafficType) : null;
        return (react_1.default.createElement(SplitComponent, __assign({}, props, { factory: factory, client: client })));
    }));
}
exports.default = SplitClient;
