...
var SplitTreatments_1 = __importDefault(require("./SplitTreatments"));
/**
...
function withSplitTreatments(names, attributes) {
    return function withSplitTreatmentsHoc(WrappedComponent) {
        return function (props) {
            return (react_1.default.createElement(SplitTreatments_1.default, { names: names, attributes: attributes }, function (splitProps) {
                return (react_1.default.createElement(WrappedComponent, __assign({}, props, splitProps)));
            }));
        };
    };
}
exports.default = withSplitTreatments;
