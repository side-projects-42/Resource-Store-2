...
<div class="sourceCode" id="cb2"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="im">import</span> JestWorker <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="im">import</span> JestWorker <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="im">import</span> JestWorker <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
