...
<div class="sourceCode" id="cb2"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="im">import</span> <span class="op">{</span>Worker <span class="im">as</span> JestWorker<span class="op">}</span> <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb2-4" title="4">  <span class="kw">const</span> worker <span class="op">=</span> <span class="kw">new</span> <span class="at">JestWorker</span>(<span class="va">require</span>.<span class="at">resolve</span>(<span class="st">&#39;./Worker&#39;</span>))<span class="op">;</span></a>
...
<h3 id="workerschedulingpolicy-round-robin-in-order-optional"><code>workerSchedulingPolicy: 'round-robin' | 'in-order'</code> (optional)</h3>
...
<h3 id="taskqueue-taskqueue-optional"><code>taskQueue</code>: TaskQueue` (optional)</h3>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="im">import</span> <span class="op">{</span>Worker <span class="im">as</span> JestWorker<span class="op">}</span> <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb4-4" title="4">  <span class="kw">const</span> myWorker <span class="op">=</span> <span class="kw">new</span> <span class="at">JestWorker</span>(<span class="va">require</span>.<span class="at">resolve</span>(<span class="st">&#39;./Worker&#39;</span>)<span class="op">,</span> <span class="op">{</span></a>
...
<a class="sourceLine" id="cb4-13" title="13">  <span class="kw">const</span> <span class="op">{</span>forceExited<span class="op">}</span> <span class="op">=</span> <span class="cf">await</span> <span class="va">myWorker</span>.<span class="at">end</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb4-14" title="14">  <span class="cf">if</span> (forceExited) <span class="op">{</span></a>
<a class="sourceLine" id="cb4-15" title="15">    <span class="va">console</span>.<span class="at">error</span>(<span class="st">&#39;Workers failed to exit gracefully&#39;</span>)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb4-19" title="19"><span class="at">main</span>()<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode javascript"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="im">import</span> <span class="op">{</span>Worker <span class="im">as</span> JestWorker<span class="op">}</span> <span class="im">from</span> <span class="st">&#39;jest-worker&#39;</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb6-4" title="4">  <span class="kw">const</span> myWorker <span class="op">=</span> <span class="kw">new</span> <span class="at">JestWorker</span>(<span class="va">require</span>.<span class="at">resolve</span>(<span class="st">&#39;./Worker&#39;</span>)<span class="op">,</span> <span class="op">{</span></a>
...
<a class="sourceLine" id="cb6-19" title="19">  <span class="kw">const</span> <span class="op">{</span>forceExited<span class="op">}</span> <span class="op">=</span> <span class="cf">await</span> <span class="va">myWorker</span>.<span class="at">end</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb6-20" title="20">  <span class="cf">if</span> (forceExited) <span class="op">{</span></a>
<a class="sourceLine" id="cb6-21" title="21">    <span class="va">console</span>.<span class="at">error</span>(<span class="st">&#39;Workers failed to exit gracefully&#39;</span>)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb6-25" title="25"><span class="at">main</span>()<span class="op">;</span></a></code></pre></div>
