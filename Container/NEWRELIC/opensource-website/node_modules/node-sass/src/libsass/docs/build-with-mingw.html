...
<p>You need to have the following components installed: <img src="https://cloud.githubusercontent.com/assets/282293/5525466/947bf396-89e6-11e4-841d-4aa916f14de1.png" /></p>
...
<p>Download <a href="http://sourceforge.net/projects/mingw-w64/files/Toolchains%20targetting%20Win64/Personal%20Builds/mingw-builds/4.9.2/threads-win32/seh/x86_64-4.9.2-release-win32-seh-rt_v3-rev0.7z/download">MinGW64 for windows7 64bit</a> and unzip to “C:64”.</p>
<p>Create a batch file with this content:</p>
<pre class="bat"><code>@echo off
