...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> readPkgUp <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;read-pkg-up&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-2" title="2"></a>
<a class="sourceLine" id="cb2-3" title="3"><span class="at">readPkgUp</span>().<span class="at">then</span>(<span class="kw">function</span> (result) <span class="op">{</span></a>
...
<a class="sourceLine" id="cb2-12" title="12"><span class="co">        path: &#39;/Users/sindresorhus/dev/awesome-package&#39;</span></a>
