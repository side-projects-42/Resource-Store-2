<span id="eslint-plugin-flowtype"></span> \# eslint-plugin-flowtype
...
<span id="eslint-plugin-flowtype-rules-object-type-delimiter"></span> \#\#\# `object-type-delimiter`
...
<span id="eslint-plugin-flowtype-rules-quotes"></span> \#\#\# `quotes`
...
<span id="eslint-plugin-flowtype-rules-require-valid-file-annotation"></span> \#\#\# `require-valid-file-annotation`
...
<span id="eslint-plugin-flowtype-rules-require-valid-file-annotation-options-11"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-require-variable-type"></span> \#\#\# `require-variable-type`

Requires that all variable declarators have type annotations.

<span id="eslint-plugin-flowtype-rules-require-variable-type-options-12"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-semi"></span> \#\#\# `semi`
...
<span id="eslint-plugin-flowtype-rules-sort-keys"></span> \#\#\# `sort-keys`

*The `--fix` option on the command line automatically fixes problems reported by this rule.*

Enforces natural, case-insensitive sorting of Object annotations.

<span id="eslint-plugin-flowtype-rules-sort-keys-options-13"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-space-after-type-colon"></span> \#\#\# `space-after-type-colon`

*The `--fix` option on the command line automatically fixes problems reported by this rule.*

Enforces consistent spacing after the type annotation colon.

<span id="eslint-plugin-flowtype-rules-space-after-type-colon-options-14"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-space-before-generic-bracket"></span> \#\#\# `space-before-generic-bracket`
...
<span id="eslint-plugin-flowtype-rules-space-before-type-colon"></span> \#\#\# `space-before-type-colon`
...
<span id="eslint-plugin-flowtype-rules-spread-exact-type"></span> \#\#\# `spread-exact-type`
...
<span id="eslint-plugin-flowtype-rules-type-id-match"></span> \#\#\# `type-id-match`

Enforces a consistent naming pattern for type aliases.

<span id="eslint-plugin-flowtype-rules-type-id-match-options-15"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-type-import-style"></span> \#\#\# `type-import-style`
...
<span id="eslint-plugin-flowtype-rules-type-import-style-options-16"></span> \#\#\#\# Options
...
<span id="eslint-plugin-flowtype-rules-union-intersection-spacing"></span> \#\#\# `union-intersection-spacing`
...
<span id="eslint-plugin-flowtype-rules-use-flow-type"></span> \#\#\# `use-flow-type`
...
<span id="eslint-plugin-flowtype-rules-use-read-only-spread"></span> \#\#\# `use-read-only-spread`
...
\`\`\`flow js type INode = {| +type: string, |};

type Identifier = {| …INode, +name: string, |}; \`\`\`
...
\`\`\`flow js const x: Identifier = { name: ’‘, type:’’ };

x.type = ‘Should not be writable!’; // No Flow error x.name = ‘Should not be writable!’; // No Flow error \`\`\`

This rule suggests to use `$ReadOnly<…>` to prevent accidental loss of readonly-ness:

\`\`\`flow js type Identifier = $ReadOnly&lt;{| …INode, +name: string, |}&gt;;

const x: Identifier = { name: ’‘, type:’’ };

x.type = ‘Should not be writable!’; // $FlowExpectedError\[cannot-write\] x.name = ‘Should not be writable!’; // $FlowExpectedError\[cannot-write\] \`\`\`
...
<span id="eslint-plugin-flowtype-rules-valid-syntax"></span> \#\#\# `valid-syntax`
