...
<li>Optionally <a href="#argument-resolvers"><strong>accepts resolvers</strong></a> that normalize function arguments before passing them to underlying function.</li>
...
<p><strong>Note</strong>: Invocations that throw exceptions are not cached.</p>
