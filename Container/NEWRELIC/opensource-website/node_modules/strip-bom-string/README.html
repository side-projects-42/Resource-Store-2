...
<body>
<h1 id="strip-bom-string-npm-version-npm-monthly-downloads-npm-total-downloads-linux-build-status">strip-bom-string <a href="https://www.npmjs.com/package/strip-bom-string"><img src="https://img.shields.io/npm/v/strip-bom-string.svg?style=flat" alt="NPM version" /></a> <a href="https://npmjs.org/package/strip-bom-string"><img src="https://img.shields.io/npm/dm/strip-bom-string.svg?style=flat" alt="NPM monthly downloads" /></a> <a href="https://npmjs.org/package/strip-bom-string"><img src="https://img.shields.io/npm/dt/strip-bom-string.svg?style=flat" alt="NPM total downloads" /></a> <a href="https://travis-ci.org/jonschlinkert/strip-bom-string"><img src="https://img.shields.io/travis/jonschlinkert/strip-bom-string.svg?style=flat&amp;label=Travis" alt="Linux Build Status" /></a></h1>
<blockquote>
<p>Strip a byte order mark (BOM) from a string.</p>
</blockquote>
<h2 id="install">Install</h2>
<p>Install with <a href="https://www.npmjs.com/">npm</a>:</p>
<div class="sourceCode" id="cb1"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">npm</span> install --save strip-bom-string</a></code></pre></div>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> strip <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;strip-bom-string&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-2" title="2"><span class="at">strip</span>(<span class="st">&#39;</span><span class="sc">\ufeff</span><span class="st">foo&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-3" title="3"><span class="co">//=&gt; &#39;foo&#39;</span></a></code></pre></div>
...
<li><a href="https://www.npmjs.com/package/strip-bom-buffer">strip-bom-buffer</a>: Strip a byte order mark (BOM) from a buffer. | <a href="https://github.com/jonschlinkert/strip-bom-buffer" title="Strip a byte order mark (BOM) from a buffer.">homepage</a></li>
</ul>
