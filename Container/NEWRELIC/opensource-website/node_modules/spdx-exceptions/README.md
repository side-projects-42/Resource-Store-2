The package exports an array of strings. Each string is an identifier for a license exception under the [Software Package Data Exchange (SPDX)](https://spdx.org) software license metadata standard.
