...
<table><thead><tr class="header"><th>hoist-non-react-statics Version</th><th>Compatible React Version</th></tr></thead><tbody><tr class="odd"><td>3.x</td><td>0.13-16.x With ForwardRef Support</td></tr><tr class="even"><td>2.x</td><td>0.13-16.x Without ForwardRef Support</td></tr><tr class="odd"><td>1.x</td><td>0.13-16.2</td></tr></tbody></table>
...
This software is free to use under the Yahoo Inc. BSD license. See the [LICENSE file](https://github.com/mridgway/hoist-non-react-statics/blob/master/LICENSE.md) for license text and copyright information.
