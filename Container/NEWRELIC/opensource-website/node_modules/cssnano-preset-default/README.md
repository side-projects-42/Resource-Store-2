...
> PostCSS plugin to discard overridden <span class="citation" data-cites="keyframes">@keyframes</span> or <span class="citation" data-cites="counter-style">@counter-style</span>.
