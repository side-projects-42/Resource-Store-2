...
<pre><code>$ npm install file-type</code></pre>
...
<p>It only needs the first 4100 bytes. The exception is detection of <code>docx</code>, <code>pptx</code>, and <code>xlsx</code> which potentially requires reading the whole file.</p>
