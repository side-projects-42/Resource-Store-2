...
[🔗](#promise) Client usage with Promise
...
[🔗](#retry-strategy) Client usage with custom retry timeout strategy
...
[🔗](#dynamic-schema) [ws](https://github.com/websockets/ws) server usage with dynamic schema
