...
<a class="sourceLine" id="cb3-12" title="12"><span class="va">keyv</span>.<span class="at">on</span>(<span class="st">&#39;error&#39;</span> err <span class="kw">=&gt;</span> <span class="va">console</span>.<span class="at">log</span>(<span class="st">&#39;Connection Error&#39;</span><span class="op">,</span> err))<span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">const</span> Keyv <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;keyv&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-2" title="2"><span class="kw">const</span> myAdapter <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;./my-storage-adapter&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-3" title="3"></a>
<a class="sourceLine" id="cb5-4" title="4"><span class="kw">const</span> keyv <span class="op">=</span> <span class="kw">new</span> <span class="at">Keyv</span>(<span class="op">{</span> <span class="dt">store</span><span class="op">:</span> myAdapter <span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="kw">new</span> <span class="at">Keyv</span>(<span class="op">{</span> <span class="dt">store</span><span class="op">:</span> <span class="kw">new</span> <span class="at">Map</span>() <span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">const</span> Keyv <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;keyv&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-2" title="2"><span class="kw">const</span> QuickLRU <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;quick-lru&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-3" title="3"></a>
<a class="sourceLine" id="cb7-4" title="4"><span class="kw">const</span> lru <span class="op">=</span> <span class="kw">new</span> <span class="at">QuickLRU</span>(<span class="op">{</span> <span class="dt">maxSize</span><span class="op">:</span> <span class="dv">1000</span> <span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-5" title="5"><span class="kw">const</span> keyv <span class="op">=</span> <span class="kw">new</span> <span class="at">Keyv</span>(<span class="op">{</span> <span class="dt">store</span><span class="op">:</span> lru <span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="kw">class</span> AwesomeModule <span class="op">{</span></a>
<a class="sourceLine" id="cb8-2" title="2">    <span class="at">constructor</span>(opts) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-3" title="3">        <span class="kw">this</span>.<span class="at">cache</span> <span class="op">=</span> <span class="kw">new</span> <span class="at">Keyv</span>(<span class="op">{</span></a>
<a class="sourceLine" id="cb8-4" title="4">            <span class="dt">uri</span><span class="op">:</span> <span class="kw">typeof</span> <span class="va">opts</span>.<span class="at">cache</span> <span class="op">===</span> <span class="st">&#39;string&#39;</span> <span class="op">&amp;&amp;</span> <span class="va">opts</span>.<span class="at">cache</span><span class="op">,</span></a>
<a class="sourceLine" id="cb8-5" title="5">            <span class="dt">store</span><span class="op">:</span> <span class="kw">typeof</span> <span class="va">opts</span>.<span class="at">cache</span> <span class="op">!==</span> <span class="st">&#39;string&#39;</span> <span class="op">&amp;&amp;</span> <span class="va">opts</span>.<span class="at">cache</span><span class="op">,</span></a>
<a class="sourceLine" id="cb8-6" title="6">            <span class="dt">namespace</span><span class="op">:</span> <span class="st">&#39;awesome-module&#39;</span></a>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="kw">const</span> AwesomeModule <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;awesome-module&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-2" title="2"></a>
<a class="sourceLine" id="cb9-3" title="3"><span class="co">// Caches stuff in memory by default</span></a>
<a class="sourceLine" id="cb9-4" title="4"><span class="kw">const</span> awesomeModule <span class="op">=</span> <span class="kw">new</span> <span class="at">AwesomeModule</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb9-5" title="5"></a>
<a class="sourceLine" id="cb9-6" title="6"><span class="co">// After npm install --save keyv-redis</span></a>
<a class="sourceLine" id="cb9-7" title="7"><span class="kw">const</span> awesomeModule <span class="op">=</span> <span class="kw">new</span> <span class="at">AwesomeModule</span>(<span class="op">{</span> <span class="dt">cache</span><span class="op">:</span> <span class="st">&#39;redis://localhost&#39;</span> <span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-8" title="8"></a>
<a class="sourceLine" id="cb9-9" title="9"><span class="co">// Some third-party module that implements the Map API</span></a>
<a class="sourceLine" id="cb9-10" title="10"><span class="kw">const</span> awesomeModule <span class="op">=</span> <span class="kw">new</span> <span class="at">AwesomeModule</span>(<span class="op">{</span> <span class="dt">cache</span><span class="op">:</span> some3rdPartyStore <span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
<h2 id="api">API</h2>
