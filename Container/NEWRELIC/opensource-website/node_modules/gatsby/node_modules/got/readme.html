...
<h6 id="retries">retries</h6>
<p>Type: <code>number</code> <code>Function</code><br> Default: <code>2</code></p>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="va">got</span>.<span class="at">stream</span>(<span class="st">&#39;github.com&#39;</span>)</a>
<a class="sourceLine" id="cb5-2" title="2">    .<span class="at">on</span>(<span class="st">&#39;request&#39;</span><span class="op">,</span> req <span class="kw">=&gt;</span> <span class="at">setTimeout</span>(() <span class="kw">=&gt;</span> <span class="va">req</span>.<span class="at">abort</span>()<span class="op">,</span> <span class="dv">50</span>))<span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb6-2" title="2">    <span class="dt">percent</span><span class="op">:</span> <span class="fl">0.1</span><span class="op">,</span></a>
<a class="sourceLine" id="cb6-3" title="3">    <span class="dt">transferred</span><span class="op">:</span> <span class="dv">1024</span><span class="op">,</span></a>
<a class="sourceLine" id="cb6-4" title="4">    <span class="dt">total</span><span class="op">:</span> <span class="dv">10240</span></a>
...
<a class="sourceLine" id="cb7-2" title="2">    <span class="kw">const</span> response <span class="op">=</span> <span class="cf">await</span> <span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span>)</a>
<a class="sourceLine" id="cb7-3" title="3">        .<span class="at">on</span>(<span class="st">&#39;downloadProgress&#39;</span><span class="op">,</span> progress <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb7-4" title="4">            <span class="co">// Report download progress</span></a>
<a class="sourceLine" id="cb7-5" title="5">        <span class="op">}</span>)</a>
<a class="sourceLine" id="cb7-6" title="6">        .<span class="at">on</span>(<span class="st">&#39;uploadProgress&#39;</span><span class="op">,</span> progress <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb7-7" title="7">            <span class="co">// Report upload progress</span></a>
<a class="sourceLine" id="cb7-8" title="8">        <span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-9" title="9"></a>
<a class="sourceLine" id="cb7-10" title="10">    <span class="va">console</span>.<span class="at">log</span>(response)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb8-2" title="2">    <span class="kw">const</span> request <span class="op">=</span> <span class="at">got</span>(url<span class="op">,</span> options)<span class="op">;</span></a>
<a class="sourceLine" id="cb8-3" title="3"></a>
<a class="sourceLine" id="cb8-4" title="4">    …</a>
<a class="sourceLine" id="cb8-5" title="5"></a>
<a class="sourceLine" id="cb8-6" title="6">    <span class="co">// In another part of the code</span></a>
<a class="sourceLine" id="cb8-7" title="7">    <span class="cf">if</span> (something) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-8" title="8">        <span class="va">request</span>.<span class="at">cancel</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb8-9" title="9">    <span class="op">}</span></a>
<a class="sourceLine" id="cb8-10" title="10"></a>
<a class="sourceLine" id="cb8-11" title="11">    …</a>
<a class="sourceLine" id="cb8-12" title="12"></a>
<a class="sourceLine" id="cb8-13" title="13">    <span class="cf">try</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb8-14" title="14">        <span class="cf">await</span> request<span class="op">;</span></a>
<a class="sourceLine" id="cb8-15" title="15">    <span class="op">}</span> <span class="cf">catch</span> (error) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-16" title="16">        <span class="cf">if</span> (<span class="va">request</span>.<span class="at">isCanceled</span>) <span class="op">{</span> <span class="co">// Or `error instanceof got.CancelError`</span></a>
<a class="sourceLine" id="cb8-17" title="17">            <span class="co">// Handle cancelation</span></a>
<a class="sourceLine" id="cb8-18" title="18">        <span class="op">}</span></a>
<a class="sourceLine" id="cb8-19" title="19"></a>
<a class="sourceLine" id="cb8-20" title="20">        <span class="co">// Handle other errors</span></a>
...
<a class="sourceLine" id="cb9-2" title="2"><span class="kw">const</span> map <span class="op">=</span> <span class="kw">new</span> <span class="at">Map</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb9-3" title="3"></a>
<a class="sourceLine" id="cb9-4" title="4">(<span class="kw">async</span> () <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb9-5" title="5">        <span class="kw">let</span> response <span class="op">=</span> <span class="cf">await</span> <span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span><span class="dt">cache</span><span class="op">:</span> map<span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-6" title="6">        <span class="va">console</span>.<span class="at">log</span>(<span class="va">response</span>.<span class="at">fromCache</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-7" title="7">        <span class="co">//=&gt; false</span></a>
<a class="sourceLine" id="cb9-8" title="8"></a>
<a class="sourceLine" id="cb9-9" title="9">        response <span class="op">=</span> <span class="cf">await</span> <span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span><span class="dt">cache</span><span class="op">:</span> map<span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-10" title="10">        <span class="va">console</span>.<span class="at">log</span>(<span class="va">response</span>.<span class="at">fromCache</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-11" title="11">        <span class="co">//=&gt; true</span></a>
<a class="sourceLine" id="cb9-12" title="12"><span class="op">}</span>)()<span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb11-2" title="2"><span class="kw">const</span> KeyvRedis <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;@keyv/redis&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb11-3" title="3"></a>
<a class="sourceLine" id="cb11-4" title="4"><span class="kw">const</span> redis <span class="op">=</span> <span class="kw">new</span> <span class="at">KeyvRedis</span>(<span class="st">&#39;redis://user:pass@localhost:6379&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb11-5" title="5"></a>
<a class="sourceLine" id="cb11-6" title="6"><span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span><span class="dt">cache</span><span class="op">:</span> redis<span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="kw">const</span> storageAdapter <span class="op">=</span> <span class="kw">new</span> <span class="at">Map</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb12-2" title="2"><span class="co">// or</span></a>
<a class="sourceLine" id="cb12-3" title="3"><span class="kw">const</span> storageAdapter <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;./my-storage-adapter&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-4" title="4"><span class="co">// or</span></a>
<a class="sourceLine" id="cb12-5" title="5"><span class="kw">const</span> QuickLRU <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;quick-lru&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-6" title="6"><span class="kw">const</span> storageAdapter <span class="op">=</span> <span class="kw">new</span> <span class="at">QuickLRU</span>(<span class="op">{</span><span class="dt">maxSize</span><span class="op">:</span> <span class="dv">1000</span><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-7" title="7"></a>
<a class="sourceLine" id="cb12-8" title="8"><span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span><span class="dt">cache</span><span class="op">:</span> storageAdapter<span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb13-2" title="2"><span class="kw">const</span> tunnel <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;tunnel&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb13-3" title="3"></a>
<a class="sourceLine" id="cb13-4" title="4"><span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb13-5" title="5">    <span class="dt">agent</span><span class="op">:</span> <span class="va">tunnel</span>.<span class="at">httpOverHttp</span>(<span class="op">{</span></a>
<a class="sourceLine" id="cb13-6" title="6">        <span class="dt">proxy</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb13-7" title="7">            <span class="dt">host</span><span class="op">:</span> <span class="st">&#39;localhost&#39;</span></a>
<a class="sourceLine" id="cb13-8" title="8">        <span class="op">}</span></a>
<a class="sourceLine" id="cb13-9" title="9">    <span class="op">}</span>)</a>
<a class="sourceLine" id="cb13-10" title="10"><span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb14-2" title="2"><span class="kw">const</span> HttpAgent <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;agentkeepalive&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb14-3" title="3"><span class="kw">const</span> HttpsAgent <span class="op">=</span> <span class="va">HttpAgent</span>.<span class="at">HttpsAgent</span><span class="op">;</span></a>
<a class="sourceLine" id="cb14-4" title="4"></a>
<a class="sourceLine" id="cb14-5" title="5"><span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb14-6" title="6">    <span class="dt">agent</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb14-7" title="7">        <span class="dt">http</span><span class="op">:</span> <span class="kw">new</span> <span class="at">HttpAgent</span>()<span class="op">,</span></a>
<a class="sourceLine" id="cb14-8" title="8">        <span class="dt">https</span><span class="op">:</span> <span class="kw">new</span> <span class="at">HttpsAgent</span>()</a>
...
<a class="sourceLine" id="cb15-2" title="2"><span class="kw">const</span> cookie <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;cookie&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb15-3" title="3"></a>
<a class="sourceLine" id="cb15-4" title="4"><span class="at">got</span>(<span class="st">&#39;google.com&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb15-5" title="5">    <span class="dt">headers</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb15-6" title="6">        <span class="dt">cookie</span><span class="op">:</span> <span class="va">cookie</span>.<span class="at">serialize</span>(<span class="st">&#39;foo&#39;</span><span class="op">,</span> <span class="st">&#39;bar&#39;</span>)</a>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb16-1" title="1"><span class="kw">const</span> fs <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;fs&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb16-2" title="2"><span class="kw">const</span> got <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;got&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb16-3" title="3"><span class="kw">const</span> FormData <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;form-data&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb16-4" title="4"><span class="kw">const</span> form <span class="op">=</span> <span class="kw">new</span> <span class="at">FormData</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb16-5" title="5"></a>
<a class="sourceLine" id="cb16-6" title="6"><span class="va">form</span>.<span class="at">append</span>(<span class="st">&#39;my_file&#39;</span><span class="op">,</span> <span class="va">fs</span>.<span class="at">createReadStream</span>(<span class="st">&#39;/foo/bar.jpg&#39;</span>))<span class="op">;</span></a>
<a class="sourceLine" id="cb16-7" title="7"></a>
<a class="sourceLine" id="cb16-8" title="8"><span class="va">got</span>.<span class="at">post</span>(<span class="st">&#39;google.com&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb16-9" title="9">    <span class="dt">body</span><span class="op">:</span> form</a>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb17-1" title="1"><span class="kw">const</span> got <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;got&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb17-2" title="2"><span class="kw">const</span> crypto  <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;crypto&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb17-3" title="3"><span class="kw">const</span> OAuth <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;oauth-1.0a&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb17-4" title="4"></a>
<a class="sourceLine" id="cb17-5" title="5"><span class="kw">const</span> oauth <span class="op">=</span> <span class="at">OAuth</span>(<span class="op">{</span></a>
<a class="sourceLine" id="cb17-6" title="6">    <span class="dt">consumer</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb17-7" title="7">        <span class="dt">key</span><span class="op">:</span> <span class="va">process</span>.<span class="va">env</span>.<span class="at">CONSUMER_KEY</span><span class="op">,</span></a>
<a class="sourceLine" id="cb17-8" title="8">        <span class="dt">secret</span><span class="op">:</span> <span class="va">process</span>.<span class="va">env</span>.<span class="at">CONSUMER_SECRET</span></a>
<a class="sourceLine" id="cb17-9" title="9">    <span class="op">},</span></a>
<a class="sourceLine" id="cb17-10" title="10">    <span class="dt">signature_method</span><span class="op">:</span> <span class="st">&#39;HMAC-SHA1&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb17-11" title="11">    <span class="dt">hash_function</span><span class="op">:</span> (baseString<span class="op">,</span> key) <span class="kw">=&gt;</span> <span class="va">crypto</span>.<span class="at">createHmac</span>(<span class="st">&#39;sha1&#39;</span><span class="op">,</span> key).<span class="at">update</span>(baseString).<span class="at">digest</span>(<span class="st">&#39;base64&#39;</span>)</a>
<a class="sourceLine" id="cb17-12" title="12"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb17-13" title="13"></a>
<a class="sourceLine" id="cb17-14" title="14"><span class="kw">const</span> token <span class="op">=</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb17-15" title="15">    <span class="dt">key</span><span class="op">:</span> <span class="va">process</span>.<span class="va">env</span>.<span class="at">ACCESS_TOKEN</span><span class="op">,</span></a>
<a class="sourceLine" id="cb17-16" title="16">    <span class="dt">secret</span><span class="op">:</span> <span class="va">process</span>.<span class="va">env</span>.<span class="at">ACCESS_TOKEN_SECRET</span></a>
<a class="sourceLine" id="cb17-17" title="17"><span class="op">};</span></a>
<a class="sourceLine" id="cb17-18" title="18"></a>
<a class="sourceLine" id="cb17-19" title="19"><span class="kw">const</span> url <span class="op">=</span> <span class="st">&#39;https://api.twitter.com/1.1/statuses/home_timeline.json&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb17-20" title="20"></a>
<a class="sourceLine" id="cb17-21" title="21"><span class="at">got</span>(url<span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb17-22" title="22">    <span class="dt">headers</span><span class="op">:</span> <span class="va">oauth</span>.<span class="at">toHeader</span>(<span class="va">oauth</span>.<span class="at">authorize</span>(<span class="op">{</span>url<span class="op">,</span> <span class="dt">method</span><span class="op">:</span> <span class="st">&#39;GET&#39;</span><span class="op">},</span> token))<span class="op">,</span></a>
<a class="sourceLine" id="cb17-23" title="23">    <span class="dt">json</span><span class="op">:</span> <span class="kw">true</span></a>
<a class="sourceLine" id="cb17-24" title="24"><span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb18"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb18-1" title="1"><span class="at">got</span>(<span class="st">&#39;http://unix:/var/run/docker.sock:/containers/json&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb18-2" title="2"></a>
<a class="sourceLine" id="cb18-3" title="3"><span class="co">// or without protocol (http by default)</span></a>
<a class="sourceLine" id="cb18-4" title="4"><span class="at">got</span>(<span class="st">&#39;unix:/var/run/docker.sock:/containers/json&#39;</span>)<span class="op">;</span></a></code></pre></div>
<h2 id="aws">AWS</h2>
...
<div class="sourceCode" id="cb19"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb19-1" title="1"><span class="kw">const</span> url <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;url&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-2" title="2"><span class="kw">const</span> AWS <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;aws-sdk&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-3" title="3"><span class="kw">const</span> aws4 <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;aws4&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-4" title="4"><span class="kw">const</span> got <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;got&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-5" title="5"><span class="kw">const</span> config <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;./config&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-6" title="6"></a>
<a class="sourceLine" id="cb19-7" title="7"><span class="co">// Reads keys from the environment or `~/.aws/credentials`. Could be a plain object.</span></a>
<a class="sourceLine" id="cb19-8" title="8"><span class="kw">const</span> awsConfig <span class="op">=</span> <span class="kw">new</span> <span class="va">AWS</span>.<span class="at">Config</span>(<span class="op">{</span> <span class="dt">region</span><span class="op">:</span> <span class="va">config</span>.<span class="at">region</span> <span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-9" title="9"></a>
<a class="sourceLine" id="cb19-10" title="10"><span class="kw">function</span> <span class="at">request</span>(uri<span class="op">,</span> options) <span class="op">{</span></a>
<a class="sourceLine" id="cb19-11" title="11">    <span class="kw">const</span> awsOpts <span class="op">=</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb19-12" title="12">        <span class="dt">region</span><span class="op">:</span> <span class="va">awsConfig</span>.<span class="at">region</span><span class="op">,</span></a>
<a class="sourceLine" id="cb19-13" title="13">        <span class="dt">headers</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb19-14" title="14">            <span class="dt">accept</span><span class="op">:</span> <span class="st">&#39;application/json&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb19-15" title="15">            <span class="st">&#39;content-type&#39;</span><span class="op">:</span> <span class="st">&#39;application/json&#39;</span></a>
<a class="sourceLine" id="cb19-16" title="16">        <span class="op">},</span></a>
<a class="sourceLine" id="cb19-17" title="17">        <span class="dt">method</span><span class="op">:</span> <span class="st">&#39;GET&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb19-18" title="18">        <span class="dt">json</span><span class="op">:</span> <span class="kw">true</span></a>
<a class="sourceLine" id="cb19-19" title="19">    <span class="op">};</span></a>
<a class="sourceLine" id="cb19-20" title="20"></a>
<a class="sourceLine" id="cb19-21" title="21">    <span class="co">// We need to parse the URL before passing it to `got` so `aws4` can sign the request</span></a>
<a class="sourceLine" id="cb19-22" title="22">    <span class="kw">const</span> opts <span class="op">=</span> <span class="va">Object</span>.<span class="at">assign</span>(<span class="va">url</span>.<span class="at">parse</span>(uri)<span class="op">,</span> awsOpts<span class="op">,</span> options)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-23" title="23">    <span class="va">aws4</span>.<span class="at">sign</span>(opts<span class="op">,</span> <span class="va">awsConfig</span>.<span class="at">credentials</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-24" title="24"></a>
<a class="sourceLine" id="cb19-25" title="25">    <span class="cf">return</span> <span class="at">got</span>(opts)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-26" title="26"><span class="op">}</span></a>
<a class="sourceLine" id="cb19-27" title="27"></a>
<a class="sourceLine" id="cb19-28" title="28"><span class="at">request</span>(<span class="vs">`https://</span><span class="sc">${</span><span class="va">config</span>.<span class="at">host</span><span class="sc">}</span><span class="vs">/production/users/1`</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb19-29" title="29"></a>
<a class="sourceLine" id="cb19-30" title="30"><span class="at">request</span>(<span class="vs">`https://</span><span class="sc">${</span><span class="va">config</span>.<span class="at">host</span><span class="sc">}</span><span class="vs">/production/`</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb19-31" title="31">    <span class="co">// All usual `got` options</span></a>
<a class="sourceLine" id="cb19-32" title="32"><span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb20-2" title="2"><span class="kw">const</span> nock <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;nock&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-3" title="3"></a>
<a class="sourceLine" id="cb20-4" title="4"><span class="at">nock</span>(<span class="st">&#39;https://sindresorhus.com&#39;</span>)</a>
<a class="sourceLine" id="cb20-5" title="5">    .<span class="at">get</span>(<span class="st">&#39;/&#39;</span>)</a>
<a class="sourceLine" id="cb20-6" title="6">    .<span class="at">reply</span>(<span class="dv">200</span><span class="op">,</span> <span class="st">&#39;Hello world!&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-7" title="7"></a>
<a class="sourceLine" id="cb20-8" title="8">(<span class="kw">async</span> () <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb20-9" title="9">    <span class="kw">const</span> response <span class="op">=</span> <span class="cf">await</span> <span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-10" title="10">    <span class="va">console</span>.<span class="at">log</span>(<span class="va">response</span>.<span class="at">body</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb20-11" title="11">    <span class="co">//=&gt; &#39;Hello world!&#39;</span></a>
...
<div class="sourceCode" id="cb21"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb21-1" title="1"><span class="kw">const</span> got <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;got&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb21-2" title="2"><span class="kw">const</span> createTestServer <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;create-test-server&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb21-3" title="3"></a>
<a class="sourceLine" id="cb21-4" title="4">(<span class="kw">async</span> () <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb21-5" title="5">    <span class="kw">const</span> server <span class="op">=</span> <span class="cf">await</span> <span class="at">createTestServer</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb21-6" title="6">    <span class="va">server</span>.<span class="at">get</span>(<span class="st">&#39;/&#39;</span><span class="op">,</span> <span class="st">&#39;Hello world!&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb21-7" title="7"></a>
<a class="sourceLine" id="cb21-8" title="8">    <span class="kw">const</span> response <span class="op">=</span> <span class="cf">await</span> <span class="at">got</span>(<span class="va">server</span>.<span class="at">url</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb21-9" title="9">    <span class="va">console</span>.<span class="at">log</span>(<span class="va">response</span>.<span class="at">body</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb21-10" title="10">    <span class="co">//=&gt; &#39;Hello world!&#39;</span></a>
<a class="sourceLine" id="cb21-11" title="11"></a>
<a class="sourceLine" id="cb21-12" title="12">    <span class="cf">await</span> <span class="va">server</span>.<span class="at">close</span>()<span class="op">;</span></a>
...
<a class="sourceLine" id="cb22-2" title="2"><span class="kw">const</span> pkg <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;./package.json&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb22-3" title="3"></a>
<a class="sourceLine" id="cb22-4" title="4"><span class="at">got</span>(<span class="st">&#39;sindresorhus.com&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb22-5" title="5">    <span class="dt">headers</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb22-6" title="6">        <span class="st">&#39;user-agent&#39;</span><span class="op">:</span> <span class="vs">`my-module/</span><span class="sc">${</span><span class="va">pkg</span>.<span class="at">version</span><span class="sc">}</span><span class="vs"> (https://github.com/username/my-module)`</span></a>
