...
<p><a href="https://travis-ci.org/sindresorhus/execa"><img src="https://travis-ci.org/sindresorhus/execa.svg?branch=master" alt="Build Status" /></a> <a href="https://coveralls.io/github/sindresorhus/execa?branch=master"><img src="https://coveralls.io/repos/github/sindresorhus/execa/badge.svg?branch=master" alt="Coverage Status" /></a></p>
<blockquote>
...
<a class="sourceLine" id="cb4-12" title="12"><span class="co">            errno: &#39;ENOENT&#39;,</span></a>
...
<a class="sourceLine" id="cb4-18" title="18"><span class="co">            command: &#39;unknown command&#39;,</span></a>
<a class="sourceLine" id="cb4-19" title="19"><span class="co">            stdout: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb4-20" title="20"><span class="co">            stderr: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb4-21" title="21"><span class="co">            all: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb4-22" title="22"><span class="co">            failed: true,</span></a>
<a class="sourceLine" id="cb4-23" title="23"><span class="co">            timedOut: false,</span></a>
<a class="sourceLine" id="cb4-24" title="24"><span class="co">            isCanceled: false,</span></a>
<a class="sourceLine" id="cb4-25" title="25"><span class="co">            killed: false</span></a>
...
<a class="sourceLine" id="cb6-8" title="8"><span class="co">        errno: &#39;ENOENT&#39;,</span></a>
...
<a class="sourceLine" id="cb6-14" title="14"><span class="co">        command: &#39;unknown command&#39;,</span></a>
<a class="sourceLine" id="cb6-15" title="15"><span class="co">        stdout: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb6-16" title="16"><span class="co">        stderr: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb6-17" title="17"><span class="co">        all: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb6-18" title="18"><span class="co">        failed: true,</span></a>
<a class="sourceLine" id="cb6-19" title="19"><span class="co">        timedOut: false,</span></a>
<a class="sourceLine" id="cb6-20" title="20"><span class="co">        isCanceled: false,</span></a>
<a class="sourceLine" id="cb6-21" title="21"><span class="co">        killed: false</span></a>
...
<h2 id="api">API</h2>
<h3 id="execafile-arguments-options">execa(file, arguments, <a href="#options">options</a>)</h3>
...
<h4 id="killsignal-options">kill(<a href="#signal">signal</a>, <a href="#options">options</a>)</h4>
...
<h3 id="execa.syncfile-arguments-options">execa.sync(file, [arguments], <a href="#options">options</a>)</h3>
<p>Execute a file synchronously.</p>
<p>Returns or throws a <a href="#childProcessResult"><code>childProcessResult</code></a>.</p>
<h3 id="execa.commandcommand-options">execa.command(command, <a href="#options">options</a>)</h3>
...
<h3 id="execa.commandsynccommand-options">execa.commandSync(command, <a href="#options">options</a>)</h3>
<p>Same as <a href="#execacommand-command-options"><code>execa.command()</code></a> but synchronous.</p>
<p>Returns or throws a <a href="#childProcessResult"><code>childProcessResult</code></a>.</p>
<h3 id="execa.nodescriptpath-arguments-options">execa.node(scriptPath, [arguments], <a href="#options">options</a>)</h3>
...
<p>The child process <a href="#failed">fails</a> when: - its <a href="#exitcode">exit code</a> is not <code>0</code> - it was <a href="#killed">killed</a> with a <a href="#signal">signal</a> - <a href="#timedout">timing out</a> - <a href="#iscanceled">being canceled</a> - there’s not enough memory or there are already too many child processes</p>
...
<p>Type: <code>string | undefined</code></p>
<p>Original error message. This is <code>undefined</code> unless the child process exited due to an <code>error</code> event or a timeout.</p>
<p>The <code>message</code> property contains both the <code>originalMessage</code> and some additional information added by Execa.</p>
...
<p>Type: <code>string</code><br> Default: <code>process.execPath</code> (current Node.js executable)</p>
...
<p>Write some input to the <code>stdin</code> of your binary.<br> Streams are not allowed when using the synchronous methods.</p>
<h4 id="stdin">stdin</h4>
<p>Type: <code>string | number | Stream | undefined</code><br> Default: <code>pipe</code></p>
...
<p>Type: <code>string | string[]</code><br> Default: <code>pipe</code></p>
...
<p>Type: <code>boolean | string</code><br> Default: <code>false</code></p>
...
<p>Type: <code>string | null</code><br> Default: <code>utf8</code></p>
...
<p>Type: <code>string</code><br> Default: <a href="https://nodejs.org/api/process.html#process_process_execpath"><code>process.execPath</code></a></p>
