...
<a class="sourceLine" id="cb2-4" title="4">    <span class="va">console</span>.<span class="at">log</span>(<span class="cf">await</span> <span class="at">readPkg</span>())<span class="op">;</span></a>
<a class="sourceLine" id="cb2-5" title="5">    <span class="co">//=&gt; {name: &#39;read-pkg&#39;, …}</span></a>
<a class="sourceLine" id="cb2-6" title="6"></a>
<a class="sourceLine" id="cb2-7" title="7">    <span class="va">console</span>.<span class="at">log</span>(<span class="cf">await</span> <span class="at">readPkg</span>(<span class="op">{</span><span class="dt">cwd</span><span class="op">:</span> <span class="st">&#39;some-other-directory&#39;</span><span class="op">}</span>))<span class="op">;</span></a>
<a class="sourceLine" id="cb2-8" title="8">    <span class="co">//=&gt; {name: &#39;unicorn&#39;, …}</span></a>
<a class="sourceLine" id="cb2-9" title="9"><span class="op">}</span>)()<span class="op">;</span></a></code></pre></div>
<h2 id="api">API</h2>
<h3 id="readpkgoptions">readPkg(options?)</h3>
<p>Returns a <code>Promise&lt;object&gt;</code> with the parsed JSON.</p>
<h3 id="readpkg.syncoptions">readPkg.sync(options?)</h3>
