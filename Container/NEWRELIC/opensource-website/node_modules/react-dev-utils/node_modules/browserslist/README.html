...
<a class="sourceLine" id="cb1-4" title="4">    <span class="st">&quot;not IE_Mob 11&quot;</span><span class="ot">,</span></a>
<a class="sourceLine" id="cb1-5" title="5">    <span class="st">&quot;maintained node versions&quot;</span></a>
<a class="sourceLine" id="cb1-6" title="6">  <span class="ot">]</span></a></code></pre></div>
...
<a class="sourceLine" id="cb2-5" title="5">not IE_Mob 11</a>
<a class="sourceLine" id="cb2-6" title="6">maintained node versions</a></code></pre></div>
...
<p>If you don’t accept Browserslist queries from users, you can disable the validation by using the or <code>BROWSERSLIST_DANGEROUS_EXTEND</code> environment variable or <code>dangerousExtend</code> option.</p>
