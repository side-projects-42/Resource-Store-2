...
<div class="sourceCode" id="cb1"><pre class="sourceCode sh"><code class="sourceCode bash"><a class="sourceLine" id="cb1-1" title="1">$ <span class="ex">yarn</span> add pretty-format</a></code></pre></div>
<h2 id="usage">Usage</h2>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">const</span> prettyFormat <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;pretty-format&#39;</span>)<span class="op">;</span> <span class="co">// CommonJS</span></a></code></pre></div>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="im">import</span> prettyFormat <span class="im">from</span> <span class="st">&#39;pretty-format&#39;</span><span class="op">;</span> <span class="co">// ES2015 modules</span></a></code></pre></div>
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">const</span> val <span class="op">=</span> <span class="op">{</span><span class="dt">object</span><span class="op">:</span> <span class="op">{}};</span></a>
...
<a class="sourceLine" id="cb4-22" title="22"><span class="co">*/</span></a></code></pre></div>
<h2 id="usage-with-options">Usage with options</h2>
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">onClick</span>() <span class="op">{}</span></a>
...
<a class="sourceLine" id="cb5-14" title="14"><span class="co">*/</span></a></code></pre></div>
<!-- prettier-ignore -->
<table>
<colgroup>
<col style="width: 20%" />
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="kw">const</span> DEFAULT_THEME <span class="op">=</span> <span class="op">{</span></a>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="co">// CommonJS</span></a>
<a class="sourceLine" id="cb7-2" title="2"><span class="kw">const</span> React <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;react&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-3" title="3"><span class="kw">const</span> renderer <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;react-test-renderer&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-4" title="4"><span class="kw">const</span> prettyFormat <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;pretty-format&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb7-5" title="5"><span class="kw">const</span> ReactElement <span class="op">=</span> <span class="va">prettyFormat</span>.<span class="va">plugins</span>.<span class="at">ReactElement</span><span class="op">;</span></a>
<a class="sourceLine" id="cb7-6" title="6"><span class="kw">const</span> ReactTestComponent <span class="op">=</span> <span class="va">prettyFormat</span>.<span class="va">plugins</span>.<span class="at">ReactTestComponent</span><span class="op">;</span></a></code></pre></div>
...
<a class="sourceLine" id="cb8-2" title="2"><span class="im">import</span> renderer <span class="im">from</span> <span class="st">&#39;react-test-renderer&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb8-3" title="3"><span class="co">// ES2015 modules and destructuring assignment</span></a>
<a class="sourceLine" id="cb8-4" title="4"><span class="im">import</span> prettyFormat <span class="im">from</span> <span class="st">&#39;pretty-format&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb8-5" title="5"><span class="kw">const</span> <span class="op">{</span>ReactElement<span class="op">,</span> ReactTestComponent<span class="op">}</span> <span class="op">=</span> <span class="va">prettyFormat</span>.<span class="at">plugins</span><span class="op">;</span></a></code></pre></div>
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="kw">const</span> onClick <span class="op">=</span> () <span class="kw">=&gt;</span> <span class="op">{};</span></a>
...
<a class="sourceLine" id="cb9-18" title="18"><span class="co">*/</span></a></code></pre></div>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="im">import</span> serializer <span class="im">from</span> <span class="st">&#39;my-serializer-module&#39;</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb10-4" title="4"><span class="co">// tests which have `expect(value).toMatchSnapshot()` assertions</span></a></code></pre></div>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="kw">const</span> elementSymbol <span class="op">=</span> <span class="va">Symbol</span>.<span class="at">for</span>(<span class="st">&#39;react.element&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb12-2" title="2"><span class="kw">const</span> test <span class="op">=</span> val <span class="kw">=&gt;</span> val <span class="op">&amp;&amp;</span> <span class="va">val</span>.<span class="at">$$typeof</span> <span class="op">===</span> elementSymbol<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1"><span class="co">// We reused more code when we factored out a function for child items</span></a>
...
<a class="sourceLine" id="cb13-37" title="37"><span class="op">};</span></a></code></pre></div>
<div class="sourceCode" id="cb14"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb14-1" title="1"><span class="kw">const</span> val <span class="op">=</span> <span class="op">{</span></a>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb15-1" title="1"><span class="va">console</span>.<span class="at">log</span>(</a>
...
<a class="sourceLine" id="cb15-20" title="20"><span class="co">*/</span></a></code></pre></div>
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb16-1" title="1"><span class="va">console</span>.<span class="at">log</span>(</a>
...
<a class="sourceLine" id="cb16-21" title="21"><span class="co">*/</span></a></code></pre></div>
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb17-1" title="1"><span class="va">console</span>.<span class="at">log</span>(</a>
...
<a class="sourceLine" id="cb17-12" title="12"><span class="co">*/</span></a></code></pre></div>
<div class="sourceCode" id="cb18"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb18-1" title="1"><span class="va">console</span>.<span class="at">log</span>(</a>
...
<div class="sourceCode" id="cb19"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb19-1" title="1"><span class="kw">const</span> plugin <span class="op">=</span> <span class="op">{</span></a>
...
<div class="sourceCode" id="cb20"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb20-1" title="1"><span class="kw">const</span> val <span class="op">=</span> <span class="op">{</span></a>
...
<a class="sourceLine" id="cb20-22" title="22"><span class="co">*/</span></a></code></pre></div>
...
<div class="sourceCode" id="cb21"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb21-1" title="1"><span class="at">prettyFormat</span>(val<span class="op">,</span> <span class="op">{</span></a>
...
<a class="sourceLine" id="cb21-20" title="20"><span class="co">*/</span></a></code></pre></div>
</body>
</html>
