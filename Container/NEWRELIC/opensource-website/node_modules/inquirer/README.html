...
<a class="sourceLine" id="cb2-10" title="10">    <span class="cf">if</span>(<span class="va">error</span>.<span class="at">isTtyError</span>) <span class="op">{</span></a>
<a class="sourceLine" id="cb2-11" title="11">      <span class="co">// Prompt couldn&#39;t be rendered in the current environment</span></a>
<a class="sourceLine" id="cb2-12" title="12">    <span class="op">}</span> <span class="cf">else</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb2-13" title="13">      <span class="co">// Something else when wrong</span></a>
...
<p>Take <code>type</code>, <code>name</code>, <code>message</code>, <code>choices</code>[, <code>default</code>, <code>filter</code>, <code>loop</code>] properties. (Note that default must be the choice <code>index</code> in the array or a choice <code>value</code>)</p>
<figure>
...
<p>Take <code>type</code>, <code>name</code>, <code>message</code>, <code>choices</code>[, <code>default</code>, <code>filter</code>, <code>loop</code>] properties. (Note that default must be the choice <code>index</code> in the array)</p>
<figure>
...
<h3 id="use-in-non-interactive-environments">Use in Non-Interactive Environments</h3>
...
<li><strong>Windows (<a href="#issues">Known issues</a>)</strong>:
<ul>
...
<p><a name="issues"></a></p>
<p>Running Inquirer together with network streams in Windows platform inside some terminals can result in process hang. Workaround: run inside another terminal. Please refer to the https://github.com/nodejs/node/issues/21771</p>
...
<p><a href="https://github.com/robin-rpr/inquirer-search-list"><strong>inquirer-search-list</strong></a><br> Searchable Inquirer list<br> <br> <img src="https://github.com/robin-rpr/inquirer-search-list/blob/master/preview.gif" alt="inquirer-search-list" /></p>
