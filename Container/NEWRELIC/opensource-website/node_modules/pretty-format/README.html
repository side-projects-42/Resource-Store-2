...
<a class="sourceLine" id="cb7-7" title="7"><span class="kw">const</span> renderer <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;react-test-renderer&#39;</span>)<span class="op">;</span></a></code></pre></div>
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="co">// ES2015 modules and destructuring assignment</span></a>
...
<a class="sourceLine" id="cb8-6" title="6"><span class="im">import</span> renderer <span class="im">from</span> <span class="st">&#39;react-test-renderer&#39;</span><span class="op">;</span></a></code></pre></div>
