...
- [2952](http://wg21.link/lwg2952) `iterator_traits` should work for pointers to _cv_ `T`
...
- [2977](http://wg21.link/lwg2977) `unordered_`_meow_`::merge()` has incorrect **Throws:** clause
