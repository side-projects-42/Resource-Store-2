...
CWG motion 6: [P0134R0 "Introducing a name for _brace-or-equal-initializers_ for non-static data members"](http://wg21.link/p0134r0)
...
- Note: [2181](http://wg21.link/lwg2181) resolution from P0165R0 was _not_ applied by this motion
