...
(function () {
  ...
  QuerypointPanel.FileViewModel = function (
    querypointViewModel,
    editorViewModel
  ) {
    // public:
  ...
  QuerypointPanel.FileViewModel.openResourceView = function (resource) {
    ...
    var fileViewModel = new QuerypointPanel.FileViewModel(
      null,
      editorViewModel
    );
  ...
  QuerypointPanel.FileViewModel.openSourceFileView = function (sourceFile) {
    ...
    var querypointViewModel = new QuerypointPanel.QuerypointViewModel(
      this._panel,
      sourceFile,
      editorViewModel
    );
