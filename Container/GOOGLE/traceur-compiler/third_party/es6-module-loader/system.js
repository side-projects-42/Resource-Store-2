...
(function (global) {
  (function () {
    ...
    var Loader =
      (global.Reflect && global.Reflect.Loader) || require("./loader");
    ...
    var System = new Loader({
      ...
      normalize: function (name, parentName, parentAddress) {
        ...
        normalizedParts = normalizedParts.concat(
          parentParts.splice(0, parentParts.length - 1 - dotdots)
        );
        normalizedParts = normalizedParts.concat(
      ...
      locate: function (load) {
        ...
        for (var p in this.paths) {
          ...
          if (pathParts.length == 1) {
            if (name == p && p.length > pathMatch.length) pathMatch = p;
          }
        ...
        if (wildcard) outPath = outPath.replace("*", wildcard);
      ...
      fetch: function (load) {
        return new Promise(function (resolve, reject) {
          fetchTextFromURL(
            toAbsoluteURL(this.baseURL, load.address),
            function (source) {
              resolve(source);
            },
            reject
    ...
    System.parse = function (load) {
      if (!traceur) {
        if (typeof window == "undefined") traceur = require("traceur");
        else if (global.traceur) traceur = global.traceur;
        else throw new TypeError("Include Traceur for module syntax support");
      }
      ...
      (function () {
        try {
          ...
          if (e.name == "SyntaxError" || e.name == "TypeError")
            e.message =
              "Evaluating " + (load.name || load.address) + "\n\t" + e.message;
          throw e;
        }
      })();
      return depsList;
