...
suite("instantiate", function () {
  ...
  test("Circular dependencies", function (done) {
    System.import("./circular1.js")
      .then(function (m1) {
        System.import("./circular2.js")
          .then(function (m2) {
  ...
  test("Circular annotations", function (done) {
    ...
    System.import("./circular_annotation1.js")
      .then(function (m1) {
        System.import("./circular_annotation2.js")
          .then(function (m2) {
            assert.instanceOf(
              m1.BarAnnotation.annotations[0],
              m2.FooAnnotation
            );
            assert.instanceOf(
              m2.FooAnnotation.annotations[0],
              m1.BarAnnotation
            );
            done();
          })
    ...
    System.import("./circular_annotation1.js")
      .then(function (m1) {
        System.import("./circular_annotation2.js")
          .then(function (m2) {
            assert.instanceOf(
              m1.BarAnnotation.parameters[0][0],
              m2.FooAnnotation
            );
            assert.instanceOf(
              m2.FooAnnotation.parameters[0][0],
              m1.BarAnnotation
            );
            done();
          })
  ...
  test("Re-export bindings", function (done) {
    System.import("./reexport-binding.js")
      .then(function (m) {
        System.import("./rebinding.js")
          .then(function (m) {
            assert.equal(m.p, 4);
            done();
          })
  ...
  test("Export Reassignments", function (done) {
    System.import("./export-reassignment.js")
      .then(function (m) {
        assert.equal(m.a, -6);
        assert.equal(m.b, 6);
  ...
  test("Postfix Operator", function (done) {
    System.import("./postfix-operator.js")
      .then(function (m) {
        assert.equal(m.a, 5);
        assert.equal(m.b, 5);
        assert.equal(m.c, 6);
  ...
  test("Module import", function (done) {
    System.import("./module-import.js")
      .then(function (m) {
  ...
  test("Export default function parsing", function (done) {
    System.import("./export-default-fn.js")
      .then(function (m) {
  ...
  test("Export default class", function (done) {
    System.import("./export-default-class.js")
      .then(function (m) {
        var f = new m.default();
  ...
  test("Export star as", function (done) {
    System.import("./export-star-as.js")
      .then(function (m) {
  ...
  test("Export name from", function (done) {
    ...
    traceurOptions.validate = true;
    System.import("./export-forward-default.js")
      .then(function (m) {
        assert.equal(42, m.a);
        done();
      })
  ...
  test("Export destructuring", function (done) {
    System.import("./export-destructuring.js")
      .then(function (m) {
        assert.equal(1, m.x);
        assert.equal(2, m.y);
        m.f();
