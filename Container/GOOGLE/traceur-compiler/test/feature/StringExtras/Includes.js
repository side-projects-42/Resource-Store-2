...
assert.throw(function () {
  String.prototype.includes.call(undefined, "b");
}, TypeError);
assert.throw(function () {
  String.prototype.includes.call(undefined, "b", 4);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.call(null);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.call(null, "b");
}, TypeError);
assert.throw(function () {
...
assert.throw(function () {
  String.prototype.includes.apply(undefined);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.apply(undefined, ["b"]);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.apply(undefined, ["b", 4]);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.apply(null);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.apply(null, ["b"]);
}, TypeError);
assert.throw(function () {
  String.prototype.includes.apply(null, ["b", 4]);
}, TypeError);
