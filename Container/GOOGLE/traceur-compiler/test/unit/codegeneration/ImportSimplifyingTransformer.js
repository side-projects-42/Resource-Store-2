...
suite("ImportSimplifyingTransformer.js", function () {
  ...
  testNormalize("import empty", 'import "mod";', 'import {} from "mod";');
  testNormalize(
    "import pair",
  ...
  testNormalize(
    "import pair with name space",
    'import a, * as b from "mod";',
    'import {default as a} from "mod";' + 'import * as b from "mod";'
  );
});
