...
suite("ExplodeExpressionTransformer.js", function () {
  ...
  testExplode(
    "MemberLookupExpression + MemberExpression",
    "a.b[c.d]",
    "$0 = a.b, $1 = c.d, $2 = $0[$1], $2"
  );
  ...
  testExplode(
    "PostfixMemberExpression",
    "a.b.c--",
    "$0 = a.b, $1 = $0.c, $0.c = $1 - 1, $1"
  );

  testExplode(
    "PostfixMemberLookupExpression",
    "a.b[c.d]++",
  ...
  testExplode("ArrayLiteral", "[...a.b]", "$0 = a.b, $1 = [...$0], $1");
  testExplode(
    "ArrayLiteral",
    "[...a.b.c]",
    "$0 = a.b, $1 = $0.c, $2 = [...$1], $2"
  ...
  testExplode("ArrayLiteral", "[a.b, ...x]", "$0 = a.b, $1 = [$0, ...x], $1");
