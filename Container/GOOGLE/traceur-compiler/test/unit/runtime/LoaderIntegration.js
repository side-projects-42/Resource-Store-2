...
suite("Loader.js", function () {
  ...
  test("Loader.Script.Named", function (done) {
    ...
    loader
      .script(src, { name: name, metadata: metadata })
      .then(function (result) {
  ...
  test("Loader.Script.Fail", function (done) {
    ...
    getTestLoader(reporter)
      .script("export var x = 5;", {})
      .then(
        function (result) {
  ...
  test("LoaderLoad", function (done) {
    getTestLoader()
      .loadAsScript("./test/unit/runtime/resources/test_script.js", {})
      .then(function (result) {
  ...
  test("LoaderLoad.Fail", function (done) {
    var reporter = new MutedErrorReporter();
    getTestLoader(reporter)
      .loadAsScript("./test/unit/runtime/resources/non_existing.js", {})
      .then(
        function (result) {
          assert.fail("should not have succeeded");
          done();
  ...
  test("LoaderImport", function (done) {
    getTestLoader()
      .import("./test/unit/runtime/resources/test_module.js", {})
      .then(function (mod) {
  ...
  test("LoaderImport.Fail", function (done) {
    var reporter = new MutedErrorReporter();
    getTestLoader(reporter)
      .import("./test/unit/runtime/resources/non_existing.js", {})
      .then(
        function (mod) {
          assert.fail("should not have succeeded");
          done();
  ...
  test("LoaderImport.Fail.deperror", function (done) {
    ...
    getTestLoader(reporter)
      .import("test/unit/runtime/loads/main.js", { metadata: metadata })
      .then(
        function (mod) {
          assert.fail("should not have succeeded");
          done();
        ...
        function (error) {
          assert(
            (error + "").indexOf("ModuleEvaluationError: dep error in") !== -1
          );
          assert(
            (error.stack + "").indexOf("eval at <anonymous>") === -1,
  ...
  test("Loader.define", function (done) {
    ...
    global.testGlobal = {};
    getTestLoader()
      .import("./test/unit/runtime/resources/side-effect.js", {})
      .then(function (mod) {
        assert.equal(6, mod.currentSideEffect()); // starting value.
        var src =
          "export {name as a} from './test/unit/runtime/resources/test_a.js';\n" +
          "export var d = 4;\n" +
          "testGlobal.sideEffect++;";
        return getTestLoader()
          .define(name, src, {})
          .then(function () {
            return mod;
          });
  ...
  test("Loader.defineWithSourceMap", function (done) {
    var normalizedName = ModuleStore.normalize(
      "./test_define_with_source_map.js"
    );
    var loader = getTestLoader();
    var metadata = { traceurOptions: { sourceMaps: true } };
    var src =
      "export {name as a} from './test/unit/runtime/resources/test_a.js';\nexport var d = 4;\n";
    loader
      .define(normalizedName, src, { metadata: metadata })
      .then(function () {
        var sourceMap = loader.getSourceMap(normalizedName);
