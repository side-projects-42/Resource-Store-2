...
suite("System.js", function () {
  ...
  test("System.normalize", function () {
    ...
    assert.equal(
      System.normalize("../src/Options.js", "traceur@/b/node"),
      "traceur@/src/Options.js"
    );
    // not relative
  ...
  test("System.set", function () {
    ...
    var polyfills = store.get(
      "traceur@" + System.version + "/src/runtime/polyfills/polyfills.js"
    );
  ...
  test("traceur@", function () {
    var optionsModule = System.get(
      "traceur@" + System.version + "/src/Options.js"
    );
  ...
  test("System.hookAPI", function (done) {
    ...
    var load = {
      metadata: {},
      normalizedName: System.normalize(
    ...
    assert(
      /test\/unit\/runtime\/resources\/test_module.js$/.test(url),
    ...
    System.fetch(load)
      ...
      .then(System.translate.bind(System))
      .then(function (source) {
        assert.equal(source, load.source);
        return load;
      })
      .then(System.instantiate.bind(System))
      .then(function (nada) {
