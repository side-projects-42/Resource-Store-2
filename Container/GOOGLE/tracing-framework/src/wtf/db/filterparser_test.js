...
wtf.db.FilterParser_test = suite("wtf.db.FilterParser", function () {
  ...
  test("substringTypeQuery", function () {
    assert.deepEqual(wtf.db.FilterParser.parse("abc123_456"), {
      type_query: {
        type: "substring",
        value: "abc123_456",
      },
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("abc123_456(foo<5)"), {
      type_query: {
        type: "substring",
        value: "abc123_456",
      },
  ...
  test("regexTypeQuery", function () {
    assert.deepEqual(wtf.db.FilterParser.parse("/abc[5](2)/"), {
      type_query: {
        type: "regex",
        value: "abc[5](2)",
        flags: "",
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("/abc/gi"), {
      type_query: {
        type: "regex",
        value: "abc",
        flags: "gi",
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("/abc/gi(foo<5)"), {
      type_query: {
        type: "regex",
        value: "abc",
        flags: "gi",
  ...
  test("argumentReferences", function () {
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<5)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
        rhs: { type: "number", value: 5 },
  ...
  test("numericArguments", function () {
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<0x125)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<43.233)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
  ...
  test("stringArguments", function () {
    assert.deepEqual(wtf.db.FilterParser.parse('a(foo<"")').arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
  ...
  test("regexArguments", function () {
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo !~ /blah/)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "!~",
  ...
  test("literalArguments", function () {
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<true)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<null)").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
  ...
  test("arrayArguments", function () {
    ...
    assert.deepEqual(wtf.db.FilterParser.parse("a(foo<[1,2])").arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
  ...
  test("objectArguments", function () {
    ...
    assert.deepEqual(wtf.db.FilterParser.parse('a(foo<{"a": 5})').arg_query, [
      {
        lhs: { type: "reference", value: "foo" },
        op: "<",
