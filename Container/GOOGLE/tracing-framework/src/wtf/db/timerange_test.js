...
wtf.db.TimeRangeList_test = suite("wtf.db.TimeRangeList", function () {
  ...
  test("rebuildEvents", function () {
    ...
    assert.deepEqual(timeRangeList.getAllTimeRanges(), [
      timeRange100,
      timeRange200,
    ]);
  });
  ...
  test("timeRanges", function () {
    ...
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(10), [
      timeRangeRoot,
      timeRange100,
    ]);
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(30), [
      timeRangeRoot,
      timeRange100,
    ]);
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(31), [timeRangeRoot]);
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(60), [
      timeRangeRoot,
      timeRange200,
    ]);
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(70), [
      timeRangeRoot,
      timeRange200,
    ]);
    assert.deepEqual(timeRangeList.getTimeRangesAtTime(80), [
      timeRangeRoot,
      timeRange200,
    ]);
