...
wtf.db.HealthInfo.prototype.analyzeStatistics_ = function (db, table) {
  ...
  if (counts.instanceCount / counts.totalCount > 0.3) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.genericEnterScope / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.genericTimeStamp / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.appendScopeData / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.anyArguments / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.stringArguments / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
  ...
  if (counts.avg5us / counts.totalCount > 0.1) {
    warnings.push(
      new wtf.db.HealthWarning(
        "Too many \u22645\u00B5s scopes.",
        "Very short scopes are not representative of their actual time and " +
...
goog.exportProperty(
  wtf.db.HealthInfo.prototype,
  "isBad",
  wtf.db.HealthInfo.prototype.isBad
);
goog.exportProperty(
  wtf.db.HealthInfo.prototype,
  "getOverheadPerScopeNs",
...
goog.exportProperty(
  wtf.db.HealthWarning.prototype,
  "getTitle",
