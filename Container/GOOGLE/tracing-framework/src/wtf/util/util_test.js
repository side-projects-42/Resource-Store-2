...
wtf.util_test = suite("wtf.util", function () {
  test("#getCompiledMemberName", function () {
    ...
    assert.equal(
      wtf.util.getCompiledMemberName(simpleObject, simpleObject["a"]),
      "a"
    );
    assert.equal(
      wtf.util.getCompiledMemberName(simpleObject, simpleObject["b"]),
      "b"
    );
    assert.equal(
      wtf.util.getCompiledMemberName(simpleObject, simpleObject["c"]),
      "c"
    );
    assert.isNull(wtf.util.getCompiledMemberName(simpleObject, "not_found"));
