...
goog.exportSymbol("wtf.addon.registerAddon", wtf.addon.registerAddon);
goog.exportSymbol("wtf.addon.getTraceAddons", wtf.addon.getTraceAddons);
goog.exportSymbol("wtf.addon.getAppAddons", wtf.addon.getAppAddons);
