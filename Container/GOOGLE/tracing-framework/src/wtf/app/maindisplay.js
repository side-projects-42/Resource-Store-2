 ...
 */
wtf.app.MainDisplay = function (platform, options, opt_parentElement, opt_dom) {
  ...
  this.commandManager_.registerSimpleCommand(
    "open_local_trace",
    this.requestLocalTraceLoad,
    this
  );
  this.commandManager_.registerSimpleCommand(
    "open_drive_trace",
    this.requestDriveTraceLoad,
    this
  );
  this.commandManager_.registerSimpleCommand(
    "show_settings",
...
wtf.app.MainDisplay.prototype.createDom = function (dom) {
  return /** @type {!Element} */ (
    goog.soy.renderAsFragment(wtf.app.maindisplay.control, {}, undefined, dom)
  );
};
  ...
  eh.listen(
    ...
    function (e) {
      ...
      if (
        ...
        browserEvent.dataTransfer.files &&
 ...
 *     being shown.
 */
wtf.app.MainDisplay.prototype.setDocumentView = function (
  documentView,
  opt_preventSplash
) {
...
wtf.app.MainDisplay.prototype.toggleHelpDialog_ = function () {
  ...
  goog.asserts.assert(body);
  this.activeDialog_ = new wtf.app.HelpDialog(body, this.getDom());
  this.activeDialog_.addListener(
    wtf.ui.Dialog.EventType.CLOSED,
    function () {
      this.activeDialog_ = null;
    },
    this
...
wtf.app.MainDisplay.prototype.showSplashDialog_ = function (visible) {
  ...
  var body = this.getDom().getDocument().body;
  goog.asserts.assert(body);
  this.activeDialog_ = new wtf.app.SplashDialog(body, this.getDom());
  this.activeDialog_.addListener(
    wtf.ui.Dialog.EventType.CLOSED,
    function () {
      this.activeDialog_ = null;
