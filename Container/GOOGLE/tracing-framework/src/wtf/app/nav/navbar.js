...
wtf.app.nav.Navbar = function (documentView, parentElement) {
  ...
  var heatmapPainter = new wtf.app.nav.HeatmapPainter(this.navbarCanvas_, db);
 ...
 * @private
 */
wtf.app.nav.Navbar.MIN_GRANULARITY_ = 100 * wtf.app.Granularity.SECOND;
 ...
 * @private
 */
wtf.app.nav.Navbar.MAX_GRANULARITY_ = 0.001;
