...
wtf.replay.graphics.ui.EventNavigatorToolbar = function (
   ...
   * @private
   */
  this.optionsButton_ = this.getChildElement(goog.getCssName("optionsButton"));
  ...
  menu.addChild(new goog.ui.MenuItem("TODO", "some_token", dom), true);
  menu.render();
...
wtf.replay.graphics.ui.EventNavigatorToolbar.prototype.setReady = function () {
  ...
  var overdrawVisualizer =
    /** @type {wtf.replay.graphics.OverdrawVisualizer} */
 ...
 * @private
 */
wtf.replay.graphics.ui.EventNavigatorToolbar.prototype.setEnabled_ = function (
  enabled
) {
 ...
 * @private
 */
wtf.replay.graphics.ui.EventNavigatorToolbar.prototype.previousDrawCallHandler_ =
  function () {
    if (!this.enabled_) {
      return;
    }
