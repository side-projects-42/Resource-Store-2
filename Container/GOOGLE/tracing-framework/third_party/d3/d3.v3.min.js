(function () {
  ...
  function O(t) {
    ...
    n[0] * e[1] < e[0] * n[1] &&
      ((n[0] *= -1), (n[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(n[1], n[0]) : Math.atan2(-e[0], e[1])) * Oi),
  ...
  function Q(t, n, e) {
    ...
    var r = gn((0.4124564 * t + 0.3575761 * n + 0.1804375 * e) / sa),
      u = gn((0.2126729 * t + 0.7151522 * n + 0.072175 * e) / fa),
      i = gn((0.0193339 * t + 0.119192 * n + 0.9503041 * e) / ha);
  ...
  function fn(t, n, e) {
    ...
    return (
      ...
      (i = dn(i) * ha),
      $(
        pn(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        pn(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        pn(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function hn(t, n, e) {
  ...
  function ee(t, n) {
    ...
    return (
      ...
      (e.rangePoints = function (u, i) {
        ...
        return (
          (a = r(2 > t.length ? (c + l) / 2 : c + (s * i) / 2, s)),
          (o = 0),
  ...
  function fe(t) {
    ...
    return (
      ...
      (n.interpolate = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? (i = t) : (i = Oa.get(t) || ge).key),
            n)
          : a;
      }),
      ...
      if (
        ...
        for (
          ...
          if (1 == g)
            for (
              c = r._pack_prev;
              c !== o._pack_prev && !br(c, i);
              c = c._pack_prev, m++
            );
          g
            ? (m > p || (p == m && u.r < r.r) ? Mr(r, (u = o)) : Mr((r = c), u),
              a--)
            : (yr(r, i), (u = i), n(i));
        }
      var v = (s + f) / 2,
  ...
  function Ir(t, n) {
    ...
    return (
      ...
      (e.parseRows = function (t, n) {
        ...
        for (
          var r, u, i = {}, a = {}, c = [], l = t.length, s = 0, f = 0;
          (r = e()) !== a;
    ...
    function e(n, u, i, a, o, c, l, s, f, h, d, g, p, m) {
      ...
      if (M > 4 * r && p--) {
        ...
        ((C * C) / M > r || Math.abs((v * T + y * q) / M - 0.5) > 0.3) &&
          (e(n, u, i, a, o, c, A, N, k, (b /= w), (x /= w), _, p, m),
          m.point(A, N),
  ...
  function du(t, n) {
    return (
      (0 > (t = t.point)[0] ? t[1] - Ri / 2 - Pi : Ri / 2 - t[1]) -
      (0 > (n = n.point)[0] ? n[1] - Ri / 2 - Pi : Ri / 2 - n[1])
    );
  }
  function gu(t) {
    return t.length > 1;
  ...
  function mu(t, n) {
    ...
    for (
      ...
      (o = t[i]),
        ...
        (u = 1 - n * Math.cos(c) * s),
        (Pi > Math.abs(h - 2) && Pi > Math.abs(u - 2)) ||
          (Pi > Math.abs(u) ||
            Pi > Math.abs(h) ||
            (Pi > Math.abs(Math.abs(r - f) - Ri)
              ? u + h > 2 && (a += 4 * (r - f))
              : (a +=
                  Pi > Math.abs(h - 2)
                    ? 4 * (r - d)
                    : (((3 * Ri + r - f) % (2 * Ri)) - Ri) * (h + u))),
          (d = f),
          (f = r),
          (h = u));
    return a;
  ...
  function ku(t, n, e, r) {
    function u(t) {
      ...
      return [
        Math.atan2(u, r) / ji,
        Math.atan2(i, Math.sqrt(r * r + u * u)) / ji,
      ];
    }
    var i = Math.cos(n),
      a = Math.sin(n),
  ...
  function Eu(t, n) {
    return [
      ...
      Math.max(
        -0.5,
        Math.min(0.5, Math.log(Math.tan(Ri / 4 + n / 2)) / (2 * Ri))
      ),
    ];
  }
  function Au(t) {
  ...
  function Hu() {
    function t(t, n) {
      if (
        ...
        (n *= ji),
        !(
          Pi > Math.abs(Math.abs(i) - Ri / 2) &&
          Pi > Math.abs(Math.abs(n) - Ri / 2)
        ))
      ) {
        var e = Math.cos(n),
          c = Math.sin(n);
  ...
  function Pu(t) {
    ...
    function e(t) {
      return (
        (t = a.invert((t[0] - o) / s, (c - t[1]) / s)), [t[0] * Oi, t[1] * Oi]
      );
    }
    function r() {
      a = xu((i = Ou(p, m, v)), u);
  ...
  function Iu(t, n) {
    function e(t, n) {
      var e = Math.cos(n),
        ...
        s = l * r + o * u;
      return [
        Math.atan2(c * i - s * a, o * r - l * u),
        Math.asin(Math.max(-1, Math.min(1, s * i + c * a))),
      ];
    }
    var r = Math.cos(t),
      u = Math.sin(t),
    ...
    return (
      (e.invert = function (t, n) {
        var e = Math.cos(n),
          ...
          s = l * i - c * a;
        return [
          Math.atan2(c * i + l * a, o * r + s * u),
          Math.asin(Math.max(-1, Math.min(1, s * r - o * u))),
        ];
      }),
      e
    );
    ...
    for (var a, o, c, l, s, f, h, d, g, p, m, v, y, M = e.list.shift(); ; )
      if (
        ...
        (o = r.leftBound(M)),
          ...
          r.insert(o, f),
          (p = u.intersect(o, f)),
          p && (i.del(o), i.insert(o, p, u.distance(p, M))),
          (o = f),
        ...
        (o = i.extractMin()),
          ...
          u.endPoint(v, _o[y], m),
          (p = u.intersect(l, f)),
          p && (i.del(l), i.insert(l, p, u.distance(p, h))),
          (p = u.intersect(f, s)),
  ...
  (d3.bisectLeft = Zi.left),
    ...
    (d3.nest = function () {
      function t(n, o) {
        ...
        for (
          var c, l, s, f = -1, h = n.length, d = a[o++], g = new i(), p = {};
          h > ++f;
    ...
    (d3.interpolateString = function (t, n) {
      ...
      for (ua.lastIndex = 0, r = 0; (e = ua.exec(n)); ++r)
        e.index && l.push(n.substring(o, (c = e.index))),
          ...
          (o = ua.lastIndex);
      for (
        n.length > o && l.push(n.substring(o)), r = 0, i = s.length;
        (e = ua.exec(t)) && i > r;
        ++r
      )
        if (((a = s[r]), a.x == e[0])) {
        ...
        if (n) {
          ...
          for (r = -1; h > ++r; )
            (u = t[r]),
              (a = e[r]),
              u
                ? ((u.__data__ = a), (g[r] = u), (p[r] = m[r] = null))
                : ((p[r] = kn(a)), (g[r] = m[r] = null));
  ...
  (wa.call = Ma.call),
    ...
    (wa.style = function (t, n, e) {
      ...
      return Ln(this, "style." + t, n, function (n) {
        function u() {
          var r,
            u = getComputedStyle(this, null).getPropertyValue(t);
          return (
            u !== n &&
            ((r = i(u, n)),
            function (n) {
    ...
    (wa.transition = function () {
      for (
        var t, n, e, r, u = this.id, i = ++Sa, a = [], o = 0, c = this.length;
        c > o;
        o++
      ) {
        a.push((t = []));
      ...
      function t(i) {
        i.each(function () {
          ...
          a
            ...
            h.exit().remove(),
            o &&
              ((i = On(o)), s.attr("x", i[0]).attr("width", i[1] - i[0]), e(a)),
            c &&
              ((i = On(c)),
  ...
  (d3.behavior = {}),
    (d3.behavior.drag = function () {
      ...
      function n() {
        ...
        function u() {
          c({ type: "dragend" }),
            h && (R(), d3.event.target === l && d.on("click.drag", i, !0)),
            d
    ...
    (d3.behavior.zoom = function () {
      ...
      function s() {
        ...
        r(
          Math.pow(2, d3.event.shiftKey ? Math.ceil(i) - 1 : Math.floor(i) + 1)
        ),
          u(t, e),
          a(w.of(this, arguments));
      }
  ...
  d3.layout.stack = function () {
    ...
    return (
      ...
      (t.order = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : Wa.get(n) || ur), t)
          : e;
      }),
      (t.offset = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : Qa.get(n) || ir), t)
          : r;
      }),
      (t.x = function (n) {
  ...
  var Wa = d3.map({
      "inside-out": function (t) {
        ...
        for (n = 0; r > n; ++n)
          (e = a[n]),
            c > o ? ((o += i[e]), l.push(e)) : ((c += i[e]), s.push(e));
      ...
      if (d > 0)
        for (i = -1; h > ++i; )
          (o = l[i]),
            o >= s[0] &&
              s[1] >= o &&
              ((a = c[d3.bisect(f, o, 1, d) - 1]), (a.y += g), a.push(t[i]));
      return c;
    }
    var n = !0,
      e = Number,
      ...
      function t(t, u) {
        function i(t, n) {
          ...
          if (r && (a = r.length)) {
            ...
            n
              ? ((u.prelim = n._tree.prelim + e(t, n)), (u.mod = u.prelim - d))
              : (u.prelim = d);
  ...
  ((d3.geo.azimuthalEquidistant = function () {
    ...
    (d3.geo.centroid = function (t) {
      ...
      var n;
      return io && Math.abs((n = Math.sqrt(ao * ao + oo * oo + co * co))) > Pi
        ? [
            Math.atan2(oo, ao) * Oi,
            Math.asin(Math.max(-1, Math.min(1, co / n))) * Oi,
          ]
        : void 0;
    });
  var uo,
    ...
    (d3.geo.graticule = function () {
      ...
      function n() {
        return d3
          ...
          .map(a)
          .concat(d3.range(Math.ceil(i / l) * l, u, l).map(o));
      }
      var e,
        r,
        u,
    ...
    (d3.geo.path = function () {
      ...
      return (
        ...
        (t.projection = function (e) {
          return arguments.length
            ? ((r = (n = e) ? e.stream || Nu(e) : a), t)
            : n;
        }),
        (t.context = function (n) {
          return arguments.length
            ? ((u = null == (e = n) ? new Tu() : new qu(n)), t)
            : e;
        }),
  ...
  ((d3.geo.stereographic = function () {
    ...
    (d3.geom.hull = function (t) {
      ...
      for (n = 0; f > n; ++n)
        n !== p &&
          ((u = t[n][1] - t[p][1]),
          (r = t[n][0] - t[p][0]),
          d.push({ angle: Math.atan2(u, r), index: n }));
      for (
        d.sort(function (t, n) {
    ...
    (d3.geom.polygon = function (t) {
      return (
        ...
        (t.clip = function (n) {
          for (
            var e, r, u, i, a, o, c = -1, l = t.length, s = t[l - 1];
            l > ++c;
            ...
            for (
              ...
              (o = e[r]),
                Zu(o, s, i)
                  ? (Zu(a, s, i) || n.push(Bu(a, o, s, i)), n.push(o))
                  : Zu(a, s, i) && n.push(Bu(a, o, s, i)),
                (a = o);
            s = i;
          }
          return n;
