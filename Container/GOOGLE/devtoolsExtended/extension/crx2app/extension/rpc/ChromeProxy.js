...
define([
  "crx2app/lib/MetaObject",
  "crx2app/rpc/JSONMarshall",
  "crx2app/rpc/chrome",
  "crx2app/rpc/ChromeDebuggerProxy",
  ...
  var ChromeProxy = MetaObject.extend(JSONMarshall, {
    ...
    openDebuggerProxyOnTab: function (tabId, onPreAttach, onPostAttach) {
      ...
      function onAttach() {
        if (this.debug) {
          console.log(
            "ChromeProxy openDebuggerProxy connected, send enable: " + tabId
          );
        }
    ...
    openDebuggerProxy: function (url, debuggerEventHandlers, callback) {
      this.openNewWindow(
        function (win) {
          if (this.debug) {
            console.log(
              "ChromeProxy openDebuggerProxy onCreated callback, trying connect",
              win
            );
          }
          var tabId = win.tabs[0].id;
