...
function KratuSignalDefinitions(kratu) {
  ...
  var createSignalDescriptionBox = function (args) {
    ...
    if (!signalDescriptionBox) {
      ...
      var content =
        ...
        "<h3>What it means</h3>" +
        "<span>" +
        signalInfo.interpretation +
        "</span>" +
        supportLink +
        "<h3>What to do</h3>" +
        "<span>" +
        signalInfo.mitigation +
        "</span>" +
        moreLink;
  ...
  signals.budgetUtilization = {
    ...
    getData: function (account) {
      ...
      if (budget === undefined || spend === undefined || budget === 0) return 0;
      else {
  ...
  signals.percentageOfClicksFromMobile = {
    ...
    getData: function (account) {
      var totalClicks =
        account.totalClicksSearch +
        account.totalClicksDisplay +
        account.totalClicksMobile;
  ...
  signals.percentageOfActiveKeywordsWithPoorQualityScore = {
    ...
    getData: function (account) {
      var totalKWs =
        account.numberOfActivePoorQualityScoreKeywords +
    ...
    getData: function (account) {
      var numAdGroupsWith2OrLessAds =
        account.numberOfAdgroupsWithoneActiveAd +
          account.numberOfAdgroupsWithTwoActiveAds || 0;
      var numAdGroups = account.numberOfActiveAdGroups;
  ...
  signals.percentageOfActiveBroadMatchingKeywords = {
    ...
    getData: function (account) {
      var totalKWs =
        account.numberOfActiveBroadMatchingKeywords +
  ...
  signals.percentageOfActiveNegativeKeywords = {
    ...
    getData: function (account) {
      var totalKWs =
        account.numberOfPositiveActiveKeywords +
  ...
  signals.optedIntoSearchPartners = {
    ...
    getData: function (account) {
      var value =
        account.numberOfCampaignsOptedIntoSearchPartners /
  ...
  var signalDescriptions = {
    ...
    averageQualityScore: {
      name: "Average QS",
      description: "Average QS is the Average Quality Score",
      supportLink: "",
      interpretation:
    ...
    lostImpressionsDueToBidAdRankSearch: {
      name: "Lost IS Bid/AdRank, Search",
      description:
    ...
    lostImpressionsDueToBidAdRankDisplay: {
      name: "Lost IS Bid/AdRank, Display",
      description:
    ...
    siteLinksEnabled: {
      name: "% Sitelinks Extensions Enabled",
      description:
    ...
    averageKeywordPosition: {
      name: "Avg KW Position",
      description: "Avg KW Position is the Average keyword position.",
      supportLink: "",
      interpretation:
