...
2.  Use the conventional key names for associated data (association\_attributes).
...
View [Basic Nested Forms](https://learn.co/lessons/basic-nested-forms) on Learn.co and start learning to code for free.
