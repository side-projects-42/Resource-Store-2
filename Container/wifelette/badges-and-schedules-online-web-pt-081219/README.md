...
You’re hosting a conference and need to print badges for the speakers. Each badge should read: “Hello, my name is **\_**.” Write a `badge_maker` method that, when provided a person’s name, will create and return this message. E.g.:
...
View [Badges and Schedules](https://learn.co/lessons/badges-and-schedules "Badges and Schedules") on Learn.co and start learning to code for free.
