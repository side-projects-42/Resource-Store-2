...
**NOTE**: To test, log in via the *Developer* link (not either OAuth option) with the following credentials:
...
The ‘Notifications’ dropdown will display a count of any in app notifications you haven’t read. Clicking the dropdown will show you a list of these notifications such as ‘Marty Haught has commented on ’. You have a ‘Mark all as read’ and ‘View all notifications’ options as well.
