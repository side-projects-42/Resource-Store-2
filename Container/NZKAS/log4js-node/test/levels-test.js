  ...
  .addBatch({
    values: {
      ...
      INFO: {
        ...
        "should be less than WARN": function (info) {
          ...
          assertThat(info).isNotLessThanOrEqualTo([
            levels.ALL,
            levels.TRACE,
            levels.DEBUG,
          ]);
      ...
      WARN: {
        ...
        "should be less than ERROR": function (warn) {
          assertThat(warn).isLessThanOrEqualTo([
            levels.ERROR,
            levels.FATAL,
            levels.MARK,
            levels.OFF,
      ...
      ERROR: {
        ...
        "should be less than FATAL": function (error) {
          assertThat(error).isLessThanOrEqualTo([
            levels.FATAL,
            levels.MARK,
            levels.OFF,
          ]);
        ...
        "should be greater than WARN": function (error) {
          ...
          assertThat(error).isNotGreaterThanOrEqualTo([
            levels.FATAL,
            levels.MARK,
            levels.OFF,
          ]);
      ...
      FATAL: {
        ...
        "should be greater than ERROR": function (fatal) {
          ...
          assertThat(fatal).isNotGreaterThanOrEqualTo([
            levels.MARK,
            levels.OFF,
          ]);
        },
    ...
    toLevel: {
      "with lowercase argument": {
        ...
        "should take the string and return the corresponding level": function (
          level
        ) {
