    ...
    appenders: {
      "when specified by type": {
        topic: function () {
          ...
          log4js.configure(
            {
              appenders: [{ type: "cheese", flavour: "gouda" }],
            },
            { pants: "yes" }
          );
          return testAppender;
      ...
      "when core appender loaded via loadAppender": {
        ...
        "should add appender configure function to appenderMakers": function (
          log4js
        ) {
      ...
      "when configuration file loaded via LOG4JS_CONFIG environment variable": {
        ...
        "should load the specified local configuration file": function (
          fileRead
        ) {
