...
expectType<NodeJS.ReadableStream>(
	globbyStream(["a.tmp", "*.tmp", "!{c,d,e}.tmp"])
);

expectType<NodeJS.ReadableStream>(
	globbyStream("*.tmp", { expandDirectories: false })
);
expectType<NodeJS.ReadableStream>(
	globbyStream("*.tmp", { expandDirectories: ["a*", "b*"] })
);
expectType<NodeJS.ReadableStream>(
	globbyStream("*.tmp", {
		expandDirectories: {
...
expectType<GlobTask[]>(
	generateGlobTasks("*.tmp", { expandDirectories: false })
);
expectType<GlobTask[]>(
