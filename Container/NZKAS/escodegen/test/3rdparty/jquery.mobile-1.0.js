...
(function ($, window, undefined) {
  ...
  $.each(
    (
      "touchstart touchmove touchend orientationchange throttledresize " +
  ...
  $.event.special.tap = {
    setup: function () {
      ...
      $this.bind("vmousedown", function (event) {
        ...
        $this
          .bind("vmousecancel", clearTapHandlers)
...
--------------------------------------*/
  ...
  getScrollElem = function () {
    ...
    if (touchOverflow) {
      ...
      scrollElem = activePage.is(".ui-native-fixed")
        ? activePage.find(".ui-content")
        : activePage;
    }
  ...
  function transitionPages(toPage, fromPage, transition, reverse) {
    ...
    var active = $.mobile.urlHistory.getActive(),
      touchOverflow = $.support.touchOverflow && $.mobile.touchOverflowEnabled,
      toScroll =
        active.lastScroll || (touchOverflow ? 0 : $.mobile.defaultHomeScroll),
    ...
    var th =
        $.mobile.transitionHandlers[transition || "none"] ||
  ...
  $.mobile.noneTransitionHandler = function (
    name,
    reverse,
    $toPage,
    $fromPage
  ...
  $.mobile.loadPage = function (url, options) {
    ...
    if (
      !(
        $.mobile.allowCrossDomainPages || path.isSameDomain(documentUrl, absUrl)
      )
    ) {
      deferred.reject(absUrl, options);
    } else {
  ...
  $.mobile._registerInternalEvents = function () {
    ...
    $(document).bind("click", function (event) {
      ...
      var useDefaultUrlHandling =
        ...
        isCrossDomainPageLoad =
          $.mobile.allowCrossDomainPages &&
          documentUrl.protocol === "file:" &&
          href.search(/^https?:/) != -1,
        ...
        isExternal =
          ...
          (path.isExternal(href) && !isCrossDomainPageLoad);
...
(function ($, window, undefined) {
  ...
  //auto self-init widgets
  $($.mobile.dialog.prototype.options.initSelector).live(
    "pagecreate",
    function () {
      $(this).dialog();
    }
...
(function ($, undefined) {
  $.widget("mobile.collapsible", $.mobile.widget, {
    ...
    _create: function () {
      var $el = this.element,
        ...
        collapsiblesInSet = collapsibleSet.children(
  ...
  $(document).bind("pagecreate create", function (e) {
    $(
      $.mobile.collapsible.prototype.options.initSelector,
      e.target
    ).collapsible();
  });
})(jQuery);
  ...
  $.widget("mobile.listview", $.mobile.widget, {
    ...
    _refreshCorners: function (create) {
      ...
      if (this.options.inset) {
        ...
        $topli
          .add(
            $topli.find(".ui-btn-inner").not(".ui-li-link-alt span:first-child")
          )
          .addClass("ui-corner-top")
          .end()
    ...
    refresh: function (create) {
      ...
      var o = this.options,
        ...
        counter =
          $.support.cssPseudoElement || !$.nodeName($list[0], "ol") ? 0 : 1,
        itemClassDict = {},
        item,
        itemClass,
        itemTheme,
      ...
      for (var pos = 0, numli = li.length; pos < numli; pos++) {
        ...
        if (counter && itemClass.indexOf("ui-li-divider") < 0) {
          countParent = item.is(".ui-li-static:first")
            ? item
      ...
      search = $("<input>", {
        ...
        .bind("keyup change", function () {
          ...
          if (
            ...
            change.length != val.length - lastval.length
          ) {
  ...
  $.widget("mobile.slider", $.mobile.widget, {
    ...
    refresh: function (val, isfromControl, preventInputUpdate) {
      ...
      if (typeof val === "object") {
        ...
        percent = Math.round(
          ((data.pageX - this.slider.offset().left) / this.slider.width()) * 100
        );
      } else {
        if (val == null) {
          val =
      ...
      if (cType === "select") {
        if (newval === 0) {
          this.slider
            .addClass("ui-slider-switch-a")
            .removeClass("ui-slider-switch-b");
        } else {
          this.slider
            .addClass("ui-slider-switch-b")
...
(function ($, undefined) {
  var extendSelect = function (widget) {
    var select = widget.select,
      ...
      listbox = $("<div>", {
        class:
          "ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-" +
          widget.options.overlayTheme +
          " " +
          $.mobile.defaultDialogTransition,
      }).insertAfter(screen),
    ...
    $.extend(widget, {
      ...
      open: function () {
        ...
        var self = this,
          ...
          tScrollElem = activePage.is(".ui-native-fixed")
            ? activePage.find(".ui-content")
            : activePage;
        (scrollTop = tOverflow
          ? tScrollElem.scrollTop()
          : $(window).scrollTop()),
        ...
        if (menuHeight > screenHeight - 80 || !$.support.scrollTop) {
          ...
          if (roomtop > menuHeight / 2 && roombot > menuHeight / 2) {
            ...
            newtop =
              roomtop > roombot
                ? scrollTop + screenHeight - menuHeight - 30
                : scrollTop + 30;
          }
          ...
          if (menuWidth < maxwidth) {
            ...
            newleft =
              self.button.offset().left +
              self.button.outerWidth() / 2 -
              menuWidth / 2;
  ...
  $.widget("mobile.selectmenu", $.mobile.widget, {
    ...
    _create: function () {
      ...
      var self = this,
        ...
        selectedIndex =
          this.select[0].selectedIndex == -1 ? 0 : this.select[0].selectedIndex,
...
(function ($, undefined) {
          ...
          $.fn.buttonMarkup.defaults,
          {
            ...
            iconpos:
              options.iconpos !== undefined
                ...
                : el.jqmData("iconpos"),
            theme:
              options.theme !== undefined ? options.theme : el.jqmData("theme"),
            inline:
  ...
  function closestEnabledButton(element) {
    ...
    while (element) {
      ...
      if (
        cname &&
        $.inArray("ui-btn", cname) > -1 &&
        $.inArray("ui-disabled", cname) < 0
      ) {
        break;
      }
      element = element.parentNode;
...
(function ($, undefined) {
  ...
  $.mobile.fixedToolbars = (function () {
    ...
    var stickyFooter,
      ...
      showDelay = 100,
      ignoreTargets =
        "a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed",
      toolbarSelector =
    ...
    $(".ui-page")
      .live("pagebeforeshow", function (event, ui) {
        var page = $(event.target),
          ...
          prevFooterMatches =
            prevFooter.length && prevFooter.jqmData("id") === id;
    ...
    function setTop(el) {
      ...
      if (el.is(".ui-header-fixed")) {
        ...
        return el.css(
          "top",
          useRelative ? relval : fromTop + screenHeight - thisHeight
        );
      }
    }
    ...
    return {
      show: function (immediately, page) {
        ...
        return $ap.children(toolbarSelector).each(function () {
          var el = $(this),
            ...
            thisHeight = el.outerHeight(),
            alreadyVisible =
              (el.is(".ui-header-fixed") && fromTop <= thisTop + thisHeight) ||
      ...
      hide: function (immediately) {
        ...
        return $ap.children(toolbarSelector).each(function () {
          ...
          if (
            thisCSStop < 0 ||
            (el.is(".ui-header-fixed") && thisCSStop !== 0)
          ) {
            if (immediately) {
              el.css("top", 0);
            } else {
    ...
    if ($.support.touchOverflow && $.mobile.touchOverflowEnabled) {
      ...
      if ($target.is(":jqmData(role='page')")) {
        $target.each(function () {
          var $page = $(this),
            $fixies = $page
              .find(":jqmData(role='header'), :jqmData(role='footer')")
