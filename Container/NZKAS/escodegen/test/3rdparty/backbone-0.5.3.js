...
(function () {
  ...
  _.extend(Backbone.Model.prototype, Backbone.Events, {
    ...
    escape: function (attr) {
      ...
      return (this._escapedAttributes[attr] = escapeHTML(
        val == null ? "" : "" + val
      ));
    },
    ...
    unset: function (attr, options) {
      ...
      if (
        !options.silent &&
        this.validate &&
        !this._performValidation(validObj, options)
      )
        return false;
  ...
  _.extend(Backbone.Collection.prototype, Backbone.Events, {
    ...
    _add: function (model, options) {
      ...
      if (already)
        throw new Error([
          "Can't add the same model to a set twice",
          already.id,
        ]);
      ...
      var index =
        options.at != null
          ? options.at
          : this.comparator
          ? this.sortedIndex(model, this.comparator)
          : this.length;
