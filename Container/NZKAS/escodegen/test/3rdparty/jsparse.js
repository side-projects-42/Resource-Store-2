...
Narcissus.parser = (function () {
    ...
    switch (tt) {
      ...
      case FOR:
        ...
        if (n2 && t.match(IN)) {
          ...
          n.condition = t.peek(true) === SEMICOLON ? null : Expression(t, x3);
          t.mustMatch(SEMICOLON);
          tt2 = t.peek(true);
          n.update = (
            x.parenFreeMode
  ...
  function FunctionDefinition(t, x, requireName, functionForm, comments) {
    ...
    if (t.match(IDENTIFIER, false, true)) f.name = t.token.value;
  ...
  function PrimaryExpression(t, x) {
    ...
    switch (tt) {
      ...
      default:
        throw t.newSyntaxError(
          "missing operand; found " + definitions.tokens[tt]
        );
        break;
    }
