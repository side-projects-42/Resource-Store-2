...
testFail(
  ...
  "Illegal 'use strict' directive in function with non-simple parameter list (1:20)",
  { ecmaVersion: 7 }
);
testFail(
  "(a=2) => { 'use strict'; }",
  "Illegal 'use strict' directive in function with non-simple parameter list (1:11)",
  { ecmaVersion: 7 }
);
testFail(
