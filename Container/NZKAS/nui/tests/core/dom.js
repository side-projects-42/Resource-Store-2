(function () {
  ...
  suite.add(
    new YUITest.TestCase({
      ...
      "Adding a class on an element that doesn't have one should work":
        function () {
      ...
      "Adding a class on an element that has one already should work":
        function () {
      ...
      "Adding a duplicate class on an element should omit the duplicate":
        function () {
          var element = { className: "bar" };
      ...
      "Adding a duplicate class on an element with multiple classes should omit the duplicate":
        function () {
  ...
  suite.add(
    new YUITest.TestCase({
      ...
      "Removing a class on an element that doesn't have one should work":
        function () {
          var element = { className: "" };
