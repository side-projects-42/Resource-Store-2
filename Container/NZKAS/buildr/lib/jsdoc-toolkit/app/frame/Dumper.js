...
Dumper = {
  ...
  dump: function () {
    if (arguments.length > 1) return this._dump(arguments);
    else if (arguments.length == 1) return this._dump(arguments[0]);
    else return "()";
  },
  ...
  _dump: function (obj) {
    ...
    switch (type) {
      ...
      case "object":
        ...
        for (var prop in obj) {
          if (prop != "circularReference" && obj.hasOwnProperty(prop)) {
