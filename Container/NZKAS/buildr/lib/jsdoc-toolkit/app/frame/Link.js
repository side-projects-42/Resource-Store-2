...
Link.getSymbol = function (alias) {
  ...
  while (container) {
    ...
    //  No superclass
    if (!container.augments.length) return null;
...
Link.prototype._makeSrcLink = function (srcFilePath) {
  ...
  var srcFile = srcFilePath
    .replace(/\.\.?[\\\/]/g, "")
    .replace(/[:\\\/]/g, "_");
  var outFilePath =
    Link.base + publish.conf.srcDir + srcFile + publish.conf.ext;
