...
This example calculates 5<sup>2</sup>, which is equal to 25. You can still use `Math.pow()` to achieve the same result.
...
The calculation of 5<sup>2</sup> happens first. The resulting value is then multiplied by 2 for a final result of 50.
