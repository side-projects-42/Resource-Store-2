Are you working on a project which uses java.net’s <a href="http://en.wikipedia.org/wiki/Apache%20Maven" id="aptureLink_L4MIM7mY1F">Maven</a> repository for deploying its artifacts?
