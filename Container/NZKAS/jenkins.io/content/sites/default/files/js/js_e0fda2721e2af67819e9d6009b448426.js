...
Drupal.behaviors.multiselectSelector = function () {
  ...
  $(".multiselect select:not(.multiselectSelector-processed)")
    .addClass("multiselectSelector-processed")
    .change(function () {
      $('.multiselect input:radio[value="' + this.id.substr(5) + '"]').attr(
        "checked",
        true
      );
    });
...
Drupal.behaviors.tableSelect = function (context) {
  $("form table:has(th.select-all):not(.tableSelect-processed)", context).each(
    Drupal.tableSelect
  );
};
    ...
    .click(function (event) {
      if ($(event.target).is("input:checkbox")) {
        ...
        checkboxes.each(function () {
          ...
          $(this)
            .parents("tr:first")
            [this.checked ? "addClass" : "removeClass"]("selected");
        });
  ...
  checkboxes = $("td input:checkbox", table).click(function (e) {
    ...
    if (e.shiftKey && lastChecked && lastChecked != e.target) {
      ...
      Drupal.tableSelectRange(
        $(e.target).parents("tr")[0],
        $(lastChecked).parents("tr")[0],
        e.target.checked
      );
    }
