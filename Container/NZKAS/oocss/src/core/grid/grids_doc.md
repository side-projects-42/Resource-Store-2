...
<table><thead><tr class="header"><th>Property</th><th>Description</th></tr></thead><tbody><tr class="odd"><td><code>line</code></td><td>Groups units on one horizontal line. Note: for mobile layout units may be stacked to avoid horizontal scrolling.</td></tr><tr class="even"><td><code>unit</code></td><td>Base class which divides a line into sections (columns).</td></tr><tr class="odd"><td><code>sizeXofY</code></td><td>Extends <code>unit</code>. Indicates the fractional width of the unit, for example <code>size3of4</code> would take up three quarters, or 75%, of the horizontal space. The following fractions are supported: 1 1/2 1/3 2/3 1/4 3/4 1/5 2/5 3/5 4/5</td></tr><tr class="even"><td><code>lastUnit</code></td><td>Extends <code>unit</code>. Applied to the last child of every line.</td></tr></tbody></table>
