...
- [ts-jest](https://github.com/kulshekhar/ts-jest) – all you need to successfully run Jest within TypeScript project by <span class="citation" data-cites="kulshekhar">\[@kulshekhar\]</span>(https://github.com/kulshekhar/ts-jest)
