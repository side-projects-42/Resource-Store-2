...
const createToBeCalledMatcher =
  (matcherName: string) =>
  (received: any, expected: unknown): SyncExpectationResult => {
...
const createToBeCalledTimesMatcher =
  (matcherName: string) =>
  (received: any, expected: number): SyncExpectationResult => {
...
const createToBeCalledWithMatcher =
  (matcherName: string) =>
  (received: any, ...expected: Array<unknown>): SyncExpectationResult => {
    ensureMock(received, matcherName);
...
const createNthReturnedWithMatcher =
  (matcherName: string) =>
  (received: any, nth: number, expected: unknown): SyncExpectationResult => {
    ensureMock(received, matcherName);
