...
(function (a, b) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l == "string" &&
          (!k || g[l]
            ? (l = b)
            : (c.dataTypes.unshift(l), (l = bY(a, c, d, e, l, g))));
  ...
  function bk(a) {
    f.nodeName(a, "input")
      ? bj(a)
      : a.getElementsByTagName && f.grep(a.getElementsByTagName("input"), bj);
  }
  function bj(a) {
      ...
      k.appendChild(a),
        ...
        c.defaultView &&
          ...
          (i.reliableMarginRight =
            (parseInt(
              c.defaultView.getComputedStyle(h, null).marginRight,
              10
            ) || 0) === 0)),
        (k.innerHTML = ""),
      ...
      if (a.attachEvent)
        for (p in { submit: 1, change: 1, focusin: 1 })
          (o = "on" + p),
            (q = o in a),
            q ||
              (a.setAttribute(o, "return;"), (q = typeof a[o] == "function")),
            (i[p + "Bubbles"] = q);
      return i;
    })()),
      ...
      clean: function (a, b, d, e) {
        ...
        if (d) {
          ...
          for (i = 0; h[i]; i++)
            if (
              e &&
              f.nodeName(h[i], "script") &&
              (!h[i].type || h[i].type.toLowerCase() === "text/javascript")
            )
              e.push(
                h[i].parentNode ? h[i].parentNode.removeChild(h[i]) : h[i]
              );
            else {
              if (h[i].nodeType === 1) {
  ...
  f.ajaxSetup({
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (
        b.dataTypes[0] === "jsonp" ||
        (b.jsonp !== !1 && (cb.test(b.url) || (e && cb.test(b.data))))
      ) {
        var g,
                ...
                (d = function (a, e) {
                  ...
                  try {
                    if (d && (e || h.readyState === 4)) {
                      (d = b),
                        i &&
                          ((h.onreadystatechange = f.noop), cc && delete ce[i]);
        ...
        (d = this[g]),
          d.style &&
            ...
            e === "" &&
              ...
              f._data(d, "olddisplay", ct(d.nodeName)));
      for (g = 0; g < h; g++) {
        d = this[g];
        if (d.style) {
          e = d.style.display;
          ...
          c &&
            ...
            f.css(this, "display") === "inline" &&
              ...
              (f.support.inlineBlockNeedsLayout
                ...
                : (this.style.display = "inline-block"))),
            (b.animatedProperties[g] = f.isArray(h)
              ? h[1]
          ...
          h() &&
            ...
            (cp
              ? ((cm = 1),
                ...
                cp(g))
              : (cm = setInterval(e.tick, e.interval)));
      },
      show: function () {
