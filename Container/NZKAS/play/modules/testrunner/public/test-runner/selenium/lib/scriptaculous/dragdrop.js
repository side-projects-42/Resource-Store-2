...
var Sortable = {
  ...
  create: function (element) {
    ...
    (this.findElements(element, options) || []).each(function (e) {
      ...
      var handle = options.handle
        ? Element.childrenWithClassName(e, options.handle)[0]
        : e;
  ...
  mark: function (dropon, position) {
    ...
    if (position == "after")
      ...
      else Sortable._marker.style.top = offsets[1] + dropon.clientHeight + "px";
  ...
  _tree: function (element, options, parent) {
    ...
    for (var i = 0; i < children.length; ++i) {
      ...
      var child = {
        ...
        container: Sortable._findChildrenElement(
          children[i],
...
Element.offsetSize = function (element, type) {
  if (type == "vertical" || type == "height") return element.offsetHeight;
