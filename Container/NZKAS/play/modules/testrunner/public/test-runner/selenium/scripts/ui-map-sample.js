...
myMap.addElement("allPages", {
  ...
  getLocator: function (args) {
    return (
      "//div[@id='topiclist']/ul/li" +
      "/a[text()=" +
      args.topic.quoteForXPath() +
      "]"
    );
  },
  testcase1: {
  ...
  args: [
    {
      name: "issue_index",
      description:
        "the index of the article's issue on the page; " +
    ...
    },
    {
      name: "article_index",
      description:
        "the index of the article within the issue; " +
...
myMap.addElement("articlePages", {
  name: "article_topics",
  description:
    "links to topics under which article is published, before \
article content",
  args: [
    {
      name: "topic",
...
myMap.addElement("articlePages", {
  name: "related_topics",
  description:
    "links to topics under which article is published, after \
article content",
  args: [
    {
      name: "topic",
...
myMap.addPageset({
  ...
  pathPrefix: "topics/",
  paths: ["code", "content", "culture", "design", "process", "userscience"],
});
...
myMap.addElement("subtopicArticleListingPages", {
  ...
  getLocator: function (args) {
    return (
      "//div[@id='content']/div[@class='item']" + "[" + args.index + "]/h3/a"
    );
  },
  testcase1: {
    args: { index: 2 },
    xhtml:
      '<div id="content"><div class="item" /><div class="item">' +
...
myMap.addElement("subtopicArticleListingPages", {
  ...
  getLocator: function (args) {
    return (
      "//div[@id='content']/div[@class='item']" + "[" + args.index + "]/h5/a"
    );
  },
});
  ...
  args: [
    {
      ...
      defaultValues: ["ALA Crew", "Support", "Emeritus"],
    },
    {
      name: "role_index",
...
myMap.addElement("searchResultsPages", {
  ...
  getLocator: function (args) {
    return (
      "//div[@id='content']/div[@class='pages'][" +
...
myMap.addElement("commentsPages", {
  ...
  getLocator: function (args) {
    return (
      "//div[@class='content']/div[contains(@class, 'comment')]" +
      "[" +
      args.index +
      "]/h4/a[2]"
    );
...
myMap.addElement("authorPages", {
  name: "article",
  description:
    "link to article written by this author.\n" +
...
myMap.addElement("qaPages", {
  ...
  locator:
    "//div[@id='content' and " + "child::h1[text()='Questions and Answers']]",
...
myRollupManager.addRollupRule({
  ...
  description:
    "drill down to the listing of articles for a given subtopic \
...
myRollupManager.addRollupRule({
  ...
  description:
    "replaces commands where a click was detected with \
