  ...
  http
    .createServer(function (req, res) {
      ...
      YUI().use("nodejs-dom", "node", function (Page) {
        ...
        ln.href =
          "http://yui.yahooapis.com/2in3.1/2.8.0/build/yui2-skin-sam-calendar/assets/skins/sam/yui2-skin-sam-calendar-min.css";
        ...
        Page.use("yui2-calendar", function () {
          ...
          cal1.renderEvent.subscribe(function () {
            ...
            //Fix up the dom
            Page.one("#cal1 .calheader .calnavright").set(
              "href",
              "/?page=" + next
            );
            Page.one("#cal1 .calheader .calnavleft").set(
              "href",
              "/?page=" + prev
            );
