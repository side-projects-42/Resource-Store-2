      ...
      .createServer(function (req, res) {
        YUI({ debug: DEBUG }).use(
          ...
          function (Page) {
            ...
            body.append(
              '<p>The content below is dynamically generated on the server.<br>You can access this code in 3 different ways:<ul><li>Like this as a full page</li><li><a href="/html">Or as just the content</a></li><li><a href="/json">Or as just the JSON data</a></li></ul></p>'
            );
