...
YUI({
  ...
  el.id = "foo";
  el.innerHTML =
    '<em>This is a test</em> This <strong class="odd">is another</strong> test ';
  ...
  el2.id = "foo2bar";
  el2.innerHTML =
    '<em class="odd">This is a test</em> This <strong>is another</strong> test ';
  Y.Browser.document.body.appendChild(el2);

  sys.puts(
    "getElementByid(foo2bar): " + Y.Browser.document.getElementById("foo2bar")
  );
  sys.puts("getElementByid(foo): " + Y.Browser.document.getElementById("foo"));
  sys.puts(
    "getElementByTagName(em): " + Y.Browser.document.getElementsByTagName("em")
  );
  sys.puts(
    "getElementByClassName(odd): " +
      Y.Browser.document.getElementsByClassName("odd")
  );
