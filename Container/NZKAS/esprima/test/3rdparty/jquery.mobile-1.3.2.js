  ...
  */
  ...
  (function ($, undefined) {
    ...
    $.extend($.support, {
      cssTransitions:
        ...
        (validStyle("transition", "height 100ms linear", [
          "Webkit",
          "Moz",
          "",
        ]) &&
    ...
    $.mobile.gradeA = function () {
      return (
        ($.support.mediaquery ||
          ($.mobile.browser.oldIE && $.mobile.browser.oldIE >= 7)) &&
  ...
  (function ($, undefined) {
    ...
    $.mobile.path = path = {
      ...
      squash: function (url, resolutionUrl) {
        ...
        resolutionUrl =
          resolutionUrl ||
          (path.isPath(url) ? path.getLocation() : path.getDocumentUrl());
      ...
      return function (name, reverse, $to, $from) {
        var deferred = new $.Deferred(),
          ...
          none =
            ...
            !name ||
            name === "none" ||
            Math.max($.mobile.window.scrollTop(), toScroll) >
  ...
  (function ($, undefined) {
    ...
    function transitionPages(toPage, fromPage, transition, reverse) {
      ...
      promise.done(function () {
        ...
        if (fromPage) {
          fromPage
            .data("mobile-page")
            ._trigger("hide", null, { nextPage: toPage });
        }
    ...
    $.mobile.resetActivePageHeight = function resetActivePageHeight(height) {
      ...
      aPage.css(
        "min-height",
        height - aPagePadT - aPagePadB - aPageBorderT - aPageBorderB
      );
    };
    ...
    $.mobile._registerInternalEvents = function () {
      ...
      $window.bind("navigate", function (e, data) {
        ...
        url =
          $.event.special.navigate.originalEventName.indexOf("hashchange") > -1
            ? data.state.hash
            : data.state.url;
            ...
            $.fn.buttonMarkup.defaults,
            {
              icon:
                options.icon !== undefined
                  ? options.icon
                  : getAttrFixed(e, nsKey + "icon"),
              iconpos:
                options.iconpos !== undefined
                  ? options.iconpos
                  : getAttrFixed(e, nsKey + "iconpos"),
              theme:
                options.theme !== undefined
                  ? options.theme
                  : getAttrFixed(e, nsKey + "theme") ||
                    $.mobile.getInheritedTheme(el, "c"),
              inline:
                options.inline !== undefined
                  ? options.inline
                  : getAttrFixed(e, nsKey + "inline"),
              shadow:
                options.shadow !== undefined
                  ? options.shadow
                  : getAttrFixed(e, nsKey + "shadow"),
              corners:
                options.corners !== undefined
                  ? options.corners
                  : getAttrFixed(e, nsKey + "corners"),
              iconshadow:
                options.iconshadow !== undefined
                  ? options.iconshadow
                  : getAttrFixed(e, nsKey + "iconshadow"),
              mini:
                options.mini !== undefined
                  ? options.mini
                  : getAttrFixed(e, nsKey + "mini"),
            },
            options
          ),
          // Classes Defined
    ...
    $.widget("mobile.collapsible", $.mobile.widget, {
      ...
      _create: function () {
        ...
        if (collapsibleSet.length) {
          ...
          o.collapsedIcon =
            $el.jqmData("collapsed-icon") ||
            collapsibleSet.jqmData("collapsed-icon") ||
            o.collapsedIcon;

          // Get the preference for expanded icon in the set, but override with data- attribute on the individual collapsible
          o.expandedIcon =
            $el.jqmData("expanded-icon") ||
            collapsibleSet.jqmData("expanded-icon") ||
            o.expandedIcon;
      ...
      $.extend(
        {
          ...
          _init: function () {
            var $el = this.element,
              ...
              expanded = collapsiblesInSet.filter(
              ...
              if (create || !item.hasClass("ui-li")) {
                ...
                if (a.length && !isDivider) {
                  ...
                  item.buttonMarkup({
                    ...
                    iconpos: "right",
                    icon:
                      a.length > 1 || icon === false
                        ? false
                        : icon || listicon || o.icon,
                    theme: itemTheme,
                  });
                  ...
                  itemClass +=
                    ...
                    (item.jqmData("theme") || dividertheme);
            ...
            if (
              ...
              var newRemove = function (e, ui) {
                ...
                if (ui.nextPage) {
                  ...
                  if (
                    npURL.indexOf(parentUrl + "&" + $.mobile.subPageUrlKey) !==
                    0
                  ) {
    ...
    $.widget("mobile.textinput", $.mobile.widget, {
      ...
      disable: function () {
        var $el,
          ...
          parentNeedsDisabled =
            this.element.attr("disabled", true) && (inputNeedsWrap || isSearch);
      ...
      var wrapper = $("<form>", {
        ...
        onKeyUp = function (e) {
          ...
          listview._addFirstLastClasses(
            li,
            listview._getVisibles(li, false),
            false
          );
        },
        search = $("<input>", {
      ...
      $.extend(
        {
          ...
          _create: function () {
            ...
            control.addClass(
              this.isToggleSwitch ? "ui-slider-switch" : "ui-slider-input"
            );
  ...
  (function ($, undefined) {
    $.widget("mobile.rangeslider", $.mobile.widget, {
      ...
      _updateHighlight: function () {
        var min = parseInt(
            $.data(this._inputFirst.get(0), "mobileSlider").handle.get(0).style
              .left,
            10
          ),
          max = parseInt(
            $.data(this._inputLast.get(0), "mobileSlider").handle.get(0).style
              .left,
            10
          ),
          width = max - min;
            ...
            if (wrapper.length > 0) {
              if (wrapper.is(".ui-btn-left, .ui-btn-right")) {
                this.element.addClass(
                  wrapper.is(".ui-btn-left") ? "ui-btn-left" : "ui-btn-right"
                );
              }
  ...
  (function ($, undefined) {
    ...
    $.widget("mobile.popup", $.mobile.widget, {
      ...
      _create: function () {
        ...
        o.history =
          o.history && $.mobile.ajaxEnabled && $.mobile.hashListeningEnabled;
      ...
      _reposition: function (o) {
        ...
        this._ui.container.offset(
          this._placementCoords(this._desiredCoords(o))
        );
      },
      ...
      $.extend(widget, {
        ...
        build: function () {
          ...
          if (self._origTabIndex === undefined) {
            ...
            // none present.
            self._origTabIndex =
              self.select[0].getAttribute("tabindex") === null
                ? false
                : self.select.attr("tabindex");
          }
  ...
  (function ($, undefined) {
    $.widget("mobile.fixedtoolbar", $.mobile.fixedtoolbar, {
      ...
      _viewportOffset: function () {
        ...
        if (!header) {
          offset =
            Math.round(offset - $.mobile.window.height() + $el.outerHeight()) -
            60;
        }
        return offset;
      },
    ...
    $.widget("mobile.panel", $.mobile.widget, {
          ...
          _getPanelInner = function () {
            ...
            if ($panelInner.length === 0) {
              $panelInner = $el
                .children()
                .wrapAll(
                  '<div class="' + self.options.classes.panelInner + '" />'
                )
                .parent();
            }
            return $panelInner;
      ...
      _bindLinkListeners: function () {
        ...
        self._page.on("click.panel", "a", function (e) {
          if (
            this.href.split("#")[1] === self._panelID &&
        ...
        if (!this._open) {
          var self = this,
            ...
            _openPanel = function () {
              ...
              self._contentWrapOpenClasses = self._getPosDisplayClasses(
                o.classes.contentWrap
              );
              self._wrapper
                .removeClass(o.classes.contentWrapClosed)
                .addClass(
                  self._contentWrapOpenClasses + " " + o.classes.contentWrapOpen
                );

              self._fixedToolbarOpenClasses = self._getPosDisplayClasses(
                o.classes.contentFixedToolbar
              );
              self._fixedToolbar
        ...
        if (this._open) {
          var o = this.options,
            ...
            complete = function () {
              if (self.options.theme && self.options.display !== "overlay") {
                self._page
                  .removeClass("ui-body-" + self.options.theme)
                  .addClass(self._pageTheme);
      ...
      _destroy: function () {
        var classes = this.options.classes,
          ...
          hasOtherSiblingPanels = this.element.siblings(
            "." + classes.panel
          ).length;
        ...
        this.element
          .removeClass(
            [this._getPanelClasses(), classes.panelAnimate].join(" ")
          )
        ...
        this.element
          ...
          .removeClass(
            [classes.panelUnfixed, classes.panelClosed, classes.panelOpen].join(
              " "
            )
          );
      },
        ...
        trs.each(function () {
          ...
          $(this)
            ...
            .each(function (i) {
              ...
              $(this).jqmData(
                "cells",
                self.element.find("tr").not(trs.eq(0)).not(this).children(sel)
              );
    ...
    $.mobile.document.delegate(
      ...
      function (e) {
        var $table = $(this),
          ...
          ns = $.mobile.ns,
          id =
            ($table.attr("id") || o.classes.popup) +
            "-popup" /* TODO BETTER FALLBACK ID HERE */,
          $menuButton,
          $popup,
          $menu,
          $switchboard;
        ...
        if (event !== "refresh") {
          ...
          ($menuButton = $(
            ...
            ($menu = $(
              "<fieldset data-" + ns + "role='controlgroup'></fieldset>"
            ));
        }
        ...
        reverseHeaders.each(function (i) {
          ...
          if (text !== "") {
            if (hierarchyClass) {
              ...
              $cells.prepend(
                "<b class='" + o.classes.cellLabels + "'>" + text + "</b>"
              );
            }
          }
        });
