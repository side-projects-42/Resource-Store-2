...
exports.latedef = function () {
  ...
  TestRun().addError(1, "'fn' is not defined.").test("fn();", { undef: true });
...
exports.testProtoAndIterator = function () {
  var source = fs.readFileSync(
    __dirname + "/fixtures/protoiterator.js",
    "utf8"
  );
  var json =
    '{"__proto__": true, "__iterator__": false, "_identifier": null, "property": 123}';
...
exports.noempty = function () {
  ...
  TestRun().addError(1, "Empty block.").test(code, { noempty: true });
};
...
exports.scripturl = function () {
  ...
  TestRun().addError(1, "Script URL.").test(code);
...
exports.eqeqeq = function () {
  ...
  TestRun().addError(8, "Use '===' to compare with 'null'.").test(src);
...
exports.evil = function () {
  ...
  TestRun().addError(1, "eval is evil.").test(src);
...
exports.passfail = function () {
  ...
  TestRun().addError(1, "Missing semicolon.").test(code, { passfail: true });
};
...
exports.strict = function () {
  ...
  var src = fs.readFileSync(
    __dirname + "/fixtures/strict_violations.js",
    "utf8"
  );
...
exports.globalstrict = function () {
  var code = ['"use strict";', "function hello() { return; }"];
...
exports.regexp = function () {
  var code = ["var a = /hey/;", "var a = /h.ey/;", "var a = /h[^...]/;"];
  ...
  TestRun().addError(1, "Insecure '.'.").test(code[1], { regexp: true });

  TestRun().addError(1, "Insecure '^'.").test(code[2], { regexp: true });
};
...
exports.laxbreak = function () {
  ...
  code = ["var a = b ", "? c : d;"];
  TestRun().addError(2, "Bad line breaking before '?'.").test(code);
...
exports.onecase = function () {
  ...
  TestRun().addError(1, "This 'switch' should be an 'if'.").test(code);
...
exports.validthis = function () {
  ...
  TestRun().addError(2, "Bad option value.").test(code);
};
