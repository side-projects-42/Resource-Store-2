...
exports.testCustomGlobals = function () {
  ...
  var dict = {};
  for (var i = 0, g; (g = report.globals[i]); i += 1) dict[g] = true;

  for (i = 0, g = null; (g = custom[i]); i += 1) assert.ok(g in dict);
};
...
exports.switchFallThrough = function () {
  var src = fs.readFileSync(
    __dirname + "/fixtures/switchFallThrough.js",
    "utf8"
  );
  TestRun()
...
exports.testVoid = function () {
  var code = ["void(0);", "void 0;", "var a = void(1);"];
  TestRun().test(code);
};

exports.functionScopedOptions = function () {
  var src = fs.readFileSync(
    __dirname + "/fixtures/functionScopedOptions.js",
    "utf8"
  );
  TestRun().addError(1, "eval is evil.").addError(8, "eval is evil.").test(src);
};
...
exports.caseExpressions = function () {
  ...
  TestRun().addError(2, "This 'switch' should be an 'if'.").test(src);
};
