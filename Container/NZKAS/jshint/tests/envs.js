...
assert.globalsKnown = function (globals, options) {
  ...
  for (i = 0, g = null; (g = globals[i]); i += 1) assert.ok(g in globals);
};
...
exports.node = function () {
  ...
  var asGlobals = ["console.log(__dirname);", "console.log(__filename);"];
...
exports.devel = function () {
  var globals = ["alert", "confirm", "console", "Debug", "opera", "prompt"];
