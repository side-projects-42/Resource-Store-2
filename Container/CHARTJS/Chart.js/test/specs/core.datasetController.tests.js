describe("Chart.DatasetController", function () {
  ...
  it("should not fail to produce stacks when parsing is off", function () {
    ...
    var meta = chart.getDatasetMeta(0);
    expect(meta._parsed[0]._stacks).toEqual(
      jasmine.objectContaining({
        y: { 0: 10, 1: 20, _top: null, _bottom: null },
      })
    );
  });
      ...
      for (const [prop, opts] of Object.entries(props)) {
        ...
        if (anim) {
          for (const [name, value] of Object.entries(opts)) {
            expect(anim[name])
              .withContext('"' + name + '" of ' + JSON.stringify(anim))
              .toEqual(value);
          }
        }
      }
  ...
  describe("getContext", function () {
    it("should reflect updated data", function () {
      ...
      expect(meta.controller.getContext(undefined, true, "test")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 0,
      ...
      expect(meta.controller.getContext(1, false, "datatest")).toEqual(
        jasmine.objectContaining({
          active: false,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      expect(meta.controller.getContext(undefined, false, "test2")).toEqual(
        jasmine.objectContaining({
          active: false,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      expect(meta.controller.getContext(1, true, "datatest2")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      chart.update();
      expect(meta.controller.getContext(0, true, "unshift")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      expect(meta.controller.getContext(2, true, "unshift2")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      chart.update();
      meta = chart.getDatasetMeta(0);
      expect(meta.controller.getContext(0, true, "unshift3")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 0,
          dataset: chart.data.datasets[0],
      ...
      expect(meta.controller.getContext(2, true, "unshift4")).toEqual(
        jasmine.objectContaining({
          active: true,
          datasetIndex: 1,
