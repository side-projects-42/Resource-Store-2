...
(function (global, factory) {
  ...
  var Defaults = (function () {
    ...
    _proto.route = function route(scope, name, targetScope, targetName) {
      ...
      Object.defineProperties(
        ...
        (_Object$definePropert[privateName] = {
          writable: true,
        }),
  ...
  function getContainerSize(canvas, width, height) {
    ...
    if (width === undefined || height === undefined) {
      ...
      if (!container) {
        ...
        var containerBorder = getPositionedStyle(
          containerStyle,
          "border",
          "width"
        );
  ...
  var BasePlatform = (function () {
    ...
    _proto.getMaximumSize = function getMaximumSize(
      element,
      width,
      height,
      aspectRatio
  ...
  var DomPlatform = (function (_BasePlatform) {
    ...
    _proto.getMaximumSize = function getMaximumSize$1(
      canvas,
      width,
      height,
      aspectRatio
  ...
  var effects = {
    ...
    easeInOutElastic: function easeInOutElastic(t) {
      ...
      if (t < 1) {
        return (
          -0.5 *
          (a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - s) * TAU) / p))
        );
      }
      return (
        a * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - s) * TAU) / p) * 0.5 +
        1
      );
    },
        ...
        (cfg.properties || [key]).forEach(function (prop) {
          if (!animatedProps.has(prop)) {
            ...
            var _animatedProps$get = animatedProps.get(prop),
              ...
              inherited = _objectWithoutPropertiesLoose(_animatedProps$get, [
                "properties",
              ]);
  ...
  var DatasetController = (function () {
    ...
    _proto.linkScales = function linkScales() {
      ...
      var xid = (meta.xAxisID = valueOrDefault(
        dataset.xAxisID,
        getFirstScaleId(chart, "x")
      ));
      var yid = (meta.yAxisID = valueOrDefault(
        dataset.yAxisID,
        getFirstScaleId(chart, "y")
      ));
      var rid = (meta.rAxisID = valueOrDefault(
        dataset.rAxisID,
    ...
    _proto.configure = function configure() {
      ...
      me._config = merge(
        ...
        [
          ...
          (_me$chart$options$me$ = me.chart.options[me._type]) == null
            ? void 0
            : _me$chart$options$me$.datasets,
          me.getDataset(),
        ],
        {
    ...
    _proto.parsePrimitiveData = function parsePrimitiveData(
      meta,
      data,
      start,
      count
      ...
      for (i = 0, ilen = count; i < ilen; ++i) {
        ...
        parsed[i] =
          ...
          (_parsed$i[vAxis] = vScale.parse(data[index], index)),
          _parsed$i);
      }
      return parsed;
    };
    ...
    _proto.parseObjectData = function parseObjectData(
      meta,
      data,
      start,
      count
      ...
      var _this$_parsing = this._parsing,
        ...
        xAxisKey =
          _this$_parsing$xAxisK === void 0 ? "x" : _this$_parsing$xAxisK,
        _this$_parsing$yAxisK = _this$_parsing.yAxisKey,
        yAxisKey =
          _this$_parsing$yAxisK === void 0 ? "y" : _this$_parsing$yAxisK;
      var parsed = new Array(count);
      var i, ilen, index, item;
      for (i = 0, ilen = count; i < ilen; ++i) {
        index = i + start;
    ...
    _proto.updateRangeFromParsed = function updateRangeFromParsed(
      range,
      scale,
      parsed,
      stack
    ...
    _proto._addAutomaticHoverColors = function _addAutomaticHoverColors(
      index,
      options
    ) {
      var me = this;
    ...
    _proto.resolveDatasetElementOptions = function resolveDatasetElementOptions(
      active
    ) {
    ...
    _proto.resolveDataElementOptions = function resolveDataElementOptions(
      index,
      mode
    ) {
      mode = mode || "default";
    ...
    _proto.updateSharedOptions = function updateSharedOptions(
      sharedOptions,
      mode,
      newOptions
    ) {
    ...
    _proto.removeHoverStyle = function removeHoverStyle(
      element,
      datasetIndex,
      index
    ) {
    ...
    _proto.setHoverStyle = function setHoverStyle(
      element,
      datasetIndex,
      index
    ) {
    ...
    _proto._insertElements = function _insertElements(start, count) {
      ...
      if (me._parsing) {
        ...
        (_meta$_parsed = meta._parsed).splice.apply(
          _meta$_parsed,
          [start, 0].concat(new Array(count))
        );
      }
  ...
  var Scale = (function (_Element) {
    ...
    _proto.beforeTickToLabelConversion =
    ...
    _proto.beforeCalculateLabelRotation =
      function beforeCalculateLabelRotation() {
    ...
    _proto.calculateLabelRotation = function calculateLabelRotation() {
      ...
      if (maxLabelWidth + 6 > tickWidth) {
        ...
        maxHeight =
          ...
          tickOpts.padding -
          getScaleLabelHeight(options.scaleLabel, me.chart.options.font);
    ...
    _proto.afterCalculateLabelRotation =
      function afterCalculateLabelRotation() {
    ...
    _proto.fit = function fit() {
      ...
      var scaleLabelHeight =
        display && getScaleLabelHeight(scaleLabelOpts, chart.options.font);
      if (isHorizontal) {
      ...
      if (Object.keys(defaults.get(scope)).length) {
        throw new Error(
          'Can not register "' +
            ...
            '", because "defaults.' +
            scope +
            '" would collide with existing defaults'
        );
      }
      items[id] = item;
  ...
  function registerDefaults(item, scope, parentScope) {
    var itemDefaults = parentScope
      ? _extends({}, defaults.get(parentScope), item.defaults)
      : item.defaults;
  ...
  function mergeScaleConfig(config, options) {
    ...
    Object.keys(configScales).forEach(function (id) {
      ...
      scales[id] = mergeIf(Object.create(null), [
        ...
        chartDefaults.scales[defaultId],
      ]);
    });
    if (options.scale) {
  ...
  function initConfig(config) {
    ...
    var options = (config.options = includeDefaults(
      config.options,
      config.type
    ));
    ...
    options.title =
      options.title !== false &&
      merge(Object.create(null), [defaults.plugins.title, options.title]);
    options.tooltips =
      options.tooltips !== false &&
      merge(Object.create(null), [
        defaults.interaction,
  ...
  var Chart = (function () {
    ...
    _proto._resize = function _resize(width, height) {
      ...
      var newSize = me.platform.getMaximumSize(
        canvas,
        width,
        height,
        aspectRatio
    ...
    _proto.buildOrUpdateScales = function buildOrUpdateScales() {
      ...
      if (scaleOpts) {
        items = items.concat(
          Object.keys(scaleOpts).map(function (id) {
      ...
      for (i = 0, ilen = datasets.length; i < ilen; i++) {
        ...
        if (meta.controller) {
          ...
          _extends(ControllerClass.prototype, {
            dataElementType: registry.getElement(
              controllerDefaults.dataElementType
            ),
            datasetElementType:
              controllerDefaults.datasetElementType &&
    ...
    _proto._getSortedDatasetMetas = function _getSortedDatasetMetas(
      filterVisible
    ) {
      var me = this;
    ...
    _proto.getSortedVisibleDatasetMetas =
      function getSortedVisibleDatasetMetas() {
    ...
    _proto.getElementsAtEventForMode = function getElementsAtEventForMode(
      e,
      mode,
      options,
      useFinalPosition
    ...
    _proto.setDatasetVisibility = function setDatasetVisibility(
      datasetIndex,
      visible
    ) {
      var meta = this.getDatasetMeta(datasetIndex);
    ...
    _proto._updateDatasetVisibility = function _updateDatasetVisibility(
      datasetIndex,
      visible
    ) {
      var me = this;
    ...
    _proto._updateHoverStyles = function _updateHoverStyles(
      active,
      lastActive
    ) {
      var me = this;
  ...
  var BarController = (function (_DatasetController) {
    ...
    _proto.updateRangeFromParsed = function updateRangeFromParsed(
      ...
      _DatasetController.prototype.updateRangeFromParsed.call(
        this,
        range,
        scale,
        parsed,
    ...
    _proto._calculateBarValuePixels = function _calculateBarValuePixels(
      index,
      options
    ) {
      var me = this;
      ...
      var base = _limitValue(
        vScale.getPixelForValue(startValue),
    ...
    _proto._calculateBarIndexPixels = function _calculateBarIndexPixels(
      index,
      ruler,
      options
    ) {
      var me = this;
      var stackCount = me.chart.options.skipNull
  ...
  var BubbleController = (function (_DatasetController) {
    ...
    _proto.resolveDataElementOptions = function resolveDataElementOptions(
      ...
      var chart = me.chart;
      var parsed = me.getParsed(index);
      var values = _DatasetController.prototype.resolveDataElementOptions.call(
        this,
        index,
        mode
      );
  ...
  function getRatioAndOffset(rotation, circumference, cutout) {
    ...
    if (circumference < TAU) {
      ...
      var contains90 =
        (startAngle <= HALF_PI && endAngle >= HALF_PI) ||
        endAngle >= TAU + HALF_PI;
  ...
  var DoughnutController = (function (_DatasetController) {
    ...
    _proto._getRotationExtents = function _getRotationExtents() {
      ...
      for (var i = 0; i < me.chart.data.datasets.length; ++i) {
        if (me.chart.isDatasetVisible(i)) {
          ...
          var rotation = toRadians(
            valueOrDefault(dataset.rotation, opts.rotation) - 90
          );
          var circumference = toRadians(
            valueOrDefault(dataset.circumference, opts.circumference)
          );
    ...
    _proto._circumference = function _circumference(i, reset) {
      ...
      var meta = me._cachedMeta;
      var circumference = toRadians(
        valueOrDefault(me._config.circumference, opts.circumference)
      );
      return reset && opts.animation.animateRotate
        ? 0
        : this.chart.getDataVisibility(i)
        ? me.calculateCircumference((meta._parsed[i] * circumference) / TAU)
        : 0;
    };
    _proto.updateElements = function updateElements(arcs, start, count, mode) {
      ...
      var sharedOptions = me.getSharedOptions(firstOpts);
      var includeOptions = me.includeOptions(mode, sharedOptions);
      var startAngle = toRadians(
        valueOrDefault(me._config.rotation, opts.rotation) - 90
      );
      var i;
      for (i = 0; i < start; ++i) {
    ...
    _proto._getVisibleDatasetWeightTotal =
  ...
  var LineController = (function (_DatasetController) {
    ...
    _proto.update = function update(mode) {
      ...
      var _getStartAndCountOfVi = getStartAndCountOfVisiblePoints(
          meta,
          points,
          animationsDisabled
        ),
    ...
    _proto.resolveDatasetElementOptions = function resolveDatasetElementOptions(
      ...
      var values =
        _DatasetController.prototype.resolveDatasetElementOptions.call(
          this,
          active
        );
  ...
  var PolarAreaController = (function (_DatasetController) {
    ...
    _proto.updateElements = function updateElements(arcs, start, count, mode) {
      ...
      for (i = start; i < start + count; i++) {
        ...
        var outerRadius = this.chart.getDataVisibility(i)
    ...
    _proto._computeAngle = function _computeAngle(index, mode) {
      ...
      return toRadians(
        resolve(
          [me.chart.options.elements.arc.angle, 360 / count],
          context,
          index
        )
      );
  ...
  var BarElement = (function (_Element) {
    ...
    _proto.draw = function draw(ctx) {
      ...
      var addRectPath = hasRadius(outer.radius)
        ? addRoundedRectPath
        : addNormalRectPath;
      ctx.save();
        ...
        for (var k = 0; k < fillSources.length; k++) {
          ...
          parts.push({
            ...
            start:
              ...
              ((_end = {}),
              (_end[property] = _getEdge(bounds, subBounds, "end", Math.min)),
              _end),
          });
        }
      }
  ...
  function resolveOptions(options) {
    return (
      options !== false &&
      merge(Object.create(null), [defaults.plugins.legend, options])
    );
  }
      ...
      labels: {
        ...
        generateLabels: function generateLabels(chart) {
          ...
          return chart._getSortedDatasetMetas().map(function (meta) {
            ...
            var borderWidth = isObject(style.borderWidth)
  ...
  var Title = (function (_Element) {
    ...
    _proto.fit = function fit() {
      ...
      var textSize =
        lineCount * toFont(opts.font, me.chart.options.font).lineHeight +
        me._padding.height;
  ...
  function resolveOptions$1(options, fallbackFont) {
    ...
    options.boxHeight = valueOrDefault(
      options.boxHeight,
      options.bodyFont.size
    );
  ...
  var Tooltip = (function (_Element) {
    ...
    _proto._resolveAnimations = function _resolveAnimations() {
      ...
      var options = me.options;
      var opts =
        options.enabled && chart.options.animation && options.animation;
    ...
    _proto.getBeforeBody = function getBeforeBody(tooltipItems) {
      return getBeforeAfterBodyLines(
        this.options.callbacks.beforeBody.apply(this, [tooltipItems])
      );
    };
    ...
    _proto.getAfterBody = function getAfterBody(tooltipItems) {
      return getBeforeAfterBodyLines(
        this.options.callbacks.afterBody.apply(this, [tooltipItems])
      );
    };
    ...
    _proto._createItems = function _createItems() {
      ...
      each(tooltipItems, function (context) {
        ...
        labelTextColors.push(
          options.callbacks.labelTextColor.call(me, context)
        );
      });
    ...
    _proto.setActiveElements = function setActiveElements(
      activeElements,
      eventPosition
    ) {
      var me = this;
  ...
  var LogarithmicScale = (function (_Scale) {
    ...
    _proto.handleTickRangeOptions = function handleTickRangeOptions() {
      ...
      if (
        !me._userMin &&
        me._zero &&
        min === Math.pow(10, Math.floor(log10(me.min)))
      ) {
        min = Math.pow(10, Math.floor(log10(min)) - 1);
      }
      me.min = min;
  ...
  function drawPointLabels(scale) {
    ...
    for (var i = scale.chart.data.labels.length - 1; i >= 0; i--) {
      ...
      var context = scale.getContext(i);
      var plFont = toFont(
        resolve([pointLabelOpts.font], context, i),
        scale.chart.options.font
      );
  ...
  var RadialLinearScale = (function (_LinearScaleBase) {
    ...
    _proto._setReductions = function _setReductions(
    ...
    _proto.setCenterPoint = function setCenterPoint(
      leftMovement,
      rightMovement,
      topMovement,
      bottomMovement
    ...
    _proto.getDistanceFromCenterForValue =
      function getDistanceFromCenterForValue(value) {
        var me = this;
        if (isNullOrUndef(value)) {
          return NaN;
        }
    ...
    _proto.getValueForDistanceFromCenter =
      function getValueForDistanceFromCenter(distance) {
    ...
    _proto.getPointPosition = function getPointPosition(
      index,
      distanceFromCenter
    ) {
      var me = this;
    ...
    _proto.getPointPositionForValue = function getPointPositionForValue(
      index,
      value
    ) {
  ...
  var TimeScale = (function (_Scale) {
    ...
    _proto.init = function init(scaleOpts, opts) {
      ...
      var adapter = (this._adapter = new _adapters._date(
    ...
    _proto._tickFormatFunction = function _tickFormatFunction(
      time,
      index,
      ticks,
      format
