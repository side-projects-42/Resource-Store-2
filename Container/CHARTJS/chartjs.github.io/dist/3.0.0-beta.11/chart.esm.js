...
import {
  ...
  B as readUsedSize,
  C as throttled,
  D as supportsEventListenerOptions,
  E as log10,
  F as finiteOrDefault,
  G as isNumberFinite,
  I as callback,
  J as toDegrees,
  K as _measureText,
  ...
  S as isFunction,
  U as _attachContext,
  V as _createResolver,
  W as mergeIf,
  X as _descriptors,
  Y as uid,
  Z as retinaScale,
  $ as clearCanvas,
  a0 as _elementsEqual,
  a1 as getAngleFromPoint,
  a2 as _angleBetween,
  a3 as _updateBezierControlPoints,
  a4 as _computeSegments,
  a5 as _boundSegments,
  ...
  al as noop,
  am as distanceBetweenPoints,
  an as toFontString,
  ao as _setMinAndMaxByKey,
  ap as _decimalPlaces,
  aq as almostEquals,
  ar as almostWhole,
  as as _longestText,
  at as _filterBetween,
  au as _lookup,
...
var plugin_tooltip = {
  ...
  descriptors: {
    _scriptable: (name) =>
      name !== "filter" && name !== "itemSort" && name !== "custom",
    _indexable: false,
    callbacks: {
      _scriptable: false,
      _indexable: false,
