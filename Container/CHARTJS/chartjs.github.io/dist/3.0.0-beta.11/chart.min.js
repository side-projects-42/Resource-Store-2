...
!(function (t, e) {
  ...
  function Z(t) {
    if (H(t)) return t.map(Z);
    if (Y(t)) {
      const e = Object.create(null),
        i = Object.keys(t),
        n = i.length;
      let o = 0;
      for (; o < n; ++o) e[i[o]] = Z(t[i[o]]);
      return e;
    }
    return t;
  }
  ...
  function J(t, e, i, n) {
    ...
    const o = e[t],
      s = i[t];
    Y(o) && Y(s) ? tt(o, s, n) : (e[t] = Z(s));
  }
  function tt(t, e, i) {
    const n = H(e) ? e : [e],
      o = n.length;
    if (!Y(t)) return t;
    const s = (i = i || {}).merger || J;
    for (let a = 0; a < o; ++a) {
      if (!Y((e = n[a]))) continue;
  ...
  function it(t, e, i) {
    ...
    Y(n) && Y(o)
      ? et(n, o)
      : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = Z(o));
  }
  function nt(t, e) {
    const i = t.indexOf(".", e);
  ...
  function ot(t, e) {
    ...
    let i = 0,
      n = nt(e, i);
    for (; n > i && (t = t[e.substr(i, n - i)]); ) (i = n + 1), (n = nt(e, i));
    return t;
  }
  function st(t) {
  ...
  var ht = new (class {
    ...
    set(t, e) {
      return "string" == typeof t ? tt(ct(this, t), e) : tt(ct(this, ""), t);
    }
    get(t) {
      return ct(this, t);
    }
    describe(t, e) {
      const i = this[lt];
      return "string" == typeof t ? tt(ct(i, t), e) : tt(ct(i, ""), t);
    }
    get descriptors() {
      return this[lt];
    }
    ...
    _scriptable: (t) => "onClick" !== t && "onHover" !== t,
  ...
  function Ct(t, e) {
    ...
    return s < -0.5 * dt && (s += ut), { angle: s, distance: o };
  }
  function At(t, e) {
  ...
  function Vt(t, e, i, n) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
      if (((d = i[l]), null != d && !0 !== H(d))) a = It(t, o, s, a, d);
      else if (H(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), null == u || H(u) || (a = It(t, o, s, a, u));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
      ...
      switch ((t.beginPath(), c)) {
        ...
        case "rectRounded":
          (l = 0.516 * d),
            ...
            (s = Math.cos(u + xt) * r),
            (a = Math.sin(u + xt) * r),
            t.arc(i - s, n - a, l, u - dt, u - mt),
            t.arc(i + a, n - s, l, u - mt, u),
            t.arc(i + s, n + a, l, u, u + mt),
            t.arc(i - a, n + s, l, u + mt, u + dt),
            t.closePath();
          break;
        case "rect":
          if (!h) {
  ...
  const qt = (t, e, i) => Kt(t, i, (n) => t[n][e] < i),
    Gt = (t, e, i) => Kt(t, i, (n) => t[n][e] >= i);
  function Zt(t, e, i) {
    let n = 0,
      o = t.length;
    for (; n < o && t[n] < e; ) n++;
  ...
  const Qt = ["push", "pop", "shift", "splice", "unshift"];
  function Jt(t, e) {
    t._chartjs
  ...
  function he(t, e, i, n) {
    const o = oe(t),
      s = re(o, "margin"),
      a = ne(o.maxWidth, t, "clientWidth") || gt,
      r = ne(o.maxHeight, t, "clientHeight") || gt,
      l = (function (t, e, i) {
        let n, o;
        if (void 0 === e || void 0 === i) {
          ...
          if (s) {
            ...
            (e = t.width - l.width - r.width),
              ...
              (n = ne(a.maxWidth, s, "clientWidth")),
              (o = ne(a.maxHeight, s, "clientHeight"));
          } else (e = t.clientWidth), (i = t.clientHeight);
        }
        return { width: e, height: i, maxWidth: n || gt, maxHeight: o || gt };
      })(t, e, i);
    let { width: c, height: h } = l;
    if ("content-box" === o.boxSizing) {
      const t = re(o, "border", "width"),
        e = re(o, "padding");
    ...
    return (
      ...
      {
        width: ce(Math.min(c, a, l.maxWidth)),
        height: ce(Math.min(h, r, l.maxHeight)),
      }
    );
  }
  function de(t, e, i) {
  ...
  function be(t, e, i, n, o) {
    ...
    let a = Number.POSITIVE_INFINITY,
      r = [];
    if (!jt(e, t.chartArea)) return r;
    return (
      me(t, i, e, function (t, i, l) {
  ...
  var ye = {
    modes: {
      index(t, e, i, n) {
        const o = ge(e, t),
          s = i.axis || "x",
          a = i.intersect ? xe(t, o, s, n) : be(t, o, s, !1, n),
          r = [];
        return a.length
      ...
      dataset(t, e, i, n) {
        const o = ge(e, t),
          s = i.axis || "xy";
        let a = i.intersect ? xe(t, o, s, n) : be(t, o, s, !1, n);
        if (a.length > 0) {
      ...
      point: (t, e, i, n) => xe(t, ge(e, t), i.axis || "xy", n),
      nearest: (t, e, i, n) => be(t, ge(e, t), i.axis || "xy", i.intersect, n),
      x: (t, e, i, n) => ((i.axis = "x"), _e(t, e, i, n)),
      y: (t, e, i, n) => ((i.axis = "y"), _e(t, e, i, n)),
    },
  };
  const ve = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/);
  function Me(t, e) {
    const i = ("" + t).match(ve);
  ...
  function De(t, e) {
    ...
    const n = {
      ...
      lineHeight: Me(X(t.lineHeight, e.lineHeight), i),
      size: i,
      style: X(t.style, e.style),
      weight: X(t.weight, e.weight),
      string: "",
    };
    return (n.string = Ft(n)), n;
  }
  function Oe(t, e, i, n) {
    let o,
      s,
  ...
  const Ce = ["left", "top", "right", "bottom"];
  function Ae(t, e) {
    return t.filter((t) => t.pos === e);
  }
  function Te(t, e) {
    return t.filter((t) => -1 === Ce.indexOf(t.pos) && t.box.axis === e);
  }
  function Le(t, e) {
    return t.sort((t, i) => {
      const n = e ? i : t,
  ...
  function Ee(t, e, i) {
    ...
    const s = Math.max(0, e.outerWidth - Re(o, t, "left", "right")),
      a = Math.max(0, e.outerHeight - Re(o, t, "top", "bottom"));
    return s !== t.w || a !== t.h
  ...
  function Fe(t, e, i) {
    ...
    for (o = 0, s = t.length; o < s; ++o)
      (a = t[o]),
        (r = a.box),
        r.update(a.width || e.w, a.height || e.h, ze(a.horizontal, e)),
        Ee(e, i, a) && ((c = !0), n.length && (l = !0)),
        r.fullSize || n.push(a);
    return (l && Fe(n, e, i)) || c;
  }
  function Ie(t, e, i) {
  ...
  ht.set("layout", { padding: { top: 0, right: 0, bottom: 0, left: 0 } });
  var Ve = {
    addBox(t, e) {
      t.boxes || (t.boxes = []),
    ...
    update(t, e, i) {
      ...
      !(function (t, e) {
        ...
        q(a.chartArea, (e) => {
          const i = e.box;
          Object.assign(i, t.chartArea), i.update(h.w, h.h);
        });
    },
  };
  class Be {
  ...
  const We = {
    ...
    je = (t) => null === t || "" === t;
  const He = !!ue && { passive: !0 };
  function Ye(t, e, i) {
    t.canvas.removeEventListener(e, i, He);
  }
  function $e(t, e, i) {
    const n = t.canvas,
      o = (n && ie(n)) || n,
  ...
  function Ge(t, i, n) {
    ...
    return (
      r.observe(s),
      (function (t, e) {
        Xe.size || window.addEventListener("resize", qe), Xe.set(t, e);
      })(t, a),
      r
    );
  }
  function Ze(t, e, i) {
    i && i.disconnect(),
      "resize" === e &&
        (function (t) {
          Xe.delete(t), Xe.size || window.removeEventListener("resize", qe);
        })(t);
  }
  function Qe(t, i, n) {
    const o = t.canvas,
  ...
  class Je extends Be {
    ...
    addEventListener(t, e, i) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        o = { attach: $e, detach: Ue, resize: Ge }[e] || Qe;
      n[e] = o(t, e, i);
    }
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: Ze, detach: Ze, resize: Ze }[e] || Ye)(t, e, n),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  const ei = {
      ...
      easeInElastic(t) {
        ...
        return 0 === t
          ...
          : (i || (i = 0.3),
            (e = (i / ut) * Math.asin(1)),
            -1 * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * ut) / i));
      },
      easeOutElastic(t) {
        let e = 1.70158,
          i = 0;
        return 0 === t
          ...
          : (i || (i = 0.3),
            (e = (i / ut) * Math.asin(1)),
            1 * Math.pow(2, -10 * t) * Math.sin(((t - e) * ut) / i) + 1);
      },
      easeInOutElastic(t) {
        let e = 1.70158,
          i = 0;
      ...
      easeInOutBounce: (t) =>
        t < 0.5
          ? 0.5 * ei.easeInBounce(2 * t)
          : 0.5 * ei.easeOutBounce(2 * t - 1) + 0.5,
    },
    ii = "transparent",
    ni = {
  ...
  class oi {
    constructor(t, e, i, n) {
      ...
      const s = Oe([t.from, o, n]);
      (this._active = !0),
        (this._fn = t.fn || ni[t.type || typeof s]),
        (this._easing = ei[t.easing] || ei.linear),
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._loop = !!t.loop),
          (n._to = Oe([t.to, e, o, t.from])),
          (n._from = Oe([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  const si = Object.keys(ht.animation);
  ht.describe("animation", {
    ...
    ht.describe("animations", { _fallback: "animation" }),
    ht.set("transitions", {
      ...
      hide: {
        animations: {
          ...
          visible: { type: "boolean", fn: (t) => (t < 1 ? 0 : 1) },
        },
      },
    });
  class ai {
  ...
  function ci(t, e, i, n) {
    ...
    for (s = 0, a = o.length; s < a; ++s) {
      ...
      (l = t.values[r]), isNaN(l) || (0 !== e && Pt(e) !== Pt(l)) || (e += l);
    }
    return e;
  }
  function hi(t, e) {
  ...
  function ui(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: n, [c]: s } = i;
      (u = (i._stacks || (i._stacks = {}))[c] = di(o, h, n)), (u[r] = s);
    }
  }
  function fi(t, e) {
    const i = t.scales;
  ...
  class xi {
    ...
    linkScales() {
      const t = this,
        ...
        s = (i.xAxisID = X(n.xAxisID, fi(e, "x"))),
        a = (i.yAxisID = X(n.yAxisID, fi(e, "y"))),
        r = (i.rAxisID = X(n.rAxisID, fi(e, "r"))),
        l = i.indexAxis,
    ...
    _destroy() {
      ...
      this._data && te(this._data, this), t._stacked && gi(t);
    }
    _dataCheck() {
      const t = this,
        e = t.getDataset(),
      ...
      Y(i)
        ...
        : t._data !== i &&
          (t._data && te(t._data, t),
          i && Object.isExtensible(i) && Jt(i, t),
          (t._data = i));
    }
    addElements() {
      const t = this,
    ...
    buildOrUpdateElements(t) {
      ...
      let o = !1;
      e._dataCheck(),
        (i._stacked = hi(i.vScale, i)),
        i.stack !== n.stack && ((o = !0), gi(i), (i.stack = n.stack)),
        e._resyncElements(t),
        o && ui(e, i._parsed);
    }
    configure() {
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (c = 0, h = n; c < h; ++c)
        (d = c + i),
          (u = e[d]),
          (l[c] = { x: o.parse(ot(u, a), d), y: s.parse(ot(u, r), d) });
      return l;
    }
    getParsed(t) {
    ...
    applyStack(t, e) {
      const i = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return ci({ keys: li(i, !0), values: e._stacks[t.axis] }, o, n.index);
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (o = ci(n, o, this._cachedMeta.index, !0))),
        (t.min = Math.min(t.min, o)),
        (t.max = Math.max(t.max, o));
    }
    getMinMax(t, e) {
      const i = this,
        ...
        l = e && n._stacked && { keys: li(i.chart, !0), values: null },
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        g.$shared && ((g.$shared = l), (s[a] = Object.freeze(mi(g, l)))), g
      );
    }
    _resolveAnimations(t, e, i) {
      ...
      const c = new ai(o, l && l.animations);
    ...
    updateElement(t, e, i, n) {
      pi(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
    }
  ...
  (xi.defaults = {}),
    (xi.prototype.datasetElementType = null),
    (xi.prototype.dataElementType = null);
  class bi {
    constructor() {
      (this.x = void 0),
        (this.y = void 0),
  ...
  (bi.defaults = {}), (bi.defaultRoutes = void 0);
  const _i = new Map();
  function yi(t, e, i) {
    return (function (t, e) {
      e = e || {};
      ...
      let n = _i.get(i);
      return n || ((n = new Intl.NumberFormat(t, e)), _i.set(i, n)), n;
    })(e, i).format(t);
  }
  const vi = {
    values: (t) => (H(t) ? t : "" + t),
    numeric(t, e, i) {
      ...
      const r = yt(Math.abs(a)),
        l = Math.max(Math.min(-1 * Math.floor(r), 20), 0),
        c = { notation: s, minimumFractionDigits: l, maximumFractionDigits: l };
      return Object.assign(c, this.options.ticks.format), yi(t, n, c);
    },
    logarithmic: function (t, e, i) {
      if (0 === t) return "0";
      const n = t / Math.pow(10, Math.floor(yt(t)));
      return 1 === n || 2 === n || 5 === n
        ? vi.numeric.call(this, t, e, i)
        : "";
    },
  };
  var Mi = { formatters: vi };
  function wi(t, e) {
    const i = [],
      n = t.length / e,
      o = t.length;
  ...
  ht.set("scale", {
    ...
    ht.route("scale.ticks", "color", "", "color"),
    ht.route("scale.gridLines", "color", "", "borderColor"),
    ht.route("scale.scaleLabel", "color", "", "color"),
    ht.describe("scale", {
      _fallback: !1,
      _scriptable: (t) =>
        !t.startsWith("before") &&
    ...
    ht.describe("scales", { _fallback: "scale" });
  class Oi extends bi {
    constructor(t) {
      super(),
        (this.id = t.id),
    ...
    calculateLabelRotation() {
      ...
      const h = t._getLabelSizes(),
        ...
        f = Math.min(t.maxWidth, t.chart.width - d);
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            Pi(e.gridLines) -
            i.padding -
            Si(e.scaleLabel, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = Dt(
            Math.min(
        ...
        if (
          ...
          if (H(g))
            for (u = 0, f = g.length; u < f; ++u)
              (v = g[u]),
                j(v) || H(v) || ((_ = It(e, x.data, x.gc, _, v)), (y += b));
        } else (_ = It(e, x.data, x.gc, _, g)), (y = b);
        o.push(_),
          s.push(y),
          a.push(b / 2),
          (r = Math.max(_, r)),
    ...
    getPixelForDecimal(t) {
      const e = this;
      return e._reversePixels && (t = 1 - t), zt(e._startPixel + t * e._length);
    }
    ...
    _autoSkip(t) {
      ...
      if (s > 0) {
        ...
        for (Di(t, l, c, j(n) ? 0 : a - n, a), e = 0, i = s - 1; e < i; e++)
          Di(t, l, c, o[e], o[e + 1]);
        return Di(t, l, c, r, j(n) ? t.length : r + n), l;
      }
      return Di(t, l, c), l;
    }
    _tickSize() {
          ...
          ? ((_ = M),
            "top" === o
              ? "near" === c || 0 !== f
                ...
                : "center" === c
                ? ((S = (O.highest.height / 2) * -1), (S -= i * k))
                : (S = -1 * O.highest.height + 0.5 * k)
              : "near" === c || 0 !== f
              ? ((S = Math.sin(f) * i * k),
                (S += (0 === f ? 0.5 : Math.cos(f) * i) * k))
              : "center" === c
              ? ((S = O.highest.height / 2), (S -= i * k))
              : (S = O.highest.height - (P - 0.5) * k))
          : ((y = M), (S = ((1 - P) * k) / 2)),
          g.push({
            rotation: f,
            label: b,
    ...
    _getXAxisLabelAlignment() {
      ...
      if (-St(this.labelRotation)) return "top" === t ? "left" : "right";
      let i = "center";
      return (
    ...
    drawGrid(t) {
      ...
      if (a) {
        ...
        e.isHorizontal()
          ? ((l = Bt(o, e.left, a) - a / 2),
            (c = Bt(o, e.right, s) + s / 2),
            (h = d = r))
          : ((h = Bt(o, e.top, a) - a / 2),
            (d = Bt(o, e.bottom, s) + s / 2),
            (l = c = r)),
          (n.lineWidth = a),
    ...
    drawLabels(t) {
      ...
      for (s = 0, a = o.length; s < a; ++s) {
        const t = o[s],
          e = t.font;
        Xt(i, t.label, 0, t.textOffset, e, t);
      }
      n && Yt(i);
    }
    drawTitle(t) {
  ...
  Oi.prototype._draw = Oi.prototype.draw;
  class Ci {
    constructor(t, e) {
      ...
      return (
        o in n ||
          ...
          (function (t, e, i) {
            ...
            t.descriptors && ht.describe(e, t.descriptors);
          })(t, a, i)),
        a
      );
    }
    ...
    unregister(t) {
      const e = this.items,
        i = t.id,
        n = this.scope;
      i in e && delete e[i], n && i in ht[n] && delete ht[n][i];
    }
  }
  var Ai = new (class {
    constructor() {
      (this.controllers = new Ci(xi, "controllers")),
        (this.elements = new Ci(bi, "elements")),
        (this.plugins = new Ci(Object, "plugins")),
        (this.scales = new Ci(Oi, "scales")),
  ...
  class Ti {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        o = (function (t) {
          const e = [],
            i = Object.keys(Ai.plugins.items);
          for (let t = 0; t < i.length; t++) e.push(Ai.getPlugin(i[t]));
          const n = t.plugins || [];
        ...
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Li(i[r.id], n);
              null !== l &&
                o.push({ plugin: r, options: Ri(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  function Ei(t, e = [""], i = t, n) {
    at(n) || (n = Hi("_fallback", t));
    const o = {
      ...
      get: (i, n) =>
        Bi(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e)
              if (((o = Hi(Ii(s, t), i)), at(o)))
                return Vi(t, o) ? ji(i, n, t, o) : o;
          })(n, e, t, i)
        ),
      getOwnPropertyDescriptor: (t, e) =>
        Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
      getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
      has: (t, e) => Yi(t).includes(e),
      ownKeys: (t) => Yi(t),
      set: (e, i, n) => ((t[0][i] = n), delete e[i]),
    });
  }
  function zi(t, e, i) {
    const n = {
      ...
      _stack: new Set(),
      _descriptors: Fi(t),
      setContext: (e) => zi(t, e, i),
      override: (n) => zi(t.override(n), e, i),
    };
    return new Proxy(n, {
      get: (t, e, i) =>
        Bi(t, e, () =>
            ...
            rt(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                r.add(t),
                  (e = e(s, a || n)),
                  r.delete(t),
                  Y(e) && (e = ji(o._scopes, o, t, e));
                return e;
              })(e, r, t, i));
            H(r) &&
              r.length &&
              (r = (function (t, e, i, n) {
                const { _proxy: o, _context: s, _subProxy: a } = i;
                if (at(s.index) && n(t)) e = e[s.index % e.length];
                else if (Y(e[0])) {
                  const i = e,
      ...
      set: (e, i, n) => ((t[i] = n), delete e[i]),
    });
  }
  function Fi(t) {
    const { _scriptable: e = !0, _indexable: i = !0 } = t;
    return {
      isScriptable: rt(e) ? e : () => e,
      isIndexable: rt(i) ? i : () => i,
    };
  }
  const Ii = (t, e) => (t ? t + st(e) : e),
    Vi = (t, e) => Y(e);
  function Bi(t, e, i) {
    let n = t[e];
    return at(n) || ((n = i()), at(n) && (t[e] = n)), n;
  }
  const Ni = (t, e) => (!0 === t ? e : ot(e, t));
  function Wi(t, e, i, n) {
    for (const o of e) {
      const e = Ni(i, o);
      if (e) {
        t.add(e);
        const o = e._fallback;
        if (at(o) && o !== i && o !== n) return o;
      } else if (!1 === e && "fill" !== i) return null;
    }
    return !1;
  }
  function ji(t, e, i, n) {
    const o = e._rootScopes,
      ...
      r = new Set([n]);
    let l = i;
    for (; !1 !== l; ) if (((l = Wi(r, a, l, s)), null === l)) return !1;
    if (at(s) && s !== i) {
      const t = a;
      for (l = s; !1 !== l; ) l = Wi(r, t, l, s);
    }
    return Ei([...r], [""], o, s);
  }
  function Hi(t, e) {
  ...
  function $i(t, e) {
    const i = (ht.controllers[t] || {}).datasets || {};
    return (
  ...
  function Xi(t, e) {
    return (
      ((e = e || {}).plugins = X(e.plugins, {})),
      (e.scales = (function (t, e) {
        const i = ht.controllers[t.type] || { scales: {} },
          n = e.scales || {},
          o = $i(t.type, e),
        ...
        return (
          Object.keys(n).forEach((t) => {
            const e = n[t],
              ...
              c = i.scales || {};
            (s[r] = s[r] || t),
              (a[t] = et(Object.create(null), [{ axis: r }, e, c[r], c[l]]));
          }),
          t.data.datasets.forEach((i) => {
            const o = i.type || t.type,
              r = i.indexAxis || $i(o, e),
              l = (ht.controllers[o] || {}).scales || {};
            Object.keys(l).forEach((t) => {
              ...
              (a[o] = a[o] || Object.create(null)),
                et(a[o], [{ axis: e }, n[o], l[t]]);
            });
          }),
          Object.keys(a).forEach((t) => {
            const e = a[t];
            et(e, [ht.scales[e.type], ht.scale]);
          }),
          a
        );
      })(t, e)),
  ...
  function Gi(t, e) {
    let i = Ki.get(t);
    return i || ((i = e()), Ki.set(t, i), qi.add(i)), i;
  }
  const Zi = (t, e, i) => {
    const n = ot(e, i);
    void 0 !== n && t.add(n);
  ...
  class Qi {
    ...
    update(t) {
      ...
      this.clearCache(), (e.options = Xi(e, t));
    }
    clearCache() {
    ...
    datasetAnimationScopeKeys(t, e) {
      return Gi(`${t}.transition.${e}`, () => [
        ...
        `controllers.${t}.transitions.${e}`,
        `controllers.${t}.datasets.transitions.${e}`,
        "transitions." + e,
        "datasets." + t,
        "controllers." + t,
        `controllers.${t}.datasets`,
    ...
    pluginScopeKeys(t) {
      ...
      return Gi(`${i}-plugin-${e}`, () => [
        `controllers.${i}.plugins.${e}`,
        "plugins." + e,
        ...(t.additionalOptionScopes || []),
      ]);
    }
    getOptionScopes(t, e, i) {
      let n = this._scopeCache.get(t);
      (n && !i) || ((n = new Map()), this._scopeCache.set(t, n));
      const o = n.get(e);
      if (o) return o;
      const s = new Set();
      t && (s.add(t), e.forEach((e) => Zi(s, t, e))),
        e.forEach((t) => Zi(s, this.options, t)),
        e.forEach((t) => Zi(s, ht, t)),
        e.forEach((t) => Zi(s, ht.descriptors, t));
      const a = [...s];
      return qi.has(e) && n.set(e, a), a;
    }
    chartOptionScopes() {
      return [
        this.options,
        ht.controllers[this.type] || {},
        { type: this.type },
        ht,
        ht.descriptors,
      ];
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = Ji(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
          const { isScriptable: i, isIndexable: n } = Fi(t);
          for (const o of e)
            if ((i(o) && rt(t[o])) || (n(o) && H(t[o]))) return !0;
          return !1;
        })(s, e)
      ) {
        o.$shared = !1;
        r = zi(s, (i = rt(i) ? i() : i), this.createResolver(t, i, a));
      }
      for (const t of e) o[t] = r[t];
      return o;
    }
    createResolver(t, e, i = [""]) {
      const { resolver: n } = Ji(this._resolverCache, t, i);
      return Y(e) ? zi(n, rt(e) ? e() : e) : n;
    }
  }
  function Ji(t, e, i) {
    let n = t.get(e);
  ...
  const tn = ["top", "bottom", "left", "right", "chartArea"];
  function en(t, e) {
  ...
  class hn {
    constructor(t, e) {
      ...
      (this.id = W()),
        ...
        (ln[i.id] = i),
        r && l
          ? (o.listen(i, "complete", on),
            o.listen(i, "progress", sn),
            i._initialize(),
            i.attached && i.update())
          : console.error(
    ...
    _initialize() {
      ...
      return (
        ...
        t.options.responsive ? t.resize() : de(t, t.options.devicePixelRatio),
        t.bindEvents(),
      ...
      i &&
        ...
        q(s, (i) => {
          const s = i.options,
            ...
            r = Ui(a, s),
            l = X(s.type, i.dtype);
          (void 0 !== s.position && en(s.position, r) === en(i.dposition)) ||
        ...
        q(n, (e) => {
          Ve.configure(t, e, e.options), Ve.addBox(t, e);
        });
    }
    ...
    _updateMetasets() {
      ...
      t._sortedMetasets = e.slice(0).sort(nn("order", "index"));
    }
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          const i = ht.controllers[a],
            o = Ai.getController(a);
          Object.assign(o.prototype, {
            dataElementType: Ai.getElement(i.dataElementType),
            datasetElementType:
              i.datasetElementType && Ai.getElement(i.datasetElementType),
          }),
    ...
    bindEvents() {
      ...
      if ((q(t.options.events, (t) => n(t, s)), t.options.responsive)) {
        let e;
        s = (e, i) => {
    ...
    _handleEvent(t, e) {
      ...
      return (
        ...
        K(o.onHover || s.onHover, [t, r, i], i),
        ("mouseup" !== t.type &&
          "click" !== t.type &&
          "contextmenu" !== t.type) ||
          (jt(t, i.chartArea) && K(o.onClick, [t, r, i], i)),
        (l = !G(r, n)),
  ...
  const dn = () => q(hn.instances, (t) => t._plugins.invalidate()),
    un = !0;
  Object.defineProperties(hn, {
    defaults: { enumerable: un, value: ht },
    instances: { enumerable: un, value: ln },
    registry: { enumerable: un, value: Ai },
    version: { enumerable: un, value: "3.0.0-beta.11" },
    getChart: { enumerable: un, value: cn },
    register: {
      enumerable: un,
      value: (...t) => {
        Ai.add(...t), dn();
  ...
  function xn(t, e, i, n) {
    ...
    if (
      ...
      for (o = 0, s = t.length; o < s; ++o)
        (a = t[o]),
          (r = gn(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension)),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (o = t[i]),
            jt(o, e) &&
              (i > 0 &&
                jt(t[i - 1], e) &&
                ((o.controlPointPreviousX = mn(
                  o.controlPointPreviousX,
                  e.left,
                  e.right
                )),
                (o.controlPointPreviousY = mn(
              ...
              i < t.length - 1 &&
                jt(t[i + 1], e) &&
                ((o.controlPointNextX = mn(
                  o.controlPointNextX,
                  e.left,
                  e.right
                )),
                (o.controlPointNextY = mn(
                  o.controlPointNextY,
                  e.top,
                  e.bottom
                ))));
  ...
  function kn(t) {
    return "angle" === t
      ? { between: Rt, compare: Tt, normalize: Lt }
      : {
  ...
  function Sn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      a = e.length,
      { compare: r, between: l, normalize: c } = kn(n),
      {
        start: h,
        end: d,
        loop: u,
    ...
    for (let t = h, i = h; t <= d; ++t)
      (p = e[t % a]),
        p.skip ||
          ...
          null !== b && y() && (f.push(Pn(b, t, u, a)), (b = null)),
          (i = t),
          (m = g));
    return null !== b && f.push(Pn(b, d, u, a)), f;
  }
  function Dn(t, e) {
    const i = [],
      n = t.segments;
    for (let o = 0; o < n.length; o++) {
      const s = Sn(n[o], t.points, e);
      s.length && i.push(...s);
    }
    return i;
  }
  ...
  var Cn = Object.freeze({
    ...
    _rlookupByKey: Gt,
    _filterBetween: Zt,
    listenArrayEvents: Jt,
    unlistenArrayEvents: te,
    _arrayUnique: ee,
    _createResolver: Ei,
    _attachContext: zi,
    _descriptors: Fi,
    splineCurve: gn,
    splineCurveMonotone: pn,
    _updateBezierControlPoints: xn,
    _getParentNode: ie,
    getStyle: se,
    getRelativePosition: le,
    getMaximumSize: he,
    retinaScale: de,
    supportsEventListenerOptions: ue,
    readUsedSize: fe,
    _pointInLine: bn,
    _steppedInterpolation: _n,
    _bezierInterpolation: yn,
    toLineHeight: Me,
    toTRBL: ke,
    toTRBLCorners: Pe,
    toPadding: Se,
    ...
    almostEquals: Mt,
    almostWhole: wt,
    _setMinAndMaxByKey: kt,
    sign: Pt,
    toRadians: St,
    toDegrees: Dt,
    _decimalPlaces: Ot,
    getAngleFromPoint: Ct,
    distanceBetweenPoints: At,
    _angleDiff: Tt,
    _normalizeAngle: Lt,
    _angleBetween: Rt,
    _limitValue: Et,
  ...
  function Rn(t) {
    const e = (function (t) {
      if (!t._cache.$bar) {
        ...
        t._cache.$bar = ee(i.sort((t, e) => t - e));
      }
      return t._cache.$bar;
    })(t);
    let i,
  ...
  class In extends xi {
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (d = i, u = i + n; d < u; ++d)
        (g = e[d]),
          (f = {}),
          (f[o.axis] = o.parse(ot(g, l), d)),
          h.push(En(ot(g, c), f, s, d));
      return h;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    draw() {
      const t = this,
        ...
        s = o.length;
      let a = 0;
      for (Ht(e.ctx, e.chartArea); a < s; ++a)
  ...
  class Bn extends xi {
    ...
    update(t) {
      const e = this,
        ...
        o = e._cachedMeta,
        s = o.data,
        a = e.options.cutoutPercentage / 100 || 0,
        r = e._getRingWeight(e.index),
        { circumference: l, rotation: c } = e._getRotationExtents(),
        {
          ratioX: h,
          ratioY: d,
          offsetX: u,
          ...
          if (e < ut) {
            ...
            const l = r + e,
              ...
              g = (r <= mt && l >= mt) || l >= ut + mt,
              p = (r <= -mt && l >= -mt) || l >= dt + mt,
              m = r === -dt || l >= dt ? -1 : Math.min(c, c * i, d, d * i),
              x = p ? -1 : Math.min(h, h * i, u, u * i),
              b = f ? 1 : Math.max(c, c * i, d, d * i),
              _ = g ? 1 : Math.max(h, h * i, u, u * i);
            (n = (b - m) / 2),
              (o = (_ - x) / 2),
              (s = -(b + m) / 2),
              (a = -(_ + x) / 2);
        ...
        g = e.getMaxBorderWidth() + e.getMaxOffset(s),
        p = (n.right - n.left - g) / h,
        m = (n.bottom - n.top - g) / d,
        x = Math.max(Math.min(p, m) / 2, 0),
        b = (x - Math.max(x * a, 0)) / e._getVisibleDatasetWeightTotal();
      (e.offsetX = u * x),
        (e.offsetY = f * x),
        (o.total = e.calculateTotal()),
        (e.outerRadius = x - b * e._getRingWeightOffset(e.index)),
        (e.innerRadius = Math.max(e.outerRadius - b * r, 0)),
    ...
    _circumference(t, e) {
      ...
      return e && n.animation.animateRotate
        ...
        ? i.calculateCircumference((o._parsed[t] * s) / ut)
        : 0;
    }
    updateElements(t, e, i, n) {
      const o = this,
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        i = this.chart,
        n = i.data.labels || [],
        o = yi(e._parsed[t], i.options.locale);
  ...
  (Bn.id = "doughnut"),
    (Bn.defaults = {
      ...
      aspectRatio: 1,
      datasets: { cutoutPercentage: 50, rotation: 0, circumference: 360 },
      indexAxis: "r",
      plugins: {
        legend: {
          labels: {
  ...
  class Nn extends xi {
    ...
    update(t) {
        ...
        if (t._sorted) {
          ...
          d &&
            (o = Et(
              Math.min(
                qt(r, a.axis, c).lo,
                i ? n : qt(e, l, a.getPixelForValue(c)).lo
              ),
              0,
              n - 1
            )),
            (s = u
              ? Et(
                  Math.max(
                    qt(r, a.axis, h).hi + 1,
                    i ? 0 : qt(e, l, a.getPixelForValue(h)).hi + 1
                  ),
                  o,
                  n
                ) - o
      ...
      if (
        ...
        e.options.showLine || (i.borderWidth = 0),
          e.updateElement(n, void 0, { animated: !s, options: i }, t);
      }
    ...
    updateElements(t, e, i, n) {
      const o = this,
        ...
        f = vt(u) ? u : Number.POSITIVE_INFINITY,
  ...
  (Nn.id = "line"),
    (Nn.defaults = {
      ...
      dataElementType: "point",
      datasets: { showLine: !0, spanGaps: !1 },
      interaction: { mode: "index" },
      hover: {},
  ...
  class Wn extends xi {
    ...
    _computeAngle(t, e, i) {
      return this.chart.getDataVisibility(t)
        ? St(this.resolveDataElementOptions(t, e).angle || i)
        : 0;
    }
  }
  (Wn.id = "polarArea"),
  ...
  (jn.id = "pie"),
    (jn.defaults = {
      datasets: { cutoutPercentage: 0, rotation: 0, circumference: 360 },
    });
  class Hn extends xi {
    getLabelAndValue(t) {
    ...
    r.borderWidth &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          for (
            i &&
              ((e.endAngle = e.startAngle + ut),
              Un(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle &&
                ((e.endAngle += ut), e.fullCircles--)),
              t.beginPath(),
              t.arc(n, o, c, s + ut, s, !0),
              h = 0;
            h < e.fullCircles;
            ++h
          )
            t.stroke();
          for (
            t.beginPath(), t.arc(n, o, l, s, s + ut), h = 0;
            h < e.fullCircles;
            ++h
          )
            t.stroke();
  ...
  class qn extends bi {
    ...
    inRange(t, e, i) {
      const n = this.getProps(["x", "y"], i),
        { angle: o, distance: s } = Ct(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      ...
      if (
        ...
        (e.fullCircles = Math.floor(e.circumference / ut)),
        !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0))
      ) {
        if ((t.save(), n && e.circumference < ut)) {
        ...
        (t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              (e.endAngle = e.startAngle + ut), Xn(t, e);
              for (let i = 0; i < e.fullCircles; ++i) t.fill();
              e.endAngle = e.startAngle + (e.circumference % ut);
            }
            Xn(t, e), t.fill();
          })(t, e),
          Kn(t, e),
  ...
  function Qn(t, e, i, n) {
    const { points: o, options: s } = e,
      { count: a, start: r, loop: l, ilen: c } = Zn(o, i, n),
      h = (function (t) {
        return t.stepped ? $t : t.tension ? Ut : Gn;
      })(s);
    let d,
      u,
      f,
  ...
  function Jn(t, e, i, n) {
    const o = e.points,
      { count: s, start: a, ilen: r } = Zn(o, i, n),
  ...
  function to(t) {
    ...
    return !(t._loop || e.tension || e.stepped || i) ? Jn : Qn;
  }
  (qn.id = "arc"),
    (qn.defaults = {
      borderAlign: "center",
    ...
    (qn.defaultRoutes = { backgroundColor: "backgroundColor" });
  class eo extends bi {
    constructor(t) {
      super(),
        (this.animated = !0),
    ...
    updateControlPoints(t) {
      ...
      if (i.tension && !i.stepped && !e._pointsUpdated) {
        ...
        xn(e._points, i, t, n), (e._pointsUpdated = !0);
      }
    }
    set points(t) {
      const e = this;
    ...
    get segments() {
      return this._segments || (this._segments = On(this));
    }
    first() {
    ...
    interpolate(t, e) {
      ...
      const r = [],
        l = (function (t) {
          return t.stepped ? _n : t.tension ? yn : bn;
        })(n);
      let c, h;
  ...
  function oo(t) {
    ...
    return e
      ? ((e = t.horizontal
          ? so(e, "left", "right", t.base > t.x)
          : so(e, "bottom", "top", t.base < t.y)),
        (i[e] = !0),
        i)
      : i;
  }
    ...
    const e = no(t),
      ...
      o = (function (t, e, i) {
        const n = t.options.borderWidth,
          ...
          s = ke(n);
        return {
          t: ro(o.top, s.top, 0, i),
          r: ro(o.right, s.right, 0, e),
          b: ro(o.bottom, s.bottom, 0, i),
          l: ro(o.left, s.left, 0, e),
        };
      })(t, i / 2, n / 2),
      s = (function (t, e, i) {
        const n = Pe(t.options.borderRadius),
          o = Math.min(e, i),
          s = oo(t);
        return {
          topLeft: ro(s.top || s.left, n.topLeft, 0, o),
          topRight: ro(s.top || s.right, n.topRight, 0, o),
          bottomLeft: ro(s.bottom || s.left, n.bottomLeft, 0, o),
          bottomRight: ro(s.bottom || s.right, n.bottomRight, 0, o),
        };
      })(t, i / 2, n / 2);
    return {
  ...
  function ho(t, e) {
    ...
    t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -mt, dt, !0),
      t.lineTo(i, n + s - a.bottomLeft),
      t.arc(i + a.bottomLeft, n + s - a.bottomLeft, a.bottomLeft, dt, mt, !0),
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        const { _data: s, indexAxis: a } = e,
          ...
          l = s || e.data;
        if ("y" === Oe([a, t.options.indexAxis])) return;
    ...
    const { chart: e, scale: i, index: n, line: o } = t,
      ...
      l = (function (t, e) {
        ...
        for (let t = 0; t < n.length; t++) {
          const o = n[t];
          if (o.index === e) break;
          yo(o) && i.unshift(o.dataset);
        }
        return i;
      })(e, n);
    l.push(wo({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) vo(s, r[t], l);
    }
    return new eo({ points: s, options: {} });
  }
  const yo = (t) => "line" === t.type && !t.hidden;
  function vo(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = Mo(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function Ao(t, e) {
    const { line: i, target: n, property: o, color: s, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (let t = 0; t < n.length; t++) {
          const r = n[t],
            l = So(i, o[r.start], o[r.end], r.loop);
          if (!e.segments) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              n = So(i, s[e.start], s[e.end], e.loop),
              h = Sn(r, o, n);
            for (let t = 0; t < h.length; t++)
              a.push({
                source: h[t],
                target: e,
                start: { [i]: Do(l, n, "start", Math.max) },
                end: { [i]: Do(l, n, "end", Math.min) },
              });
          }
        }
        return a;
    ...
    for (let e = 0, s = r.length; e < s; ++e) {
      ...
      t.save(), Oo(t, a, So(o, c, h)), t.beginPath();
      const d = !!i.pathSegment(t, s);
      d ? t.closePath() : Co(t, n, h, o);
  ...
  var To = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          s.push(c);
      for (r = 0; r < n; ++r)
        (c = s[r]), c && !1 !== c.fill && (c.fill = ko(s, r, o));
    },
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          if ("stack" === i) return _o(t);
          const o = bo(t);
          return o instanceof xo ? o : wo(o, n);
        })(o),
        { line: a, scale: r } = o,
        l = a.options,
        c = l.fill,
        ...
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              s !== o &&
              (Po(t, n, a.top),
              Ao(t, { line: i, target: n, color: o, scale: r, property: l }),
              t.restore(),
              t.save(),
              Po(t, n, a.bottom)),
            Ao(t, { line: i, target: n, color: s, scale: r, property: l }),
            t.restore();
  ...
  class Ro extends bi {
    ...
    buildLabels() {
      const t = this,
        e = t.options.labels || {};
      let i = K(e.generateLabels, [t.chart], t) || [];
    ...
    fit() {
      ...
      const n = e.labels,
        ...
        { boxWidth: r, itemHeight: l } = Lo(n, s);
      let c, h;
      (i.font = o.string),
        t.isHorizontal()
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (s.fillStyle = u),
        (s.font = d.string);
      const { boxWidth: m, boxHeight: x, itemHeight: b } = Lo(l, g),
        _ = t.isHorizontal(),
      ...
      t.legendItems.forEach((e, u) => {
        ...
        !(function (t, e, i) {
          ...
          (function (t, e, i) {
            const n = g / 2,
              o = h.xPlus(t, m + n);
            Xt(s, i.text, o, e + b / 2, d, { strikethrough: i.hidden });
          })(S, P, e),
          _ ? (p.x += w + f) : (p.y += v);
      }),
    ...
    drawTitle() {
      const t = this,
        ...
        a = Se(o.padding);
      if (!o.display) return;
      const r = vn(e.rtl, t.left, t.width),
        l = t.ctx,
        c = o.position,
        h = s.size / 2,
        d = a.top + h;
    ...
    handleEvent(t) {
      ...
      if ("mousemove" === t.type) {
        ...
        o && o !== n && K(i.onLeave, [t, o, e], e),
          (e._hoveredItem = n),
          n && K(i.onHover, [t, n, e], e);
      } else n && K(i.onClick, [t, n, e], e);
    }
  }
  var Eo = {
    id: "legend",
    ...
    start(t, e, i) {
      ...
      Ve.configure(t, n, i), Ve.addBox(t, n);
    },
    stop(t) {
    ...
    beforeUpdate(t, e, i) {
      const n = t.legend;
      Ve.configure(t, n, i), (n.options = i);
    },
    afterUpdate(t) {
  ...
  class zo extends bi {
    ...
    update(t, e) {
      ...
      const s = o * De(n.font).lineHeight + i._padding.height;
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ...
          : ("left" === a.position
              ? ((c = i + t), (h = n(r, o, e)), (d = -0.5 * dt))
              : ((c = s - t), (h = n(r, e, o)), (d = 0.5 * dt)),
            (l = o - e)),
  ...
  function Fo(t, e) {
    ...
    Ve.configure(t, i, e), Ve.addBox(t, i), (t.titleBlock = i);
  }
  var Io = {
    id: "title",
    _element: zo,
    ...
    beforeUpdate(t, e, i) {
      !1 === i
        ? (function (t) {
            const e = t.titleBlock;
            e && (Ve.removeBox(t, e), delete t.titleBlock);
          })(t)
        : (function (t, e) {
            const i = t.titleBlock;
            i ? (Ve.configure(t, i, e), (i.options = e)) : Fo(t, e);
          })(t, i);
    },
    defaults: {
      align: "center",
  ...
  function jo(t) {
    ...
    if (
      ...
      d && (g += d * l.size + (d - 1) * o.titleSpacing + o.titleMarginBottom),
      m)
    ) {
      g +=
    ...
    u && (g += o.footerMarginTop + u * r.size + (u - 1) * o.footerSpacing);
    let x = 0;
    const b = function (t) {
      p = Math.max(p, e.measureText(t).width + x);
    };
    return (
      e.save(),
      (e.font = Ft(l)),
      q(t.title, b),
      (e.font = Ft(a)),
      q(t.beforeBody.concat(t.afterBody), b),
      (x = o.displayColors ? c + 2 : 0),
      q(i, (t) => {
        q(t.before, b), q(t.lines, b), q(t.after, b);
      }),
      (x = 0),
      (e.font = Ft(r)),
      q(t.footer, b),
  ...
  class Xo extends bi {
    ...
    getTitle(t) {
      ...
      let a = [];
      return (a = Bo(a, No(n))), (a = Bo(a, No(o))), (a = Bo(a, No(s))), a;
    }
    getBeforeBody(t) {
      return Uo(this.options.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t) {
      const e = this,
        i = e.options.callbacks,
      ...
      return (
        q(t, (t) => {
          ...
          Bo(o.before, No(i.beforeLabel.call(e, t))),
            Bo(o.lines, i.label.call(e, t)),
            Bo(o.after, No(i.afterLabel.call(e, t))),
            n.push(o);
        }),
        n
      );
    ...
    getAfterBody(t) {
      return Uo(this.options.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t) {
      const e = this,
        i = e.options.callbacks,
    ...
    _createItems() {
      ...
      let r,
        l,
        c = [];
      for (r = 0, l = e.length; r < l; ++r) c.push(Wo(t._chart, e[r]));
      return (
    ...
    update(t) {
      ...
      let o;
      if (n.length) {
        const t = Vo[i.position].call(e, n, e._eventPosition),
          s = e._createItems();
    ...
    drawTitle(t, e) {
      ...
      let a, r, l;
      if (s) {
        const c = vn(n.rtl, i.x, i.width);
        for (
          t.x = $o(i, n.titleAlign),
    ...
    _drawColorBox(t, e, i, n) {
      ...
      if (s.usePointStyle) {
        ...
        (t.strokeStyle = s.multiKeyBackground),
          ...
          Wt(t, e, i, o);
      } else (t.fillStyle = s.multiKeyBackground), t.fillRect(n.leftForLtr(u, c), g, c, l), (t.lineWidth = 1), (t.strokeStyle = a.borderColor), t.strokeRect(n.leftForLtr(u, c), g, c, l), (t.fillStyle = a.backgroundColor), t.fillRect(n.leftForLtr(n.xPlus(u, 1), c - 2), g + 1, c - 2, l - 2);
    ...
    drawBody(t, e) {
      ...
      for (
        ...
        for (
          m = n[_],
            x = i.labelTextColors[_],
            e.fillStyle = x,
            q(m.before, g),
            b = m.lines,
            l &&
              b.length &&
              (i._drawColorBox(e, t, _, f), (d = Math.max(s.size, c))),
            y = 0,
            M = b.length;
          y < M;
          ++y
      ...
      (u = 0), (d = s.size), q(i.afterBody, g), (t.y -= a);
    }
    drawFooter(t, e) {
      const i = this,
        n = i.options,
      ...
      let a, r;
      if (s) {
        const l = vn(n.rtl, i.x, i.width);
        for (
          t.x = $o(i, n.footerAlign),
    ...
    _updateAnimationTarget() {
      const t = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = Vo[i.position].call(t, t._active, t._eventPosition);
        if (!n) return;
        const a = (t._size = jo(t)),
    ...
    _positionChanged(t, e) {
      const i = this,
        n = Vo[i.options.position].call(i, t, e);
  ...
  var Ko = {
      ...
      positioners: Vo,
      afterInit(t, e, i) {
        i && (t.tooltip = new Xo({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
  ...
  function Zo(t) {
    const e = Math.floor(yt(t)),
      i = t / Math.pow(10, e);
    let n;
    return (n = i <= 1 ? 1 : i <= 2 ? 2 : i <= 5 ? 5 : 10), n * Math.pow(10, e);
  }
  (Go.id = "category"),
    (Go.defaults = { ticks: { callback: Go.prototype.getLabelForValue } });
  class Qo extends Oi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        let d,
          ...
          g,
          p = Zo((h - c) / l / r) * r;
        if (p < 1e-14 && j(o) && j(s)) return [{ value: c }, { value: h }];
        (g = Math.ceil(h / p) - Math.floor(c / p)),
          g > l && (p = Zo((g * p) / l / r) * r),
          n || j(a)
            ? (d = Math.pow(10, Ot(p)))
            : ((d = Math.pow(10, a)), (p = Math.ceil(p * d) / d)),
          (u = Math.floor(c / p) * p),
          (f = Math.ceil(h / p) * p),
          !n ||
            j(o) ||
            j(s) ||
            (wt((s - o) / n, p / 1e3) && ((u = o), (f = s))),
          (g = (f - u) / p),
          (g = Mt(g, Math.round(g), p / 1e3) ? Math.round(g) : Math.ceil(g)),
          (u = Math.round(u * d) / d),
          (f = Math.round(f * d) / d),
          i.push({ value: j(o) ? u : o });
        for (let t = 1; t < g; ++t)
          i.push({ value: Math.round((u + t * p) * d) / d });
        return i.push({ value: j(s) ? f : s }), i;
      })(
        {
          maxTicks: n,
          min: e.min,
          ...
          stepSize: X(i.fixedStepSize, i.stepSize),
        },
        t
      );
      return (
        "ticks" === e.bounds && kt(o, t, "value"),
        e.reverse
    ...
    getLabelForValue(t) {
      return yi(t, this.options.locale);
    }
  }
  class Jo extends Qo {
    determineDataLimits() {
  ...
  (Jo.id = "linear"),
    (Jo.defaults = { ticks: { callback: Mi.formatters.numeric } });
  class es extends Oi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    handleTickRangeOptions() {
      ...
      const s = (t) => (n = e ? n : t),
        a = (t) => (o = i ? o : t),
        r = (t, e) => Math.pow(10, Math.floor(yt(t)) + e);
    ...
    buildTicks() {
      const t = this,
        e = t.options,
        i = (function (t, e) {
          const i = Math.floor(yt(e.max)),
            n = Math.ceil(e.max / Math.pow(10, i)),
            o = [];
          let s = U(t.min, Math.pow(10, Math.floor(yt(e.min)))),
            a = Math.floor(yt(s)),
    ...
    getLabelForValue(t) {
      return void 0 === t ? "0" : yi(t, this.options.locale);
    }
    configure() {
      const t = this,
        e = t.min;
    ...
    getPixelForValue(t) {
      ...
      return (
        ...
        e.getPixelForDecimal(
          t === e.min ? 0 : (yt(t) - e._startValue) / e._valueRange
        )
      );
    }
    getValueForPixel(t) {
  ...
  function is(t) {
    ...
    return e.display && t.display
      ? X(e.font && e.font.size, ht.font.size) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  class rs extends Qo {
    ...
    generateTickLabels(t) {
      const e = this;
      Qo.prototype.generateTickLabels.call(e, t),
    ...
    getIndexAngle(t) {
      const e = this.chart;
      return Lt(
        t * (ut / e.data.labels.length) + St((e.options || {}).startAngle || 0)
      );
    }
          ...
          (function (t) {
            ...
            for (let i = t.chart.data.labels.length - 1; i >= 0; i--) {
              const a = 0 === i ? o / 2 : 0,
                ...
                c = De(l.font),
                h = Dt(t.getIndexAngle(i));
              ss(h, t._pointLabelSizes[i], r),
                Xt(e, t.pointLabels[i], r.x, r.y + c.lineHeight / 2, c, {
                  color: l.color,
                  textAlign: os(h),
                });
            }
              ...
              !(function (t, e, i) {
                ...
                if ((o || s) && a && r && !(i < 0)) {
                  if (
                    ...
                    n.arc(t.xCenter, t.yCenter, i, 0, ut);
                  else {
      ...
      e.save(),
        ...
        t.ticks.forEach((o, r) => {
          ...
          (s = t.getDistanceFromCenterForValue(t.ticks[r].value)),
            ...
            Xt(e, o.label, 0, -s, c, { color: l.color });
        }),
        e.restore();
    }
    drawTitle() {}
  ...
  (rs.id = "radialLinear"),
    ...
    (rs.descriptors = { angleLines: { _fallback: "gridLines" } });
  const ls = Number.MAX_SAFE_INTEGER || 9007199254740991,
    cs = {
  ...
  function fs(t, e, i, n) {
    const o = hs.length;
    for (let s = hs.indexOf(t); s < o - 1; ++s) {
      const t = cs[hs[s]],
        o = t.steps ? t.steps : ls;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return hs[s];
    }
    return hs[o - 1];
  }
  function gs(t, e, i) {
  ...
  class ms extends Oi {
    ...
    init(t, e) {
      ...
      et(i.displayFormats, n.formats()),
        super.init(t),
        (this._normalized = e.normalized);
    }
    parse(t, e) {
      return void 0 === t ? NaN : us(this, t);
    }
    beforeLayout() {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? fs(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = hs.length - 1; s >= hs.indexOf(i); s--) {
                  const i = hs[s];
                  if (cs[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
                return hs[i ? hs.indexOf(i) : 0];
              })(t, a.length, i.minUnit, t.min, t.max))),
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = hs.indexOf(t) + 1, i = hs.length; e < i; ++e)
                  if (cs[hs[e]].common) return hs[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || fs(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = X(s.stepSize, 1),
      ...
      for (d = u; d < n; d = +e.add(d, r, a)) gs(h, d, f);
      return (
        (d !== n && "ticks" !== o.bounds) || gs(h, d, f),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelSize(t) {
      const e = this,
        ...
        o = St(e.isHorizontal() ? i.maxRotation : i.minRotation),
        s = Math.cos(o),
        a = Math.sin(o),
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(us(t, o[i]));
  ...
  class bs extends ms {
    ...
    getDecimalForValue(t) {
      return xs(this._table, t) / this._maxIndex;
    }
    getValueForPixel(t) {
      const e = this,
        i = e._offsets,
        n = e.getDecimalForPixel(t) / i.factor - i.end;
      return xs(e._table, n * this._maxIndex, !0);
    }
  }
  (bs.id = "timeseries"), (bs.defaults = ms.defaults);
  var _s = Object.freeze({
    __proto__: null,
    CategoryScale: Go,
    LinearScale: Jo,
    LogarithmicScale: es,
    RadialLinearScale: rs,
    TimeScale: ms,
    TimeSeriesScale: bs,
  });
  return (
    hn.register($n, _s, go, qo),
    (hn.helpers = { ...Cn }),
    (hn._adapters = Ln),
    (hn.Animation = oi),
    (hn.Animations = ai),
    (hn.animator = o),
    (hn.controllers = Ai.controllers.items),
    (hn.DatasetController = xi),
    (hn.Element = bi),
    (hn.elements = go),
    (hn.Interaction = ye),
    (hn.layouts = Ve),
    ...
    (hn.Scale = Oi),
    (hn.Ticks = Mi),
    Object.assign(hn, $n, _s, go, qo, ti),
    (hn.Chart = hn),
