...
!(function (t, e) {
  ...
  var i = new (class {
    ...
    _update() {
      ...
      t._charts.forEach((n, o) => {
        ...
        l && (o.draw(), t._notify(o, n, e, "progress")),
          o.options.animation.debug &&
            (function (t, e, i, n) {
              const o = (1e3 / (i - n)) | 0,
                s = t.ctx;
              s.save(),
                s.clearRect(0, 0, 50, 24),
                (s.fillStyle = "black"),
                (s.textAlign = "right"),
                e && (s.fillText(e, 50, 8), s.fillText(o + " fps", 50, 18)),
                s.restore();
            })(o, s.length, e, t._lastDate),
          s.length || ((n.running = !1), t._notify(o, n, e, "complete")),
          (i += s.length);
      }),
        (t._lastDate = e),
        0 === i && (t._running = !1);
  ...
  function u(t, e, i, n) {
    ...
    if (a(t))
      ...
      for (l = Object.keys(t), s = l.length, o = 0; o < s; o++)
        e.call(i, t[l[o]], l[o]);
  }
  function g(t, e) {
    let i, n, o, s;
  ...
  function f(t) {
    if (a(t)) return t.map(f);
    if (r(t)) {
      const e = Object.create(null),
        i = Object.keys(t),
        n = i.length;
      let o = 0;
      for (; o < n; ++o) e[i[o]] = f(t[i[o]]);
      return e;
    }
    return t;
  }
  ...
  function y(t, e) {
    ...
    if ("y" === e) return t.y;
    const i = e.split(".");
    for (let e = 0, n = i.length; e < n && t; ++e) {
      const n = i[e];
      if (!n) break;
      t = t[n];
    }
  ...
  var w = new (class {
    ...
    set(t, e) {
      return "string" == typeof t ? x(M(this, t), e) : x(M(this, ""), t);
    }
    get(t) {
      return M(this, t);
    }
  ...
  function H(t, e) {
    ...
    return s < -0.5 * k && (s += P), { angle: s, distance: o };
  }
  function j(t, e) {
  ...
  function Z(t, e, i, n) {
    ...
    let c, h, d, u, g;
    for (c = 0; c < l; c++)
      if (((u = i[c]), null != u && !0 !== a(u))) r = G(t, o, s, r, u);
      else if (a(u))
        for (h = 0, d = u.length; h < d; h++)
          (g = u[h]), null == g || a(g) || (r = G(t, o, s, r, g));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
      for (c = 0; c < f; c++) delete o[s[c]];
      s.splice(0, f);
    }
    return r;
  }
      ...
      switch ((t.beginPath(), c)) {
        ...
        case "rectRounded":
          (l = 0.516 * d),
            ...
            (s = Math.cos(u + A) * r),
            (a = Math.sin(u + A) * r),
            t.arc(i - s, n - a, l, u - k, u - T),
            t.arc(i + a, n - s, l, u - T, u),
            t.arc(i + s, n + a, l, u, u + T),
            t.arc(i - a, n + s, l, u + T, u + k),
            t.closePath();
          break;
        case "rect":
          if (!h) {
  ...
  const rt = (t, e, i) => at(t, i, (n) => t[n][e] < i),
    lt = (t, e, i) => at(t, i, (n) => t[n][e] >= i);
  function ct(t, e, i) {
    let n = 0,
      o = t.length;
    for (; n < o && t[n] < e; ) n++;
  ...
  const mt = (t) => window.getComputedStyle(t, null);
  function xt(t, e) {
    return mt(t).getPropertyValue(e);
  }
  ...
  function vt(t, e, i, n) {
    const o = mt(t),
      s = _t(o, "margin"),
      a = pt(o.maxWidth, t, "clientWidth") || D,
      r = pt(o.maxHeight, t, "clientHeight") || D,
      l = (function (t, e, i) {
        let n, o;
        if (void 0 === e || void 0 === i) {
          ...
          if (s) {
            ...
            (e = t.width - l.width - r.width),
              ...
              (n = pt(a.maxWidth, s, "clientWidth")),
              (o = pt(a.maxHeight, s, "clientHeight"));
    ...
    return (
      ...
      { width: Math.min(c, a, l.maxWidth), height: Math.min(h, r, l.maxHeight) }
    );
  }
  function Mt(t, e) {
    const i = (t.currentDevicePixelRatio =
        e || ("undefined" != typeof window && window.devicePixelRatio) || 1),
      { canvas: n, width: o, height: s } = t;
    (n.height = s * i),
      (n.width = o * i),
      ...
      !n.style ||
        n.style.height ||
        n.style.width ||
        ((n.style.height = s + "px"), (n.style.width = o + "px"));
  }
  const wt = (function () {
    let t = !1;
    try {
  ...
  var Ct = {
    modes: {
      index(t, e, i, n) {
        const o = Pt(e, t),
          s = i.axis || "x",
          a = i.intersect ? Ot(t, o, s, n) : Tt(t, o, s, !1, n),
          r = [];
        return a.length
      ...
      dataset(t, e, i, n) {
        const o = Pt(e, t),
          s = i.axis || "xy";
        let a = i.intersect ? Ot(t, o, s, n) : Tt(t, o, s, !1, n);
        if (a.length > 0) {
      ...
      point: (t, e, i, n) => Ot(t, Pt(e, t), i.axis || "xy", n),
      nearest: (t, e, i, n) => Tt(t, Pt(e, t), i.axis || "xy", i.intersect, n),
      x: (t, e, i, n) => ((i.axis = "x"), At(t, e, i, n)),
      y: (t, e, i, n) => ((i.axis = "y"), At(t, e, i, n)),
    },
  };
  function Lt(t, e) {
  ...
  function It(t, e) {
    ...
    const n = {
      ...
      lineHeight: Lt(h(t.lineHeight, e.lineHeight), i),
      size: i,
      style: h(t.style, e.style),
      weight: h(t.weight, e.weight),
      string: "",
    };
    return (n.string = q(n)), n;
  }
  function Vt(t, e, i, n) {
    let o,
      s,
  ...
  const Bt = ["left", "top", "right", "bottom"];
  function Wt(t, e) {
    return t.filter((t) => t.pos === e);
  }
  function Nt(t, e) {
    return t.filter((t) => -1 === Bt.indexOf(t.pos) && t.box.axis === e);
  }
  function Ht(t, e) {
    return t.sort((t, i) => {
      const n = e ? i : t,
  ...
  function Yt(t, e, i) {
    ...
    const s = e.outerWidth - jt(o, t, "left", "right"),
      a = e.outerHeight - jt(o, t, "top", "bottom");
    return s !== t.w || a !== t.h
      ? ((t.w = s), (t.h = a), i.horizontal ? s !== t.w : a !== t.h)
      : void 0;
  }
  function Ut(t, e) {
  ...
  function $t(t, e, i) {
    ...
    for (o = 0, s = t.length; o < s; ++o)
      (a = t[o]),
        (r = a.box),
        r.update(a.width || e.w, a.height || e.h, Ut(a.horizontal, e)),
        Yt(e, i, a) && ((c = !0), n.length && (l = !0)),
        r.fullWidth || n.push(a);
    return (l && $t(n, e, i)) || c;
  }
  function Xt(t, e, i) {
    const n = i.padding;
    ...
    for (o = 0, s = t.length; o < s; ++o)
      (a = t[o]),
        (r = a.box),
        a.horizontal
          ? ((r.left = r.fullWidth ? n.left : e.left),
            (r.right = r.fullWidth ? i.outerWidth - n.right : e.left + e.w),
            (r.top = c),
            (r.bottom = c + r.height),
          ...
          : ((r.left = l),
            (r.right = l + r.width),
            (r.top = r.fullWidth ? n.top : e.top),
            (r.bottom = r.fullWidth ? i.outerHeight - n.right : e.top + e.h),
            (r.height = r.bottom - r.top),
            (l = r.right));
    (e.x = l), (e.y = c);
  }
  w.set("layout", { padding: { top: 0, right: 0, bottom: 0, left: 0 } });
  var Kt = {
    addBox(t, e) {
      t.boxes || (t.boxes = []),
    ...
    configure(t, e, i) {
      ...
      let s,
        a = 0;
      for (; a < o; ++a)
        (s = n[a]), Object.prototype.hasOwnProperty.call(i, s) && (e[s] = i[s]);
    },
    update(t, e, i) {
      if (!t) return;
      const n = t.options.layout || {},
        o = { chart: t },
        s = zt(Vt([n.padding], o)),
        a = e - s.width,
        r = i - s.height,
        l = (function (t) {
          ...
          return {
            ...
            rightAndBottom: n.concat(r).concat(s).concat(a),
            chartArea: Wt(e, "chartArea"),
            vertical: i.concat(n).concat(r),
        ...
        d = Object.freeze({
          ...
          availableWidth: a,
          availableHeight: r,
          vBoxMaxWidth: a / 2 / c.length,
          hBoxMaxHeight: r / 2,
        }),
        g = Object.assign(
          { maxPadding: Object.assign({}, s), w: a, h: r, x: s.left, y: s.top },
          s
        );
      !(function (t, e) {
        let i, n, o;
        for (i = 0, n = t.length; i < n; ++i)
          (o = t[i]),
            o.horizontal
              ? ((o.width = o.box.fullWidth && e.availableWidth),
                (o.height = e.hBoxMaxHeight))
              : ((o.width = e.vBoxMaxWidth),
                (o.height = o.box.fullWidth && e.availableHeight));
      })(c.concat(h), d),
        $t(c, g, d),
        $t(h, g, d) && $t(c, g, d),
        (function (t) {
  ...
  function ae(t, i, n) {
    ...
    return (
      r.observe(s),
      (function (t, e) {
        ne.size || window.addEventListener("resize", se), ne.set(t, e);
      })(t, a),
      r
    );
  }
  function re(t, e, i) {
    i && i.disconnect(),
      "resize" === e &&
        (function (t) {
          ne.delete(t), ne.size || window.removeEventListener("resize", se);
        })(t);
  }
  function le(t, i, n) {
    const o = t.canvas,
  ...
  class ce extends qt {
    ...
    addEventListener(t, e, i) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        o = { attach: ee, detach: ie, resize: ae }[e] || le;
      n[e] = o(t, e, i);
    }
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: re, detach: re, resize: re }[e] || te)(t, e, n),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  const de = {
      ...
      easeInElastic(t) {
        ...
        return 0 === t
          ...
          : (i || (i = 0.3),
            (e = (i / P) * Math.asin(1)),
            -1 * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * P) / i));
      },
      easeOutElastic(t) {
        let e = 1.70158,
          i = 0;
        return 0 === t
          ...
          : (i || (i = 0.3),
            (e = (i / P) * Math.asin(1)),
            1 * Math.pow(2, -10 * t) * Math.sin(((t - e) * P) / i) + 1);
      },
      easeInOutElastic(t) {
        let e = 1.70158,
          i = 0;
   ...
   */ function xe(t) {
    var e = (function (t) {
      return me(t.r) && me(t.g) && me(t.b) && me(t.a);
    })(t)
      ? fe
      : pe;
  ...
  const _e = (t, e, i) => Math.max(Math.min(t, i), e);
  function ye(t) {
    return _e(be(2.55 * t), 0, 255);
  }
  function ve(t) {
    return _e(be(255 * t), 0, 255);
  }
  function Me(t) {
    return _e(be(t / 2.55) / 100, 0, 1);
  }
  function we(t) {
    return _e(be(100 * t), 0, 100);
  }
  const ke =
  ...
  function Ae(t, e, i, n) {
    return (Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, n)).map(ve);
  }
  function Ce(t, e, i) {
    return Ae(Se, t, e, i);
  }
      ...
      ((ze = (function () {
        ...
        for (n = 0; n < e.length; n++) {
          for (a = r = e[n], o = 0; o < i.length; o++)
            (s = i[o]), (r = r.replace(s, Ee[s]));
          (s = parseInt(Fe[a], 16)),
            (t[r] = [(s >> 16) & 255, (s >> 8) & 255, 255 & s]);
        }
        return t;
      })()),
      (ze.transparent = [0, 0, 0, 0]));
  ...
  function We(t) {
    ...
    return (
      Array.isArray(t)
        ...
        : ((e = Be(t, { r: 0, g: 0, b: 0, a: 1 })).a = ve(e.a)),
      e
    );
  }
  function Ne(t) {
  ...
  function $e(t) {
    return Ye(t) ? t : je(t).saturate(0.5).darken(0.1).hexString();
  }
  ...
  class qe {
    constructor(t, e, i, n) {
      const o = e[i];
      n = Vt([t.to, n, o, t.from]);
      const s = Vt([t.from, o, n]);
      (this._active = !0),
        (this._fn = t.fn || Ke[t.type || typeof s]),
        (this._easing = de[t.easing || "linear"]),
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._loop = !!t.loop),
          (n._to = Vt([t.to, e, o, t.from])),
          (n._from = Vt([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  const Ge = ["borderColor", "backgroundColor"];
  w.set("animation", {
    duration: 1e3,
    easing: "easeOutQuart",
    onProgress: n,
    onComplete: n,
    colors: { type: "color", properties: Ge },
    numbers: {
      type: "number",
    ...
    resize: { duration: 0 },
    show: {
      colors: { type: "color", properties: Ge, from: "transparent" },
      visible: { type: "boolean", duration: 0 },
    },
    hide: {
      colors: { type: "color", properties: Ge, to: "transparent" },
      ...
      Object.keys(t).forEach((n) => {
        ...
        r(o) &&
          (o.properties || [n]).forEach((t) => {
            if (e.has(t)) {
              if (t === n) {
                const { properties: i, ...n } = e.get(t);
                e.set(t, Object.assign({}, n, o));
              }
            } else e.set(t, Object.assign({}, i, o));
          });
      });
    }
    _animateOptions(t, e) {
  ...
  function ti(t, e, i, n) {
    ...
    for (s = 0, a = o.length; s < a; ++s) {
      ...
      (l = t.values[r]), isNaN(l) || (0 !== e && V(e) !== V(l)) || (e += l);
    }
    return e;
  }
  function ei(t, e) {
  ...
  function ni(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: n, [c]: s } = i;
      (u = (i._stacks || (i._stacks = {}))[c] = ii(o, h, n)), (u[r] = s);
    }
  }
  function oi(t, e) {
    const i = t.scales;
  ...
  class li {
    ...
    linkScales() {
      const t = this,
        ...
        s = (i.xAxisID = h(n.xAxisID, oi(e, "x"))),
        a = (i.yAxisID = h(n.yAxisID, oi(e, "y"))),
        r = (i.rAxisID = h(n.rAxisID, oi(e, "r"))),
        l = i.indexAxis,
        c = (i.iAxisID = o(l, s, a, r)),
        d = (i.vAxisID = o(l, a, s, r));
      (i.xScale = t.getScaleForId(s)),
        (i.yScale = t.getScaleForId(a)),
        (i.rScale = t.getScaleForId(r)),
        (i.iScale = t.getScaleForId(c)),
        (i.vScale = t.getScaleForId(d));
    }
    getDataset() {
    ...
    _destroy() {
      ...
      this._data && ut(this._data, this), t._stacked && si(t);
    }
    _dataCheck() {
      const t = this,
        e = t.getDataset(),
      ...
      r(i)
        ...
        : t._data !== i &&
          (t._data && ut(t._data, t),
          i && Object.isExtensible(i) && dt(i, t),
          (t._data = i));
    }
    addElements() {
      const t = this,
    ...
    buildOrUpdateElements() {
      ...
      t._dataCheck(),
        (e._stacked = ei(e.vScale, e)),
        e.stack !== i.stack && ((n = !0), si(e), (e.stack = i.stack)),
        t._resyncElements(),
        n && ni(t, e._parsed);
    }
    configure() {
      ...
      (t._config = x(
        Object.create(null),
        [
          w.controllers[t._type].datasets,
        ...
        (t._parsing = Vt([t._config.parsing, t.chart.options.parsing, !0]));
    }
    parse(t, e) {
      const i = this,
        { _cachedMeta: n, _data: o } = i,
        { iScale: s, vScale: l, _stacked: c } = n,
        h = s.axis;
      let d,
        u,
        g,
        ...
        p = !0;
      if (
        (t > 0 && ((p = n._sorted), (f = n._parsed[t - 1])), !1 === i._parsing)
      )
        ...
        const s = () => isNaN(g[h]) || (f && g[h] < f[h]);
        for (d = 0; d < e; ++d)
          (n._parsed[d + t] = g = u[d]), p && (s() && (p = !1), (f = g));
        n._sorted = p;
      }
      c && ni(i, u), s.invalidateCaches(), l.invalidateCaches();
    }
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (c = 0, h = n; c < h; ++c)
        (d = c + i),
          (u = e[d]),
          (l[c] = { x: o.parse(y(u, a), d), y: s.parse(y(u, r), d) });
      return l;
    }
    getParsed(t) {
    ...
    applyStack(t, e) {
      const i = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return ti({ keys: Je(i, !0), values: e._stacks[t.axis] }, o, n.index);
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (o = ti(n, o, this._cachedMeta.index, !0))),
        (t.min = Math.min(t.min, o)),
        (t.max = Math.max(t.max, o));
    }
    getMinMax(t, e) {
      const i = this,
        ...
        l = e && n._stacked && { keys: Je(i.chart, !0), values: null },
      ...
      function m() {
        return (
          ...
          (g = f[t.axis]),
          (p = f[r.axis]),
          isNaN(g) || isNaN(p) || h > p || d < p
        );
      }
      for (
        u = 0;
        u < a && (m() || (i.updateRangeFromParsed(c, t, f, l), !s));
        ++u
      );
      if (s)
        for (u = a - 1; u >= 0; --u)
          if (!m()) {
            i.updateRangeFromParsed(c, t, f, l);
            break;
          }
      return c;
    }
    ...
    getContext(t, e) {
      ...
      if (t >= 0 && t < i._cachedMeta.data.length) {
        ...
        n =
          ...
          })(i.getContext(), t, i.getParsed(t), e));
      } else
        n =
          i.$context ||
    ...
    resolveDataElementOptions(t, e) {
      ...
      if (s) return ((t, e) => (e ? t : Object.assign({}, t)))(s, a);
      const r = { cacheable: !n },
        l = i._resolveOptions(i.dataElementOptions, {
          index: t,
          active: n,
          info: r,
      ...
      return (
        r.cacheable &&
          ((l.$shared = a),
          (o[e] = ((t, e) => (e ? Object.freeze(t) : t))(l, a))),
        l
      );
    }
    _resolveOptions(t, e) {
      const i = this,
        { index: n, active: o, type: s, info: r } = e,
        l = i._config,
        c = i.chart.options.elements[s] || {},
        h = {},
        d = i.getContext(n, o),
        u = ((t) => (a(t) ? t : Object.keys(t)))(t);
      for (let e = 0, i = u.length; e < i; ++e) {
        const i = u[e],
          s = ai(i, o),
          a = Vt([l[t[s]], l[s], c[s]], d, n, r);
        void 0 !== a && (h[i] = a);
      }
      return h;
    }
    _resolveAnimations(t, e, i) {
      const n = this,
        o = n.chart,
        s = n._cachedAnimations;
      if (s[(e = e || "default")]) return s[e];
      const a = { cacheable: !0 },
        r = n.getContext(t, i),
        l = Vt([o.options.animation], r, t, a),
        c = Vt([n._config.animation], r, t, a);
      let h = l && b({}, [c, l]);
      h[e] && (h = Object.assign({}, h, h[e]));
      const d = new Ze(o, h);
      return a.cacheable && (s[e] = d && Object.freeze(d)), d;
    }
    getSharedOptions(t) {
      if (t.$shared)
        return (
    ...
    updateElement(t, e, i, n) {
      ri(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
    }
    ...
    _setStyle(t, e, i, n) {
      ...
      this._resolveAnimations(e, i, n).update(t, {
        options: this.getSharedOptions(o) || o,
      });
    }
    ...
    _resyncElements() {
      const t = this,
        ...
        i = t._data.length;
      i > e
        ? t._insertElements(e, i - e)
        : i < e && t._removeElements(i, e - i),
        t.parse(0, Math.min(i, e));
    }
    _insertElements(t, e) {
      const i = this,
        n = new Array(e),
        ...
        s = o.data;
      let a;
      for (a = 0; a < e; ++a) n[a] = new i.dataElementType();
      s.splice(t, 0, ...n),
        i._parsing && o._parsed.splice(t, 0, ...new Array(e)),
        i.parse(t, e),
        i.updateElements(s, t, e, "reset");
    }
  ...
  (li.defaults = {}),
    ...
    (li.prototype.datasetElementOptions = [
      "backgroundColor",
      "borderCapStyle",
      "borderColor",
      "borderDash",
    ...
    (li.prototype.dataElementOptions = [
      "backgroundColor",
      "borderColor",
      "borderWidth",
      "pointStyle",
  ...
  (ci.defaults = {}), (ci.defaultRoutes = void 0);
  const hi = new Map(),
    di = {
      values: (t) => (a(t) ? t : "" + t),
      numeric(t, e, i) {
        ...
        const h = n + JSON.stringify(c);
        let d = hi.get(h);
        return (
          d || ((d = new Intl.NumberFormat(n, c)), hi.set(h, d)), d.format(t)
        );
      },
      logarithmic: function (t, e, i) {
        if (0 === t) return "0";
        const n = t / Math.pow(10, Math.floor(R(t)));
        return 1 === n || 2 === n || 5 === n
          ? di.numeric.call(this, t, e, i)
          : "";
      },
    };
  var ui = { formatters: di };
  function gi(t, e) {
    const i = [],
      n = t.length / e,
      o = t.length;
  ...
  function xi(t, e, i, n, o) {
    const s = h(n, 0),
      a = Math.min(h(o, t.length), t.length);
    let r,
      l,
      c,
      d = 0;
    for (
      ...
      d++, (c = Math.round(s + d * i));
    for (l = Math.max(s, 0); l < a; l++)
      l === c && (e.push(t[l]), d++, (c = Math.round(s + d * i)));
  }
  w.set("scale", {
    display: !0,
    offset: !1,
    ...
    w.route("scale.gridLines", "color", "", "borderColor"),
    w.route("scale.scaleLabel", "color", "", "color");
  class bi extends ci {
    constructor(t) {
      super(),
        (this.id = t.id),
    ...
    getMinMax(t) {
      ...
      return { min: c(n, c(o, n)), max: c(o, c(n, o)) };
    }
    invalidateCaches() {
      this._cache = {};
    }
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? gi(n.ticks, s) : n.ticks),
        n.configure(),
    ...
    _callHooks(t) {
      const e = this;
      e.chart.notifyPlugins(t, e.getContext()), d(e.options[t], [e]);
    }
    beforeDataLimits() {
    ...
    generateTickLabels(t) {
      ...
      let n, o, s;
      for (n = 0, o = t.length; n < o; n++)
        (s = t[n]), (s.label = d(i.callback, [s.value, n, t], e));
    }
    ...
    calculateLabelRotation() {
      ...
      const h = t._getLabelSizes(),
        ...
        g = Math.min(t.maxWidth, t.chart.width - d);
      (a = e.offset ? t.maxWidth / n : g / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            pi(e.gridLines) -
            i.padding -
            mi(e.scaleLabel, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = W(
            Math.min(
    ...
    fit() {
      const t = this,
        ...
        c = t.isHorizontal(),
        h = r && mi(s, i.options.font);
      if (
        (c ? (e.width = t.maxWidth) : r && (e.width = pi(a) + h),
        c ? r && (e.height = pi(a) + h) : (e.height = t.maxHeight),
        ...
        if (c) {
          const i = 0 !== t.labelRotation,
            ...
            u = Math.cos(c),
            g = Math.sin(c),
            f = g * a.width + u * (r.height - (i ? r.offset : 0)) + (i ? 0 : h);
          e.height = Math.min(t.maxHeight, e.height + f + d);
          const p = t.getPixelForTick(0) - t.left,
            m = t.right - t.getPixelForTick(t.ticks.length - 1);
          let x, b;
          i
            ? ((x = l ? u * n.width + g * n.offset : g * (n.height - n.offset)),
              (b = l ? g * (s.height - s.offset) : u * s.width + g * s.offset))
            : "start" === o.align
            ? ((x = 0), (b = s.width))
            : "end" === o.align
            ? ((x = n.width), (b = 0))
    ...
    _computeLabelSizes() {
      ...
      n < d.length && (d = gi(d, n));
      const g = d.length;
      let f, p, m, x, b, _, y, v, M, w, k;
      for (f = 0; f < g; ++f) {
        if (
          ((x = d[f].label),
          (b = t._resolveTickFontOptions(f)),
          (e.font = _ = b.string),
          (y = i[_] = i[_] || { data: {}, gc: [] }),
          (v = b.lineHeight),
          (M = w = 0),
          ...
          if (a(x))
            for (p = 0, m = x.length; p < m; ++p)
              (k = x[p]),
                s(k) || a(k) || ((M = G(e, y.data, y.gc, M, k)), (w += v));
        } else (M = G(e, y.data, y.gc, M, x)), (w = v);
        o.push(M),
          r.push(w),
          l.push(v / 2),
          (c = Math.max(M, c)),
      ...
      const P = o.indexOf(c),
        S = r.indexOf(h);
      function D(t) {
        return { width: o[t] || 0, height: r[t] || 0, offset: l[t] || 0 };
      }
      return { first: D(0), last: D(g - 1), widest: D(P), highest: D(S) };
    }
    getLabelForValue(t) {
      return t;
    }
    ...
    getPixelForDecimal(t) {
      const e = this;
      return e._reversePixels && (t = 1 - t), K(e._startPixel + t * e._length);
    }
    ...
    getContext(t) {
      ...
      return (
        ...
        (e.$context =
          ...
          (o = e),
          Object.create(n, { scale: { value: o }, type: { value: "scale" } })))
      );
      var n, o;
    }
    _autoSkip(t) {
      ...
      if (a > 0) {
        ...
        for (xi(t, c, h, s(n) ? 0 : r - n, r), e = 0, i = a - 1; e < i; e++)
          xi(t, c, h, o[e], o[e + 1]);
        return xi(t, c, h, l, s(n) ? t.length : l + n), c;
      }
      return xi(t, c, h), c;
    }
    _tickSize() {
    ...
    _computeGridLineItems(t) {
      const e = this,
        ...
        d = pi(s),
        u = [];
      let g = this.getContext(0);
      const f = s.drawBorder ? Vt([s.borderWidth, s.lineWidth, 0], g, 0) : 0,
        p = f / 2,
        m = function (t) {
          return Q(n, t, f);
        };
      let x, b, _, y, v, M, w, k, P, S, D, O;
      if ("top" === a)
        (x = m(e.bottom)),
          (M = e.bottom - d),
          (k = x - p),
        ...
        if ("center" === a) x = m((t.top + t.bottom) / 2);
        else if (r(a)) {
          const t = Object.keys(a)[0],
            i = a[t];
          x = m(e.chart.scales[t].getPixelForValue(i));
        }
        (S = t.top), (O = t.bottom), (M = x + p), (k = M + d);
      } else if ("y" === i) {
        ...
        (v = x - p), (w = v - d), (P = t.left), (D = t.right);
      }
      for (b = 0; b < h; ++b) {
        g = this.getContext(b);
        const t = Vt([s.lineWidth], g, b),
          i = Vt([s.color], g, b),
          o = s.borderDash || [],
          a = Vt([s.borderDashOffset], g, b);
        (_ = fi(e, b, l)),
          void 0 !== _ &&
            ((y = Q(n, _, t)),
            c ? (v = w = P = D = y) : (M = k = S = O = y),
            u.push({
              tx1: v,
              ty1: M,
              tx2: w,
      ...
      return (e._ticksLength = h), (e._borderValue = x), u;
    }
    _computeLabelItems(t) {
      const e = this,
        ...
        l = e.isHorizontal(),
        c = e.ticks,
        { align: h, crossAlign: d, padding: u } = s,
        g = pi(n.gridLines),
        f = g + u,
        p = -B(e.labelRotation),
        m = [];
      let x,
        ...
        O,
        T = "middle";
      if ("top" === o) (M = e.bottom - f), (w = e._getXAxisLabelAlignment());
      else if ("bottom" === o)
        (M = e.top + f), (w = e._getXAxisLabelAlignment());
      else if ("left" === o) {
        ...
        if ("center" === o) M = (t.top + t.bottom) / 2 + f;
        else if (r(o)) {
          const t = Object.keys(o)[0],
            i = o[t];
          M = e.chart.scales[t].getPixelForValue(i) + f;
        }
      ...
      for (x = 0, b = c.length; x < b; ++x) {
        ...
        l
          ? ((v = k),
            "top" === o
              ? "near" === d || 0 !== p
                ? ((O = (Math.sin(p) * t + 0.5) * S),
                  (O -= (0 === p ? D - 0.5 : Math.cos(p) * t) * S))
                : "center" === d
                ? ((O = (A.highest.height / 2) * -1), (O -= t * S))
                : (O = -1 * A.highest.height + 0.5 * S)
              : "bottom" === o &&
                ("near" === d || 0 !== p
                  ? ((O = Math.sin(p) * t * S),
                    (O += (0 === p ? 0.5 : Math.cos(p) * t) * S))
                  : "center" === d
                  ? ((O = A.highest.height / 2), (O -= t * S))
                  : (O = A.highest.height - (D - 0.5) * S)))
          : ((M = k), (O = ((1 - D) * S) / 2)),
          m.push({
            x: v,
            y: M,
    ...
    _getYAxisLabelAlignment(t) {
      const e = this,
        ...
        r = t + a,
        l = e._getLabelSizes().widest.width;
      let c, h;
      return (
        "left" === i
          ? s
    ...
    drawGrid(t) {
      const e = this,
        ...
        n = e.ctx,
        o = e.chart;
      let s = e.getContext(0);
      const a = i.drawBorder ? Vt([i.borderWidth, i.lineWidth, 0], s, 0) : 0,
      ...
      if (a) {
        const t = a;
        s = e.getContext(e._ticksLength - 1);
        const r = Vt([i.lineWidth, 1], s, e._ticksLength - 1),
          l = e._borderValue;
        let c, h, d, u;
        e.isHorizontal()
          ? ((c = Q(o, e.left, t) - t / 2),
            ...
            (d = u = l))
          : ((d = Q(o, e.top, t) - t / 2),
            (u = Q(o, e.bottom, r) + r / 2),
            (c = h = l)),
          (n.lineWidth = a),
          (n.strokeStyle = Vt([i.borderColor, i.color], s, 0)),
          n.beginPath(),
          n.moveTo(c, d),
          n.lineTo(h, u),
          n.stroke();
    ...
    drawLabels(t) {
      ...
      for (s = 0, l = o.length; s < l; ++s) {
        const t = o[s],
          e = t.font,
          l = i.textStrokeWidth > 0 && "" !== i.textStrokeColor;
        n.save(),
          n.translate(t.x, t.y),
          n.rotate(t.rotation),
          (n.font = e.string),
          ...
          l &&
            ((n.strokeStyle = i.textStrokeColor),
            (n.lineWidth = i.textStrokeWidth));
        const h = t.label;
        let d = t.textOffset;
        if (a(h))
          for (r = 0, c = h.length; r < c; ++r)
            l && n.strokeText("" + h[r], 0, d),
              n.fillText("" + h[r], 0, d),
              (d += e.lineHeight);
        else l && n.strokeText(h, 0, d), n.fillText(h, 0, d);
        n.restore();
      }
    }
    drawTitle(t) {
      const e = this,
        ...
        o = n.scaleLabel;
      if (!o.display) return;
      const s = It(o.font, e.chart.options.font),
        a = zt(o.padding),
        r = s.lineHeight / 2,
        l = o.align,
        c = n.position,
      ...
      if (e.isHorizontal()) {
        ...
        g = "top" === c ? e.top + r + a.top : e.bottom - r - a.bottom;
      } else {
        const t = "left" === c;
        switch (((u = t ? e.left + r + a.top : e.right - r - a.top), l)) {
          case "start":
            (g = e.top + (h ? 0 : e.height)), (d = h === t ? "right" : "left");
            break;
          case "end":
            (g = e.top + (h ? e.height : 0)), (d = h === t ? "left" : "right");
            break;
          default:
            (g = e.top + e.height / 2), (d = "center");
        }
        f = t ? -T : T;
      }
      i.save(),
    ...
    _resolveTickFontOptions(t) {
      const e = this,
        ...
        n = e.options.ticks,
        o = e.getContext(t);
      return It(Vt([n.font], o), i.options.font);
    }
  }
  ...
  class _i {
    ...
    unregister(t) {
      const e = this.items,
        i = t.id,
        n = this.scope;
      i in e && delete e[i], n && i in w[n] && delete w[n][i];
    }
  }
  var yi = new (class {
    constructor() {
      (this.controllers = new _i(li, "controllers")),
        (this.elements = new _i(ci, "elements")),
        (this.plugins = new _i(Object, "plugins")),
        (this.scales = new _i(bi, "scales")),
  ...
  class vi {
    ...
    _notify(t, e, i, n) {
      ...
      for (const o of t) {
        const t = o.plugin;
        if (!1 === d(t[i], [e, n, o.options], t) && n.cancelable) return !1;
      }
      return !0;
    }
    invalidate() {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        o = (function (t) {
          ...
          for (let t = 0; t < i.length; t++) e.push(yi.getPlugin(i[t]));
          const n = t.plugins || [];
        ...
        ? (function (t, e, i) {
            ...
            for (let o = 0; o < t.length; o++) {
              const s = t[o],
                ...
                r = Mi(e[a], i);
              null !== r &&
                n.push({ plugin: s, options: b({}, [r, w.plugins[a]]) });
            }
            return n;
          })(o, n, e)
        : [];
  ...
  function wi(t, e) {
    const i = (w.controllers[t] || {}).datasets || {};
    return (
  ...
  function Pi(t, e) {
    const i = (function (t, e) {
        const i = w.controllers[t.type] || { scales: {} },
          n = e.scales || {},
          o = wi(t.type, e),
        ...
        return (
          ...
          e.scale &&
            ((a[e.scale.id || "r"] = b(Object.create(null), [
              { axis: "r" },
              e.scale,
              i.scales.r,
            ])),
            (s.r = s.r || e.scale.id || "r")),
          t.data.datasets.forEach((i) => {
            const o = i.type || t.type,
              r = i.indexAxis || wi(o, e),
              l = (w.controllers[o] || {}).scales || {};
            Object.keys(l).forEach((t) => {
              ...
              (a[o] = a[o] || Object.create(null)),
                b(a[o], [{ axis: e }, n[o], l[t]]);
            });
          }),
          Object.keys(a).forEach((t) => {
            const e = a[t];
            b(e, [w.scales[e.type], w.scale]);
          }),
          a
        );
      })(t, (e = e || {})),
      n = !1 !== e.interaction && !1 !== e.hover;
    return (
      ((e = (function (...t) {
        return x(Object.create(null), t, {
          merger(t, e, i, n) {
            "scales" !== t &&
              "scale" !== t &&
              "controllers" !== t &&
      ...
      })(w, w.controllers[t.type], e)).hover =
        n &&
      ...
      !1 !== e.plugins &&
        (function (t) {
          (t.plugins = t.plugins || {}),
            (t.plugins.title =
              !1 !== t.plugins.title &&
              x(Object.create(null), [w.plugins.title, t.plugins.title])),
            (t.plugins.tooltip =
              !1 !== t.plugins.tooltip &&
              x(Object.create(null), [
                w.interaction,
  ...
  const Di = ["top", "bottom", "left", "right", "chartArea"];
  function Oi(t, e) {
    return "top" === t || "bottom" === t || (-1 === Di.indexOf(t) && "x" === e);
  }
  function Ti(t, e) {
    return function (i, n) {
  ...
  class Ei {
    constructor(t, e) {
      ...
      const r = n.platform.acquireContext(s, e),
        l = r && r.canvas,
        c = l && l.height,
        h = l && l.width;
      (this.id = o()),
        ...
        (Ei.instances[n.id] = n),
        r && l
          ? (i.listen(n, "complete", Ai),
            i.listen(n, "progress", Ci),
            n._initialize(),
            n.attached && n.update())
          : console.error(
    ...
    _initialize() {
      ...
      return (
        ...
        t.options.responsive ? t.resize() : Mt(t, t.options.devicePixelRatio),
        t.bindEvents(),
    ...
    _resize(t, e) {
      ...
      (i.width === a.width && i.height === a.height && r === l) ||
        ((o.width = i.width = a.width),
        (o.height = i.height = a.height),
        o.style &&
      ...
      i &&
        ...
        u(s, (i) => {
          const s = i.options,
            ...
            r = ki(a, s),
            l = h(s.type, i.dtype);
          (void 0 !== s.position && Oi(s.position, r) === Oi(i.dposition)) ||
          ...
          c.init(s, e), i.isDefault && (t.scale = c);
        }),
        u(o, (t, e) => {
          t || delete n[e];
        }),
    ...
    _updateMetasets() {
      ...
      t._sortedMetasets = e.slice(0).sort(Ti("order", "index"));
    }
    _removeUnreferencedMetasets() {
      const t = this,
        e = t.data.datasets;
      t._metasets.forEach((i, n) => {
        0 === e.filter((t) => t === i._dataset).length &&
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || wi(a, t.options)),
          (s.order = o.order || 0),
          ...
          const i = w.controllers[a],
            o = yi.getController(a);
          Object.assign(o.prototype, {
            dataElementType: yi.getElement(i.dataElementType),
            datasetElementType:
              i.datasetElementType && yi.getElement(i.datasetElementType),
            dataElementOptions: i.dataElementOptions,
            datasetElementOptions: i.datasetElementOptions,
          }),
            (s.controller = new o(t, n)),
            e.push(s.controller);
        }
      }
    ...
    update(t) {
      ...
      if (
        ...
        e.config.update(e.options),
        (e.options = e.config.options),
        (e._animationsDisabled = !e.options.animation),
    ...
    render() {
      ...
      !1 !== t.notifyPlugins("beforeRender", { cancelable: !0 }) &&
        (i.has(t)
          ? t.attached && !i.running(t) && i.start(t)
          : (t.draw(), Ai({ chart: t })));
    }
    draw() {
      const t = this;
    ...
    destroy() {
      const t = this,
        e = t.canvas;
      let n, o;
      for (t.stop(), i.remove(t), n = 0, o = t.data.datasets.length; n < o; ++n)
        t._destroyDatasetMeta(n);
      e &&
        (t.unbindEvents(),
        J(t),
    ...
    bindEvents() {
      ...
      if ((u(t.options.events, (t) => n(t, s)), t.options.responsive)) {
        let e;
        s = (e, i) => {
    ...
    updateHoverStyle(t, e, i) {
      ...
      for (
        ...
        (s = t[a]),
          s &&
            this.getDatasetMeta(s.datasetIndex).controller[n + "HoverStyle"](
              s.element,
              s.datasetIndex,
              s.index
            );
    ...
    setActiveElements(t) {
      ...
      !g(n, i) && ((e._active = n), e._updateHoverStyles(n, i));
    }
    notifyPlugins(t, e) {
    ...
    _handleEvent(t, e) {
      ...
      return (
        ...
        d(o.onHover || o.hover.onHover, [t, r, i], i),
        ("mouseup" !== t.type &&
          "click" !== t.type &&
          "contextmenu" !== t.type) ||
          (et(t, i.chartArea) && d(o.onClick, [t, r, i], i)),
        (l = !g(r, n)),
        (l || e) && ((i._active = r), i._updateHoverStyles(r, n)),
        l
      );
    }
  }
  ...
  const Fi = () => u(Ei.instances, (t) => t._plugins.invalidate());
  (Ei.register = (...t) => {
    yi.add(...t), Fi();
  }),
    (Ei.unregister = (...t) => {
  ...
  function Wi(t, e, i, n) {
    ...
    if (
      ...
      for (o = 0, s = t.length; o < s; ++o)
        (a = t[o]),
          (r = Ii(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension)),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (o = t[i]),
            et(o, e) &&
              (i > 0 &&
                et(t[i - 1], e) &&
                ((o.controlPointPreviousX = Bi(
                  o.controlPointPreviousX,
                  e.left,
                  e.right
                )),
                (o.controlPointPreviousY = Bi(
              ...
              i < t.length - 1 &&
                et(t[i + 1], e) &&
                ((o.controlPointNextX = Bi(
                  o.controlPointNextX,
                  e.left,
                  e.right
                )),
                (o.controlPointNextY = Bi(
                  o.controlPointNextY,
                  e.top,
                  e.bottom
                ))));
  ...
  function qi(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      a = e.length,
      { compare: r, between: l, normalize: c } = Xi(n),
      {
        start: h,
        end: d,
        loop: u,
        ...
        return u < d && (u += l), { start: d, end: u, loop: g };
      })(t, e, i),
      g = [];
    let f,
      p,
    ...
    for (let t = h, i = h; t <= d; ++t)
      (p = e[t % a]),
        p.skip ||
          ((f = c(p[n])),
          (x = l(f, o, s)),
          null === b && _() && (b = 0 === r(f, o) ? t : i),
          null !== b && y() && (g.push(Ki(b, t, u, a)), (b = null)),
          (i = t),
          (m = f));
    return null !== b && g.push(Ki(b, d, u, a)), g;
  }
  function Gi(t, e) {
    const i = [],
      n = t.segments;
    for (let o = 0; o < n.length; o++) {
      const s = qi(n[o], t.points, e);
      s.length && i.push(...s);
    }
    return i;
  }
  ...
  var Qi = Object.freeze({
    ...
    _rlookupByKey: lt,
    _filterBetween: ct,
    listenArrayEvents: dt,
    unlistenArrayEvents: ut,
    _arrayUnique: gt,
    splineCurve: Ii,
    splineCurveMonotone: Vi,
    _updateBezierControlPoints: Wi,
    _getParentNode: ft,
    getStyle: xt,
    getRelativePosition: yt,
    getMaximumSize: vt,
    retinaScale: Mt,
    supportsEventListenerOptions: wt,
    readUsedSize: kt,
    _pointInLine: Ni,
    _steppedInterpolation: Hi,
    _bezierInterpolation: ji,
    toLineHeight: Lt,
    toTRBL: Et,
    toTRBLCorners: Ft,
    toPadding: zt,
  ...
  function nn(t) {
    const e = (function (t) {
      if (!t._cache.$bar) {
        ...
        t._cache.$bar = gt(i.sort((t, e) => t - e));
      }
      return t._cache.$bar;
    })(t);
    let i,
  ...
  class rn extends li {
    ...
    parseObjectData(t, e, i, n) {
      ...
      for (d = i, u = i + n; d < u; ++d)
        (f = e[d]),
          (g = {}),
          (g[o.axis] = o.parse(y(f, l), d)),
          h.push(on(y(f, c), g, s, d));
      return h;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let a = e; a < e + i; a++) {
        const e = d || o.resolveDataElementOptions(a, n),
          i = o._calculateBarValuePixels(a, e),
          h = o._calculateBarIndexPixels(a, c, e),
          g = {
            horizontal: l,
            base: s ? r : i.base,
            x: l ? (s ? r : i.head) : h.center,
            y: l ? h.center : s ? r : i.head,
            height: l ? h.size : void 0,
            width: l ? void 0 : h.size,
          };
        u && (g.options = e), o.updateElement(t[a], a, g, n);
      }
    }
    _getStacks(t, e) {
    ...
    _calculateBarValuePixels(t, e) {
      ...
      let d,
        ...
        g = l[o.axis],
        f = 0,
        p = n._stacked ? i.applyStack(o, l) : g;
      p !== g && ((f = p - g), (p = g)),
        h &&
          ((g = c.barStart),
          (p = c.barEnd - c.barStart),
          0 !== g && V(g) !== V(c.barEnd) && (f = 0),
          (f += g));
      const m = s(a) || h ? f : a;
      let x = o.getPixelForValue(m);
      return (
        (d = this.chart.getDataVisibility(t) ? o.getPixelForValue(f + p) : x),
        (u = d - x),
        void 0 !== r &&
          Math.abs(u) < r &&
          ((u = u < 0 ? -r : r), 0 === g && (x -= u / 2), (d = x + u)),
        { size: u, base: x, head: d, center: d + u / 2 }
      );
    }
    _calculateBarIndexPixels(t, e, i) {
      const n = this,
        o = n.chart.options.skipNull ? n._getStackCount(t) : e.stackCount,
        a =
          "flex" === i.barThickness
            ? (function (t, e, i, n) {
                const o = e.pixels,
        ...
        r = n._getStackIndex(n.index, n._cachedMeta.stack),
        l = a.start + a.chunk * r + a.chunk / 2,
        c = Math.min(h(i.maxBarThickness, 1 / 0), a.chunk * a.ratio);
    ...
    draw() {
      const t = this,
        ...
        s = o.length;
      let a = 0;
      for (it(e.ctx, e.chartArea); a < s; ++a)
        isNaN(t.getParsed(a)[n.axis]) || o[a].draw(t._ctx);
      nt(e.ctx);
    }
  }
  (rn.id = "bar"),
  ...
  class ln extends li {
    ...
    resolveDataElementOptions(t, e) {
      ...
      const a = i.getContext(t, "active" === e);
      return (
        s.$shared && (s = Object.assign({}, s, { $shared: !1 })),
        "active" !== e && (s.radius = 0),
        (s.radius += Vt(
          [o && o._custom, i._config.radius, n.options.elements.point.radius],
          a,
          t
        )),
        s
  ...
  class cn extends li {
    ...
    _getRotation() {
      return B(h(this._config.rotation, this.chart.options.rotation) - 90);
    }
    _getCircumference() {
      return B(h(this._config.circumference, this.chart.options.circumference));
    }
    _getRotationExtents() {
      let t = P,
        e = -P;
    ...
    update(t) {
      const e = this,
        ...
        s = e._cachedMeta,
        a = s.data,
        r = o.cutoutPercentage / 100 || 0,
        l = e._getRingWeight(e.index),
        { circumference: c, rotation: h } = e._getRotationExtents(),
        {
          ratioX: d,
          ratioY: u,
          offsetX: g,
          ...
          if (e < P) {
            ...
            const l = r + e,
              ...
              f = (r <= T && l >= T) || l >= P + T,
              p = (r <= -T && l >= -T) || l >= k + T,
              m = r === -k || l >= k ? -1 : Math.min(c, c * i, d, d * i),
              x = p ? -1 : Math.min(h, h * i, u, u * i),
              b = g ? 1 : Math.max(c, c * i, d, d * i),
              _ = f ? 1 : Math.max(h, h * i, u, u * i);
            (n = (b - m) / 2),
              (o = (_ - x) / 2),
              (s = -(b + m) / 2),
              (a = -(_ + x) / 2);
        ...
        p = e.getMaxBorderWidth() + e.getMaxOffset(a),
        m = (n.right - n.left - p) / d,
        x = (n.bottom - n.top - p) / u,
        b = Math.max(Math.min(m, x) / 2, 0),
        _ = (b - Math.max(b * r, 0)) / e._getVisibleDatasetWeightTotal();
      (e.offsetX = g * b),
        (e.offsetY = f * b),
        (s.total = e.calculateTotal()),
        (e.outerRadius = b - _ * e._getRingWeightOffset(e.index)),
        (e.innerRadius = Math.max(e.outerRadius - _ * l, 0)),
    ...
    _circumference(t, e) {
      ...
      return e && n.animation.animateRotate
        ...
        ? i.calculateCircumference((o._parsed[t] * s) / P)
        : 0;
    }
    updateElements(t, e, i, n) {
      const o = this,
        ...
        tooltip: {
          callbacks: {
            ...
            label(t) {
              ...
              return a(e) ? ((e = e.slice()), (e[0] += i)) : (e += i), e;
            },
          },
        },
      },
  ...
  class hn extends li {
        ...
        if (t._sorted) {
          ...
          d &&
            (o = X(
              Math.min(
                rt(r, a.axis, c).lo,
                i ? n : rt(e, l, a.getPixelForValue(c)).lo
              ),
              0,
              n - 1
            )),
            (s = u
              ? X(
                  Math.max(
                    rt(r, a.axis, h).hi + 1,
                    i ? 0 : rt(e, l, a.getPixelForValue(h)).hi + 1
                  ),
                  o,
                  n
                ) - o
    ...
    updateElements(t, e, i, n) {
      const o = this,
        ...
        u = o.includeOptions(n, d),
        g = h(o._config.spanGaps, o.chart.options.spanGaps),
        f = E(g) ? g : Number.POSITIVE_INFINITY;
      let p = e > 0 && o.getParsed(e - 1);
      for (let c = e; c < e + i; ++c) {
        const e = t[c],
          i = o.getParsed(c),
          h = a.getPixelForValue(i.x, c),
          g = s
            ? r.getBasePixel()
        ...
        u && (m.options = d || o.resolveDataElementOptions(c, n)),
          o.updateElement(e, c, m, n),
          (p = i);
      }
    ...
    resolveDatasetElementOptions(t) {
      const e = this._config,
        ...
        s = h(e.showLine, i.showLine);
      return (
        (o.spanGaps = h(e.spanGaps, i.spanGaps)),
        (o.tension = h(e.tension, n.tension)),
        (o.stepped = Vt([e.stepped, n.stepped])),
        s || (o.borderWidth = 0),
        o
      );
    }
  ...
  class dn extends li {
    ...
    updateElements(t, e, i, n) {
      const o = this,
        ...
        d = h.xCenter,
        u = h.yCenter,
        g = B(l.startAngle) - 0.5 * k;
      let f,
        p = g;
      for (o._cachedMeta.count = o.countVisibleElements(), f = 0; f < e; ++f)
        p += o._computeAngle(f, n);
      for (f = e; f < e + i; f++) {
        const e = t[f];
        let i = p,
          a = p + o._computeAngle(f, n),
          l = this.chart.getDataVisibility(f)
            ? h.getDistanceFromCenterForValue(r.data[f])
            : 0;
        (p = a),
          s &&
            (c.animateScale && (l = 0), c.animateRotate && ((i = g), (a = g)));
        const m = {
          x: d,
          y: u,
          innerRadius: 0,
    ...
    _computeAngle(t, e) {
      const i = this,
        n = i._cachedMeta.count,
        o = i.getDataset();
      if (isNaN(o.data[t]) || !this.chart.getDataVisibility(t)) return 0;
      const s = i.getContext(t, "active" === e);
      return B(Vt([i.chart.options.elements.arc.angle, 360 / n], s, t));
    }
  }
  (dn.id = "polarArea"),
    (dn.defaults = {
  ...
  class un extends cn {}
  (un.id = "pie"), (un.defaults = { cutoutPercentage: 0 });
  class gn extends li {
    getLabelAndValue(t) {
    ...
    resolveDatasetElementOptions(t) {
      const e = this._config,
        ...
        o = h(e.showLine, i.showLine);
      return (
        (n.spanGaps = h(e.spanGaps, i.spanGaps)),
        (n.tension = h(e.tension, i.elements.line.tension)),
        o || (n.borderWidth = 0),
        n
      );
    }
    ...
    r.borderWidth &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          for (
            i &&
              ((e.endAngle = e.startAngle + P),
              mn(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle &&
                ((e.endAngle += P), e.fullCircles--)),
              t.beginPath(),
              t.arc(n, o, c, s + P, s, !0),
              h = 0;
            h < e.fullCircles;
            ...
            t.stroke();
          for (
            t.beginPath(), t.arc(n, o, l, s, s + P), h = 0;
            h < e.fullCircles;
            ++h
          )
            t.stroke();
  ...
  class _n extends ci {
    ...
    inRange(t, e, i) {
      const n = this.getProps(["x", "y"], i),
        { angle: o, distance: s } = H(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      ...
      if (
        ...
        (e.fullCircles = Math.floor(e.circumference / P)),
        0 !== e.circumference)
      ) {
        if ((t.save(), n && e.circumference < P)) {
        ...
        (t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              (e.endAngle = e.startAngle + P), xn(t, e);
              for (let i = 0; i < e.fullCircles; ++i) t.fill();
              e.endAngle = e.startAngle + (e.circumference % P);
            }
            xn(t, e), t.fill();
          })(t, e),
          bn(t, e),
  ...
  function Mn(t, e, i, n) {
    const { points: o, options: s } = e,
      { count: a, start: r, loop: l, ilen: c } = vn(o, i, n),
      h = (function (t) {
        return t.stepped ? ot : t.tension ? st : yn;
      })(s);
    let d,
      u,
      g,
  ...
  function wn(t, e, i, n) {
    const o = e.points,
      { count: s, start: a, ilen: r } = vn(o, i, n),
  ...
  function kn(t) {
    ...
    return !(t._loop || e.tension || e.stepped || i) ? wn : Mn;
  }
  (_n.id = "arc"),
    (_n.defaults = {
      borderAlign: "center",
    ...
    (_n.defaultRoutes = { backgroundColor: "backgroundColor" });
  class Pn extends ci {
    constructor(t) {
      super(),
        (this.options = void 0),
    ...
    updateControlPoints(t) {
      ...
      if (i.tension && !i.stepped && !e._pointsUpdated) {
        ...
        Wi(e._points, i, t, n), (e._pointsUpdated = !0);
      }
    }
    set points(t) {
    ...
    get segments() {
      return this._segments || (this._segments = Zi(this));
    }
    first() {
    ...
    interpolate(t, e) {
      const i = this,
        ...
        o = t[e],
        s = i.points,
        a = Gi(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [],
        l = (function (t) {
          return t.stepped ? Hi : t.tension ? ji : Ni;
        })(n);
      let c, h;
  ...
  function On(t) {
    ...
    return e
      ? ((e = t.horizontal
          ? Tn(e, "left", "right", t.base > t.x)
          : Tn(e, "bottom", "top", t.base < t.y)),
        (i[e] = !0),
        i)
      : i;
  }
    ...
    const e = Dn(t),
      ...
      o = (function (t, e, i) {
        const n = t.options.borderWidth,
          ...
          s = Et(n);
        return {
          t: Cn(o.top, s.top, 0, i),
          r: Cn(o.right, s.right, 0, e),
          b: Cn(o.bottom, s.bottom, 0, i),
          l: Cn(o.left, s.left, 0, e),
        };
      })(t, i / 2, n / 2),
      s = (function (t, e, i) {
        const n = Ft(t.options.borderRadius),
          o = Math.min(e, i),
          s = On(t);
        return {
          topLeft: Cn(s.top || s.left, n.topLeft, 0, o),
          topRight: Cn(s.top || s.right, n.topRight, 0, o),
          bottomLeft: Cn(s.bottom || s.left, n.bottomLeft, 0, o),
          bottomRight: Cn(s.bottom || s.right, n.bottomRight, 0, o),
        };
      })(t, i / 2, n / 2);
    return {
  ...
  function En(t, e) {
    ...
    t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -T, k, !0),
      t.lineTo(i, n + s - a.bottomLeft),
      t.arc(i + a.bottomLeft, n + s - a.bottomLeft, a.bottomLeft, k, T, !0),
      ...
      t.arc(i + o - a.topRight, n + a.topRight, a.topRight, 0, -T, !0),
  ...
  (zn.id = "bar"),
    (zn.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0 }),
    (zn.defaultRoutes = {
      backgroundColor: "backgroundColor",
      borderColor: "borderColor",
    });
  ...
  class Bn {
    ...
    interpolate(t, e) {
      const { x: i, y: n, radius: o } = this,
        s = t.angle;
      if ("angle" === e)
        return { x: i + Math.cos(s) * o, y: n + Math.sin(s) * o, angle: s };
    }
  }
  function Wn(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          for (c = 0; c < o; ++c) s.push(e.getPointPositionForValue(c, d));
          return s;
        })(t)
      : (function (t) {
          const { scale: e = {}, fill: i } = t;
    ...
    const { chart: e, scale: i, index: n, line: o } = t,
      ...
      l = (function (t, e) {
        ...
        for (let t = 0; t < n.length; t++) {
          const o = n[t];
          if (o.index === e) break;
          Hn(o) && i.unshift(o.dataset);
        }
        return i;
      })(e, n);
    l.push(Un({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) jn(s, r[t], l);
    }
    return new Pn({ points: s, options: {} });
  }
  const Hn = (t) => "line" === t.type && !t.hidden;
  function jn(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = Yn(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function Un(t, e) {
    ...
    return (
      ...
      i.length
        ? new Pn({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function $n(t, e, i) {
  ...
  function Qn(t, e) {
    const { line: i, target: n, property: o, color: s, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (let t = 0; t < n.length; t++) {
          const r = n[t],
            l = Kn(i, o[r.start], o[r.end], r.loop);
          if (!e.segments) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              n = Kn(i, s[e.start], s[e.end], e.loop),
              h = qi(r, o, n);
            for (let t = 0; t < h.length; t++)
              a.push({
                source: h[t],
                target: e,
                start: { [i]: qn(l, n, "start", Math.max) },
                end: { [i]: qn(l, n, "end", Math.min) },
              });
          }
        }
        return a;
    ...
    for (let e = 0, s = r.length; e < s; ++e) {
      ...
      t.save(), Gn(t, a, Kn(o, c, h)), t.beginPath();
      const d = !!i.pathSegment(t, s);
      d ? t.closePath() : Zn(t, n, h, o);
  ...
  var Jn = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          s.push(c);
      for (r = 0; r < n; ++r)
        (c = s[r]), c && !1 !== c.fill && (c.fill = $n(s, r, o));
    },
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          if ("stack" === i) return Nn(t);
          const o = Wn(t);
          return o instanceof Bn ? o : Un(o, n);
        })(o),
        { line: a, scale: r } = o,
        c = a.options,
        h = c.fill,
        d = c.backgroundColor,
        { above: u = d, below: g = d } = h || {};
      s &&
        a.points.length &&
        (it(n, i),
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              s !== o &&
              (Xn(t, n, a.top),
              Qn(t, { line: i, target: n, color: o, scale: r, property: l }),
              t.restore(),
              t.save(),
              Xn(t, n, a.bottom)),
            Qn(t, { line: i, target: n, color: s, scale: r, property: l }),
            t.restore();
        })(n, { line: a, target: s, above: u, below: g, area: i, scale: r }),
        nt(n));
    },
  ...
  function to(t, e) {
    const { boxWidth: i } = t;
    return (t.usePointStyle && i > e) || s(i) ? e : i;
  }
  function eo(t, e) {
    const { boxHeight: i } = t;
    return (t.usePointStyle && i > e) || s(i) ? e : i;
  ...
  class io extends ci {
    ...
    buildLabels() {
      const t = this,
        e = t.options.labels || {};
      let i = d(e.generateLabels, [t.chart], t) || [];
    ...
    fit() {
      const t = this,
        ...
        n = e.display,
        o = t.ctx,
        s = It(i.font, t.chart.options.font),
        a = s.size,
        r = to(i, a),
        l = eo(i, a),
        c = Math.max(l, a),
      ...
      if (
        (u
          ? ((d.width = t.maxWidth), (d.height = n ? 10 : 0))
          : ((d.width = n ? 10 : 0), (d.height = t.maxHeight)),
        n)
      ) {
        if (((o.font = s.string), u)) {
          const e = (t.lineWidths = [0]);
          let n = g;
          (o.textAlign = "left"),
            (o.textBaseline = "middle"),
            t.legendItems.forEach((t, s) => {
              const l = r + a / 2 + o.measureText(t.text).width;
              (0 === s || e[e.length - 1] + l + 2 * i.padding > d.width) &&
                ((n += c + i.padding), (e[e.length - (s > 0 ? 0 : 1)] = 0)),
                (h[s] = { left: 0, top: 0, width: l, height: c }),
          ...
          let l = i.padding,
            ...
            f = 0;
          const p = d.height - g;
          t.legendItems.forEach((t, d) => {
            const g = r + a / 2 + o.measureText(t.text).width;
            d > 0 &&
              f + a + 2 * e > p &&
              ((l += u + i.padding), n.push(u), s.push(f), (u = 0), (f = 0)),
              (u = Math.max(u, g)),
              (f += a + e),
              (h[d] = { left: 0, top: 0, width: g, height: c });
          }),
            (l += u),
            n.push(u),
            s.push(f),
        ...
        (t.width = Math.min(d.width, e.maxWidth || D)),
          (t.height = Math.min(d.height, e.maxHeight || D));
    ...
    draw() {
      ...
      if (!e.display) return;
      t.drawTitle();
      const l = Yi(e.rtl, t.left, t._minSize.width),
        c = t.ctx,
        d = It(i.font, t.chart.options.font),
        u = i.color,
        g = d.size;
      let f;
      ...
      (f = y
        ? { x: t.left + _(a, r[0]), y: t.top + i.padding + v, line: 0 }
        : { x: t.left + i.padding, y: t.top + _(o, s[0]) + v, line: 0 }),
        Ui(t.ctx, e.textDirection);
      const M = x + i.padding;
      t.legendItems.forEach((e, d) => {
        const u = c.measureText(e.text).width,
          v = p + g / 2 + u;
        let w = f.x,
          k = f.y;
        l.setWidth(t._minSize.width),
          y
            ? d > 0 &&
              w + v + i.padding > t.left + t._minSize.width &&
              ((k = f.y += M), f.line++, (w = f.x = t.left + _(a, r[f.line])))
            : d > 0 &&
              k + M > t.top + t._minSize.height &&
              ((w = f.x = w + t.columnWidths[f.line] + i.padding),
              f.line++,
              (k = f.y = t.top + _(o, s[f.line])));
        const P = l.x(w);
        !(function (t, e, o) {
          if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
          c.save();
          const s = h(o.lineWidth, 1);
          if (
            ((c.fillStyle = h(o.fillStyle, n)),
            (c.lineCap = h(o.lineCap, "butt")),
            (c.lineDashOffset = h(o.lineDashOffset, 0)),
            (c.lineJoin = h(o.lineJoin, "miter")),
            (c.lineWidth = s),
            (c.strokeStyle = h(o.strokeStyle, n)),
            c.setLineDash(h(o.lineDash, [])),
            i && i.usePointStyle)
          ) {
            const i = {
            ...
            c.fillRect(l.leftForLtr(t, p), i, p, m),
              0 !== s && c.strokeRect(l.leftForLtr(t, p), i, p, m);
          }
          c.restore();
        })(P, k, e),
          (b[d].left = l.leftForLtr(P, b[d].width)),
          (b[d].top = k),
          (function (t, e, i, n) {
            const o = g / 2,
              s = l.xPlus(t, p + o),
              a = e + x / 2;
            c.fillText(i.text, s, a),
              i.hidden &&
                (c.beginPath(),
                (c.lineWidth = 2),
                c.moveTo(s, a),
                c.lineTo(l.xPlus(s, n), a),
                c.stroke());
          })(P, k, e, u),
          y ? (f.x += v + i.padding) : (f.y += M);
      }),
        $i(t.ctx, e.textDirection);
    }
    drawTitle() {
      const t = this,
        e = t.options,
        i = e.title,
        n = It(i.font, t.chart.options.font),
        o = zt(i.padding);
      if (!i.display) return;
      const s = Yi(e.rtl, t.left, t._minSize.width),
        a = t.ctx,
        r = i.position;
      let l, c;
      const h = n.size / 2;
      ...
      (a.textAlign = s.textAlign(c)),
        (a.textBaseline = "middle"),
        (a.strokeStyle = i.color),
        (a.fillStyle = i.color),
        (a.font = n.string),
        a.fillText(i.text, l, d);
    }
    _computeTitleHeight() {
      const t = this.options.title,
        e = It(t.font, this.chart.options.font),
        i = zt(t.padding);
    ...
    handleEvent(t) {
      ...
      "click" === n
        ? o && d(i.onClick, [t, o, e], e)
        : (i.onLeave &&
            o !== e._hoveredItem &&
            (e._hoveredItem && d(i.onLeave, [t, e._hoveredItem, e], e),
            (e._hoveredItem = o)),
          o && d(i.onHover, [t, o, e], e));
    }
  }
  function no(t) {
    return !1 !== t && x(Object.create(null), [w.plugins.legend, t]);
  }
  function oo(t, e) {
    const i = new io({ ctx: t.ctx, options: e, chart: t });
    Kt.configure(t, i, e), Kt.addBox(t, i), (t.legend = i);
  }
  var so = {
    id: "legend",
    _element: io,
    start(t) {
      oo(t, no(t.options.plugins.legend));
    },
    stop(t) {
      Kt.removeBox(t, t.legend), delete t.legend;
    },
    beforeUpdate(t) {
      const e = no(t.options.plugins.legend),
        i = t.legend;
      e
        ? i
          ? (Kt.configure(t, i, e), (i.options = e))
          : oo(t, e)
        : i && (Kt.removeBox(t, i), delete t.legend);
    },
    afterUpdate(t) {
        ...
        generateLabels(t) {
          ...
          return t._getSortedDatasetMetas().map((t) => {
            const i = t.controller.getStyle(n ? 0 : void 0),
              s = r(i.borderWidth)
                ? (h(i.borderWidth.top, 0) +
                    h(i.borderWidth.left, 0) +
                    h(i.borderWidth.bottom, 0) +
                    h(i.borderWidth.right, 0)) /
                  4
                : i.borderWidth;
            return {
  ...
  const ao = (t, e, i) => ("start" === t ? e : "end" === t ? i : (e + i) / 2);
  class ro extends ci {
    constructor(t) {
      super(),
        Object.assign(this, t),
    ...
    fit() {
      ...
      const o = a(e.text) ? e.text.length : 1;
      t._padding = zt(e.padding);
      const s =
        o * It(e.font, t.chart.options.font).lineHeight + t._padding.height;
      (t.width = i.width = n ? t.maxWidth : s),
        (t.height = i.height = n ? s : t.maxHeight);
    }
    isHorizontal() {
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ? ((l = ao(a, i, o)), (c = e + t), (r = o - i))
          : ("left" === s.position
              ? ((l = i + t), (c = ao(a, n, e)), (h = -0.5 * k))
              : ((l = o - t), (c = ao(a, e, n)), (h = 0.5 * k)),
            (r = n - e)),
    ...
    draw() {
      const t = this,
        ...
        i = t.options;
      if (!i.display) return;
      const n = It(i.font, t.chart.options.font),
        o = n.lineHeight,
        s = o / 2 + t._padding.top,
        { titleX: r, titleY: l, maxWidth: c, rotation: h } = t._drawArgs(s);
      var d;
      e.save(),
        (e.fillStyle = i.color),
        (e.font = n.string),
      ...
      if (a(u)) {
        let t = 0;
        for (let i = 0; i < u.length; ++i) e.fillText(u[i], 0, t, c), (t += o);
      } else e.fillText(u, 0, 0, c);
      e.restore();
    }
  }
  function lo(t, e) {
    const i = new ro({ ctx: t.ctx, options: e, chart: t });
    Kt.configure(t, i, e), Kt.addBox(t, i), (t.titleBlock = i);
  }
  var co = {
    id: "title",
    _element: ro,
    ...
    stop(t) {
      ...
      Kt.removeBox(t, e), delete t.titleBlock;
    },
    beforeUpdate(t, e, i) {
      !1 === i
        ? (function (t) {
            const e = t.titleBlock;
            e && (Kt.removeBox(t, e), delete t.titleBlock);
          })(t)
        : (function (t, e) {
            const i = t.titleBlock;
            i ? (Kt.configure(t, i, e), (i.options = e)) : lo(t, e);
          })(t, i);
    },
    defaults: {
      align: "center",
  ...
  function po(t) {
    const e = t._chart.ctx,
      { body: i, footer: n, options: o, title: s } = t,
      {
        bodyFont: a,
        footerFont: r,
        titleFont: l,
    ...
    if (
      ...
      d && (p += d * l.size + (d - 1) * o.titleSpacing + o.titleMarginBottom),
      x)
    ) {
      p +=
        f * (o.displayColors ? Math.max(h, a.size) : a.size) +
        (x - f) * a.size +
        (x - 1) * o.bodySpacing;
    }
    g && (p += o.footerMarginTop + g * r.size + (g - 1) * o.footerSpacing);
    let b = 0;
    const _ = function (t) {
      m = Math.max(m, e.measureText(t).width + b);
    };
    return (
      e.save(),
      (e.font = l.string),
  ...
  class yo extends ci {
    ...
    initialize() {
      ...
      (t.options =
        ((i = e.plugins.tooltip),
        (n = e.font),
        ((i = x(Object.create(null), [w.plugins.tooltip, i])).bodyFont = It(
          i.bodyFont,
          n
        )),
        (i.titleFont = It(i.titleFont, n)),
        (i.footerFont = It(i.footerFont, n)),
        (i.boxHeight = h(i.boxHeight, i.bodyFont.size)),
        (i.boxWidth = h(i.boxWidth, i.bodyFont.size)),
        i)),
        (t._cachedAnimations = void 0);
    }
    _resolveAnimations() {
      const t = this,
      ...
      const i = t._chart,
        n = t.options,
        o = n.enabled && i.options.animation && n.animation,
        s = new Ze(t._chart, o);
      return (t._cachedAnimations = Object.freeze(s)), s;
    }
    getTitle(t) {
      const e = this,
        i = e.options.callbacks,
        n = i.beforeTitle.apply(e, [t]),
        o = i.title.apply(e, [t]),
        s = i.afterTitle.apply(e, [t]);
      let a = [];
      return (a = uo(a, go(n))), (a = uo(a, go(o))), (a = uo(a, go(s))), a;
    }
    getBeforeBody(t) {
      return _o(this.options.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t) {
      const e = this,
        i = e.options.callbacks,
      ...
      return (
        u(t, (t) => {
          ...
          uo(o.before, go(i.beforeLabel.call(e, t))),
            uo(o.lines, i.label.call(e, t)),
            uo(o.after, go(i.afterLabel.call(e, t))),
            n.push(o);
        }),
        n
      );
    ...
    getAfterBody(t) {
      return _o(this.options.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t) {
      const e = this,
        i = e.options.callbacks,
        n = i.beforeFooter.apply(e, [t]),
        o = i.footer.apply(e, [t]),
        s = i.afterFooter.apply(e, [t]);
      let a = [];
      return (a = uo(a, go(n))), (a = uo(a, go(o))), (a = uo(a, go(s))), a;
    }
    _createItems() {
      ...
      let r,
        l,
        c = [];
      for (r = 0, l = e.length; r < l; ++r) c.push(fo(t._chart, e[r]));
      return (
        i.filter && (c = c.filter((t, e, o) => i.filter(t, e, o, n))),
        i.itemSort && (c = c.sort((t, e) => i.itemSort(t, e, n))),
        u(c, (e) => {
          o.push(i.callbacks.labelColor.call(t, e)),
            s.push(i.callbacks.labelPointStyle.call(t, e)),
            a.push(i.callbacks.labelTextColor.call(t, e));
        }),
        (t.labelColors = o),
        (t.labelPointStyles = s),
        (t.labelTextColors = a),
        (t.dataPoints = c),
        c
      );
    ...
    update(t) {
      ...
      let o;
      if (n.length) {
        const t = ho[i.position].call(e, n, e._eventPosition),
          s = e._createItems();
        (e.title = e.getTitle(s)),
          (e.beforeBody = e.getBeforeBody(s)),
          (e.body = e.getBody(s)),
          (e.afterBody = e.getAfterBody(s)),
          (e.footer = e.getFooter(s));
        const a = (e._size = po(e)),
          r = Object.assign({}, t, a),
          l = mo(e._chart, i, r),
          c = xo(i, r, l, e._chart);
        (e.xAlign = l.xAlign),
      ...
      o && e._resolveAnimations().update(e, o),
        t && i.custom && i.custom.call(e, { chart: e._chart, tooltip: e });
    }
    drawCaret(t, e, i) {
    ...
    drawTitle(t, e) {
      ...
      let a, r, l;
      if (s) {
        const c = Yi(n.rtl, i.x, i.width);
        for (
          t.x = bo(i, n.titleAlign),
          ...
          e.fillText(o[l], c.x(t.x), t.y + a.size / 2),
            (t.y += a.size + r),
            l + 1 === s && (t.y += n.titleMarginBottom - r);
      }
    }
    _drawColorBox(t, e, i, n) {
      const o = this,
        s = o.options,
        a = o.labelColors[i],
        r = o.labelPointStyles[i],
        { boxHeight: l, boxWidth: c, bodyFont: h } = s,
        d = bo(o, "left"),
        u = n.x(d),
        g = l < h.size ? (h.size - l) / 2 : 0,
        f = e.y + g;
      if (s.usePointStyle) {
        const e = {
        ...
        (t.strokeStyle = s.multiKeyBackground),
          ...
          tt(t, e, i, o);
      } else (t.fillStyle = s.multiKeyBackground), t.fillRect(n.leftForLtr(u, c), f, c, l), (t.lineWidth = 1), (t.strokeStyle = a.borderColor), t.strokeRect(n.leftForLtr(u, c), f, c, l), (t.fillStyle = a.backgroundColor), t.fillRect(n.leftForLtr(n.xPlus(u, 1), c - 2), f + 1, c - 2, l - 2);
      t.fillStyle = o.labelTextColors[i];
    }
    drawBody(t, e) {
      const i = this,
        { body: n, options: o } = i,
      ...
      let d = s.size,
        g = 0;
      const f = Yi(o.rtl, i.x, i.width),
        p = function (i) {
          e.fillText(i, f.x(t.x + g), t.y + d / 2), (t.y += d + a);
        },
        m = f.textAlign(r);
      let x, b, _, y, v, M, w;
      for (
        e.textAlign = r,
          ...
          e.font = s.string,
          t.x = bo(i, m),
          e.fillStyle = o.bodyColor,
          u(i.beforeBody, p),
          g = l && "right" !== m ? ("center" === r ? h / 2 + 1 : h + 2) : 0,
          y = 0,
          M = n.length;
        y < M;
        ++y
        ...
        for (
          x = n[y],
            ...
            l &&
              _.length &&
              (i._drawColorBox(e, t, y, f), (d = Math.max(s.size, c))),
            v = 0,
            w = _.length;
          v < w;
          ++v
      ...
      (g = 0), (d = s.size), u(i.afterBody, p), (t.y -= a);
    }
    drawFooter(t, e) {
      const i = this,
        n = i.options,
      ...
      let a, r;
      if (s) {
        const l = Yi(n.rtl, i.x, i.width);
        for (
          t.x = bo(i, n.footerAlign),
          ...
          e.fillText(o[r], l.x(t.x), t.y + a.size / 2),
            (t.y += a.size + n.footerSpacing);
      }
    }
    drawBackground(t, e, i) {
      const { xAlign: n, yAlign: o, options: s } = this,
        { x: a, y: r } = t,
        { width: l, height: c } = i,
        h = s.cornerRadius;
    ...
    _updateAnimationTarget() {
      const t = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = ho[i.position].call(t, t._active, t._eventPosition);
        if (!n) return;
        const a = (t._size = po(t)),
          r = Object.assign({}, n, t._size),
          l = mo(e, i, r),
          c = xo(i, r, l, e);
        (o._to === c.x && s._to === c.y) ||
          ((t.xAlign = l.xAlign),
    ...
    draw(t) {
      ...
      i.enabled &&
        ...
        (t.save(),
        (t.globalAlpha = n),
        e.drawBackground(s, t, o),
        Ui(t, i.textDirection),
        (s.y += i.yPadding),
        e.drawTitle(s, t),
        e.drawBody(s, t),
        e.drawFooter(s, t),
    ...
    _positionChanged(t, e) {
      const i = this,
        n = ho[i.options.position].call(i, t, e);
  ...
  var vo = {
      ...
      positioners: ho,
      afterInit(t) {
        t.options.plugins.tooltip && (t.tooltip = new yo({ _chart: t }));
      },
      beforeUpdate(t) {
  ...
  function ko(t) {
    const e = Math.floor(R(t)),
      i = t / Math.pow(10, e);
    let n;
    return (n = i <= 1 ? 1 : i <= 2 ? 2 : i <= 5 ? 5 : 10), n * Math.pow(10, e);
  }
  (wo.id = "category"),
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        let u,
          ...
          p,
          m = ko((d - h) / c / l) * l;
        if (m < 1e-14 && s(o) && s(a)) return [{ value: h }, { value: d }];
        (p = Math.ceil(d / m) - Math.floor(h / m)),
          p > c && (m = ko((p * m) / c / l) * l),
          n || s(r)
            ? (u = Math.pow(10, N(m)))
            : ((u = Math.pow(10, r)), (m = Math.ceil(m * u) / u)),
          (g = Math.floor(h / m) * m),
          (f = Math.ceil(d / m) * m),
          !n || s(o) || s(a) || (z((a - o) / n, m / 1e3) && ((g = o), (f = a))),
          (p = (f - g) / m),
          (p = F(p, Math.round(p), m / 1e3) ? Math.round(p) : Math.ceil(p)),
          (g = Math.round(g * u) / u),
          (f = Math.round(f * u) / u),
          i.push({ value: s(o) ? g : o });
        for (let t = 1; t < p; ++t)
          i.push({ value: Math.round((g + t * m) * u) / u });
        return i.push({ value: s(a) ? f : a }), i;
      })(
        {
          maxTicks: n,
          min: e.min,
          ...
          stepSize: h(i.fixedStepSize, i.stepSize),
        },
        t
      );
      return (
        "ticks" === e.bounds && I(o, t, "value"),
        e.reverse
  ...
  (So.id = "linear"),
    (So.defaults = { ticks: { callback: ui.formatters.numeric } });
  class Oo extends bi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    parse(t, e) {
      const i = Po.prototype.parse.apply(this, [t, e]);
      if (0 !== i) return l(i) && i > 0 ? i : NaN;
      this._zero = !0;
    }
    determineDataLimits() {
      const t = this,
        { min: e, max: i } = t.getMinMax(!0);
      (t.min = l(e) ? Math.max(0, e) : null),
        (t.max = l(i) ? Math.max(0, i) : null),
    ...
    handleTickRangeOptions() {
      ...
      const s = (t) => (n = e ? n : t),
        a = (t) => (o = i ? o : t),
        r = (t, e) => Math.pow(10, Math.floor(R(t)) + e);
    ...
    getPixelForValue(t) {
      ...
      return (
        ...
        e.getPixelForDecimal(
          t === e.min ? 0 : (R(t) - e._startValue) / e._valueRange
        )
      );
    }
    getValueForPixel(t) {
  ...
  function To(t) {
    ...
    return e.display && t.display
      ? h(e.font && e.font.size, w.font.size) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  function Lo(t, e, i, n) {
    let o,
      ...
      r = i.y + n / 2;
    if (a(e))
      for (o = 0, s = e.length; o < s; ++o) t.fillText(e[o], i.x, r), (r += n);
  ...
  class Fo extends Po {
    ...
    determineDataLimits() {
      ...
      (t.min = l(e) && !isNaN(e) ? e : 0),
        (t.max = l(i) && !isNaN(i) ? i : 0),
        t.handleTickRangeOptions();
    }
    computeTickLimit() {
    ...
    generateTickLabels(t) {
      const e = this;
      Po.prototype.generateTickLabels.call(e, t),
        (e.pointLabels = e.chart.data.labels.map((t, i) => {
          const n = d(e.options.pointLabels.callback, [t, i], e);
          return n || 0 === n ? n : "";
        }));
    }
    fit() {
      ...
      e.display && e.pointLabels.display
        ? (function (t) {
            ...
            for (n = 0; n < r; n++) {
              ...
              const r = t.getContext(n),
                d = It(
                  Vt([t.options.pointLabels.font], r, n),
                  t.chart.options.font
                );
              (t.ctx.font = d.string),
                (l = t.ctx),
                (c = d.lineHeight),
                (o = a((h = t.pointLabels[n]))
                  ? { w: Z(l, l.font, h), h: h.length * c }
                  : { w: l.measureText(h).width, h: c }),
                (t._pointLabelSizes[n] = o);
              const u = t.getIndexAngle(n),
                g = W(u),
                f = Ao(g, s.x, o.w, 0, 180),
                p = Ao(g, s.y, o.h, 90, 270);
              f.start < e.l && ((e.l = f.start), (i.l = u)),
                f.end > e.r && ((e.r = f.end), (i.r = u)),
                p.start < e.t && ((e.t = p.start), (i.t = u)),
                p.end > e.b && ((e.b = p.end), (i.b = u));
            }
            var l, c, h;
    ...
    getIndexAngle(t) {
      const e = this.chart;
      return U(
        t * (P / e.data.labels.length) + B((e.options || {}).startAngle || 0)
      );
    }
    ...
    drawGrid() {
      ...
      if (
          ...
          (function (t) {
            ...
            for (let i = t.chart.data.labels.length - 1; i >= 0; i--) {
              const a = 0 === i ? o / 2 : 0,
                ...
                l = t.getContext(i),
                c = It(Vt([n.font], l, i), t.chart.options.font);
              (e.font = c.string), (e.fillStyle = n.color);
              const h = W(t.getIndexAngle(i));
              (e.textAlign = Co(h)),
                Ro(h, t._pointLabelSizes[i], r),
                Lo(e, t.pointLabels[i], r, c.lineHeight);
            }
            e.restore();
          })(t),
        n.display &&
              ...
              (function (t, e, i, n) {
                ...
                if ((s || a) && l && c) {
                  if (
                    ...
                    (o.lineWidth = c),
                    o.setLineDash &&
                      (o.setLineDash(Vt([e.borderDash, []], r)),
                      (o.lineDashOffset = Vt([e.borderDashOffset], r, n - 1))),
                    o.beginPath(),
                    s)
                  )
                    o.arc(t.xCenter, t.yCenter, i, 0, P);
                  else {
                    (h = t.getPointPosition(0, i)), o.moveTo(h.x, h.y);
                    for (let e = 1; e < a; e++)
                      (h = t.getPointPosition(e, i)), o.lineTo(h.x, h.y);
                  }
        ...
        for (e.save(), s = t.chart.data.labels.length - 1; s >= 0; s--) {
          const l = t.getContext(s),
            c = Vt([o.lineWidth, n.lineWidth], l, s),
            h = Vt([o.color, n.color], l, s);
          c &&
            h &&
            ((e.lineWidth = c),
            (e.strokeStyle = h),
            e.setLineDash &&
              (e.setLineDash(Vt([o.borderDash, n.borderDash, []], l)),
              (e.lineDashOffset = Vt(
    ...
    drawLabels() {
      ...
      e.save(),
        ...
        t.ticks.forEach((o, r) => {
          ...
          const l = t.getContext(r),
            c = t._resolveTickFontOptions(r);
          (e.font = c.string),
            (s = t.getDistanceFromCenterForValue(t.ticks[r].value));
          Vt([n.showLabelBackdrop], l, r) &&
            ((a = e.measureText(o.label).width),
            (e.fillStyle = Vt([n.backdropColor], l, r)),
            e.fillRect(
              -a / 2 - n.backdropPaddingX,
              -s - c.size / 2 - n.backdropPaddingY,
              a + 2 * n.backdropPaddingX,
              c.size + 2 * n.backdropPaddingY
            )),
            (e.fillStyle = n.color),
            e.fillText(o.label, 0, -s);
        }),
        e.restore();
    }
    drawTitle() {}
  ...
  const zo = Number.MAX_SAFE_INTEGER || 9007199254740991,
    Io = {
  ...
  function Wo(t, e) {
    ...
    let c = e;
    return (
      "function" == typeof o && (c = o(c)),
      l(c) || (c = "string" == typeof o ? i.parse(c, o) : i.parse(c)),
      null === c
        ? c
        : (a &&
            (c =
              "week" !== a || (!E(r) && !0 !== r)
                ? t._adapter.startOf(c, a)
                : t._adapter.startOf(c, "isoWeek", r)),
          +c)
    );
  }
  function No(t, e, i, n) {
    const o = Vo.length;
    for (let s = Vo.indexOf(t); s < o - 1; ++s) {
      const t = Io[Vo[s]],
        o = t.steps ? t.steps : zo;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Vo[s];
    }
    return Vo[o - 1];
  }
  function Ho(t, e, i) {
  ...
  class Yo extends bi {
    ...
    init(t, e) {
      ...
      b(i.displayFormats, n.formats()),
        super.init(t),
        (this._normalized = e.normalized);
    }
    parse(t, e) {
      return void 0 === t ? NaN : Wo(this, t);
    }
    invalidateCaches() {
      this._cache = { data: [], labels: [], all: [] };
    }
    determineDataLimits() {
      ...
      (a && r) ||
        ...
        ("ticks" === e.bounds && "labels" === e.ticks.source) ||
          c(t.getMinMax(!1))),
        (o = l(o) && !isNaN(o) ? o : +i.startOf(Date.now(), n)),
        (s = l(s) && !isNaN(s) ? s : +i.endOf(Date.now(), n) + 1),
        (t.min = Math.min(o, s)),
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? No(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = Vo.length - 1; s >= Vo.indexOf(i); s--) {
                  const i = Vo[s];
                  if (Io[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
        ...
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = Vo.indexOf(t) + 1, i = Vo.length; e < i; ++e)
                  if (Io[Vo[e]].common) return Vo[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || No(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = h(s.stepSize, 1),
      ...
      let u,
        g = i;
      if (
        (c && (g = +e.startOf(g, "isoWeek", l)),
        (g = +e.startOf(g, c ? "day" : a)),
        e.diff(n, i, a) > 1e5 * r)
      )
        throw new Error(
          i + " and " + n + " are too far apart with stepSize of " + r + " " + a
        );
      const f = "data" === o.ticks.source && t.getDataTimestamps();
      for (u = g; u < n; u = +e.add(u, r, a)) Ho(d, u, f);
      return (
        (u !== n && "ticks" !== o.bounds) || Ho(d, u, f),
        Object.keys(d)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelSize(t) {
      const e = this,
        ...
        o = B(e.isHorizontal() ? i.maxRotation : i.minRotation),
        s = Math.cos(o),
        a = Math.sin(o),
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, jo(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(Wo(t, o[i]));
  ...
  class $o extends Yo {
    ...
    getPixelForValue(t, e) {
      const i = this,
        n = i._offsets,
        o =
          i._normalized && i._maxIndex > 0 && !s(e)
            ? e / i._maxIndex
            : i.getDecimalForValue(t);
      return i.getPixelForDecimal((n.start + o) * n.factor);
    }
    getDecimalForValue(t) {
      return Uo(this._table, t) / this._maxIndex;
    }
    getValueForPixel(t) {
      const e = this,
        i = e._offsets,
        n = e.getDecimalForPixel(t) / i.factor - i.end;
      return Uo(e._table, n * this._maxIndex, !0);
    }
  }
  ($o.id = "timeseries"), ($o.defaults = Yo.defaults);
  ...
  return (
    Ei.register(pn, Xo, In, Mo),
    (Ei.helpers = { ...Qi }),
    (Ei._adapters = en),
    (Ei.Animation = qe),
    (Ei.Animations = Ze),
    (Ei.animator = i),
    (Ei.controllers = yi.controllers.items),
    (Ei.DatasetController = li),
    (Ei.Element = ci),
    (Ei.elements = In),
    (Ei.Interaction = Ct),
    (Ei.layouts = Kt),
    ...
    (Ei.Scale = bi),
    (Ei.Ticks = ui),
    Object.assign(Ei, pn, Xo, In, Mo, he),
    (Ei.Chart = Ei),
