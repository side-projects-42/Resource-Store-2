...
!(function (t, e) {
  ...
  var ut = new (class {
    ...
    set(t, e) {
      return "string" == typeof t ? it(dt(this, t), e) : it(dt(this, ""), t);
    }
    get(t) {
      return dt(this, t);
    }
    describe(t, e) {
      const i = this[ht];
      return "string" == typeof t ? it(dt(i, t), e) : it(dt(i, ""), t);
    }
    get descriptors() {
      return this[ht];
    }
  ...
  function Tt(t, e) {
    ...
    return s < -0.5 * ft && (s += gt), { angle: s, distance: o };
  }
  function Lt(t, e) {
  ...
  function Wt(t, e, i, n) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
      if (((d = i[l]), null != d && !0 !== H(d))) a = Bt(t, o, s, a, d);
      else if (H(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), null == u || H(u) || (a = Bt(t, o, s, a, u));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
      ...
      switch ((t.beginPath(), c)) {
        ...
        case "rectRounded":
          (l = 0.516 * d),
            ...
            (s = Math.cos(u + _t) * r),
            (a = Math.sin(u + _t) * r),
            t.arc(i - s, n - a, l, u - ft, u - bt),
            t.arc(i + a, n - s, l, u - bt, u),
            t.arc(i + s, n + a, l, u, u + bt),
            t.arc(i - a, n + s, l, u + bt, u + ft),
            t.closePath();
          break;
        case "rect":
          if (!h) {
  ...
  const Zt = (t, e, i) => Gt(t, i, (n) => t[n][e] < i),
    Qt = (t, e, i) => Gt(t, i, (n) => t[n][e] >= i);
  function Jt(t, e, i) {
    let n = 0,
      o = t.length;
    for (; n < o && t[n] < e; ) n++;
  ...
  const ae = (t) => window.getComputedStyle(t, null);
  function re(t, e) {
  ...
  function ue(t, e, i, n) {
    const o = ae(t),
      s = ce(o, "margin"),
      a = se(o.maxWidth, t, "clientWidth") || mt,
      r = se(o.maxHeight, t, "clientHeight") || mt,
      l = (function (t, e, i) {
        let n, o;
        if (void 0 === e || void 0 === i) {
          ...
          if (s) {
            ...
            (e = t.width - l.width - r.width),
              ...
              (n = se(a.maxWidth, s, "clientWidth")),
              (o = se(a.maxHeight, s, "clientHeight"));
          } else (e = t.clientWidth), (i = t.clientHeight);
        }
        return { width: e, height: i, maxWidth: n || mt, maxHeight: o || mt };
      })(t, e, i);
    let { width: c, height: h } = l;
    if ("content-box" === o.boxSizing) {
      const t = ce(o, "border", "width"),
        e = ce(o, "padding");
    ...
    return (
      ...
      {
        width: de(Math.min(c, a, l.maxWidth)),
        height: de(Math.min(h, r, l.maxHeight)),
      }
    );
  }
  function fe(t, e, i) {
  ...
  function xe(t, e, i, n) {
    ...
    if (r && e === r.axis && a && s.length) {
      const t = r._reversePixels ? Qt : Zt;
      if (!n) return t(s, e, i);
      if (o._sharedOptions) {
        const n = s[0],
  ...
  function ye(t, e, i, n, o) {
    ...
    let a = Number.POSITIVE_INFINITY,
      r = [];
    if (!Yt(e, t.chartArea)) return r;
    return (
      be(t, i, e, function (t, i, l) {
  ...
  var Me = {
    modes: {
      index(t, e, i, n) {
        const o = me(e, t),
          s = i.axis || "x",
          a = i.intersect ? _e(t, o, s, n) : ye(t, o, s, !1, n),
          r = [];
        return a.length
      ...
      dataset(t, e, i, n) {
        const o = me(e, t),
          s = i.axis || "xy";
        let a = i.intersect ? _e(t, o, s, n) : ye(t, o, s, !1, n);
        if (a.length > 0) {
      ...
      point: (t, e, i, n) => _e(t, me(e, t), i.axis || "xy", n),
      nearest: (t, e, i, n) => ye(t, me(e, t), i.axis || "xy", i.intersect, n),
      x: (t, e, i, n) => ((i.axis = "x"), ve(t, e, i, n)),
      y: (t, e, i, n) => ((i.axis = "y"), ve(t, e, i, n)),
    },
  };
  const we = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/);
  function ke(t, e) {
    const i = ("" + t).match(we);
  ...
  function Ce(t, e) {
    ...
    const n = {
      ...
      lineHeight: ke(X(t.lineHeight, e.lineHeight), i),
      size: i,
  ...
  const Te = ["left", "top", "right", "bottom"];
  function Le(t, e) {
    return t.filter((t) => t.pos === e);
  }
  function Re(t, e) {
    return t.filter((t) => -1 === Te.indexOf(t.pos) && t.box.axis === e);
  }
  function Ee(t, e) {
    return t.sort((t, i) => {
      const n = e ? i : t,
  ...
  function Fe(t, e, i) {
    ...
    const s = Math.max(0, e.outerWidth - ze(o, t, "left", "right")),
      a = Math.max(0, e.outerHeight - ze(o, t, "top", "bottom"));
    return s !== t.w || a !== t.h
  ...
  function Ve(t, e, i) {
    ...
    for (o = 0, s = t.length; o < s; ++o)
      (a = t[o]),
        (r = a.box),
        r.update(a.width || e.w, a.height || e.h, Ie(a.horizontal, e)),
        Fe(e, i, a) && ((c = !0), n.length && (l = !0)),
        r.fullSize || n.push(a);
    return (l && Ve(n, e, i)) || c;
  }
  function Be(t, e, i) {
  ...
  ut.set("layout", { padding: { top: 0, right: 0, bottom: 0, left: 0 } });
  var We = {
    addBox(t, e) {
      t.boxes || (t.boxes = []),
    ...
    update(t, e, i) {
      if (!t) return;
      const n = Oe(t.options.layout.padding),
        o = e - n.width,
        s = i - n.height,
        a = (function (t) {
          const e = (function (t) {
  ...
  const He = {
    ...
    Ye = (t) => null === t || "" === t;
  const $e = !!ge && { passive: !0 };
  function Ue(t, e, i) {
    t.canvas.removeEventListener(e, i, $e);
  }
  function Xe(t, e, i) {
    const n = t.canvas,
      o = (n && oe(n)) || n,
  ...
  function Qe(t, i, n) {
    ...
    return (
      r.observe(s),
      (function (t, e) {
        qe.size || window.addEventListener("resize", Ze), qe.set(t, e);
      })(t, a),
      r
    );
  }
  function Je(t, e, i) {
    i && i.disconnect(),
      "resize" === e &&
        (function (t) {
          qe.delete(t), qe.size || window.removeEventListener("resize", Ze);
        })(t);
  }
  function ti(t, i, n) {
    const o = t.canvas,
  ...
  class ei extends Ne {
    ...
    addEventListener(t, e, i) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        o = { attach: Xe, detach: Ke, resize: Qe }[e] || ti;
      n[e] = o(t, e, i);
    }
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: Je, detach: Je, resize: Je }[e] || Ue)(t, e, n),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  const ni = (t) => 0 === t || 1 === t,
    oi = (t, e, i) =>
      -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * gt) / i),
    si = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * gt) / i) + 1,
    ai = {
      linear: (t) => t,
      easeInQuad: (t) => t * t,
      easeOutQuad: (t) => -t * (t - 2),
      ...
      easeInOutQuint: (t) =>
        (t /= 0.5) < 1
          ? 0.5 * t * t * t * t * t
          : 0.5 * ((t -= 2) * t * t * t * t + 2),
      easeInSine: (t) => 1 - Math.cos(t * bt),
      easeOutSine: (t) => Math.sin(t * bt),
      easeInOutSine: (t) => -0.5 * (Math.cos(ft * t) - 1),
      ...
      easeOutElastic: (t) => (ni(t) ? t : si(t, 0.075, 0.3)),
      easeInOutElastic(t) {
        const e = 0.1125;
        return ni(t)
          ? t
      ...
      easeInBounce: (t) => 1 - ai.easeOutBounce(1 - t),
      easeOutBounce(t) {
        const e = 7.5625,
          i = 2.75;
        return t < 1 / i
  ...
  class ci {
    constructor(t, e, i, n) {
      ...
      const s = Ae([t.from, o, n]);
      (this._active = !0),
        (this._fn = t.fn || li[t.type || typeof s]),
        (this._easing = ai[t.easing] || ai.linear),
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._loop = !!t.loop),
          (n._to = Ae([t.to, e, o, t.from])),
          (n._from = Ae([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  const hi = Object.keys(ut.animation);
  ut.describe("animation", {
    ...
    ut.describe("animations", { _fallback: "animation" }),
    ut.set("transitions", {
  ...
  function gi(t, e, i, n) {
    ...
    if (null !== e) {
      for (s = 0, a = o.length; s < a; ++s) {
        ...
        (l = t.values[r]), !$(l) || (0 !== e && Dt(e) !== Dt(l)) || (e += l);
      }
      return e;
    }
  }
  ...
  function xi(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: n, [c]: s } = i;
      (u = (i._stacks || (i._stacks = {}))[c] = mi(o, h, n)), (u[r] = s);
    }
  }
  function bi(t, e) {
    const i = t.scales;
  ...
  class Mi {
    ...
    linkScales() {
      const t = this,
        ...
        s = (i.xAxisID = X(n.xAxisID, bi(e, "x"))),
        a = (i.yAxisID = X(n.yAxisID, bi(e, "y"))),
        r = (i.rAxisID = X(n.rAxisID, bi(e, "r"))),
        l = i.indexAxis,
    ...
    _destroy() {
      ...
      this._data && ie(this._data, this), t._stacked && _i(t);
    }
    _dataCheck() {
      const t = this,
        e = t.getDataset(),
      ...
      Y(i)
        ...
        : t._data !== i &&
          (t._data && ie(t._data, t),
          i && Object.isExtensible(i) && ee(i, t),
          (t._data = i));
    }
    addElements() {
      const t = this,
    ...
    buildOrUpdateElements(t) {
      ...
      e._dataCheck(),
        ...
        i.stack !== n.stack && ((o = !0), _i(i), (i.stack = n.stack)),
        e._resyncElements(t),
        o && xi(e, i._parsed);
    }
    configure() {
    ...
    applyStack(t, e) {
      const i = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return gi({ keys: fi(i, !0), values: e._stacks[t.axis] }, o, n.index);
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (s = gi(n, o, this._cachedMeta.index, !0))),
        (t.min = Math.min(t.min, s)),
        (t.max = Math.max(t.max, s));
    }
    getMinMax(t, e) {
      const i = this,
        ...
        l = e && n._stacked && { keys: fi(i.chart, !0), values: null },
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        g.$shared && ((g.$shared = l), (s[a] = Object.freeze(vi(g, l)))), g
      );
    }
    ...
    updateElement(t, e, i, n) {
      yi(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
    }
  ...
  (wi.defaults = {}), (wi.defaultRoutes = void 0);
  const ki = new Map();
  function Pi(t, e, i) {
    return (function (t, e) {
      e = e || {};
      ...
      let n = ki.get(i);
      return n || ((n = new Intl.NumberFormat(t, e)), ki.set(i, n)), n;
    })(e, i).format(t);
  }
  const Si = {
    values: (t) => (H(t) ? t : "" + t),
    ...
    logarithmic: function (t, e, i) {
      if (0 === t) return "0";
      const n = t / Math.pow(10, Math.floor(Mt(t)));
      return 1 === n || 2 === n || 5 === n
        ? Si.numeric.call(this, t, e, i)
        : "";
    },
  };
  var Di = { formatters: Si };
  function Oi(t, e) {
    const i = [],
      n = t.length / e,
      o = t.length;
  ...
  ut.set("scale", {
    ...
    ut.route("scale.ticks", "color", "", "color"),
    ut.route("scale.gridLines", "color", "", "borderColor"),
    ut.route("scale.scaleLabel", "color", "", "color"),
    ut.describe("scale", {
      _fallback: !1,
      _scriptable: (t) =>
        !t.startsWith("before") &&
    ...
    ut.describe("scales", { _fallback: "scale" });
  class Ri extends wi {
    constructor(t) {
      super(),
        (this.id = t.id),
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? Oi(n.ticks, s) : n.ticks),
        n.configure(),
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            Ai(e.gridLines) -
            i.padding -
            Ti(e.scaleLabel, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = Ct(
            Math.min(
    ...
    fit() {
      const t = this,
        ...
        c = t.isHorizontal(),
        h = r && Ti(s, i.options.font);
      if (
        (c ? (e.width = t.maxWidth) : r && (e.width = Ai(a) + h),
        c ? r && (e.height = Ai(a) + h) : (e.height = t.maxHeight),
        ...
        if (
          ...
          if (H(g))
            for (u = 0, f = g.length; u < f; ++u)
              (v = g[u]),
                j(v) || H(v) || ((_ = Bt(e, x.data, x.gc, _, v)), (y += b));
        } else (_ = Bt(e, x.data, x.gc, _, g)), (y = b);
        o.push(_),
          s.push(y),
          a.push(b / 2),
          (r = Math.max(_, r)),
    ...
    getPixelForDecimal(t) {
      const e = this;
      return e._reversePixels && (t = 1 - t), It(e._startPixel + t * e._length);
    }
    ...
    _autoSkip(t) {
      ...
      if (s > 0) {
        ...
        for (Li(t, l, c, j(n) ? 0 : a - n, a), e = 0, i = s - 1; e < i; e++)
          Li(t, l, c, o[e], o[e + 1]);
        return Li(t, l, c, r, j(n) ? t.length : r + n), l;
      }
      return Li(t, l, c), l;
    }
    _tickSize() {
    ...
    _getXAxisLabelAlignment() {
      ...
      if (-Ot(this.labelRotation)) return "top" === t ? "left" : "right";
      let i = "center";
      return (
    ...
    drawGrid(t) {
      ...
      if (a) {
        ...
        e.isHorizontal()
          ? ((l = Nt(o, e.left, a) - a / 2),
            (c = Nt(o, e.right, s) + s / 2),
            (h = d = r))
          : ((h = Nt(o, e.top, a) - a / 2),
            (d = Nt(o, e.bottom, s) + s / 2),
            (l = c = r)),
          (n.lineWidth = a),
  ...
  Ri.prototype._draw = Ri.prototype.draw;
  class Ei {
    constructor(t, e) {
    ...
    unregister(t) {
      const e = this.items,
        i = t.id,
        n = this.scope;
      i in e && delete e[i], n && i in ut[n] && delete ut[n][i];
    }
  }
  var zi = new (class {
    constructor() {
      (this.controllers = new Ei(Mi, "controllers")),
        (this.elements = new Ei(wi, "elements")),
        (this.plugins = new Ei(Object, "plugins")),
        (this.scales = new Ei(Ri, "scales")),
  ...
  class Fi {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        o = (function (t) {
          const e = [],
            i = Object.keys(zi.plugins.items);
          for (let t = 0; t < i.length; t++) e.push(zi.getPlugin(i[t]));
          const n = t.plugins || [];
        ...
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Ii(i[r.id], n);
              null !== l &&
                o.push({ plugin: r, options: Vi(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  function Vi(t, e, i, n) {
    ...
    return t.createResolver(s, n, [""], { scriptable: !1, indexable: !1 });
  }
  function Bi(t, e = [""], i = t, n) {
      ...
      get: (i, n) =>
        Yi(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e)
              if (((o = Ki(ji(s, t), i)), lt(o)))
                return Hi(t, o) ? Xi(i, n, t, o) : o;
          })(n, e, t, i)
        ),
  ...
  function Wi(t, e, i, n) {
    const o = {
      ...
      _stack: new Set(),
      _descriptors: Ni(t, n),
      setContext: (e) => Wi(t, e, i, n),
      override: (o) => Wi(t.override(o), e, i, n),
    };
    return new Proxy(o, {
            ...
            H(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (lt(s.index) && n(t)) e = e[s.index % e.length];
                  ...
                  for (const l of i) {
                    const i = Xi(n, o, t, l);
                    e.push(Wi(i, s, a && a[t], r));
                  }
                }
                return e;
              })(e, r, t, a.isIndexable));
            Hi(e, r) && (r = Wi(r, o, s && s[e], a));
            return r;
          })(t, e, i)
        ),
  ...
  function Ni(t, e = { scriptable: !0, indexable: !0 }) {
    const { _scriptable: i = e.scriptable, _indexable: n = e.indexable } = t;
    return {
      scriptable: i,
      indexable: n,
  ...
  const ji = (t, e) => (t ? t + rt(e) : e),
    Hi = (t, e) => Y(e);
  function Yi(t, e, i) {
    let n = t[e];
    return lt(n) || ((n = i()), lt(n) && (t[e] = n)), n;
  }
  const $i = (t, e) => (!0 === t ? e : at(e, t));
  function Ui(t, e, i, n) {
    for (const o of e) {
      const e = $i(i, o);
      if (e) {
  ...
  function Xi(t, e, i, n) {
    const o = e._rootScopes,
      ...
      r = new Set([n]);
    let l = i;
    for (; !1 !== l; ) if (((l = Ui(r, a, l, s)), null === l)) return !1;
    if (lt(s) && s !== i) {
      const t = a;
      for (l = s; !1 !== l; ) l = Ui(r, t, l, s);
    }
    return Bi([...r], [""], o, s);
  }
  function Ki(t, e) {
  ...
  function Gi(t, e) {
    const i = (ut.controllers[t] || {}).datasets || {};
    return (
  ...
  function Qi(t) {
    ...
    (e.plugins = X(e.plugins, {})),
      (e.scales = (function (t, e) {
        const i = ut.controllers[t.type] || { scales: {} },
          n = e.scales || {},
          o = Gi(t.type, e),
        ...
        return (
          ...
          t.data.datasets.forEach((i) => {
            const o = i.type || t.type,
              r = i.indexAxis || Gi(o, e),
              l = (ut.controllers[o] || {}).scales || {};
          ...
          Object.keys(a).forEach((t) => {
            const e = a[t];
            nt(e, [ut.scales[e.type], ut.scale]);
          }),
          a
        );
      })(t, e));
  ...
  function en(t, e) {
    let i = Ji.get(t);
    return i || ((i = e()), Ji.set(t, i), tn.add(i)), i;
  }
  const nn = (t, e, i) => {
    const n = at(e, i);
    void 0 !== n && t.add(n);
  ...
  class on {
    constructor(t) {
      (this._config = (function (t) {
        ...
        return (
          (e.datasets = e.datasets || []), (e.labels = e.labels || []), Qi(t), t
        );
      })(t)),
    ...
    getOptionScopes(t, e, i) {
      ...
      if (o) return o;
      const s = new Set();
      t && (s.add(t), e.forEach((e) => nn(s, t, e))),
        e.forEach((t) => nn(s, this.options, t)),
        e.forEach((t) => nn(s, ut, t)),
        e.forEach((t) => nn(s, ut.descriptors, t));
      const a = [...s];
      return tn.has(e) && n.set(e, a), a;
    }
    chartOptionScopes() {
      return [
        this.options,
        ut.controllers[this.type] || {},
        { type: this.type },
        ut,
        ut.descriptors,
      ];
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = sn(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
        ...
        o.$shared = !1;
        r = Wi(s, (i = ct(i) ? i() : i), this.createResolver(t, i, a));
      }
  ...
  class pn {
    constructor(t, e) {
      ...
      (this.id = N()),
        ...
        (fn[i.id] = i),
        r && l
          ? (o.listen(i, "complete", cn),
            o.listen(i, "progress", hn),
            i._initialize(),
            i.attached && i.update())
          : console.error(
    ...
    _initialize() {
      ...
      return (
        ...
        t.options.responsive ? t.resize() : fe(t, t.options.devicePixelRatio),
        t.bindEvents(),
      ...
      i &&
        ...
        Z(s, (i) => {
          const s = i.options,
            ...
            r = Zi(a, s),
            l = X(s.type, i.dtype);
          (void 0 !== s.position && rn(s.position, r) === rn(i.dposition)) ||
        ...
        Z(n, (e) => {
          We.configure(t, e, e.options), We.addBox(t, e);
        });
    }
    ...
    _updateMetasets() {
      ...
      t._sortedMetasets = e.slice(0).sort(ln("order", "index"));
    }
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || Gi(a, t.options)),
          (s.order = o.order || 0),
          ...
          const i = ut.controllers[a],
            o = zi.getController(a);
          Object.assign(o.prototype, {
            dataElementType: zi.getElement(i.dataElementType),
            datasetElementType:
              i.datasetElementType && zi.getElement(i.datasetElementType),
          }),
    ...
    _handleEvent(t, e) {
      ...
      return (
        ...
        ("mouseup" !== t.type &&
          "click" !== t.type &&
          "contextmenu" !== t.type) ||
          (Yt(t, i.chartArea) && G(o.onClick, [t, r, i], i)),
        (l = !Q(r, n)),
  ...
  const mn = () => Z(pn.instances, (t) => t._plugins.invalidate()),
    xn = !0;
  Object.defineProperties(pn, {
    defaults: { enumerable: xn, value: ut },
    instances: { enumerable: xn, value: fn },
    registry: { enumerable: xn, value: zi },
    version: { enumerable: xn, value: "3.0.0-beta.12" },
    getChart: { enumerable: xn, value: gn },
    register: {
      enumerable: xn,
      value: (...t) => {
        zi.add(...t), mn();
  ...
  function Mn(t, e, i, n) {
    ...
    if (
      ...
      for (o = 0, s = t.length; o < s; ++o)
        (a = t[o]),
          (r = _n(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension)),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (o = t[i]),
            Yt(o, e) &&
              (i > 0 &&
                Yt(t[i - 1], e) &&
                ((o.controlPointPreviousX = vn(
                  o.controlPointPreviousX,
                  e.left,
                  e.right
                )),
                (o.controlPointPreviousY = vn(
              ...
              i < t.length - 1 &&
                Yt(t[i + 1], e) &&
                ((o.controlPointNextX = vn(
                  o.controlPointNextX,
                  e.left,
                  e.right
                )),
                (o.controlPointNextY = vn(
                  o.controlPointNextY,
                  e.top,
                  e.bottom
                ))));
  ...
  function Cn(t) {
    return "angle" === t
      ? { between: zt, compare: Rt, normalize: Et }
      : {
  ...
  function Tn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      a = e.length,
      { compare: r, between: l, normalize: c } = Cn(n),
      {
        start: h,
        end: d,
        loop: u,
    ...
    for (let t = h, i = h; t <= d; ++t)
      (p = e[t % a]),
        p.skip ||
          ...
          null !== b && y() && (f.push(An(b, t, u, a)), (b = null)),
          (i = t),
          (m = g));
    return null !== b && f.push(An(b, d, u, a)), f;
  }
  function Ln(t, e) {
    const i = [],
      n = t.segments;
    for (let o = 0; o < n.length; o++) {
      const s = Tn(n[o], t.points, e);
      s.length && i.push(...s);
    }
    return i;
  }
  ...
  var En = Object.freeze({
    ...
    _rlookupByKey: Qt,
    _filterBetween: Jt,
    listenArrayEvents: ee,
    unlistenArrayEvents: ie,
    _arrayUnique: ne,
    _createResolver: Bi,
    _attachContext: Wi,
    _descriptors: Ni,
    splineCurve: _n,
    splineCurveMonotone: yn,
    ...
    getMaximumSize: ue,
    retinaScale: fe,
    supportsEventListenerOptions: ge,
    readUsedSize: pe,
    _pointInLine: wn,
    _steppedInterpolation: kn,
    _bezierInterpolation: Pn,
    toLineHeight: ke,
    toTRBL: Se,
    toTRBLCorners: De,
    toPadding: Oe,
    ...
    almostEquals: kt,
    almostWhole: Pt,
    _setMinAndMaxByKey: St,
    sign: Dt,
    toRadians: Ot,
    toDegrees: Ct,
    _decimalPlaces: At,
    getAngleFromPoint: Tt,
    distanceBetweenPoints: Lt,
    _angleDiff: Rt,
    _normalizeAngle: Et,
    _angleBetween: zt,
    _limitValue: Ft,
  ...
  function Vn(t) {
    const e = (function (t) {
      if (!t._cache.$bar) {
        ...
        t._cache.$bar = ne(i.sort((t, e) => t - e));
      }
      return t._cache.$bar;
    })(t);
    let i,
  ...
  class Yn extends Mi {
        ...
        { circumference: h, rotation: d } = e._getRotationExtents(),
        {
          ...
          if (e < gt) {
            const r = t,
              ...
              d = Math.cos(l),
              u = Math.sin(l),
              f = (t, e, n) => (zt(t, r, l) ? 1 : Math.max(e, e * i, n, n * i)),
              g = (t, e, n) =>
                zt(t, r, l) ? -1 : Math.min(e, e * i, n, n * i),
              p = f(0, c, d),
              m = f(bt, h, u),
              x = g(ft, c, d),
              b = g(ft + bt, h, u);
    ...
    _circumference(t, e) {
      ...
      return (e && n.animation.animateRotate) ||
        ...
        null === o._parsed[t]
        ? 0
        : i.calculateCircumference((o._parsed[t] * s) / gt);
    }
    updateElements(t, e, i, n) {
      const o = this,
        s = "reset" === n,
  ...
  class $n extends Mi {
        ...
        if (t._sorted) {
          ...
          d &&
            (o = Ft(
              Math.min(
                Zt(r, a.axis, c).lo,
                i ? n : Zt(e, l, a.getPixelForValue(c)).lo
              ),
              0,
              n - 1
            )),
            (s = u
              ? Ft(
                  Math.max(
                    Zt(r, a.axis, h).hi + 1,
                    i ? 0 : Zt(e, l, a.getPixelForValue(h)).hi + 1
                  ),
                  o,
                  n
                ) - o
    ...
    updateElements(t, e, i, n) {
      const o = this,
        ...
        f = wt(u) ? u : Number.POSITIVE_INFINITY,
  ...
  class Un extends Mi {
    ...
    _computeAngle(t, e, i) {
      return this.chart.getDataVisibility(t)
        ? Ot(this.resolveDataElementOptions(t, e).angle || i)
        : 0;
    }
  }
  (Un.id = "polarArea"),
  ...
  (Xn.id = "pie"),
    (Xn.defaults = {
      datasets: { cutout: 0, rotation: 0, circumference: 360, radius: "100%" },
    });
  class Kn extends Mi {
    getLabelAndValue(t) {
    ...
    r.borderWidth &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          for (
            i &&
              ((e.endAngle = e.startAngle + gt),
              Zn(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle &&
                ((e.endAngle += gt), e.fullCircles--)),
              t.beginPath(),
              t.arc(n, o, c, s + gt, s, !0),
              h = 0;
            h < e.fullCircles;
            ++h
          )
            t.stroke();
          for (
            t.beginPath(), t.arc(n, o, l, s, s + gt), h = 0;
            h < e.fullCircles;
            ++h
          )
            t.stroke();
  ...
  class to extends wi {
    ...
    inRange(t, e, i) {
      const n = this.getProps(["x", "y"], i),
        { angle: o, distance: s } = Tt(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      ...
      if (
        ...
        (e.fullCircles = Math.floor(e.circumference / gt)),
        !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0))
      ) {
        if ((t.save(), n && e.circumference < gt)) {
        ...
        (t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              (e.endAngle = e.startAngle + gt), Qn(t, e);
              for (let i = 0; i < e.fullCircles; ++i) t.fill();
              e.endAngle = e.startAngle + (e.circumference % gt);
            }
            Qn(t, e), t.fill();
          })(t, e),
          Jn(t, e),
  ...
  function no(t, e, i, n) {
    const { points: o, options: s } = e,
      ...
      h = (function (t) {
        return t.stepped ? Xt : t.tension ? Kt : eo;
      })(s);
    let d,
      u,
      f,
  ...
  function so(t) {
    ...
    return !(t._decimated || t._loop || e.tension || e.stepped || i) ? oo : no;
  }
  (to.id = "arc"),
    (to.defaults = {
      borderAlign: "center",
  ...
  class ro extends wi {
    ...
    get segments() {
      return this._segments || (this._segments = Rn(this));
    }
    first() {
    ...
    interpolate(t, e) {
      const i = this,
        ...
        o = t[e],
        s = i.points,
        a = Ln(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [],
        l = (function (t) {
          return t.stepped ? kn : t.tension ? Pn : wn;
        })(n);
      let c, h;
  ...
  function mo(t) {
    const e = ho(t),
      ...
      s = (function (t, e, i) {
        const n = De(t.options.borderRadius),
          o = Math.min(e, i),
          s = uo(t);
        return {
          topLeft: po(s.top || s.left, n.topLeft, 0, o),
          topRight: po(s.top || s.right, n.topRight, 0, o),
          bottomLeft: po(s.bottom || s.left, n.bottomLeft, 0, o),
          bottomRight: po(s.bottom || s.right, n.bottomRight, 0, o),
        };
      })(t, i / 2, n / 2);
    return {
  ...
  function bo(t, e) {
    ...
    t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -bt, ft, !0),
      t.lineTo(i, n + s - a.bottomLeft),
      t.arc(i + a.bottomLeft, n + s - a.bottomLeft, a.bottomLeft, ft, bt, !0),
      ...
      t.arc(i + o - a.topRight, n + a.topRight, a.topRight, 0, -bt, !0),
    ...
    const { chart: e, scale: i, index: n, line: o } = t,
      ...
      l = (function (t, e) {
        ...
        for (let t = 0; t < n.length; t++) {
          const o = n[t];
          if (o.index === e) break;
          Do(o) && i.unshift(o.dataset);
        }
        return i;
      })(e, n);
    l.push(Ao({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) Oo(s, r[t], l);
    }
    return new ro({ points: s, options: {} });
  }
  const Do = (t) => "line" === t.type && !t.hidden;
  function Oo(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = Co(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function Ao(t, e) {
    ...
    return (
      ...
      i.length
        ? new ro({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function To(t, e, i) {
  ...
  function Io(t, e) {
    const { line: i, target: n, property: o, color: s, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (let t = 0; t < n.length; t++) {
          const r = n[t],
            l = Ro(i, o[r.start], o[r.end], r.loop);
          if (!e.segments) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              n = Ro(i, s[e.start], s[e.end], e.loop),
              h = Tn(r, o, n);
    ...
    for (let e = 0, s = r.length; e < s; ++e) {
      ...
      t.save(), zo(t, a, Ro(o, c, h)), t.beginPath();
      const d = !!i.pathSegment(t, s);
      d ? t.closePath() : Fo(t, n, h, o);
  ...
  var Vo = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          s.push(c);
      for (r = 0; r < n; ++r)
        (c = s[r]), c && !1 !== c.fill && (c.fill = To(s, r, o));
    },
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          if ("stack" === i) return So(t);
          const o = Po(t);
          return o instanceof ko ? o : Ao(o, n);
        })(o),
        { line: a, scale: r } = o,
        l = a.options,
        c = l.fill,
        ...
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              s !== o &&
              (Lo(t, n, a.top),
              Io(t, { line: i, target: n, color: o, scale: r, property: l }),
              t.restore(),
              t.save(),
              Lo(t, n, a.bottom)),
            Io(t, { line: i, target: n, color: s, scale: r, property: l }),
            t.restore();
  ...
  class Wo extends wi {
    ...
    fit() {
      ...
      const n = e.labels,
        ...
        { boxWidth: r, itemHeight: l } = Bo(n, s);
      let c, h;
      (i.font = o.string),
        t.isHorizontal()
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (s.fillStyle = u),
        (s.font = d.string);
      const { boxWidth: m, boxHeight: x, itemHeight: b } = Bo(l, g),
        _ = t.isHorizontal(),
  ...
  var No = {
    ...
    _element: Wo,
    start(t, e, i) {
      const n = (t.legend = new Wo({ ctx: t.ctx, options: i, chart: t }));
      We.configure(t, n, i), We.addBox(t, n);
    },
    stop(t) {
      We.removeBox(t, t.legend), delete t.legend;
    },
    beforeUpdate(t, e, i) {
      const n = t.legend;
      We.configure(t, n, i), (n.options = i);
    },
    afterUpdate(t) {
  ...
  class jo extends wi {
    ...
    update(t, e) {
      ...
      i._padding = Oe(n.padding);
      const s = o * Ce(n.font).lineHeight + i._padding.height;
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ...
          : ("left" === a.position
              ? ((c = i + t), (h = n(r, o, e)), (d = -0.5 * ft))
              : ((c = s - t), (h = n(r, e, o)), (d = 0.5 * ft)),
            (l = o - e)),
  ...
  var Ho = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        const i = new jo({ ctx: t.ctx, options: e, chart: t });
        We.configure(t, i, e), We.addBox(t, i), (t.titleBlock = i);
      })(t, i);
    },
    stop(t) {
      const e = t.titleBlock;
      We.removeBox(t, e), delete t.titleBlock;
    },
    beforeUpdate(t, e, i) {
  ...
  class Jo extends wi {
    ...
    getTitle(t) {
      ...
      let a = [];
      return (a = $o(a, Uo(n))), (a = $o(a, Uo(o))), (a = $o(a, Uo(s))), a;
    }
    getBeforeBody(t) {
      return Qo(this.options.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t) {
      const e = this,
        i = e.options.callbacks,
      ...
      return (
        Z(t, (t) => {
          ...
          $o(o.before, Uo(i.beforeLabel.call(e, t))),
            $o(o.lines, i.label.call(e, t)),
            $o(o.after, Uo(i.afterLabel.call(e, t))),
            n.push(o);
        }),
        n
      );
    ...
    getAfterBody(t) {
      return Qo(this.options.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t) {
      const e = this,
        i = e.options.callbacks,
    ...
    _createItems() {
      ...
      let r,
        l,
        c = [];
      for (r = 0, l = e.length; r < l; ++r) c.push(Xo(t._chart, e[r]));
      return (
    ...
    update(t) {
      ...
      let o;
      if (n.length) {
        const t = Yo[i.position].call(e, n, e._eventPosition),
          s = e._createItems();
    ...
    drawTitle(t, e) {
      ...
      let a, r, l;
      if (s) {
        const c = Sn(n.rtl, i.x, i.width);
        for (
          t.x = Zo(i, n.titleAlign),
    ...
    drawBody(t, e) {
      ...
      (u = 0), (d = s.size), Z(i.afterBody, g), (t.y -= a);
    }
    drawFooter(t, e) {
      const i = this,
        n = i.options,
      ...
      let a, r;
      if (s) {
        const l = Sn(n.rtl, i.x, i.width);
        for (
          t.x = Zo(i, n.footerAlign),
    ...
    _updateAnimationTarget() {
      const t = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = Yo[i.position].call(t, t._active, t._eventPosition);
        if (!n) return;
        const a = (t._size = Ko(t)),
    ...
    _positionChanged(t, e) {
      const i = this,
        n = Yo[i.options.position].call(i, t, e);
  ...
  var ts = {
      ...
      positioners: Yo,
      afterInit(t, e, i) {
        i && (t.tooltip = new Jo({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
  ...
  function ns(t) {
    const e = Math.floor(Mt(t)),
      i = t / Math.pow(10, e);
    let n;
    return (n = i <= 1 ? 1 : i <= 2 ? 2 : i <= 5 ? 5 : 10), n * Math.pow(10, e);
  }
  (is.id = "category"),
    (is.defaults = { ticks: { callback: is.prototype.getLabelForValue } });
  class os extends Ri {
    constructor(t) {
      super(t),
        (this.start = void 0),
      ...
      const o = (function (t, e) {
        ...
        (g = Math.ceil(h / p) - Math.floor(c / p)),
          ...
          !n ||
            j(o) ||
            j(s) ||
            (Pt((s - o) / n, p / 1e3) && ((u = o), (f = s))),
          (g = (f - u) / p),
          (g = kt(g, Math.round(g), p / 1e3) ? Math.round(g) : Math.ceil(g)),
          (u = Math.round(u * d) / d),
          (f = Math.round(f * d) / d),
  ...
  (ss.id = "linear"),
    (ss.defaults = { ticks: { callback: Di.formatters.numeric } });
  class rs extends Ri {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    handleTickRangeOptions() {
      ...
      const s = (t) => (n = e ? n : t),
        a = (t) => (o = i ? o : t),
        r = (t, e) => Math.pow(10, Math.floor(Mt(t)) + e);
    ...
    getPixelForValue(t) {
      ...
      return (
        ...
        e.getPixelForDecimal(
          t === e.min ? 0 : (Mt(t) - e._startValue) / e._valueRange
        )
      );
    }
    getValueForPixel(t) {
  ...
  function ls(t) {
    ...
    return e.display && t.display
      ? X(e.font && e.font.size, ut.font.size) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  (rs.id = "logarithmic"),
    (rs.defaults = {
      ticks: { callback: Di.formatters.logarithmic, major: { enabled: !0 } },
    });
  class fs extends os {
    constructor(t) {
      super(t),
    ...
    getIndexAngle(t) {
      const e = this.chart;
      return Et(
        t * (gt / e.data.labels.length) + Ot((e.options || {}).startAngle || 0)
      );
    }
          ...
          (function (t) {
            ...
            for (let i = t.chart.data.labels.length - 1; i >= 0; i--) {
              const a = 0 === i ? o / 2 : 0,
                ...
                c = Ce(l.font),
                h = Ct(t.getIndexAngle(i));
              ds(h, t._pointLabelSizes[i], r),
              ...
              !(function (t, e, i) {
                ...
                if ((o || s) && a && r && !(i < 0)) {
                  if (
                    ...
                    n.arc(t.xCenter, t.yCenter, i, 0, gt);
                  else {
  ...
  (fs.id = "radialLinear"),
    ...
    (fs.descriptors = { angleLines: { _fallback: "gridLines" } });
  const gs = Number.MAX_SAFE_INTEGER || 9007199254740991,
    ps = {
  ...
  function _s(t, e, i, n) {
    const o = ms.length;
    for (let s = ms.indexOf(t); s < o - 1; ++s) {
      const t = ps[ms[s]],
        o = t.steps ? t.steps : gs;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return ms[s];
    }
    return ms[o - 1];
  }
  function ys(t, e, i) {
  ...
  class Ms extends Ri {
    ...
    init(t, e) {
      const i = t.time || (t.time = {}),
        n = (this._adapter = new In._date(t.adapters.date));
      nt(i.displayFormats, n.formats()),
        super.init(t),
        (this._normalized = e.normalized);
    }
    parse(t, e) {
      return void 0 === t ? null : bs(this, t);
    }
    beforeLayout() {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? _s(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = ms.length - 1; s >= ms.indexOf(i); s--) {
                  const i = ms[s];
                  if (ps[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
        ...
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = ms.indexOf(t) + 1, i = ms.length; e < i; ++e)
                  if (ps[ms[e]].common) return ms[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || _s(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = X(s.stepSize, 1),
      ...
      for (d = u; d < n; d = +e.add(d, r, a)) ys(h, d, f);
      return (
        (d !== n && "ticks" !== o.bounds) || ys(h, d, f),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelSize(t) {
      const e = this,
        ...
        o = Ot(e.isHorizontal() ? i.maxRotation : i.minRotation),
        s = Math.cos(o),
        a = Math.sin(o),
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, vs(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(bs(t, o[i]));
  ...
  class ks extends Ms {
    ...
    getDecimalForValue(t) {
      return ws(this._table, t) / this._maxIndex;
    }
    getValueForPixel(t) {
      const e = this,
        i = e._offsets,
        n = e.getDecimalForPixel(t) / i.factor - i.end;
      return ws(e._table, n * this._maxIndex, !0);
    }
  }
  (ks.id = "timeseries"), (ks.defaults = Ms.defaults);
  ...
  return (
    pn.register(Gn, Ps, vo, es),
    (pn.helpers = { ...En }),
    (pn._adapters = In),
    (pn.Animation = ci),
    (pn.Animations = di),
    (pn.animator = o),
    (pn.controllers = zi.controllers.items),
    (pn.DatasetController = Mi),
    (pn.Element = wi),
    (pn.elements = vo),
    (pn.Interaction = Me),
    (pn.layouts = We),
    ...
    (pn.Scale = Ri),
    (pn.Ticks = Di),
    Object.assign(pn, Gn, Ps, vo, es, ii),
    (pn.Chart = pn),
    "undefined" != typeof window && (window.Chart = pn),
    pn
  );
});
