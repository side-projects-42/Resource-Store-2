...
!(function (t, e) {
  ...
  const z = (t) => t instanceof CanvasGradient || t instanceof CanvasPattern;
  function V(t) {
    return z(t) ? t : I(t);
  }
  function B(t) {
    return z(t) ? t : I(t).saturate(0.5).darken(0.1).hexString();
  }
  function W() {}
  const H = (function () {
    let t = 0;
  ...
  function at(t, e) {
    ...
    let i = 0,
      n = st(e, i);
    for (; t && n > i; )
      (t = t[e.substr(i, n - i)]), (i = n + 1), (n = st(e, i));
    return t;
  }
  function rt(t) {
      ...
      Object.defineProperties(o, {
        ...
        [e]: {
          ...
          get() {
            const t = this[a],
              e = s[n];
            return $(t) ? Object.assign({}, e, t) : X(t, e);
          },
          set(t) {
            this[a] = t;
          },
  ...
  function jt(t, e, i, n) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
      if (((d = i[l]), null != d && !0 !== j(d))) a = Nt(t, o, s, a, d);
      else if (j(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), null == u || j(u) || (a = Nt(t, o, s, a, u));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
  ...
  function Qt(t, e, i, n, o, s = {}) {
    ...
    for (
      t.save(),
        ...
        N(s.rotation) || t.rotate(s.rotation),
        t.font = o.string,
      ...
      if (
        ...
        r &&
          ...
          N(s.strokeWidth) || (t.lineWidth = s.strokeWidth),
  ...
  function Me(t, e, i, n) {
    const o = [];
    if (!Xt(e, t.chartArea, t._minPadding)) return o;
    return (
      ve(
        t,
        i,
  ...
  const Pe = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/);
  function De(t, e) {
    const i = ("" + t).match(Pe);
  ...
  function Oe(t) {
    ...
    return { top: e, right: i, bottom: n, left: o };
  }
  function Te(t) {
    let e, i, n, o;
    return (
  ...
  function Fe(t, e) {
    const { min: i, max: n } = t;
    return { min: i - Math.abs(K(e, i)), max: n + K(e, n) };
  }
  const Ie = ["left", "top", "right", "bottom"];
  function ze(t, e) {
    return t.filter((t) => t.pos === e);
  }
  function Ve(t, e) {
    return t.filter((t) => -1 === Ie.indexOf(t.pos) && t.box.axis === e);
  }
  function Be(t, e) {
    return t.sort((t, i) => {
      const n = e ? i : t,
  ...
  function Ne(t, e, i) {
    const n = i.box,
      o = t.maxPadding;
    if ($(i.pos)) return { same: !1, other: !1 };
    i.size && (t[i.pos] -= i.size),
      (i.size = i.horizontal ? n.height : n.width),
      (t[i.pos] += i.size),
      n.getPadding && He(o, n.getPadding());
    const s = Math.max(0, e.outerWidth - We(o, t, "left", "right")),
      a = Math.max(0, e.outerHeight - We(o, t, "top", "bottom")),
      r = s !== t.w,
      l = a !== t.h;
    return (
      (t.w = s),
  ...
  function $e(t, e, i) {
    ...
    for (o = 0, s = t.length, l = 0; o < s; ++o) {
      (a = t[o]),
        (r = a.box),
        r.update(a.width || e.w, a.height || e.h, je(a.horizontal, e));
      const { same: s, other: h } = Ne(e, i, a);
  ...
  var Ue = {
    ...
    update(t, e, i, n) {
      if (!t) return;
      const o = Le(t.options.layout.padding),
        s = e - o.width,
        a = i - o.height,
        r = (function (t) {
          const e = (function (t) {
  ...
  const Ke = {
    ...
    Ge = (t) => null === t || "" === t;
  const Ze = !!xe && { passive: !0 };
  function Qe(t, e, i) {
    t.canvas.removeEventListener(e, i, Ze);
  }
  function Je(t, e, i) {
    const n = t.canvas,
      o = (n && re(n)) || n,
  ...
  function oi(t, i, n) {
    ...
    return (
      r.observe(s),
      (function (t, e) {
        ei.size || window.addEventListener("resize", ni), ei.set(t, e);
      })(t, a),
      r
    );
  }
  function si(t, e, i) {
    i && i.disconnect(),
      "resize" === e &&
        (function (t) {
          ei.delete(t), ei.size || window.removeEventListener("resize", ni);
        })(t);
  }
  function ai(t, i, n) {
    const o = t.canvas,
  ...
  class ri extends Xe {
    ...
    releaseContext(t) {
      ...
      ["height", "width"].forEach((t) => {
        const n = i[t];
        N(n) ? e.removeAttribute(t) : e.setAttribute(t, n);
      });
      const n = i.style || {};
      return (
    ...
    addEventListener(t, e, i) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        o = { attach: Je, detach: ti, resize: oi }[e] || ai;
      n[e] = o(t, e, i);
    }
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: si, detach: si, resize: si }[e] || Qe)(t, e, n),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  const ci = (t) => 0 === t || 1 === t,
    ...
    di = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * mt) / i) + 1,
    ui = {
      linear: (t) => t,
      easeInQuad: (t) => t * t,
      easeOutQuad: (t) => -t * (t - 2),
      ...
      easeInElastic: (t) => (ci(t) ? t : hi(t, 0.075, 0.3)),
      easeOutElastic: (t) => (ci(t) ? t : di(t, 0.075, 0.3)),
      easeInOutElastic(t) {
        const e = 0.1125;
        return ci(t)
          ? t
  ...
  class pi {
    constructor(t, e, i, n) {
      const o = e[i];
      n = Ee([t.to, n, o, t.from]);
      const s = Ee([t.from, o, n]);
      (this._active = !0),
        (this._fn = t.fn || gi[t.type || typeof s]),
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._total += s),
          (n._loop = !!t.loop),
          (n._to = Ee([t.to, e, o, t.from])),
          (n._from = Ee([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  class xi {
    ...
    configure(t) {
      ...
      Object.getOwnPropertyNames(t).forEach((i) => {
        ...
        if (!$(n)) return;
        const o = {};
        for (const t of mi) o[t] = n[t];
        ((j(n.properties) && n.properties) || [i]).forEach((t) => {
  ...
  class Ci {
    ...
    linkScales() {
      const t = this,
        ...
        s = (i.xAxisID = X(n.xAxisID, ki(e, "x"))),
        a = (i.yAxisID = X(n.yAxisID, ki(e, "y"))),
        r = (i.rAxisID = X(n.rAxisID, ki(e, "r"))),
        l = i.indexAxis,
    ...
    _destroy() {
      ...
      this._data && se(this._data, this), t._stacked && Si(t);
    }
    _dataCheck() {
      const t = this,
        e = t.getDataset(),
      ...
      $(i)
        ...
        : t._data !== i &&
          (t._data && (se(t._data, t), Si(t._cachedMeta)),
    ...
    buildOrUpdateElements(t) {
      ...
      e._dataCheck(),
        ...
        i.stack !== n.stack && ((o = !0), Si(i), (i.stack = n.stack)),
        e._resyncElements(t),
        o && wi(e, i._parsed);
    }
    configure() {
    ...
    applyStack(t, e, i) {
      const n = this.chart,
        o = this._cachedMeta,
        s = e[t.axis];
      return yi({ keys: _i(n, !0), values: e._stacks[t.axis] }, s, o.index, {
        mode: i,
      });
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (s = yi(n, o, this._cachedMeta.index, { all: !0 }))),
        (t.min = Math.min(t.min, s)),
        (t.max = Math.max(t.max, s));
    }
    getMinMax(t, e) {
      ...
      function m() {
        return (
          (g = o[u]), (f = g[t.axis]), (p = g[r.axis]), !Y(f) || h > p || d < p
        );
      }
      for (
        u = 0;
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        g.$shared && ((g.$shared = l), (s[a] = Object.freeze(Di(g, l)))), g
      );
    }
    ...
    updateSharedOptions(t, e, i) {
      t && !Pi(e) && this._resolveAnimations(void 0, e).update(t, i);
    }
    _setStyle(t, e, i, n) {
      t.active = n;
  ...
  (Ai.defaults = {}), (Ai.defaultRoutes = void 0);
  const Oi = new Map();
  function Ti(t, e, i) {
    return (function (t, e) {
      e = e || {};
  ...
  const Li = {
    ...
    numeric(t, e, i) {
      ...
      return Object.assign(c, this.options.ticks.format), Ti(t, n, c);
    },
    logarithmic: function (t, e, i) {
      if (0 === t) return "0";
      const n = t / Math.pow(10, Math.floor(wt(t)));
      return 1 === n || 2 === n || 5 === n
        ? Li.numeric.call(this, t, e, i)
        : "";
    },
  };
  var Ri = { formatters: Li };
  const Ei = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i);
  function Fi(t, e) {
    const i = [],
      n = t.length / e,
      o = t.length;
  ...
  function Vi(t, e) {
    ...
    const i = Re(t.font, e),
      n = Le(t.padding);
    return (j(t.text) ? t.text.length : 1) * i.lineHeight + n.height;
  }
  ...
  class Hi extends Ai {
    ...
    getUserBounds() {
      ...
      return (
        ...
        { min: U(t, i), max: U(e, n), minDefined: Y(t), maxDefined: Y(e) }
      );
    }
    getMinMax(t) {
      const e = this;
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? Fi(n.ticks, s) : n.ticks),
        n.configure(),
        ...
        o.display &&
          ...
          ((n.ticks = n._autoSkip(n.ticks)), (n._labelSizes = null)),
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            zi(e.grid) -
            i.padding -
            Vi(e.title, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = Lt(
            Math.min(
    ...
    fit() {
      const t = this,
        ...
        r = t.isHorizontal();
      if (a) {
        const a = Vi(o, i.options.font);
        if (
          (r
            ? ((e.width = t.maxWidth), (e.height = zi(s) + a))
            : ((e.height = t.maxHeight), (e.width = zi(s) + a)),
        ...
        if (
          ...
          if (j(c))
            for (r = 0, l = c.length; r < l; ++r)
              (m = c[r]),
                N(m) || j(m) || ((g = Nt(i, u.data, u.gc, g, m)), (p += f));
        } else (g = Nt(i, u.data, u.gc, g, c)), (p = f);
    ...
    getPixelForDecimal(t) {
      ...
      return Wt(e._alignToPixels ? $t(e.chart, i, 0) : i);
    }
    ...
    _autoSkip(t) {
      ...
      if (o > 0) {
        let e, i;
        const c = o > 1 ? Math.round((a - s) / (o - 1)) : null;
        for (Bi(t, r, l, N(c) ? 0 : s - c, s), e = 0, i = o - 1; e < i; e++)
          Bi(t, r, l, n[e], n[e + 1]);
        return Bi(t, r, l, a, N(c) ? t.length : a + c), r;
      }
      return Bi(t, r, l), r;
    }
    _tickSize() {
    ...
    drawTitle() {
      ...
      "bottom" === e
        ? ((l += a.bottom),
          j(i.text) && (l += s.lineHeight * (i.text.length - 1)))
        : (l += a.top);
      const {
        titleX: c,
        titleY: h,
    ...
    _layers() {
      const t = this,
        ...
        n = (e.grid && e.grid.z) || 0;
      return t._isVisible() && i !== n && t.draw === Hi.prototype.draw
        ? [
            {
              z: n,
              draw(e) {
    ...
    _resolveTickFontOptions(t) {
      return Re(this.options.ticks.setContext(this.getContext(t)).font);
    }
  }
  function Ni(t, e = [""], i = t, n) {
    lt(n) || (n = Ji("_fallback", t));
    const o = {
      ...
      get: (i, n) =>
        Xi(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e)
              if (((o = Ji(Yi(s, t), i)), lt(o)))
                return Ui(t, o) ? Zi(i, n, t, o) : o;
          })(n, e, t, i)
        ),
      getOwnPropertyDescriptor: (t, e) =>
        Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
      getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
      has: (t, e) => tn(t).includes(e),
      ownKeys: (t) => tn(t),
  ...
  function ji(t, e, i, n) {
    const o = {
      ...
      _stack: new Set(),
      _descriptors: $i(t, n),
      setContext: (e) => ji(t, e, i, n),
      override: (o) => ji(t.override(o), e, i, n),
    };
    return new Proxy(o, {
            ...
            j(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (lt(s.index) && n(t)) e = e[s.index % e.length];
                  ...
                  for (const l of i) {
                    const i = Zi(n, o, t, l);
                    e.push(ji(i, s, a && a[t], r));
                  }
                }
                return e;
              })(e, r, t, a.isIndexable));
            Ui(e, r) && (r = ji(r, o, s && s[e], a));
            return r;
          })(t, e, i)
        ),
  ...
  function $i(t, e = { scriptable: !0, indexable: !0 }) {
    const {
  ...
  const en = Number.EPSILON || 1e-14,
    nn = (t, e) => e < t.length && !t[e].skip && t[e];
  function on(t, e, i, n) {
    const o = t.skip ? e : t,
      s = e,
      a = i.skip ? e : i,
    ...
    !(function (t, e, i) {
      ...
      (function (t, e) {
        ...
        let n,
          ...
          a = nn(t, 0);
        for (let r = 0; r < i; ++r) {
          if (((o = s), (s = a), (a = nn(t, r + 1)), !s)) continue;
          const { x: i, y: l } = s;
  ...
  function rn(t, e, i, n) {
    ...
    if (
      ...
      for (o = 0, s = t.length; o < s; ++o)
        (a = t[o]),
          (r = on(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension)),
          (a.cp1x = r.previous.x),
          (a.cp1y = r.previous.y),
          (a.cp2x = r.next.x),
          (a.cp2y = r.next.y),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a &&
                ((o.cp1x = an(o.cp1x, e.left, e.right)),
                (o.cp1y = an(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = an(o.cp2x, e.left, e.right)),
                (o.cp2y = an(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function ln(t, e, i, n) {
  ...
  function gn(t) {
    return "angle" === t
      ? { between: Vt, compare: It, normalize: zt }
      : {
  ...
  function mn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      a = e.length,
      { compare: r, between: l, normalize: c } = gn(n),
      {
        start: h,
        end: d,
        loop: u,
  ...
  var _n = Object.freeze({
    ...
    _descriptors: $i,
    splineCurve: on,
    splineCurveMonotone: sn,
    _updateBezierControlPoints: rn,
    _getParentNode: re,
    getStyle: he,
    ...
    readUsedSize: be,
    _pointInLine: ln,
    _steppedInterpolation: cn,
    _bezierInterpolation: hn,
    toLineHeight: De,
    toTRBL: Oe,
    toTRBLCorners: Te,
    toPadding: Le,
    ...
    _int16Range: Wt,
    getRtlAdapter: dn,
    overrideTextDirection: un,
    restoreTextDirection: fn,
    _boundSegment: mn,
    _boundSegments: xn,
    _computeSegments: bn,
  });
  ...
  var vn = new (class {
    constructor() {
      (this.controllers = new yn(Ci, "datasets", !0)),
        (this.elements = new yn(Ai, "elements")),
        (this.plugins = new yn(Object, "plugins")),
        (this.scales = new yn(Hi, "scales")),
        ...
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = wn(i[r.id], n);
              null !== l &&
                o.push({ plugin: r, options: kn(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  function On(t, e) {
    let i = Cn.get(t);
    return i || ((i = e()), Cn.set(t, i), An.add(i)), i;
  }
  const Tn = (t, e, i) => {
    const n = at(e, i);
    void 0 !== n && t.add(n);
  ...
  class Ln {
    constructor(t) {
      (this._config = (function (t) {
        ...
        return (
          (e.datasets = e.datasets || []), (e.labels = e.labels || []), Dn(t), t
        );
      })(t)),
    ...
    getOptionScopes(t, e, i) {
      ...
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => Tn(r, t, e))),
          e.forEach((t) => Tn(r, n, t)),
          e.forEach((t) => Tn(r, ht[o] || {}, t)),
          e.forEach((t) => Tn(r, gt, t)),
          e.forEach((t) => Tn(r, dt, t));
      });
      const l = [...r];
      return An.has(e) && s.set(e, l), l;
    }
    chartOptionScopes() {
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = Rn(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
          const { isScriptable: i, isIndexable: n } = $i(t);
          for (const o of e)
            if ((i(o) && ct(t[o])) || (n(o) && j(t[o]))) return !0;
          return !1;
        })(s, e)
      ) {
        o.$shared = !1;
        r = ji(s, (i = ct(i) ? i() : i), this.createResolver(t, i, a));
      }
      for (const t of e) o[t] = r[t];
      return o;
    }
    createResolver(t, e, i = [""], n) {
      const { resolver: o } = Rn(this._resolverCache, t, i);
      return $(e) ? ji(o, e, void 0, n) : o;
    }
  }
  function Rn(t, e, i) {
    let n = t.get(e);
  ...
  class jn {
    constructor(t, e) {
      ...
      (this.id = H()),
        ...
        (Hn[i.id] = i),
        r && l
          ? (o.listen(i, "complete", zn),
            o.listen(i, "progress", Vn),
            i._initialize(),
            i.attached && i.update())
          : console.error(
      ...
      i &&
        ...
        Z(s, (i) => {
          const s = i.options,
            ...
            r = Pn(a, s),
            l = X(s.type, i.dtype);
          (void 0 !== s.position && Fn(s.position, r) === Fn(i.dposition)) ||
        ...
        Z(n, (e) => {
          Ue.configure(t, e, e.options), Ue.addBox(t, e);
        });
    }
    ...
    _updateMetasets() {
      ...
      t._sortedMetasets = e.slice(0).sort(In("order", "index"));
    }
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || Sn(a, t.options)),
          (s.order = o.order || 0),
          ...
          const i = vn.getController(a),
            { datasetElementType: o, dataElementType: r } = gt.datasets[a];
          Object.assign(i.prototype, {
            dataElementType: vn.getElement(r),
            datasetElementType: o && vn.getElement(o),
          }),
    ...
    _updateLayout(t) {
      ...
      Ue.update(e, e.width, e.height, t);
      const i = e.chartArea,
    ...
    _handleEvent(t, e) {
      ...
      return (
        ...
        ("mouseup" !== t.type &&
          "click" !== t.type &&
          "contextmenu" !== t.type) ||
          (Xt(t, i.chartArea, i._minPadding) && G(o.onClick, [t, r, i], i)),
        (l = !Q(r, n)),
  ...
  const $n = () => Z(jn.instances, (t) => t._plugins.invalidate()),
    Yn = !0;
  function Un() {
    throw new Error(
  ...
  Object.defineProperties(jn, {
    defaults: { enumerable: Yn, value: gt },
    instances: { enumerable: Yn, value: Hn },
    overrides: { enumerable: Yn, value: ht },
    registry: { enumerable: Yn, value: vn },
    version: { enumerable: Yn, value: "3.0.0-rc" },
    getChart: { enumerable: Yn, value: Nn },
    register: {
      enumerable: Yn,
      value: (...t) => {
        vn.add(...t), $n();
  ...
  class Jn extends Ci {
    ...
    draw() {
      const t = this,
        ...
        s = o.length;
      let a = 0;
      for (qt(e.ctx, e.chartArea); a < s; ++a)
  ...
  class eo extends Ci {
    ...
    update(t) {
      const e = this,
        ...
        l = Math.min(q(e.options.cutout, r), 1),
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        i = this.chart,
        n = i.data.labels || [],
        o = Ti(e._parsed[t], i.options.locale);
        ...
        tooltip: {
          callbacks: {
            ...
            label(t) {
              ...
              return j(e) ? ((e = e.slice()), (e[0] += i)) : (e += i), e;
            },
          },
        },
      },
  ...
  var ro = Object.freeze({
    ...
    BarController: Jn,
    BubbleController: to,
    DoughnutController: eo,
    LineController: io,
    PolarAreaController: no,
    PieController: oo,
    RadarController: so,
    ...
    draw(t) {
      ...
      if (
        ...
        (t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              (e.endAngle = e.startAngle + mt), co(t, e);
  ...
  function po(t, e, i, n) {
    const { points: o, options: s } = e,
      ...
      h = (function (t) {
        return t.stepped ? Gt : t.tension ? Zt : fo;
      })(s);
    let d,
      u,
      f,
  ...
  function xo(t) {
    ...
    return !(t._decimated || t._loop || e.tension || e.stepped || i) ? mo : po;
  }
  (uo.id = "arc"),
    (uo.defaults = {
      borderAlign: "center",
    ...
    (uo.defaultRoutes = { backgroundColor: "backgroundColor" });
  const bo =
  ...
  class _o extends Ai {
    ...
    updateControlPoints(t) {
      ...
      if (i.tension && !i.stepped && !e._pointsUpdated) {
        ...
        rn(e._points, i, t, n), (e._pointsUpdated = !0);
      }
    }
    set points(t) {
      const e = this;
    ...
    get segments() {
      return this._segments || (this._segments = bn(this));
    }
    first() {
    ...
    interpolate(t, e) {
      const i = this,
        ...
        o = t[e],
        s = i.points,
        a = xn(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [],
        l = (function (t) {
          return t.stepped ? cn : t.tension ? hn : ln;
        })(n);
      let c, h;
  ...
  function Eo(t, e, i) {
    ...
    if ($(n)) return !isNaN(n.value) && n;
    let o = parseFloat(n);
    return Y(o) && Math.floor(o) === o
      ? (("-" !== n[0] && "+" !== n[0]) || (o = e + o),
        !(o === e || o < 0 || o >= i) && o)
    ...
    const { chart: e, scale: i, index: n, line: o } = t,
      ...
      l = (function (t, e) {
        ...
        for (let t = 0; t < n.length; t++) {
          const o = n[t];
          if (o.index === e) break;
          Vo(o) && i.unshift(o.dataset);
        }
        return i;
      })(e, n);
    l.push(Ho({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) Bo(s, r[t], l);
    }
    return new _o({ points: s, options: {} });
  }
  const Vo = (t) => "line" === t.type && !t.hidden;
  function Bo(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = Wo(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function Ho(t, e) {
    ...
    return (
      ...
      i.length
        ? new _o({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function No(t, e, i) {
  ...
  function qo(t, e) {
    const { line: i, target: n, property: o, color: s, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (let t = 0; t < n.length; t++) {
          const r = n[t],
            l = $o(i, o[r.start], o[r.end], r.loop);
          if (!e.segments) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              n = $o(i, s[e.start], s[e.end], e.loop),
              h = mn(r, o, n);
            for (let t = 0; t < h.length; t++)
              a.push({
                source: h[t],
                target: e,
                start: { [i]: Yo(l, n, "start", Math.max) },
                end: { [i]: Yo(l, n, "end", Math.min) },
              });
          }
        }
        return a;
    ...
    for (let e = 0, s = r.length; e < s; ++e) {
      ...
      t.save(), Uo(t, a, $o(o, c, h)), t.beginPath();
      const d = !!i.pathSegment(t, s);
      d ? t.closePath() : Xo(t, n, h, o);
  ...
  var Ko = {
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          s.push(c);
      for (r = 0; r < n; ++r)
        (c = s[r]), c && !1 !== c.fill && (c.fill = No(s, r, o));
    },
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          if ("stack" === i) return zo(t);
          const o = Io(t);
          return o instanceof Fo ? o : Ho(o, n);
        })(o),
        { line: a, scale: r } = o,
        l = a.options,
        c = l.fill,
  ...
  class Zo extends Ai {
    ...
    fit() {
      ...
      const n = e.labels,
        ...
        { boxWidth: r, itemHeight: l } = Go(n, s);
      let c, h;
      (i.font = o.string),
        t.isHorizontal()
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (s.fillStyle = u),
        (s.font = d.string);
      const { boxWidth: x, boxHeight: b, itemHeight: _ } = Go(l, g),
        y = t.isHorizontal(),
        ...
        h.setWidth(t.width),
          y
            ...
            : u > 0 &&
              ...
              m.line++,
              (D = m.y = n(r, t.top + v + f, t.bottom - i[m.line].height)));
        const C = h.x(P);
        !(function (t, e, i) {
          ...
          (a[u].left = h.leftForLtr(C, a[u].width)),
          (a[u].top = D),
          (P = ((t, e, i) =>
    ...
    drawTitle() {
      const t = this,
        ...
        a = Le(o.padding);
      if (!o.display) return;
      const r = dn(e.rtl, t.left, t.width),
        l = t.ctx,
        c = o.position,
        h = s.size / 2,
        d = a.top + h;
  ...
  var Qo = {
    ...
    _element: Zo,
    start(t, e, i) {
      const n = (t.legend = new Zo({ ctx: t.ctx, options: i, chart: t }));
      Ue.configure(t, n, i), Ue.addBox(t, n);
    },
    stop(t) {
      Ue.removeBox(t, t.legend), delete t.legend;
    },
    beforeUpdate(t, e, i) {
      const n = t.legend;
      Ue.configure(t, n, i), (n.options = i);
    },
    afterUpdate(t) {
  ...
  class Jo extends Ai {
    ...
    update(t, e) {
      ...
      i._padding = Le(n.padding);
      const s = o * Re(n.font).lineHeight + i._padding.height;
  ...
  var ts = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        ...
        Ue.configure(t, i, e), Ue.addBox(t, i), (t.titleBlock = i);
      })(t, i);
    },
    stop(t) {
      const e = t.titleBlock;
      Ue.removeBox(t, e), delete t.titleBlock;
    },
    beforeUpdate(t, e, i) {
  ...
  function ls(t, e, i, n) {
    ...
    return (
      "center" === l
        ...
        ? (d -= h)
        : "right" === r && (d += h),
      { x: Bt(d, 0, n.width - e.width), y: Bt(u, 0, n.height - e.height) }
    );
  }
  function cs(t, e, i) {
    const n = Le(i.padding);
    return "center" === e
      ? t.x + t.width / 2
      : "right" === e
      ? t.x + t.width - n.right
  ...
  class us extends Ai {
    ...
    getTitle(t, e) {
      ...
      let r = [];
      return (r = is(r, ns(o))), (r = is(r, ns(s))), (r = is(r, ns(a))), r;
    }
    getBeforeBody(t, e) {
      ...
      return (
        Z(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            s = ds(n, t);
          is(e.before, ns(s.beforeLabel.call(i, t))),
            is(e.lines, s.label.call(i, t)),
            is(e.after, ns(s.afterLabel.call(i, t))),
            o.push(e);
        }),
        o
      );
    ...
    update(t) {
      ...
      let o,
        s = [];
      if (n.length) {
        const t = es[i.position].call(e, n, e._eventPosition);
        (s = e._createItems(i)),
    ...
    drawTitle(t, e, i) {
      ...
      let a, r, l;
      if (s) {
        const c = dn(i.rtl, n.x, n.width);
        for (
          t.x = cs(n, i.titleAlign, i),
    ...
    drawBody(t, e, i) {
      ...
      (u = 0), (d = h.lineHeight), Z(n.afterBody, g), (t.y -= s);
    }
    drawFooter(t, e, i) {
      const n = this,
        o = n.footer,
      ...
      let a, r;
      if (s) {
        const l = dn(i.rtl, n.x, n.width);
        for (
          t.x = cs(n, i.footerAlign, i),
    ...
    _updateAnimationTarget(t) {
      const e = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = es[t.position].call(e, e._active, e._eventPosition);
        if (!n) return;
        const a = (e._size = ss(e, t)),
    ...
    draw(t) {
      ...
      i.enabled &&
        ...
        un(t, i.textDirection),
        (s.y += a.top),
        e.drawTitle(s, t, i),
        e.drawBody(s, t, i),
        e.drawFooter(s, t, i),
        fn(t, i.textDirection),
        t.restore());
    }
    getActiveElements() {
      return this._active || [];
    ...
    _positionChanged(t, e) {
      const i = this,
        n = es[i.options.position].call(i, t, e);
  ...
  var fs = {
      ...
      positioners: es,
      afterInit(t, e, i) {
        i && (t.tooltip = new us({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
  ...
  class ms extends Hi {
    ...
    parse(t, e) {
      ...
      return isFinite(e) && i[e] === t ? e : ps(i, t, X(e, t));
    }
    determineDataLimits() {
      const t = this,
  ...
  (ms.id = "category"),
    (ms.defaults = { ticks: { callback: ms.prototype.getLabelForValue } });
  class xs extends Hi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        (_ = Math.ceil(u / y) - Math.floor(d / y)),
          _ > h && (y = St((_ * y) / h / c) * c),
          N(a) || ((m = Math.pow(10, a)), (y = Math.ceil(y * m) / m)),
          (x = Math.floor(d / y) * y),
          (b = Math.ceil(u / y) * y),
          f && g && n && At((s - o) / n, y / 1e3)
            ? ((_ = Math.min((s - o) / y, l)),
              (y = (s - o) / _),
              (x = o),
              (b = s))
            ...
            : ((_ = (b - x) / y),
              (_ = Ct(_, Math.round(_), y / 1e3)
                ? Math.round(_)
                : Math.ceil(_))),
          (m = Math.pow(10, N(a) ? Rt(y) : a)),
          (x = Math.round(x * m) / m),
          (b = Math.round(b * m) / m);
        let v = 0;
        for (
          ...
          (i.push({ value: o }),
          x < o && v++,
          At(Math.round((x + v * y) * m) / m / o, y / 1e3) && v++);
          v < _;
          ++v
        )
    ...
    getLabelForValue(t) {
      return Ti(t, this.options.locale);
    }
  }
  class bs extends xs {
    determineDataLimits() {
  ...
  (bs.id = "linear"),
    (bs.defaults = { ticks: { callback: Ri.formatters.numeric } });
  class ys extends Hi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    parse(t, e) {
      ...
      if (0 !== i) return Y(i) && i > 0 ? i : null;
      this._zero = !0;
    }
    determineDataLimits() {
      const t = this,
        { min: e, max: i } = t.getMinMax(!0);
      (t.min = Y(e) ? Math.max(0, e) : null),
        (t.max = Y(i) ? Math.max(0, i) : null),
    ...
    getLabelForValue(t) {
      return void 0 === t ? "0" : Ti(t, this.options.locale);
    }
    configure() {
      const t = this,
        e = t.min;
  ...
  function vs(t) {
    ...
    if (e.display && t.display) {
      ...
      return X(e.font && e.font.size, gt.font.size) + t.height;
    }
    return 0;
  }
  ...
  function Ss(t, e, i, n) {
    const { ctx: o } = t;
    if (i) o.arc(t.xCenter, t.yCenter, e, 0, mt);
    else {
  ...
  (ys.id = "logarithmic"),
    (ys.defaults = {
      ticks: { callback: Ri.formatters.logarithmic, major: { enabled: !0 } },
    });
  class Ds extends xs {
    constructor(t) {
      super(t),
    ...
    determineDataLimits() {
      ...
      (t.min = Y(e) && !isNaN(e) ? e : 0),
        (t.max = Y(i) && !isNaN(i) ? i : 0),
        t.handleTickRangeOptions();
    }
    computeTickLimit() {
        ...
        ? (function (t) {
            ...
            for (n = 0; n < l; n++) {
              ...
              (t.ctx.font = u.string),
                (c = t.ctx),
                (h = u.lineHeight),
                (o = j((d = t._pointLabels[n]))
                  ? { w: jt(c, c.font, d), h: d.length * h }
                  : { w: c.measureText(d).width, h: h }),
                (a[n] = o);
              const f = t.getIndexAngle(n),
                g = Lt(f),
                p = Ms(g, s.x, o.w, 0, 180),
                m = Ms(g, s.y, o.h, 90, 270);
    ...
    getIndexAngle(t) {
      return zt(
        t * (mt / this.getLabels().length) + Tt(this.options.startAngle || 0)
      );
    }
        ...
        (i.pointLabels.display &&
          (function (t, e) {
            ...
            for (let o = e - 1; o >= 0; o--) {
              ...
              Qt(i, t._pointLabels[o], a, r + s.lineHeight / 2, s, {
                color: e.color,
                textAlign: l,
                textBaseline: "middle",
              });
  ...
  (Ds.id = "radialLinear"),
    ...
    (Ds.descriptors = { angleLines: { _fallback: "grid" } });
  const Cs = {
  ...
  function Ts(t, e) {
    ...
    return (
      ...
      Y(r) || (r = "string" == typeof o ? i.parse(r, o) : i.parse(r)),
      null === r
        ? null
        : (s &&
            (r =
  ...
  function Ls(t, e, i, n) {
    const o = As.length;
    for (let s = As.indexOf(t); s < o - 1; ++s) {
      const t = Cs[As[s]],
        o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return As[s];
    }
    return As[o - 1];
  }
  function Rs(t, e, i) {
  ...
  class Fs extends Hi {
    ...
    init(t, e) {
      const i = t.time || (t.time = {}),
        n = (this._adapter = new qn._date(t.adapters.date));
      nt(i.displayFormats, n.formats()),
        super.init(t),
        (this._normalized = e.normalized);
    }
    parse(t, e) {
      return void 0 === t ? null : Ts(this, t);
    }
    beforeLayout() {
    ...
    determineDataLimits() {
      ...
      (a && r) ||
        ...
        ("ticks" === e.bounds && "labels" === e.ticks.source) ||
          l(t.getMinMax(!1))),
        (o = Y(o) && !isNaN(o) ? o : +i.startOf(Date.now(), n)),
        (s = Y(s) && !isNaN(s) ? s : +i.endOf(Date.now(), n) + 1),
        (t.min = Math.min(o, s)),
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? Ls(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = As.length - 1; s >= As.indexOf(i); s--) {
                  const i = As[s];
                  if (Cs[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
                return As[i ? As.indexOf(i) : 0];
              })(t, a.length, i.minUnit, t.min, t.max))),
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = As.indexOf(t) + 1, i = As.length; e < i; ++e)
                  if (Cs[As[e]].common) return As[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || Ls(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = X(s.stepSize, 1),
      ...
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Rs(h, d, g);
      return (
        (d !== n && "ticks" !== o.bounds && 1 !== u) || Rs(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, Es(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(Ts(t, o[i]));
  ...
  class zs extends Fs {
    ...
    getPixelForValue(t, e) {
      const i = this,
        n = i._offsets,
        o =
          i._normalized && i._maxIndex > 0 && !N(e)
            ? e / i._maxIndex
            : i.getDecimalForValue(t);
      return i.getPixelForDecimal((n.start + o) * n.factor);
    }
    getDecimalForValue(t) {
      return Is(this._table, t) / this._maxIndex;
    }
    getValueForPixel(t) {
      const e = this,
        i = e._offsets,
        n = e.getDecimalForPixel(t) / i.factor - i.end;
      return Is(e._table, n * this._maxIndex, !0);
    }
  }
  (zs.id = "timeseries"), (zs.defaults = Fs.defaults);
  ...
  return (
    jn.register(ro, Vs, Lo, gs),
    (jn.helpers = { ..._n }),
    (jn._adapters = qn),
    (jn.Animation = pi),
    (jn.Animations = xi),
    (jn.animator = o),
    (jn.controllers = vn.controllers.items),
    (jn.DatasetController = Ci),
    (jn.Element = Ai),
    (jn.elements = Lo),
    (jn.Interaction = Se),
    (jn.layouts = Ue),
    ...
    (jn.Scale = Hi),
    (jn.Ticks = Ri),
    Object.assign(jn, ro, Vs, Lo, gs, li),
    (jn.Chart = jn),
