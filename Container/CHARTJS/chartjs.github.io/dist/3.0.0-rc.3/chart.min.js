...
!(function (t, e) {
  ...
  function Fi(t, e) {
    ...
    if (s > 0) {
      ...
      for (Ii(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++)
        Ii(e, l, c, o[t], o[t + 1]);
      return Ii(e, l, c, r, $(n) ? e.length : r + n), l;
    }
    return Ii(e, l, c), l;
  }
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? Vi(n.ticks, s) : n.ticks),
        ...
        o.display &&
          ...
          ((n.ticks = Fi(n, n.ticks)), (n._labelSizes = null)),
  ...
  class En {
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = Fn(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
    ...
    createResolver(t, e, i = [""], n) {
      const { resolver: o } = Fn(this._resolverCache, t, i);
  ...
  const In = ["top", "bottom", "left", "right", "chartArea"];
  function zn(t, e) {
    return "top" === t || "bottom" === t || (-1 === In.indexOf(t) && "x" === e);
  }
  function Vn(t, e) {
    return function (i, n) {
  ...
  Object.defineProperties(Yn, {
    ...
    version: { enumerable: Xn, value: "3.0.0-rc.3" },
  ...
  class Jo extends Oi {
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (a.fillStyle = f),
        (a.font = u.string);
      const { boxWidth: b, boxHeight: _, itemHeight: y } = Qo(c, p),
        v = t.isHorizontal(),
  ...
  class gs extends Oi {
    ...
    update(t) {
      ...
      let o,
        s = [];
      if (n.length) {
        const t = ns[i.position].call(e, n, e._eventPosition);
        (s = e._createItems(i)),
  ...
  class zs extends ji {
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, Is(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
