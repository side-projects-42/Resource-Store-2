...
(function (global, factory) {
  ...
  function _coordsAnimated(element) {
    ...
    return (
      anims && ((anims.x && anims.x.active()) || (anims.y && anims.y.active()))
    );
  }
  ...
  const optionKey = (key, active) =>
    active ? "hover" + _capitalize(key) : key;
  ...
  function includeDefaults(config, options) {
    ...
    const hoverEanbled =
      options.interaction !== false && options.hover !== false;
