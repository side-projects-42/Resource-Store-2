...
!(function (t, e) {
  ...
  function i(t) {
    ...
    return [
      e(t)[0],
      100 * ((1 / 255) * Math.min(n, Math.min(i, a))),
      100 * (a = 1 - (1 / 255) * Math.max(n, Math.max(i, a))),
    ];
  }
  function a(t) {
    var e,
  ...
  function l(t) {
    ...
    return (
      ...
      (a /= 108.883),
      (n =
        (n /= 95.047) > 0.008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116),
      [
  ...
  var w = {
    ...
    k = {};
  for (var M in w) k[JSON.stringify(w[M])] = M;
  var S = function () {
    return new A();
  };
  for (var D in t) {
    ...
    (j.prototype.setValues = function (t, e) {
      ...
      for (n = 0; n < t.length; n++)
        (i = Math.max(0, Math.min(o[t][n], a[t][n]))),
          (a[t][n] = Math.round(i));
      for (var u in r) u !== t && (a[u] = O[t][u](a[t]));
      return !0;
    }),
  ...
  var U,
    ...
    q = {
      ...
      _merger: function (t, e, n, i) {
        var a = e[t],
          r = n[t];
        q.isObject(a) && q.isObject(r) ? q.merge(a, r, i) : (e[t] = q.clone(r));
      },
      _mergerIf: function (t, e, n) {
        var i = e[t],
          a = n[t];
        q.isObject(i) && q.isObject(a)
          ? q.mergeIf(i, a)
      ...
      merge: function (t, e, n) {
        ...
        for (i = (n = n || {}).merger || q._merger, a = 0; a < u; ++a)
      ...
      extend:
        Object.assign ||
        function (t) {
          return q.merge(t, [].slice.call(arguments, 1), {
          ...
          switch ((t.beginPath(), e)) {
            ...
            case "rectRounded":
              (u = n - (d = 0.516 * n)),
                (s = Math.cos(h + et) * u),
                (l = Math.sin(h + et) * u),
                t.arc(i - s, a - l, d, h - K, h - tt),
                t.arc(i + l, a - s, d, h - tt, h),
                t.arc(i + s, a + l, d, h, h + tt),
                t.arc(i - l, a + s, d, h + tt, h + K),
                t.closePath();
              break;
            case "rect":
              if (!r) {
      ...
      resolve: function (t, e, n, i) {
        ...
        for (a = 0, r = t.length; a < r; ++a)
          if (
            ...
            void 0 !== n && Z.isArray(o) && ((o = o[n]), (s = !1)),
            void 0 !== o)
          )
  ...
  ht.extend(vt.prototype, {
    ...
    pivot: function () {
      var t = this;
      return t._view || (t._view = ht.extend({}, t._model)), (t._start = {}), t;
    },
    transition: function (t) {
      ...
      return n && 1 !== t
        ? (a || (a = e._view = {}),
            ...
            for (a = 0, r = f.length; a < r; ++a)
              if (
                ...
                if (
                  ...
                  } else if (ht.isFinite(l) && ht.isFinite(u)) {
                    e[o] = l + (u - l) * i;
                    continue;
                  }
                e[o] = u;
          ...
          e)
        : ((e._view = ht.extend({}, n)), (e._start = null), e);
    },
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      if (((i = i || {}), ht.isArray(c)))
        for (o = 0, s = c.length; o < s; ++o)
          f[(l = c[o])] = wt([i[l], d[l], h[l]], g, e, m);
      else
        for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o)
          f[(l = r[o])] = wt([i[l], d[c[l]], d[l], h[l]], g, e, m);
    ...
    i
      ...
      n.fullCircles &&
        (function (t, e, n, i) {
          ...
          for (
            i &&
              ((n.endAngle = n.startAngle + Ct),
              Tt(t, n),
              (n.endAngle = r),
              n.endAngle === n.startAngle &&
                n.fullCircles &&
                ((n.endAngle += Ct), n.fullCircles--)),
              t.beginPath(),
              t.arc(
                n.x,
                n.y,
          ...
          for (
            t.beginPath(),
              t.arc(n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + Ct),
              a = 0;
            a < n.fullCircles;
            ++a
          )
  ...
  var At = yt.extend({
      ...
      inRange: function (t, e) {
        ...
        if (n) {
          for (
            var i = ht.getAngleFromPoint(n, { x: t, y: e }),
              a = i.angle,
              r = i.distance,
              o = n.startAngle,
              s = n.endAngle;
      ...
      draw: function () {
        ...
        if (
          ...
          for (
            ...
            e.fill();
          a.endAngle = a.startAngle + (n.circumference % Ct);
        }
        e.beginPath(),
          e.arc(a.x, a.y, a.outerRadius, a.startAngle, a.endAngle),
          e.arc(a.x, a.y, a.innerRadius, a.endAngle, a.startAngle, !0),
          e.closePath(),
          e.fill(),
          n.borderWidth && Pt(e, n, a),
          e.restore();
      },
    }),
    Ot = ht.valueOrDefault,
        ...
        if (s.length) {
          if (i._loop) {
            for (t = 0; t < s.length; ++t)
              if (
                ((e = ht.previousItem(s, t)), !s[t]._view.skip && e._view.skip)
              ) {
          ...
          for (
            r.save(),
              ...
              r.lineDashOffset = Ot(a.borderDashOffset, u.borderDashOffset),
              r.lineJoin = a.borderJoinStyle || u.borderJoinStyle,
              r.lineWidth = Ot(a.borderWidth, u.borderWidth),
            ...
            (n = s[t]._view),
              (e = -1 === d ? ht.previousItem(s, t) : s[d]),
              n.skip ||
                ((d !== t - 1 && !o) || -1 === d
                  ? r.moveTo(n.x, n.y)
                  : ht.canvas.lineTo(r, e._view, n),
                (d = t));
          h && r.closePath(), r.stroke(), r.restore();
        }
      },
    }),
    Lt = ht.valueOrDefault,
    Rt = ot.global.defaultColor;
  function Nt(t) {
    var e = this._view;
      ...
      draw: function (t) {
        ...
        e.skip ||
          ((void 0 === t || ht.canvas._isPointInArea(e, t)) &&
            ...
            ht.canvas.drawPoint(n, i, r, o, s, a)));
      },
    }),
    Yt = ot.global.defaultColor;
  function zt(t) {
  ...
  function Ht(t, e, n) {
    var i,
      ...
      l = (function (t) {
        ...
        return e
          ? (t.horizontal
              ? t.base > t.x && (e = Et(e, "left", "right"))
              : t.base < t.y && (e = Et(e, "bottom", "top")),
            (n[e] = !0),
            n)
          : n;
      })(t);
  ...
  var jt = yt.extend({
      ...
      inLabelRange: function (t, e) {
        var n = this._view;
        return zt(n) ? Bt(n, t, null) : Bt(n, null, e);
      },
      inXRange: function (t) {
    ...
    Zt = Wt,
    $t = jt;
  (Ut.Arc = Gt), (Ut.Line = qt), (Ut.Point = Zt), (Ut.Rectangle = $t);
  var Xt = ht._deprecated,
  ...
  var Qt = Dt.extend({
      ...
      initialize: function () {
        var t,
          e,
          n = this;
        Dt.prototype.initialize.apply(n, arguments),
      ...
      updateElement: function (t, e, n) {
        ...
        (t._xScale = i.getScaleForId(a.xAxisID)),
          ...
          ht.isArray(r.data[e]) && (t._model.borderSkipped = null),
      ...
      calculateBarIndexPixels: function (t, e, n, i) {
        var a =
          ...
          s = Math.min(Kt(i.maxBarThickness, 1 / 0), a.chunk * a.ratio);
      ...
      draw: function () {
        var t = this.chart,
          ...
          a = n.length,
          r = 0;
        for (ht.canvas.clipArea(t.ctx, t.chartArea); r < a; ++r) {
      ...
      _resolveDataElementOptions: function () {
        var t = this,
          e = ht.extend(
            {},
            Dt.prototype._resolveDataElementOptions.apply(t, arguments)
          ),
          n = t._getIndexScale().options,
          i = t._getValueScale().options;
        return (
          (e.barPercentage = Kt(n.barPercentage, e.barPercentage)),
          (e.barThickness = Kt(n.barThickness, e.barThickness)),
          (e.categoryPercentage = Kt(
            n.categoryPercentage,
            e.categoryPercentage
          )),
          (e.maxBarThickness = Kt(n.maxBarThickness, e.maxBarThickness)),
          (e.minBarLength = Kt(i.minBarLength, e.minBarLength)),
          e
        );
      },
    }),
  ...
  var ne = Dt.extend({
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.borderColor = te(n.hoverBorderColor, i(n.borderColor))),
          (e.borderWidth = te(n.hoverBorderWidth, n.borderWidth)),
      ...
      _resolveDataElementOptions: function (t, e) {
        var n = this,
          ...
          r = t.custom || {},
          o = a.data[e] || {},
          s = Dt.prototype._resolveDataElementOptions.apply(n, arguments),
          l = { chart: i, dataIndex: e, dataset: a, datasetIndex: n.index };
        return (
          n._cachedDataOpts === s && (s = ht.extend({}, s)),
          (s.radius = ee(
      ...
      callbacks: {
        ...
        label: function (t, e) {
          var n = e.labels[t.index],
            i = ": " + e.datasets[t.datasetIndex].data[t.index];
          return ht.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n;
        },
      },
    },
  });
  var se = Dt.extend({
    ...
    update: function (t) {
      ...
      if (p < re) {
        var y = l.rotation % re,
          ...
          S = (y <= oe && b >= oe) || b >= re + oe,
          D = (y <= -oe && b >= -oe) || b >= ae + oe,
          C = y === -ae || b >= ae ? -1 : Math.min(x, x * m, w, w * m),
          T = D ? -1 : Math.min(_, _ * m, k, k * m),
          P = M ? 1 : Math.max(x, x * m, w, w * m),
          A = S ? 1 : Math.max(_, _ * m, k, k * m);
        (u = (P - C) / 2),
          (d = (A - T) / 2),
          (h = -(P + C) / 2),
          (c = -(A + T) / 2);
      ...
      var i = this,
        ...
        f =
          n && s.animateRotate
            ...
            : t.hidden
            ? 0
            : i.calculateCircumference(c.data[e]) * (o.circumference / re),
    ...
    calculateCircumference: function (t) {
      ...
      return e > 0 && !isNaN(t) ? re * (Math.abs(t) / e) : 0;
    },
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (e.backgroundColor = ie(n.hoverBackgroundColor, i(n.backgroundColor))),
        (e.borderColor = ie(n.hoverBorderColor, i(n.borderColor))),
        (e.borderWidth = ie(n.hoverBorderWidth, n.borderWidth));
    },
  ...
  var le = Qt.extend({
    ...
    ue = ht.valueOrDefault,
    de = ht.options.resolve,
    he = ht.canvas._isPointInArea;
  ot._set("line", {
    showLines: !0,
    spanGaps: !1,
    hover: { mode: "label" },
  ...
  var ce = Dt.extend({
      ...
      update: function (t) {
        var e,
          ...
          s = i.chart.options,
          l = i._config,
          u = (i._showLine = ue(l.showLine, s.showLines));
        for (
      ...
      updateElement: function (t, e, n) {
        ...
        (i = h.getPixelForValue("object" == typeof d ? d : NaN, e, u)),
          ...
          (t._model = {
            ...
            tension: ue(s.tension, f ? f.tension : 0),
      ...
      _resolveDatasetElementOptions: function (t) {
        var e = this,
          ...
          a = e.chart.options,
          r = a.elements.line,
          o = Dt.prototype._resolveDatasetElementOptions.apply(e, arguments);
        return (
          (o.spanGaps = ue(n.spanGaps, a.spanGaps)),
          (o.tension = ue(n.lineTension, r.tension)),
          (o.steppedLine = de([i.steppedLine, n.steppedLine, r.stepped])),
          o
        );
      },
      calculatePointY: function (t, e, n) {
        ...
        if (l.options.stacked) {
          for (i = 0; i < f && (r = c[i]).index !== n; ++i)
            (a = s.data.datasets[r.index]),
              "line" === r.type &&
                r.yAxisID === l.id &&
                ((o = +l.getRightValue(a.data[e])) < 0
                  ? (d += o || 0)
                  : (u += o || 0));
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.borderColor = ue(n.hoverBorderColor, i(n.borderColor))),
          (e.borderWidth = ue(n.hoverBorderWidth, n.borderWidth)),
          (e.radius = ue(n.hoverRadius, n.radius));
      },
    }),
    fe = ht.options.resolve;
  ot._set("polarArea", {
    scale: {
      type: "radialLinear",
  ...
  var ge = Dt.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      ht.extend(t, {
        ...
        _model: {
          ...
          label: ht.valueAtIndexOrDefault(u, e, u[e]),
        },
      }),
        t.pivot();
    },
    ...
    _computeAngle: function (t) {
      ...
      return fe([e.chart.options.elements.arc.angle, (2 * Math.PI) / n], r, t);
    },
  });
  ot._set("pie", ht.clone(ot.doughnut)),
    ot._set("pie", { cutoutPercentage: 0 });
  var me = se,
    pe = ht.valueOrDefault;
  ot._set("radar", {
    spanGaps: !1,
  ...
  var ve = Dt.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      (t._scale = o),
        ...
        (t._model = {
          ...
          borderColor: l.borderColor,
          borderWidth: l.borderWidth,
          tension: pe(a.tension, u ? u.tension : 0),
          hitRadius: l.hitRadius,
        });
    },
    _resolveDatasetElementOptions: function () {
      var t = this,
        e = t._config,
        n = t.chart.options,
        i = Dt.prototype._resolveDatasetElementOptions.apply(t, arguments);
      return (
        (i.spanGaps = pe(e.spanGaps, n.spanGaps)),
        (i.tension = pe(e.lineTension, n.elements.line.tension)),
        i
      );
    },
    updateBezierControlPoints: function () {
      ...
      for (
        ...
        (n = o[t]._model),
          (i = ht.splineCurve(
            ht.previousItem(o, t, !0)._model,
            n,
            ht.nextItem(o, t, !0)._model,
            n.tension
          )),
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (e.backgroundColor = pe(n.hoverBackgroundColor, i(n.backgroundColor))),
        (e.borderColor = pe(n.hoverBorderColor, i(n.borderColor))),
        (e.borderWidth = pe(n.hoverBorderWidth, n.borderWidth)),
        (e.radius = pe(n.hoverRadius, n.radius));
    },
  });
  ot._set("scatter", {
    hover: { mode: "single" },
    ...
    ot._set("global", { datasets: { scatter: { showLine: !1 } } });
  var ye = {
    bar: Qt,
    bubble: ne,
    doughnut: se,
  ...
  function Me(t, e, n) {
    ...
    n.axis = n.axis || "x";
    var a = ke(n.axis),
      r = n.intersect ? _e(t, i) : we(t, i, !1, a),
      o = [];
    return r.length
  ...
  function Ae(t, e, n) {
    ...
    if (
      ((i = e.outerWidth - Pe(o, t, "left", "right")),
      (a = e.outerHeight - Pe(o, t, "top", "bottom")),
      i !== t.w || a !== t.h)
    )
    ...
    update: function (t, e, n) {
      if (t) {
        var i = t.options.layout || {},
          a = ht.options.toPadding(i.padding),
          r = e - a.width,
          o = n - a.height,
          s = (function (t) {
            var e = (function (t) {
          ...
          h = De({ maxPadding: De({}, a), w: r, h: o, x: a.left, y: a.top }, a);
        !(function (t, e) {
          var n, i, a;
          for (n = 0, i = t.length; n < i; ++n)
          ...
          ht.each(s.chartArea, function (e) {
            var n = e.box;
            De(n, t.chartArea), n.update(h.w, h.h);
          });
      }
    },
  };
  ...
  var Ne,
    We =
      ...
      Ne,
    Ye = "$chartjs",
    ze = "chartjs-size-monitor",
    Ve = "chartjs-render-monitor",
    Ee = "chartjs-render-animation",
  ...
  function Ge(t, e, n) {
    t.addEventListener(e, n, Ue);
  }
  function qe(t, e, n) {
    t.removeEventListener(e, n, Ue);
  }
    ...
    !(function (t, e) {
      var n = t[Ye] || (t[Ye] = {}),
        i = (n.renderProxy = function (t) {
          t.animationName === Ee && e();
        });
      ht.each(He, function (e) {
        Ge(t, e, i);
      }),
  ...
  var Je = {
    ...
    releaseContext: function (t) {
      ...
      if (e[Ye]) {
        ...
        ["height", "width"].forEach(function (t) {
          var i = n[t];
          ht.isNullOrUndef(i) ? e.removeAttribute(t) : e.setAttribute(t, i);
        }),
          ht.each(n.style || {}, function (t, n) {
            e.style[n] = t;
          }),
          (e.width = e.width),
          delete e[Ye];
            ...
            n(
              (function (t, e) {
                var n = Be[t.type] || t.type,
                  i = ht.getRelativePosition(t, e);
                return Ze(n, e, i.x, i.y, t);
              })(e, t)
            );
          })
        );
    ...
    removeEventListener: function (t, e, n) {
      var i = t.canvas;
      if ("resize" !== e) {
        var a = ((n[Ye] || {}).proxies || {})[t.id + "_" + e];
        a && qe(i, e, a);
      } else Ke(i);
    },
  };
  (ht.addEvent = Ge), (ht.removeEvent = qe);
  var Qe = Je._enabled
      ? Je
      : {
  ...
  var en = {
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === n.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = ht.clone(ot.global.plugins[e])),
                n.push(t),
    ...
    nn = {
      ...
      registerScaleType: function (t, e, n) {
        (this.constructors[t] = e), (this.defaults[t] = ht.clone(n));
      },
      ...
      getScaleDefaults: function (t) {
        return this.defaults.hasOwnProperty(t)
          ? ht.merge({}, [ot.scale, this.defaults[t]])
          : {};
      },
    ...
    an = ht.valueOrDefault,
    rn = ht.rtl.getRtlAdapter;
  ot._set("global", {
    tooltips: {
      enabled: !0,
      custom: null,
      ...
      callbacks: {
        ...
        label: function (t, e) {
          ...
          return (
            n && (n += ": "),
            ht.isNullOrUndef(t.value) ? (n += t.yLabel) : (n += t.value),
            n
          );
        },
      ...
      for (n = 0, i = t.length; n < i; ++n) {
        ...
        if (l && l.hasValue()) {
          var u = l.getCenterPoint(),
            d = ht.distanceBetweenPoints(e, u);
          d < s && ((s = d), (a = l));
        }
      }
      if (a) {
  ...
  function un(t) {
    ...
    return {
      ...
      _bodyFontFamily: an(t.bodyFontFamily, e.defaultFontFamily),
      _bodyFontStyle: an(t.bodyFontStyle, e.defaultFontStyle),
      _bodyAlign: t.bodyAlign,
      bodyFontSize: an(t.bodyFontSize, e.defaultFontSize),
      bodySpacing: t.bodySpacing,
      titleFontColor: t.titleFontColor,
      _titleFontFamily: an(t.titleFontFamily, e.defaultFontFamily),
      _titleFontStyle: an(t.titleFontStyle, e.defaultFontStyle),
      titleFontSize: an(t.titleFontSize, e.defaultFontSize),
      _titleAlign: t.titleAlign,
      titleSpacing: t.titleSpacing,
      titleMarginBottom: t.titleMarginBottom,
      footerFontColor: t.footerFontColor,
      _footerFontFamily: an(t.footerFontFamily, e.defaultFontFamily),
      _footerFontStyle: an(t.footerFontStyle, e.defaultFontStyle),
      footerFontSize: an(t.footerFontSize, e.defaultFontSize),
  ...
  var cn = yt.extend({
      ...
      getTitle: function () {
        var t = this,
          ...
          o = [];
        return (o = sn(o, ln(i))), (o = sn(o, ln(a))), (o = sn(o, ln(r)));
      },
      getBeforeBody: function () {
        return hn(this._options.callbacks.beforeBody.apply(this, arguments));
      },
      getBody: function (t, e) {
        ...
        return (
          ht.each(t, function (t) {
            ...
            sn(r.before, ln(i.beforeLabel.call(n, t, e))),
              sn(r.lines, i.label.call(n, t, e)),
              sn(r.after, ln(i.afterLabel.call(n, t, e))),
              a.push(r);
          }),
          a
        );
      ...
      getFooter: function () {
        var t = this,
          ...
          r = [];
        return (r = sn(r, ln(n))), (r = sn(r, ln(i))), (r = sn(r, ln(a)));
      },
      update: function (t) {
        var e,
          n,
        ...
        if (m.length) {
          ...
          var _ = [],
            w = [];
          x = on[c.position].call(h, m, h._eventPosition);
          var k = [];
      ...
      drawTitle: function (t, e, n) {
        var i,
          ...
          s = o.length;
        if (s) {
          var l = rn(e.rtl, e.x, e.width);
          for (
            t.x = dn(e, e._titleAlign),
              n.textAlign = l.textAlign(e._titleAlign),
              n.textBaseline = "middle",
              i = e.titleFontSize,
              a = e.titleSpacing,
              n.fillStyle = e.titleFontColor,
              n.font = ht.fontString(i, e._titleFontStyle, e._titleFontFamily),
              r = 0;
            r < s;
            ++r
          )
      ...
      drawBody: function (t, e, n) {
        ...
        for (
          n.textAlign = f,
            n.textBaseline = "middle",
            n.font = ht.fontString(h, e._bodyFontStyle, e._bodyFontFamily),
            t.x = dn(e, x),
            n.fillStyle = e.bodyFontColor,
            ht.each(e.beforeBody, b),
        ...
        (p = 0), ht.each(e.afterBody, b), (t.y -= c);
      },
      drawFooter: function (t, e, n) {
        var i,
          ...
          o = r.length;
        if (o) {
          var s = rn(e.rtl, e.x, e.width);
          for (
            t.x = dn(e, e._footerAlign),
      ...
      draw: function () {
        ...
        if (0 !== e.opacity) {
          ...
          this._options.enabled &&
            ...
            (i.y += e.yPadding),
            ht.rtl.overrideTextDirection(t, e.textDirection),
            this.drawTitle(i, e, t),
            this.drawBody(i, e, t),
            this.drawFooter(i, e, t),
            ht.rtl.restoreTextDirection(t, e.textDirection),
            t.restore());
        }
      },
      handleEvent: function (t) {
        ...
        return (
          ...
          (e = !ht.arrayEquals(n._active, n._lastActive)) &&
      ...
      merger: function (t, e, n, i) {
        if ("xAxes" === t || "yAxes" === t) {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = n[t][a]),
              (r = mn(o.type, "xAxes" === t ? "category" : "linear")),
              a >= e[t].length && e[t].push({}),
              !e[t][a].type || (o.type && o.type !== e[t][a].type)
                ? ht.merge(e[t][a], [nn.getScaleDefaults(r), o])
                : ht.merge(e[t][a], o);
        } else ht._merger(t, e, n, i);
      },
    });
  }
  function vn() {
    return ht.merge({}, [].slice.call(arguments), {
      merger: function (t, e, n, i) {
        ...
        "scales" === t
          ? (e[t] = pn(a, r))
          : "scale" === t
          ? (e[t] = ht.merge(a, [nn.getScaleDefaults(r.type), r]))
          : ht._merger(t, e, n, i);
      },
    });
  }
  function yn(t) {
    ...
    ht.each(t.scales, function (e) {
      ...
      (e = vn(ot.global, ot[t.config.type], e)),
  ...
  ht.extend(wn.prototype, {
    construct: function (t, e) {
      ...
      e = (function (t) {
        ...
        return (
          ...
          (e.labels = e.labels || []),
          (t.options = vn(ot.global, ot[t.type], t.options || {})),
          t
        );
      })(e);
      var i = tn.acquireContext(t, e),
        a = i && i.canvas,
        r = a && a.height,
        o = a && a.width;
      (n.id = ht.uid()),
    ...
    resize: function (t) {
      var e = this,
        ...
        r = Math.max(0, Math.floor(ht.getMaximumWidth(i))),
        o = Math.max(0, Math.floor(a ? r / a : ht.getMaximumHeight(i)));
      if (
        ...
        (i.style.width = r + "px"),
        (i.style.height = o + "px"),
        ht.retinaScale(e, n.devicePixelRatio),
        !t)
      ) {
        var s = { width: r, height: o };
        en.notify(e, "resize", [s]),
    ...
    ensureScalesHaveIDs: function () {
      var t = this.options,
        e = t.scales || {},
        n = t.scale;
      ht.each(e.xAxes, function (t, n) {
        t.id || (t.id = bn(e.xAxes, "x-axis-", n));
      }),
        ht.each(e.yAxes, function (t, n) {
          t.id || (t.id = bn(e.yAxes, "y-axis-", n));
        }),
        n && (n.id = n.id || "scale");
    },
      ...
      e.scales &&
        ...
        ht.each(i, function (e) {
          var i = e.options,
            r = i.id,
            o = mn(i.type, e.dtype);
          xn(i.position) !== xn(e.dposition) && (i.position = e.dposition),
            (a[r] = !0);
          var s = null;
          if (r in n && n[r].type === o)
            ((s = n[r]).options = i), (s.ctx = t.ctx), (s.chart = t);
          else {
            var l = nn.getScaleConstructor(o);
            if (!l) return;
    ...
    update: function (t) {
      ...
      if (
        ...
        i.updateLayout(),
          ...
          (i.lastActive = []),
          en.notify(i, "afterUpdate"),
          i._layers.sort(_n("z", "_idx")),
          i._bufferedRender
            ? (i._bufferedRequest = {
                duration: t.duration,
                easing: t.easing,
    ...
    updateLayout: function () {
      ...
      !1 !== en.notify(t, "beforeLayout") &&
        ...
        en.notify(t, "afterScaleUpdate"),
        en.notify(t, "afterLayout"));
    },
    ...
    updateDataset: function (t) {
      ...
      !1 !== en.notify(this, "beforeDatasetUpdate", [n]) &&
        (e.controller._update(), en.notify(this, "afterDatasetUpdate", [n]));
    },
    render: function (t) {
      var e = this;
      (t && "object" == typeof t) || (t = { duration: t, lazy: arguments[1] });
      var n = e.options.animation,
        i = mn(t.duration, n && n.duration),
        a = t.lazy;
      if (!1 !== en.notify(e, "beforeRender")) {
        var r = function (t) {
          en.notify(e, "afterRender"), ht.callback(n && n.onComplete, [t], e);
        };
        if (n && i) {
          var o = new xt({
            numSteps: i / 16.66,
            ...
            render: function (t, e) {
              var n = ht.easing.effects[e.easing],
                i = e.currentStep,
                a = i / e.numSteps;
              t.draw(n(a), a, i);
            },
          ...
          _t.addAnimation(e, o, i, a);
        } else e.draw(), r(new xt({ numSteps: 0, chart: e }));
        return e;
      }
    },
    draw: function (t) {
    ...
    _getSortedDatasetMetas: function (t) {
      ...
      return i.sort(_n("order", "index")), i;
    },
    ...
    drawDatasets: function (t) {
      var e, n;
      if (!1 !== en.notify(this, "beforeDatasetsDraw", [t])) {
        for (
    ...
    bindEvents: function () {
      ...
      ht.each(t.options.events, function (i) {
        tn.addEventListener(t, i, n), (e[i] = n);
      }),
        t.options.responsive &&
          ((n = function () {
            t.resize();
          }),
          tn.addEventListener(t, "resize", n),
          (e.resize = n));
    },
    ...
    handleEvent: function (t) {
      ...
      return (
        ...
        ht.callback(i.onHover || i.hover.onHover, [t.native, n.active], n),
        ...
        (e = !ht.arrayEquals(n.active, n.lastActive)),
    ...
    Cn = {
      formatters: {
        ...
        logarithmic: function (t, e, n) {
          var i = t / Math.pow(10, Math.floor(ht.log10(t)));
          return 0 === t
            ? "0"
        ...
        if (Tn(s))
          for (r = 0, o = s.length; r < o; ++r)
            (g = s[r]),
              Pn(g) ||
                Tn(g) ||
                ((c = ht.measureText(t, d.data, d.gc, c, g)), (f += h));
      } else (c = ht.measureText(t, d.data, d.gc, c, s)), (f = h);
      y.push(c), b.push(f), x.push(h / 2);
    }
    function _(t) {
  ...
  function Rn(t) {
    var e, n;
    return t.display
      ? ((e = ht.options._parseFont(t)),
        (n = ht.options.toPadding(t.padding)),
        e.lineHeight + n.height)
      : 0;
  }
  function Nn(t, e) {
    return ht.extend(
      ht.options._parseFont({
  ...
  function Wn(t) {
    var e = Nn(t, t.minor);
    return { minor: e, major: t.major.enabled ? Nn(t, t.major) : e };
  }
  function Yn(t) {
    var e,
      n,
  ...
  var Vn = yt.extend({
    ...
    update: function (t, e, n) {
      ...
      if (
        ...
        (l.maxWidth = t),
        (l.maxHeight = e),
        (l.margins = ht.extend({ left: 0, right: 0, top: 0, bottom: 0 }, n)),
        (l._ticks = null),
        (l.ticks = null),
        (l._labelSizes = null),
        (l._maxLabelLines = 0),
    ...
    afterBuildTicks: function (t) {
      var e = this;
      return Tn(t) && t.length
        ? ht.callback(e.options.afterBuildTicks, [e, t])
        : ((e.ticks =
            ht.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks),
          t);
    },
      ...
      !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
        ...
        : ((e = (t = s._getLabelSizes()).widest.width),
          ...
          e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
            ...
            (r = s.maxHeight - Ln(l.gridLines) - u.padding - Rn(l.scaleLabel)),
            (o = Math.sqrt(e * e + n * n)),
            (f = ht.toDegrees(
              Math.min(
    ...
    fit: function () {
      var t = this,
        ...
        u = t.isHorizontal();
      if (
        (u ? (e.width = t.maxWidth) : s && (e.width = Ln(o) + Rn(r)),
        u ? s && (e.height = Ln(o) + Rn(r)) : (e.height = t.maxHeight),
        a.display && s)
      ) {
        var d = Wn(a),
          h = t._getLabelSizes(),
        ...
        if (u) {
          var y = 0 !== t.labelRotation,
            b = ht.toRadians(t.labelRotation),
            x = Math.cos(b),
            _ = Math.sin(b),
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e =
            In(t.ctx, Wn(t.options.ticks), t.getTicks(), t.longestTextCache)),
    ...
    _autoSkip: function (t) {
      ...
      if (
        ((i = (function (t, e, n, i) {
          ...
          for (o = 0, s = (a = ht.math._factorize(l)).length - 1; o < s; o++)
            if ((r = a[o]) > u) return r;
          return Math.max(u, 1);
        })(l, t, 0, s)),
        u > 0)
      ) {
        for (e = 0, n = u - 1; e < n; e++) zn(t, i, l[e], l[e + 1]);
        return (
          (a = u > 1 ? (h - d) / (u - 1) : null),
          zn(t, i, ht.isNullOrUndef(a) ? 0 : d - a, d),
          zn(t, i, h, ht.isNullOrUndef(a) ? t.length : h + a),
          Yn(t)
        );
      }
      return zn(t, i), Yn(t);
    ...
    _tickSize: function () {
      var t = this.options.ticks,
        e = ht.toRadians(this.labelRotation),
    ...
    _computeGridLineItems: function (t) {
      var e,
        ...
        C = Ln(_),
        T = [],
        P = _.drawBorder ? On(_.lineWidth, 0, 0) : 0,
        A = P / 2,
        O = ht._alignPixel,
        F = function (t) {
          return O(b, t, P);
          ...
          (Pn(i.label) && n < S.length) ||
            (n === y.zeroLineIndex && x.offset === k
              ...
              : ((g = On(_.lineWidth, n, 1)),
                (m = On(_.color, n, "rgba(0,0,0,0.1)")),
                (p = _.borderDash || []),
                (v = _.borderDashOffset || 0)),
            void 0 !== (a = Fn(y, i._index || n, k)) &&
              ((r = O(b, a, g)),
    ...
    _computeLabelItems: function () {
      var t,
        ...
        x = g.padding,
        _ = Ln(f.gridLines),
        w = -ht.toRadians(c.labelRotation),
        k = [];
      for (
        "top" === m
    ...
    _drawTitle: function () {
      ...
      if (i.display) {
        var a,
          r,
          o = An(i.fontColor, ot.global.defaultFontColor),
          s = ht.options._parseFont(i),
          l = ht.options.toPadding(i.padding),
          u = s.lineHeight / 2,
          d = n.position,
          h = 0;
        if (t.isHorizontal())
    ...
    Bn = En.extend({
      ...
      _configure: function () {
        var t = this,
          e = t.options.offset,
          n = t.ticks;
        En.prototype._configure.call(t),
  ...
  var qn = En.extend({
      getRightValue: function (t) {
        return "string" == typeof t
          ? +t
          : En.prototype.getRightValue.call(this, t);
      },
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            var n,
              ...
              f = e.min,
              g = e.max,
              m = ht.niceNum((g - f) / u / l) * l;
            if (m < 1e-14 && Gn(d) && Gn(h)) return [f, g];
            (r = Math.ceil(g / m) - Math.floor(f / m)) > u &&
              (m = ht.niceNum((r * m) / u / l) * l),
              s || Gn(c)
                ? (n = Math.pow(10, ht._decimalPlaces(m)))
                : ((n = Math.pow(10, c)), (m = Math.ceil(m * n) / n)),
              (i = Math.floor(f / m) * m),
              (a = Math.ceil(g / m) * m),
              s &&
                (!Gn(d) && ht.almostWhole(d / m, m / 1e3) && (i = d),
                !Gn(h) && ht.almostWhole(h / m, m / 1e3) && (a = h)),
              (r = (a - i) / m),
              (r = ht.almostEquals(r, Math.round(r), m / 1e3)
                ? Math.round(r)
                : Math.ceil(r)),
              (i = Math.round(i * n) / n),
              (a = Math.round(a * n) / n),
      ...
      convertTicksToLabels: function () {
        ...
        (t.ticksAsNumbers = t.ticks.slice()),
          ...
          En.prototype.convertTicksToLabels.call(t);
      },
      _configure: function () {
        var t,
          e = this,
          ...
          i = e.min,
          a = e.max;
        En.prototype._configure.call(e),
          e.options.offset &&
            n.length &&
    ...
    Zn = { position: "left", ticks: { callback: Cn.formatters.linear } };
  function $n(t, e, n, i) {
    var a,
      r,
      o = t.options,
  ...
  var Kn = qn.extend({
      determineDataLimits: function () {
        ...
        for (t = 0; t < d; ++t)
          (n = o[(e = s[t]).index].data), l ? $n(a, u, e, n) : Xn(a, e, n);
        ht.each(u, function (t) {
          (i = t.pos.concat(t.neg)),
            (a.min = Math.min(a.min, ht.min(i))),
            (a.max = Math.max(a.max, ht.max(i)));
        }),
          (a.min = ht.isFinite(a.min) && !isNaN(a.min) ? a.min : 0),
          (a.max = ht.isFinite(a.max) && !isNaN(a.max) ? a.max : 1),
    ...
    Jn = Zn;
  Kn._defaults = Jn;
  var Qn = ht.valueOrDefault,
    ti = ht.math.log10;
  var ei = { position: "left", ticks: { callback: Cn.formatters.logarithmic } };
  function ni(t, e) {
  ...
  var ii = En.extend({
      determineDataLimits: function () {
        ...
        (o.min = ht.isFinite(o.min) ? o.min : null),
          (o.max = ht.isFinite(o.max) ? o.max : null),
          (o.minNotZero = ht.isFinite(o.minNotZero) ? o.minNotZero : null),
          this.handleTickRangeOptions();
      },
      handleTickRangeOptions: function () {
        var t = this,
          e = t.options.ticks;
        (t.min = ni(e.min, t.min)),
          (t.max = ni(e.max, t.max)),
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(ti(t.min)) - 1)),
                (t.max = Math.pow(10, Math.floor(ti(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(ti(t.max)) - 1)),
          null === t.max &&
            (t.max =
              0 !== t.min ? Math.pow(10, Math.floor(ti(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
              ? (t.minNotZero = Math.pow(10, Math.floor(ti(t.max))))
              : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
          n = !t.isHorizontal(),
          i = { min: ni(e.min), max: ni(e.max) },
          a = (t.ticks = (function (t, e) {
            var n,
              i,
              a = [],
              r = Qn(t.min, Math.pow(10, Math.floor(ti(e.min)))),
              o = Math.floor(ti(e.max)),
              s = Math.ceil(e.max / Math.pow(10, o));
            0 === r
              ? ((n = Math.floor(ti(e.minNotZero))),
      ...
      convertTicksToLabels: function () {
        (this.tickValues = this.ticks.slice()),
          En.prototype.convertTicksToLabels.call(this);
      },
      getLabelForIndex: function (t, e) {
        return this._getScaleLabel(this.chart.data.datasets[e].data[t]);
      },
      ...
      _configure: function () {
        ...
        En.prototype._configure.call(t),
          0 === e &&
            ...
            (n =
              Qn(t.options.ticks.fontSize, ot.global.defaultFontSize) /
              t._length)),
          (t._startValue = ti(e)),
          (t._valueOffset = n),
          (t._valueRange = (ti(t.max) - ti(e)) / (1 - n));
      },
      getPixelForValue: function (t) {
        var e = this,
          n = 0;
        return (
          (t = +e.getRightValue(t)) > e.min &&
            t > 0 &&
            (n = (ti(t) - e._startValue) / e._valueRange + e._valueOffset),
    ...
    ai = ei;
  ii._defaults = ai;
  var ri = ht.valueOrDefault,
    oi = ht.valueAtIndexOrDefault,
    si = ht.options.resolve,
    li = {
      display: !0,
      animate: !0,
      position: "chartArea",
  ...
  function ui(t) {
    ...
    return e.display && t.display
      ? ri(e.fontSize, ot.global.defaultFontSize) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  var mi = qn.extend({
      ...
      determineDataLimits: function () {
        ...
        ht.each(e.data.datasets, function (a, r) {
      ...
      convertTicksToLabels: function () {
        var t = this;
        qn.prototype.convertTicksToLabels.call(t),
          (t.pointLabels = t.chart.data.labels.map(function () {
            var e = ht.callback(t.options.pointLabels.callback, arguments, t);
            return e || 0 === e ? e : "";
          }));
      },
      getLabelForIndex: function (t, e) {
          ...
          ? (function (t) {
              ...
              for (e = 0; e < d; e++) {
                (i = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (u = t.pointLabels[e]),
                  (n = ht.isArray(u)
                    ? { w: ht.longestText(s, s.font, u), h: u.length * l }
                    : { w: s.measureText(u).width, h: l }),
                  (t._pointLabelSizes[e] = n);
                var h = t.getIndexAngle(e),
                  c = ht.toDegrees(h) % 360,
                  f = di(c, i.x, n.w, 0, 180),
                  g = di(c, i.y, n.h, 90, 270);
      ...
      _drawGrid: function () {
        var t,
          ...
          o = r.gridLines,
          s = r.angleLines,
          l = ri(s.lineWidth, o.lineWidth),
          u = ri(s.color, o.color);
        if (
            ...
            (function (t) {
              ...
              for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                var l = 0 === s ? a / 2 : 0,
                  ...
                  d = oi(i.fontColor, s, ot.global.defaultFontColor);
                e.fillStyle = d;
                var h = t.getIndexAngle(s),
                  c = ht.toDegrees(h);
                (e.textAlign = hi(c)),
                  fi(c, t._pointLabelSizes[s], u),
                  ci(e, t.pointLabels[s], u, o.lineHeight);
              }
              e.restore();
            })(i),
          o.display &&
            ht.each(i.ticks, function (t, n) {
              0 !== n &&
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(si([s.borderDash, o.borderDash, []])),
                (a.lineDashOffset = si([
                  s.borderDashOffset,
                  o.borderDashOffset,
                  0,
      ...
      _drawLabels: function () {
        ...
        if (n.display) {
          var i,
            a,
            r = t.getIndexAngle(0),
            o = ht.options._parseFont(n),
            s = ri(n.fontColor, ot.global.defaultFontColor);
          e.save(),
            (e.font = o.string),
    ...
    pi = li;
  mi._defaults = pi;
  var vi = ht._deprecated,
    yi = ht.options.resolve,
    bi = ht.valueOrDefault,
    xi = Number.MIN_SAFE_INTEGER || -9007199254740991,
    _i = Number.MAX_SAFE_INTEGER || 9007199254740991,
    wi = {
  ...
  function Si(t) {
    return ht.valueOrDefault(t.time.min, t.ticks.min);
  }
  function Di(t) {
    return ht.valueOrDefault(t.time.max, t.ticks.max);
  }
  function Ci(t, e, n, i) {
  ...
  function Ti(t, e) {
    ...
    return (
      ...
      ht.isFinite(o) || (o = "string" == typeof r ? n.parse(o, r) : n.parse(o)),
      null !== o
        ? +o
        : (a ||
            "function" != typeof r ||
            ((o = r(e)), ht.isFinite(o) || (o = n.parse(o))),
          o)
    );
  }
  function Pi(t, e) {
  ...
  function Ai(t, e, n, i) {
    var a,
      ...
      o,
      s = ki.length;
    for (a = ki.indexOf(t); a < s - 1; ++a)
      if (
        ((o = (r = wi[ki[a]]).steps ? r.steps : _i),
  ...
  var Fi = En.extend({
      ...
      update: function () {
        var t = this,
          e = t.options,
          n = e.time || (e.time = {}),
          i = (t._adapter = new Dn._date(e.adapters.date));
        return (
          vi("time scale", n.format, "time.format", "time.parser"),
          vi("time scale", n.min, "time.min", "ticks.min"),
          vi("time scale", n.max, "time.max", "ticks.max"),
          ht.mergeIf(n.displayFormats, i.formats()),
          En.prototype.update.apply(t, arguments)
        );
      },
      getRightValue: function (t) {
        return (
      ...
      determineDataLimits: function () {
        var t,
          ...
          p = [],
          v = s._getLabels();
        for (t = 0, n = v.length; t < n; ++t) p.push(Pi(s, v[t]));
        for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
          if (l.isDatasetVisible(t))
            if (((a = l.data.datasets[t].data), ht.isObject(a[0])))
              for (m[t] = [], e = 0, i = a.length; e < i; ++e)
                (r = Pi(s, a[e])), g.push(r), (m[t][e] = r);
        ...
        p.length &&
          ...
          (c = Pi(s, Si(d)) || c),
          (f = Pi(s, Di(d)) || f),
          (c = c === _i ? +u.startOf(Date.now(), h) : c),
          (f = f === xi ? +u.endOf(Date.now(), h) + 1 : f),
          (s.min = Math.min(c, f)),
            ...
            "data" === c || ("auto" === c && "series" === f)
              ...
              : (function (t, e, n, i) {
                  var a,
                    ...
                    u = yi([s.stepSize, s.unitStepSize, 1]),
        ...
        return (
          ...
          (i._unit =
            ...
            (s.autoSkip
              ...
              : (function (t, e, n, i, a) {
                  var r, o;
                  for (r = ki.length - 1; r >= ki.indexOf(n); r--)
                    if (
                      ((o = ki[r]),
                      wi[o].common && t._adapter.diff(a, i, o) >= e - 1)
                    )
                      return o;
          ...
          (i._majorUnit =
            s.major.enabled && "year" !== i._unit
              ? (function (t) {
                  for (var e = ki.indexOf(t) + 1, n = ki.length; e < n; ++e)
                    if (wi[ki[e]].common) return ki[e];
                })(i._unit)
              : void 0),
            ...
            return (
              a.offset &&
                ...
                (s =
                  1 === e.length
                    ? 1 - r
                    : (Ci(t, "time", e[1], "pos") - r) / 2),
                (o = Ci(t, "time", e[e.length - 1], "pos")),
                (l =
                  1 === e.length
                    ? o
                    : (o - Ci(t, "time", e[e.length - 2], "pos")) / 2)),
      ...
      getLabelForIndex: function (t, e) {
        ...
        return (
          ht.isObject(s) && (o = n.getRightValue(s)),
          r.tooltipFormat
            ? i.format(Ti(n, o), r.tooltipFormat)
            : "string" == typeof o
            ? o
            : i.format(Ti(n, o), r.displayFormats.datetime)
        );
      },
      tickFormatFunction: function (t, e, n, i) {
        var a = this._adapter,
          ...
          g = c ? h.major : h.minor,
          m = yi([g.callback, g.userCallback, h.callback, h.userCallback]);
        return m ? m(f, e, n) : f;
      },
      ...
      getValueForPixel: function (t) {
        var e = this._offsets,
          ...
          i = Ci(this._table, "pos", n, "time");
        return this._adapter._create(i);
      },
      _getLabelSize: function (t) {
        var e = this.options.ticks,
          n = this.ctx.measureText(t).width,
          i = ht.toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation),
          a = Math.cos(i),
          r = Math.sin(i),
          o = bi(e.fontSize, ot.global.defaultFontSize);
  ...
  var Li = {
    ...
    Ri = (function (t, e) {
      ...
      t.exports = (function () {
        ...
        function Yt(t) {
          return null != t
            ? (Wt(this, t), i.updateOffset(this, !0), this)
            : At(this, "Month");
        }
        var zt = st,
          Vt = st;
        ...
        function Gt(t, e, n) {
          ...
          return (
            o < 1
              ? (i = o + qt((a = t.year() - 1), e, n))
              : o > qt(t.year(), e, n)
              ? ((i = o - qt(t.year(), e, n)), (a = t.year() + 1))
              : ((a = t.year()), (i = o)),
            { week: i, year: a }
          );
        }
        ...
        B("H", ["HH", 2], 0, "hour"),
          ...
          B("hmmss", 0, 0, function () {
            return (
              "" + ie.apply(this) + Y(this.minutes(), 2) + Y(this.seconds(), 2)
            );
          }),
          B("Hmm", 0, 0, function () {
        ...
        function me(t) {
          ...
          return (function (t) {
            for (var e, n, i, a, r = 0; r < t.length; ) {
              for (
                e = (a = he(t[r]).split("-")).length,
                  n = (n = he(t[r + 1])) ? n.split("-") : null;
                e > 0;

              ) {
                if ((i = ce(a.slice(0, e).join("-")))) return i;
        ...
        function ye(t) {
          ...
          if (!t._d) {
                ...
                t._w &&
                  ...
                  (function (t) {
                    ...
                    if (null != (e = t._w).GG || null != e.W || null != e.E)
                      (r = 1),
                        (o = 4),
                        (n = ve(e.GG, t._a[pt], Gt(Ie(), 1, 4).year)),
                        (i = ve(e.W, 1)),
                        ((a = ve(e.E, 1)) < 1 || a > 7) && (l = !0);
                    else {
                      (r = t._locale._week.dow), (o = t._locale._week.doy);
                      var u = Gt(Ie(), r, o);
                      (n = ve(e.gg, t._a[pt], u.year)),
                        (i = ve(e.w, u.week)),
                        null != e.d
                          ? ((a = e.d) < 0 || a > 6) && (l = !0)
                          : null != e.e
            ...
            24 === t._a[bt] &&
              ...
              (t._d = (t._useUTC ? Bt : Ht).apply(null, s)),
          ...
          if (l) {
            ...
            if (
              !(function (t, e, n) {
                return (
                  !t ||
                  Xt.indexOf(t) === new Date(e[0], e[1], e[2]).getDay() ||
        ...
        function Ue(t, e) {
          ...
          return e._isUTC
            ? ((n = e.clone()),
              (a =
                (x(t) || l(t) ? t.valueOf() : Ie(t).valueOf()) - n.valueOf()),
          ...
          return (
            Ve(t)
              ...
              : "object" == typeof u &&
                ...
                (a =
                  r.isValid() && o.isValid()
                    ? ((o = Ue(o, r)),
                      r.isBefore(o)
                        ? (l = Je(r, o))
                        : (((l = Je(o, r)).milliseconds = -l.milliseconds),
                          (l.months = -l.months)),
                      l)
                ...
                (u.M = a.months)),
            (i = new ze(u)),
            Ve(t) && d(t, "_locale") && (i._locale = t._locale),
            i
          );
        }
        function Ke(t, e) {
        ...
        function tn(t, e, n, a) {
          ...
          t.isValid() &&
            ((a = null == a || a),
            s && Wt(t, At(t, "Month") + s * n),
            o && Ot(t, "Date", At(t, "Date") + o * n),
        ...
        function rn(t) {
          ...
          return void 0 === t
            ? this._locale._abbr
            : (null != (e = me(t)) && (this._locale = e), this);
        }
        ...
        function pn(t, e, n, i, a) {
          ...
          return null == t
            ? Gt(this, i, a).year
            : (e > (r = qt(t, i, a)) && (e = r), vn.call(this, t, e, n, i, a));
        }
        ...
        for (xn = "S"; xn.length <= 9; xn += "S") ft(xn, wn);
        var kn = Pt("Milliseconds", !1);
        ...
        (Mn.add = en),
          (Mn.calendar = function (t, e) {
            var n = t || Ie(),
              a = Ue(n, this).startOf("day"),
              r = i.calendarFormat(this, a) || "sameElse",
              o = e && (P(e[r]) ? e[r].call(this, n) : e[r]);
            return this.format(o || this.localeData().calendar(r, this, Ie(n)));
          }),
          (Mn.clone = function () {
            return new b(this);
          }),
          (Mn.diff = function (t, e, n) {
            ...
            switch (
              ((a = 6e4 * (i.utcOffset() - this.utcOffset())), (e = L(e)))
            ) {
              case "year":
                r = an(this, i) / 12;
                break;
          ...
          (Mn.endOf = function (t) {
            var e;
            if (void 0 === (t = L(t)) || "millisecond" === t || !this.isValid())
              return this;
          ...
          (Mn.dates = S("dates accessor is deprecated. Use date instead.", yn)),
          (Mn.months = S(
            "months accessor is deprecated. Use month instead",
            Yt
          )),
          (Mn.years = S("years accessor is deprecated. Use year instead", Tt)),
          (Mn.zone = S(
        ...
        function Pn(t, e, n, i) {
          ...
          var l = [];
          for (a = 0; a < 7; a++) l[a] = Cn(e, (a + o) % 7, i, "day");
          return l;
        }
        (Dn.calendar = function (t, e, n) {
          ...
          (Dn.monthsRegex = function (t) {
            return this._monthsParseExact
              ? (d(this, "_monthsRegex") || Et.call(this),
                t ? this._monthsStrictRegex : this._monthsRegex)
              : (d(this, "_monthsRegex") || (this._monthsRegex = Vt),
          ...
          (Dn.monthsShortRegex = function (t) {
            return this._monthsParseExact
              ...
              : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = zt),
          ...
          (Dn.weekdaysRegex = function (t) {
            return this._weekdaysParseExact
              ? (d(this, "_weekdaysRegex") || ne.call(this),
                t ? this._weekdaysStrictRegex : this._weekdaysRegex)
              : (d(this, "_weekdaysRegex") || (this._weekdaysRegex = Qt),
          ...
          (Dn.weekdaysMinRegex = function (t) {
            return this._weekdaysParseExact
              ...
              : (d(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = ee),
          ...
          (i.updateLocale = function (t, e) {
            if (null != e) {
              var n,
                i,
                a = le;
              null != (i = ce(t)) && (a = i._config),
                (e = A(a, e)),
                ((n = new O(e)).parentLocale = ue[t]),
                (ue[t] = n),
                fe(t);
            } else
              null != ue[t] &&
  ...
  function Ei(t) {
    var e = t.fill,
      n = "dataset";
    return !1 === e ? null : (isFinite(e) || (n = "boundary"), Wi[n](t));
  }
  function Hi(t) {
    return t && !t.skip;
  }
  function Bi(t, e, n, i, a) {
    var r, o, s, l;
    if (i && a) {
      for (t.moveTo(e[0].x, e[0].y), r = 1; r < i; ++r)
        ht.canvas.lineTo(t, e[r - 1], e[r]);
      if (void 0 === n[0].angle)
        for (t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1; r > 0; --r)
          ht.canvas.lineTo(t, n[r], n[r - 1], !0);
      else
        for (
          o = n[0].cx,
            s = n[0].cy,
  ...
  function ji(t, e, n, i, a, r) {
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c
          ? ((y = p.push(u)), (b = v.push(d)))
          : y &&
            b &&
            (m
              ? (h && p.push(u), c && v.push(d))
              : (Bi(t, p, v, y, b), (y = b = 0), (p = []), (v = [])));
    Bi(t, p, v, y, b), t.closePath(), (t.fillStyle = a), t.fill();
  }
  var Ui = {
      id: "filler",
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = l[i]) &&
            ((r.fill = Vi(l, i, s)), (r.boundary = zi(r)), (r.mapper = Ei(r)));
      },
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            (r = i._children || []),
            (o = e.mapper),
            (s = a.backgroundColor || ot.global.defaultColor),
            o &&
              s &&
              r.length &&
              (ht.canvas.clipArea(u, t.chartArea),
              ji(u, r, o, a, s, i._loop),
              ht.canvas.unclipArea(u)));
      },
    },
    Gi = ht.rtl.getRtlAdapter,
    qi = ht.noop,
    Zi = ht.valueOrDefault;
  function $i(t, e) {
    ...
    legend: {
      ...
      labels: {
        ...
        generateLabels: function (t) {
          ...
          return t._getSortedDatasetMetas().map(function (n, a) {
  ...
  var Xi = yt.extend({
    ...
    buildLabels: function () {
      var t = this,
        e = t.options.labels || {},
        n = ht.callback(e.generateLabels, [t.chart], t) || [];
      e.filter &&
        ...
        if (((a.font = r.string), u)) {
          ...
          (a.textAlign = "left"),
            ...
            ht.each(t.legendItems, function (t, e) {
              var i = $i(n, o) + o / 2 + a.measureText(t.text).width;
    ...
    draw: function () {
      ...
      if (e.display) {
        var d,
          h = Gi(e.rtl, t.left, t.minSize.width),
          c = t.ctx,
          f = Zi(n.fontColor, i.defaultFontColor),
          g = ht.options._parseFont(n),
          m = g.size;
        ...
        (d = b
          ...
          ht.rtl.overrideTextDirection(t.ctx, e.textDirection);
        var x = m + n.padding;
        ht.each(t.legendItems, function (e, i) {
          ...
          h.setWidth(t.minSize.width),
            b
              ? i > 0 &&
                ...
                ((w = d.y += x), d.line++, (_ = d.x = t.left + y(l, u[d.line])))
              : i > 0 &&
                w + x > t.top + t.minSize.height &&
                ((_ = d.x = _ + t.columnWidths[d.line] + n.padding),
                d.line++,
                (w = d.y = t.top + y(o, s[d.line])));
          var k = h.x(_);
          !(function (t, e, i) {
            if (!(isNaN(p) || p <= 0)) {
              c.save();
              var o = Zi(i.lineWidth, r.borderWidth);
              if (
                ((c.fillStyle = Zi(i.fillStyle, a)),
                (c.lineCap = Zi(i.lineCap, r.borderCapStyle)),
                (c.lineDashOffset = Zi(i.lineDashOffset, r.borderDashOffset)),
                (c.lineJoin = Zi(i.lineJoin, r.borderJoinStyle)),
                (c.lineWidth = o),
                (c.strokeStyle = Zi(i.strokeStyle, a)),
                c.setLineDash && c.setLineDash(Zi(i.lineDash, r.borderDash)),
                n && n.usePointStyle)
              ) {
                var s = (p * Math.SQRT2) / 2,
                  l = h.xPlus(t, p / 2),
                  u = e + m / 2;
                ht.canvas.drawPoint(c, i.pointStyle, s, l, u, i.rotation);
              } else
            ...
            b ? (d.x += g + n.padding) : (d.y += x);
        }),
          ht.rtl.restoreTextDirection(t.ctx, e.textDirection);
      }
    },
  ...
  var Ji = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          n = t.legend;
        e
          ? (ht.mergeIf(e, ot.global.legend),
            n ? (Le.configure(t, n, e), (n.options = e)) : Ki(t, e))
  ...
  var ta = yt.extend({
    ...
    fit: function () {
      ...
      n.display
        ? ((t =
            (ht.isArray(n.text) ? n.text.length : 1) *
              ht.options._parseFont(n).lineHeight +
            2 * n.padding),
  ...
  function ea(t, e) {
    var n = new ta({ ctx: t.ctx, options: e, chart: t });
    ...
    ra = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          n = t.titleBlock;
        e
          ? (ht.mergeIf(e, ot.global.title),
            n ? (Le.configure(t, n, e), (n.options = e)) : ea(t, e))
          : n && (Le.removeBox(t, n), delete t.titleBlock);
      },
    };
  for (var oa in ((na.filler = ia),
  (na.legend = aa),
  (na.title = ra),
  (kn.helpers = ht),
  (function () {
    ...
    (ht.where = function (t, e) {
      ...
      (ht.findNextWhere = function (t, e, n) {
        ht.isNullOrUndef(n) && (n = -1);
        for (var i = n + 1; i < t.length; i++) {
          var a = t[i];
          if (e(a)) return a;
        }
      }),
      (ht.findPreviousWhere = function (t, e, n) {
        ht.isNullOrUndef(n) && (n = t.length);
        for (var i = n - 1; i >= 0; i--) {
          var a = t[i];
          if (e(a)) return a;
        }
      ...
      (ht.almostEquals = function (t, e, n) {
      ...
      (ht._alignPixel = function (t, e, n) {
        var i = t.currentDevicePixelRatio,
          a = n / 2;
        return Math.round((e - a) * i) / i + a;
      }),
      (ht.splineCurve = function (t, e, n, i) {
        var a = t.skip ? e : t,
          r = e,
          o = n.skip ? e : n,
      ...
      (ht.splineCurveMonotone = function (t) {
        ...
        for (e = 0; e < h - 1; ++e)
          (i = d[e]),
            ...
            i.model.skip ||
              a.model.skip ||
              (ht.almostEquals(i.deltaK, 0, this.EPSILON)
                ? (i.mK = a.mK = 0)
                : ((r = i.mK / i.deltaK),
                  (o = a.mK / i.deltaK),
      ...
      (ht.previousItem = function (t, e, n) {
        return n
          ? e <= 0
            ? t[t.length - 1]
            : t[e - 1]
      ...
      (ht.getRelativePosition = function (t, e) {
        ...
        var l = parseFloat(ht.getStyle(r, "padding-left")),
          u = parseFloat(ht.getStyle(r, "padding-top")),
          d = parseFloat(ht.getStyle(r, "padding-right")),
          h = parseFloat(ht.getStyle(r, "padding-bottom")),
      ...
      (ht._calculatePadding = function (t, e, n) {
      ...
      (ht.getMaximumWidth = function (t) {
        ...
        var n = e.clientWidth,
          i =
            n -
            ht._calculatePadding(e, "padding-left", n) -
            ht._calculatePadding(e, "padding-right", n),
      ...
      (ht.getMaximumHeight = function (t) {
        ...
        var n = e.clientHeight,
          i =
            n -
            ht._calculatePadding(e, "padding-top", n) -
            ht._calculatePadding(e, "padding-bottom", n),
      ...
      (ht.fontString = function (t, e, n) {
        return e + " " + t + "px " + n;
      }),
      (ht.longestText = function (t, e, n, i) {
        ...
        var o,
          ...
          c = n.length;
        for (o = 0; o < c; o++)
          if (null != (u = n[o]) && !0 !== ht.isArray(u))
            h = ht.measureText(t, a, r, h, u);
          else if (ht.isArray(u))
            for (s = 0, l = u.length; s < l; s++)
              null == (d = u[s]) ||
                ht.isArray(d) ||
                (h = ht.measureText(t, a, r, h, d));
        var f = r.length / 2;
        if (f > n.length) {
      ...
      (ht.measureText = function (t, e, n, i, a) {
        var r = e[a];
        return (
  ...
  (kn._adapters = Dn),
  (kn.Animation = xt),
  (kn.animationService = _t),
  (kn.controllers = ye),
  (kn.DatasetController = Dt),
  (kn.defaults = ot),
  (kn.Element = yt),
  (kn.elements = Ut),
  (kn.Interaction = Se),
  ...
  (kn.Ticks = Cn),
  (kn.Tooltip = gn),
  kn.helpers.each(Li, function (t, e) {
    kn.scaleService.registerScaleType(e, t, t._defaults);
  }),
  na))
    na.hasOwnProperty(oa) && kn.plugins.register(na[oa]);
  kn.platform.initialize();
  var sa = kn;
  return (
    "undefined" != typeof window && (window.Chart = kn),
    (kn.Chart = kn),
    (kn.Legend = na.legend._element),
    (kn.Title = na.title._element),
    (kn.pluginService = kn.plugins),
    (kn.PluginBase = kn.Element.extend({})),
    (kn.canvasHelpers = kn.helpers.canvas),
    (kn.layoutService = kn.layouts),
    (kn.LinearScaleBase = qn),
    kn.helpers.each(
