...
!(function (t, e) {
  ...
  class ui {
    ...
    parse(t, e) {
      ...
      if (!1 === i._parsing) (n._parsed = o), (n._sorted = !0);
        ...
        const s = () => isNaN(d[r]) || (f && d[r] < f[r]);
        for (h = 0; h < e; ++h)
          (n._parsed[h + t] = d = u[h]), g && (s() && (g = !1), (f = d));
        n._sorted = g;
      }
      a && ri(i, u);
    }
    ...
    _insertElements(t, e, i = !0) {
      const n = this,
        ...
        a = s.data;
      let r;
      for (r = 0; r < e; ++r) o[r] = new n.dataElementType();
      a.splice(t, 0, ...o),
        n._parsing && s._parsed.splice(t, 0, ...new Array(e)),
        n.parse(t, e),
        i && n.updateElements(a, t, e, "reset");
    }
  ...
  class nn {
    ...
    buildOrUpdateScales() {
      ...
      i &&
        ...
        (t.scales = n),
        f(n, (e) => {
          Qt.configure(t, e, e.options), Qt.addBox(t, e);
        });
    }
    ...
    update(t) {
      ...
      for (
        ...
        const { controller: t } = e.getDatasetMeta(i),
          n = !o && -1 === s.indexOf(t);
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        const { _data: s, indexAxis: a } = e,
          ...
          c = s || e.data;
        if ("y" === Ht([a, t.options.indexAxis])) return;
        if ("line" !== l.type) return;
        const h = t.scales[l.xAxisID];
        if ("linear" !== h.type && "time" !== h.type) return;
        if (t.options.parsing) return;
        if (c.length <= 4 * n) return;
        let d;
        switch (
          (r(s) &&
            ((e._data = c),
          ...
          case "min-max":
            d = (function (t, e) {
              let i, n, o, s, a, r, l, c, h;
              const d = [],
                u = t[0].x,
                g = t[t.length - 1].x - u;
              for (i = 0; i < t.length; ++i) {
                (n = t[i]), (o = ((n.x - u) / g) * e), (s = n.y);
                const f = 0 | o;
                f === a
                  ? s < c
                    ? ((c = s), (r = i))
  ...
  var so = {
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          const o = $n(t);
          return o instanceof Un ? o : Zn(o, n);
        })(o),
        { line: a, scale: r } = o,
        l = a.options,
        c = l.fill,
    ...
    beforeUpdate(t, e, i) {
      !1 === i
        ...
        : (function (t, e) {
            ...
            i ? (Qt.configure(t, i, e), (i.options = e)) : ho(t, e);
          })(t, i);
    },
    defaults: {
      align: "center",
  ...
  (Oo.id = "linear"),
    (Oo.defaults = { ticks: { callback: xi.formatters.numeric } });
  class Ao extends wi {
    constructor(t) {
      super(t),
        (this.start = void 0),
  ...
  class Uo extends wi {
    ...
    _generate() {
      ...
      for (d = g; d < n; d = +e.add(d, r, a)) jo(h, d, f);
      return (
  ...
  (Xo.id = "timeseries"), (Xo.defaults = Uo.defaults);
  ...
  return (
    ...
    (nn.Scale = wi),
    (nn.Ticks = xi),
    Object.assign(nn, yn, Ko, Hn, ko, fe),
    (nn.Chart = nn),
