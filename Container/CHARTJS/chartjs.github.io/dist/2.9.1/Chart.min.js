...
!(function (t, e) {
  ...
  function z(t) {
    if (t) {
      ...
      if (e) {
        ...
        return [
          W(parseInt(e[1]), 0, 360),
          W(parseFloat(e[2]), 0, 100),
          W(parseFloat(e[3]), 0, 100),
          W(isNaN(i) ? 1 : i, 0, 1),
        ];
      }
    }
  ...
  var Y,
    ...
    X = {
      ...
      _mergerIf: function (t, e, i) {
        var n = e[t],
          a = i[t];
        X.isObject(n) && X.isObject(a)
          ? X.mergeIf(n, a)
          : e.hasOwnProperty(t) || (e[t] = X.clone(a));
      },
          ...
          t.moveTo(e, l),
            s < u && l < d
              ...
              ? (t.moveTo(s, i),
                ...
                t.arc(s, l, o, et, J + et))
              : l < d
              ? (t.arc(s, l, o, -J, 0), t.arc(s, d, o, 0, J))
              : t.arc(s, l, o, -J, J),
            t.closePath(),
            t.moveTo(e, i);
        } else t.rect(e, i, n, a);
  ...
  var ut = {
      ...
      _parseFont: function (t) {
        ...
        return (
          (n.string = (function (t) {
            return !t || K.isNullOrUndef(t.size) || K.isNullOrUndef(t.family)
              ? null
              : (t.style ? t.style + " " : "") +
                  (t.weight ? t.weight + " " : "") +
                  t.size +
      ...
      resolve: function (t, e, i, n) {
        ...
        for (a = 0, r = t.length; a < r; ++a)
          if (
            ...
            void 0 !== i && K.isArray(o) && ((o = o[i]), (s = !1)),
            void 0 !== o)
          )
    ...
    transition: function (t) {
      ...
      return i && 1 !== t
        ? (a || (a = e._view = {}),
          ...
          e)
        : ((e._view = ct.extend({}, i)), (e._start = null), e);
    },
  ...
  var kt = {
      ...
      requestAnimationFrame: function () {
        var t = this;
        null === t.request &&
          (t.request = ct.requestAnimFrame.call(window, function () {
      ...
      advance: function () {
        for (var t, e, i, n, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            ct.callback(t.render, [e, t], e),
            ct.callback(t.onAnimationProgress, [t], e),
            t.currentStep >= i
              ? (ct.callback(t.onAnimationComplete, [t], e),
                (e.animating = !1),
                a.splice(r, 1))
              : ++r;
      },
  ...
  ct.extend(Ct.prototype, {
    ...
    linkScales: function () {
      var t = this.getMeta(),
        ...
        n = this.getDataset(),
        a = e.options.scales;
      (null !== t.xAxisID && t.xAxisID in i && !n.xAxisID) ||
        (t.xAxisID = n.xAxisID || a.xAxes[0].id),
        (null !== t.yAxisID && t.yAxisID in i && !n.yAxisID) ||
          (t.yAxisID = n.yAxisID || a.yAxes[0].id);
    },
    getDataset: function () {
                ...
                Object.defineProperty(t, e, {
                  ...
                  value: function () {
                    var e = Array.prototype.slice.call(arguments),
                      a = n.apply(this, e);
                    return (
                      ct.each(t._chartjs.listeners, function (t) {
    ...
    getStyle: function (t) {
      ...
      return (
        this._configure(),
        n && void 0 === t
          ? (e = this._resolveDatasetElementOptions(n || {}))
          : ((t = t || 0),
            (e = this._resolveDataElementOptions(i.data[t] || {}, t))),
  ...
  function Dt(t, e) {
    var i = e.startAngle,
      ...
      s = e.y;
    t.beginPath(),
      t.arc(o, s, e.outerRadius, i - r, n + r),
      e.innerRadius > a
        ? ((r = a / e.innerRadius),
          t.arc(o, s, e.innerRadius - a, n + r, i - r, !0))
        : t.arc(o, s, a, n + Math.PI / 2, i - Math.PI / 2),
      t.closePath(),
      t.clip();
  }
  function Tt(t, e, i) {
    ...
    n
      ...
      i.fullCircles &&
        (function (t, e, i, n) {
          ...
          for (
            t.beginPath(),
              t.arc(i.x, i.y, e.outerRadius, i.startAngle, i.startAngle + At),
              a = 0;
            a < i.fullCircles;
            ++a
          )
  ...
  var It = xt.extend({
      ...
      inRange: function (t, e) {
        ...
        if (i) {
          for (
            var n = ct.getAngleFromPoint(i, { x: t, y: e }),
              a = n.angle,
              r = n.distance,
              o = i.startAngle,
              s = i.endAngle;
        ...
        if (s.length) {
          if (n._loop) {
            for (t = 0; t < s.length; ++t)
              if (
                ((e = ct.previousItem(s, t)), !s[t]._view.skip && e._view.skip)
              ) {
          ...
          for (
            r.save(),
              ...
              r.lineDashOffset = Ft(a.borderDashOffset, u.borderDashOffset),
              r.lineJoin = a.borderJoinStyle || u.borderJoinStyle,
              r.lineWidth = Ft(a.borderWidth, u.borderWidth),
              r.strokeStyle = a.borderColor || l.defaultColor,
              r.beginPath(),
              (i = s[0]._view).skip || (r.moveTo(i.x, i.y), (d = 0)),
              t = 1;
            t < s.length;
            ++t
          )
            (i = s[t]._view),
              (e = -1 === d ? ct.previousItem(s, t) : s[d]),
              i.skip ||
                ((d !== t - 1 && !o) || -1 === d
                  ? r.moveTo(i.x, i.y)
                  : ct.canvas.lineTo(r, e._view, i),
                (d = t));
  ...
  var Bt = xt.extend({
      ...
      draw: function (t) {
        var e = this._view,
          ...
          u = l.defaultColor;
        e.skip ||
          ((void 0 === t || ct.canvas._isPointInArea(e, t)) &&
            ((i.strokeStyle = e.borderColor || u),
            (i.lineWidth = Rt(e.borderWidth, l.elements.point.borderWidth)),
            (i.fillStyle = e.backgroundColor || u),
            ct.canvas.drawPoint(i, n, r, o, s, a)));
      },
    }),
  ...
  function jt(t, e, i) {
    var n,
      ...
      l = (function (t) {
        ...
        return e
          ? (t.horizontal
              ? t.base > t.x && (e = Ht(e, "left", "right"))
              : t.base < t.y && (e = Ht(e, "bottom", "top")),
            (i[e] = !0),
            i)
          : i;
      })(t);
  ...
  var te = Pt.extend({
      ...
      initialize: function () {
        ...
        Pt.prototype.initialize.apply(i, arguments),
          ((t = i.getMeta()).stack = i.getDataset().stack),
          (t.bar = !0),
      ...
      updateElement: function (t, e, i) {
        ...
        (t._xScale = n.getScaleForId(a.xAxisID)),
          ...
          ct.isArray(r.data[e]) && (t._model.borderSkipped = null),
          n._updateElementGeometry(t, e, i, o),
          t.pivot();
      },
      _updateElementGeometry: function (t, e, i, n) {
        ...
        (r.horizontal = l),
          (r.base = i ? s : d.base),
          (r.x = l ? (i ? s : d.head) : h.center),
          (r.y = l ? h.center : i ? s : d.head),
      ...
      _resolveDataElementOptions: function () {
        var t = this,
          e = ct.extend(
            {},
            Pt.prototype._resolveDataElementOptions.apply(t, arguments)
          ),
          i = t._getIndexScale().options,
          n = t._getValueScale().options;
        return (
          (e.barPercentage = Jt(i.barPercentage, e.barPercentage)),
          (e.barThickness = Jt(i.barThickness, e.barThickness)),
          (e.categoryPercentage = Jt(
            i.categoryPercentage,
            e.categoryPercentage
          )),
          (e.maxBarThickness = Jt(i.maxBarThickness, e.maxBarThickness)),
          (e.minBarLength = Jt(n.minBarLength, e.minBarLength)),
          e
        );
      },
    }),
  ...
  var ne = Pt.extend({
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.borderColor = ee(i.hoverBorderColor, n(i.borderColor))),
          (e.borderWidth = ee(i.hoverBorderWidth, i.borderWidth)),
      ...
      _resolveDataElementOptions: function (t, e) {
        ...
        return (
          i._cachedDataOpts === s && (s = ct.extend({}, s)),
          (s.radius = ie(
            [r.radius, o.r, i._config.radius, n.options.elements.point.radius],
            l,
            e
          )),
          s
  ...
  st._set("doughnut", {
    ...
    legendCallback: function (t) {
      ...
      if ((a.setAttribute("class", t.id + "-legend"), o.length))
        for (e = 0, i = o[0].data.length; e < i; ++e)
          ((n = a.appendChild(document.createElement("li"))).appendChild(
            document.createElement("span")
          ).style.backgroundColor = o[0].backgroundColor[e]),
            s[e] && n.appendChild(document.createTextNode(s[e]));
      return a.outerHTML;
    },
    legend: {
      labels: {
  ...
  var le = Pt.extend({
    ...
    update: function (t) {
      ...
      for (
        o.borderWidth = r.getMaxBorderWidth(),
          ...
          i = (s.bottom - s.top - o.borderWidth) / d,
          o.outerRadius = Math.max(Math.min(e, i) / 2, 0),
      ...
      var n = this,
        ...
        f =
          i && s.animateRotate
            ...
            : t.hidden
            ? 0
            : n.calculateCircumference(c.data[e]) * (o.circumference / oe),
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (e.backgroundColor = ae(i.hoverBackgroundColor, n(i.backgroundColor))),
        (e.borderColor = ae(i.hoverBorderColor, n(i.borderColor))),
  ...
  var fe = Pt.extend({
      ...
      _resolveDatasetElementOptions: function (t) {
        ...
        return (
          (o.spanGaps = de(i.spanGaps, a.spanGaps)),
          (o.tension = de(i.lineTension, r.tension)),
          (o.steppedLine = he([n.steppedLine, i.steppedLine, r.stepped])),
          o
        );
      },
      ...
      updateBezierControlPoints: function () {
        ...
        if (
          ...
          ct.splineCurveMonotone(l);
        else
          for (t = 0, e = l.length; t < e; ++t)
            (i = l[t]._model),
              (n = ct.splineCurve(
                ct.previousItem(l, t)._model,
                i,
                ct.nextItem(l, t)._model,
                o.tension
              )),
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.backgroundColor = de(
            i.hoverBackgroundColor,
            n(i.backgroundColor)
          )),
          (e.borderColor = de(i.hoverBorderColor, n(i.borderColor))),
          (e.borderWidth = de(i.hoverBorderWidth, i.borderWidth)),
          (e.radius = de(i.hoverRadius, i.radius));
      },
    }),
  ...
  st._set("pie", ct.clone(st.doughnut)),
  ...
  var be = Pt.extend({
    ...
    _resolveDatasetElementOptions: function () {
      ...
      return (
        (n.spanGaps = ve(e.spanGaps, i.spanGaps)),
        (n.tension = ve(e.lineTension, i.elements.line.tension)),
        n
      );
    },
    updateBezierControlPoints: function () {
      ...
      for (
        ...
        (i = o[t]._model),
          (n = ct.splineCurve(
            ct.previousItem(o, t, !0)._model,
            i,
            ct.nextItem(o, t, !0)._model,
            i.tension
          )),
    ...
    setHoverStyle: function (t) {
      ...
      (t.$previousStyle = {
        ...
        (e.backgroundColor = ve(i.hoverBackgroundColor, n(i.backgroundColor))),
        (e.borderColor = ve(i.hoverBorderColor, n(i.borderColor))),
        (e.borderWidth = ve(i.hoverBorderWidth, i.borderWidth)),
        (e.radius = ve(i.hoverRadius, i.radius));
    },
  });
  st._set("scatter", {
    hover: { mode: "single" },
  ...
  function Ie(t, e, i) {
    ...
    if (
      ...
      (i.size = i.horizontal ? r.height : r.width),
      (t[i.pos] += i.size),
      r.getPadding)
    ) {
      var s = r.getPadding();
    ...
    if (
      ((n = e.outerWidth - Te(o, t, "left", "right")),
      (a = e.outerHeight - Te(o, t, "top", "bottom")),
      n !== t.w || a !== t.h)
    )
  ...
  function Ze(t, e, i) {
    var n,
      ...
      l = (s.resizer = (function (t) {
        ...
        return (
          Ye(i, "scroll", a.bind(i, "expand")),
          Ye(n, "scroll", a.bind(n, "shrink")),
          e
        );
      })(
        ((n = function () {
          if (s.resizer) {
            var n = i.options.maintainAspectRatio && t.parentNode,
              a = n ? n.clientWidth : 0;
            e(Xe("resize", i)),
              n && n.clientWidth < a && i.canvas && e(Xe("resize", i));
          }
        }),
        (r = !1),
        (o = []),
        function () {
          (o = Array.prototype.slice.call(arguments)),
            ...
            r ||
              ((r = !0),
              ct.requestAnimFrame.call(window, function () {
                (r = !1), n.apply(a, o);
              }));
        })
      ));
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === i.indexOf(t)) {
              var e = t.id,
                a = r[e];
              !1 !== a &&
                (!0 === a && (a = ct.clone(st.global.plugins[e])),
                i.push(t),
    ...
    ii = {
      ...
      getScaleDefaults: function (t) {
        return this.defaults.hasOwnProperty(t)
          ? ct.merge({}, [st.scale, this.defaults[t]])
          : {};
      },
      updateScaleDefaults: function (t, e) {
        this.defaults.hasOwnProperty(t) &&
          (this.defaults[t] = ct.extend(this.defaults[t], e));
      },
    ...
    tooltips: {
      ...
      callbacks: {
        ...
        label: function (t, e) {
          ...
          return (
            i && (i += ": "),
            ct.isNullOrUndef(t.value) ? (i += t.yLabel) : (i += t.value),
            i
          );
        },
  ...
  function oi(t, e) {
    return (
      e && (ct.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
    );
  }
  function si(t) {
  ...
  var hi = xt.extend({
      ...
      getBody: function (t, e) {
        ...
        return (
          ct.each(t, function (t) {
            ...
            oi(r.before, si(n.beforeLabel.call(i, t, e))),
              oi(r.lines, n.label.call(i, t, e)),
              oi(r.after, si(n.afterLabel.call(i, t, e))),
              a.push(r);
          }),
          a
        );
          ...
          c.filter &&
            ...
            (x = (function (t, e) {
              ...
              return (
                ...
                ct.each(e.beforeBody.concat(e.afterBody), f),
                (c = e.displayColors ? d + 2 : 0),
                ct.each(r, function (t) {
                  ct.each(t.before, f),
                    ct.each(t.lines, f),
                    ct.each(t.after, f);
                }),
      ...
      drawTitle: function (t, e, i) {
        ...
        if (s) {
          ...
          for (
            t.x = ui(e, e._titleAlign),
              i.textAlign = l.textAlign(e._titleAlign),
              i.textBaseline = "middle",
              n = e.titleFontSize,
              a = e.titleSpacing,
              i.fillStyle = e.titleFontColor,
              i.font = ct.fontString(n, e._titleFontStyle, e._titleFontFamily),
              r = 0;
            r < s;
            ++r
          )
            i.fillText(o[r], l.x(t.x), t.y + n / 2),
              (t.y += n + a),
      ...
      drawBody: function (t, e, i) {
        ...
        for (
          i.textAlign = f,
            i.textBaseline = "middle",
            i.font = ct.fontString(h, e._bodyFontStyle, e._bodyFontFamily),
            t.x = ui(e, y),
            i.fillStyle = e.bodyFontColor,
            ct.each(e.beforeBody, x),
          ...
          for (
            ...
            if (p) {
              ...
              (i.fillStyle = e.legendColorBackground),
                i.fillRect(b.leftForLtr(_, h), t.y, h, h),
                (i.lineWidth = 1),
                (i.strokeStyle = r.borderColor),
                i.strokeRect(b.leftForLtr(_, h), t.y, h, h),
                (i.fillStyle = r.backgroundColor),
                i.fillRect(
      ...
      drawFooter: function (t, e, i) {
        ...
        if (o) {
          ...
          for (
            ...
            i.fillText(r[a], s.x(t.x), t.y + n / 2),
      ...
      draw: function () {
        ...
        if (0 !== e.opacity) {
          ...
          this._options.enabled &&
            ...
            (n.y += e.yPadding),
            ct.rtl.overrideTextDirection(t, e.textDirection),
            this.drawTitle(n, e, t),
            this.drawBody(n, e, t),
            this.drawFooter(n, e, t),
            ct.rtl.restoreTextDirection(t, e.textDirection),
            t.restore());
        }
      },
        ...
        return (
          ...
          "mouseout" === t.type
            ...
            : ((i._active = i._chart.getElementsAtEventForMode(t, n.mode, n)),
              n.reverse && i._active.reverse()),
          (e = !ct.arrayEquals(i._active, i._lastActive)) &&
      ...
      merger: function (t, e, i, n) {
        if ("xAxes" === t || "yAxes" === t) {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = i[t][a]),
              (r = gi(o.type, "xAxes" === t ? "category" : "linear")),
              a >= e[t].length && e[t].push({}),
              !e[t][a].type || (o.type && o.type !== e[t][a].type)
                ? ct.merge(e[t][a], [ii.getScaleDefaults(r), o])
                : ct.merge(e[t][a], o);
    ...
    return ct.merge({}, [].slice.call(arguments), {
      merger: function (t, e, i, n) {
        ...
        "scales" === t
          ? (e[t] = pi(a, r))
          : "scale" === t
          ? (e[t] = ct.merge(a, [ii.getScaleDefaults(r.type), r]))
          : ct._merger(t, e, i, n);
      },
    });
  }
  function vi(t) {
    ...
    ct.each(t.scales, function (e) {
      ...
      (e = mi(st.global, st[t.config.type], e)),
  ...
  ct.extend(_i.prototype, {
    construct: function (t, e) {
      ...
      e = (function (t) {
        ...
        return (
          ...
          (e.labels = e.labels || []),
          (t.options = mi(st.global, st[t.type], t.options || {})),
          t
        );
      })(e);
    ...
    initialize: function () {
      var t = this;
      return (
        ei.notify(t, "beforeInit"),
        ct.retinaScale(t, t.options.devicePixelRatio),
        t.bindEvents(),
        t.options.responsive && t.resize(!0),
        t.initToolTip(),
        ei.notify(t, "afterInit"),
        t
      );
    },
    clear: function () {
    ...
    resize: function (t) {
      ...
      if (
        ...
        (n.style.width = r + "px"),
        (n.style.height = o + "px"),
        ct.retinaScale(e, i.devicePixelRatio),
        !t)
      ) {
        var s = { width: r, height: o };
        ei.notify(e, "resize", [s]),
      ...
      e.scales &&
        ...
        ct.each(n, function (e) {
          var n = e.options,
            r = n.id,
            o = gi(n.type, e.dtype);
          xi(n.position) !== xi(e.dposition) && (n.position = e.dposition),
            (a[r] = !0);
          var s = null;
    ...
    buildOrUpdateControllers: function () {
      ...
      for (t = 0, e = a.length; t < e; t++) {
        ...
        if (
          (o.type &&
            o.type !== s &&
            (i.destroyDatasetMeta(t), (o = i.getDatasetMeta(t))),
          (o.type = s),
          (o.order = r.order || 0),
          (o.index = t),
          o.controller)
      ...
      if (
        ...
        n.updateLayout(),
          n.options.animation &&
            ...
            ct.each(a, function (t) {
              t.reset();
            }),
          n.updateDatasets(),
          n.tooltip.initialize(),
          (n.lastActive = []),
          ei.notify(n, "afterUpdate"),
          n._layers.sort(yi("z", "_idx")),
          n._bufferedRender
            ? (n._bufferedRequest = {
                duration: t.duration,
                easing: t.easing,
    ...
    updateLayout: function () {
      ...
      !1 !== ei.notify(t, "beforeLayout") &&
        ...
        ei.notify(t, "afterScaleUpdate"),
        ei.notify(t, "afterLayout"));
    },
    ...
    updateDataset: function (t) {
      var e = this.getDatasetMeta(t),
        i = { meta: e, index: t };
      !1 !== ei.notify(this, "beforeDatasetUpdate", [i]) &&
        (e.controller._update(), ei.notify(this, "afterDatasetUpdate", [i]));
    },
    render: function (t) {
      var e = this;
    ...
    draw: function (t) {
      ...
      if (
        (n.clear(),
        ct.isNullOrUndef(t) && (t = 1),
        n.transition(t),
        !(n.width <= 0 || n.height <= 0) &&
          !1 !== ei.notify(n, "beforeDraw", [t]))
      ) {
    ...
    drawDatasets: function (t) {
      ...
      if (!1 !== ei.notify(this, "beforeDatasetsDraw", [t])) {
        for (
          i = (e = this._getSortedVisibleDatasetMetas()).length - 1;
          i >= 0;
          --i
        )
    ...
    drawDataset: function (t, e) {
      ...
      !1 !== ei.notify(this, "beforeDatasetDraw", [i]) &&
        (t.controller.draw(e), ei.notify(this, "afterDatasetDraw", [i]));
    },
    _drawTooltip: function (t) {
      var e = this.tooltip,
        i = { tooltip: e, easingValue: t };
      !1 !== ei.notify(this, "beforeTooltipDraw", [i]) &&
        (e.draw(), ei.notify(this, "afterTooltipDraw", [i]));
    },
    ...
    destroy: function () {
      ...
      n &&
        (i.unbindEvents(),
        ct.canvas.clear(i),
        ti.releaseContext(i.ctx),
        (i.canvas = null),
        (i.ctx = null)),
        ei.notify(i, "destroy"),
        delete _i.instances[i.id];
    },
    ...
    bindEvents: function () {
      ...
      ct.each(t.options.events, function (n) {
        ...
        t.options.responsive &&
          ...
          ti.addEventListener(t, "resize", i),
          (e.resize = i));
    },
    ...
    updateHoverStyle: function (t, e, i) {
      ...
      for (a = 0, r = t.length; a < r; ++a)
        (n = t[a]) &&
          this.getDatasetMeta(n._datasetIndex).controller[o + "HoverStyle"](n);
      "dataset" === e &&
    ...
    handleEvent: function (t) {
      ...
      return (
        ...
        ct.callback(n.onHover || n.hover.onHover, [t.native, i.active], i),
        ...
        (e = !ct.arrayEquals(i.active, i.lastActive)),
        ...
        if (Pi(s))
          for (r = 0, o = s.length; r < o; ++r)
            (g = s[r]),
              Ai(g) ||
                Pi(g) ||
                ((c = ct.measureText(t, d.data, d.gc, c, g)), (f += h));
  ...
  function Oi(t) {
    var e, i;
    return t.display
      ? ((e = ct.options._parseFont(t)),
        (i = ct.options.toPadding(t.padding)),
        e.lineHeight + i.height)
      : 0;
  }
  function Ri(t, e) {
    return ct.extend(
      ct.options._parseFont({
  ...
  function Bi(t, e, i, n) {
    var a,
      ...
      d = 0;
    for (
      e = Math.ceil(e), n && (e = (a = n - i) / Math.floor(a / e)), s = l;
      s < 0;
  ...
  var Ei = xt.extend({
    ...
    update: function (t, e, i) {
      ...
      if (
        ...
        (l.maxWidth = t),
        (l.maxHeight = e),
        (l.margins = ct.extend({ left: 0, right: 0, top: 0, bottom: 0 }, i)),
        (l._ticks = null),
        (l.ticks = null),
        (l._labelSizes = null),
        (l._maxLabelLines = 0),
        ...
        for (o = [], n = 0, a = l.ticks.length; n < a; ++n)
          o.push({ value: l.ticks[n], major: !1 });
      return (
        (l._ticks = o),
        (s = d < o.length),
        (r = l._convertTicksToLabels(
          s
            ? (function (t, e) {
                for (
                  var i = [], n = t.length / e, a = 0, r = t.length;
                  a < r;
                  a += n
                )
    ...
    afterBuildTicks: function (t) {
      var e = this;
      return Pi(t) && t.length
        ? ct.callback(e.options.afterBuildTicks, [e, t])
        : ((e.ticks =
            ct.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks),
          t);
    },
    ...
    calculateTickRotation: function () {
      ...
      !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
        ...
        : ((e = (t = s._getLabelSizes()).widest.width),
          ...
          e + 6 > (a = l.offset ? s.maxWidth / d : n / (d - 1)) &&
            ((a = n / (d - (l.offset ? 0.5 : 1))),
            (r = s.maxHeight - Li(l.gridLines) - u.padding - Oi(l.scaleLabel)),
            (o = Math.sqrt(e * e + i * i)),
            (f = ct.toDegrees(
              Math.min(
                Math.asin(Math.min((t.highest.height + 6) / a, 1)),
                Math.asin(Math.min(r / o, 1)) - Math.asin(i / o)
              )
            )),
    ...
    fit: function () {
      var t = this,
        ...
        u = t.isHorizontal();
      if (
        (u ? (e.width = t.maxWidth) : s && (e.width = Li(o) + Oi(r)),
        u ? s && (e.height = Li(o) + Oi(r)) : (e.height = t.maxHeight),
        a.display && s)
      ) {
        var d = zi(a),
          h = t._getLabelSizes(),
      ...
      t.handleMargins(),
        u
          ? ((t.width = t._length = i.width - t.margins.left - t.margins.right),
            (t.height = e.height))
          : ((t.width = e.width),
            (t.height = t._length =
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e =
            Fi(t.ctx, zi(t.options.ticks), t.getTicks(), t.longestTextCache)),
      ...
      return (
        Pi(t)
          ? ((e = +this.getRightValue(t[0])),
            ...
            (n = Math.min(e, i)),
            (a = Math.max(e, i)))
          : ((e = void 0), (i = t = +this.getRightValue(t)), (n = t), (a = t)),
        ...
        return (
          (function (t, e, i) {
            ...
            for (i = Math.ceil(i), n = 0; n < t.length; n++)
              (a = t[n]),
                n === o ? ((a._index = n), (o = e[++r * i])) : delete a.label;
          })(t, l, u / s),
          Ni(t)
        );
      if (
        ...
        return (
          (a = u > 1 ? (h - d) / (u - 1) : null),
          Bi(t, n, ct.isNullOrUndef(a) ? 0 : d - a, d),
          Bi(t, n, h, ct.isNullOrUndef(a) ? t.length : h + a),
          Ni(t)
        );
      }
      return Bi(t, n), Ni(t);
    ...
    _computeGridLineItems: function (t) {
      ...
      for (
        ...
        (n = S[i] || {}),
          (Ai(n.label) && i < S.length) ||
            (i === b.zeroLineIndex && y.offset === w
              ? ((g = _.zeroLineWidth),
                (p = _.zeroLineColor),
                (m = _.zeroLineBorderDash || []),
                (v = _.zeroLineBorderDashOffset || 0))
              : ((g = Ti(_.lineWidth, i, 1)),
                (p = Ti(_.color, i, "rgba(0,0,0,0.1)")),
                (m = _.borderDash || []),
                (v = _.borderDashOffset || 0)),
            void 0 !== (a = Ii(b, n._index || i, w)) &&
              ((r = I(x, a, g)),
    ...
    _computeLabelItems: function () {
      ...
      for (
        ...
        (n = (i = b[t]).label),
          Ai(n) ||
            ((s = c.getPixelForTick(i._index || t) + g.labelOffset),
            (u = (l = i.major ? x.major : x.minor).lineHeight),
            (d = Pi(n) ? n.length : 1),
            v
              ? ((a = s),
        ...
        for (r = 0, o = c.length; r < o; ++r)
          (n = (s = c[r]).width),
            ...
            n &&
              ...
              i.drawOnChartArea && (l.moveTo(s.x1, s.y1), l.lineTo(s.x2, s.y2)),
              l.stroke(),
              l.restore());
        if (h) {
          var f,
    ...
    _getMatchingVisibleMetas: function (t) {
      ...
      return e.chart._getSortedVisibleDatasetMetas().filter(function (n) {
        return (
          (!t || n.type === t) && (i ? n.xAxisID === e.id : n.yAxisID === e.id)
        );
      });
    },
  });
    ...
    Hi = Vi.extend({
      determineDataLimits: function () {
        var t,
          ...
          o = 0,
          s = i.length - 1;
        void 0 !== a && (t = i.indexOf(a)) >= 0 && (o = t),
          void 0 !== r && (t = i.indexOf(r)) >= 0 && (s = t),
          (e.minIndex = o),
          (e.maxIndex = s),
          (e.min = i[o]),
          (e.max = i[s]);
      ...
      _configure: function () {
        var t = this,
          e = t.options.offset,
          i = t.ticks;
        Vi.prototype._configure.call(t),
      ...
      getPixelForValue: function (t, e, i) {
        var n,
          ...
          o = this;
        return (
          Wi(e) || Wi(i) || (t = o.chart.data.datasets[i].data[e]),
          Wi(t) || (n = o.isHorizontal() ? t.x : t.y),
          (void 0 !== n || (void 0 !== t && isNaN(e))) &&
            ((a = o._getLabels()),
            (t = ct.valueOrDefault(n, t)),
  ...
  var Yi = Vi.extend({
      getRightValue: function (t) {
        return "string" == typeof t
          ? +t
          : Vi.prototype.getRightValue.call(this, t);
      },
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
              (p = ct.niceNum((r * p) / u / l) * l),
              s || Ui(c)
                ? (i = Math.pow(10, ct._decimalPlaces(p)))
                : ((i = Math.pow(10, c)), (p = Math.ceil(p * i) / i)),
              (n = Math.floor(f / p) * p),
              (a = Math.ceil(g / p) * p),
              s &&
                (!Ui(d) && ct.almostWhole(d / p, p / 1e3) && (n = d),
                !Ui(h) && ct.almostWhole(h / p, p / 1e3) && (a = h)),
              (r = (a - n) / p),
              (r = ct.almostEquals(r, Math.round(r), p / 1e3)
                ? Math.round(r)
                : Math.ceil(r)),
              (n = Math.round(n * i) / i),
              (a = Math.round(a * i) / i),
      ...
      convertTicksToLabels: function () {
        ...
        (t.ticksAsNumbers = t.ticks.slice()),
          ...
          Vi.prototype.convertTicksToLabels.call(t);
      },
      _configure: function () {
        var t,
          e = this,
          ...
          n = e.min,
          a = e.max;
        Vi.prototype._configure.call(e),
          e.options.offset &&
            i.length &&
            ((n -= t = (a - n) / Math.max(i.length - 1, 1) / 2), (a += t)),
          (e._startValue = n),
          (e._endValue = a),
          (e._valueRange = a - n);
      },
  ...
  var Zi = Yi.extend({
      determineDataLimits: function () {
        ...
        ct.each(u, function (t) {
          (n = t.pos.concat(t.neg)),
            (a.min = Math.min(a.min, ct.min(n))),
            (a.max = Math.max(a.max, ct.max(n)));
        }),
          (a.min = ct.isFinite(a.min) && !isNaN(a.min) ? a.min : 0),
          (a.max = ct.isFinite(a.max) && !isNaN(a.max) ? a.max : 1),
      ...
      _computeTickLimit: function () {
        ...
        return this.isHorizontal()
          ...
          : ((t = ct.options._parseFont(this.options.ticks)),
  ...
  var nn = Vi.extend({
        ...
        if (s.stacked || c) {
          ...
          for (t = 0; t < u.length; t++)
            if (((e = l.getDatasetMeta(t)), l.isDatasetVisible(t) && h(e)))
              for (a = 0, r = (n = u[t].data).length; a < r; a++)
                (i = o._parseValue(n[a])),
                  isNaN(i.min) ||
                    isNaN(i.max) ||
                    e.data[a].hidden ||
                    i.min < 0 ||
                    i.max < 0 ||
                    ((o.min = Math.min(i.min, o.min)),
                    (o.max = Math.max(i.max, o.max)),
                    0 !== i.min &&
                      (o.minNotZero = Math.min(i.min, o.minNotZero)));
        (o.min = ct.isFinite(o.min) ? o.min : null),
          (o.max = ct.isFinite(o.max) ? o.max : null),
          (o.minNotZero = ct.isFinite(o.minNotZero) ? o.minNotZero : null),
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = en(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min
              ? ((t.min = Math.pow(10, Math.floor(Qi(t.min)) - 1)),
                (t.max = Math.pow(10, Math.floor(Qi(t.max)) + 1)))
              : ((t.min = 1), (t.max = 10))),
          null === t.min && (t.min = Math.pow(10, Math.floor(Qi(t.max)) - 1)),
          null === t.max &&
            (t.max =
              0 !== t.min ? Math.pow(10, Math.floor(Qi(t.min)) + 1) : 10),
          null === t.minNotZero &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
              ? (t.minNotZero = Math.pow(10, Math.floor(Qi(t.max))))
              : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
      ...
      convertTicksToLabels: function () {
        (this.tickValues = this.ticks.slice()),
          Vi.prototype.convertTicksToLabels.call(this);
      },
      getLabelForIndex: function (t, e) {
        return this._getScaleLabel(this.chart.data.datasets[e].data[t]);
      },
      ...
      _configure: function () {
        ...
        Vi.prototype._configure.call(t),
          0 === e &&
            ...
            (i =
              Ji(t.options.ticks.fontSize, st.global.defaultFontSize) /
              t._length)),
          (t._startValue = Qi(e)),
          (t._valueOffset = i),
          (t._valueRange = (Qi(t.max) - Qi(e)) / (1 - i));
      },
      getPixelForValue: function (t) {
        var e = this,
          i = 0;
        return (
          (t = +e.getRightValue(t)) > e.min &&
            t > 0 &&
            (i = (Qi(t) - e._startValue) / e._valueRange + e._valueOffset),
      ...
      getValueForPixel: function (t) {
        ...
        return 0 === i && 0 === e.min
          ? 0
          : Math.pow(10, e._startValue + (i - e._valueOffset) * e._valueRange);
      },
    }),
    an = tn;
  nn._defaults = an;
  ...
  function un(t) {
    ...
    return e.display && t.display
      ? rn(e.fontSize, st.global.defaultFontSize) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  var pn = Yi.extend({
          ...
          ? (function (t) {
              ...
              for (e = 0; e < d; e++) {
                (n = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (u = t.pointLabels[e]),
                  (i = ct.isArray(u)
                    ? { w: ct.longestText(s, s.font, u), h: u.length * l }
      ...
      getBasePosition: function (t) {
        ...
        return this.getPointPositionForValue(
          t || 0,
          this.beginAtZero ? 0 : e < 0 && i < 0 ? i : e > 0 && i > 0 ? e : 0
        );
      },
      _drawGrid: function () {
        var t,
        ...
        if (
            ...
            (function (t) {
              ...
              for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                ...
                var h = t.getIndexAngle(s),
                  c = ct.toDegrees(h);
                (e.textAlign = hn(c)),
                  fn(c, t._pointLabelSizes[s], u),
                  cn(e, t.pointLabels[s], u, o.lineHeight);
              }
              e.restore();
            })(n),
          o.display &&
            ct.each(n.ticks, function (t, i) {
              0 !== i &&
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(sn([s.borderDash, o.borderDash, []])),
                (a.lineDashOffset = sn([
                  s.borderDashOffset,
                  o.borderDashOffset,
                  0,
      ...
      _drawLabels: function () {
        ...
        if (i.display) {
          ...
          e.save(),
            ...
            (e.textAlign = "center"),
            (e.textBaseline = "middle"),
            ct.each(t.ticks, function (r, l) {
              (0 !== l || i.reverse) &&
                ((n = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l])),
                i.showLabelBackdrop &&
                  ((a = e.measureText(r).width),
                  (e.fillStyle = i.backdropColor),
                  e.fillRect(
                    -a / 2 - i.backdropPaddingX,
                    -n - o.size / 2 - i.backdropPaddingY,
                    a + 2 * i.backdropPaddingX,
  ...
  function An(t, e) {
    ...
    return (
      ...
      ct.isFinite(o) || (o = "string" == typeof r ? i.parse(o, r) : i.parse(o)),
      null !== o
        ? +o
        : (a ||
            "function" != typeof r ||
            ((o = r(e)), ct.isFinite(o) || (o = i.parse(o))),
          o)
    );
  }
  function Dn(t, e) {
  ...
  var Fn = Vi.extend({
      ...
      update: function () {
        ...
        return (
          vn("time scale", i.format, "time.format", "time.parser"),
          vn("time scale", i.min, "time.min", "ticks.min"),
          vn("time scale", i.max, "time.max", "ticks.max"),
          ct.mergeIf(i.displayFormats, n.formats()),
          Vi.prototype.update.apply(t, arguments)
        );
      },
      getRightValue: function (t) {
        return (
      ...
      determineDataLimits: function () {
        ...
        m.length &&
          ...
          (c = Dn(s, Sn(d)) || c),
          (f = Dn(s, Cn(d)) || f),
          (c = c === _n ? +u.startOf(Date.now(), h) : c),
          (f = f === yn ? +u.endOf(Date.now(), h) + 1 : f),
          (s.min = Math.min(c, f)),
      ...
      buildTicks: function () {
        ...
        return (
          ...
          (n._unit =
            l.unit ||
            (s.autoSkip
              ? Tn(l.minUnit, n.min, n.max, h)
              : (function (t, e, i, n, a) {
                  var r, o;
                  for (r = wn.length - 1; r >= wn.indexOf(i); r--)
                    if (
                      ((o = wn[r]),
                      kn[o].common && t._adapter.diff(a, n, o) >= e - 1)
                    )
                      return o;
                  return wn[i ? wn.indexOf(i) : 0];
                })(n, d.length, l.minUnit, n.min, n.max))),
          (n._majorUnit =
            s.major.enabled && "year" !== n._unit
              ? (function (t) {
            ...
            return (
              a.offset &&
                ...
                (s =
                  1 === e.length
                    ? 1 - r
                    : (Pn(t, "time", e[1], "pos") - r) / 2),
                (o = Pn(t, "time", e[e.length - 1], "pos")),
                (l =
                  1 === e.length
                    ? o
                    : (o - Pn(t, "time", e[e.length - 2], "pos")) / 2)),
      ...
      getLabelForIndex: function (t, e) {
        ...
        return (
          ct.isObject(s) && (o = i.getRightValue(s)),
          r.tooltipFormat
            ? n.format(An(i, o), r.tooltipFormat)
            : "string" == typeof o
            ? o
            : n.format(An(i, o), r.displayFormats.datetime)
        );
      },
    ...
    return (t.el._scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          for (
            ...
            (r =
              "start" === u || "end" === u
                ? o.getPointPositionForValue(a, "start" === u ? e : i)
                : o.getBasePosition(a)),
    ...
    if (n && a) {
      ...
      if (void 0 === i[0].angle)
        ...
        for (
          o = i[0].cx,
            s = i[0].cy,
            l = Math.sqrt(Math.pow(i[0].x - o, 2) + Math.pow(i[0].y - s, 2)),
            r = a - 1;
          r > 0;
          --r
        )
  ...
  var qn = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (n = 0; n < o; ++n)
          (r = l[n]) &&
            ((r.fill = En(l, n, s)), (r.boundary = Bn(r)), (r.mapper = Vn(r)));
      },
      beforeDatasetsDraw: function (t) {
        ...
        for (i = l.length - 1; i >= 0; --i)
          (e = l[i].$filler) &&
            ...
            (r = n._children || []),
            (o = e.mapper),
            (s = a.backgroundColor || st.global.defaultColor),
            o &&
              s &&
              r.length &&
              (ct.canvas.clipArea(u, t.chartArea),
              jn(u, r, o, a, s, n._loop),
              ct.canvas.unclipArea(u)));
      },
    },
  ...
  st._set("global", {
    ...
    legendCallback: function (t) {
      var e,
        ...
        r = t.data.datasets;
      for (
        a.setAttribute("class", t.id + "-legend"), e = 0, i = r.length;
        e < i;
        e++
      )
        ((n = a.appendChild(document.createElement("li"))).appendChild(
        ...
        if (((a.font = r.string), u)) {
          ...
          (a.textAlign = "left"),
            ...
            ct.each(t.legendItems, function (t, e) {
              ...
              (0 === e || d[d.length - 1] + n + 2 * i.padding > l.width) &&
                ((h += o + i.padding), (d[d.length - (e > 0 ? 0 : 1)] = 0)),
          ...
          ct.each(t.legendItems, function (t, e) {
            ...
            e > 0 &&
              v + o + 2 * c > l.height &&
              ((p += m + i.padding), f.push(m), g.push(v), (m = 0), (v = 0)),
              (m = Math.max(m, n)),
              (v += o + c),
              (s[e] = { left: 0, top: 0, width: n, height: o });
          }),
    ...
    draw: function () {
      ...
      if (e.display) {
        ...
        var m = Xn(i, p),
          ...
          x = t.isHorizontal();
        (d = x
          ? { x: t.left + b(l, u[0]), y: t.top + i.padding, line: 0 }
          : { x: t.left + i.padding, y: t.top + b(o, s[0]), line: 0 }),
        ...
        ct.each(t.legendItems, function (e, n) {
          ...
          h.setWidth(t.minSize.width),
            x
              ? n > 0 &&
                _ + g + i.padding > t.left + t.minSize.width &&
                ((k = d.y += y), d.line++, (_ = d.x = t.left + b(l, u[d.line])))
              : n > 0 &&
                k + y > t.top + t.minSize.height &&
                ((_ = d.x = _ + t.columnWidths[d.line] + i.padding),
                d.line++,
          ...
          !(function (t, e, n) {
            if (!(isNaN(m) || m <= 0)) {
              ...
              if (
                ((c.fillStyle = Gn(n.fillStyle, a)),
                (c.lineCap = Gn(n.lineCap, r.borderCapStyle)),
                (c.lineDashOffset = Gn(n.lineDashOffset, r.borderDashOffset)),
                (c.lineJoin = Gn(n.lineJoin, r.borderJoinStyle)),
                (c.lineWidth = o),
                (c.strokeStyle = Gn(n.strokeStyle, a)),
                c.setLineDash && c.setLineDash(Gn(n.lineDash, r.borderDash)),
                i && i.usePointStyle)
              ) {
            ...
            (v[n].left = h.leftForLtr(w, v[n].width)),
            (v[n].top = k),
            (function (t, e, i, n) {
              var a = p / 2,
                r = h.xPlus(t, m + a),
              ...
              c.fillText(i.text, r, o),
                i.hidden &&
                  ...
                  (c.lineWidth = 2),
                  c.moveTo(r, o),
                  c.lineTo(h.xPlus(r, n), o),
                  c.stroke());
            })(w, k, e, f),
            x ? (d.x += g + i.padding) : (d.y += y);
        }),
  ...
  var $n = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          i = t.legend;
        e
          ? (ct.mergeIf(e, st.global.legend),
            i ? (Re.configure(t, i, e), (i.options = e)) : Zn(t, e))
          : i && (Re.removeBox(t, i), delete t.legend);
      },
  ...
  var Qn = xt.extend({
    ...
    fit: function () {
      ...
      i.display
        ? ((t =
            (ct.isArray(i.text) ? i.text.length : 1) *
              ct.options._parseFont(i).lineHeight +
            2 * i.padding),
          (e.width = n.width = a ? e.maxWidth : t),
          (e.height = n.height = a ? t : e.maxHeight))
    ...
    aa = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          i = t.titleBlock;
        e
          ? (ct.mergeIf(e, st.global.title),
            i ? (Re.configure(t, i, e), (i.options = e)) : ta(t, e))
          : i && (Re.removeBox(t, i), delete t.titleBlock);
      },
    };
  for (var ra in ((ea.filler = ia),
  (ea.legend = na),
  (ea.title = aa),
  (ki.helpers = ct),
  (function () {
    ...
    (ct.where = function (t, e) {
      ...
      (ct.findIndex = Array.prototype.findIndex
        ? function (t, e, i) {
      ...
      (ct.EPSILON = Number.EPSILON || 1e-14),
      (ct.splineCurveMonotone = function (t) {
        var e,
          i,
          n,
          a,
        ...
        for (e = 0; e < h - 1; ++e)
          (n = d[e]),
            ...
            n.model.skip ||
              a.model.skip ||
              (ct.almostEquals(n.deltaK, 0, this.EPSILON)
                ? (n.mK = a.mK = 0)
                : ((r = n.mK / n.deltaK),
                  (o = a.mK / n.deltaK),
      ...
      (ct._calculatePadding = function (t, e, i) {
        return (e = ct.getStyle(t, e)).indexOf("%") > -1
          ? (i * parseInt(e, 10)) / 100
          : parseInt(e, 10);
      }),
      ...
      (ct.getMaximumWidth = function (t) {
        ...
        var i = e.clientWidth,
          n =
            i -
            ct._calculatePadding(e, "padding-left", i) -
            ct._calculatePadding(e, "padding-right", i),
      ...
      (ct.getMaximumHeight = function (t) {
        ...
        var i = e.clientHeight,
          n =
            i -
            ct._calculatePadding(e, "padding-top", i) -
            ct._calculatePadding(e, "padding-bottom", i),
      ...
      (ct.longestText = function (t, e, i, n) {
        ...
        var o,
          ...
          c = i.length;
        for (o = 0; o < c; o++)
          if (null != (u = i[o]) && !0 !== ct.isArray(u))
            h = ct.measureText(t, a, r, h, u);
          else if (ct.isArray(u))
            for (s = 0, l = u.length; s < l; s++)
              null == (d = u[s]) ||
                ct.isArray(d) ||
                (h = ct.measureText(t, a, r, h, d));
        var f = r.length / 2;
        if (f > i.length) {
      ...
      (ct.color = G
        ? function (t) {
            return (
              t instanceof CanvasGradient && (t = st.global.defaultColor), G(t)
            );
          }
        : function (t) {
      ...
      (ct.getHoverColor = function (t) {
        return t instanceof CanvasPattern || t instanceof CanvasGradient
          ? t
          : ct.color(t).saturate(0.5).darken(0.1).rgbString();
      });
  })(),
  (ki._adapters = Si),
  (ki.Animation = _t),
  (ki.animationService = kt),
  (ki.controllers = xe),
  (ki.DatasetController = Pt),
  (ki.defaults = st),
  (ki.Element = xt),
  (ki.elements = Yt),
  (ki.Interaction = Ce),
  ...
  (ki.Ticks = Ci),
  (ki.Tooltip = fi),
  ki.helpers.each(On, function (t, e) {
  ...
  var oa = ki;
  return (
    "undefined" != typeof window && (window.Chart = ki),
    (ki.Chart = ki),
    (ki.Legend = ea.legend._element),
    (ki.Title = ea.title._element),
    (ki.pluginService = ki.plugins),
    (ki.PluginBase = ki.Element.extend({})),
    (ki.canvasHelpers = ki.helpers.canvas),
    (ki.layoutService = ki.layouts),
    (ki.LinearScaleBase = Yi),
    ki.helpers.each(
