    ...
    updateElement: function updateElement(rectangle, index, reset, numBars) {
      ...
      helpers.extend(rectangle, {
        ...
        _model: {
          ...
          stepLabelColor: rectangleElementOptions.stepLabel.color
            ? rectangleElementOptions.stepLabel.color
            : helpers.getValueAtIndexOrDefault(
                dataset.borderColor,
                index,
                rectangleElementOptions.borderColor
              ),
          stepLabelFontSize: rectangleElementOptions.stepLabel.fontSize
            ? rectangleElementOptions.stepLabel.fontSize
        ...
        draw: function () {
          ...
          if (rectangleElementOptions.stepLabel.display && index != 0) {
            ...
            if (dataset.data[index] > 0) {
              // Draw Step Label
              ctx.font =
                vm.stepLabelFontSize + "px " + options.defaultFontFamily;
          ...
          if (chartOptions.region.display && index < meta.data.length - 1) {
            ...
            var regionCorners = [
              ...
              [
                nextVm.x - halfWidth,
                nextVm.base - (nextVm.base - nextVm.y - 1),
              ],
