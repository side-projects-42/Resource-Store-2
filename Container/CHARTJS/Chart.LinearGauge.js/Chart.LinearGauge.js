(function () {
  ...
  Chart.LinearScale = Chart.Element.extend({
    initialize: function () {
      ...
      //	Major ticks
      if (
        typeof this.majorTicks == "object" &&
        this.majorTicks !== null &&
        this.majorTicks.interval > 0
      ) {
        var majorVals = [];
        if (this.majorTicks.customValues.length > 0) {
          ...
          var numOfMajor =
            (this.range.endValue - this.range.startValue) / interval;
      ...
      //	Minor ticks
      if (
        typeof this.minorTicks == "object" &&
        this.minorTicks !== null &&
        this.minorTicks.interval > 0
      ) {
        var minorVals = [];
      ...
      //	Labels of ticks
      if (
        typeof this.tickLabels == "object" &&
        this.tickLabels !== null &&
        this.tickLabels.interval > 0
      ) {
        var labelVals = [];
        if (this.tickLabels.customValues.length > 0) {
          ...
          var numOfLabels =
            (this.range.endValue - this.range.startValue) / interval + 1;
      ...
      if (this.geometry == "horizontal") {
        this.scalePoint = function (val) {
          ...
          return Math.round(
            val * factor + this.padding.left - this.range.startValue * factor
          );
        };
        ...
        this.scalePoint = function (val) {
          ...
          return Math.round(
            this.height -
              (val * factor - this.range.startValue * factor) -
              this.padding.bottom
          );
        };
    ...
    draw: function () {
      ...
      if (this.geometry == "horizontal") {
        ...
        if (
          typeof this.scaleColorRanges == "object" &&
          this.scaleColorRanges.length > 0
        ) {
          helpers.each(
            this.scaleColorRanges,
            function (d, ind) {
        ...
        if (typeof this.minorVals == "object" && this.minorVals.length > 0) {
          ...
          for (var v = 0; v < this.minorVals.length; v++) {
            ...
            ctx.lineTo(
              this.scalePoint(val) - this.minorTicks.height / 2,
              this.base -
                this.minorTicks.width / 2 +
                this.minorTicks.offset +
                this.minorTicks.width
            );
            ctx.stroke();
          }
        }
        ...
        if (typeof this.majorVals == "object" && this.majorVals.length > 0) {
          ...
          for (var v = 0; v < this.majorVals.length; v++) {
            ...
            ctx.lineTo(
              this.scalePoint(val) - this.majorTicks.height / 2,
              this.base -
                this.majorTicks.width / 2 +
                this.majorTicks.offset +
                this.majorTicks.width
            );
            ctx.stroke();
          }
        }
          ...
          for (var v = 0; v < this.labelVals.length; v++) {
            ...
            if (this.showLabels) {
              ...
              ctx.fillText(
                ...
                this.base +
                  (this.tickLabels.offset > 0
                    ? 0
                    : this.textDimention(text).height) -
                  this.tickLabels.offset
              );
            }
          }
        }
  ...
  Chart.Type.extend({
    ...
    initialize: function (data) {
      ...
      padding.right =
        this.options.scaleFontSize * 2 + this.options.padding.right;
      ...
      this.RangeClass = Chart.Element.extend({
        ...
        generateImage: function (colors, widths) {
          ...
          for (var k = 0; k < colors.length; k++) {
            ...
            this.ctx.closePath();
            if (k + 1 < colors.length) gw2 += widths[k + 1] / 2;
          }
          c.fillStyle = grd;
          ...
          if (this.rangeColorImage === null) {
            ...
            helpers.each(
              ...
              function (cl, i) {
                if (i === 0)
                  widths.push(
                    (cl.breakpoint - this.axisRange.startValue) *
                      this.scaleValue
                  );
                else
                  widths.push(
                    (cl.breakpoint - this.colorRanges[i - 1].breakpoint) *
                      this.scaleValue
                  );
        ...
        draw: function () {
          ...
          if (this.img !== null) {
            if (this.geometry == "horizontal") {
              var x = (this.leftX =
                  this.startPoint +
                  (this.value - this.startValue) * this.scaleValue -
                  this.width / 2),
          ...
          if (
            typeof this.colorRanges == "object" &&
          ...
          if (this.indicator == "range") {
            if (this.geometry == "horizontal") {
              ...
              leftY = this.leftY =
                this.base - this.width / 2 + this.offset * -1;
              rightX = this.rightX =
                this.startPoint +
                (this.value - this.startValue) * this.scaleValue;
              rightY = this.rightY =
            ...
            if (this.shape == "inverted-triangle") {
              if (this.geometry == "horizontal") {
                var x1 =
                    ...
                    (this.value - this.startValue) * this.scaleValue,
                  y1 = (this.leftY =
                    this.base + this.offset * -1 - this.height),
                  x2 = (this.leftX = x1 - this.width / 2),
                  y2 = y1 + this.height,
                  x3 = x2 + this.width,
                  y3 = y2;
            ...
            if (this.shape == "bowtie") {
              if (this.geometry == "horizontal") {
                ...
                var x1 =
                    ...
                    (this.value - this.startValue) * this.scaleValue,
                  y1 = (this.leftY =
                    local_base + this.offset * -1 + local_height),
        ...
        inRange: function (chartX, chartY) {
          if (this.geometry == "horizontal") {
            return (
              ((chartX >= this.leftX && chartX <= this.rightX) ||
                (chartX >= this.rightX && chartX <= this.leftX)) &&
              chartY <= this.rightY &&
              chartY >= this.leftY
            );
          } else {
      ...
      this.startPoint =
        options.range.startValue > 0 ? options.range.startValue : 0;
      this.startPoint =
        options.range.endValue <= 0
          ? options.range.startValue
          : this.startPoint;
      ...
      if (options.geometry == "horizontal") {
        this.scaleValue =
          (this.chart.width - (this.padding.left + this.padding.right)) /
          (options.range.endValue - options.range.startValue);
        this.startPoint =
          this.padding.left +
          (Math.abs(options.range.startValue * this.scaleValue) -
            Math.abs(this.startPoint) * this.scaleValue);
        this.base = this.chart.height / 2;
      } else {
        this.scaleValue =
          (this.chart.height - (this.padding.top + this.padding.bottom)) /
          (options.range.endValue - options.range.startValue);
        this.startPoint =
          this.chart.height -
          (this.padding.bottom +
    ...
    getBarsAtEvent: function (e) {
      ...
      for (
        ...
        if (
          this.datasets[datasetIndex].bar.inRange(
            eventPosition.x,
            eventPosition.y
          )
        ) {
    ...
    addData: function (dataset) {
      ...
      if (typeof dataset.img !== "undefined") imbuffer.src = dataset.img;
      ...
      var label = dataset.label || null,
        ...
        width =
          typeof dataset.width !== "undefined"
            ? dataset.width
            : options.dataset.width,
        height =
          typeof dataset.height !== "undefined"
            ? dataset.height
            : options.dataset.height,
        offset =
          typeof dataset.offset !== "undefined"
            ? dataset.offset
            : options.dataset.offset,
    ...
    showTooltip: function (ChartElements, forceRedraw) {
      ...
      function rangeTooltip(templFunc, element) {
        ...
        if (
          typeof element.tooltipRanges == "object" &&
          element.tooltipRanges.length &&
          element.tooltipRanges.length > 0
        ) {
            ...
            medianPosition = function () {
              ...
              helpers.each(
                ...
                function (element) {
                  ...
                  tooltipLabels.push(
                    rangeTooltip(this.options.multiTooltipTemplate, element)
                  );
                  tooltipColors.push({
