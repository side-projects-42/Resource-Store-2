{% set base\_path = "." %} {% extends 'base.html' %} {% block title %}Chart.js | Open source HTML5 Charts for your website{% endblock title %} {% block head %} {% include 'typekit.html' %} {% include 'modernizr.html' %}
