const { toLineHeight, toPadding, toFont, resolve, toTRBLCorners } =
  Chart.helpers;
...
describe("Chart.helpers.options", function () {
  ...
  describe("toTRBLCorners", function () {
    ...
    it("should support object values", function () {
      ...
      ).toEqual({ topLeft: 1, topRight: 2, bottomLeft: 3, bottomRight: 4 });
      expect(
        toTRBLCorners({
          topLeft: 1.5,
          topRight: 2.5,
  ...
  describe("toPadding", function () {
    ...
    it("should support object values", function () {
      ...
      expect(
        toPadding({ top: 1.5, right: 2.5, bottom: 3.5, left: 4.5 })
      ).toEqual({
        top: 1.5,
        right: 2.5,
        bottom: 3.5,
      ...
      expect(
        toPadding({ top: "1", right: "2", bottom: "3", left: "4" })
      ).toEqual({ top: 1, right: 2, bottom: 3, left: 4, height: 4, width: 6 });
    });
    it("should fallback to 0 for invalid values", function () {
      expect(
        toPadding({ top: "foo", right: "foo", bottom: "foo", left: "foo" })
      ).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 });
      expect(
        toPadding({ top: null, right: null, bottom: null, left: null })
      ).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 });
