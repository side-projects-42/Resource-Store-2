describe("Chart.controllers.bar", function () {
  ...
  it("should set hover styles on bars", function () {
    ...
    chart.data.datasets[1].hoverBackgroundColor = [
      "rgb(255, 255, 255)",
      "rgb(128, 128, 128)",
    ];
  ...
  it("should remove a hover style from a bar", function () {
    ...
    meta.controller.setHoverStyle(bar, 1, 0);
    expect(bar.options.backgroundColor).toBe(
      helpers.getHoverColor("rgb(128, 128, 128)")
    );
    expect(bar.options.borderColor).toBe(
      helpers.getHoverColor("rgb(15, 15, 15)")
    );
    expect(bar.options.borderWidth).toBe(3.14);
    ...
    meta.controller.setHoverStyle(bar, 1, 0);
    expect(bar.options.backgroundColor).toBe(
      helpers.getHoverColor("rgb(255, 255, 255)")
    );
      ...
      describe("When barThickness is " + barThickness, function () {
        ...
        it("should correctly set bar width", function () {
          ...
          if (barThickness) {
            ...
            expected =
              ((tickInterval * categoryPercentage) / 2) * barPercentage;
          }
