  ...
  draw(ctx) {
    ...
    if (close < open) {
      borderColor = valueOrDefault(
        ...
        globalOpts.elements.candlestick.borderColor
      );
      ctx.fillStyle = valueOrDefault(
        me.color ? me.color.up : undefined,
        globalOpts.elements.candlestick.color.up
      );
    } else if (close > open) {
      borderColor = valueOrDefault(
      ...
      ctx.fillStyle = valueOrDefault(
        ...
        globalOpts.elements.candlestick.color.down
      );
    } else {
      borderColor = valueOrDefault(
      ...
      ctx.fillStyle = valueOrDefault(
        ...
        globalOpts.elements.candlestick.color.unchanged
      );
    }

    ctx.lineWidth = valueOrDefault(
      me.borderWidth,
      globalOpts.elements.candlestick.borderWidth
    );
