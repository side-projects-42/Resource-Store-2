...
})(
  {
        ...
        (i = this),
          (a = function (i) {
                ...
                ((function (t) {
                  ...
                  for (var n in o)
                    if (o.hasOwnProperty(n)) {
                      ...
                      if (!("labels" in o[n]))
                        throw new Error(
                          "missing channel labels property: " + n
                        );
            ...
            function s(t) {
              var e = (function () {
                  for (
                    var t = {}, e = Object.keys(u), n = e.length, i = 0;
                    i < n;
                    i++
                  )
              ...
              for (e[t].distance = 0; n.length; )
                for (
                  var i = n.pop(), a = Object.keys(u[i]), r = a.length, o = 0;
                  o < r;
                  o++
                ) {
                  var s = a[o],
            ...
            Object.keys(u).forEach(function (n) {
              (a[n] = {}),
                Object.defineProperty(a[n], "channels", {
                  value: u[n].channels,
                }),
                Object.defineProperty(a[n], "labels", { value: u[n].labels });
              var i = (function (t) {
                for (
                  var e = s(t), n = {}, i = Object.keys(e), a = i.length, r = 0;
                  r < a;
                  r++
                ) {
                  var o = i[r];
            ...
            function g(t) {
              if (t) {
                ...
                if (i) {
                  ...
                  a &&
                    (n = Math.round((parseInt(a + a, 16) / 255) * 100) / 100);
                } else if (
            ...
            function m(t) {
              if (t) {
                ...
                if (e) {
                  ...
                  return [
                    x(parseInt(e[1]), 0, 360),
                    x(parseFloat(e[2]), 0, 100),
                    x(parseFloat(e[3]), 0, 100),
                    x(isNaN(n) ? 1 : n, 0, 1),
                  ];
                }
              }
            ...
            var O = Math.PI,
                    ...
                    t.moveTo(e, l),
                      s < u && l < d
                        ...
                        ? (t.moveTo(s, n),
                          ...
                          t.arc(s, l, o, I, O + I))
                        : l < d
                        ? (t.arc(s, l, o, -O, 0), t.arc(s, d, o, 0, O))
                        : t.arc(s, l, o, -O, O),
                      t.closePath(),
                      t.moveTo(e, n);
                  } else t.rect(e, n, i, a);
                    ...
                    switch ((t.beginPath(), e)) {
                      ...
                      case "rectRounded":
                        (u = n - (d = 0.516 * n)),
                          (s = Math.cos(h + L) * u),
                          (l = Math.sin(h + L) * u),
                          t.arc(i - s, a - l, d, h - O, h - I),
                          t.arc(i + l, a - s, d, h - I, h),
                          t.arc(i + s, a + l, d, h, h + I),
                          t.arc(i - l, a + s, d, h + I, h + O),
                          t.closePath();
                        break;
                      case "rect":
                        if (!r) {
              ...
              N = W;
            (C.clear = W.clear),
              (C.drawRoundedRectangle = function (t) {
                ...
                _parseFont: function (t) {
                  var e,
                    ...
                    a = {
                      ...
                      lineHeight: C.options.toLineHeight(
                        E(t.lineHeight, n.defaultLineHeight),
                        i
                      ),
                      size: i,
                  ...
                  return (
                    (a.string =
                      !(e = a) ||
                      C.isNullOrUndef(e.size) ||
                      C.isNullOrUndef(e.family)
                        ? null
                        : (e.style ? e.style + " " : "") +
                          (e.weight ? e.weight + " " : "") +
                          e.size +
                  ...
                  for (a = 0, r = t.length; a < r; ++a)
                    if (
                      ...
                      (void 0 !== e &&
                        "function" == typeof o &&
                        ((o = o(e)), (s = !1)),
                      void 0 !== n && C.isArray(o) && ((o = o[n]), (s = !1)),
                      void 0 !== o)
                    )
            ...
            j.extend(X.prototype, {
              ...
              pivot: function () {
                var t = this;
                return (
                  t._view || (t._view = j.extend({}, t._model)),
                  (t._start = {}),
                  t
                );
              },
              transition: function (t) {
                ...
                return (
                  n && 1 !== t
                    ...
                    : ((e._view = j.extend({}, n)), (e._start = null)),
                  e
                );
              },
            ...
            var tt = {
                ...
                advance: function () {
                  for (
                    var t, e, n, i, a = this.animations, r = 0;
                    r < a.length;
            ...
            j.extend(at.prototype, {
                          ...
                          Object.defineProperty(a, t, {
                            ...
                            value: function () {
                              var e = Array.prototype.slice.call(arguments),
                                t = i.apply(this, e);
                              return (
                                j.each(a._chartjs.listeners, function (t) {
                  ...
                  (!1 !==
                    (e =
                      i && void 0 === t
                        ...
                        : ((t = t || 0),
                          this._resolveDataElementOptions(n.data[t] || {}, t)))
                      .fill &&
                    null !== e.fill) ||
              ...
              _resolveDataElementOptions: function (t, e) {
                ...
                var r,
                  ...
                  d = n._config,
                  h =
                    u.options.elements[n.dataElementType.prototype._type] || {},
              ...
              i
                ...
                n.fullCircles &&
                  (function (t, e, n, i) {
                    ...
                    for (
                      i &&
                        ((n.endAngle = n.startAngle + ot),
                        st(t, n),
                        (n.endAngle = r),
                        n.endAngle === n.startAngle &&
                          n.fullCircles &&
                          ((n.endAngle += ot), n.fullCircles--)),
                        t.beginPath(),
                        t.arc(
                          n.x,
                          n.y,
                  ...
                  if (s.length) {
                    ...
                    for (
                      r.save(),
                        ...
                        r.lineWidth = dt(a.borderWidth, u.borderWidth),
            ...
            function _t(t, e, n) {
              var i,
                ...
                h =
                  ...
                  a &&
                    (i.horizontal
                      ? i.base > i.x && (a = xt(a, "left", "right"))
                      : i.base < i.y && (a = xt(a, "bottom", "top")),
                    (r[a] = !0)),
                  r);
              return (
                j.isObject(d)
            ...
            var kt = K.extend({
                ...
                draw: function () {
                  var t,
                    ...
                    l = s.outer,
                    u = s.inner;
                  (r.fillStyle = o.backgroundColor),
                    r.fillRect(l.x, l.y, l.w, l.h),
                    (l.w === u.w && l.h === u.h) ||
                      (r.save(),
                      r.beginPath(),
                      r.rect(l.x, l.y, l.w, l.h),
                      r.clip(),
                      (r.fillStyle = o.borderColor),
                      r.rect(u.x, u.y, u.w, u.h),
                      r.fill("evenodd"),
                      r.restore());
                },
                height: function () {
            ...
            function At(t, e, n) {
                  ...
                  ? (function (t, e) {
                      ...
                      for (a = 0, r = t.getTicks().length; a < r; ++a)
                        (i = t.getPixelForTick(a)),
                          (o = 0 < a ? Math.min(o, Math.abs(i - n)) : o),
                          (n = i);
                      return o;
                    })(e.scale, e.pixels)
                  : -1;
              return (
                (a = j.isNullOrUndef(r)
                  ? ((i = l * n.categoryPercentage), n.barPercentage)
                  : ((i = r * o), 1)),
            ...
            var Ft = rt.extend({
                ...
                initialize: function () {
                  var t,
                    e,
                    n = this;
                  rt.prototype.initialize.apply(n, arguments),
                    ...
                    f =
                      "flex" === i.barThickness
                        ? ((a = e),
                          ...
                          (u = l[a]),
                          (d = 0 < a ? l[a - 1] : null),
                          (h = a < l.length - 1 ? l[a + 1] : null),
                          (c = o.categoryPercentage),
                          null === d &&
                            (d = u - (null === h ? r.end - r.start : h - u)),
                          null === h && (h = u + u - d),
                          (s = u - ((u - Math.min(d, h)) / 2) * c),
                          {
                ...
                _resolveDataElementOptions: function () {
                  var t = j.extend(
                      {},
                      rt.prototype._resolveDataElementOptions.apply(
                        this,
                        arguments
                      )
                    ),
                  ...
                  return (
                    (t.barPercentage = Ot(e.barPercentage, t.barPercentage)),
                    (t.barThickness = Ot(e.barThickness, t.barThickness)),
                    (t.categoryPercentage = Ot(
                      e.categoryPercentage,
                      t.categoryPercentage
                    )),
                    (t.maxBarThickness = Ot(
                      e.maxBarThickness,
                      t.maxBarThickness
                    )),
                    (t.minBarLength = Ot(n.minBarLength, t.minBarLength)),
                    t
                  );
                },
              }),
            ...
            var Rt = rt.extend({
                ...
                _resolveDataElementOptions: function (t, e) {
                  var n = this,
                    ...
                    r = t.custom || {},
                    o = a.data[e] || {},
                    s = rt.prototype._resolveDataElementOptions.apply(
                      n,
                      arguments
                    ),
                    l = {
                    ...
                    return r.labels.length && r.datasets.length
                      ? r.labels.map(function (t, e) {
                          ...
                          return {
                            ...
                            hidden:
                              isNaN(r.datasets[0].data[e]) || n.data[e].hidden,
                            index: e,
                          };
                        })
                      : [];
                ...
                callbacks: {
                  ...
                  label: function (t, e) {
                    var n = e.labels[t.index],
                      i = ": " + e.datasets[t.datasetIndex].data[t.index];
                    return (
                      j.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n
                    );
                  },
                },
              },
              ...
              update: function (t) {
                ...
                if (p < Yt) {
                  var b = l.rotation % Yt,
                    ...
                    D = (b <= -zt && -zt <= y) || Nt + zt <= y,
                    C =
                      b === -Nt || Nt <= y ? -1 : Math.min(x, x * m, w, w * m),
            ...
            var Gt = rt.extend({
                ...
                _resolveDatasetElementOptions: function (t) {
                  var e,
                    ...
                    m = c.chart.options,
                    p = m.elements.line,
                    v = rt.prototype._resolveDatasetElementOptions.apply(
                      c,
                      arguments
                    );
                  return (
                    (v.spanGaps = Bt(f.spanGaps, m.spanGaps)),
                    (v.tension = Bt(f.lineTension, p.tension)),
                    (v.steppedLine = Ht([
                      g.steppedLine,
                      f.steppedLine,
                      p.stepped,
            ...
            var Zt = rt.extend({
              ...
              update: function (t) {
                ...
                for (
                  ...
                  (l[e] = s), (i = a._computeAngle(e)), (s += u[e] = i);
            ...
            var Kt = rt.extend({
              ...
              _resolveDatasetElementOptions: function () {
                var t = this._config,
                  ...
                  n = rt.prototype._resolveDatasetElementOptions.apply(
                    this,
                    arguments
                  );
                return (
                  (n.spanGaps = Xt(t.spanGaps, e.spanGaps)),
                  (n.tension = Xt(t.lineTension, e.elements.line.tension)),
                  n
                );
              },
              updateBezierControlPoints: function () {
            ...
            function he(t, e, n) {
              ...
              return (
                ...
                i !== t.w || a !== t.h
                  ? ((t.w = i), (t.h = a), n.horizontal ? i !== t.w : a !== t.h)
                  : void 0
              );
            }
            function ce(t, n) {
            ...
            function Ae(n, i, a) {
              var t,
                ...
                p = (m.resizer =
                  ...
                  Ce(r, "scroll", v.bind(r, "expand")),
                  Ce(o, "scroll", v.bind(o, "shrink")),
                  e));
              function v() {
                e._reset(), t();
              }
              (c = function () {
                if (m.resizer) {
                  var t = n.parentNode;
                  t && t !== p.parentNode && t.insertBefore(p, t.firstChild),
                    p._reset();
                }
              }),
                (f = (h = n)[be] || (h[be] = {})),
              ...
              addEventListener: function (r, t, o) {
                ...
                if ("resize" !== t) {
                  ...
                  Ce(
                    e,
                    t,
                    ((n.proxies || (n.proxies = {}))[r.id + "_" + t] =
                      function (t) {
                        var e, n, i, a;
                        o(
                          ((n = r),
                          (i = Me[(e = t).type] || e.type),
                          (a = j.getRelativePosition(e, n)),
                          Te(i, n, a.x, a.y, e))
                        );
                      })
                  );
                    ...
                    this._plugins.concat(n.plugins || []).forEach(function (t) {
                      if (-1 === i.indexOf(t)) {
                        var e = t.id,
                          n = r[e];
                        !1 !== n &&
                          (!0 === n && (n = j.clone(z.global.plugins[e])),
                          i.push(t),
              ...
              Ne = {
                ...
                getScaleDefaults: function (t) {
                  return this.defaults.hasOwnProperty(t)
                    ? j.merge({}, [z.scale, this.defaults[t]])
                    : {};
                },
            ...
            function Ve(t, e) {
              return (
                e &&
                  (j.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                t
              );
            }
            function Be(t) {
            ...
            function je(t, e) {
              ...
              return (
                ...
                j.each(e.beforeBody.concat(e.afterBody), c),
            ...
            var qe = K.extend({
                ...
                getTitle: function () {
                  var t = this._options.callbacks,
                    ...
                    a = [];
                  return (
                    (a = Ve(a, Be(e))), (a = Ve(a, Be(n))), (a = Ve(a, Be(i)))
                  );
                },
                ...
                getBody: function (t, n) {
                  ...
                  return (
                    j.each(t, function (t) {
                      ...
                      Ve(e.before, Be(a.beforeLabel.call(i, t, n))),
                        Ve(e.lines, a.label.call(i, t, n)),
                        Ve(e.after, Be(a.afterLabel.call(i, t, n))),
                        r.push(e);
                    }),
                    r
                  );
                  ...
                  if (P.length) {
                    ...
                    for (e = 0, n = P.length; e < n; ++e)
                      W.push(
                        ...
                        (y = p._index),
                        (x = p._datasetIndex),
                        (_ = p._chart.getDatasetMeta(x).controller),
                        (w = _._getIndexScale()),
                        (k = _._getValueScale()),
                        {
                    ...
                    S.filter &&
                      ...
                      j.each(W, function (t) {
                        L.push(S.callbacks.labelColor.call(M, t, M._chart)),
                          R.push(
                    ...
                    for (
                      ...
                      if (p) {
                        ...
                        (n.fillStyle = t.legendColorBackground),
                          n.fillRect(y.leftForLtr(_, c), e.y, c, c),
                          (n.lineWidth = 1),
                          (n.strokeStyle = o.borderColor),
                          n.strokeRect(y.leftForLtr(_, c), e.y, c, c),
                          (n.fillStyle = o.backgroundColor),
                          n.fillRect(
                            y.leftForLtr(y.xPlus(_, 1), c - 2),
                            e.y + 1,
                            c - 2,
                            c - 2
                          ),
                ...
                merger: function (t, e, n, i) {
                  if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                      (o = n[t][a]),
                        (r = Xe(o.type, "xAxes" === t ? "category" : "linear")),
                        a >= e[t].length && e[t].push({}),
                        !e[t][a].type || (o.type && o.type !== e[t][a].type)
                          ? j.merge(e[t][a], [Ne.getScaleDefaults(r), o])
                          : j.merge(e[t][a], o);
              ...
              return j.merge({}, [].slice.call(arguments), {
                merger: function (t, e, n, i) {
                  ...
                  "scales" === t
                    ? (e[t] = Ke(a, r))
                    : "scale" === t
                    ? (e[t] = j.merge(a, [Ne.getScaleDefaults(r.type), r]))
                    : j._merger(t, e, n, i);
                },
              });
            }
            ...
            j.extend(nn.prototype, {
              construct: function (t, e) {
                ...
                ((i = (n = (n = e) || {}).data = n.data || {}).datasets =
                  i.datasets || []),
                  (i.labels = i.labels || []),
                  (n.options = Je(z.global, z[n.type], n.options || {})),
                  (e = n);
              ...
              resize: function (t) {
                var e = this,
                  ...
                  o = Math.max(
                    0,
                    Math.floor(a ? r / a : j.getMaximumHeight(i))
                  );
                if (
              ...
              update: function (t) {
                ...
                if (
                  ...
                  (a = Je(z.global, z[i.config.type], a)),
                  ...
                  r.updateLayout(),
                    ...
                    (r.lastActive = []),
                    We.notify(r, "afterUpdate"),
                    r._layers.sort(en("z", "_idx")),
                    r._bufferedRender
                      ? (r._bufferedRequest = {
                          duration: t.duration,
                          easing: t.easing,
              ...
              updateLayout: function () {
                ...
                !1 !== We.notify(e, "beforeLayout") &&
                  ...
                  We.notify(e, "afterScaleUpdate"),
                  We.notify(e, "afterLayout"));
              },
              ...
              updateDataset: function (t) {
                var e = this.getDatasetMeta(t),
                  n = { meta: e, index: t };
                !1 !== We.notify(this, "beforeDatasetUpdate", [n]) &&
                  (e.controller._update(),
                  We.notify(this, "afterDatasetUpdate", [n]));
              },
              render: function (t) {
                var e = this;
                (t && "object" == typeof t) ||
                ...
                if (!1 !== We.notify(e, "beforeRender")) {
                  ...
                  } else e.draw(), r(new Q({ numSteps: 0, chart: e }));
                  return e;
                }
              },
              draw: function (t) {
              ...
              drawDataset: function (t, e) {
                ...
                !1 !== We.notify(this, "beforeDatasetDraw", [n]) &&
                  (t.controller.draw(e),
                  We.notify(this, "afterDatasetDraw", [n]));
              },
              _drawTooltip: function (t) {
                var e = this.tooltip,
                  n = { tooltip: e, easingValue: t };
                !1 !== We.notify(this, "beforeTooltipDraw", [n]) &&
                  (e.draw(), We.notify(this, "afterTooltipDraw", [n]));
              },
              ...
              bindEvents: function () {
                ...
                j.each(e.options.events, function (t) {
                  ...
                  e.options.responsive &&
                    ...
                    Re.addEventListener(e, "resize", i),
                    (n.resize = i));
              },
            ...
            function gn(t, e, n, i) {
                  ...
                  if (un(s))
                    for (r = 0, o = s.length; r < o; ++r)
                      (g = s[r]),
                        dn(g) ||
                          un(g) ||
                          ((c = j.measureText(t, d.data, d.gc, c, g)),
                          (f += h));
              ...
              return (
                ...
                (p = _.indexOf(Math.max.apply(null, _))),
                { first: k(0), last: k(y - 1), widest: k(m), highest: k(p) }
              );
            }
            function mn(t) {
            ...
            function bn(t) {
              var e = vn(t, t.minor);
              return { minor: e, major: t.major.enabled ? vn(t, t.major) : e };
            }
            function yn(t) {
              var e,
                n,
            ...
            var wn = K.extend({
              ...
              calculateTickRotation: function () {
                ...
                !s.isHorizontal()
                  ...
                  : ((e = (t = s._getLabelSizes()).widest.width),
                    ...
                    (a = l.offset ? s.maxWidth / d : i / (d - 1)) < e + 6 &&
              ...
              fit: function () {
                var t = this,
                  ...
                  u = t.isHorizontal();
                if (
                  (u ? (e.width = t.maxWidth) : s && (e.width = mn(o) + pn(r)),
                  u
                    ? s && (e.height = mn(o) + pn(r))
                ...
                return (
                  (a = un(t)
                    ? ((e = +this.getRightValue(t[0])),
                      ...
                      (i = Math.min(e, n)),
                      Math.max(e, n))
                    : ((e = void 0), (i = n = t = +this.getRightValue(t)))),
              ...
              _autoSkip: function (t) {
                ...
                if (((i = xn(l, t, 0, s)), 0 < u)) {
                  ...
                  return (
                    (a = 1 < u ? (h - d) / (u - 1) : null),
                    _n(t, i, j.isNullOrUndef(a) ? 0 : d - a, d),
                    _n(t, i, h, j.isNullOrUndef(a) ? t.length : h + a),
                    yn(t)
                  );
                }
                return _n(t, i), yn(t);
              ...
              _computeGridLineItems: function (t) {
                ...
                for (
                  ...
                  (a = D[i] || {}),
                    (dn(a.label) && i < D.length) ||
                      ((b =
                        i === y.zeroLineIndex && _.offset === M
                          ? ((m = w.zeroLineWidth),
                            (p = w.zeroLineColor),
                            (v = w.zeroLineBorderDash || []),
                            w.zeroLineBorderDashOffset || 0)
                          : ((m = cn(w.lineWidth, i, 1)),
                            (p = cn(w.color, i, "rgba(0,0,0,0.1)")),
                            (v = w.borderDash || []),
                            w.borderDashOffset || 0)),
                      void 0 !== (r = fn(y, a._index || i, M)) &&
                        ((o = F(x, r, m)),
                        S ? (s = u = h = f = o) : (l = d = c = g = o),
                        T.push({
                          tx1: s,
                          ty1: l,
                          tx2: u,
              ...
              _computeLabelItems: function () {
                ...
                for (
                  o =
                    "top" === m
                      ? ((r = c.bottom - _ - x), w ? "left" : "center")
                      : "bottom" === m
                      ? ((r = c.top + _ + x), w ? "right" : "center")
                      : "left" === m
                      ? ((a = c.right - (p ? 0 : _) - x), p ? "left" : "right")
                      : ((a = c.left + (p ? 0 : _) + x), p ? "right" : "left"),
                    t = 0,
                    e = b.length;
                  t < e;
                  ++t
              ...
              _drawLabels: function () {
                ...
                if (t.options.ticks.display) {
                  var e,
                    ...
                    u = t.ctx,
                    d =
                      t._labelItems || (t._labelItems = t._computeLabelItems());
              ...
              _drawTitle: function () {
                ...
                if (i.display) {
                  var a,
                    r,
                    o = hn(i.fontColor, z.global.defaultFontColor),
              ...
              _getMatchingVisibleMetas: function (e) {
                ...
                return n.chart
                  ...
                  .filter(function (t) {
                    return (
                      (!e || t.type === e) &&
                      (i ? t.xAxisID === n.id : t.yAxisID === n.id)
                    );
                  });
              },
            });
              ...
              Sn = kn.extend({
                ...
                _configure: function () {
                  var t = this,
                    e = t.options.offset,
                    n = t.ticks;
                  kn.prototype._configure.call(t),
            ...
            var Tn = kn.extend({
                getRightValue: function (t) {
                  return "string" == typeof t
                    ? +t
                    : kn.prototype.getRightValue.call(this, t);
                },
                ...
                buildTicks: function () {
                  var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                      ...
                      u < (r = Math.ceil(g / m) - Math.floor(f / m)) &&
                        (m = j.niceNum((r * m) / u / l) * l),
                        s || Pn(c)
                        ...
                        (a = Math.ceil(g / m) * m),
                        s &&
                          (!Pn(d) && j.almostWhole(d / m, m / 1e3) && (i = d),
                          !Pn(h) && j.almostWhole(h / m, m / 1e3) && (a = h)),
                        (r = (a - i) / m),
                        (r = j.almostEquals(r, Math.round(r), m / 1e3)
                          ? Math.round(r)
                          : Math.ceil(r)),
                        (i = Math.round(i * n) / n),
                        (a = Math.round(a * n) / n),
                ...
                _configure: function () {
                  var t,
                    ...
                    i = e.min,
                    a = e.max;
                  kn.prototype._configure.call(e),
                    e.options.offset &&
                      n.length &&
              ...
              On = {
                position: "left",
                ticks: { callback: ln.formatters.linear },
              };
            function An(t, e, n, i) {
              var a,
                r,
                ...
                c =
                  ...
                  (s = [
                    (o = n).type,
                    void 0 === r && void 0 === o.stack ? o.index : "",
                    o.stack,
                  ].join(".")),
                  void 0 === a[s] && (a[s] = { pos: [], neg: [] }),
                  a[s]),
                f = c.pos,
                g = c.neg,
                m = i.length;
            ...
            var Nn = {
              position: "left",
              ticks: { callback: ln.formatters.logarithmic },
            };
            function Yn(t, e) {
            ...
            var zn = kn.extend({
                determineDataLimits: function () {
                  ...
                  (o.min = j.isFinite(o.min) ? o.min : null),
                    ...
                    (o.minNotZero = j.isFinite(o.minNotZero)
                      ? o.minNotZero
                      : null),
                ...
                handleTickRangeOptions: function () {
                  var t = this,
                    e = t.options.ticks;
                  (t.min = Yn(e.min, t.min)),
                    (t.max = Yn(e.max, t.max)),
                    t.min === t.max &&
                      (0 !== t.min && null !== t.min
                        ? ((t.min = Math.pow(10, Math.floor(Wn(t.min)) - 1)),
                          (t.max = Math.pow(10, Math.floor(Wn(t.max)) + 1)))
                        : ((t.min = 1), (t.max = 10))),
                    null === t.min &&
                      (t.min = Math.pow(10, Math.floor(Wn(t.max)) - 1)),
                    null === t.max &&
                      (t.max =
                        0 !== t.min
                          ? Math.pow(10, Math.floor(Wn(t.min)) + 1)
                          : 10),
                    null === t.minNotZero &&
                      (0 < t.min
                        ? (t.minNotZero = t.min)
                        : t.max < 1
                        ? (t.minNotZero = Math.pow(10, Math.floor(Wn(t.max))))
                        : (t.minNotZero = 1));
                },
                buildTicks: function () {
                  var t = this,
                ...
                convertTicksToLabels: function () {
                  (this.tickValues = this.ticks.slice()),
                    kn.prototype.convertTicksToLabels.call(this);
                },
                getLabelForIndex: function (t, e) {
                  return this._getScaleLabel(
                    this.chart.data.datasets[e].data[t]
                ...
                _configure: function () {
                  ...
                  kn.prototype._configure.call(t),
                    0 === e &&
                      ...
                      (n =
                        Rn(t.options.ticks.fontSize, z.global.defaultFontSize) /
                        t._length)),
                    (t._startValue = Wn(e)),
                    (t._valueOffset = n),
                    (t._valueRange = (Wn(t.max) - Wn(e)) / (1 - n));
                },
                getPixelForValue: function (t) {
                  var e = this,
                    n = 0;
                  return (
                    (t = +e.getRightValue(t)) > e.min &&
                      0 < t &&
                      (n =
                        (Wn(t) - e._startValue) / e._valueRange +
                        e._valueOffset),
            ...
            function Un(t) {
              ...
              return e.display && t.display
                ? Vn(e.fontSize, z.global.defaultFontSize) +
                  ...
                  if (
                    (r.pointLabels.display &&
                      (function (t) {
                        ...
                        for (
                          var h = t.chart.data.labels.length - 1;
                          0 <= h;
                          h--
                        ) {
                          var c = 0 === h ? l / 2 : 0,
                          ...
                          (r.textAlign =
                            0 === (a = p) || 180 === a
                              ...
                              : "right"),
                            (e = p),
                            (n = t._pointLabelSizes[h]),
                            (i = f),
                            90 === e || 270 === e
                              ? (i.y -= n.h / 2)
                              : (270 < e || e < 90) && (i.y -= n.h),
                            qn(r, t.pointLabels[h], f, d.lineHeight);
                        }
                        r.restore();
                      })(i),
                    o.display &&
                      j.each(i.ticks, function (t, e) {
                        0 !== e &&
                    ...
                    for (
                      a.save(),
                        ...
                        a.strokeStyle = u,
                        a.setLineDash &&
                          (a.setLineDash(Hn([s.borderDash, o.borderDash, []])),
                          (a.lineDashOffset = Hn([
                            s.borderDashOffset,
                            o.borderDashOffset,
                            0,
                ...
                _drawLabels: function () {
                  ...
                  if (a.display) {
                    ...
                    i.save(),
                      ...
                      j.each(n.ticks, function (t, e) {
                        (0 === e && !a.reverse) ||
                          ((r = n.getDistanceFromCenterForValue(
                            n.ticksAsNumbers[e]
                          )),
                          a.showLabelBackdrop &&
                            ((o = i.measureText(t).width),
                            (i.fillStyle = a.backdropColor),
                            i.fillRect(
                              -o / 2 - a.backdropPaddingX,
                              -r - s.size / 2 - a.backdropPaddingY,
                              o + 2 * a.backdropPaddingX,
            ...
            function ui(t, e) {
              ...
              return (
                null === i ||
                  (n.round && (i = +t._adapter.startOf(i, n.round))),
                i
              );
            }
            function di(t, e, n, i) {
            ...
            var ci = kn.extend({
                ...
                update: function () {
                  ...
                  return (
                    Kn("time scale", e.format, "time.format", "time.parser"),
                    Kn("time scale", e.min, "time.min", "ticks.min"),
                    Kn("time scale", e.max, "time.max", "ticks.max"),
                    j.mergeIf(e.displayFormats, n.formats()),
                    kn.prototype.update.apply(this, arguments)
                  );
                },
                getRightValue: function (t) {
                  return (
                    ...
                    (u._unit =
                      ...
                      (f.autoSkip
                        ...
                        : (function (t, e, n, i, a) {
                          ...
                          })(u, p.length, g.minUnit, u.min, u.max))),
                    (u._majorUnit =
                      f.major.enabled && "year" !== u._unit
                        ? (function (t) {
                            for (
                    ...
                    (u._offsets =
                      ...
                      c.offset &&
                        ...
                        (s =
                          1 === a.length
                            ? 1 - r
                            : (si(i, "time", a[1], "pos") - r) / 2),
                        (o = si(i, "time", a[a.length - 1], "pos")),
                        (l =
                          1 === a.length
                            ? o
                            : (o - si(i, "time", a[a.length - 2], "pos")) / 2)),
                ...
                getLabelCapacity: function (t) {
                  var e = this.options.time,
                    ...
                    a = this.tickFormatFunction(
                      t,
                      0,
                      hi(this, [t], this._majorUnit),
                      i
                    ),
            ...
            function bi(t) {
              return (
                (t.el._scale || {}).getPointPositionForValue
                  ? function (t) {
                      var e,
                        n,
                        i,
            ...
            var Pi = K.extend({
                  ...
                  if (((a.font = r.string), u)) {
                    ...
                    (a.textAlign = "left"),
                      ...
                      j.each(t.legendItems, function (t, e) {
                        ...
                        (0 === e ||
                          d[d.length - 1] + n + 2 * i.padding > l.width) &&
                          ((h += o + i.padding),
                          (d[d.length - (0 < e ? 0 : 1)] = 0)),
              ...
              draw: function () {
                ...
                if (n.display) {
                  var w,
                    k = Mi(n.rtl, g.left, g.minSize.width),
                    M = g.ctx,
                    e = Di(m.fontColor, t.defaultFontColor),
                    i = j.options._parseFont(m),
                    S = i.size;
                  (M.textAlign = k.textAlign("left")),
                  ...
                  var D = Ci(m, S),
                    ...
                    T = g.isHorizontal();
                  (w = T
                    ? { x: g.left + P(x, _[0]), y: g.top + m.padding, line: 0 }
                    : {
                        x: g.left + m.padding,
                        y: g.top + P(b, y[0]),
                        line: 0,
                  ...
                  j.each(g.legendItems, function (t, e) {
                    var n = M.measureText(t.text).width,
                      ...
                      a = w.x,
                      r = w.y;
                    k.setWidth(g.minSize.width),
                      T
                        ? 0 < e &&
                          a + i + m.padding > g.left + g.minSize.width &&
                          ((r = w.y += O),
                          w.line++,
                          (a = w.x = g.left + P(x, _[w.line])))
                        : 0 < e &&
                          r + O > g.top + g.minSize.height &&
                          ((a = w.x = a + g.columnWidths[w.line] + m.padding),
                          w.line++,
                          (r = w.y = g.top + P(b, y[w.line])));
                    var o,
                      s,
                      l,
                      u,
                    ...
                    !(function (t, e, n) {
                      if (!(isNaN(D) || D <= 0)) {
                        ...
                        if (
                          ((M.fillStyle = Di(n.fillStyle, p)),
                          (M.lineCap = Di(n.lineCap, v.borderCapStyle)),
                          (M.lineDashOffset = Di(
                            n.lineDashOffset,
                            v.borderDashOffset
                          )),
                          (M.lineJoin = Di(n.lineJoin, v.borderJoinStyle)),
                          (M.lineWidth = i),
                          (M.strokeStyle = Di(n.strokeStyle, p)),
                          M.setLineDash &&
                            M.setLineDash(Di(n.lineDash, v.borderDash)),
                          m && m.usePointStyle)
                        ) {
                          ...
                          M.fillRect(k.leftForLtr(t, D), e, D, S),
                            0 !== i &&
                              M.strokeRect(k.leftForLtr(t, D), e, D, S);
                        M.restore();
                      }
                    })(f, r, t),
                      (C[e].left = k.leftForLtr(f, C[e].width)),
                      (C[e].top = r),
                      (o = f),
                      (s = r),
                      (l = t),
                      ...
                      (h = k.xPlus(o, D + d)),
                      (c = s + d),
                      M.fillText(l.text, h, c),
                      l.hidden &&
                        (M.beginPath(),
                        (M.lineWidth = 2),
                        M.moveTo(h, c),
                        M.lineTo(k.xPlus(h, u), c),
                        M.stroke()),
                      T ? (w.x += i + m.padding) : (w.y += O);
                  }),
              ...
              handleEvent: function (t) {
                ...
                (e = this._getLegendItemAt(t.x, t.y)),
                  "click" === i
                    ? e && n.onClick && n.onClick.call(this, t.native, e)
                    : (n.onLeave &&
                        e !== this._hoveredItem &&
                        (this._hoveredItem &&
                          n.onLeave.call(this, t.native, this._hoveredItem),
                        (this._hoveredItem = e)),
                      n.onHover && e && n.onHover.call(this, t.native, e));
              },
            });
            function Ti(t, e) {
            ...
            var Oi = {
                ...
                beforeUpdate: function (t) {
                  var e = t.options.legend,
                    n = t.legend;
                  e
                    ? (j.mergeIf(e, z.global.legend),
                      n ? (pe.configure(t, n, e), (n.options = e)) : Ti(t, e))
            ...
            var Fi = K.extend({
              ...
              fit: function () {
                ...
                e.display
                  ? ((t =
                      (j.isArray(e.text) ? e.text.length : 1) *
                        j.options._parseFont(e).lineHeight +
                      2 * e.padding),
                    (this.width = n.width = i ? this.maxWidth : t),
                    (this.height = n.height = i ? t : this.maxHeight))
              ...
              draw: function () {
                ...
                if (e.display) {
                  var n,
                    ...
                    h = this.bottom,
                    c = this.right;
                  (t.fillStyle = j.valueOrDefault(
                    e.fontColor,
                    z.global.defaultFontColor
                  )),
                    (t.font = r.string),
                    this.isHorizontal()
                      ? ((i = d + (c - d) / 2), (a = u + s), (n = c - d))
                      : ((i = "left" === e.position ? d + s : c - s),
                        (a = u + (h - u) / 2),
                        (n = h - u),
              ...
              Ni = {
                ...
                beforeUpdate: function (t) {
                  var e = t.options.title,
                    n = t.titleBlock;
                  e
                    ? (j.mergeIf(e, z.global.title),
                      n ? (pe.configure(t, n, e), (n.options = e)) : Ii(t, e))
            ...
            function Ei(t, e, n) {
              ...
              return s || l
                ? Math.min(s ? Yi(r, t, n) : u, l ? Yi(o, a, n) : u)
                : "none";
            }
            for (var Vi in ((Li.filler = Ri),
            (Li.legend = Wi),
            (Li.title = Ni),
            ((an.helpers = j).where = function (t, e) {
            ...
            (j._calculatePadding = function (t, e, n) {
              return -1 < (e = j.getStyle(t, e)).indexOf("%")
                ? (n * parseInt(e, 10)) / 100
                : parseInt(e, 10);
            }),
            ...
            (j.longestText = function (t, e, n, i) {
              ...
              for (o = 0; o < c; o++)
                if (null != (u = n[o]) && !0 !== j.isArray(u))
                  h = j.measureText(t, a, r, h, u);
                else if (j.isArray(u))
                  for (s = 0, l = u.length; s < l; s++)
                    null == (d = u[s]) ||
                      j.isArray(d) ||
                      (h = j.measureText(t, a, r, h, d));
              var f = r.length / 2;
              if (f > n.length) {
            ...
            (an._adapters = sn),
            (an.Animation = Q),
            (an.animationService = tt),
            (an.controllers = Jt),
            (an.DatasetController = rt),
            (an.defaults = z),
            (an.Element = K),
            (an.elements = Mt),
            (an.Interaction = re),
            ...
            (an.Ticks = ln),
            (an.Tooltip = $e),
            an.helpers.each(gi, function (t, e) {
              an.scaleService.registerScaleType(e, t, t._defaults);
            }),
            Li))
              Li.hasOwnProperty(Vi) && an.plugins.register(Li[Vi]);
            an.platform.initialize();
            var Bi = an;
            return (
              "undefined" != typeof window && (window.Chart = an),
              ((an.Chart = an).Legend = Li.legend._element),
              (an.Title = Li.title._element),
              (an.pluginService = an.plugins),
              (an.PluginBase = an.Element.extend({})),
              (an.canvasHelpers = an.helpers.canvas),
              (an.layoutService = an.layouts),
              (an.LinearScaleBase = Tn),
              an.helpers.each(
                [
                  "Bar",
                  "Bubble",
          ...
          (n = function () {
            ...
            function j(t, e) {
              ...
              for (z.lastIndex = 0; 0 <= n && z.test(t); )
                (t = t.replace(z, i)), (z.lastIndex = 0), --n;
              return t;
            }
            var U = /\d/,
              G = /\d\d/,
            ...
            var It = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split(
              "_"
            );
            function Lt(t, e) {
              var n;
            ...
            function Rt(t) {
              return null != t
                ? (Lt(this, t), c.updateOffset(this, !0), this)
                : Pt(this, "Month");
            }
            var Wt = ot;
            var Nt = ot;
            ...
            function Bt(t, e, n) {
              ...
              return (
                o < 1
                  ? (i = o + Ht((a = t.year() - 1), e, n))
                  : o > Ht(t.year(), e, n)
                  ? ((i = o - Ht(t.year(), e, n)), (a = t.year() + 1))
                  : ((a = t.year()), (i = o)),
                { week: i, year: a }
              );
            }
            ...
            function se(t) {
              var e = null;
              if (!ae[t] && void 0 !== Kn && Kn && Kn.exports)
                try {
              ...
              if (((e.abbr = t), null != ae[t]))
                ...
                if (null != ae[e.parentLocale]) i = ae[e.parentLocale]._config;
                  ...
                  if (null == (n = se(e.parentLocale)))
                    return (
                      re[e.parentLocale] || (re[e.parentLocale] = []),
                      re[e.parentLocale].push({ name: t, config: e }),
                      null
                    );
                  i = n._config;
                }
            ...
            function de(t) {
              ...
              return (function (t) {
                for (var e, n, i, a, r = 0; r < t.length; ) {
                  for (
                    e = (a = oe(t[r]).split("-")).length,
                      n = (n = oe(t[r + 1])) ? n.split("-") : null;
                    0 < e;
                ...
                n &&
                  ...
                  ((e =
                    n[mt] < 0 || 11 < n[mt]
                      ...
                      ? xt
                      : -1),
                  m(t)._overflowDayOfYear && (e < gt || pt < e) && (e = pt),
                  m(t)._overflowWeeks && -1 === e && (e = _t),
                  m(t)._overflowWeekday && -1 === e && (e = wt),
                  (m(t).overflow = e)),
                t
              );
            }
              ...
              if (!t._d) {
                ...
                for (
                  s = t,
                    ...
                    t._w &&
                      ...
                      (function (t) {
                        ...
                        if (null != (e = t._w).GG || null != e.W || null != e.E)
                          (r = 1),
                            (o = 4),
                            (n = ce(e.GG, t._a[gt], Bt(Pe(), 1, 4).year)),
                            (i = ce(e.W, 1)),
                            ((a = ce(e.E, 1)) < 1 || 7 < a) && (l = !0);
                        else {
                          (r = t._locale._week.dow), (o = t._locale._week.doy);
                          var u = Bt(Pe(), r, o);
                          (n = ce(e.gg, t._a[gt], u.year)),
                            (i = ce(e.w, u.week)),
                            null != e.d
                              ? ((a = e.d) < 0 || 6 < a) && (l = !0)
                              : null != e.e
                    ...
                    null != t._dayOfYear &&
                      ((r = ce(t._a[gt], i[gt])),
                      (t._dayOfYear > kt(r) || 0 === t._dayOfYear) &&
              ...
              if (a) {
                ...
                if (
                  ...
                  e &&
                    ...
                    ((m(i).weekdayMismatch = !0), !void (i._isValid = !1)))
                )
                  return;
                (t._a = r),
              ...
              if (t._f !== c.ISO_8601)
                if (t._f !== c.RFC_2822) {
                  ...
                  var e,
                    ...
                    h = 0;
                  for (
                    i = j(t._f, t._locale).match(Y) || [], e = 0;
                    e < i.length;
                    e++
                  )
                    (a = i[e]),
                      (n = (u.match(ut(a, t)) || [])[0]) &&
                        ...
                        (h += n.length)),
                      V[a]
                        ? (n ? (m(t).empty = !1) : m(t).unusedTokens.push(a),
                          (o = a),
                          (l = t),
                          null != (s = n) && f(ht, o) && ht[o](s, l._a, l, o))
                        : t._strict && !n && m(t).unusedTokens.push(a);
                  (m(t).charsLeftOver = d - h),
                    0 < u.length && m(t).unusedInput.push(u),
                    t._a[vt] <= 12 &&
                      !0 === m(t).bigHour &&
                      0 < t._a[vt] &&
                      (m(t).bigHour = void 0),
            ...
            function Ie(t) {
              ...
              (this._isValid = (function (t) {
                for (var e in t)
                  if (-1 === St.call(Fe, e) || (null != t[e] && isNaN(t[e])))
                    return !1;
            ...
            function ze(t, e) {
              ...
              return e._isUTC
                ? ((n = e.clone()),
                  (i =
                    (_(t) || o(t) ? t.valueOf() : Pe(t).valueOf()) -
                    n.valueOf()),
                  ...
                  : "object" == typeof r &&
                    ...
                    ((a = (function (t, e) {
                      ...
                      (e = ze(e, t)),
                        t.isBefore(e)
                          ? (n = Ge(t, e))
                          : (((n = Ge(e, t)).milliseconds = -n.milliseconds),
                            (n.months = -n.months));
                      return n;
                    })(Pe(r.from), Pe(r.to))),
                    ((r = {}).ms = a.milliseconds),
                    (r.M = a.months)),
                (i = new Ie(r)),
                Le(t) && f(t, "_locale") && (i._locale = t._locale),
                i
              );
            }
            function Ue(t, e) {
              ...
              return function (t, e) {
                ...
                return (
                  null === e ||
                    ...
                    (t = e),
                    (e = n)),
                  Ze(this, je((t = "string" == typeof t ? +t : t), e), i),
                  this
                );
              };
            }
            ...
            function Je(t) {
              ...
              return void 0 === t
                ? this._locale._abbr
                : (null != (e = de(t)) && (this._locale = e), this);
            }
            ...
            function an(t, e, n) {
              return t < 100 && 0 <= t
                ? new Date(t + 400, e, n) - en
                : new Date(t, e, n).valueOf();
            }
            function rn(t, e, n) {
              return t < 100 && 0 <= t
                ? Date.UTC(t + 400, e, n) - en
                : Date.UTC(t, e, n);
            }
            function on(t, e) {
              B(0, [t, t.length], 0, e);
            ...
            (gn.add = $e),
              (gn.calendar = function (t, e) {
                ...
                return this.format(
                  r || this.localeData().calendar(a, this, Pe(n))
                );
              }),
              (gn.clone = function () {
                return new x(this);
              ...
              (gn.diff = function (t, e, n) {
                ...
                switch (
                  ((a = 6e4 * (i.utcOffset() - this.utcOffset())), (e = I(e)))
                ) {
                  case "year":
                    r = Ke(this, i) / 12;
                    break;
              ...
              (gn.isDSTShifted = n(
                ...
                function () {
                  ...
                  if ((y(t, this), (t = De(t))._a)) {
                    ...
                    this._isDSTShifted =
                      this.isValid() && 0 < M(t._a, e.toArray());
            ...
            (pn.calendar = function (t, e, n) {
              ...
              (pn.preparse = mn),
              (pn.postformat = mn),
              (pn.relativeTime = function (t, e, n, i) {
              ...
              (pn.months = function (t, e) {
                return t
                  ? s(this._months)
                    ...
                    : this._months[
                        (this._months.isFormat || At).test(e)
                          ? "format"
                          : "standalone"
                      ][t.month()]
                  : s(this._months)
              ...
              (pn.monthsShort = function (t, e) {
                return t
                  ? s(this._monthsShort)
                    ...
                    : this._monthsShort[At.test(e) ? "format" : "standalone"][
                        t.month()
                      ]
                  : s(this._monthsShort)
                  ? this._monthsShort
              ...
              (pn.monthsRegex = function (t) {
                return this._monthsParseExact
                  ? (f(this, "_monthsRegex") || Yt.call(this),
                    t ? this._monthsStrictRegex : this._monthsRegex)
                  : (f(this, "_monthsRegex") || (this._monthsRegex = Nt),
              ...
              (pn.weekdaysRegex = function (t) {
                return this._weekdaysParseExact
                  ? (f(this, "_weekdaysRegex") || Kt.call(this),
            ...
            return (
              ...
              ($n.as = function (t) {
                ...
                if ("month" === (t = I(t)) || "quarter" === t || "year" === t)
                  ...
                  switch (
                    ((e = this._days + Math.round(Mn(this._months))), t)
                  ) {
                    case "week":
                      return e / 7 + i / 6048e5;
                    case "day":
              ...
              (c.updateLocale = function (t, e) {
                if (null != e) {
                  var n,
                    i,
                    a = ie;
                  null != (i = se(t)) && (a = i._config),
                    ((n = new O((e = T(a, e)))).parentLocale = ae[t]),
                    (ae[t] = n),
                    le(t);
                } else
                  null != ae[t] &&
            ...
            var e,
              ...
              i = new a.default(t, {
                ...
                options: {
                  legend: { display: !1 },
                  elements: {
                    point: { borderColor: "rgba(0,0,0,0)", hoverRadius: 0 },
                  },
                  animation: {
                    onComplete: function () {
                      e && clearTimeout(e),
                  ...
                  scales: {
                    xAxes: [{ display: !1, ticks: n }],
                    yAxes: [{ display: !1, ticks: n }],
                  },
                },
              });
          });
        var i,
          a = (i = t("chart.js")) && i.__esModule ? i : { default: i },
          r = t("../colours.js");
        function o() {
          return (
            (0.5 < Math.random() ? 1 : -1) * Math.round(85 * Math.random())
          );
        }
        var s = function (t) {
            for (
              var e,
                n = [],
                i = (0 < arguments.length && void 0 !== t ? t : 10) - 1;
              0 <= i;
              i--
            )
              n.push(((e = Math.abs(o()) / 5), { x: o(), y: o(), r: e }));
            return n;
          },
          l = function (t) {
          ...
          d = [
            { backgroundColor: r.grey, data: s() },
            { backgroundColor: r.red, data: s() },
            { backgroundColor: r.blue, data: s() },
            { backgroundColor: r.yellow, data: s() },
            { backgroundColor: r.green, data: s() },
          ];
      },
      { "../colours.js": 7, "chart.js": 1 },
    ],
    4: [
      function (t, e, n) {
        "use strict";
                ...
                datasets: [
                  {
                    ...
                    backgroundColor: e.alpha(0.5).rgbaString(),
                      ...
                      ticks: {
                        userCallback: function (t) {
                          var e =
                            ...
                            Math.pow(
                              10,
                              Math.floor(a.default.helpers.log10(t))
                            );
    ...
    5: [
      function (t, e, n) {
        ...
        var i,
          l = (i = t("chart.js")) && i.__esModule ? i : { default: i };
      },
      { "chart.js": 1 },
    ],
    6: [
          ...
          (n.default = function (t) {
            var e = {
                ...
                datasets: [
                  ...
                  {
                    type: "line",
                    backgroundColor: a.default.helpers
                      .color(r.yellow)
                      .alpha(0.5)
                      .rgbaString(),
                    data: [l(), l(), l(), l(), l(), l(), l()],
                    borderColor: a.default.helpers
                      .color(r.yellow)
                      .alpha(1)
                      .rgbaString(),
                    borderWidth: 1,
                    pointBorderColor: a.default.helpers
                      .color(r.yellow)
                      .alpha(1)
                      .rgbaString(),
                    pointBorderWidth: 2,
              ...
              n = a.default.helpers.color(r.grey).alpha(0.5).rgbaString(),
              ...
              options: {
                ...
                scales: {
                  xAxes: [
                    {
                      barPercentage: 0.75,
                      gridLines: { color: n, zeroLineColor: i },
                    },
                  ],
                  yAxes: [
                    {
    ...
    8: [
      function (t, e, n) {
        ...
        ((i.default.defaults.global.tooltips.enabled = !1), a.default)(
          document.getElementById("background-bar").getContext("2d")
        ),
          (0, r.default)(
            document.getElementById("mixed-chart").getContext("2d")
          ),
          (0, o.default)(
            document.getElementById("axis-chart").getContext("2d")
          ),
          (0, s.default)(
            document.getElementById("animate-chart").getContext("2d")
          );
      },
      {
