...
!(function (t, e) {
      ...
      switch ((t.beginPath(), c)) {
        ...
        case "rectRounded":
          (l = 0.516 * d),
            ...
            (s = Math.cos(u + kt) * r),
            (a = Math.sin(u + kt) * r),
            t.arc(i - s, n - a, l, u - bt, u - wt),
            t.arc(i + a, n - s, l, u - wt, u),
            t.arc(i + s, n + a, l, u, u + wt),
            t.arc(i - a, n + s, l, u + wt, u + bt),
            t.closePath();
          break;
        case "rect":
          if (!h) {
  ...
  function ne(t, e) {
    ...
    t.arc(i + a.topLeft, n + a.topLeft, a.topLeft, -wt, bt, !0),
      t.lineTo(i, n + s - a.bottomLeft),
      t.arc(i + a.bottomLeft, n + s - a.bottomLeft, a.bottomLeft, bt, wt, !0),
  ...
  class Ei {
    ...
    _resolveAnimations(t, e, i) {
      ...
      const c = new Mi(o, l && l.animations);
  ...
  function Fi(t, e, i) {
    return (function (t, e) {
      ...
      let n = zi.get(i);
      return n || ((n = new Intl.NumberFormat(t, e)), zi.set(i, n)), n;
    })(e, i).format(t);
  }
  const Vi = {
    values: (t) => (Y(t) ? t : "" + t),
  ...
  class qi extends Ii {
    ...
    _computeLabelItems(t) {
      ...
      let x,
        ...
        C,
        O = "middle";
      if ("top" === o) (M = e.bottom - g), (w = e._getXAxisLabelAlignment());
      else if ("bottom" === o)
        (M = e.top + g), (w = e._getXAxisLabelAlignment());
      else if ("left" === o) {
        ...
        w = e._getYAxisLabelAlignment(u).textAlign;
      }
      "y" === i &&
  ...
  var Ln = new (class {
    constructor() {
      (this.controllers = new An(Ei, "datasets", !0)),
        (this.elements = new An(Ii, "elements")),
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || zn(a, t.options)),
          (s.order = o.order || 0),
          (s.index = n),
          (s.label = "" + o.label),
  ...
  Object.defineProperties(eo, {
    ...
    version: { enumerable: no, value: "3.3.1" },
  ...
  function ko(t, e, i, n, o) {
    ...
    const g = (f - Math.max(0.001, f * h - i / bt) / h) / 2,
      ...
      D = p + _ / S,
      C = m - y / P;
    if ((t.beginPath(), t.arc(s, a, h, w, k), b > 0)) {
      const e = wo(M, k, s, a);
      t.arc(e.x, e.y, b, k, m + wt);
    }
    const O = wo(P, m, s, a);
    if ((t.lineTo(O.x, O.y), y > 0)) {
      const e = wo(P, C, s, a);
      t.arc(e.x, e.y, y, m + wt, C + Math.PI);
    }
    if ((t.arc(s, a, d, m - y / d, p + _ / d, !0), _ > 0)) {
      const e = wo(S, D, s, a);
      t.arc(e.x, e.y, _, D + Math.PI, p - wt);
    }
    const T = wo(v, p, s, a);
    if ((t.lineTo(T.x, T.y), x > 0)) {
      const e = wo(v, w, s, a);
      t.arc(e.x, e.y, x, p - wt, w);
    }
    t.closePath();
  }
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        const { _data: s, indexAxis: a } = e,
          ...
          l = s || e.data;
        if ("y" === Be([a, t.options.indexAxis])) return;
  ...
  function es(t) {
    ...
    return new Io({ points: s, options: {} });
  }
  ...
  function ss(t, e) {
    ...
    return (
      ...
      i.length
        ? new Io({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function as(t, e, i) {
  ...
  class ms extends Ii {
    ...
    _draw() {
      ...
      t.legendItems.forEach((w, k) => {
        (a.strokeStyle = w.fontColor || u), (a.fillStyle = w.fontColor || u);
        const S = a.measureText(w.text).width,
          P = h.textAlign(w.textAlign || (w.textAlign = l.textAlign)),
          D = x + p + S;
        let C = m.x,
          O = m.y;
        h.setWidth(t.width),
  ...
  function Ps(t, e, i) {
    ...
    return { xAlign: e.xAlign || Ss(t, e, i, n), yAlign: n };
  }
  function Ds(t, e, i, n) {
  ...
  class As extends Ii {
    ...
    getTitle(t, e) {
      ...
      let r = [];
      return (r = vs(r, Ms(o))), (r = vs(r, Ms(s))), (r = vs(r, Ms(a))), r;
    }
    getBeforeBody(t, e) {
      return Os(e.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t, e) {
      const i = this,
        { callbacks: n } = e,
      ...
      return (
        J(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            s = Ts(n, t);
          vs(e.before, Ms(s.beforeLabel.call(i, t))),
            vs(e.lines, s.label.call(i, t)),
            vs(e.after, Ms(s.afterLabel.call(i, t))),
            o.push(e);
        }),
        o
      );
    ...
    getAfterBody(t, e) {
      return Os(e.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t, e) {
      const i = this,
        { callbacks: n } = e,
    ...
    update(t, e) {
      ...
      let s,
        a = [];
      if (o.length) {
        const t = ys[n.position].call(i, o, i._eventPosition);
        (a = i._createItems(n)),
    ...
    _updateAnimationTarget(t) {
      const e = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = ys[t.position].call(e, e._active, e._eventPosition);
        if (!n) return;
        const a = (e._size = ks(e, t)),
  ...
  var Ls = {
      ...
      positioners: ys,
      afterInit(t, e, i) {
        i && (t.tooltip = new As({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
      ...
      return ((t, e) =>
        null === t
          ...
          : Ht(
              ...
              0,
              e
            ))((e = isFinite(e) && i[e] === t ? e : Es(i, t, K(e, t))), i.length - 1);
    }
    determineDataLimits() {
      const t = this,
  ...
  function zs(t, e, { horizontal: i, minRotation: n }) {
    const o = Et(n),
      ...
      const o = (function (t, e) {
        ...
        (w = Math.ceil(p / k) - Math.floor(g / k)),
          ...
          m && x && o && Lt((a - s) / o, k / 1e3)
            ? ((w = Math.min((a - s) / k, c)),
              ...
              (M = a))
            : b
            ? ((v = m ? s : v), (M = x ? a : M), (w = l - 1), (k = (M - v) / w))
            : ((w = (M - v) / k),
              (w = At(w, Math.round(w), k / 1e3)
                ? Math.round(w)
                : Math.ceil(w)));
        ...
        for (
          ...
          (d && v !== s
            ? (i.push({ value: s }),
              v < s && P++,
              At(Math.round((v + P * k) * y) / y, s, zs(s, _, t)) && P++)
            : v < s && P++);
          P < w;
          ++P
        )
        ...
        return (
          x && d && M !== a
            ? At(i[i.length - 1].value, a, zs(a, _, t))
  ...
  (Vs.id = "linear"),
    (Vs.defaults = { ticks: { callback: Bi.formatters.numeric } });
  class Ws extends qi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    parse(t, e) {
      const i = Fs.prototype.parse.apply(this, [t, e]);
  ...
  function js(t) {
    ...
    for (let c = 0; c < s; c++) {
      ...
      const f = t.getIndexAngle(c),
        g = It(f),
        p = Hs(g, h.x, u.w, 0, 180),
        m = Hs(g, h.y, u.h, 90, 270);
  ...
  class Ks extends Fs {
    ...
    computeTickLimit() {
      return Math.ceil(this.drawingArea / Ns(this.options));
    }
    generateTickLabels(t) {
      const e = this;
      Fs.prototype.generateTickLabels.call(e, t),
    ...
    fit() {
      const t = this,
        e = t.options;
      e.display && e.pointLabels.display ? js(t) : t.setCenterPoint(0, 0, 0, 0);
    }
  ...
  function ta(t, e, i, n) {
    const o = Zs.length;
    for (let s = Zs.indexOf(t); s < o - 1; ++s) {
      const t = Gs[Zs[s]],
        o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Zs[s];
    }
    return Zs[o - 1];
  }
  function ea(t, e, i) {
  ...
  class na extends qi {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? ta(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = Zs.length - 1; s >= Zs.indexOf(i); s--) {
                  const i = Zs[s];
                  if (Gs[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || ta(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = K(s.stepSize, 1),
      ...
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) ea(h, d, g);
      return (
        (d !== n && "ticks" !== o.bounds && 1 !== u) || ea(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, ia(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
  ...
  class sa extends na {
    ...
    getValueForPixel(t) {
      const e = this,
        i = e._offsets,
        n = e.getDecimalForPixel(t) / i.factor - i.end;
      return oa(e._table, n * this._maxIndex, !0);
    }
  }
  (sa.id = "timeseries"), (sa.defaults = na.defaults);
  ...
  return (
    ...
    (eo.Scale = qi),
    (eo.Ticks = Bi),
    Object.assign(eo, yo, aa, Xo, Rs, fi),
    (eo.Chart = eo),
