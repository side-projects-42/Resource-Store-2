...
!(function (t, e) {
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._total += s),
          (n._loop = !!t.loop),
          (n._to = Fe([t.to, e, o, t.from])),
          (n._from = Fe([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  const Fi = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i);
  function Ii(t, e) {
    const i = [],
      n = t.length / e,
      o = t.length;
  ...
  class Ni extends Oi {
    ...
    update(t, e, i) {
      ...
      n._convertTicksToLabels(a ? Ii(n.ticks, s) : n.ticks),
        n.configure(),
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            Vi(e.grid) -
            i.padding -
            Bi(e.title, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = Et(
            Math.min(
    ...
    fit() {
      const t = this,
        ...
        r = t.isHorizontal();
      if (a) {
        const a = Bi(o, i.options.font);
        if (
          (r
            ? ((e.width = t.maxWidth), (e.height = Vi(s) + a))
            : ((e.height = t.maxHeight), (e.width = Vi(s) + a)),
    ...
    _autoSkip(t) {
      ...
      if (o > 0) {
        ...
        for (Wi(t, r, l, $(c) ? 0 : s - c, s), e = 0, i = o - 1; e < i; e++)
          Wi(t, r, l, n[e], n[e + 1]);
        return Wi(t, r, l, a, $(c) ? t.length : a + c), r;
      }
      return Wi(t, r, l), r;
    }
    _tickSize() {
    ...
    _layers() {
      const t = this,
        ...
        n = (e.grid && e.grid.z) || 0;
      return t._isVisible() && i !== n && t.draw === Ni.prototype.draw
        ? [
            {
              z: n,
              draw(e) {
      ...
      get: (i, n) =>
        qi(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e)
              if (((o = tn(Ui(s, t), i)), ht(o)))
                return Xi(t, o) ? Qi(i, n, t, o) : o;
          })(n, e, t, i)
        ),
      getOwnPropertyDescriptor: (t, e) =>
        Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
      getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
      has: (t, e) => en(t).includes(e),
      ownKeys: (t) => en(t),
  ...
  function $i(t, e, i, n) {
    const o = {
      ...
      _stack: new Set(),
      _descriptors: Yi(t, n),
      setContext: (e) => $i(t, e, i, n),
      override: (o) => $i(t.override(o), e, i, n),
    };
    return new Proxy(o, {
            ...
            Y(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (ht(s.index) && n(t)) e = e[s.index % e.length];
                  ...
                  for (const l of i) {
                    const i = Qi(n, o, t, l);
                    e.push($i(i, s, a && a[t], r));
                  }
                }
                return e;
              })(e, r, t, a.isIndexable));
            Xi(e, r) && (r = $i(r, o, s && s[e], a));
            return r;
          })(t, e, i)
        ),
  ...
  const Ui = (t, e) => (t ? t + ct(e) : e),
    Xi = (t, e) => U(e) && "adapters" !== t;
  function qi(t, e, i) {
    let n = t[e];
  ...
  function Qi(t, e, i, n) {
    const o = e._rootScopes,
      s = Ki(e._fallback, i, n),
      a = [...t, ...o],
      r = new Set([n]);
    let l = Ji(r, a, i, s || i);
    return (
      null !== l &&
      (!ht(s) || s === i || ((l = Ji(r, a, s, l)), null !== l)) &&
      ji([...r], [""], o, s)
    );
  }
  function Ji(t, e, i, n) {
  ...
  const nn = Number.EPSILON || 1e-14,
    on = (t, e) => e < t.length && !t[e].skip && t[e];
  function sn(t, e, i, n) {
    const o = t.skip ? e : t,
      s = e,
      a = i.skip ? e : i,
    ...
    !(function (t, e, i) {
      ...
      (function (t, e) {
        ...
        let n,
          ...
          a = on(t, 0);
        for (let r = 0; r < i; ++r) {
          if (((o = s), (s = a), (a = on(t, r + 1)), !s)) continue;
          const { x: i, y: l } = s;
  ...
  function ln(t, e, i, n) {
    ...
    if (
      ...
      for (o = 0, s = t.length; o < s; ++o)
        (a = t[o]),
          (r = sn(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension)),
          (a.cp1x = r.previous.x),
          (a.cp1y = r.previous.y),
          (a.cp2x = r.next.x),
          (a.cp2y = r.next.y),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a &&
                ((o.cp1x = rn(o.cp1x, e.left, e.right)),
                (o.cp1y = rn(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = rn(o.cp2x, e.left, e.right)),
                (o.cp2y = rn(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function cn(t, e, i, n) {
  ...
  function xn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i,
      a = e.length,
      { compare: r, between: l, normalize: c } = pn(n),
      {
        start: h,
        end: d,
        loop: u,
    ...
    for (let t = h, i = h; t <= d; ++t)
      (p = e[t % a]),
        p.skip ||
          ...
          null !== b && y() && (f.push(mn(b, t, u, a)), (b = null)),
          (i = t),
          (m = g));
    return null !== b && f.push(mn(b, d, u, a)), f;
  }
  function bn(t, e) {
    const i = [],
      n = t.segments;
    for (let o = 0; o < n.length; o++) {
      const s = xn(n[o], t.points, e);
      s.length && i.push(...s);
    }
    return i;
  }
  ...
  var yn = Object.freeze({
    ...
    _descriptors: Yi,
    splineCurve: sn,
    splineCurveMonotone: an,
    _updateBezierControlPoints: ln,
    _getParentNode: ce,
    getStyle: ue,
    ...
    _textX: s,
    _pointInLine: cn,
    _steppedInterpolation: hn,
    _bezierInterpolation: dn,
    formatNumber: Li,
    toLineHeight: Ae,
    toTRBL: Te,
    toTRBLCorners: Le,
    ...
    _int16Range: Nt,
    getRtlAdapter: un,
    overrideTextDirection: fn,
    restoreTextDirection: gn,
    _boundSegment: xn,
    _boundSegments: bn,
    _computeSegments: _n,
  });
  ...
  var Mn = new (class {
    constructor() {
      (this.controllers = new vn(Ai, "datasets", !0)),
        (this.elements = new vn(Oi, "elements")),
        (this.plugins = new vn(Object, "plugins")),
        (this.scales = new vn(Ni, "scales")),
  ...
  class wn {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config,
        ...
        o = (function (t) {
          const e = [],
            i = Object.keys(Mn.plugins.items);
          for (let t = 0; t < i.length; t++) e.push(Mn.getPlugin(i[t]));
          const n = t.plugins || [];
        ...
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = kn(i[r.id], n);
              null !== l &&
                o.push({ plugin: r, options: Sn(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  function Tn(t, e) {
    let i = An.get(t);
    return i || ((i = e()), An.set(t, i), On.add(i)), i;
  }
  const Ln = (t, e, i) => {
    const n = lt(e, i);
    void 0 !== n && t.add(n);
  ...
  class Rn {
    constructor(t) {
      (this._config = (function (t) {
        ...
        return (
          (e.datasets = e.datasets || []), (e.labels = e.labels || []), Cn(t), t
        );
      })(t)),
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set();
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => Ln(r, t, e))),
          e.forEach((t) => Ln(r, n, t)),
          e.forEach((t) => Ln(r, ut[o] || {}, t)),
          e.forEach((t) => Ln(r, mt, t)),
          e.forEach((t) => Ln(r, ft, t));
      });
      const l = [...r];
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = En(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
        ...
        o.$shared = !1;
        r = $i(s, (i = dt(i) ? i() : i), this.createResolver(t, i, a));
      }
      for (const t of e) o[t] = r[t];
      return o;
    }
    createResolver(t, e, i = [""], n) {
      const { resolver: o } = En(this._resolverCache, t, i);
      return U(e) ? $i(o, e, void 0, n) : o;
    }
  }
  function En(t, e, i) {
    let n = t.get(e);
  ...
  class $n {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (Nn[n.id] = n),
        l && c
          ? (a.listen(n, "complete", Vn),
            a.listen(n, "progress", Bn),
            n._initialize(),
            n.attached && n.update())
          : console.error(
      ...
      i &&
        ...
        J(s, (i) => {
          const s = i.options,
            ...
            r = Dn(a, s),
            l = K(s.type, i.dtype);
          (void 0 !== s.position && In(s.position, r) === In(i.dposition)) ||
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || Pn(a, t.options)),
          (s.order = o.order || 0),
          ...
          const i = Mn.getController(a),
            { datasetElementType: o, dataElementType: r } = mt.datasets[a];
          Object.assign(i.prototype, {
            dataElementType: Mn.getElement(r),
            datasetElementType: o && Mn.getElement(o),
          }),
  ...
  const Yn = () => J($n.instances, (t) => t._plugins.invalidate()),
    Un = !0;
  function Xn() {
    throw new Error(
  ...
  Object.defineProperties($n, {
    defaults: { enumerable: Un, value: mt },
    instances: { enumerable: Un, value: Nn },
    overrides: { enumerable: Un, value: ut },
    registry: { enumerable: Un, value: Mn },
    version: { enumerable: Un, value: "3.0.0-rc.2" },
    getChart: { enumerable: Un, value: jn },
    register: {
      enumerable: Un,
      value: (...t) => {
        Mn.add(...t), Yn();
  ...
  var lo = Object.freeze({
    ...
    BarController: to,
    BubbleController: eo,
    DoughnutController: io,
    LineController: no,
    PolarAreaController: oo,
    PieController: so,
    RadarController: ao,
    ScatterController: ro,
  });
  function co(t, e) {
    const {
      startAngle: i,
  ...
  class fo extends Oi {
    ...
    inRange(t, e, i) {
      const n = this.getProps(["x", "y"], i),
        { angle: o, distance: s } = It(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      ...
      if (
        ...
        (t.fillStyle = i.backgroundColor),
          ...
          (function (t, e) {
            if (e.fullCircles) {
              (e.endAngle = e.startAngle + bt), ho(t, e);
  ...
  function mo(t, e, i, n) {
    const { points: o, options: s } = e,
      { count: a, start: r, loop: l, ilen: c } = po(o, i, n),
      h = (function (t) {
        return t.stepped ? Qt : t.tension ? Jt : go;
      })(s);
    let d,
      u,
      f,
  ...
  function xo(t, e, i, n) {
    const o = e.points,
      { count: s, start: a, ilen: r } = po(o, i, n),
  ...
  function bo(t) {
    ...
    return !(t._decimated || t._loop || e.tension || e.stepped || i) ? xo : mo;
  }
  (fo.id = "arc"),
    (fo.defaults = {
      borderAlign: "center",
    ...
    (fo.defaultRoutes = { backgroundColor: "backgroundColor" });
  const _o =
  ...
  class yo extends Oi {
    ...
    updateControlPoints(t) {
      ...
      if (i.tension && !i.stepped && !e._pointsUpdated) {
        ...
        ln(e._points, i, t, n), (e._pointsUpdated = !0);
      }
    }
    set points(t) {
      const e = this;
    ...
    get segments() {
      return this._segments || (this._segments = _n(this));
    }
    first() {
    ...
    interpolate(t, e) {
      const i = this,
        ...
        o = t[e],
        s = i.points,
        a = bn(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [],
        l = (function (t) {
          return t.stepped ? hn : t.tension ? dn : cn;
        })(n);
      let c, h;
    ...
    const e = wo(t),
      ...
      o = (function (t, e, i) {
        const n = t.options.borderWidth,
          ...
          s = Te(n);
        return {
          t: Do(o.top, s.top, 0, i),
          r: Do(o.right, s.right, 0, e),
          b: Do(o.bottom, s.bottom, 0, i),
          l: Do(o.left, s.left, 0, e),
        };
      })(t, i / 2, n / 2),
      s = (function (t, e, i) {
        const n = Le(t.options.borderRadius),
          ...
          s = ko(t);
        return {
          topLeft: Do(s.top || s.left, n.topLeft, 0, o),
          topRight: Do(s.top || s.right, n.topRight, 0, o),
          bottomLeft: Do(s.bottom || s.left, n.bottomLeft, 0, o),
          bottomRight: Do(s.bottom || s.right, n.bottomRight, 0, o),
        };
      })(t, i / 2, n / 2);
    return {
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        const { _data: s, indexAxis: a } = e,
          ...
          l = s || e.data;
        if ("y" === Fe([a, t.options.indexAxis])) return;
    ...
    const { chart: e, scale: i, index: n, line: o } = t,
      ...
      l = (function (t, e) {
        ...
        for (let t = 0; t < n.length; t++) {
          const o = n[t];
          if (o.index === e) break;
          Bo(o) && i.unshift(o.dataset);
        }
        return i;
      })(e, n);
    l.push(No({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) Wo(s, r[t], l);
    }
    return new yo({ points: s, options: {} });
  }
  const Bo = (t) => "line" === t.type && !t.hidden;
  function Wo(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = Ho(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function No(t, e) {
    ...
    return (
      ...
      i.length
        ? new yo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function jo(t, e, i) {
  ...
  function Ko(t, e) {
    const { line: i, target: n, property: o, color: s, scale: a } = e,
      r = (function (t, e, i) {
        ...
        for (let t = 0; t < n.length; t++) {
          const r = n[t],
            l = Yo(i, o[r.start], o[r.end], r.loop);
          if (!e.segments) {
          ...
          for (let t = 0; t < c.length; ++t) {
            const e = c[t],
              n = Yo(i, s[e.start], s[e.end], e.loop),
              h = xn(r, o, n);
            for (let t = 0; t < h.length; t++)
              a.push({
                source: h[t],
                target: e,
                start: { [i]: Uo(l, n, "start", Math.max) },
                end: { [i]: Uo(l, n, "end", Math.min) },
              });
          }
        }
        return a;
    ...
    for (let e = 0, s = r.length; e < s; ++e) {
      ...
      t.save(), Xo(t, a, Yo(o, c, h)), t.beginPath();
  ...
  var Go = {
    ...
    beforeDatasetDraw(t, e) {
      ...
      const s = (function (t) {
          ...
          if ("stack" === i) return Vo(t);
          const o = zo(t);
          return o instanceof Io ? o : No(o, n);
        })(o),
        { line: a, scale: r } = o,
        l = a.options,
        c = l.fill,
        ...
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              s !== o &&
              ($o(t, n, a.top),
              Ko(t, { line: i, target: n, color: o, scale: r, property: l }),
              t.restore(),
              t.save(),
              $o(t, n, a.bottom)),
            Ko(t, { line: i, target: n, color: s, scale: r, property: l }),
            t.restore();
  ...
  class Qo extends Oi {
    ...
    fit() {
      ...
      const n = e.labels,
        ...
        { boxWidth: r, itemHeight: l } = Zo(n, s);
      let c, h;
      (i.font = o.string),
        t.isHorizontal()
    ...
    _draw() {
      ...
      let x;
      t.drawTitle(),
        (a.textAlign = d.textAlign("left")),
        (a.textBaseline = "middle"),
        (a.lineWidth = 0.5),
        (a.strokeStyle = f),
        (a.fillStyle = f),
        (a.font = u.string);
      const { boxWidth: b, boxHeight: _, itemHeight: y } = Zo(c, p),
        v = t.isHorizontal(),
        M = this._computeTitleHeight();
      (x = v
        ? { x: o(l, t.left + g, t.right - n[0]), y: t.top + g + M, line: 0 }
        : {
            x: t.left + g,
            y: o(l, t.top + M + g, t.bottom - i[0].height),
            line: 0,
          }),
      ...
      t.legendItems.forEach((e, f) => {
        const k = a.measureText(e.text).width,
          S = d.textAlign(e.textAlign || (e.textAlign = c.textAlign)),
          P = b + p / 2 + k;
        let D = x.x,
          C = x.y;
        d.setWidth(t.width),
          v
            ? f > 0 &&
              ...
              ((C = x.y += w),
              x.line++,
              (D = x.x = o(l, t.left + g, t.right - n[x.line])))
            : f > 0 &&
              C + w > t.bottom &&
              ((D = x.x = D + i[x.line].width + g),
              x.line++,
              (C = x.y = o(l, t.top + M + g, t.bottom - i[x.line].height)));
        const A = d.x(D);
        !(function (t, e, i) {
          if (isNaN(b) || b <= 0 || isNaN(_) || _ < 0) return;
          a.save();
          const n = K(i.lineWidth, 1);
          if (
            ((a.fillStyle = K(i.fillStyle, h)),
            (a.lineCap = K(i.lineCap, "butt")),
            (a.lineDashOffset = K(i.lineDashOffset, 0)),
            (a.lineJoin = K(i.lineJoin, "miter")),
            (a.lineWidth = n),
            (a.strokeStyle = K(i.strokeStyle, h)),
            ...
            const i = e + Math.max((p - _) / 2, 0);
            a.fillRect(d.leftForLtr(t, b), i, b, _),
              0 !== n && a.strokeRect(d.leftForLtr(t, b), i, b, _);
          }
          a.restore();
        })(A, C, e),
          (r[f].left = d.leftForLtr(A, r[f].width)),
          (r[f].top = C),
          (D = s(S, D + b + m, t.right)),
          (function (t, e, i) {
            te(a, i.text, t, e + y / 2, u, {
    ...
    drawTitle() {
      const t = this,
        ...
        a = Re(i.padding);
      if (!i.display) return;
      const r = un(e.rtl, t.left, t.width),
        l = t.ctx,
        c = i.position,
        h = s.size / 2,
        d = a.top + h;
    ...
    handleEvent(t) {
      ...
      if ("mousemove" === t.type) {
        ...
        o && o !== n && Q(i.onLeave, [t, o, e], e),
          (e._hoveredItem = n),
          n && Q(i.onHover, [t, n, e], e);
  ...
  var Jo = {
    ...
    _element: Qo,
    start(t, e, i) {
      const n = (t.legend = new Qo({ ctx: t.ctx, options: i, chart: t }));
  ...
  var es = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        const i = new ts({ ctx: t.ctx, options: e, chart: t });
  ...
  function ls(t, e, i) {
    ...
    return { xAlign: e.xAlign || rs(t, e, i, n), yAlign: n };
  }
  function cs(t, e, i, n) {
  ...
  class fs extends Oi {
    ...
    getTitle(t, e) {
      ...
      let r = [];
      return (r = ns(r, os(o))), (r = ns(r, os(s))), (r = ns(r, os(a))), r;
    }
    getBeforeBody(t, e) {
      ...
      return (
        J(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            s = us(n, t);
          ns(e.before, os(s.beforeLabel.call(i, t))),
            ns(e.lines, s.label.call(i, t)),
            ns(e.after, os(s.afterLabel.call(i, t))),
            o.push(e);
        }),
        o
      );
    ...
    update(t) {
      ...
      let o,
        s = [];
      if (n.length) {
        const t = is[i.position].call(e, n, e._eventPosition);
        (s = e._createItems(i)),
    ...
    drawTitle(t, e, i) {
      ...
      let a, r, l;
      if (s) {
        const c = un(i.rtl, n.x, n.width);
        for (
          t.x = hs(n, i.titleAlign, i),
    ...
    drawFooter(t, e, i) {
      ...
      let a, r;
      if (s) {
        const l = un(i.rtl, n.x, n.width);
        for (
          t.x = hs(n, i.footerAlign, i),
    ...
    _updateAnimationTarget(t) {
      const e = this,
        ...
        s = n && n.y;
      if (o || s) {
        const n = is[t.position].call(e, e._active, e._eventPosition);
        if (!n) return;
        const a = (e._size = as(e, t)),
    ...
    _positionChanged(t, e) {
      const i = this,
        n = is[i.options.position].call(i, t, e);
  ...
  class xs extends Ni {
    ...
    parse(t, e) {
      ...
      return isFinite(e) && i[e] === t ? e : ms(i, t, K(e, t));
    }
    determineDataLimits() {
      const t = this,
  ...
  (xs.id = "category"),
    (xs.defaults = { ticks: { callback: xs.prototype.getLabelForValue } });
  class bs extends Ni {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    getLabelForValue(t) {
      return Li(t, this.options.locale);
    }
  }
  class _s extends bs {
    determineDataLimits() {
  ...
  (_s.id = "linear"),
    (_s.defaults = { ticks: { callback: Ei.formatters.numeric } });
  class vs extends Ni {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    parse(t, e) {
      const i = bs.prototype.parse.apply(this, [t, e]);
    ...
    getLabelForValue(t) {
      return void 0 === t ? "0" : Li(t, this.options.locale);
    }
    configure() {
      const t = this,
        e = t.min;
  ...
  class Cs extends bs {
    ...
    computeTickLimit() {
      return Math.ceil(this.drawingArea / Ms(this.options));
    }
    generateTickLabels(t) {
      const e = this;
      bs.prototype.generateTickLabels.call(e, t),
  ...
  function Rs(t, e, i, n) {
    const o = Os.length;
    for (let s = Os.indexOf(t); s < o - 1; ++s) {
      const t = As[Os[s]],
        o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Os[s];
    }
    return Os[o - 1];
  }
  function Es(t, e, i) {
  ...
  class Is extends Ni {
    ...
    init(t, e) {
      const i = t.time || (t.time = {}),
        n = (this._adapter = new Kn._date(t.adapters.date));
      st(i.displayFormats, n.formats()),
        super.init(t),
        (this._normalized = e.normalized);
    }
    parse(t, e) {
      return void 0 === t ? null : Ls(this, t);
    }
    beforeLayout() {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? Rs(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = Os.length - 1; s >= Os.indexOf(i); s--) {
                  const i = Os[s];
                  if (As[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
                return Os[i ? Os.indexOf(i) : 0];
              })(t, a.length, i.minUnit, t.min, t.max))),
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = Os.indexOf(t) + 1, i = Os.length; e < i; ++e)
                  if (As[Os[e]].common) return Os[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || Rs(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = K(s.stepSize, 1),
      ...
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Es(h, d, g);
      return (
        (d !== n && "ticks" !== o.bounds && 1 !== u) || Es(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(Ls(t, o[i]));
  ...
  (Vs.id = "timeseries"), (Vs.defaults = Is.defaults);
  ...
  return (
    $n.register(lo, Bs, Ro, ps),
    ($n.helpers = { ...yn }),
    ($n._adapters = Kn),
    ($n.Animation = mi),
    ($n.Animations = bi),
    ($n.animator = a),
    ($n.controllers = Mn.controllers.items),
    ($n.DatasetController = Ai),
    ($n.Element = Oi),
    ($n.elements = Ro),
    ($n.Interaction = De),
    ($n.layouts = Xe),
    ...
    ($n.Scale = Ni),
    ($n.Ticks = Ei),
    Object.assign($n, lo, Bs, Ro, ps, ci),
    ($n.Chart = $n),
