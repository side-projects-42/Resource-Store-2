...
import {
  ...
  F as readUsedSize,
  G as throttled,
  H as supportsEventListenerOptions,
  I as log10,
  J as isNumberFinite,
  K as callback,
  L as toDegrees,
  ...
  W as _angleBetween,
  X as _updateBezierControlPoints,
  Y as _computeSegments,
  Z as _boundSegments,
  $ as _steppedInterpolation,
  a0 as _bezierInterpolation,
  a1 as _pointInLine,
  a2 as _steppedLineTo,
  a3 as _bezierCurveTo,
  a4 as drawPoint,
  a5 as toTRBL,
  a6 as _normalizeAngle,
  a7 as _boundSegment,
  a8 as getRtlAdapter,
  a9 as overrideTextDirection,
  ...
  af as almostWhole,
  ag as _longestText,
  ah as _filterBetween,
  ai as _arrayUnique,
  aj as _lookup,
} from "./chunks/helpers.rtl.js";
...
function getRatioAndOffset(rotation, circumference, cutout) {
  ...
  if (circumference < DOUBLE_PI) {
    ...
    startAngle +=
      startAngle >= PI ? -DOUBLE_PI : startAngle < -PI ? DOUBLE_PI : 0;
    ...
    const contains0 =
      (startAngle <= 0 && endAngle >= 0) || endAngle >= DOUBLE_PI;
    const contains90 =
      (startAngle <= HALF_PI && endAngle >= HALF_PI) ||
      endAngle >= DOUBLE_PI + HALF_PI;
  ...
  _circumference(i, reset) {
    ...
    return reset && opts.animation.animateRotate
      ...
      ? me.calculateCircumference(
          (meta._parsed[i] * opts.circumference) / DOUBLE_PI
        )
      : 0;
  }
