...
import {
  ...
  a0 as _angleBetween,
  a1 as _updateBezierControlPoints,
  a2 as _computeSegments,
  a3 as _boundSegments,
  a4 as _steppedInterpolation,
  a5 as _bezierInterpolation,
  a6 as _pointInLine,
  a7 as _steppedLineTo,
  a8 as _bezierCurveTo,
  a9 as drawPoint,
  aa as toTRBL,
  ab as toTRBLCorners,
  ac as _normalizeAngle,
  ad as _boundSegment,
  ae as INFINITY,
  af as getRtlAdapter,
  ag as overrideTextDirection,
  ah as restoreTextDirection,
  ai as distanceBetweenPoints,
  aj as _setMinAndMaxByKey,
...
class Scale extends Element {
  ...
  drawLabels(chartArea) {
    ...
    for (i = 0, ilen = items.length; i < ilen; ++i) {
      ...
      const useStroke =
        optionTicks.textStrokeWidth > 0 && optionTicks.textStrokeColor !== "";
      ctx.save();
...
const toLeftRightCenter = (align) =>
  align === "start" ? "left" : align === "end" ? "right" : "center";
const alignStartEnd = (align, start, end) =>
