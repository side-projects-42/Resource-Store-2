...
!(function (t, e) {
  ...
  function Nt(t, e, i, n) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
      if (((d = i[l]), null != d && !0 !== N(d))) a = jt(t, o, s, a, d);
      else if (N(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), null == u || N(u) || (a = jt(t, o, s, a, u));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
  ...
  function $e(t, e, i) {
    ...
    for (o = 0, s = t.length; o < s; ++o) {
      (a = t[o]),
        (r = a.box),
        r.update(a.width || e.w, a.height || e.h, Ne(a.horizontal, e));
  ...
  class xi {
    ...
    configure(t) {
      ...
      Object.getOwnPropertyNames(t).forEach((i) => {
        ...
        ((N(n.properties) && n.properties) || [i]).forEach((t) => {
  ...
  function Ti(t, e, i) {
    return (function (t, e) {
      ...
      let n = Ai.get(i);
      return n || ((n = new Intl.NumberFormat(t, e)), Ai.set(i, n)), n;
    })(e, i).format(t);
  }
  const Li = {
    values: (t) => (N(t) ? t : "" + t),
  ...
  class Hi extends Oi {
    ...
    fit() {
      ...
      if (
        (c ? (e.width = t.maxWidth) : r && (e.width = zi(a) + h),
        c ? r && (e.height = zi(a) + h) : (e.height = t.maxHeight),
        ...
        if (
          ...
          if (N(g))
            for (u = 0, f = g.length; u < f; ++u)
              (v = g[u]),
                j(v) || N(v) || ((_ = jt(e, x.data, x.gc, _, v)), (y += b));
    ...
    _autoSkip(t) {
      ...
      if (o > 0) {
        ...
        for (Bi(t, r, l, j(c) ? 0 : s - c, s), e = 0, i = o - 1; e < i; e++)
          Bi(t, r, l, n[e], n[e + 1]);
        return Bi(t, r, l, a, j(c) ? t.length : a + c), r;
      }
      return Bi(t, r, l), r;
    }
    _tickSize() {
      ...
      for (p = 0, m = r.length; p < m; ++p) {
        ...
        a
          ? ((_ = M),
            "top" === o
              ? "near" === c || 0 !== f
                ? ((P = (Math.sin(f) * i + 0.5) * k),
                  (P -= (0 === f ? S - 0.5 : Math.cos(f) * i) * k))
                : "center" === c
                ? ((P = (C.highest.height / 2) * -1), (P -= i * k))
                : (P = -1 * C.highest.height + 0.5 * k)
              : "near" === c || 0 !== f
              ? ((P = Math.sin(f) * i * k),
                (P += (0 === f ? 0.5 : Math.cos(f) * i) * k))
              : "center" === c
              ? ((P = C.highest.height / 2), (P -= i * k))
              : (P = C.highest.height - (S - 0.5) * k))
          : ((y = M), (P = ((1 - S) * k) / 2)),
          g.push({
            rotation: f,
            label: b,
    ...
    drawTitle() {
      ...
      "bottom" === e
        ? ((l += a.bottom),
          N(i.text) && (l += s.lineHeight * (i.text.length - 1)))
        : (l += a.top);
      const {
        titleX: c,
        titleY: h,
  ...
  function Ni(t, e, i, n) {
    const o = {
      ...
      _stack: new Set(),
      _descriptors: $i(t, n),
      setContext: (e) => Ni(t, e, i, n),
      override: (o) => Ni(t.override(o), e, i, n),
    };
    return new Proxy(o, {
            ...
            N(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (lt(s.index) && n(t)) e = e[s.index % e.length];
                  ...
                  for (const l of i) {
                    const i = Zi(n, o, t, l);
                    e.push(Ni(i, s, a && a[t], r));
                  }
                }
                return e;
              })(e, r, t, a.isIndexable));
            Ui(e, r) && (r = Ni(r, o, s && s[e], a));
            return r;
          })(t, e, i)
        ),
  ...
  var vn = new (class {
    constructor() {
      (this.controllers = new yn(Ci, "datasets", !0)),
        (this.elements = new yn(Oi, "elements")),
  ...
  function An(t, e) {
    let i = Cn.get(t);
    return i || ((i = e()), Cn.set(t, i), On.add(i)), i;
  }
  const Tn = (t, e, i) => {
    const n = at(e, i);
    void 0 !== n && t.add(n);
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      ...
      if (
        (function (t, e) {
          ...
          for (const o of e)
            if ((i(o) && ct(t[o])) || (n(o) && N(t[o]))) return !0;
          return !1;
        })(s, e)
      ) {
        o.$shared = !1;
        r = Ni(s, (i = ct(i) ? i() : i), this.createResolver(t, i, a));
      }
  ...
  const $n = () => Z(Nn.instances, (t) => t._plugins.invalidate()),
    Yn = !0;
  function Un() {
    throw new Error(
  ...
  Object.defineProperties(Nn, {
    ...
    version: { enumerable: Yn, value: "3.0.0-beta.14" },
    getChart: { enumerable: Yn, value: jn },
    register: {
      enumerable: Yn,
      value: (...t) => {
        vn.add(...t), $n();
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          s.push(c);
      for (r = 0; r < n; ++r)
        (c = s[r]), c && !1 !== c.fill && (c.fill = jo(s, r, o));
    },
  ...
  class Zo extends Oi {
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (s.fillStyle = u),
        (s.font = d.string);
      const { boxWidth: m, boxHeight: x, itemHeight: b } = Go(l, g),
        _ = t.isHorizontal(),
        ...
        h.setWidth(t.width),
          _
            ...
            : u > 0 &&
              ...
              p.line++,
              (S = p.y = n(r, t.top + y + f, t.bottom - i[p.line].height)));
        const P = h.x(k);
        !(function (t, e, i) {
          ...
          (a[u].left = h.leftForLtr(P, a[u].width)),
          (a[u].top = S),
          (function (t, e, i) {
            const n = g / 2,
              o = h.xPlus(t, m + n);
  ...
  class Jo extends Oi {
    ...
    update(t, e) {
      ...
      const o = N(n.text) ? n.text.length : 1;
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        (_ = Math.ceil(u / y) - Math.floor(d / y)),
          _ > h && (y = St((_ * y) / h / c) * c),
          j(a) || ((m = Math.pow(10, a)), (y = Math.ceil(y * m) / m)),
          (x = Math.floor(d / y) * y),
          (b = Math.ceil(u / y) * y),
          f && g && n && Ot((s - o) / n, y / 1e3)
            ? ((_ = Math.min((s - o) / y, l)),
              (y = (s - o) / _),
              (x = o),
              (b = s))
        ...
        for (
          ...
          (i.push({ value: o }),
          x < o && v++,
          Ot(Math.round((x + v * y) * m) / m / o, y / 1e3) && v++);
          v < _;
          ++v
        )
  ...
  (xs.id = "linear"),
    (xs.defaults = { ticks: { callback: Ri.formatters.numeric } });
  class _s extends Hi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    parse(t, e) {
      const i = ms.prototype.parse.apply(this, [t, e]);
    ...
    buildTicks() {
      const t = this,
        ...
        i = (function (t, e) {
          ...
          do {
            o.push({ value: s, major: bs(s) }),
              ++r,
              10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
              (s = Math.round(r * Math.pow(10, a) * l) / l);
          } while (a < i || (a === i && r < n));
          const c = U(t.max, s);
          return o.push({ value: c, major: bs(s) }), o;
  ...
  class Ps extends ms {
    ...
    generateTickLabels(t) {
      const e = this;
      ms.prototype.generateTickLabels.call(e, t),
        ...
        ? (function (t) {
            ...
            for (n = 0; n < l; n++) {
              ...
              (t.ctx.font = u.string),
                (c = t.ctx),
                (h = u.lineHeight),
                (o = N((d = t._pointLabels[n]))
                  ? { w: Nt(c, c.font, d), h: d.length * h }
  ...
  (Ps.id = "radialLinear"),
    ...
    (Ps.descriptors = { angleLines: { _fallback: "grid" } });
  const Ds = {
  ...
  function Ts(t, e, i, n) {
    const o = Cs.length;
    for (let s = Cs.indexOf(t); s < o - 1; ++s) {
      const t = Ds[Cs[s]],
        o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
      if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Cs[s];
    }
    return Cs[o - 1];
  }
  function Ls(t, e, i) {
  ...
  class Es extends Hi {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? Ts(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = Cs.length - 1; s >= Cs.indexOf(i); s--) {
                  const i = Cs[s];
                  if (Ds[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
                return Cs[i ? Cs.indexOf(i) : 0];
              })(t, a.length, i.minUnit, t.min, t.max))),
        (t._majorUnit =
          n.major.enabled && "year" !== t._unit
            ? (function (t) {
                for (let e = Cs.indexOf(t) + 1, i = Cs.length; e < i; ++e)
                  if (Ds[Cs[e]].common) return Cs[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      const t = this,
        ...
        o = t.options,
        s = o.time,
        a = s.unit || Ts(s.minUnit, i, n, t._getLabelCapacity(i)),
        r = X(s.stepSize, 1),
      ...
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Ls(h, d, g);
      return (
        (d !== n && "ticks" !== o.bounds && 1 !== u) || Ls(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelCapacity(t) {
      const e = this,
        ...
        s = e._tickFormatFunction(t, 0, Rs(e, [t], e._majorUnit), o),
        a = e._getLabelSize(s),
    ...
    getLabelTimestamps() {
      ...
      const o = t.getLabels();
      for (i = 0, n = o.length; i < n; ++i) e.push(As(t, o[i]));
  ...
  (Is.id = "timeseries"), (Is.defaults = Es.defaults);
  var zs = Object.freeze({
    __proto__: null,
    CategoryScale: ps,
    LinearScale: xs,
    LogarithmicScale: _s,
    RadialLinearScale: Ps,
    TimeScale: Es,
    TimeSeriesScale: Is,
  });
  return (
    Nn.register(ro, zs, Lo, gs),
    (Nn.helpers = { ..._n }),
    (Nn._adapters = qn),
    (Nn.Animation = pi),
    (Nn.Animations = xi),
    (Nn.animator = o),
    (Nn.controllers = vn.controllers.items),
    (Nn.DatasetController = Ci),
    (Nn.Element = Oi),
    (Nn.elements = Lo),
    (Nn.Interaction = Se),
    (Nn.layouts = Ue),
    ...
    (Nn.Scale = Hi),
    (Nn.Ticks = Ri),
    Object.assign(Nn, ro, zs, Lo, gs, li),
    (Nn.Chart = Nn),
