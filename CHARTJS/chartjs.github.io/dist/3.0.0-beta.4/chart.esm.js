...
import {
  ...
  Z as _angleBetween,
  $ as _updateBezierControlPoints,
  a0 as _computeSegments,
  a1 as _boundSegments,
  a2 as _steppedInterpolation,
  a3 as _bezierInterpolation,
  a4 as _pointInLine,
  a5 as _steppedLineTo,
  a6 as _bezierCurveTo,
  a7 as drawPoint,
  a8 as toTRBL,
  a9 as _normalizeAngle,
  aa as _boundSegment,
  ab as INFINITY,
  ac as getRtlAdapter,
  ad as overrideTextDirection,
  ae as restoreTextDirection,
...
function mergeScaleConfig(config, options) {
  ...
  if (options.scale) {
    scales[options.scale.id || "r"] = mergeIf({ axis: "r" }, [
      options.scale,
