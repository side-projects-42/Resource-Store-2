...
!(function (t, e) {
  ...
  class Bn {
    constructor(t) {
      (this._config = (function (t) {
        ...
        return (
          (e.datasets = e.datasets || []), (e.labels = e.labels || []), En(t), t
        );
      })(t)),
  ...
  function Qo(t, e) {
    ...
    return (
      ...
      i.length
        ? new Ao({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n })
        : null
    );
  }
  function Jo(t, e, i) {
      ...
      return ((t, e) =>
        null === t
          ...
          : Nt(
              ...
              0,
              e
            ))((e = isFinite(e) && i[e] === t ? e : Ds(i, t, K(e, t))), i.length - 1);
    }
    determineDataLimits() {
      const t = this,
  ...
  (Cs.id = "category"),
    (Cs.defaults = { ticks: { callback: Cs.prototype.getLabelForValue } });
  class Os extends Yi {
    constructor(t) {
      super(t),
        (this.start = void 0),
  ...
  (As.id = "linear"),
    (As.defaults = { ticks: { callback: Fi.formatters.numeric } });
  class Rs extends Yi {
    constructor(t) {
      super(t),
        (this.start = void 0),
