...
!(function (t, e) {
    ...
    Hi = Wi.extend({
      ...
      _configure: function () {
        var t = this,
          e = t.options.offset,
          i = t.ticks;
        Wi.prototype._configure.call(t),
      ...
      getPixelForValue: function (t, e, i) {
        var n,
          ...
          o = this;
        return (
          Vi(e) || Vi(i) || (t = o.chart.data.datasets[i].data[e]),
          Vi(t) || (n = o.isHorizontal() ? t.x : t.y),
  ...
  var Yi = Wi.extend({
      getRightValue: function (t) {
        return "string" == typeof t
          ? +t
          : Wi.prototype.getRightValue.call(this, t);
      },
      ...
      convertTicksToLabels: function () {
        ...
        (t.ticksAsNumbers = t.ticks.slice()),
          ...
          Wi.prototype.convertTicksToLabels.call(t);
      },
      _configure: function () {
        var t,
          e = this,
  ...
  var Fn = Wi.extend({
      ...
      update: function () {
        ...
        return (
          ...
          Wi.prototype.update.apply(t, arguments)
        );
      },
      getRightValue: function (t) {
        return (
  ...
  var qn = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (n = 0; n < o; ++n)
          (r = l[n]) &&
            ((r.fill = En(l, n, s)), (r.boundary = Bn(r)), (r.mapper = Wn(r)));
      },
