...
import {
  ...
  $ as _angleBetween,
  a0 as _updateBezierControlPoints,
  a1 as _computeSegments,
  a2 as _boundSegments,
  a3 as _steppedInterpolation,
  a4 as _bezierInterpolation,
  a5 as _pointInLine,
  a6 as _steppedLineTo,
  a7 as _bezierCurveTo,
  a8 as drawPoint,
  a9 as toTRBL,
  aa as toTRBLCorners,
  ab as _normalizeAngle,
  ac as _boundSegment,
  ad as INFINITY,
  ae as getRtlAdapter,
  af as overrideTextDirection,
  ag as restoreTextDirection,
  ah as distanceBetweenPoints,
  ai as _setMinAndMaxByKey,
...
const freezeIfShared = (values, shared) =>
  shared ? Object.freeze(values) : values;
  ...
  _getRotationExtents() {
    ...
    for (let i = 0; i < me.chart.data.datasets.length; ++i) {
      if (me.chart.isDatasetVisible(i)) {
        ...
        const rotation = toRadians(
          valueOrDefault(dataset.rotation, opts.rotation) - 90
        );
        const circumference = toRadians(
...
function initConfig(config) {
  ...
  const options = (config.options = includeDefaults(
    config.options,
    config.type
  ));
