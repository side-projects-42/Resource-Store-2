...
(function (global, factory) {
  ...
  var Chart = (function () {
    ...
    _proto._removeUnreferencedMetasets =
      function _removeUnreferencedMetasets() {
        var me = this;
        var datasets = me.data.datasets;
        me._metasets.forEach(function (meta, index) {
          if (
            datasets.filter(function (x) {
  ...
  var DoughnutController = (function (_DatasetController) {
    ...
    _proto._getRotation = function _getRotation() {
      return toRadians(
        valueOrDefault(this._config.rotation, this.chart.options.rotation) - 90
      );
    };
    _proto._getCircumference = function _getCircumference() {
      return toRadians(
        valueOrDefault(
          this._config.circumference,
