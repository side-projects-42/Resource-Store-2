...
-   Axes <span class="arrow down"></span>
    ...
    -   Cartesian <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/axes/cartesian/linear.html" class="active sidebar-link">Linear Axis</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/axes/cartesian/category.html" class="prev">Category Axis</a> </span> <span class="next"> [Logarithmic Axis](/docs/3.2.0/axes/cartesian/logarithmic.html) → </span>
