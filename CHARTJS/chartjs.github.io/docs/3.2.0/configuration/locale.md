...
-   Configuration <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/configuration/locale.html" class="active sidebar-link">Locale</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/configuration/device-pixel-ratio.html" class="prev">Device Pixel Ratio</a> </span> <span class="next"> [Interactions](/docs/3.2.0/configuration/interactions.html) → </span>
