...
-   Line Charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/line/line.html" class="active sidebar-link">Line Chart</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/samples/bar/border-radius.html" class="prev">Bar Chart Border Radius</a> </span> <span class="next"> [Multi Axis Line Chart](/docs/3.2.0/samples/line/multi-axis.html) → </span>
