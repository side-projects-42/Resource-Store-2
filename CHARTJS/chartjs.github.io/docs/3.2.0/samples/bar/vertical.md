...
-   Bar Charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/bar/vertical.html" class="active sidebar-link">Vertical Bar Chart</a>
...
<span class="next"> [Horizontal Bar Chart](/docs/3.2.0/samples/bar/horizontal.html) → </span>
