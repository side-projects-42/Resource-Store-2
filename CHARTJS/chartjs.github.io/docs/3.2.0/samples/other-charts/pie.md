...
-   Other charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/other-charts/pie.html" class="active sidebar-link">Pie</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/samples/other-charts/doughnut.html" class="prev">Doughnut</a> </span> <span class="next"> [Multi Series Pie](/docs/3.2.0/samples/other-charts/multi-series-pie.html) → </span>
