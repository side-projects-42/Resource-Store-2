...
-   Other charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/other-charts/radar.html" class="active sidebar-link">Radar</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/samples/other-charts/polar-area.html" class="prev">Polar area</a> </span> <span class="next"> [Radar skip points](/docs/3.2.0/samples/other-charts/radar-skip-points.html) → </span>
