...
-   Other charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/other-charts/scatter-multi-axis.html" class="active sidebar-link">Scatter - Multi axis</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/samples/other-charts/scatter.html" class="prev">Scatter</a> </span> <span class="next"> [Doughnut](/docs/3.2.0/samples/other-charts/doughnut.html) → </span>
