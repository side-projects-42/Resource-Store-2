...
-   Scriptable Options <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.2.0/samples/scriptable/bar.html" class="active sidebar-link">Bar Chart</a>
...
<span class="prev"> ← <a href="/docs/3.2.0/samples/tooltip/html.html" class="prev">External HTML Tooltip</a> </span> <span class="next"> [Bubble Chart](/docs/3.2.0/samples/scriptable/bubble.html) → </span>
