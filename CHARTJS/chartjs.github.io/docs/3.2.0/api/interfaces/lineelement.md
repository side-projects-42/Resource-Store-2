...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/lineelement.html" class="active sidebar-link">LineElement</a>
...
<a href="#interface-lineelement-t-o" class="header-anchor">#</a> Interface: LineElement&lt;T, O&gt;
===================================================================================================

<a href="#type-parameters" class="header-anchor">#</a> Type parameters
----------------------------------------------------------------------

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th><th style="text-align: left;">Default</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>T</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/lineprops.html"><em>LineProps</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/lineprops.html"><em>LineProps</em></a></td></tr><tr class="even"><td style="text-align: left;"><code>O</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/lineoptions.html"><em>LineOptions</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/lineoptions.html"><em>LineOptions</em></a></td></tr></tbody></table>
...
### <a href="#points" class="header-anchor">#</a> points

• **points**: [*Point*](/docs/3.2.0/api/interfaces/point.html)\[\]

Defined in: [index.esm.d.ts:1715 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1715)

------------------------------------------------------------------------

### <a href="#segments" class="header-anchor">#</a> segments

• `Readonly` **segments**: [*Segment*](/docs/3.2.0/api/interfaces/segment.html)\[\]

Defined in: [index.esm.d.ts:1716 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1716)
...
### <a href="#first" class="header-anchor">#</a> first

▸ **first**(): *false* | [*Point*](/docs/3.2.0/api/interfaces/point.html)

**Returns:** *false* | [*Point*](/docs/3.2.0/api/interfaces/point.html)

Defined in: [index.esm.d.ts:1717 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1717)
...
### <a href="#interpolate" class="header-anchor">#</a> interpolate

▸ **interpolate**(`point`: [*Point*](/docs/3.2.0/api/interfaces/point.html), `property`: *x* | *y*): [*Point*](/docs/3.2.0/api/interfaces/point.html) | [*Point*](/docs/3.2.0/api/interfaces/point.html)\[\]

#### <a href="#parameters-13" class="header-anchor">#</a> Parameters:

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>point</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/point.html"><em>Point</em></a></td></tr><tr class="even"><td style="text-align: left;"><code>property</code></td><td style="text-align: left;"><em>x</em> | <em>y</em></td></tr></tbody></table>

**Returns:** [*Point*](/docs/3.2.0/api/interfaces/point.html) | [*Point*](/docs/3.2.0/api/interfaces/point.html)\[\]

Defined in: [index.esm.d.ts:1719 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1719)

------------------------------------------------------------------------

### <a href="#last" class="header-anchor">#</a> last

▸ **last**(): *false* | [*Point*](/docs/3.2.0/api/interfaces/point.html)

**Returns:** *false* | [*Point*](/docs/3.2.0/api/interfaces/point.html)

Defined in: [index.esm.d.ts:1718 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1718)

------------------------------------------------------------------------

### <a href="#path" class="header-anchor">#</a> path
...
Defined in: [index.esm.d.ts:1721 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1721)

------------------------------------------------------------------------

### <a href="#pathsegment" class="header-anchor">#</a> pathSegment

▸ **pathSegment**(`ctx`: CanvasRenderingContext2D, `segment`: [*Segment*](/docs/3.2.0/api/interfaces/segment.html), `params`: *Record*&lt;string, unknown&gt;): *boolean*

#### <a href="#parameters-15" class="header-anchor">#</a> Parameters:

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>ctx</code></td><td style="text-align: left;">CanvasRenderingContext2D</td></tr><tr class="even"><td style="text-align: left;"><code>segment</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/segment.html"><em>Segment</em></a></td></tr><tr class="odd"><td style="text-align: left;"><code>params</code></td><td style="text-align: left;"><em>Record</em>&lt;string, unknown&gt;</td></tr></tbody></table>

**Returns:** *boolean*

Defined in: [index.esm.d.ts:1720 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1720)
...
### <a href="#updatecontrolpoints" class="header-anchor">#</a> updateControlPoints

▸ **updateControlPoints**(`chartArea`: [*ChartArea*](/docs/3.2.0/api/interfaces/chartarea.html)): *void*
...
Defined in: [index.esm.d.ts:1714 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1714)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/linecontrollerdatasetoptions.html" class="prev">LineControllerDatasetOptions</a> </span> <span class="next"> [LineHoverOptions](/docs/3.2.0/api/interfaces/linehoveroptions.html) → </span>
