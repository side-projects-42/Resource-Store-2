...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/filleroptions.html" class="active sidebar-link">FillerOptions</a>
...
<a href="#interface-filleroptions" class="header-anchor">#</a> Interface: FillerOptions
=======================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#drawtime" class="header-anchor">#</a> drawTime

• **drawTime**: *beforeDatasetDraw* | *beforeDatasetsDraw*

Defined in: [index.esm.d.ts:1976 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1976)
...
Defined in: [index.esm.d.ts:1977 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1977)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/fillercontrollerdatasetoptions.html" class="prev">FillerControllerDatasetOptions</a> </span> <span class="next"> [FontSpec](/docs/3.2.0/api/interfaces/fontspec.html) → </span>
