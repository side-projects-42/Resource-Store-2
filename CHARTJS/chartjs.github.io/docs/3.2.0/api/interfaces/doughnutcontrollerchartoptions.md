...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/doughnutcontrollerchartoptions.html" class="active sidebar-link">DoughnutControllerChartOptions</a>
...
• **animation**: [*DoughnutAnimationOptions*](/docs/3.2.0/api/interfaces/doughnutanimationoptions.html)

Defined in: [index.esm.d.ts:297 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L297)
...
Defined in: [index.esm.d.ts:276 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L276)

------------------------------------------------------------------------

### <a href="#cutout" class="header-anchor">#</a> cutout

• **cutout**: [*Scriptable*](/docs/3.2.0/api/#scriptable)&lt;string | number, [*ScriptableContext*](/docs/3.2.0/api/interfaces/scriptablecontext.html)&lt;*doughnut*&gt;&gt;
...
Defined in: [index.esm.d.ts:283 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L283)

------------------------------------------------------------------------

### <a href="#radius" class="header-anchor">#</a> radius

• **radius**: [*Scriptable*](/docs/3.2.0/api/#scriptable)&lt;string | number, [*ScriptableContext*](/docs/3.2.0/api/interfaces/scriptablecontext.html)&lt;*doughnut*&gt;&gt;

The outer radius of the chart. String ending with '%' means percentage of maximum radius, number means pixels.

**`default`** '100%'

Defined in: [index.esm.d.ts:289 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L289)
...
Defined in: [index.esm.d.ts:295 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L295)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/doughnutcontroller.html" class="prev">DoughnutController</a> </span> <span class="next"> [DoughnutControllerDatasetOptions](/docs/3.2.0/api/interfaces/doughnutcontrollerdatasetoptions.html) → </span>
