...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/scatterdatapoint.html" class="active sidebar-link">ScatterDataPoint</a>
...
<a href="#interface-scatterdatapoint" class="header-anchor">#</a> Interface: ScatterDataPoint
=============================================================================================
...
Defined in: [index.esm.d.ts:220 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L220)
...
Defined in: [index.esm.d.ts:221 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L221)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/scaletyperegistry.html" class="prev">ScaleTypeRegistry</a> </span> <span class="next"> [ScriptableContext](/docs/3.2.0/api/interfaces/scriptablecontext.html) → </span>
