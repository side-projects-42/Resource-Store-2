...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/doughnutanimationoptions.html" class="active sidebar-link">DoughnutAnimationOptions</a>
...
<a href="#interface-doughnutanimationoptions" class="header-anchor">#</a> Interface: DoughnutAnimationOptions
=============================================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#animaterotate" class="header-anchor">#</a> animateRotate
...
Defined in: [index.esm.d.ts:262 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L262)

------------------------------------------------------------------------

### <a href="#animatescale" class="header-anchor">#</a> animateScale
...
Defined in: [index.esm.d.ts:268 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L268)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/defaults.html" class="prev">Defaults</a> </span> <span class="next"> [DoughnutController](/docs/3.2.0/api/interfaces/doughnutcontroller.html) → </span>
