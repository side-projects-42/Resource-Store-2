...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/barcontrollerchartoptions.html" class="active sidebar-link">BarControllerChartOptions</a>
...
<a href="#interface-barcontrollerchartoptions" class="header-anchor">#</a> Interface: BarControllerChartOptions
===============================================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#skipnull" class="header-anchor">#</a> skipNull

• `Optional` **skipNull**: *boolean*

Should null or undefined values be omitted from drawing

Defined in: [index.esm.d.ts:136 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L136)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/arcprops.html" class="prev">ArcProps</a> </span> <span class="next"> [BarControllerDatasetOptions](/docs/3.2.0/api/interfaces/barcontrollerdatasetoptions.html) → </span>
