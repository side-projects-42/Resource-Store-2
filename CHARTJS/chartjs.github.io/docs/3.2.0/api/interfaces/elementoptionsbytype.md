...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/elementoptionsbytype.html" class="active sidebar-link">ElementOptionsByType</a>
...
<a href="#interface-elementoptionsbytype" class="header-anchor">#</a> Interface: ElementOptionsByType
=====================================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#arc" class="header-anchor">#</a> arc

• **arc**: [*ArcOptions*](/docs/3.2.0/api/interfaces/arcoptions.html) & [*ArcHoverOptions*](/docs/3.2.0/api/interfaces/archoveroptions.html)

Defined in: [index.esm.d.ts:1891 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1891)

------------------------------------------------------------------------

### <a href="#bar" class="header-anchor">#</a> bar

• **bar**: [*BarOptions*](/docs/3.2.0/api/interfaces/baroptions.html) & [*BarHoverOptions*](/docs/3.2.0/api/interfaces/barhoveroptions.html)

Defined in: [index.esm.d.ts:1892 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1892)

------------------------------------------------------------------------

### <a href="#line" class="header-anchor">#</a> line

• **line**: [*LineOptions*](/docs/3.2.0/api/interfaces/lineoptions.html) & [*LineHoverOptions*](/docs/3.2.0/api/interfaces/linehoveroptions.html)

Defined in: [index.esm.d.ts:1893 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1893)

------------------------------------------------------------------------

### <a href="#point" class="header-anchor">#</a> point

• **point**: [*PointOptions*](/docs/3.2.0/api/interfaces/pointoptions.html) & [*PointHoverOptions*](/docs/3.2.0/api/interfaces/pointhoveroptions.html)

Defined in: [index.esm.d.ts:1894 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1894)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/elementchartoptions.html" class="prev">ElementChartOptions</a> </span> <span class="next"> [ExtendedPlugin](/docs/3.2.0/api/interfaces/extendedplugin.html) → </span>
