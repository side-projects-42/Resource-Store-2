...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/linecontrollerchartoptions.html" class="active sidebar-link">LineControllerChartOptions</a>
...
<a href="#interface-linecontrollerchartoptions" class="header-anchor">#</a> Interface: LineControllerChartOptions
=================================================================================================================
...
Defined in: [index.esm.d.ts:208 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L208)
...
Defined in: [index.esm.d.ts:203 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L203)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/legendoptions.html" class="prev">LegendOptions</a> </span> <span class="next"> [LineControllerDatasetOptions](/docs/3.2.0/api/interfaces/linecontrollerdatasetoptions.html) → </span>
