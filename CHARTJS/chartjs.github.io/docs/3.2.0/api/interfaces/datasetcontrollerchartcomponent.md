...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/datasetcontrollerchartcomponent.html" class="active sidebar-link">DatasetControllerChartComponent</a>
...
<a href="#interface-datasetcontrollerchartcomponent" class="header-anchor">#</a> Interface: DatasetControllerChartComponent
===========================================================================================================================
...
### <a href="#defaultroutes" class="header-anchor">#</a> defaultRoutes

• `Optional` **defaultRoutes**: *object*

#### <a href="#type-declaration" class="header-anchor">#</a> Type declaration:

Inherited from: [ChartComponent](/docs/3.2.0/api/interfaces/chartcomponent.html).[defaultRoutes](/docs/3.2.0/api/interfaces/chartcomponent.html#defaultroutes)

Defined in: [index.esm.d.ts:1326 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1326)
...
<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>dataElementType</code>?</td><td style="text-align: left;"><em>string</em> | <em>false</em></td></tr><tr class="even"><td style="text-align: left;"><code>datasetElementType</code>?</td><td style="text-align: left;"><em>string</em> | <em>false</em></td></tr></tbody></table>

Overrides: [ChartComponent](/docs/3.2.0/api/interfaces/chartcomponent.html).[defaults](/docs/3.2.0/api/interfaces/chartcomponent.html#defaults)

Defined in: [index.esm.d.ts:601 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L601)
...
Inherited from: [ChartComponent](/docs/3.2.0/api/interfaces/chartcomponent.html).[id](/docs/3.2.0/api/interfaces/chartcomponent.html#id)

Defined in: [index.esm.d.ts:1324 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1324)

<a href="#methods" class="header-anchor">#</a> Methods
------------------------------------------------------

### <a href="#afterregister" class="header-anchor">#</a> afterRegister

▸ `Optional`**afterRegister**(): *void*

**Returns:** *void*

Inherited from: [ChartComponent](/docs/3.2.0/api/interfaces/chartcomponent.html)

Defined in: [index.esm.d.ts:1329 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1329)

------------------------------------------------------------------------

### <a href="#afterunregister" class="header-anchor">#</a> afterUnregister
...
Defined in: [index.esm.d.ts:1331 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1331)

------------------------------------------------------------------------

### <a href="#beforeregister" class="header-anchor">#</a> beforeRegister
...
Defined in: [index.esm.d.ts:1328 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1328)

------------------------------------------------------------------------

### <a href="#beforeunregister" class="header-anchor">#</a> beforeUnregister
...
Defined in: [index.esm.d.ts:1330 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1330)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/corescaleoptions.html" class="prev">CoreScaleOptions</a> </span> <span class="next"> [DateAdapter](/docs/3.2.0/api/interfaces/dateadapter.html) → </span>
