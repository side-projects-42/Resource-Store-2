...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/complexfilltarget.html" class="active sidebar-link">ComplexFillTarget</a>
...
<a href="#interface-complexfilltarget" class="header-anchor">#</a> Interface: ComplexFillTarget
===============================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#above" class="header-anchor">#</a> above

• **above**: [*Color*](/docs/3.2.0/api/#color)

If no color is set, the default color will be the background color of the chart.

Defined in: [index.esm.d.ts:1990 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1990)

------------------------------------------------------------------------

### <a href="#below" class="header-anchor">#</a> below

• **below**: [*Color*](/docs/3.2.0/api/#color)

Same as the above.

Defined in: [index.esm.d.ts:1994 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1994)

------------------------------------------------------------------------

### <a href="#target" class="header-anchor">#</a> target

• **target**: [*FillTarget*](/docs/3.2.0/api/#filltarget)
...
Defined in: [index.esm.d.ts:1986 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1986)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/commonhoveroptions.html" class="prev">CommonHoverOptions</a> </span> <span class="next"> [ControllerDatasetOptions](/docs/3.2.0/api/interfaces/controllerdatasetoptions.html) → </span>
