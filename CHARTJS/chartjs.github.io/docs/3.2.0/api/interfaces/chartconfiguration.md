...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/chartconfiguration.html" class="active sidebar-link">ChartConfiguration</a>
...
<a href="#interface-chartconfiguration-ttype-tdata-tlabel" class="header-anchor">#</a> Interface: ChartConfiguration&lt;TType, TData, TLabel&gt;
================================================================================================================================================
...
Defined in: [index.esm.d.ts:3362 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3362)

------------------------------------------------------------------------

### <a href="#options" class="header-anchor">#</a> options

• `Optional` **options**: *DeepPartial*&lt;[*CoreChartOptions*](/docs/3.2.0/api/interfaces/corechartoptions.html)&lt;TType&gt; & [*ElementChartOptions*](/docs/3.2.0/api/interfaces/elementchartoptions.html) & [*PluginChartOptions*](/docs/3.2.0/api/interfaces/pluginchartoptions.html)&lt;TType&gt; & [*DatasetChartOptions*](/docs/3.2.0/api/#datasetchartoptions)&lt;TType&gt; & [*ScaleChartOptions*](/docs/3.2.0/api/#scalechartoptions)&lt;TType&gt; & [*ChartTypeRegistry*](/docs/3.2.0/api/interfaces/charttyperegistry.html)\[TType\]\[*chartOptions*\]&gt;

Defined in: [index.esm.d.ts:3363 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3363)

------------------------------------------------------------------------

### <a href="#plugins" class="header-anchor">#</a> plugins

• `Optional` **plugins**: [*Plugin*](/docs/3.2.0/api/interfaces/plugin.html)&lt;TType, Record&lt;string, unknown&gt;&gt;\[\]

Defined in: [index.esm.d.ts:3364 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3364)
...
Defined in: [index.esm.d.ts:3361 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3361)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/chartcomponent.html" class="prev">ChartComponent</a> </span> <span class="next"> [ChartData](/docs/3.2.0/api/interfaces/chartdata.html) → </span>
