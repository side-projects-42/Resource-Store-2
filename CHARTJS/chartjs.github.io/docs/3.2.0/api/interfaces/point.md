...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/point.html" class="active sidebar-link">Point</a>
...
<a href="#interface-point" class="header-anchor">#</a> Interface: Point
=======================================================================
...
Defined in: [geometric.d.ts:9 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/geometric.d.ts#L9)
...
Defined in: [geometric.d.ts:10 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/geometric.d.ts#L10)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/pluginoptionsbytype.html" class="prev">PluginOptionsByType</a> </span> <span class="next"> [PointElement](/docs/3.2.0/api/interfaces/pointelement.html) → </span>
