...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/animationevent.html" class="active sidebar-link">AnimationEvent</a>
...
<a href="#interface-animationevent" class="header-anchor">#</a> Interface: AnimationEvent
=========================================================================================
...
Defined in: [animation.d.ts:13 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/animation.d.ts#L13)

------------------------------------------------------------------------

### <a href="#currentstate" class="header-anchor">#</a> currentState

• **currentState**: *number*

Defined in: [animation.d.ts:15 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/animation.d.ts#L15)

------------------------------------------------------------------------

### <a href="#numsteps" class="header-anchor">#</a> numSteps

• **numSteps**: *number*

Defined in: [animation.d.ts:14 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/animation.d.ts#L14)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/activeelement.html" class="prev">ActiveElement</a> </span> <span class="next"> [ArcBorderRadius](/docs/3.2.0/api/interfaces/arcborderradius.html) → </span>
