...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/interactionoptions.html" class="active sidebar-link">InteractionOptions</a>
...
<a href="#interface-interactionoptions" class="header-anchor">#</a> Interface: InteractionOptions
=================================================================================================
...
Defined in: [index.esm.d.ts:653 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L653)
...
Defined in: [index.esm.d.ts:654 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L654)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/interactionmodemap.html" class="prev">InteractionModeMap</a> </span> <span class="next"> [LayoutItem](/docs/3.2.0/api/interfaces/layoutitem.html) → </span>
