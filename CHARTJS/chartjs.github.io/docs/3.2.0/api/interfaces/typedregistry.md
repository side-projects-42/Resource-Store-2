...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/typedregistry.html" class="active sidebar-link">TypedRegistry</a>
        -   <a href="/docs/3.2.0/api/interfaces/visualelement.html" class="sidebar-link">VisualElement</a>

<a href="#interface-typedregistry-t" class="header-anchor">#</a> Interface: TypedRegistry&lt;T&gt;
==================================================================================================

<a href="#type-parameters" class="header-anchor">#</a> Type parameters
----------------------------------------------------------------------

<table><thead><tr class="header"><th style="text-align: left;">Name</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>T</code></td></tr></tbody></table>
...
<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>id</code></td><td style="text-align: left;"><em>string</em></td></tr></tbody></table>

**Returns:** T

Defined in: [index.esm.d.ts:1301 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1301)

------------------------------------------------------------------------

### <a href="#register" class="header-anchor">#</a> register

▸ **register**(`item`: [*ChartComponent*](/docs/3.2.0/api/interfaces/chartcomponent.html)): *string*

#### <a href="#parameters-2" class="header-anchor">#</a> Parameters:

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>item</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/chartcomponent.html"><em>ChartComponent</em></a></td></tr></tbody></table>

**Returns:** *string*

The scope where items defaults were registered to.

Defined in: [index.esm.d.ts:1300 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1300)

------------------------------------------------------------------------

### <a href="#unregister" class="header-anchor">#</a> unregister

▸ **unregister**(`item`: [*ChartComponent*](/docs/3.2.0/api/interfaces/chartcomponent.html)): *void*
...
Defined in: [index.esm.d.ts:1302 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1302)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/tooltipoptions.html" class="prev">TooltipOptions</a> </span> <span class="next"> [VisualElement](/docs/3.2.0/api/interfaces/visualelement.html) → </span>
