...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/bubbledatapoint.html" class="active sidebar-link">BubbleDataPoint</a>
...
<a href="#interface-bubbledatapoint" class="header-anchor">#</a> Interface: BubbleDataPoint
===========================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#r" class="header-anchor">#</a> r

• **r**: *number*

Bubble radius in pixels (not scaled).

Defined in: [index.esm.d.ts:164 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L164)
...
Defined in: [index.esm.d.ts:154 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L154)
...
Defined in: [index.esm.d.ts:159 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L159)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/bubblecontrollerdatasetoptions.html" class="prev">BubbleControllerDatasetOptions</a> </span> <span class="next"> [CartesianScaleOptions](/docs/3.2.0/api/interfaces/cartesianscaleoptions.html) → </span>
