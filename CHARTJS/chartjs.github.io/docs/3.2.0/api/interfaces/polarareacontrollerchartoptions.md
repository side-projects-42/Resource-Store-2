...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/polarareacontrollerchartoptions.html" class="active sidebar-link">PolarAreaControllerChartOptions</a>
...
<a href="#interface-polarareacontrollerchartoptions" class="header-anchor">#</a> Interface: PolarAreaControllerChartOptions
===========================================================================================================================
...
Defined in: [index.esm.d.ts:346 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L346)
...
Defined in: [index.esm.d.ts:344 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L344)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/polarareacontroller.html" class="prev">PolarAreaController</a> </span> <span class="next"> [PolarAreaControllerDatasetOptions](/docs/3.2.0/api/interfaces/polarareacontrollerdatasetoptions.html) → </span>
