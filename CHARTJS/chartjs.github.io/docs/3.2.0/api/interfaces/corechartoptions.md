...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/corechartoptions.html" class="active sidebar-link">CoreChartOptions</a>
...
-   [*AnimationOptions*](/docs/3.2.0/api/#animationoptions)&lt;TType&gt;
...
• **animation**: *false* | [*AnimationSpec*](/docs/3.2.0/api/#animationspec)&lt;TType&gt; & { `onComplete?`: (`event`: [*AnimationEvent*](/docs/3.2.0/api/interfaces/animationevent.html)) =&gt; *void* ; `onProgress?`: (`event`: [*AnimationEvent*](/docs/3.2.0/api/interfaces/animationevent.html)) =&gt; *void* }
...
<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>padding</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/#scriptable"><em>Scriptable</em></a>&lt;number | <a href="/docs/3.2.0/api/interfaces/chartarea.html"><em>ChartArea</em></a>, <a href="/docs/3.2.0/api/interfaces/scriptablecontext.html"><em>ScriptableContext</em></a>&lt;TType&gt;&gt;</td></tr></tbody></table>
...
Inherited from: [ParsingOptions](/docs/3.2.0/api/interfaces/parsingoptions.html).[normalized](/docs/3.2.0/api/interfaces/parsingoptions.html#normalized)
...
Inherited from: [ParsingOptions](/docs/3.2.0/api/interfaces/parsingoptions.html).[parsing](/docs/3.2.0/api/interfaces/parsingoptions.html#parsing)
...
• **transitions**: [*TransitionsSpec*](/docs/3.2.0/api/#transitionsspec)&lt;TType&gt;
...
<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/controllerdatasetoptions.html" class="prev">ControllerDatasetOptions</a> </span> <span class="next"> [CoreInteractionOptions](/docs/3.2.0/api/interfaces/coreinteractionoptions.html) → </span>
