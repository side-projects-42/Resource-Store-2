...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/tick.html" class="active sidebar-link">Tick</a>
...
<a href="#interface-tick" class="header-anchor">#</a> Interface: Tick
=====================================================================
...
Defined in: [index.esm.d.ts:1064 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1064)

------------------------------------------------------------------------

### <a href="#major" class="header-anchor">#</a> major

• `Optional` **major**: *boolean*

Defined in: [index.esm.d.ts:1065 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1065)

------------------------------------------------------------------------

### <a href="#value" class="header-anchor">#</a> value

• **value**: *number*

Defined in: [index.esm.d.ts:1063 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1063)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/segment.html" class="prev">Segment</a> </span> <span class="next"> [TickOptions](/docs/3.2.0/api/interfaces/tickoptions.html) → </span>
