...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/interactionmodemap.html" class="active sidebar-link">InteractionModeMap</a>
...
<a href="#interface-interactionmodemap" class="header-anchor">#</a> Interface: InteractionModeMap
=================================================================================================
...
• **dataset**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)
...
Defined in: [index.esm.d.ts:681 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L681)

------------------------------------------------------------------------

### <a href="#index" class="header-anchor">#</a> index

• **index**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)
...
Defined in: [index.esm.d.ts:675 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L675)

------------------------------------------------------------------------

### <a href="#nearest" class="header-anchor">#</a> nearest

• **nearest**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)

nearest mode returns the element closest to the point

Defined in: [index.esm.d.ts:690 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L690)

------------------------------------------------------------------------

### <a href="#point" class="header-anchor">#</a> point

• **point**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)

Point mode returns all elements that hit test based on the event position of the event

Defined in: [index.esm.d.ts:686 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L686)

------------------------------------------------------------------------

### <a href="#x" class="header-anchor">#</a> x

• **x**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)

x mode returns the elements that hit-test at the current x coordinate

Defined in: [index.esm.d.ts:694 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L694)

------------------------------------------------------------------------

### <a href="#y" class="header-anchor">#</a> y

• **y**: [*InteractionModeFunction*](/docs/3.2.0/api/#interactionmodefunction)

y mode returns the elements that hit-test at the current y coordinate

Defined in: [index.esm.d.ts:698 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L698)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/interactionitem.html" class="prev">InteractionItem</a> </span> <span class="next"> [InteractionOptions](/docs/3.2.0/api/interfaces/interactionoptions.html) → </span>
