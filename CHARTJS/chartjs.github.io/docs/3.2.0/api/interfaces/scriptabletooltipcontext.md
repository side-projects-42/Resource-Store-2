...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/scriptabletooltipcontext.html" class="active sidebar-link">ScriptableTooltipContext</a>
...
<a href="#interface-scriptabletooltipcontext-ttype" class="header-anchor">#</a> Interface: ScriptableTooltipContext&lt;TType&gt;
================================================================================================================================
...
Defined in: [index.esm.d.ts:2392 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2392)

------------------------------------------------------------------------

### <a href="#tooltip" class="header-anchor">#</a> tooltip

• **tooltip**: [*TooltipModel*](/docs/3.2.0/api/interfaces/tooltipmodel.html)&lt;TType&gt;

Defined in: [index.esm.d.ts:2393 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2393)

------------------------------------------------------------------------

### <a href="#tooltipitems" class="header-anchor">#</a> tooltipItems

• **tooltipItems**: [*TooltipItem*](/docs/3.2.0/api/interfaces/tooltipitem.html)&lt;TType&gt;\[\]

Defined in: [index.esm.d.ts:2394 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2394)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/scriptablescalecontext.html" class="prev">ScriptableScaleContext</a> </span> <span class="next"> [Segment](/docs/3.2.0/api/interfaces/segment.html) → </span>
