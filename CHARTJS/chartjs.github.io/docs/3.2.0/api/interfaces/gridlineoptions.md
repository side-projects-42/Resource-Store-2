...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/gridlineoptions.html" class="active sidebar-link">GridLineOptions</a>
...
<a href="#interface-gridlineoptions" class="header-anchor">#</a> Interface: GridLineOptions
===========================================================================================
...
Defined in: [index.esm.d.ts:2634 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2634)
...
Defined in: [index.esm.d.ts:2647 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2647)

------------------------------------------------------------------------

### <a href="#borderdashoffset" class="header-anchor">#</a> borderDashOffset

• **borderDashOffset**: [*Scriptable*](/docs/3.2.0/api/#scriptable)&lt;number, [*ScriptableScaleContext*](/docs/3.2.0/api/interfaces/scriptablescalecontext.html)&gt;

**`default`** 0

Defined in: [index.esm.d.ts:2651 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2651)
...
Defined in: [index.esm.d.ts:2635 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2635)

------------------------------------------------------------------------

### <a href="#circular" class="header-anchor">#</a> circular

• **circular**: *boolean*

**`default`** false

Defined in: [index.esm.d.ts:2639 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2639)

------------------------------------------------------------------------

### <a href="#color" class="header-anchor">#</a> color

• **color**: *string* | CanvasGradient | CanvasPattern | readonly [*Color*](/docs/3.2.0/api/#color)\[\] | (`ctx`: [*ScriptableScaleContext*](/docs/3.2.0/api/interfaces/scriptablescalecontext.html), `options`: *Record*&lt;string, unknown&gt;) =&gt; [*Color*](/docs/3.2.0/api/#color)

**`default`** 'rgba(0, 0, 0, 0.1)'

Defined in: [index.esm.d.ts:2643 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2643)
...
Defined in: [index.esm.d.ts:2633 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2633)

------------------------------------------------------------------------

### <a href="#drawborder" class="header-anchor">#</a> drawBorder

• **drawBorder**: *boolean*

**`default`** true

Defined in: [index.esm.d.ts:2660 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2660)

------------------------------------------------------------------------

### <a href="#drawonchartarea" class="header-anchor">#</a> drawOnChartArea

• **drawOnChartArea**: *boolean*

**`default`** true

Defined in: [index.esm.d.ts:2664 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2664)

------------------------------------------------------------------------

### <a href="#drawticks" class="header-anchor">#</a> drawTicks

• **drawTicks**: *boolean*

**`default`** true

Defined in: [index.esm.d.ts:2668 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2668)

------------------------------------------------------------------------

### <a href="#linewidth" class="header-anchor">#</a> lineWidth

• **lineWidth**: *number* | readonly *number*\[\] | (`ctx`: [*ScriptableScaleContext*](/docs/3.2.0/api/interfaces/scriptablescalecontext.html), `options`: *Record*&lt;string, unknown&gt;) =&gt; *number*

**`default`** 1

Defined in: [index.esm.d.ts:2655 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2655)
...
Defined in: [index.esm.d.ts:2692 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2692)

------------------------------------------------------------------------

### <a href="#tickborderdash" class="header-anchor">#</a> tickBorderDash

• **tickBorderDash**: *number*\[\]

**`default`** \[\]

Defined in: [index.esm.d.ts:2672 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2672)

------------------------------------------------------------------------

### <a href="#tickborderdashoffset" class="header-anchor">#</a> tickBorderDashOffset

• **tickBorderDashOffset**: [*Scriptable*](/docs/3.2.0/api/#scriptable)&lt;number, [*ScriptableScaleContext*](/docs/3.2.0/api/interfaces/scriptablescalecontext.html)&gt;

**`default`** 0

Defined in: [index.esm.d.ts:2676 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2676)

------------------------------------------------------------------------

### <a href="#tickcolor" class="header-anchor">#</a> tickColor

• **tickColor**: *string* | CanvasGradient | CanvasPattern | readonly [*Color*](/docs/3.2.0/api/#color)\[\] | (`ctx`: [*ScriptableScaleContext*](/docs/3.2.0/api/interfaces/scriptablescalecontext.html), `options`: *Record*&lt;string, unknown&gt;) =&gt; [*Color*](/docs/3.2.0/api/#color)

**`default`** 'rgba(0, 0, 0, 0.1)'

Defined in: [index.esm.d.ts:2680 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2680)

------------------------------------------------------------------------

### <a href="#ticklength" class="header-anchor">#</a> tickLength

• **tickLength**: *number*

**`default`** 10

Defined in: [index.esm.d.ts:2684 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2684)

------------------------------------------------------------------------

### <a href="#tickwidth" class="header-anchor">#</a> tickWidth

• **tickWidth**: *number*

**`default`** 1

Defined in: [index.esm.d.ts:2688 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2688)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/fontspec.html" class="prev">FontSpec</a> </span> <span class="next"> [InteractionItem](/docs/3.2.0/api/interfaces/interactionitem.html) → </span>
