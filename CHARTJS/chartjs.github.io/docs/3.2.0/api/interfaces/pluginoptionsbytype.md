...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/pluginoptionsbytype.html" class="active sidebar-link">PluginOptionsByType</a>
...
<a href="#interface-pluginoptionsbytype-ttype" class="header-anchor">#</a> Interface: PluginOptionsByType&lt;TType&gt;
======================================================================================================================
...
• **decimation**: [*DecimationOptions*](/docs/3.2.0/api/#decimationoptions)

Defined in: [index.esm.d.ts:2619 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2619)

------------------------------------------------------------------------

### <a href="#filler" class="header-anchor">#</a> filler

• **filler**: [*FillerOptions*](/docs/3.2.0/api/interfaces/filleroptions.html)

Defined in: [index.esm.d.ts:2620 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2620)

------------------------------------------------------------------------

### <a href="#legend" class="header-anchor">#</a> legend

• **legend**: [*LegendOptions*](/docs/3.2.0/api/interfaces/legendoptions.html)

Defined in: [index.esm.d.ts:2621 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2621)

------------------------------------------------------------------------

### <a href="#title" class="header-anchor">#</a> title

• **title**: [*TitleOptions*](/docs/3.2.0/api/interfaces/titleoptions.html)

Defined in: [index.esm.d.ts:2622 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2622)

------------------------------------------------------------------------

### <a href="#tooltip" class="header-anchor">#</a> tooltip

• **tooltip**: [*TooltipOptions*](/docs/3.2.0/api/interfaces/tooltipoptions.html)&lt;TType&gt;

Defined in: [index.esm.d.ts:2623 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2623)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/pluginchartoptions.html" class="prev">PluginChartOptions</a> </span> <span class="next"> [Point](/docs/3.2.0/api/interfaces/point.html) → </span>
