...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/barelement.html" class="active sidebar-link">BarElement</a>
...
<a href="#interface-barelement-t-o" class="header-anchor">#</a> Interface: BarElement&lt;T, O&gt;
=================================================================================================

<a href="#type-parameters" class="header-anchor">#</a> Type parameters
----------------------------------------------------------------------

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th><th style="text-align: left;">Default</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>T</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/barprops.html"><em>BarProps</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/barprops.html"><em>BarProps</em></a></td></tr><tr class="even"><td style="text-align: left;"><code>O</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/baroptions.html"><em>BarOptions</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/baroptions.html"><em>BarOptions</em></a></td></tr></tbody></table>
...
<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/barcontrollerdatasetoptions.html" class="prev">BarControllerDatasetOptions</a> </span> <span class="next"> [BarHoverOptions](/docs/3.2.0/api/interfaces/barhoveroptions.html) → </span>
