...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/segment.html" class="active sidebar-link">Segment</a>
...
<a href="#interface-segment" class="header-anchor">#</a> Interface: Segment
===========================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#end" class="header-anchor">#</a> end

• **end**: *number*

Defined in: [index.esm.d.ts:1599 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1599)
...
Defined in: [index.esm.d.ts:1600 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1600)
...
Defined in: [index.esm.d.ts:1598 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L1598)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/scriptabletooltipcontext.html" class="prev">ScriptableTooltipContext</a> </span> <span class="next"> [Tick](/docs/3.2.0/api/interfaces/tick.html) → </span>
