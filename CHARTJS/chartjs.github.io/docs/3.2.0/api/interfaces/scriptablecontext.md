...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/scriptablecontext.html" class="active sidebar-link">ScriptableContext</a>
...
<a href="#interface-scriptablecontext-ttype" class="header-anchor">#</a> Interface: ScriptableContext&lt;TType&gt;
==================================================================================================================
...
Defined in: [index.esm.d.ts:19 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L19)

------------------------------------------------------------------------

### <a href="#chart" class="header-anchor">#</a> chart

• **chart**: [*Chart*](/docs/3.2.0/api/classes/chart.html)&lt;TType, [*ChartTypeRegistry*](/docs/3.2.0/api/interfaces/charttyperegistry.html)\[TType\]\[*defaultDataPoint*\]\[\], unknown&gt;

Defined in: [index.esm.d.ts:20 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L20)
...
Defined in: [index.esm.d.ts:21 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L21)

------------------------------------------------------------------------

### <a href="#dataset" class="header-anchor">#</a> dataset

• **dataset**: *UnionToIntersection*&lt;[*ChartDataset*](/docs/3.2.0/api/#chartdataset)&lt;TType, [*ChartTypeRegistry*](/docs/3.2.0/api/interfaces/charttyperegistry.html)\[TType\]\[*defaultDataPoint*\]\[\]&gt;&gt;

Defined in: [index.esm.d.ts:22 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L22)
...
Defined in: [index.esm.d.ts:23 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L23)
...
Defined in: [index.esm.d.ts:24 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L24)
...
Defined in: [index.esm.d.ts:25 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L25)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/scatterdatapoint.html" class="prev">ScatterDataPoint</a> </span> <span class="next"> [ScriptableLineSegmentContext](/docs/3.2.0/api/interfaces/scriptablelinesegmentcontext.html) → </span>
