...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/scriptablelinesegmentcontext.html" class="active sidebar-link">ScriptableLineSegmentContext</a>
...
<a href="#interface-scriptablelinesegmentcontext" class="header-anchor">#</a> Interface: ScriptableLineSegmentContext
=====================================================================================================================

<a href="#properties" class="header-anchor">#</a> Properties
------------------------------------------------------------

### <a href="#p0" class="header-anchor">#</a> p0

• **p0**: [*PointElement*](/docs/3.2.0/api/#pointelement)&lt;[*PointProps*](/docs/3.2.0/api/interfaces/pointprops.html), [*PointOptions*](/docs/3.2.0/api/interfaces/pointoptions.html)&gt;

Defined in: [index.esm.d.ts:30 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L30)

------------------------------------------------------------------------

### <a href="#p1" class="header-anchor">#</a> p1

• **p1**: [*PointElement*](/docs/3.2.0/api/#pointelement)&lt;[*PointProps*](/docs/3.2.0/api/interfaces/pointprops.html), [*PointOptions*](/docs/3.2.0/api/interfaces/pointoptions.html)&gt;

Defined in: [index.esm.d.ts:31 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L31)
...
Defined in: [index.esm.d.ts:29 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L29)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/scriptablecontext.html" class="prev">ScriptableContext</a> </span> <span class="next"> [ScriptableScaleContext](/docs/3.2.0/api/interfaces/scriptablescalecontext.html) → </span>
