...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/arcelement.html" class="active sidebar-link">ArcElement</a>
...
<a href="#interface-arcelement-t-o" class="header-anchor">#</a> Interface: ArcElement&lt;T, O&gt;
=================================================================================================

<a href="#type-parameters" class="header-anchor">#</a> Type parameters
----------------------------------------------------------------------

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th><th style="text-align: left;">Default</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>T</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/arcprops.html"><em>ArcProps</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/arcprops.html"><em>ArcProps</em></a></td></tr><tr class="even"><td style="text-align: left;"><code>O</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/arcoptions.html"><em>ArcOptions</em></a></td><td style="text-align: left;"><a href="/docs/3.2.0/api/interfaces/arcoptions.html"><em>ArcOptions</em></a></td></tr></tbody></table>
...
<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/arcborderradius.html" class="prev">ArcBorderRadius</a> </span> <span class="next"> [ArcHoverOptions](/docs/3.2.0/api/interfaces/archoveroptions.html) → </span>
