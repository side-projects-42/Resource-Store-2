...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/tooltipitem.html" class="active sidebar-link">TooltipItem</a>
...
• **chart**: [*Chart*](/docs/3.2.0/api/classes/chart.html)&lt;*bar* | *line* | *scatter* | *bubble* | *pie* | *doughnut* | *polarArea* | *radar*, (number | [*ScatterDataPoint*](/docs/3.2.0/api/interfaces/scatterdatapoint.html) | [*BubbleDataPoint*](/docs/3.2.0/api/interfaces/bubbledatapoint.html))\[\], unknown&gt;

The chart the tooltip is being shown on

Defined in: [index.esm.d.ts:2575 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2575)
...
Defined in: [index.esm.d.ts:2610 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2610)

------------------------------------------------------------------------

### <a href="#dataset" class="header-anchor">#</a> dataset

• **dataset**: [*ChartDataset*](/docs/3.2.0/api/#chartdataset)&lt;*bar* | *line* | *scatter* | *bubble* | *pie* | *doughnut* | *polarArea* | *radar*, (number | [*ScatterDataPoint*](/docs/3.2.0/api/interfaces/scatterdatapoint.html) | [*BubbleDataPoint*](/docs/3.2.0/api/interfaces/bubbledatapoint.html))\[\]&gt;

The dataset the item comes from

Defined in: [index.esm.d.ts:2600 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2600)
...
Defined in: [index.esm.d.ts:2605 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2605)

------------------------------------------------------------------------

### <a href="#element" class="header-anchor">#</a> element

• **element**: [*Element*](/docs/3.2.0/api/#element)&lt;{}, {}&gt;

The chart element (point, arc, bar, etc.) for this tooltip item

Defined in: [index.esm.d.ts:2615 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2615)
...
Defined in: [index.esm.d.ts:2595 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2595)
...
Defined in: [index.esm.d.ts:2580 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2580)

------------------------------------------------------------------------

### <a href="#parsed" class="header-anchor">#</a> parsed

• **parsed**: *UnionToIntersection*&lt;[*ParsedDataType*](/docs/3.2.0/api/#parseddatatype)&lt;TType&gt;&gt;

Parsed data values for the given `dataIndex` and `datasetIndex`

Defined in: [index.esm.d.ts:2585 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2585)
...
Defined in: [index.esm.d.ts:2590 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L2590)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/tooltipcallbacks.html" class="prev">TooltipCallbacks</a> </span> <span class="next"> [TooltipLabelStyle](/docs/3.2.0/api/interfaces/tooltiplabelstyle.html) → </span>
