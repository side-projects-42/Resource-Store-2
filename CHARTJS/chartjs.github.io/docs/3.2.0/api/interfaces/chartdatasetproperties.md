...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/chartdatasetproperties.html" class="active sidebar-link">ChartDatasetProperties</a>
...
<a href="#interface-chartdatasetproperties-ttype-tdata" class="header-anchor">#</a> Interface: ChartDatasetProperties&lt;TType, TData&gt;
=========================================================================================================================================

<a href="#type-parameters" class="header-anchor">#</a> Type parameters
----------------------------------------------------------------------

<table><thead><tr class="header"><th style="text-align: left;">Name</th><th style="text-align: left;">Type</th></tr></thead><tbody><tr class="odd"><td style="text-align: left;"><code>TType</code></td><td style="text-align: left;"><a href="/docs/3.2.0/api/#charttype"><em>ChartType</em></a></td></tr><tr class="even"><td style="text-align: left;"><code>TData</code></td><td style="text-align: left;">-</td></tr></tbody></table>
...
Defined in: [index.esm.d.ts:3337 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3337)
...
Defined in: [index.esm.d.ts:3336 <span class="sr-only">(opens new window)</span>](https://github.com/chartjs/Chart.js/blob/0f1d07a/types/index.esm.d.ts#L3336)

<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/chartdata.html" class="prev">ChartData</a> </span> <span class="next"> [ChartEvent](/docs/3.2.0/api/interfaces/chartevent.html) → </span>
