...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.2.0/api/interfaces/pluginchartoptions.html" class="active sidebar-link">PluginChartOptions</a>
...
• **plugins**: [*PluginOptionsByType*](/docs/3.2.0/api/interfaces/pluginoptionsbytype.html)&lt;TType&gt;
...
<span class="prev"> ← <a href="/docs/3.2.0/api/interfaces/plugin.html" class="prev">Plugin</a> </span> <span class="next"> [PluginOptionsByType](/docs/3.2.0/api/interfaces/pluginoptionsbytype.html) → </span>
