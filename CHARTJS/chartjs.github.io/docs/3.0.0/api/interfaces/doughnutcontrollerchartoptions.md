...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/doughnutcontrollerchartoptions.html" class="active sidebar-link">DoughnutControllerChartOptions</a>
...
<a href="#interface-doughnutcontrollerchartoptions" class="header-anchor">#</a> Interface: DoughnutControllerChartOptions
=========================================================================================================================
...
• **animation**: [*DoughnutAnimationOptions*](/docs/3.0.0/api/interfaces/doughnutanimationoptions.html)

Defined in: [index.esm.d.ts:291 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L291)
...
Defined in: [index.esm.d.ts:270 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L270)

------------------------------------------------------------------------

### <a href="#cutout" class="header-anchor">#</a> cutout

• **cutout**: [*Scriptable*](/docs/3.0.0/api/#scriptable)&lt;string | number, [*ScriptableContext*](/docs/3.0.0/api/interfaces/scriptablecontext.html)&lt;*doughnut*&gt;&gt;
...
Defined in: [index.esm.d.ts:277 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L277)

------------------------------------------------------------------------

### <a href="#radius" class="header-anchor">#</a> radius

• **radius**: [*Scriptable*](/docs/3.0.0/api/#scriptable)&lt;string | number, [*ScriptableContext*](/docs/3.0.0/api/interfaces/scriptablecontext.html)&lt;*doughnut*&gt;&gt;

The outer radius of the chart. String ending with '%' means percentage of maximum radius, number means pixels.

**`default`** '100%'

Defined in: [index.esm.d.ts:283 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L283)
...
Defined in: [index.esm.d.ts:289 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L289)

<span class="prev"> ← <a href="/docs/3.0.0/api/interfaces/doughnutcontroller.html" class="prev">DoughnutController</a> </span> <span class="next"> [DoughnutControllerDatasetOptions](/docs/3.0.0/api/interfaces/doughnutcontrollerdatasetoptions.html) → </span>
