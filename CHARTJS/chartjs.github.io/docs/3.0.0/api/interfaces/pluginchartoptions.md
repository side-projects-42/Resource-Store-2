...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/pluginchartoptions.html" class="active sidebar-link">PluginChartOptions</a>
...
<a href="#interface-pluginchartoptions-ttype" class="header-anchor">#</a> Interface: PluginChartOptions&lt;TType&gt;
====================================================================================================================
...
• **plugins**: [*PluginOptionsByType*](/docs/3.0.0/api/interfaces/pluginoptionsbytype.html)&lt;TType&gt;

Defined in: [index.esm.d.ts:2557 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2557)

<span class="prev"> ← <a href="/docs/3.0.0/api/interfaces/plugin.html" class="prev">Plugin</a> </span> <span class="next"> [PluginOptionsByType](/docs/3.0.0/api/interfaces/pluginoptionsbytype.html) → </span>
