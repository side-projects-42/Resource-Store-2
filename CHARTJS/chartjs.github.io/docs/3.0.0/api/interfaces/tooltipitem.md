...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/borderradius.html" class="sidebar-link">BorderRadius</a>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/interactionoptions.html" class="sidebar-link">InteractionOptions</a>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/tooltipitem.html" class="active sidebar-link">TooltipItem</a>
...
<a href="#interface-tooltipitem-ttype" class="header-anchor">#</a> Interface: TooltipItem&lt;TType&gt;
======================================================================================================
...
• **chart**: [*Chart*](/docs/3.0.0/api/classes/chart.html)&lt;*bar* | *line* | *scatter* | *bubble* | *pie* | *doughnut* | *polarArea* | *radar*, (number | [*ScatterDataPoint*](/docs/3.0.0/api/interfaces/scatterdatapoint.html) | [*BubbleDataPoint*](/docs/3.0.0/api/interfaces/bubbledatapoint.html))\[\], unknown&gt;

The chart the tooltip is being shown on

Defined in: [index.esm.d.ts:2506 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2506)

------------------------------------------------------------------------

### <a href="#dataindex" class="header-anchor">#</a> dataIndex

• **dataIndex**: *number*

Index of this data item in the dataset

Defined in: [index.esm.d.ts:2541 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2541)

------------------------------------------------------------------------

### <a href="#dataset" class="header-anchor">#</a> dataset

• **dataset**: [*ChartDataset*](/docs/3.0.0/api/#chartdataset)&lt;*bar* | *line* | *scatter* | *bubble* | *pie* | *doughnut* | *polarArea* | *radar*, (number | [*ScatterDataPoint*](/docs/3.0.0/api/interfaces/scatterdatapoint.html) | [*BubbleDataPoint*](/docs/3.0.0/api/interfaces/bubbledatapoint.html))\[\]&gt;

The dataset the item comes from

Defined in: [index.esm.d.ts:2531 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2531)
...
Defined in: [index.esm.d.ts:2536 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2536)

------------------------------------------------------------------------

### <a href="#element" class="header-anchor">#</a> element

• **element**: [*Element*](/docs/3.0.0/api/#element)&lt;{}, {}&gt;

The chart element (point, arc, bar, etc.) for this tooltip item

Defined in: [index.esm.d.ts:2546 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2546)

------------------------------------------------------------------------

### <a href="#formattedvalue" class="header-anchor">#</a> formattedValue

• **formattedValue**: *string*

Formatted value for the tooltip

Defined in: [index.esm.d.ts:2526 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2526)
...
Defined in: [index.esm.d.ts:2511 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2511)

------------------------------------------------------------------------

### <a href="#parsed" class="header-anchor">#</a> parsed

• **parsed**: *UnionToIntersection*&lt;[*ParsedDataType*](/docs/3.0.0/api/#parseddatatype)&lt;TType&gt;&gt;

Parsed data values for the given `dataIndex` and `datasetIndex`

Defined in: [index.esm.d.ts:2516 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2516)

------------------------------------------------------------------------

### <a href="#raw" class="header-anchor">#</a> raw

• **raw**: *unknown*

Raw data values for the given `dataIndex` and `datasetIndex`

Defined in: [index.esm.d.ts:2521 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L2521)

<span class="prev"> ← <a href="/docs/3.0.0/api/interfaces/tooltipcallbacks.html" class="prev">TooltipCallbacks</a> </span> <span class="next"> [TooltipModel](/docs/3.0.0/api/interfaces/tooltipmodel.html) → </span>
