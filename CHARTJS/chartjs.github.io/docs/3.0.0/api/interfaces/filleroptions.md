...
-   API <span class="arrow down"></span>
    ...
    -   Interfaces <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.0.0/api/interfaces/filleroptions.html" class="active sidebar-link">FillerOptions</a>
...
Defined in: [index.esm.d.ts:1947 <span class="sr-only">(opens new window)</span>](https://github.com/etimberg/Chart.js/blob/8780e15/types/index.esm.d.ts#L1947)

<span class="prev"> ← <a href="/docs/3.0.0/api/interfaces/fillercontrollerdatasetoptions.html" class="prev">FillerControllerDatasetOptions</a> </span> <span class="next"> [FontSpec](/docs/3.0.0/api/interfaces/fontspec.html) → </span>
