...
-   Configuration <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/configuration/device-pixel-ratio.html" class="active sidebar-link">Device Pixel Ratio</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/configuration/responsive.html" class="prev">Responsive Charts</a> </span> <span class="next"> [Locale](/docs/3.0.0/configuration/locale.html) → </span>
