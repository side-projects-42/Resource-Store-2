...
-   Axes <span class="arrow down"></span>
    ...
    -   Cartesian <span class="arrow down"></span>
        ...
        -   <a href="/docs/3.0.0/axes/cartesian/category.html" class="active sidebar-link">Category Axis</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/axes/cartesian/" class="prev router-link-active">Cartesian Axes</a> </span> <span class="next"> [Linear Axis](/docs/3.0.0/axes/cartesian/linear.html) → </span>
