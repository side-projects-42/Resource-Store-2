...
-   Bar Charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/samples/bar/horizontal.html" class="active sidebar-link">Horizontal Bar Chart</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/samples/bar/vertical.html" class="prev">Vertical Bar Chart</a> </span> <span class="next"> [Stacked Bar Chart](/docs/3.0.0/samples/bar/stacked.html) → </span>
