...
-   Animations <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/samples/animations/drop.html" class="active sidebar-link">Drop</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/samples/animations/delay.html" class="prev">Delay</a> </span> <span class="next"> [Loop](/docs/3.0.0/samples/animations/loop.html) → </span>
