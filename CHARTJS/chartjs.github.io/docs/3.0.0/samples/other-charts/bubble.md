...
-   Other charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/samples/other-charts/bubble.html" class="active sidebar-link">Bubble</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/samples/line/styling.html" class="prev">Line Styling</a> </span> <span class="next"> [Scatter](/docs/3.0.0/samples/other-charts/scatter.html) → </span>
