...
-   Line Charts <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/samples/line/line.html" class="active sidebar-link">Line Chart</a>
...
<a href="https://github.com/chartjs/Chart.js/blob/master/docs/samples/line/line.md" class="code-editor-tool fab fa-github fa-lg" title="View on GitHub"></a>
...
<span class="prev"> ← <a href="/docs/3.0.0/samples/bar/border-radius.html" class="prev">Bar Chart Border Radius</a> </span> <span class="next"> [Multi Axis Line Chart](/docs/3.0.0/samples/line/multi-axis.html) → </span>
