...
-   Scales <span class="arrow down"></span>
    ...
    -   <a href="/docs/3.0.0/samples/scales/linear-min-max.html" class="active sidebar-link">Linear Scale - Min-Max</a>
...
<span class="prev"> ← <a href="/docs/3.0.0/samples/area/radar.html" class="prev">Radar Chart Stacked</a> </span> <span class="next"> [Linear Scale - Suggested Min-Max](/docs/3.0.0/samples/scales/linear-min-max-suggested.html) → </span>
