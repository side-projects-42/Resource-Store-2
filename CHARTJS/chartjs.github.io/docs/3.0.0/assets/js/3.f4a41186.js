  ...
  [3],
  {
        ...
        function y(t, e, i, s, r) {
          ...
          !(function (t, e, i, s, r) {
            ...
            (t.reach[h] = null),
              ...
              p[o] > t[n] - t[a] - 1 && (t.reach[h] = "end"),
              e &&
                (p.dispatchEvent(x("ps-scroll-" + h)),
                e < 0
                  ? p.dispatchEvent(x("ps-scroll-" + l))
                  : e > 0 && p.dispatchEvent(x("ps-scroll-" + c)),
                s &&
                  (function (t, e) {
                    d(t, e), f(t, e);
                  })(t, h)),
              t.reach[h] &&
                (e || r) &&
                p.dispatchEvent(x("ps-" + h + "-reach-" + t.reach[h]));
          })(t, i, n, s, r);
        }
        function b(t) {
        ...
        function S(t, e) {
          ...
          function y() {
            f(t, l),
              ...
              t.event.unbind(t.ownerDocument, "mousemove", x);
          }
          function b(e, a) {
            (m = u[h]),
              ...
              (v = (t[s] - t[i]) / (t[n] - t[o])),
              a
                ? t.event.bind(t.ownerDocument, "touchmove", x)
                : (t.event.bind(t.ownerDocument, "mousemove", x),
              ...
              function s(s) {
                ...
                if (
                  !(function (t, s, r) {
                    ...
                    for (var n = t; n && n !== i; ) {
                      if (n.classList.contains(c.consuming)) return !0;
                      var a = e(n);
                      ...
                      if (s && a.overflowX.match(/(scroll|auto)/)) {
                  ...
                  g > 0 && ((n.x = d / g), (n.y = f / g), (r = m)),
                    (function (e, s) {
                      ...
                      if (o > a) {
                        ...
                        a > o &&
                        ((e < 0 && n === t.contentWidth - t.containerWidth) ||
                          (e > 0 && 0 === n))
                      )
                        return !0;
                      return !0;
                    })(d, f) && a.preventDefault();
                }
              }
              function d() {
                  ...
                  (a = setInterval(function () {
                    t.isInitialized
                      ...
                      ? Math.abs(n.x) < 0.01 && Math.abs(n.y) < 0.01
                        ? clearInterval(a)
                        : (o(30 * n.x, 30 * n.y), (n.x *= 0.8), (n.y *= 0.8))
                      : clearInterval(a);
                  }, 10)));
              }
            },
        ...
        (E.prototype.update = function () {
          ...
          (E.prototype.onScroll = function (t) {
            this.isAlive &&
              ...
              y(this, "left", this.element.scrollLeft - this.lastScrollLeft),
    ...
    309: function (t, e, i) {
      var s = (function (t) {
          ...
          s = {
            ...
            util: {
              ...
              clone: function t(e, i) {
                ...
                switch (((i = i || {}), s.util.type(e))) {
                  case "Object":
                    if (((n = s.util.objId(e)), i[n])) return i[n];
                    for (var a in ((r = {}), (i[n] = r), e))
                      e.hasOwnProperty(a) && (r[a] = t(e[a], i));
                    return r;
                  case "Array":
                    return (
                      (n = s.util.objId(e)),
            ...
            languages: {
              ...
              insertBefore: function (t, e, i, r) {
                var n = (r = r || s.languages)[t],
                  a = {};
                for (var o in n)
                  if (n.hasOwnProperty(o)) {
                    if (o == e)
                      for (var h in i) i.hasOwnProperty(h) && (a[h] = i[h]);
                    i.hasOwnProperty(o) || (a[o] = n[o]);
                  }
                var l = r[t];
                return (
                  (r[t] = a),
            ...
            highlightAllUnder: function (t, e, i) {
              ...
              for (var n, a = 0; (n = r.elements[a++]); )
                s.highlightElement(n, !0 === e, r.callback);
            },
            highlightElement: function (i, r, n) {
              var a = s.util.getLanguage(i),
                o = s.languages[a];
              i.className =
              ...
              if ((s.hooks.run("before-sanity-check", l), !l.code))
                return (
                  s.hooks.run("complete", l), void (n && n.call(l.element))
                );
                        ...
                        for (
                          ...
                          if (!(S instanceof r)) {
                            var C,
                              E = 1;
                            if (x) {
                              if (!(C = n(_, w, e, v))) break;
                              var A = C.index,
                                P = C.index + C[0].length,
                                L = w;
                              for (L += k.value.length; A >= L; )
                              ...
                              for (
                                var I = k;
                                I !== i.tail &&
                                (L < P || "string" == typeof I.value);
                                I = I.next
                              )
                                E++, (L += I.value.length);
                              E--, (S = e.slice(w, L)), (C.index -= w);
                            ...
                            var M = k.prev;
                            N && ((M = o(i, M, N)), (w += N.length)),
                              h(i, M, E);
                            var O = new r(u, g ? s.tokenize(T, g) : T, y, T);
                            (k = o(i, M, O)),
                              R && o(i, k, R),
                              E > 1 &&
                                t(e, i, a, k.prev, w, {
            ...
            hooks: {
              ...
              run: function (t, e) {
                var i = s.hooks.all[t];
                if (i && i.length) for (var r, n = 0; (r = i[n++]); ) r(e);
              },
            },
            Token: r,
          };
        ...
        if (
          ...
          (r.stringify = function t(e, i) {
            ...
            a &&
              ...
              s.hooks.run("wrap", n);
            var o = "";
            for (var h in n.attributes)
              o +=
                " " +
                h +
                '="' +
                (n.attributes[h] || "").replace(/"/g, "&quot;") +
                '"';
            return (
              "<" +
              n.tag +
                ...
                t.addEventListener(
                  ...
                  function (e) {
                    var i = JSON.parse(e.data),
                      ...
                      n = i.code,
                      a = i.immediateClose;
                    t.postMessage(s.highlight(n, s.languages[r], r)),
                      a && t.close();
                  },
                  !1
                ),
        ...
        if (
          (l &&
            ((s.filename = l.src),
            l.hasAttribute("data-manual") && (s.manual = !0)),
          !s.manual)
        ) {
          var p = document.readyState;
          "loading" === p || ("interactive" === p && l && l.defer)
    ...
    321: function (t, e, i) {
          ...
          B(e.onComment) &&
            (e.onComment = (function (t, e) {
              return function (i, s, r, n, a, o) {
                ...
                t.locations && (h.loc = new H(this, a, o)),
                  t.ranges && (h.range = [r, n]),
                  e.push(h);
              };
            })(e, e.onComment)),
          e
      ...
      var $ = function (t, e, i) {
          ...
          var n = (s ? s + " " : "") + l.strict;
          (this.reservedWordsStrict = F(n)),
            (this.reservedWordsStrictBind = F(n + " " + l.strictBind)),
            (this.input = String(e)),
            (this.containsEsc = !1),
            i
              ? ((this.pos = i),
      ...
      ($.prototype.parse = function () {
        ...
        ($.prototype.inNonArrowFunction = function () {
      ...
      (Q.isLet = function (t) {
        ...
        if (123 === s) return !0;
        if (b(s, !0)) {
          for (var r = i + 1; _(this.input.charCodeAt(r), !0); ) ++r;
        ...
        (Q.isAsyncFunction = function () {
          ...
          return !(
            L.test(this.input.slice(this.pos, e)) ||
            "function" !== this.input.slice(e, e + 8) ||
            (e + 8 !== this.input.length && _(this.input.charAt(e + 8)))
          );
        }),
          ...
          switch ((this.isLet(t) && ((r = P._var), (s = "let")), r)) {
            ...
            default:
              ...
              return r === P.name &&
                "Identifier" === c.type &&
                this.eat(P.colon)
                ? this.parseLabeledStatement(n, l, c, t)
                : this.parseExpressionStatement(n, c);
          }
        }),
        ...
        (Q.parseFunctionStatement = function (t, e, i) {
          return this.next(), this.parseFunction(t, et | (i ? 0 : it), !1, e);
        }),
      ...
      var et = 1,
        it = 2;
      (Q.parseFunction = function (t, e, i, s) {
        this.initFunction(t),
          (this.options.ecmaVersion >= 9 ||
            (this.options.ecmaVersion >= 6 && !s)) &&
            (this.type === P.star && e & it && this.unexpected(),
        ...
        return (
          ...
          e & et || (t.id = this.type === P.name ? this.parseIdent() : null),
          ...
          this.finishNode(
            t,
            e & et ? "FunctionDeclaration" : "FunctionExpression"
          )
        );
      }),
        ...
        (Q.parseClass = function (t, e) {
          ...
          var s = this.startNode(),
            r = !1;
          for (s.body = [], this.expect(P.braceL); this.type !== P.braceR; ) {
        ...
        (Q.parseExport = function (t, e) {
          ...
          if (this.eat(P._default)) {
            ...
            if (
              ...
              this.next(),
                i && this.next(),
                (t.declaration = this.parseFunction(s, 4 | et, !1, i));
        ...
        (Q.parseImport = function (t) {
          return (
            this.next(),
            this.type === P.string
              ? ((t.specifiers = tt), (t.source = this.parseExprAtom()))
      ...
      (st.toAssignable = function (t, e, i) {
        ...
        (st.parseBindingList = function (t, e, i) {
      ...
      var rt = $.prototype;
      (rt.checkPropClash = function (t, e, i) {
        if (
          !(
        ...
        (rt.parseMaybeAssign = function (t, e, i) {
          ...
          if ((i && (h = i.call(this, h, a, o)), this.type.isAssign)) {
            ...
            return (
              ...
              (l.left = this.type === P.eq ? this.toAssignable(h, !1, e) : h),
              s ||
                (e.parenthesizedAssign = e.trailingComma = e.doubleProto = -1),
              e.shorthandAssign >= l.left.start && (e.shorthandAssign = -1),
              this.checkLVal(h),
              this.next(),
        ...
        (rt.parseExprOp = function (t, e, i, s, r) {
          ...
          if (null != n && (!r || this.type !== P._in) && n > s) {
            ...
            o && (n = P.logicalAND.binop);
            var h = this.value;
            this.next();
            var l = this.start,
              c = this.startLoc,
              p = this.parseExprOp(this.parseMaybeUnary(null, !1), l, c, n, r),
              u = this.buildBinary(e, i, t, p, h, a || o);
            return (
              ((a && this.type === P.coalesce) ||
                (o &&
        ...
        (rt.buildBinary = function (t, e, i, s, r, n) {
        ...
        (rt.parseMaybeUnary = function (t, e) {
          var i,
            s = this.start,
            r = this.startLoc;
          if (
        ...
        (rt.parseExprSubscripts = function (t) {
          var e = this.start,
            i = this.startLoc,
        ...
        (rt.parseSubscripts = function (t, e, i, s) {
          for (
            var r =
                this.options.ecmaVersion >= 8 &&
                "Identifier" === t.type &&
            ...
            if (
              (a.optional && (n = !0),
              a === t || "ArrowFunctionExpression" === a.type)
            ) {
              if (n) {
        ...
        (rt.parseSubscript = function (t, e, i, s, r, n) {
          var a = this.options.ecmaVersion >= 11,
            o = a && this.eat(P.questionDot);
          s &&
            o &&
            this.raise(
              this.lastTokStart,
          ...
          if (
            h ||
            (o && this.type !== P.parenL && this.type !== P.backQuote) ||
            this.eat(P.dot)
          ) {
            ...
            if (r && !o && !this.canInsertSemicolon() && this.eat(P.arrow))
              return (
        ...
        (rt.parseParenAndDistinguishExpression = function (t) {
          var e,
            i = this.start,
            s = this.startLoc,
        ...
        (rt.parseParenArrowList = function (t, e, i) {
      ...
      (rt.parseNew = function () {
        ...
        (rt.parsePropertyValue = function (t, e, i, s, r, n, a, o) {
          if (
        ...
        (rt.parseMethod = function (t, e, i) {
          ...
          return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(64 | U(e, s.generator) | (i ? 128 : 0)),
            this.expect(P.parenL),
        ...
        (rt.parseArrowExpression = function (t, e, i) {
          var s = this.yieldPos,
            r = this.awaitPos,
        ...
        (rt.parseFunctionBody = function (t, e, i) {
          var s = e && this.type !== P.braceL,
            r = this.strict,
            n = !1;
          if (s)
            ...
            (this.labels = []),
              ...
              (t.body = this.parseBlock(!1, void 0, n && !r)),
              (t.expression = !1),
        ...
        (rt.parseExprList = function (t, e, i, s) {
      ...
      (ot.enterScope = function (t) {
        this.scopeStack.push(new ht(t));
      }),
        (ot.exitScope = function () {
          this.scopeStack.pop();
        }),
        (ot.treatFunctionsAsVarInScope = function (t) {
          return 2 & t.flags || (!this.inModule && 1 & t.flags);
        }),
        (ot.declareName = function (t, e, i) {
          var s = !1;
          if (2 === e) {
        ...
        (ot.checkLocalExport = function (t) {
      ...
      (ct.startNode = function () {
        ...
        (ct.finishNodeAt = function (t, e, i, s) {
          return pt.call(this, t, e, i, s);
        });
      var ut = function (t, e, i, s, r) {
          (this.token = t),
            (this.isExpr = !!e),
      ...
      (ft.initialContext = function () {
        ...
        (ft.braceIsBlock = function (t) {
          var e = this.curContext();
          return (
            e === dt.f_expr ||
            e === dt.f_stat ||
            (t !== P.colon || (e !== dt.b_stat && e !== dt.b_expr)
        ...
        (P.braceL.updateContext = function (t) {
          this.context.push(this.braceIsBlock(t) ? dt.b_stat : dt.b_expr),
            (this.exprAllowed = !0);
        }),
      ...
      function wt(t) {
        var e = (kt[t] = {
          binary: F(vt[t] + " " + xt),
          nonBinary: { General_Category: F(xt), Script: F(_t[t]) },
        });
        ...
        Ct = function (t) {
          (this.parser = t),
            ...
            (this.unicodeProperties =
              kt[t.options.ecmaVersion >= 11 ? 11 : t.options.ecmaVersion]),
            (this.source = ""),
            (this.flags = ""),
            (this.start = 0),
            (this.switchU = !1),
      ...
      (Ct.prototype.reset = function (t, e, i) {
        var s = -1 !== i.indexOf("u");
        (this.start = 0 | t),
          (this.source = e + ""),
          (this.flags = i),
        ...
        (Ct.prototype.nextIndex = function (t, e) {
          void 0 === e && (e = !1);
          var i = this.source,
            s = i.length;
          if (t >= s) return s;
        ...
        (St.regexp_eatPatternCharacters = function (t) {
          for (var e = t.pos, i = 0; -1 !== (i = t.current()) && !At(i); )
            t.advance();
          return t.pos !== e;
        }),
        ...
        (St.regexp_eatControlLetter = function (t) {
          var e = t.current();
          return !!Pt(e) && ((t.lastIntValue = e % 32), t.advance(), !0);
        }),
        (St.regexp_eatRegExpUnicodeEscapeSequence = function (t, e) {
          void 0 === e && (e = !1);
          var i,
            s = t.pos,
            r = e || t.switchU;
        ...
        (St.regexp_eatDecimalDigits = function (t) {
          var e = t.pos,
            i = 0;
          for (t.lastIntValue = 0; Tt((i = t.current())); )
        ...
        (St.regexp_eatHexDigits = function (t) {
          ...
          for (t.lastIntValue = 0; Nt((i = t.current())); )
            (t.lastIntValue = 16 * t.lastIntValue + Rt(i)), t.advance();
          return t.pos !== e;
        }),
        ...
        (St.regexp_eatFixedHexDigits = function (t, e) {
          ...
          for (var s = 0; s < e; ++s) {
            ...
            (t.lastIntValue = 16 * t.lastIntValue + Rt(r)), t.advance();
          }
          return !0;
        });
      var Mt = function (t) {
      ...
      (Ot.next = function (t) {
        ...
        (Ot.skipBlockComment = function () {
          ...
          if (
            ...
            for (
              I.lastIndex = i;
              (t = I.exec(this.input)) && t.index < this.pos;
        ...
        (Ot.readToken_mult_modulo_exp = function (t) {
        ...
        (Ot.readToken_pipe_amp = function (t) {
          var e = this.input.charCodeAt(this.pos + 1);
          if (e === t) {
        ...
        (Ot.readToken_plus_min = function (t) {
          var e = this.input.charCodeAt(this.pos + 1);
          return e === t
            ? 45 !== e ||
              this.inModule ||
        ...
        (Ot.readToken_eq_excl = function (t) {
          var e = this.input.charCodeAt(this.pos + 1);
          return 61 === e
            ? this.finishOp(
                P.equality,
        ...
        (Ot.getTokenFromCode = function (t) {
          switch (t) {
            case 46:
        ...
        (Ot.readRegexp = function () {
          for (var t, e, i = this.pos; ; ) {
            ...
            if (
              (L.test(s) && this.raise(i, "Unterminated regular expression"), t)
            )
              t = !1;
            else {
              if ("[" === s) e = !0;
          ...
          return this.finishToken(P.regexp, { pattern: r, flags: a, value: h });
        }),
        (Ot.readInt = function (t, e, i) {
          for (
          ...
          return (
            ...
            this.pos === n || (null != e && this.pos - n !== e) ? null : a
          );
        }),
        (Ot.readRadixNumber = function (t) {
          var e = this.pos;
          this.pos += 2;
          ...
          return (
            ...
            110 === this.input.charCodeAt(this.pos)
              ? ((i = Dt(this.input.slice(e, this.pos))), ++this.pos)
              : b(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, "Identifier directly after number"),
            this.finishToken(P.num, i)
          );
        }),
        (Ot.readNumber = function (t) {
          var e = this.pos;
          t ||
          ...
          if (!i && !t && this.options.ecmaVersion >= 11 && 110 === s) {
            var r = Dt(this.input.slice(e, this.pos));
            return (
              ++this.pos,
              b(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, "Identifier directly after number"),
          ...
          var n,
            a =
              ...
              i ? parseInt(n, 8) : parseFloat(n.replace(/_/g, "")));
          ...
          for (var e = "", i = ++this.pos; ; ) {
            ...
            92 === s
              ? ((e += this.input.slice(i, this.pos)),
                ...
                (i = this.pos))
              : (T(s, this.options.ecmaVersion >= 10) &&
                  this.raise(this.start, "Unterminated string constant"),
                ++this.pos);
          }
          return (
      ...
      (Ot.tryReadTemplateToken = function () {
        ...
        (Ot.invalidStringToken = function (t, e) {
          if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Ft;
          this.raise(t, e);
        }),
      ...
      var Wt = i(261),
        Ht = {
          components: { PerfectScrollbar: Wt.PerfectScrollbar },
          props: {
      ...
      var $t = "navigator" in global && /Win/i.test(navigator.platform),
        Kt =
          "navigator" in global &&
        ...
        Gt = jt.a.extend({
          ...
          methods: {
            ...
            _applyEdits: function (t) {
              ...
              i &&
                e &&
                (this.history.stack[this.history.offset] = Ut({}, i, {
            ...
            _recordChange: function (t, e) {
              ...
              if (s.length && r > -1) {
                ...
                var n = this.history.stack.length;
                if (n > 100) {
                  var a = n - 100;
                  (this.history.stack = s.slice(a, n)),
                    (this.history.offset = Math.max(
                      this.history.offset - a,
                      0
                    ));
                }
              }
              ...
              if (e) {
                ...
                if (h && o - h.timestamp < 3e3) {
                  ...
                  if (u && d && d[1].startsWith(u[1]))
                    return void (this.history.stack[this.history.offset] = Ut(
                      {},
                      t,
                      { timestamp: o }
                    ));
              ...
              this.history.stack.push(Ut({}, t, { timestamp: o })),
                this.history.offset++;
            },
              ...
              if (
                ...
                if (9 === t.keyCode && !s && this.capture)
                  if ((t.preventDefault(), t.shiftKey)) {
                    var l = this._getLines(n, a),
                      c = l.length - 1,
                      p = this._getLines(n, o).length - 1,
                      u = n
                        .split("\n")
                        .map(function (t, e) {
                    ...
                    if (n !== u) {
                      ...
                      this._applyEdits({
                        value: u,
                        selectionStart: d.startsWith(h) ? a - h.length : a,
                        selectionEnd: o - (n.length - u.length),
                      });
                    }
                  } else if (a !== o) {
                    var f = this._getLines(n, a),
                      m = f.length - 1,
                      g = this._getLines(n, o).length - 1,
                      v = f[m];
                    this._applyEdits({
                      value: n
                        .split("\n")
                        ...
                        .join("\n"),
                      selectionStart: /\S/.test(v) ? a + h.length : a,
                      selectionEnd: o + h.length * (g - m + 1),
                    });
                  } else {
                    var x = a + h.length;
                    this._applyEdits({
                      value: n.substring(0, a) + h + n.substring(o),
                      selectionStart: x,
                      selectionEnd: x,
                    });
                  }
                  ...
                  var y = a !== o;
                  if (n.substring(0, a).endsWith(h) && !y) {
                    t.preventDefault();
                    var b = a - h.length;
                    this._applyEdits({
                      value: n.substring(0, a - h.length) + n.substring(o),
                      selectionStart: b,
                      selectionEnd: b,
                    });
                  }
                  ...
                  if (a === o) {
                    ...
                    if (k && k[0]) {
                      ...
                      var w = "\n" + k[0],
                        S = a + w.length;
                      this._applyEdits({
                        value: n.substring(0, a) + w + n.substring(o),
                        selectionStart: S,
                        selectionEnd: S,
                      });
                    }
          ...
          render: function (t) {
            var e = this,
              ...
              a = t("div", { staticClass: "prism-editor__container" }, [r, n]);
        ...
        qt =
          ...
          {
            components: {
              PerfectScrollbar: Wt.PerfectScrollbar,
              PrismEditor: Gt,
            },
            props: { value: { type: String, required: !0 } },
            data: () => ({ scrollbars: { wheelPropagation: !1 } }),
            methods: {
              highlight: (t) => Object(Xt.highlight)(t, Xt.languages.js),
            },
          }),
        zt =
          (i(313),
        ...
        Qt = { components: { PerfectScrollbar: Wt.PerfectScrollbar } },
        Zt =
          (i(314),
          Object(n.a)(
            Qt,
      ...
      const Jt = /^\s*<(\/?)block:([\w\s]+)(?::(\d+))?>\s*$/;
      var te = {
          components: { EditorOutput: Yt, EditorTextarea: zt, Tooltip: Zt },
          props: {
