...
define(["jquery", "../leaflet/leaflet-src", "leafclusterer"], function () {
    ...
    if (!map) {
      ...
      map.attributionControl.addAttribution(
        '<span class=".map-attribution">' +
          mw.message("attribution-mapquest") +
          "</span>"
      );
      map.attributionControl.addAttribution(
        '<br /><span class=".map-attribution">' +
          mw.message("attribution-osm") +
          "</span>"
      );
  ...
  function addMonument(monument, onClick) {
    if (
      typeof monument.lat === "undefined" ||
      typeof monument.lon === "undefined"
    ) {
      return;
    }
    var url = "images/",
    ...
    markerIcon.shadowUrl = monument.image
      ? "images/pin-shadow.png"
      : "images/pin-no-photos-shadow.png";
