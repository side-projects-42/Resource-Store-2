(function () {
  ...
  test("generateFilename: . symbol", function () {
    ...
    data.name =
      "Аўгустоўскі канал:водны шлях, які ўключае зарэгуляваны ўчастак р. Чорная Ганча ад Дзяржаўнай граніцы з Рэспублікай Польшча да в. Сонічы (13км), штучны ўчастак канала ад в. Сонічы да шлюза«Нямнова» (6,5 км)гідравузел «Нямнова»: Гарадзенскі раён. Тэрыторыя ў межах матэрыяльнай нерухомайгісторыка-культурнай каштоўнасьці, устаноўленых праектам «Зоны аховы і рэжымыіх утрыманьня гісторыка-культурнай каштоўнасьці «Аўгустоўскі канал»";
    ...
    strictEqual(
      name.indexOf("hello - symbol"),
      0,
      "the illegal symbol was escaped"
    );
    ...
    strictEqual(
      name4.indexOf("-evil-name--muh-h-a-hhh-oh-no-mr-bill"),
      0,
      "the illegal symbols were escaped"
    );
    ok(
      name5.length < 240,
      "long filenames are truncated with room to under 240 chars"
    ); // warning: actual limit lowered due to thumbnail problems
  ...
  test("randomness of monument names", function () {
    ...
    strictEqual(
      areDifferentNames,
      false,
      "ensure the names generated are unique"
    );
  });
})();
