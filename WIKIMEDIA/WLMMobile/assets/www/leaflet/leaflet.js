...
(function (a) {
    ...
    ROOT_URL:
      ...
      (function () {
        ...
        for (c = 0, d = a.length; c < d; c++) {
          ...
          if (f)
            return f[1] === "include" ? "../../dist/" : e.split(b)[0] + "/";
        }
        return "";
      })(),
    noConflict: function () {
  ...
  (L.Util = {
    ...
    limitExecByInterval: function (a, b, c) {
      ...
      return function () {
        (f = arguments),
          d ? (e = !0) : ((d = !0), setTimeout(g, b), a.apply(c, f));
      };
    },
    falseFn: function () {
      return !1;
  ...
  (L.Class.extend = function (a) {
    ...
    return (
      ...
      a.includes &&
        (L.Util.extend.apply(null, [d].concat(a.includes)), delete a.includes),
      a.options &&
        d.options &&
  ...
  (L.Mixin.Events = {
    addEventListener: function (a, b, c) {
      ...
      return (
        (d[a] = d[a] || []), d[a].push({ action: b, context: c || this }), this
      );
    },
    ...
    removeEventListener: function (a, b, c) {
      ...
      for (var d = 0, e = this._leaflet_events, f = e[a].length; d < f; d++)
        if (e[a][d].action === b && (!c || e[a][d].context === c))
          return e[a].splice(d, 1), this;
      return this;
    },
    fireEvent: function (a, b) {
      if (!this.hasEventListeners(a)) return this;
      var c = L.Util.extend({ type: a, target: this }, b),
  ...
  (function () {
    ...
    L.Browser = {
      ...
      touch: (function () {
        ...
        return !c.setAttribute || !c.removeAttribute
          ? !1
          : (c.setAttribute(b, "return;"),
            typeof c[b] == "function" && (a = !0),
            c.removeAttribute(b),
            (c = null),
            a);
      })(),
  ...
  (L.Bounds = L.Class.extend({
    ...
    extend: function (a) {
      !this.min && !this.max
        ? ((this.min = new L.Point(a.x, a.y)),
          (this.max = new L.Point(a.x, a.y)))
    ...
    contains: function (a) {
      var b, c;
      return (
        a instanceof L.Bounds ? ((b = a.min), (c = a.max)) : (b = c = a),
        b.x >= this.min.x &&
          c.x <= this.max.x &&
          b.y >= this.min.y &&
          c.y <= this.max.y
  ...
  (L.DomUtil = {
    ...
    getViewportOffset: function (a) {
      ...
      do {
        ...
        if (
          d.offsetParent === e &&
          L.DomUtil.getStyle(d, "position") === "absolute"
        )
          break;
        d = d.offsetParent;
      } while (d);
    ...
    setPosition: function (a, b) {
      (a._leaflet_pos = b),
        L.Browser.webkit3d
          ? ((a.style[L.DomUtil.TRANSFORM] = L.DomUtil.getTranslateString(b)),
            L.Browser.android &&
              ((a.style["-webkit-perspective"] = "1000"),
  ...
  (L.LatLngBounds = L.Class.extend({
    ...
    extend: function (a) {
      !this._southWest && !this._northEast
        ? ((this._southWest = new L.LatLng(a.lat, a.lng, !0)),
          (this._northEast = new L.LatLng(a.lat, a.lng, !0)))
    ...
    contains: function (a) {
      ...
      return (
        a instanceof L.LatLngBounds
          ? ((d = a.getSouthWest()), (e = a.getNorthEast()))
          : (d = e = a),
        d.lat >= b.lat && e.lat <= c.lat && d.lng >= b.lng && e.lng <= c.lng
      );
    },
    intersects: function (a) {
      var b = this._southWest,
  ...
  (L.Map = L.Class.extend({
    ...
    options: {
      ...
      zoomAnimation:
        L.DomUtil.TRANSITION && !L.Browser.android && !L.Browser.mobileOpera,
      trackResize: !0,
      closePopupOnClick: !0,
      worldCopyJump: !0,
    },
    initialize: function (a, b) {
      ...
      (this._container._leaflet = !0),
        this._initLayout(),
        L.DomEvent &&
          (this._initEvents(),
          L.Handler && this._initInteraction(),
          L.Control && this._initControls()),
    ...
    setMaxBounds: function (a) {
      ...
      return (
        (this._boundsMinZoom = b),
        this._loaded &&
          (this._zoom < b
            ? this.setView(a.getCenter(), b)
            : this.panInsideBounds(a)),
        this
      );
    },
    ...
    addLayer: function (a, b) {
      ...
      (this._layers[c] = a),
        a.options &&
          !isNaN(a.options.maxZoom) &&
          (this._layersMaxZoom = Math.max(
            this._layersMaxZoom || 0,
            a.options.maxZoom
          )),
        a.options &&
          !isNaN(a.options.minZoom) &&
          (this._layersMinZoom = Math.min(
            this._layersMinZoom || Infinity,
            a.options.minZoom
          )),
        this.options.zoomAnimation &&
          L.TileLayer &&
          a instanceof L.TileLayer &&
          (this._tileLayersNum++, a.on("load", this._onTileLayerLoad, this)),
        this.attributionControl &&
          a.getAttribution &&
          this.attributionControl.addAttribution(a.getAttribution());
      var d = function () {
        a.onAdd(this, b), this.fire("layeradd", { layer: a });
      };
      ...
      return (
        this._layers[b] &&
          ...
          this.options.zoomAnimation &&
            L.TileLayer &&
            a instanceof L.TileLayer &&
            (this._tileLayersNum--, a.off("load", this._onTileLayerLoad, this)),
          this.attributionControl &&
            a.getAttribution &&
    ...
    invalidateSize: function () {
      ...
      return (
        ...
        this.options.maxBounds && this.setMaxBounds(this.options.maxBounds),
        this._loaded
          ? (this._rawPanBy(a.subtract(this.getSize()).divideBy(2, !0)),
            this.fire("move"),
    ...
    getBoundsZoom: function (a, b) {
      ...
      do
        d++,
          (i = this.project(f, d)),
          (j = this.project(g, d)),
          (h = new L.Point(i.x - j.x, j.y - i.y)),
          b ? (k = h.x < c.x || h.y < c.y) : (k = h.x <= c.x && h.y <= c.y);
      while (k && d <= e);
    ...
    project: function (a, b) {
      return (
        ...
        this.options.crs.latLngToPoint(a, this.options.scale(b))
      );
    },
    unproject: function (a, b, c) {
      return (
        (b = typeof b == "undefined" ? this._zoom : b),
        this.options.crs.pointToLatLng(a, this.options.scale(b), c)
      );
    },
    _initLayout: function () {
      ...
      b !== "absolute" && b !== "relative" && (a.style.position = "relative"),
        this._initPanes(),
    ...
    _initPanes: function () {
      ...
      (this._mapPane = a.mapPane =
        ...
        (this._objectsPane = a.objectsPane =
          this._createPane("leaflet-objects-pane", this._mapPane)),
    ...
    _resetView: function (a, b, c, d) {
      var e = this._zoom !== b;
      d || (this.fire("movestart"), e && this.fire("zoomstart")),
        (this._zoom = b),
    ...
    _fireMouseEvent: function (a) {
      ...
      var b = a.type;
      b =
        b === "mouseenter" ? "mouseover" : b === "mouseleave" ? "mouseout" : b;
    ...
    _initInteraction: function () {
      ...
      for (b in a)
        a.hasOwnProperty(b) &&
          a[b] &&
          ((this[b] = new a[b](this)), this.options[b] && this[b].enable());
    },
      ...
      this._tileLayersToLoad--,
        this._tileLayersNum &&
          ...
          (this._clearTileBgTimer = setTimeout(
            L.Util.bind(this._clearTileBg, this),
            500
          )));
    },
  ...
  (L.Projection.Mercator = {
    ...
    project: function (a) {
      var b = L.LatLng.DEG_TO_RAD,
        ...
        j = Math.sqrt(1 - i * i),
        k = j * Math.sin(h);
      k = Math.pow((1 - k) / (1 + k), j * 0.5);
      var l = Math.tan(0.5 * (Math.PI * 0.5 - h)) / k;
  ...
  (L.TileLayer = L.Class.extend({
    ...
    setOpacity: function (a) {
      ...
      if (L.Browser.webkit)
        for (var b in this._tiles)
          this._tiles.hasOwnProperty(b) &&
            (this._tiles[b].style.webkitTransform += " translate(0,0)");
    },
    ...
    _removeOtherTiles: function (a) {
      ...
      for (e in this._tiles)
        if (this._tiles.hasOwnProperty(e)) {
          (b = e.split(":")),
            (c = parseInt(b[0], 10)),
            (d = parseInt(b[1], 10));
          if (c < a.min.x || c > a.max.x || d < a.min.y || d > a.max.y)
            (f = this._tiles[e]),
              this.fire("tileunload", { tile: f, url: f.src }),
              f.parentNode === this._container &&
                this._container.removeChild(f),
              this.options.reuseTiles && this._unusedTiles.push(this._tiles[e]),
              (f.src =
    ...
    _addTile: function (a, b) {
      ...
      L.DomUtil.setPosition(g, c),
        (this._tiles[e] = g),
        this.options.scheme === "tms" && (a.y = f - a.y - 1),
        this._loadTile(g, a, d),
        b.appendChild(g);
    },
    _getOffsetZoom: function (a) {
      return (
        (a = this.options.zoomReverse ? this.options.maxZoom - a : a),
    ...
    getTileUrl: function (a, b) {
      ...
      return L.Util.template(
        this._url,
        L.Util.extend(
          { s: d, z: this._getOffsetZoom(b), x: a.x, y: a.y },
          this._urlParams
        )
      );
    },
    ...
    _tileOnLoad: function (a) {
      ...
      (this.className += " leaflet-tile-loaded"),
        b.fire("tileload", { tile: this, url: this.src }),
        b._tilesToLoad--,
        b._tilesToLoad || b.fire("load");
    },
    _tileOnError: function (a) {
      var b = this._layer;
      b.fire("tileerror", { tile: this, url: this.src });
  ...
  (L.TileLayer.WMS = L.TileLayer.extend({
    ...
    onAdd: function (a) {
      ...
      (this.wmsParams[b] = a.options.crs.code),
  ...
  (L.ImageOverlay = L.Class.extend({
    ...
    _reset: function () {
      ...
      L.DomUtil.setPosition(this._image, a),
        (this._image.style.width = c.x + "px"),
        (this._image.style.height = c.y + "px");
    },
  ...
  (L.Icon = L.Class.extend({
    ...
    _createIcon: function (a) {
      ...
      var d;
      return (
        c ? (d = this._createImg(c)) : (d = this._createDiv()),
        ...
        L.Browser.ie6
          ? ((b = document.createElement("div")),
            (b.style.filter =
              ...
              a +
              '")'))
          : ((b = document.createElement("img")), (b.src = a)),
        b
      );
    },
    _createDiv: function () {
  ...
  (L.Marker = L.Class.extend({
    ...
    setLatLng: function (a) {
      (this._latlng = a),
        this._icon &&
          (this._reset(), this._popup && this._popup.setLatLng(this._latlng));
    },
    ...
    setIcon: function (a) {
      this._map && this._removeIcon(),
        (this.options.icon = a),
        this._map && (this._initIcon(), this._reset());
    },
    _initIcon: function () {
      this._icon ||
        ((this._icon = this.options.icon.createIcon()),
        this.options.title && (this._icon.title = this.options.title),
    ...
    _reset: function () {
      ...
      L.DomUtil.setPosition(this._icon, a),
        ...
        (this._icon.style.zIndex = a.y + this.options.zIndexOffset);
    },
    _initInteraction: function () {
  ...
  (L.Popup = L.Class.extend({
    ...
    _initLayout: function () {
      (this._container = L.DomUtil.create(
        "div",
        "leaflet-popup " + this.options.className
      )),
        ...
        (this._wrapper = L.DomUtil.create(
          "div",
    ...
    _updateLayout: function () {
      ...
      (this._container.style.width =
        (a > this.options.maxWidth
          ? this.options.maxWidth
          : a < this.options.minWidth
    ...
    _updatePosition: function () {
      ...
      (this._containerBottom = -a.y - this.options.offset.y),
        (this._containerLeft =
          a.x - Math.round(this._containerWidth / 2) + this.options.offset.x),
    ...
    _adjustPan: function () {
      ...
      var a = this._container.offsetHeight,
        ...
        f = this._map.getSize();
      c.x < 0 && (d.x = c.x - e.x),
        c.x + this._containerWidth > f.x &&
          (d.x = c.x + this._containerWidth - f.x + e.x),
        c.y < 0 && (d.y = c.y - e.y),
        c.y + a > f.y && (d.y = c.y + a - f.y + e.y),
        (d.x || d.y) && this._map.panBy(d);
    },
  ...
  L.Marker.include({
    openPopup: function () {
      return (
        ...
        this._map && this._map.openPopup(this._popup),
        this
      );
    },
    closePopup: function () {
    ...
    bindPopup: function (a, b) {
      return (
        ...
        this._popup || this.on("click", this.openPopup, this),
        (this._popup = new L.Popup(b, this)),
    ...
    unbindPopup: function () {
      return (
        this._popup &&
          ((this._popup = null), this.off("click", this.openPopup)),
        this
      );
    },
  }),
  ...
  (L.LayerGroup = L.Class.extend({
    ...
    removeLayer: function (a) {
      var b = L.Util.stamp(a);
      return (
        delete this._layers[b], this._map && this._map.removeLayer(a), this
      );
    },
    ...
    invoke: function (a) {
      ...
      for (c in this._layers)
        this._layers.hasOwnProperty(c) &&
          ((d = this._layers[c]), d[a] && d[a].apply(d, b));
      return this;
    },
    onAdd: function (a) {
  ...
  (L.Path = L.Class.extend({
    ...
    onAdd: function (a) {
      (this._map = a),
        ...
        (this._updateTrigger = this.options.updateOnMoveEnd
          ? "moveend"
          : "viewreset"),
    ...
    onRemove: function (a) {
      (this._map = null),
        ...
        a.off("viewreset", this.projectLatlngs, this),
        a.off(this._updateTrigger, this._updatePath, this);
    },
    projectLatlngs: function () {},
    setStyle: function (a) {
      return (
        L.Util.setOptions(this, a), this._container && this._updateStyle(), this
      );
    },
    _redraw: function () {
  ...
  L.Map.include({
    ...
    _updateSvgViewport: function () {
      ...
      L.Browser.webkit && g.removeChild(f),
        L.DomUtil.setPosition(f, b),
        f.setAttribute("width", d),
        f.setAttribute("height", e),
        f.setAttribute("viewBox", [b.x, b.y, d, e].join(" ")),
        L.Browser.webkit && g.appendChild(f);
    },
  }),
  L.Path.include({
    bindPopup: function (a, b) {
      ...
      return (
        this._popup.setContent(a),
        this._openPopupAdded ||
          (this.on("click", this._openPopup, this),
          (this._openPopupAdded = !0)),
        this
      );
    },
      ...
      : L.Path.extend({
          ...
          _drawPath: function () {
            ...
            for (a = 0, c = this._parts.length; a < c; a++) {
              for (b = 0, d = this._parts[a].length; b < d; b++)
                (e = this._parts[a][b]),
                  (f = (b === 0 ? "move" : "line") + "To"),
                  this._ctx[f](e.x, e.y);
          ...
          _updatePath: function () {
            ...
            this.options.fill &&
              (b < 1 && (this._ctx.globalAlpha = b), this._ctx.fill()),
              this.options.stroke &&
                (a < 1 && (this._ctx.globalAlpha = a), this._ctx.stroke()),
              this._ctx.restore();
          },
          _initEvents: function () {
      ...
      : {
          _initPathRoot: function () {
            var a = this._pathRoot,
              b;
            a ||
              ((a = this._pathRoot = document.createElement("canvas")),
              (a.style.position = "absolute"),
              (b = this._canvasCtx = a.getContext("2d")),
              (b.lineCap = "round"),
              (b.lineJoin = "round"),
  ...
  (L.PolyUtil.clipPolygon = function (a, b) {
    ...
    for (i = 0; i < 4; i++) {
      (m = f[i]), (e = []);
      for (g = 0, l = a.length, h = l - 1; g < l; h = g++)
        (j = a[g]),
          (k = a[h]),
          j._code & m
            ? k._code & m ||
              ((n = o._getEdgeIntersection(k, j, m, b)),
              (n._code = o._getBitCode(n, b)),
              e.push(n))
            : (k._code & m &&
                ((n = o._getEdgeIntersection(k, j, m, b)),
                (n._code = o._getBitCode(n, b)),
  ...
  (L.Polygon = L.Polyline.extend({
    ...
    projectLatlngs: function () {
      ...
      for (var a = 0, b = this._holes.length, c; a < b; a++) {
        this._holePoints[a] = [];
        for (var d = 0, e = this._holes[a].length; d < e; d++)
          this._holePoints[a][d] = this._map.latLngToLayerPoint(
            this._holes[a][d]
          );
      }
    },
  ...
  (L.Circle = L.Path.extend({
    ...
    projectLatlngs: function () {
      ...
      (this._point = this._map.latLngToLayerPoint(this._latlng)),
        (this._radius = Math.round(this._point.x - e.x));
    },
    getPathString: function () {
      var a = this._point,
        b = this._radius;
      ...
      ? {
          _containsPoint: function (a) {
            ...
            for (f = 0, i = this._parts.length; f < i; f++) {
              c = this._parts[f];
              for (g = 0, j = c.length, h = j - 1; g < j; h = g++)
                (d = c[g]),
                  (e = c[h]),
                  d.y > a.y != e.y > a.y &&
                    a.x < ((e.x - d.x) * (a.y - d.y)) / (e.y - d.y) + d.x &&
                    (b = !b);
            }
            return b;
          },
  ...
  L.Util.extend(L.GeoJSON, {
      ...
      switch (a.type) {
        ...
        case "MultiPoint":
          for (f = 0, g = c.length; f < g; f++)
            (d = this.coordsToLatLng(c[f])),
              (h = b ? b(d) : new L.Marker(d)),
              i.push(h);
        ...
        case "GeometryCollection":
          for (f = 0, g = a.geometries.length; f < g; f++)
            (h = this.geometryToLayer(a.geometries[f], b)), i.push(h);
          return new L.FeatureGroup(i);
        default:
    ...
    coordsToLatLngs: function (a, b, c) {
      ...
      for (f = 0; f < g; f++)
        (d = b
          ? this.coordsToLatLngs(a[f], b - 1, c)
          : this.coordsToLatLng(a[f], c)),
          e.push(d);
      return e;
    },
  }),
  (L.DomEvent = {
    addListener: function (a, b, c, d) {
      ...
      if (L.Browser.touch && b === "dblclick" && this.addDoubleTapListener)
        this.addDoubleTapListener(a, g, e);
      else if ("addEventListener" in a)
        if (b === "mousewheel")
          a.addEventListener("DOMMouseScroll", g, !1),
    ...
    removeListener: function (a, b, c) {
      ...
      L.Browser.touch && b === "dblclick" && this.removeDoubleTapListener
        ...
        ? b === "mousewheel"
          ? (a.removeEventListener("DOMMouseScroll", f, !1),
            a.removeEventListener(b, f, !1))
          : b === "mouseenter" || b === "mouseleave"
          ? a.removeEventListener(
              b === "mouseenter" ? "mouseover" : "mouseout",
              f,
              !1
            )
          : a.removeEventListener(b, f, !1)
        : "detachEvent" in a && a.detachEvent("on" + b, f),
        (a[e] = null);
    },
    ...
    disableClickPropagation: function (a) {
      L.DomEvent.addListener(a, L.Draggable.START, L.DomEvent.stopPropagation),
  ...
  (L.Draggable = L.Class.extend({
    ...
    _onDown: function (a) {
      if (
        (!L.Browser.touch && a.shiftKey) ||
        (a.which !== 1 && a.button !== 1 && !a.touches)
      )
        return;
    ...
    _onMove: function (a) {
      ...
      (this._newPos = this._startPos.add(c).subtract(this._startPoint)),
    ...
    _onUp: function (a) {
      if (a.changedTouches) {
        ...
        c.tagName.toLowerCase() === "a" &&
          (c.className = c.className.replace(" leaflet-active", "")),
          d < L.Draggable.TAP_TOLERANCE && this._simulateEvent("click", b);
      }
      L.Browser.touch ||
        (L.DomUtil.enableTextSelection(), this._restoreCursor()),
  ...
  L.Util.extend(L.DomEvent, {
    addDoubleTapListener: function (a, b, c) {
      ...
      (a[h + i + c] = k),
        (a[h + j + c] = l),
        a.addEventListener(i, k, !1),
        a.addEventListener(j, l, !1);
    },
    removeDoubleTapListener: function (a, b) {
      var c = "_leaflet_";
      a.removeEventListener(a, a[c + "touchstart" + b], !1),
        a.removeEventListener(a, a[c + "touchend" + b], !1);
    },
  }),
  (L.Map.TouchZoom = L.Handler.extend({
    ...
    _onTouchStart: function (a) {
      ...
      var b = this._map.mouseEventToLayerPoint(a.touches[0]),
        ...
        d = this._map.containerPointToLayerPoint(
    ...
    _onTouchMove: function (a) {
      ...
      this._moved ||
        ...
        this._map.fire("zoomstart").fire("movestart")._prepareTileBg(),
        (this._moved = !0));
      var b = this._map.mouseEventToLayerPoint(a.touches[0]),
        c = this._map.mouseEventToLayerPoint(a.touches[1]);
  ...
  (L.Map.BoxZoom = L.Handler.extend({
    ...
    _onMouseMove: function (a) {
      var b = this._map.mouseEventToLayerPoint(a),
        ...
        g = new L.Point(e, f);
      L.DomUtil.setPosition(this._box, g),
        (this._box.style.width = Math.abs(c) - 4 + "px"),
        (this._box.style.height = Math.abs(d) - 4 + "px");
    },
  ...
  (L.Handler.MarkerDrag = L.Handler.extend({
    ...
    addHooks: function () {
      ...
      this._draggable ||
        ((this._draggable = new L.Draggable(a, a)),
        this._draggable
          .on("dragstart", this._onDragStart, this)
          .on("drag", this._onDrag, this)
          .on("dragend", this._onDragEnd, this)),
    ...
    _onDrag: function (a) {
      ...
      this._marker._shadow && L.DomUtil.setPosition(this._marker._shadow, b),
        (this._marker._latlng = this._marker._map.layerPointToLatLng(b)),
        this._marker.fire("move").fire("drag");
    },
    _onDragEnd: function () {
  ...
  L.Map.include({
    addControl: function (a) {
      ...
      var b = a.getPosition(),
        ...
        d = a.getContainer();
      return (
        L.DomUtil.addClass(d, "leaflet-control"),
        b.indexOf("bottom") !== -1
    ...
    _initControlPos: function () {
      ...
      L.Browser.touch && (g.className += " " + b + "big-buttons"),
        (a.topLeft = L.DomUtil.create("div", c + " " + e, g)),
        (a.topRight = L.DomUtil.create("div", c + " " + f, g)),
        (a.bottomLeft = L.DomUtil.create("div", d + " " + e, g)),
        (a.bottomRight = L.DomUtil.create("div", d + " " + f, g));
    },
  }),
  ...
  (L.Control.Attribution = L.Class.extend({
    initialize: function (a) {
      (this._prefix =
        a || 'Powered by <a href="http://leaflet.cloudmade.com">Leaflet</a>'),
        (this._attributions = {});
    },
    onAdd: function (a) {
      (this._container = L.DomUtil.create(
    ...
    _update: function () {
      ...
      var c = [];
      this._prefix && c.push(this._prefix),
        a.length && c.push(a.join(", ")),
        (this._container.innerHTML = c.join(" &mdash; "));
    },
  })),
  (L.Control.Layers = L.Class.extend({
    ...
    _initLayout: function () {
      (this._container = L.DomUtil.create("div", "leaflet-control-layers")),
        L.Browser.touch || L.DomEvent.disableClickPropagation(this._container),
      ...
      if (this.options.collapsed) {
        ...
        var a = (this._layersLink = L.DomUtil.create(
          "a",
        ...
        (a.href = "#"),
          (a.title = "Layers"),
          L.Browser.touch
            ? L.DomEvent.addListener(a, "click", this._expand, this)
    ...
    _addItem: function (a, b) {
      ...
      a.overlay || (d.name = "leaflet-base-layers"),
        (d.type = a.overlay ? "checkbox" : "radio"),
        (d.checked = this._map.hasLayer(a.layer)),
        (d.layerId = L.Util.stamp(a.layer)),
        L.DomEvent.addListener(d, "click", this._onInputClick, this);
    ...
    _onInputClick: function () {
      ...
      for (a = 0; a < e; a++)
        (b = d[a]),
          ...
          b.checked
            ? this._map.addLayer(c.layer, !c.overlay)
  ...
  (L.Transition = L.Class.extend({
    includes: L.Mixin.Events,
    statics: {
      CUSTOM_PROPS_SETTERS: { position: L.DomUtil.setPosition },
      implemented: function () {
        return L.Transition.NATIVE || L.Transition.TIMER;
      },
    },
    options: { easing: "ease", duration: 0.5 },
  ...
  (L.Transition = L.Transition.extend({
    statics: (function () {
      var a = L.DomUtil.TRANSITION,
        b =
          a === "webkitTransition" || a === "OTransition"
            ? a + "End"
            : "transitionend";
      return {
        NATIVE: !!a,
    ...
    run: function (a) {
      ...
      for (b in a)
        a.hasOwnProperty(b) &&
          ((b = d[b] ? d[b] : b), (b = this._dasherize(b)), c.push(b));
  ...
  (L.Transition = L.Transition.NATIVE
    ...
    : L.Transition.extend({
        statics: {
          ...
          CUSTOM_PROPS_GETTERS: { position: L.DomUtil.getPosition },
          UNIT_RE: /^[\d\.]+(\D*)$/,
        },
        options: { fps: 50 },
        initialize: function (a, b) {
          ...
          var c =
            L.Transition.EASINGS[this.options.easing] ||
            L.Transition.EASINGS.ease;
        ...
        _step: function () {
          ...
          b < c
            ? this._runFrame(this._cubicBezier(b / c))
        ...
        _runFrame: function (a) {
          ...
          for (c in this._props)
            this._props.hasOwnProperty(c) &&
              ((d = this._props[c]),
              c in b
                ? ((e = d.to.subtract(d.from).multiplyBy(a).add(d.from)),
                  b[c](this._el, e))
                : (this._el.style[c] = (d.to - d.from) * a + d.from + d.unit));
          this.fire("step");
        },
        _complete: function () {
  ...
  L.Map.include(
    !L.Transition || !L.Transition.implemented()
      ? {}
      : {
          setView: function (a, b, c) {
            ...
            if (this._loaded && !c && this._layers) {
              var e = this._getNewTopLeftPoint(a).subtract(
                this._getTopLeftPoint()
              );
              a = new L.LatLng(a.lat, a.lng);
              var f = d
                ? !!this._zoomToIfCenterInView &&
                  this._zoomToIfCenterInView(a, b, e)
                : this._panByIfClose(e);
              if (f) return this;
            }
      ...
      ? {
          ...
          _runAnimation: function (a, b, c, d) {
            ...
            if (L.Browser.gecko || window.opera)
              this._tileBg.style[e] += " translate(0,0)";
            var f;
            L.Browser.android
              ? ((this._tileBg.style[e + "Origin"] = d.x + "px " + d.y + "px"),
                (f = "scale(" + c + ")"))
              : (f = L.DomUtil.getScaleString(c, d)),
              L.Util.falseFn(this._tileBg.offsetWidth);
            var g = {};
            (g[e] = this._tileBg.style[e] + " " + f),
              this._tileBg.transition.run(g);
          },
          _prepareTileBg: function () {
            this._tileBg ||
              ((this._tileBg = this._createPane(
                "leaflet-tile-pane",
                this._mapPane
              )),
          ...
          _stopLoadingBgTiles: function () {
            ...
            for (var b = 0, c = a.length; b < c; b++)
              a[b].complete ||
                ((a[b].onload = L.Util.falseFn),
                (a[b].onerror = L.Util.falseFn),
                (a[b].src =
                  "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="),
          ...
          _onZoomTransitionEnd: function () {
            this._restoreTileFront(),
              ...
              (this._mapPane.className = this._mapPane.className.replace(
                " leaflet-zoom-anim",
                ""
              )),
  ...
  L.Map.include({
    ...
    locateAndSetView: function (a, b) {
      return (
        (b = L.Util.extend({ maxZoom: a || Infinity, setView: !0 }, b)),
        this.locate(b)
      );
    },
