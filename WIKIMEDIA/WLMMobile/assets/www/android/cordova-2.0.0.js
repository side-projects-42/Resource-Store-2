    ...
    var Channel = function (type, opts) {
        ...
        if (opts) {
          ...
          if (opts.onUnsubscribe)
            this.events.onUnsubscribe = opts.onUnsubscribe;
        }
      },
      channel = {
        /**
 ...
 */
  ...
  define("cordova/plugin/CompassHeading", function (require, exports, module) {
    var CompassHeading = function (
      ...
      this.magneticHeading =
        magneticHeading !== undefined ? magneticHeading : null;
      this.trueHeading = trueHeading !== undefined ? trueHeading : null;
      this.headingAccuracy =
        headingAccuracy !== undefined ? headingAccuracy : null;
      this.timestamp =
  ...
  define("cordova/plugin/DirectoryEntry", function (require, exports, module) {
    ...
    var DirectoryEntry = function (name, fullPath) {
      DirectoryEntry.__super__.constructor.apply(this, [
        false,
        true,
        name,
        fullPath,
  ...
  define("cordova/plugin/Entry", function (require, exports, module) {
    ...
    function Entry(isFile, isDirectory, name, fullPath, fileSystem) {
      ...
      this.isDirectory =
        typeof isDirectory != "undefined" ? isDirectory : false;
      this.name = name || "";
  ...
  define("cordova/plugin/FileTransfer", function (require, exports, module) {
    ...
    FileTransfer.prototype.download = function (
      ...
      exec(win, errorCallback, "FileTransfer", "download", [
        source,
        target,
        this._id,
      ]);
  ...
  define(
    "cordova/plugin/android/callback",
    function (require, exports, module) {
      var port = null,
        token = null,
        cordova = require("cordova"),
          ...
          xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState === 4) {
              ...
              // If security error
                ...
                console.log(
                  "JSCallback Error: Invalid token.  Stopping callbacks."
                );
              }
              ...
              // If request wasn't GET
                ...
                console.log(
                  "JSCallback Error: Bad request.  Stopping callbacks."
                );
              }
  ...
  define("cordova/plugin/battery", function (require, exports, module) {
    ...
    var Battery = function () {
      ...
      this.channels = {
        batterystatus: cordova.addWindowEventHandler(
          "batterystatus",
          subscriptionEvents
        ),
        batterylow: cordova.addWindowEventHandler(
          "batterylow",
          subscriptionEvents
        ),
        batterycritical: cordova.addWindowEventHandler(
          "batterycritical",
          subscriptionEvents
        ),
      };
    ...
    var geolocation = {
      ...
      getCurrentPosition: function (successCallback, errorCallback, options) {
        if (arguments.length === 0) {
          throw new Error(
            "getCurrentPosition must be called with at least one argument."
          );
        }
        ...
        if (
          ...
          fail({
            code: PositionError.TIMEOUT,
            message:
              "timeout value in PositionOptions set to 0 and no cached Position object available, or cached Position object's age exceed's provided PositionOptions' maximumAge parameter.",
          });
      ...
      watchPosition: function (successCallback, errorCallback, options) {
        if (arguments.length === 0) {
          throw new Error(
            "watchPosition must be called with at least one argument."
          );
        }
        options = parseParameters(options);
