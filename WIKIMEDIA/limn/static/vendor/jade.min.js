(function () {
  ...
  (require.modules = {}),
      ...
      Compiler.prototype = {
        ...
        visit: function (node) {
          ...
          debug &&
            ...
            !1 === node.debug && this.debug && (this.buf.pop(), this.buf.pop()),
            this.visitNode(node),
        ...
        visitBlock: function (block) {
          ...
          for (var i = 0; i < len; ++i) this.visit(block.nodes[i]);
        },
        visitDoctype: function (doctype) {
          doctype &&
            (doctype.val || !this.doctype) &&
        ...
        visitTag: function (tag) {
          ...
          var name = tag.name;
          this.hasCompiledTag ||
            (!this.hasCompiledDoctype && "html" == name && this.visitDoctype(),
            (this.hasCompiledTag = !0)),
            this.pp &&
              inlineTags.indexOf(name) == -1 &&
              this.buffer("\\n" + Array(this.indents).join("  ")),
            ~selfClosing.indexOf(name) && !this.xml
              ? (this.buffer("<" + name),
        ...
        visitFilter: function (filter) {
          ...
          if (!fn)
            throw filter.isASTFilter
              ? new Error('unknown ast filter "' + filter.name + ':"')
              : new Error('unknown filter ":' + filter.name + '"');
        ...
        visitAttributes: function (attrs) {
          var buf = [],
            classes = [];
          this.terse && buf.push("terse: true"),
      ...
      function parse(str, options) {
        try {
          var parser = new Parser(str, options.filename, options),
            compiler = new (options.compiler || Compiler)(
              parser.parse(),
              options
            ),
            js = compiler.compile();
      ...
      (exports.compile = function (str, options) {
        ...
        (exports.render = function (str, options, fn) {
          ...
          if (options.cache && !options.filename)
            return fn(
              new Error('the "filename" option is required for caching')
            );
          try {
    ...
    require.register("lexer.js", function (module, exports, require) {
      var Lexer = (module.exports = function (str, options) {
        (options = options || {}),
      ...
      Lexer.prototype = {
        ...
        scan: function (regexp, type) {
          ...
          if ((captures = regexp.exec(this.input)))
            return (
              this.consume(captures[0].length), this.tok(type, captures[1])
            );
        },
        defer: function (tok) {
        ...
        indexOfDelimiters: function (start, end) {
          ...
          for (var i = 0, len = str.length; i < len; ++i)
            if (start == str[i]) ++nstart;
            else if (end == str[i] && ++nend == nstart) {
              pos = i;
              break;
            }
          return pos;
        ...
        eos: function () {
          ...
          return this.indentStack.length
            ? (this.indentStack.shift(), this.tok("outdent"))
            : this.tok("eos");
        },
        comment: function () {
          var captures;
        ...
        each: function () {
          ...
          if (
            ...
            return (
              (tok.key = captures[2] || "$index"), (tok.code = captures[3]), tok
            );
          }
        },
        code: function () {
        ...
        attrs: function () {
          if ("(" == this.input[0]) {
            ...
            for (var i = 0; i < len; ++i) parse(str[i]);
            return parse(","), tok;
          }
        },
        indent: function () {
          ...
          if (captures) {
            ...
            if (this.indentStack.length && indents < this.indentStack[0]) {
              while (this.indentStack.length && this.indentStack[0] > indents)
                this.stash.push(this.tok("outdent")), this.indentStack.shift();
              tok = this.stash.pop();
            } else
              indents && indents != this.indentStack[0]
    ...
    require.register("nodes/case.js", function (module, exports, require) {
      ...
      var When = (exports.When = function (expr, block) {
    ...
    require.register("nodes/mixin.js", function (module, exports, require) {
      var Node = require("./node"),
        Mixin = (module.exports = function (name, args, block) {
          (this.name = name), (this.args = args), (this.block = block);
        });
      (Mixin.prototype = new Node()), (Mixin.prototype.constructor = Mixin);
    }),
    ...
    require.register("nodes/tag.js", function (module, exports, require) {
      ...
      (Tag.prototype = new Node()),
        ...
        (Tag.prototype.setAttribute = function (name, val) {
          return this.attrs.push({ name: name, val: val }), this;
        }),
    ...
    require.register("nodes/text.js", function (module, exports, require) {
      var Node = require("./node"),
        Text = (module.exports = function (line) {
          (this.nodes = []), "string" == typeof line && this.push(line);
        });
    ...
    require.register("parser.js", function (module, exports, require) {
      ...
      Parser.prototype = {
        context: function (parser) {
          if (parser) this.contexts.push(parser);
          else return this.contexts.pop();
        },
        advance: function () {
        ...
        parseBlockExpansion: function () {
          return ":" == this.peek().type
            ? (this.advance(), new nodes.Block(this.parseExpr()))
            : this.block();
        },
        parseCase: function () {
        ...
        parseCode: function () {
          ...
          return (
            ...
            block && (this.skip(i - 1), (node.block = this.block())),
            node
          );
        },
        ...
        parseInclude: function () {
          ...
          if (!this.filename)
            throw new Error(
              'the "filename" option is required to use includes'
            );
        ...
        parseMixin: function () {
          var tok = this.expect("mixin"),
            name = tok.val,
            args = tok.args,
            block = "indent" == this.peek().type ? this.block() : null;
        ...
        parseTextBlock: function () {
          ...
          return (
            spaces == this._spaces && (this._spaces = null),
            this.expect("outdent"),
            text
          );
        },
