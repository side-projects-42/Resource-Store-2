  ...
  function K(v) {
    ...
    function R(a, b, c, e, f) {
      ...
      for (p = r; k || p; )
        (r = j[k][p] - 1),
          p && r === j[k][p - 1]
            ? h.push((g[g.length] = { status: c, value: b[--p], index: p }))
            : k && r === j[k - 1][p]
            ? u.push((g[g.length] = { status: e, value: a[--k], index: k }))
    ...
    function S(a, d, c, e, f) {
      ...
      ("number" != typeof c.length ||
        (0 < c.length && "number" != typeof c[0].nodeType)) &&
        i(Error("Template engine must return an array of DOM nodes"));
      g = q;
      switch (d) {
    ...
    function W(a, d, c, e) {
      ...
      b.j(
        function () {
          ...
          if (
            (j =
              ("function" == typeof d ? d(m, a) : d) ||
              b.J.instance.getBindings(a, m))
          ) {
            if (0 === h) {
              h = 1;
              for (var r in j) {
                ...
                if (
                  ...
                  (u = (0, u.init)(a, f(r), g, p, m)) &&
                  u.controlsDescendantBindings
                )
                  k !== H &&
                    i(
                      Error(
            ...
            if (2 === h)
              for (r in j)
                (u = b.c[r]) &&
                  "function" == typeof u.update &&
                  (0, u.update)(a, f(r), g, p, m);
          }
        },
        n,
        { W: a }
      ...
      b.c[a] = {
        ...
        update: function (a, g, h, j, k) {
          var h = b.a.f.get(a, ca),
            ...
            m = !h.Ya;
          if (m || d || j !== h.pb)
            m && (h.Ya = b.a.Ha(b.e.childNodes(a), l)),
              j
                ? (m || b.e.N(a, b.a.Ha(h.Ya)), b.Da(e ? e(k, g) : k, a))
                : b.e.Y(a),
              (h.pb = j);
        },
      };
    ...
    b.b = function (a, d) {
      for (var c = a.split("."), e = b, f = 0; f < c.length - 1; f++)
        e = e[c[f]];
      e[c[c.length - 1]] = d;
    };
    b.p = function (a, b, c) {
    ...
    b.a = new (function () {
      ...
      var d = /^(\s|\u00A0)+|(\s|\u00A0)+$/g,
        c = {},
        e = {};
      c[/Firefox\/2/i.test(fa.userAgent) ? "KeyboardEvent" : "UIEvents"] = [
        "keyup",
        "keydown",
        "keypress",
      ];
      ...
      var k = { propertychange: l },
        m,
        c = 3;
      f = x.createElement("div");
      for (
        g = f.getElementsByTagName("i");
        (f.innerHTML = "<!--[if gt IE " + ++c + "]><i></i><![endif]-->"), g[0];
      ...
      return {
        ...
        Gb: function (a) {
          for (
            var a = b.a.L(a), d = x.createElement("div"), c = 0, e = a.length;
            c < e;
            c++
          )
        ...
        Xa: function (a, d) {
          ...
          if (0 < c.length) {
            for (
              var e = c[0], g = e.parentNode, f = 0, h = d.length;
              f < h;
              f++
            )
        ...
        Qb: function (a, d) {
          for (
            var c = [], e = (a || "").split(d), f = 0, g = e.length;
            f < g;
            f++
          ) {
            var h = b.a.D(e[f]);
        ...
        n: function (b, d, c) {
          ...
          if (!e && "undefined" != typeof E) {
            ...
            !e && "function" == typeof b.addEventListener
              ? b.addEventListener(d, c, q)
              : "undefined" != typeof b.attachEvent
              ? b.attachEvent("on" + d, function (a) {
                  c.call(b, a);
                })
              : i(
                  Error(
        ...
        Aa: function (b, d) {
          (!b || !b.nodeType) &&
            i(Error("element must be a DOM node when calling triggerEvent"));
          if ("undefined" != typeof E) {
            var c = [];
            a(b, d) && c.push({ mb: b.checked });
            E(b).trigger(d, c);
          } else
            "function" == typeof x.createEvent
              ? "function" == typeof b.dispatchEvent
                ? ((c = x.createEvent(e[d] || "HTMLEvents")),
                  c.initEvent(d, l, l, w, 0, 0, 0, 0, 0, q, q, q, q, 0, b),
                  b.dispatchEvent(c))
                : i(Error("The supplied element doesn't support dispatchEvent"))
              : "undefined" != typeof b.fireEvent
              ? (a(b, d) && (b.checked = b.checked !== l),
                b.fireEvent("on" + d))
              : i(Error("Browser doesn't support triggering events"));
        },
        d: function (a) {
          return b.$(a) ? a() : a;
        },
        ...
        bb: function (a, d) {
          ...
          if (3 === a.nodeType) a.data = c;
            ...
            !e || 3 != e.nodeType || b.e.nextSibling(e)
              ? b.e.N(a, [x.createTextNode(c)])
              : (e.data = c);
            b.a.vb(a);
          }
        },
        $a: function (a, b) {
          ...
          if (7 >= m)
            try {
              a.mergeAttributes(
                x.createElement("<input name='" + a.name + "'/>"),
                q
              );
            } catch (d) {}
        },
        ...
        Na: function (a, d) {
          for (
            var c = b.a
                ...
                .concat(b.a.L(a.getElementsByTagName("textarea"))),
              e =
                "string" == typeof d
                  ? function (a) {
                      return a.name === d;
        ...
        Hb: function (a) {
          return "string" == typeof a && (a = b.a.D(a))
            ? w.JSON && w.JSON.parse
              ? w.JSON.parse(a)
    ...
    b.a.sa = function (a) {
      ...
      if ("undefined" != typeof E) {
        ...
        c = (c.match(/^<(thead|tbody|tfoot)/) && [1, "<table>", "</table>"]) ||
          (!c.indexOf("<tr") && [2, "<table><tbody>", "</tbody></table>"]) ||
          ((!c.indexOf("<td") || !c.indexOf("<th")) && [
            3,
            "<table><tbody><tr>",
            "</tr></tbody></table>",
          ]) || [0, "", ""];
        ...
        for (
          "function" == typeof w.innerShiv
            ? d.appendChild(w.innerShiv(a))
            : (d.innerHTML = a);
          c[0]--;
    ...
    b.a.ca = function (a, d) {
      ...
      if (d !== n && d !== H)
        if (
          ("string" != typeof d && (d = d.toString()), "undefined" != typeof E)
        )
          E(a).html(d);
        else
          for (var c = b.a.sa(d), e = 0; e < c.length; e++) a.appendChild(c[e]);
    };
    ...
    b.s = {
      qa: function (a) {
        "function" != typeof a &&
          i(Error("You can only pass a function to ko.memoization.memoize()"));
        var b =
    ...
    b.Pa = function (a) {
      return (
        "function" == typeof a.xa && "function" == typeof a.notifySubscribers
      );
    };
    ...
    var la = { undefined: l, boolean: l, number: l, string: l };
    b.m = function (a) {
      function d() {
    ...
    b.Qa = function (a) {
      return ("function" == typeof a && a[D] === b.m) ||
        ("function" == typeof a && a[D] === b.j && a.yb)
        ? l
        : q;
    };
    b.b("observable", b.m);
    ...
    b.fb = function (a) {
      0 == arguments.length &&
        i(Error("When calling ko.toJS, pass the object you want to convert."));
    ...
    b.k = {
      q: function (a) {
        switch (b.a.u(a)) {
          case "option":
            return a.__ko__hasDomDataOptionValue__ === l
              ? b.a.f.get(a, b.c.options.ra)
              : 7 >= b.a.Z
              ? a.getAttributeNode("value").specified
                ? a.value
                : a.text
              : a.value;
          case "select":
          ...
          case "option":
            switch (typeof d) {
              case "string":
                ...
                break;
              default:
                b.a.f.set(a, b.c.options.ra, d),
                  (a.__ko__hasDomDataOptionValue__ = l),
                  (a.value = "number" === typeof d ? d : "");
            }
            break;
          case "select":
    ...
    b.g = {
      ...
      aa: function (a) {
        ...
        for (var a = [], c = n, e, f = 0; f < d.length; f++) {
          var g = d.charAt(f);
          if (c === n)
            switch (g) {
              case '"':
        ...
        for (f = d.length; c < f; c++)
          (j = d[c]),
            ...
            0 < k && k < j.length - 1
              ? ((g = j.substring(k + 1)),
                e.push({ key: O(j.substring(0, k), a), value: O(g, a) }))
      ...
      ba: function (a) {
        for (
          ...
          if ((0 < c.length && c.push(","), e.key)) {
            ...
            c.push(e);
            e = b.a.D(e);
            0 <= b.a.i(ma, b.a.D(e).toLowerCase())
              ? (e = q)
              : ((h = e.match(na)),
            ...
            e &&
              (0 < a.length && a.push(", "),
              a.push(
                g + " : function(__ko_value) { " + e + " = __ko_value; }"
              ));
          } else e.unknown && c.push(e.unknown);
        d = c.join("");
        0 < a.length &&
          (d = d + ", '_ko_property_writers' : { " + a.join("") + " } ");
        return d;
      },
      Db: function (a, d) {
    ...
    b.e = {
      ...
      Oa: function (a, d, c) {
        c
          ? A(a)
            ? a.parentNode.insertBefore(d, c.nextSibling)
            : c.nextSibling
    ...
    b.z = function (a, d, c) {
      d
        ? (b.a.extend(this, d),
          ...
          (this.$parent = d.$data),
          (this.$parents = (d.$parents || []).slice(0)),
          this.$parents.unshift(this.$parent))
        : ((this.$parents = []), (this.$root = a), (this.ko = b));
      this.$data = a;
      c && (this[c] = a);
    };
      ...
      update: function (a, d) {
        ...
        for (e in c)
          if ("string" == typeof e) {
            ...
            8 >= b.a.Z && e in ea
              ? ((e = ea[e]), g ? a.removeAttribute(e) : (a[e] = f))
              : g || a.setAttribute(e, f.toString());
    ...
    b.c.checked = {
      init: function (a, d, c) {
        b.a.n(a, "click", function () {
          ...
          var f = d(),
            g = b.a.d(f);
          "checkbox" == a.type && g instanceof Array
            ? ((e = b.a.i(g, a.value)),
              a.checked && 0 > e
                ? f.push(a.value)
                : !a.checked && 0 <= e && f.splice(e, 1))
            : b.g.ea(f, c, "checked", e, l);
        });
      ...
      update: function (a, d) {
        var c = b.a.d(d());
        "checkbox" == a.type
          ? (a.checked = c instanceof Array ? 0 <= b.a.i(c, a.value) : c)
          : "radio" == a.type && (a.checked = a.value == c);
      },
    };
    b.c.css = {
      update: function (a, d) {
    ...
    b.c.hasfocus = {
      ...
      update: function (a, d) {
        ...
        a.__ko_hasfocusUpdating ||
          (c ? a.focus() : a.blur(),
          b.r.K(b.a.Aa, n, [a, c ? "focusin" : "focusout"]));
      },
    };
    b.c.html = {
      init: function () {
    ...
    b.c.options = {
      update: function (a, d, c) {
        "select" !== b.a.u(a) &&
          i(Error("options binding applies only to SELECT elements"));
        for (
          var e = 0 == a.length,
            f = b.a.V(
              b.a.fa(a.childNodes, function (a) {
    ...
    b.c.selectedOptions = {
      ...
      update: function (a, d) {
        "select" != b.a.u(a) &&
          i(Error("values binding applies only to SELECT elements"));
        var c = b.a.d(d());
        c &&
          "number" == typeof c.length &&
          b.a.o(a.getElementsByTagName("option"), function (a) {
    ...
    b.c.submit = {
      init: function (a, d, c, e) {
        "function" != typeof d() &&
          i(Error("The value for a submit binding must be a function"));
        b.a.n(a, "submit", function (b) {
          ...
          try {
            ...
            c !== l &&
              (b.preventDefault ? b.preventDefault() : (b.returnValue = q));
          }
        });
      },
    };
    ...
    b.v.prototype.isTemplateRewritten = function (a, b) {
      return this.allowTemplateRewriting === q
        ? l
    ...
    b.ya = {
      ...
      Fb: function (a, b) {
        return a
          .replace(pa, function (a, e, f, g, h, j, k) {
            return V(k, e, b);
          })
    ...
    b.va = function (a) {
      a != H &&
        !(a instanceof b.v) &&
        i(Error("templateEngine must inherit from ko.templateEngine"));
      N = a;
    };
    b.ua = function (a, d, c, e, f) {
      c = c || {};
      (c.templateEngine || N) == H &&
        i(Error("Set a template engine before calling renderTemplate"));
      f = f || "replaceChildren";
      if (e) {
        var g = M(e);
        return b.j(
      ...
      return b.j(
        function () {
          ...
          a = b.a.fa(a, function (a) {
            return (
              c.includeDestroyed || a === H || a === n || !b.a.d(a._destroy)
            );
          });
    ...
    b.c.template = {
      ...
      update: function (a, d, c, e, f) {
        ...
        "string" != typeof d &&
          ((c = d),
          (d = c.name),
          "if" in c && (e = b.a.d(c["if"])),
          e && "ifnot" in c && (e = !b.a.d(c.ifnot)),
          (g = b.a.d(c.data)));
        "foreach" in c
          ? (h = b.Lb(d || a, (e && c.foreach) || [], c, a, f))
          : e
          ? ((f = "data" in c ? f.createChildContext(g, c.as) : f),
            (h = b.ua(d || a, f, c, a)))
          : b.e.Y(a);
        f = h;
        (g = b.a.f.get(a, "__ko__templateComputedDomDataKey__")) &&
          "function" == typeof g.B &&
          g.B();
    ...
    b.g.Q.template = function (a) {
      a = b.g.aa(a);
      return (1 == a.length && a[0].unknown) || b.g.Db(a, "name")
        ? n
    ...
    b.a.Ia = function (a, b, c) {
      ...
      return a.length <= b.length
        ? R(a, b, "added", "deleted", c)
        : R(b, a, "deleted", "added", c);
    };
        ...
        switch (((D = B.moved), B.status)) {
          case "deleted":
            D === H &&
              ((s = k[u]),
              s.j && s.j.B(),
              A.push.apply(A, L(s.M)),
              e.beforeRemove && ((d[C] = s), z.push(s)));
            u++;
            break;
          case "retained":
            g(C, u++);
    ...
    b.pa = function () {
      ...
      this.renderTemplateSource = function (b, c, e) {
        ...
        f ||
          ...
          (f = E.template(
            n,
            "{{ko_with $item.koBindingContext}}" + f + "{{/ko_with}}"
          )),
          b.data("precompiled", f));
        b = [c.$data];
