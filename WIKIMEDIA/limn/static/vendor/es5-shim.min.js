(function (n) {
  ...
  var l = Function.prototype.call,
    ...
    r,
    o;
  if ((o = h(f, "__defineGetter__")))
    (t = l.bind(f.__defineGetter__)),
      (u = l.bind(f.__defineSetter__)),
      (q = l.bind(f.__lookupGetter__)),
      (r = l.bind(f.__lookupSetter__));
  if (!Array.isArray)
  ...
  if (!Array.prototype.filter)
    Array.prototype.filter = function (a, d) {
      ...
      if ("[object Function]" != m(a)) throw new TypeError();
      for (var g = 0; g < c; g++)
        g in b && a.call(d, b[g], g, b) && e.push(b[g]);
      return e;
    };
  ...
  if (!Object.getOwnPropertyDescriptor)
    Object.getOwnPropertyDescriptor = function (a, d) {
      if (("object" != typeof a && "function" != typeof a) || null === a)
        throw new TypeError(
          "Object.getOwnPropertyDescriptor called on a non-object: " + a
        );
      if (h(a, d)) {
        var b, c, e;
  ...
  if (!Object.defineProperty || s)
    Object.defineProperty = function (a, d, b) {
      ...
      if (("object" != typeof b && "function" != typeof b) || null === b)
        throw new TypeError("Property description must be an object: " + b);
      if (s)
        try {
  ...
  if (
    ...
    Date.prototype.toISOString = function () {
      ...
      c =
        (0 > c ? "-" : 9999 < c ? "+" : "") +
        ("00000" + Math.abs(c)).slice(0 <= c && 9999 >= c ? -4 : -6);
    ...
    Date = (function (a) {
      ...
      d.parse = function (d) {
        ...
        if (c) {
          ...
          h = +c[0];
          return 0 <= h && 99 >= h
            ? ((c[0] = h + 400), a.UTC.apply(this, c) + f - 126227808e5)
            : a.UTC.apply(this, c) + f;
        }
