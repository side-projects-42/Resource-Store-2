(function () {
  ...
  function v(t) {
    ...
    return (
      n.selectNode(document.body), n.createContextualFragment(t.responseText)
    );
  }
  function y(t) {
  ...
  function b(t) {
    function n() {
      for (var n, r = e, i = -1, u = r.length; u > ++i; )
    ...
    return (
      ...
      (t
        ? 1 +
          Math.floor(
            Math.log(
              t + Math.pow(10, 1 + Math.floor(Math.log(t) / Math.LN10) - n)
            ) / Math.LN10
          )
        : 1)
    );
  ...
  function O(t) {
    ...
    n[0] * e[1] < e[0] * n[1] &&
      ((n[0] *= -1), (n[1] *= -1), (r *= -1), (i *= -1)),
      (this.rotate =
        (r ? Math.atan2(n[1], n[0]) : Math.atan2(-e[0], e[1])) * Ou),
      (this.translate = [t.e, t.f]),
      (this.scale = [r, u]),
      (this.skew = u ? Math.atan2(i, u) * Ou : 0);
  }
  function Y(t, n) {
  ...
  function Q(t, n, e) {
    ...
    var r = gn((0.4124564 * t + 0.3575761 * n + 0.1804375 * e) / sa),
      i = gn((0.2126729 * t + 0.7151522 * n + 0.072175 * e) / fa),
      u = gn((0.0193339 * t + 0.119192 * n + 0.9503041 * e) / ha);
  ...
  function fn(t, n, e) {
    ...
    return (
      ...
      (u = dn(u) * ha),
      $(
        pn(3.2404542 * i - 1.5371385 * r - 0.4985314 * u),
        pn(-0.969266 * i + 1.8760108 * r + 0.041556 * u),
        pn(0.0556434 * i - 0.2040259 * r + 1.0572252 * u)
      )
    );
  }
  function hn(t, n, e) {
  ...
  function _n(t) {
    ...
    return function (e, r) {
      ...
      r
        ? ((n.lastIndex = 0),
          n.test(a) ||
            ((a = h(a + " " + t)), u ? (i.baseVal = a) : (e.className = a)))
        : a &&
          ((a = h(a.replace(n, " "))), u ? (i.baseVal = a) : (e.className = a));
    };
  }
  function wn(t, n, e) {
    function r() {
  ...
  function An(t) {
    return (
      arguments.length || (t = d3.ascending),
      function (n, e) {
  ...
  function Tn(t, n) {
    for (var e = 0, r = t.length; r > e; e++)
      for (var i, u = t[e], a = 0, o = u.length; o > a; a++)
        (i = u[a]) && n(i, a, e);
    return t;
  }
  function qn(t) {
  ...
  function Fn() {
    ...
    var r = Hn() - n;
    r > 24
      ? (isFinite(r) && (clearTimeout(Aa), (Aa = setTimeout(Fn, r))), (Ea = 0))
      : ((Ea = 1), Ca(Fn));
  }
  function Hn() {
    for (var t = null, n = qa, e = 1 / 0; n; )
      n.flush
        ? (delete Ta[n.callback.id],
          (n = t ? (t.next = n.next) : (qa = n.next)))
  ...
  function Yn(t, n) {
    ...
    return (
      ...
      (n = n(a - u)) && ((t[r] = n.floor(u)), (t[i] = n.ceil(a))),
      t
    );
  }
  function Un() {
  ...
  function $n(t, n) {
    return d3.format(
      ",." +
        Math.max(0, -Math.floor(Math.log(Zn(t, n)[2]) / Math.LN10 + 0.01)) +
        "f"
    );
  }
  function Jn(t, n, e, r) {
    ...
    return (
      ...
      (e.domain = function (i) {
        return arguments.length
          ? ((n = 0 > i[0] ? Qn : Wn), (r = n.pow), t.domain(i.map(n)), e)
          : t.domain().map(r);
      }),
      (e.nice = function () {
  ...
  function ee(t, n) {
    ...
    return (
      ...
      (e.rangePoints = function (i, u) {
        ...
        return (
          (a = r(2 > t.length ? (c + l) / 2 : c + (s * u) / 2, s)),
          (o = 0),
  ...
  function fe(t) {
    function n(n) {
      ...
      for (
        var o, s = [], f = [], h = -1, d = n.length, g = c(e), p = c(r);
        d > ++h;

      )
        i.call(this, (o = n[h]), h)
          ? f.push([+g.call(this, o, h), +p.call(this, o, h)])
          : f.length && (a(), (f = []));
    ...
    return (
      ...
      (n.interpolate = function (t) {
        return arguments.length
          ? ((a = "function" == typeof t ? (u = t) : (u = Oa.get(t) || ge).key),
            n)
          : a;
      }),
  ...
  function _e(t, n) {
    for (
      var e, r = [], i = (1 - n) / 2, u = t[0], a = t[1], o = 1, c = t.length;
      c > ++o;
  ...
  function Le(t) {
    function n(n) {
      ...
      for (
        ...
        a.call(this, (s = n[M]), M)
          ? (v.push([(g = +x.call(this, s, M)), (p = +_.call(this, s, M))]),
            y.push([+w.call(this, s, M), +S.call(this, s, M)]))
          : v.length && (o(), (v = []), (y = []));
    ...
    return (
      ...
      (n.interpolate = function (t) {
        return arguments.length
          ? ((s = "function" == typeof t ? (l = t) : (l = Oa.get(t) || ge).key),
            (f = l.reverse || l),
            (h = l.closed ? "M" : "L"),
            n)
          : s;
  ...
  function Be(t, n) {
    if (t === n) return t;
    for (
      var e = Ze(t), r = Ze(n), i = e.pop(), u = r.pop(), a = null;
      i === u;
  ...
  function ar(t) {
    for (var n, e = 1, r = 0, i = t[0][1], u = t.length; u > e; ++e)
      (n = t[e][1]) > i && ((r = e), (i = n));
    return r;
  }
  function or(t) {
  ...
  function sr(t, n) {
    for (var e = -1, r = +t[0], i = (t[1] - r) / n, u = []; n >= ++e; )
      u[e] = i * e + r;
    return u;
  }
  function fr(t) {
  ...
  function hr(t, n) {
    return (
      d3.rebind(t, n, "sort", "children", "value"),
      (t.nodes = t),
      (t.links = mr),
      t
    );
      ...
      if (
        ...
        for (
          ...
          if (1 == g)
            for (
              c = r._pack_prev;
              c !== o._pack_prev && !br(c, u);
              c = c._pack_prev, m++
            );
          g
            ? (m > p || (p == m && i.r < r.r) ? Mr(r, (i = o)) : Mr((r = c), i),
              a--)
            : (yr(r, u), (i = u), n(u));
        }
      var v = (s + f) / 2,
  ...
  function Ir(t, n) {
    ...
    return (
      ...
      (e.parseRows = function (t, n) {
        ...
        for (
          var r, i, u = {}, a = {}, c = [], l = t.length, s = 0, f = 0;
          (r = e()) !== a;
    ...
    function e(n, i, u, a, o, c, l, s, f, h, d, g, p, m) {
      ...
      if (M > 4 * r && p--) {
        ...
        ((C * C) / M > r || Math.abs((v * T + y * q) / M - 0.5) > 0.3) &&
          (e(n, i, u, a, o, c, A, N, k, (b /= w), (x /= w), _, p, m),
          m.point(A, N),
  ...
  function ii(t, n) {
    if (!io) {
      ++uo, (t *= ju);
      var e = Math.cos((n *= ju));
      (ao += (e * Math.cos(t) - ao) / uo),
        (oo += (e * Math.sin(t) - oo) / uo),
        (co += (Math.sin(n) - co) / uo);
    }
  }
  function ui() {
  ...
  function ai() {
    ...
    var n, e, r;
    io > 1 ||
      (1 > io && ((io = 1), (uo = ao = oo = co = 0)),
      (lo.point = function (i, u) {
        i *= ju;
        var a = Math.cos((u *= ju));
        (n = a * Math.cos(i)),
          (e = a * Math.sin(i)),
  ...
  function si(t, n, e) {
    return function (r) {
      ...
      function s() {
        ...
        i > 1 && 2 & n && e.push(e.pop().concat(e.shift())),
          f.push(e.filter(gi));
      }
      var f,
        h,
  ...
  function di(t, n) {
    return (
      (0 > (t = t.point)[0] ? t[1] - Ru / 2 - Pu : Ru / 2 - t[1]) -
      (0 > (n = n.point)[0] ? n[1] - Ru / 2 - Pu : Ru / 2 - n[1])
    );
  }
  function gi(t) {
    return t.length > 1;
  ...
  function mi(t, n) {
    ...
    for (
      var e,
        ...
        l = o[1],
        s = Math.cos(l),
        f = Math.atan2(n * Math.sin(c) * s, Math.sin(l)),
        h = 1 - n * Math.cos(c) * s,
        d = f;
      e > ++u;
      ...
      (o = t[u]),
        ...
        (i = 1 - n * Math.cos(c) * s),
        (Pu > Math.abs(h - 2) && Pu > Math.abs(i - 2)) ||
          (Pu > Math.abs(i) ||
            Pu > Math.abs(h) ||
            (Pu > Math.abs(Math.abs(r - f) - Ru)
              ? i + h > 2 && (a += 4 * (r - f))
              : (a +=
                  Pu > Math.abs(h - 2)
                    ? 4 * (r - d)
                    : (((3 * Ru + r - f) % (2 * Ru)) - Ru) * (h + i))),
          (d = f),
          (f = r),
          (h = i));
    return a;
    ...
    return {
      ...
      point: function (u, a) {
        ...
        Pu > Math.abs(c - Ru)
          ...
          : i !== o &&
            c >= Ru &&
            (Pu > Math.abs(e - i) && (e -= i * Pu),
            Pu > Math.abs(u - o) && (u -= o * Pu),
            (r = yi(e, r, u, a)),
            t.point(i, r),
            t.lineEnd(),
            t.lineStart(),
  ...
  function yi(t, n, e, r) {
    var i,
      u,
      a = Math.sin(t - e);
    return Math.abs(a) > Pu
      ? Math.atan(
          (Math.sin(n) * (u = Math.cos(r)) * Math.sin(e) -
        ...
        point: function (o, c) {
          ...
          !e && (u = i = f) && t.lineStart(),
            f !== i &&
              ((l = r(e, s)),
              ($r(e, l) || $r(s, l)) &&
                ((s[0] += Pu), (s[1] += Pu), (f = n(s[0], s[1])))),
            f !== i &&
              ((a = 0),
              (i = f)
                ? (t.lineStart(), (l = r(s, e)), t.point(l[0], l[1]))
                : ((l = r(e, s)), t.point(l[0], l[1]), t.lineEnd()),
              (e = l)),
  ...
  function Ei(t, n) {
    return [
      ...
      Math.max(
        -0.5,
        Math.min(0.5, Math.log(Math.tan(Ru / 4 + n / 2)) / (2 * Ru))
      ),
    ];
  }
  function Ai(t) {
  ...
  function Fi() {
    ...
    var n, e, r, i;
    2 > io && ((io = 2), (ao = oo = co = 0)),
      (vo.point = function (u, a) {
  ...
  function Hi() {
    function t(t, n) {
      if (
        ...
        (n *= ju),
        !(
          Pu > Math.abs(Math.abs(u) - Ru / 2) &&
          Pu > Math.abs(Math.abs(n) - Ru / 2)
        ))
      ) {
        var e = Math.cos(n),
          c = Math.sin(n);
        if (Pu > Math.abs(u - Ru / 2)) Mo += 2 * (t - r);
          ...
          var l = t - i,
            ...
            f = Math.atan2(
              Math.sqrt(
                (f = e * Math.sin(l)) * f + (f = a * c - o * e * s) * f
              ),
              o * c + a * e * s
            ),
            h = (f + Ru + u + n) / 4;
  ...
  function ji(t, n) {
    return {
      point: function (e, r) {
        (r = t(e * ju, r * ju)),
          (e = r[0]),
          n.point(e > Ru ? e - 2 * Ru : -Ru > e ? e + 2 * Ru : e, r[1]);
      },
      sphere: function () {
        n.sphere();
      },
  ...
  function Ii(t, n) {
    function e(t, n) {
      var e = Math.cos(n),
        ...
        s = l * r + o * i;
      return [
        Math.atan2(c * u - s * a, o * r - l * i),
        Math.asin(Math.max(-1, Math.min(1, s * u + c * a))),
      ];
    }
    var r = Math.cos(t),
      i = Math.sin(t),
    ...
    return (
      (e.invert = function (t, n) {
        var e = Math.cos(n),
          ...
          s = l * u - c * a;
        return [
          Math.atan2(c * u + l * a, o * r + s * i),
          Math.asin(Math.max(-1, Math.min(1, s * r - o * i))),
        ];
      }),
      e
    );
    ...
    for (var a, o, c, l, s, f, h, d, g, p, m, v, y, M = e.list.shift(); ; )
      if (
        ...
        (o = r.leftBound(M)),
          ...
          r.insert(o, f),
          (p = i.intersect(o, f)),
          p && (u.del(o), u.insert(o, p, i.distance(p, M))),
          (o = f),
          (f = r.createHalfEdge(v, "r")),
          r.insert(o, f),
          (p = i.intersect(f, c)),
          p && u.insert(f, p, i.distance(p, M)),
          (M = e.list.shift());
      else {
        if (u.empty()) break;
        (o = u.extractMin()),
          ...
          r.del(c),
          (y = "l"),
          h.y > d.y && ((g = h), (h = d), (d = g), (y = "r")),
          (v = i.bisect(h, d)),
          (f = r.createHalfEdge(v, y)),
          r.insert(l, f),
          i.endPoint(v, _o[y], m),
          (p = i.intersect(l, f)),
          p && (u.del(l), u.insert(l, p, i.distance(p, h))),
          (p = i.intersect(f, s)),
          p && u.insert(f, p, i.distance(p, h));
      }
  ...
  function Gi(t, n, e, r, i, u) {
    if (!t(n, e, r, i, u)) {
      var a = 0.5 * (e + i),
        o = 0.5 * (r + u),
        c = n.nodes;
      c[0] && Gi(t, c[0], e, r, a, o),
        c[1] && Gi(t, c[1], a, r, i, o),
        c[2] && Gi(t, c[2], e, o, a, u),
        c[3] && Gi(t, c[3], a, o, i, u);
    }
  }
  function Ki() {
    this._ = new Date(
  ...
  function xu(t, n, e) {
    ...
    function a(t, r, u) {
      var a = i(t),
        o = [];
      if (u > 1) for (; r > a; ) e(a) % u || o.push(new Date(+a)), n(a, 1);
  ...
  (d3.functor = c),
    ...
    (d3.median = function (t, n) {
      return (
        ...
        (t = t.filter(s)),
        t.length ? d3.quantile(t.sort(d3.ascending), 0.5) : void 0
      );
    }),
    (d3.min = function (t, n) {
      var e,
    ...
    (d3.sum = function (t, n) {
      ...
      else for (; i > ++u; ) isNaN((e = +n.call(t, t[u], u))) || (r += e);
      return r;
    }),
    ...
    (d3.zip = function () {
      ...
      for (var t = -1, n = d3.min(arguments, f), e = Array(n); n > ++t; )
        for (var r, i = -1, u = (e[t] = Array(r)); r > ++i; )
          u[i] = arguments[i][t];
      return e;
    }),
  ...
  (d3.bisectLeft = Zu.left),
    (d3.bisect = d3.bisectRight = Zu.right),
    (d3.nest = function () {
      function t(n, o) {
        if (o >= a.length) return r ? r.call(i, n) : e ? n.sort(e) : n;
        for (
          var c, l, s, f = -1, h = n.length, d = a[o++], g = new u(), p = {};
          h > ++f;
    ...
    (d3.range = function (t, n, e) {
      ...
      var r,
        ...
        a = -1;
      if (((t *= u), (n *= u), (e *= u), 0 > e))
        for (; (r = t + e * ++a) > n; ) i.push(r / u);
      else for (; n > (r = t + e * ++a); ) i.push(r / u);
      return i;
    }),
      ...
      return (
        ...
        (i.send = function (e, r, u) {
          ...
          return (
            ...
            null != u &&
              i.on("error", u).on("load", function (t) {
                u(null, t);
              }),
  ...
  (d3.ns = {
    ...
    qualify: function (t) {
      ...
      return (
        ...
        $u.hasOwnProperty(e) ? { space: $u[e], local: t } : t
      );
    },
  }),
  ...
  (d3.interpolate = function (t, n) {
    for (
      var e, r = d3.interpolators.length;
      --r >= 0 && !(e = d3.interpolators[r](t, n));
    ...
    (d3.interpolateString = function (t, n) {
      ...
      for (ia.lastIndex = 0, r = 0; (e = ia.exec(n)); ++r)
        e.index && l.push(n.substring(o, (c = e.index))),
          ...
          (o = ia.lastIndex);
      for (
        n.length > o && l.push(n.substring(o)), r = 0, u = s.length;
        (e = ia.exec(t)) && u > r;
        ++r
      )
        if (((a = s[r]), a.x == e[0])) {
  ...
  (d3.interpolators = [
    ...
    function (t, n) {
      return (
        ...
        d3.interpolateString(t + "", n + "")
      );
    },
    function (t, n) {
      return (
        ("string" == typeof n
          ? aa.has(n) || /^(#|rgb\(|hsl\()/.test(n)
          : n instanceof B) && d3.interpolateRgb(t, n)
      );
    },
    function (t, n) {
    ...
    (d3.hcl = function (t, n, e) {
      return 1 === arguments.length
        ? t instanceof on
          ...
          : t instanceof sn
          ? hn(t.l, t.a, t.b)
          : hn((t = Q((t = d3.rgb(t)).r, t.g, t.b)).l, t.a, t.b)
        : an(+t, +n, +e);
    });
  ...
  (ca.brighter = function (t) {
    return an(
      this.h,
      this.c,
      Math.min(100, this.l + la * (arguments.length ? t : 1))
    );
  }),
    (ca.darker = function (t) {
      return an(
        this.h,
        this.c,
        Math.max(0, this.l - la * (arguments.length ? t : 1))
      );
    }),
    (ca.rgb = function () {
  ...
  (d3.selection = function () {
    ...
    (Ma.select = function (t) {
      ...
      for (var a = -1, o = this.length; o > ++a; ) {
        ...
        for (var c = -1, l = r.length; l > ++c; )
          (i = r[c])
            ? (n.push((e = t.call(i, i.__data__, c))),
    ...
    (Ma.selectAll = function (t) {
      ...
      for (var i = -1, u = this.length; u > ++i; )
        for (var a = this[i], o = -1, c = a.length; c > ++o; )
          (e = a[o]) &&
    ...
    (Ma.insert = function (t, n) {
      function e() {
        return this.insertBefore(
          document.createElementNS(this.namespaceURI, t),
          ga(n, this)
        );
      }
      function r() {
        return this.insertBefore(
          document.createElementNS(t.space, t.local),
          ga(n, this)
        );
      }
      ...
      function e(t, e) {
        ...
        if (n) {
          var m,
            ...
            M = [];
          for (r = -1; o > ++r; )
            (m = n.call((i = t[r]), i.__data__, r)),
              v.has(m) ? (p[r] = i) : v.set(m, i),
              M.push(m);
          for (r = -1; f > ++r; )
            (m = n.call(e, (a = e[r]), r)),
              (i = v.get(m))
          ...
          for (r = -1; h > ++r; )
            (i = t[r]),
              (a = e[r]),
              i ? ((i.__data__ = a), (d[r] = i)) : (g[r] = kn(a));
          for (; f > r; ++r) g[r] = kn(e[r]);
          for (; o > r; ++r) p[r] = t[r];
        }
        (g.update = d),
          (g.parentNode = d.parentNode = p.parentNode = t.parentNode),
          c.push(g),
          l.push(d),
          s.push(p);
      }
    ...
    (Ma.order = function () {
      for (var t = -1, n = this.length; n > ++t; )
        for (var e, r = this[t], i = r.length - 1, u = r[i]; --i >= 0; )
          (e = r[i]) &&
    ...
    (Ma.transition = function () {
      ...
      for (var u = -1, a = this.length; a > ++u; ) {
        r.push((t = []));
        for (var o = this[u], c = -1, l = o.length; l > ++c; )
          (n = o[c]) && zn(n, c, e, i), t.push(n);
      }
      return Cn(r, e);
    });
  var ba = mn([[document]]);
  ...
  (d3.selection.enter = qn),
    ...
    (xa.select = function (t) {
      for (var n, e, r, i, u, a = [], o = -1, c = this.length; c > ++o; ) {
        ...
        for (var l = -1, s = i.length; s > ++l; )
          (u = i[l])
            ? (n.push((r[l] = e = t.call(i.parentNode, u.__data__, l))),
  ...
  (wa.call = Ma.call),
    ...
    (wa.attr = function (t, n) {
      ...
      return Ln(this, "attr." + t, n, function (t) {
        ...
        function a() {
          var n,
            e = this.getAttributeNS(u.space, u.local);
          return (
            e !== t &&
            ((n = i(e, t)),
            function (t) {
    ...
    (wa.style = function (t, n, e) {
      ...
      return Ln(this, "style." + t, n, function (n) {
        function i() {
          var r,
            i = getComputedStyle(this, null).getPropertyValue(t);
          return (
            i !== n &&
            ((r = u(i, n)),
            function (n) {
      ...
      return (
        ...
        this.tween("style." + t, function (r, i) {
          var u = n.call(
            ...
            r,
            i,
            getComputedStyle(this, null).getPropertyValue(t)
          );
          return (
            u &&
            function (n) {
    ...
    (wa.ease = function (t) {
      ...
      return 1 > arguments.length
        ...
        : ("function" != typeof t && (t = d3.ease.apply(d3, arguments)),
          Tn(this, function (e) {
    ...
    (wa.transition = function () {
      for (
        var t, n, e, r, i = this.id, u = ++Sa, a = [], o = 0, c = this.length;
        c > o;
        o++
      ) {
        a.push((t = []));
  ...
  (d3.timer = function (t, n, e) {
    ...
    r && r.callback === t
      ? ((r.then = e), (r.delay = n))
      : (Ta[(t.id = ++Na)] = qa = { callback: t, then: e, delay: n, next: qa }),
    ...
    (d3.svg.chord = function () {
      function e(t, n) {
        ...
        return (
          "M" +
          e.p0 +
          u(e.r, e.p1, e.a1 - e.a0) +
          (i(e, c)
            ? a(e.r, e.p1, e.r, e.p0)
            : a(e.r, e.p1, c.r, c.p0) +
              u(c.r, c.p1, c.a1 - c.a0) +
              a(c.r, c.p1, e.r, e.p0)) +
          "Z"
        );
      }
  ...
  (d3.svg.axis = function () {
    ...
    return (
      ...
      (t.tickSize = function (n, e) {
        ...
        return (
          (i = +n), (u = r > 1 ? +e : i), (a = r > 0 ? +arguments[r] : i), t
        );
      }),
    ...
    (d3.svg.brush = function () {
      function t(u) {
        u.each(function () {
          ...
          a
            ...
            h.exit().remove(),
            o &&
              ((u = On(o)), s.attr("x", u[0]).attr("width", u[1] - u[0]), e(a)),
            c &&
              ((u = On(c)),
              s.attr("y", u[0]).attr("height", u[1] - u[0]),
              r(a)),
            n(a);
        });
      }
      function n(t) {
        t.selectAll(".resize").attr("transform", function (t) {
          return (
            "translate(" + s[+/e$/.test(t)][0] + "," + s[+/^s/.test(t)][1] + ")"
          );
        });
      }
      function e(t) {
      ...
      function i() {
        ...
        function l() {
          32 == d3.event.keyCode &&
            (S || ((p = null), (k[0] -= s[1][0]), (k[1] -= s[1][1]), (S = 2)),
            R());
        }
        function f() {
          32 == d3.event.keyCode &&
            2 == S &&
            ((k[0] += s[1][0]), (k[1] += s[1][1]), (S = 0), R());
        }
        function h() {
          var t = i(),
            u = !1;
          m && ((t[0] += m[0]), (t[1] += m[1])),
            S ||
              (d3.event.altKey
                ? (p ||
                    (p = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]),
                  (k[0] = s[+(t[0] < p[0])][0]),
                  (k[1] = s[+(t[1] < p[1])][1]))
                : (p = null)),
            _ && d(t, o, 0) && (e(b), (u = !0)),
            w && d(t, c, 1) && (r(b), (u = !0)),
            u && (n(b), M({ type: "brush", mode: S ? "move" : "resize" }));
        }
        function d(t, n, e) {
          var r,
            i,
          ...
          return (
            ...
            S
              ? (i = (r += l) + f)
              : (p && (l = Math.max(o, Math.min(c, 2 * p[e] - r))),
                r > l ? ((i = r), (r = l)) : (i = l)),
            s[0][e] !== r || s[1][e] !== i
      ...
      var u,
        a = j(t, "brushstart", "brush", "brushend"),
        o = null,
        c = null,
        l = $a[0],
        s = [
    ...
    (d3.behavior.drag = function () {
      ...
      function n() {
        function t() {
          var t = o.parentNode;
          return null != s
            ? d3.touches(t).filter(function (t) {
        ...
        function i() {
          c({ type: "dragend" }),
            h && (R(), d3.event.target === l && d.on("click.drag", u, !0)),
            d
        ...
        var a,
          ...
          d = d3
            .select(window)
            .on(null != s ? "touchmove.drag-" + s : "mousemove.drag", n)
            .on(null != s ? "touchend.drag-" + s : "mouseup.drag", i, !0);
        r
          ? ((a = r.apply(o, arguments)), (a = [a.x - f[0], a.y - f[1]]))
          : (a = [0, 0]),
          null == s && R(),
          c({ type: "dragstart" });
      }
    ...
    (d3.behavior.zoom = function () {
      function t() {
        this.on("mousedown.zoom", o)
          .on("mousewheel.zoom", c)
          .on("mousemove.zoom", l)
          .on("DOMMouseScroll.zoom", c)
          .on("dblclick.zoom", s)
      ...
      function s() {
        ...
        r(
          Math.pow(2, d3.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1)
        ),
          i(t, e),
          a(w.of(this, arguments));
      }
      ...
      return (
        ...
        (t.scaleExtent = function (n) {
          return arguments.length
            ? ((_ = null == n ? Ga : n.map(Number)), t)
            : _;
        }),
        (t.x = function (n) {
          return arguments.length
            ? ((m = n), (p = n.copy()), (b = [0, 0]), (x = 1), t)
            : m;
        }),
        (t.y = function (n) {
          return arguments.length
  ...
  (d3.layout = {}),
    ...
    (d3.layout.chord = function () {
      function t() {
        ...
        for (
          ...
          (r[y] = { index: y, startAngle: f, endAngle: l, value: (l - f) / t }),
            (l += s);
        }
        for (h = -1; u > ++h; )
          for (d = h - 1; u > ++d; ) {
    ...
    (d3.layout.force = function () {
      ...
      return (
        (l.tick = function () {
          if (0.005 > (r *= 0.99))
            return s.end({ type: "end", alpha: (r = 0) }), !0;
          var n,
            e,
            a,
            c,
          ...
          if (p)
            for (We((n = d3.geom.quadtree(y)), r, o), e = -1; x > ++e; )
    ...
    (d3.layout.pie = function () {
      function t(u) {
        var a = u.map(function (e, r) {
          ...
          c =
            (("function" == typeof i ? i.apply(this, arguments) : i) - r) /
            d3.sum(a),
          l = d3.range(u.length);
        null != e &&
          l.sort(
  ...
  d3.layout.stack = function () {
    ...
    return (
      ...
      (t.order = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : Wa.get(n) || ir), t)
          : e;
      }),
      (t.offset = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : Qa.get(n) || ur), t)
          : r;
      }),
      (t.x = function (n) {
  ...
  (d3.layout.histogram = function () {
      ...
      if (d > 0)
        for (u = -1; h > ++u; )
          (o = l[u]),
            o >= s[0] &&
              s[1] >= o &&
              ((a = c[d3.bisect(f, o, 1, d) - 1]), (a.y += g), a.push(t[u]));
      return c;
    }
    var n = !0,
      e = Number,
    ...
    (d3.layout.hierarchy = function () {
      function t(n, a, o) {
        ...
        if (((n.depth = a), o.push(n), c && (l = c.length))) {
          for (
            var l, s, f = -1, h = (n.children = []), d = 0, g = a + 1;
            l > ++f;
      ...
      function t(t, i) {
        function u(t, n) {
          ...
          if (r && (a = r.length)) {
            ...
            Pr(t);
            var d = 0.5 * (s._tree.prelim + l._tree.prelim);
            n
              ? ((i.prelim = n._tree.prelim + e(t, n)), (i.mod = i.prelim - d))
              : (i.prelim = d);
          ...
          if (n) {
            for (
              ...
              (c = Cr(c)),
                ...
                i > 0 && (jr(Or(o, t, r), t, i), (l += i), (s += i)),
                (f += o._tree.mod),
                (l += u._tree.mod),
                (h += c._tree.mod),
                (s += a._tree.mod);
            o && !zr(a) && ((a._tree.thread = o), (a._tree.mod += f - s)),
              u &&
                !Cr(c) &&
                ((c._tree.thread = u), (c._tree.mod += l - h), (r = t));
          }
          return r;
        }
    ...
    (d3.layout.treemap = function () {
            ...
            p =
              "slice" === d
                ...
                ? 1 & e.depth
                  ...
                  : l.dx
                : Math.min(l.dx, l.dy);
          for (t(h, (l.dx * l.dy) / e.value), s.area = 0; (c = h.length) > 0; )
            s.push((a = h[c - 1])),
              (s.area += a.area),
              "squarify" !== d || g >= (o = r(s, p))
                ? (h.pop(), (g = o))
                : ((s.area -= s.pop().area),
                  i(s, p, l, !1),
      ...
      function e(n) {
        ...
        if (r && r.length) {
          var u,
            ...
            o = r.slice(),
            c = [];
          for (t(o, (a.dx * a.dy) / n.value), c.area = 0; (u = o.pop()); )
            c.push(u),
              (c.area += u.area),
              null != u.z &&
      ...
      function r(t, n) {
        for (
          var e, r = t.area, i = 0, u = 1 / 0, a = -1, o = t.length;
          o > ++a;

        )
          (e = t[a].area) && (u > e && (u = e), e > i && (i = e));
        return (
          (r *= r),
          (n *= n),
          r ? Math.max((n * i * g) / r, r / (n * u * g)) : 1 / 0
        );
      }
      function i(t, n, e, r) {
        var i,
      ...
      return (
        ...
        (u.padding = function (t) {
          function n(n) {
            ...
            return null == e
              ? Yr(n)
              : Ur(n, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(n) {
            return Ur(n, t);
          }
    ...
    return (
      ...
      (t.translate = function (n) {
        ...
        return (
          ...
          i.translate([o - 0.19 * a, c + 0.2 * a]),
          u.translate([o + 0.58 * a, c + 0.43 * a]),
          t
        );
      }),
      t.scale(e.scale())
  ...
  ((d3.geo.azimuthalEquidistant = function () {
    ...
    (d3.geo.centroid = function (t) {
      ...
      var n;
      return uo && Math.abs((n = Math.sqrt(ao * ao + oo * oo + co * co))) > Pu
        ? [
            Math.atan2(oo, ao) * Ou,
            Math.asin(Math.max(-1, Math.min(1, co / n))) * Ou,
          ]
        : void 0;
    });
  var io,
  ...
  ((d3.geo.gnomonic = function () {
    ...
    (d3.geo.graticule = function () {
      ...
      function n() {
        return d3
          .range(Math.ceil(r / c) * c, e, c)
          .map(a)
          .concat(d3.range(Math.ceil(u / l) * l, i, l).map(o));
      }
      var e,
        r,
        i,
        ...
        (e.source = function (t) {
          return arguments.length
            ? ((a = t),
              ...
              (u = r && i ? d3.geo.interpolate(r, i) : null),
              e)
            : a;
        }),
        (e.target = function (t) {
    ...
    (d3.geo.path = function () {
      ...
      return (
        ...
        (t.projection = function (e) {
          return arguments.length
            ? ((r = (n = e) ? e.stream || Ni(e) : a), t)
            : n;
        }),
        (t.context = function (n) {
          return arguments.length
            ? ((i = null == (e = n) ? new Ti() : new qi(n)), t)
            : e;
        }),
        (t.pointRadius = function (n) {
          return arguments.length
            ? ((u = "function" == typeof n ? n : +n), t)
            : u;
        }),
  ...
  ((d3.geo.stereographic = function () {
    ...
    (d3.geom.hull = function (t) {
      ...
      for (n = 1; f > n; ++n)
        t[n][1] < t[p][1]
          ? (p = n)
          : t[n][1] == t[p][1] && (p = t[n][0] < t[p][0] ? n : p);
      for (n = 0; f > n; ++n)
        n !== p &&
          ((i = t[n][1] - t[p][1]),
          (r = t[n][0] - t[p][0]),
          d.push({ angle: Math.atan2(i, r), index: n }));
      for (
        d.sort(function (t, n) {
        ...
        (e = d[n].index),
          l == d[n].angle
            ? ((r = t[c][0] - t[p][0]),
              ...
              r * r + i * i >= u * u + a * a
                ? (d[n].index = -1)
                : ((d[o].index = -1), (l = d[n].angle), (o = n), (c = e)))
            : ((l = d[n].angle), (o = n), (c = e));
    ...
    (d3.geom.polygon = function (t) {
      return (
        ...
        (t.clip = function (n) {
          for (
            var e, r, i, u, a, o, c = -1, l = t.length, s = t[l - 1];
            l > ++c;
            ...
            for (
              ...
              (o = e[r]),
                Zi(o, s, u)
                  ? (Zi(a, s, u) || n.push(Bi(a, o, s, u)), n.push(o))
                  : Zi(a, s, u) && n.push(Bi(a, o, s, u)),
                (a = o);
            s = u;
          }
          return n;
          ...
          if (t.leaf) {
            ...
            o
              ? 0.01 > Math.abs(o.x - n.x) + Math.abs(o.y - n.y)
                ? a(t, n, e, r, i, u)
                : ((t.point = null), a(t, o, e, r, i, u), a(t, n, e, r, i, u))
              : (t.point = n);
          } else a(t, n, e, r, i, u);
      }
    ...
    function n(n) {
      for (var r, i, u, a = [], o = -1, c = 0; e > ++o; )
        37 === t.charCodeAt(o) &&
          ...
          null != (i = jo[(r = t.charAt(++o))]) && (r = t.charAt(++o)),
          (u = Oo[r]) && (r = u(n, null == i ? ("e" === r ? " " : "0") : i)),
          a.push(r),
          (c = o + 1));
  ...
  (d3.time.format.iso = Date.prototype.toISOString ? bu : Vo),
    (bu.parse = function (t) {
      var n = new Date(t);
      return isNaN(n) ? null : n;
    }),
    (bu.toString = Vo.toString),
    (d3.time.second = xu(
      function (t) {
    ...
    So.forEach(function (t, n) {
      ...
      var e = (d3.time[t] = xu(
        function (t) {
          return (
            (t = d3.time.day(t)).setDate(t.getDate() - ((t.getDay() + n) % 7)),
            t
          );
        },
        function (t, n) {
        ...
        function (t) {
          ...
          return (
            Math.floor((d3.time.dayOfYear(t) + ((e + n) % 7)) / 7) - (e !== n)
          );
        }
      ));
      (d3.time[t + "s"] = e.range),
