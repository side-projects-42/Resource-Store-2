...
(function (e) {
  ...
  function q(e, t, n, r) {
    ...
    return (
      ...
      (s = new Date(0)),
      t
        ? (s.setUTCFullYear(e[0], e[1], e[2]),
          s.setUTCHours(e[3], e[4], e[5], e[6]))
        : (s.setFullYear(e[0], e[1], e[2]), s.setHours(e[3], e[4], e[5], e[6])),
      (s._a = o),
      s
    );
  }
  function R(e, n) {
    ...
    for (r = 0; r < 12; r++)
      (i = t([2e3, r])),
        (o[r] = new RegExp(
          "^" +
            (n.months[r] || n.months(i, "")) +
            "|^" +
            (n.monthsShort[r] || n.monthsShort(i, "")).replace(".", ""),
          "i"
        ));
  ...
  (A.DDDD = M(A.DDD, 3)),
    (t = function (n, r) {
      ...
      var i, s;
      return t.isMoment(n)
        ? new D(new Date(+n._d), n._isUTC, n._lang)
        : (r
            ? F(r)
              ? (i = K(n, r))
              : (i = J(n, r))
        ...
        isValid: function () {
          return this._a
            ? this._a[8] != null
              ...
              : !I(
                  this._a,
                  (this._a[7] ? t.utc(this._a) : t(this._a)).toArray()
                )
    ...
    (t.duration.fn = P.prototype =
      {
        ...
        humanize: function (e) {
          ...
          return (
            e &&
              (typeof i == "function" ? (r = i(r)) : (r = i.replace(/%s/i, r))),
            r
          );
        },
        lang: t.fn.lang,
