  ...
  function addRequireMethods(req, context, relMap) {
    each(
      ...
      function (item) {
        ...
        req[item[0]] = context
          ? makeContextModuleFunc(context[prop], relMap)
  ...
  function newContext(contextName) {
    ...
    function makeRequire(mod, enableBuildCallback, altRequire) {
      var relMap = mod && mod.map,
        modRequire = makeContextModuleFunc(
    ...
    return (context = {
      ...
      toUrl: function (moduleNamePlusExt, relModuleMap) {
        ...
        return context.nameToUrl(
          normalize(moduleNamePlusExt, relModuleMap && relModuleMap.id, true),
          ext
        );
      },
      ...
      onScriptError: function (evt) {
        ...
        if (!hasPathFallback(data.id)) {
          return onError(
            makeError("scripterror", "Script error", evt, [data.id])
          );
        }
      },
    });
