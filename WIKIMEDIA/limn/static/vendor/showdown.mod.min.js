require.define("/node_modules/showdown.js", function (e, t, n, r, i) {
  var s = { extensions: {} },
    o = (s.forEach = function (e, t) {
      if (typeof e.forEach == "function") e.forEach(t);
      else {
        var n,
          r = e.length;
  ...
  (s.converter = function (i) {
    ...
    if (
      ...
      if (p) {
        ...
        s.forEach(v, function (t) {
          var n = u(t);
          s.extensions[n] = e("./extensions/" + t);
        });
      }
    }
    ...
    if (i && i.extensions) {
      var m = this;
      s.forEach(i.extensions, function (e) {
        typeof e == "string" && (e = s.extensions[u(e)]);
        ...
        s.forEach(e(m), function (e) {
          e.type
            ? e.type === "language" || e.type === "lang"
              ? c.push(e)
              : (e.type === "output" || e.type === "html") && h.push(e)
            : h.push(e);
        });
      });
    }
    var g = function (e, t) {
      ...
      N = function (e, t, n, r, i, s, u, f) {
        ...
        if (p == "") {
          ...
          if (o[h] != undefined) (p = o[h]), a[h] != undefined && (d = a[h]);
          else {
      ...
      k = function (e, t, n, r, i, s, u, f) {
        ...
        if (p == "") {
          h == "" && (h = c.toLowerCase().replace(/ ?\n/g, " ")), (p = "#" + h);
          if (o[h] == undefined) return l;
          (p = o[h]), a[h] != undefined && (d = a[h]);
        }
        (c = c.replace(/"/g, "&quot;")), (p = V(p, "*_"));
      ...
      L = function (e) {
        ...
        return (
          (e = e.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm, function (e, n) {
            return D('<h1 id="' + t(n) + '">' + S(n) + "</h1>");
          })),
          (e = e.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm, function (e, n) {
            return D('<h2 id="' + t(n) + '">' + S(n) + "</h2>");
          })),
          (e = e.replace(
            /^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm,
            function (e, n, r) {
    ...
    var M = function (e) {
      ...
      F = function (e) {
        ...
        r = n.length;
        for (var i = 0; i < r; i++)
          while (n[i].search(/~K(\d+)K/) >= 0) {
            var o = f[RegExp.$1];
            (o = o.replace(/\$/g, "$$$$")), (n[i] = n[i].replace(/~K\d+K/, o));
          }
        return n.join("\n\n");
      },
      I = function (e) {
    ...
    typeof t != "undefined" && (t.exports = s),
