(function ($) {
  ...
  function toggleMenuItem() {
    return $("<div>")
      .addClass("ime-disable selectable-row")
      .append(
        $("<span>")
  ...
  IMESelector.prototype = {
    ...
    position: function () {
      ...
      if (verticalRoom < this.$imeSetting.outerHeight()) {
        ...
        menuTop = this.$menu.outerHeight() + this.$imeSetting.outerHeight();
      ...
      if (menuWidth > left || (rtlElement && overflowsOnRight)) {
        if (rtlElement) {
          if (overflowsOnRight) {
    ...
    prepareLanguageList: function () {
      ...
      for (languageCodeIndex in languageList) {
        ...
        $language = $("<li>")
          .addClass("ime-lang selectable-row")
    ...
    prepareInputMethods: function (languageCode) {
      ...
      language.inputmethods.forEach(function (inputmethod) {
        ...
        $inputMethod = $("<li>")
          ...
          .append($("<span>").addClass("ime-im-check"), $imeItem);
    ...
    helpLink: function () {
      return $("<div>")
        .addClass("ime-help-link selectable-row")
        .append(
          $("<a>").text("Help").addClass("selectable-row-item").attr({
