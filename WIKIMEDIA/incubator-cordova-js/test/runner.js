...
module.exports = {
  node: function () {
    ...
    try {
      ...
      console.log(
        "can't run tests in node: run jake btest instead, or install jsdom via: sudo npm install jsdom"
      );
      return;
    }
    ...
    //load in our modules
    var testLibName = _path.join(
      __dirname,
      "..",
      "pkg",
      "cordova.test-debug.js"
    );
