describe("accelerometer", function () {
  ...
  describe("watchAcceleration", function () {
    ...
    describe("success", function () {
      ...
      it("should fire the timer immediately for a watch call if the accelerometer is running", function () {
        var someId = accelerometer.watchAcceleration(
          function () {},
          function () {},
          { frequency: 50 }
        );
        ...
        runs(function () {
          id = accelerometer.watchAcceleration(success, function () {}, {
            frequency: 75,
          });
        });
        waits(5);
  ...
  describe("clearWatch", function () {
    ...
    it("should call exec with stop after the last timer is cleared", function () {
      ...
      idone = accelerometer.watchAcceleration(
        function () {},
        function () {},
        { frequency: 50 }
      );
      exec.reset();
      idtwo = accelerometer.watchAcceleration(
        function () {},
        function () {},
        { frequency: 50 }
      );
