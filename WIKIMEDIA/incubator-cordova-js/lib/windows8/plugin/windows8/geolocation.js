...
module.exports = {
      ...
      function () {
        ...
        switch (geolocator.locationStatus) {
          ...
          case Windows.Devices.Geolocation.PositionStatus.disabled:
            ...
            e.message =
              "Your location is currently turned off. " +
          ...
          case Windows.Devices.Geolocation.PositionStatus.notInitialized:
            ...
            e.message =
              "Location status is not initialized because " +
          ...
          case Windows.Devices.Geolocation.PositionStatus.notAvailable:
            ...
            e.message =
              "You do not have the required location services " +
  ...
  addWatch: function (win, lose, args) {
    ...
    // options.timeout
    // timers[]
    timers[id] = new Windows.Devices.Geolocation.Geolocator()
      .getGeopositionAsync(options.maximumAge, options.timeout)
      .done(new Geolocation().getCurrentPosition(win, lose, options));
  },
