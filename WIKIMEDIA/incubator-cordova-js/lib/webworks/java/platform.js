module.exports = {
  ...
  initialize: function () {
      ...
      return {
        ...
        onUnsubscribe: function () {
          ...
          if (this.numHandlers === 0) {
            blackberry.system.event.onHardwareKey(buttonMapping[event], null);
          }
        },
      };
    };
    ...
    var onUnsubscribe = function () {
      if (
        channel.onResume.numHandlers === 0 &&
        channel.onPause.numHandlers === 0
      ) {
    ...
    channel.onResume = cordova.addDocumentEventHandler("resume", {
      onSubscribe: function () {
        ...
        if (
          channel.onResume.numHandlers === 1 &&
          channel.onPause.numHandlers === 0
        ) {
  ...
  objects: {
    ...
    File: {
      // exists natively on BlackBerry OS 7, override
