    ...
    nativeResolveLocalFileSystemURI(
      ...
      function (entry) {
        entry.file(
            ...
            function uploadFile(blobFile) {
              ...
              xhr.onload = function (evt) {
                if (xhr.status == 200) {
                  ...
                  errorCallback(
                    new FileTransferError(FileTransferError.INVALID_URL_ERR)
                  );
                } else {
                  errorCallback(
                    new FileTransferError(FileTransferError.CONNECTION_ERR)
                  );
                }
              };
          ...
          function (error) {
            errorCallback(
              new FileTransferError(FileTransferError.FILE_NOT_FOUND_ERR)
            );
          }
        );
      },
