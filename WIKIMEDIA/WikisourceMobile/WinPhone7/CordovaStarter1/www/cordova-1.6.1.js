...
*/
    ...
    var MonkeyPatch = {
      ...
      Contacts: {
        remove: function (
          arg // actually caught by our other case inside exec
        ) {
          return arg[0];
        },
        save: function (
 ...
 */
  ...
  define("cordova/plugin/FileTransfer", function (require, exports, module) {
    ...
    FileTransfer.prototype.upload = function (
      ...
      exec(successCallback, errorCallback, "FileTransfer", "upload", [
        filePath,
        server,
        fileKey,
        fileName,
        ...
        exec(
          function (timeout) {
            if (timeout < frequency + 10000) {
              exec(null, null, "Accelerometer", "setTimeout", [
                frequency + 10000,
              ]);
            }
          },
  ...
  define(
    "cordova/plugin/wp7/CordovaCommandResult",
    function (require, exports, module) {
      var cordova = require("cordova");
      var channel = require("cordova/channel");
      ...
      module.exports = function (status, callbackId, args, cast) {
        ...
        if (
          safeStatus === cordova.callbackStatus.NO_RESULT ||
  ...
  define(
    "cordova/plugin/wp7/CordovaMediaonStatus",
    function (require, exports, module) {
      var cordova = require("cordova");
    ...
    */
        removeItem: function (key) {
          ...
          if (index > -1) {
            ...
            window.external.Notify(
              "DOMStorage/" + this._type + "/remove/" + key
            );
            delete this[key];
          }
        },
        ...
        win.XMLHttpRequest.prototype = {
          ...
          getResponseHeader: function (header) {
            return this.wrappedXHR
              ? this.wrappedXHR.getResponseHeader(header)
              : "";
          },
  ...
  define(
    "cordova/plugin/wp7/requestFileSystem",
    function (require, exports, module) {
      var FileError = require("cordova/plugin/FileError"),
        FileSystem = require("cordova/plugin/FileSystem"),
        exec = require("cordova/exec");
  ...
  define(
    "cordova/plugin/wp7/resolveLocalFileSystemURI",
    function (require, exports, module) {
      var DirectoryEntry = require("cordova/plugin/DirectoryEntry"),
        FileEntry = require("cordova/plugin/FileEntry"),
        exec = require("cordova/exec");
