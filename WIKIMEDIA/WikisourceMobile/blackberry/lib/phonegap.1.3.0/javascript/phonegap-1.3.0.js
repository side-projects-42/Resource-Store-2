...
var PhoneGap =
  ...
  (function () {
     ...
     */
    PhoneGap.onPhoneGapConnectionReady = new PhoneGap.Channel(
    ...
    document.addEventListener = function (evt, handler, capture) {
      ...
      if (e == "deviceready") {
        ...
        PhoneGap.m_document_addEventListener.call(
          document,
          evt,
          handler,
          capture
    ...
    document.removeEventListener = function (evt, handler, capture) {
      ...
      PhoneGap.m_document_removeEventListener.call(
        document,
        evt,
        handler,
        capture
    ...
    PhoneGap.exec = function (success, fail, service, action, args) {
      try {
        var v = phonegap.PluginManager.exec(
          success,
          fail,
          service,
          action,
        ...
        if (v.status == PhoneGap.callbackStatus.OK) {
          ...
          if (success) {
            try {
              ...
              console.log(
                "Error in success callback: " + callbackId + " = " + e
              );
            }
          }
          return v.message;
...
(function () {
  "use strict";
  var retAsyncCall = {
      status: PhoneGap.callbackStatus.NO_RESULT,
      message: "WebWorks Is On It",
    },
    retInvalidAction = {
      status: PhoneGap.callbackStatus.INVALID_ACTION,
  ...
  phonegap.WebWorksPluginManager.prototype.exec = function (
    win,
    fail,
    clazz,
    action,
    ...
    return {
      status: PhoneGap.callbackStatus.CLASS_NOT_FOUND_EXCEPTION,
      message: "Class " + clazz + " cannot be found",
    };
  };
})();
...
window.phonegap.PluginManager = (function (webworksPluginManager) {
      ...
      execute: function (webWorksResult, action, args, win, fail) {
        switch (action) {
          case "log":
            ...
            return {
              status: PhoneGap.callbackStatus.OK,
  ...
  phonegap.BlackBerryPluginManager.prototype.exec = function (
    win,
    fail,
    clazz,
    action,
    ...
    if (
      result.status === PhoneGap.callbackStatus.CLASS_NOT_FOUND_EXCEPTION ||
  ...
  phonegap.BlackBerryPluginManager.prototype.subExec = function (
    win,
    fail,
    clazz,
    action,
    ...
    try {
      ...
      origResult =
        "" +
        com.phonegap.JavaPluginManager.exec(
          clazz,
          action,
          callbackId,
          JSON.stringify(args),
      ...
      if (origResult.length > 0) {
        ...
        execResult = { status: PhoneGap.callbackStatus.NO_RESULT, message: "" };
      }
    } catch (e) {
      console.log("BlackBerryPluginManager Error: " + e);
      execResult = {
        status: PhoneGap.callbackStatus.ERROR,
        message: e.message,
      };
    }
  ...
  phonegap.BlackBerryPluginManager.prototype.resume =
    com.phonegap.JavaPluginManager.resume;
  phonegap.BlackBerryPluginManager.prototype.pause =
    com.phonegap.JavaPluginManager.pause;
  phonegap.BlackBerryPluginManager.prototype.destroy =
    com.phonegap.JavaPluginManager.destroy;
...
(function () {
   ...
   */
  FileMgr.prototype.readAsText = function (
    fileName,
    encoding,
    successCallback,
    errorCallback
   ...
   * @param errorCallback     Callback invoked on error
   */
  FileMgr.prototype.readAsDataURL = function (
    fileName,
    successCallback,
    errorCallback
  ) {
   ...
   * @param errorCallback     Callback invoked on error
   */
  FileMgr.prototype.write = function (
    fileName,
    data,
    position,
    successCallback,
    ...
    PhoneGap.exec(successCallback, errorCallback, "File", "write", [
      fileName,
      data,
      position,
    ]);
   ...
   * @param errorCallback     Callback invoked on error
   */
  FileMgr.prototype.truncate = function (
    fileName,
    size,
    successCallback,
    errorCallback
...
var FileReader =
  ...
  (function () {
    ...
    FileReader.prototype.readAsDataURL = function (file) {
      ...
      this.fileName = file.fullPath;
      var me = this;
      navigator.fileMgr.readAsDataURL(
        file.fullPath,
...
var Entry =
  ...
  (function () {
    ...
    Entry.prototype.moveTo = function (
      ...
      // copy
      PhoneGap.exec(success, fail, "File", "moveTo", [
        srcPath,
        parent.fullPath,
        name,
      ]);
    ...
    Entry.prototype.copyTo = function (
      ...
      // copy
      PhoneGap.exec(success, fail, "File", "copyTo", [
        srcPath,
        parent.fullPath,
        name,
      ]);
     ...
     *            {Function} called with a FileError
     */
    Entry.prototype.toURI = function (
      mimeType,
      successCallback,
      errorCallback
    ) {
...
var DirectoryEntry =
  ...
  (function () {
    ...
    DirectoryReader.prototype.readEntries = function (
      ...
      PhoneGap.exec(createEntries, errorCallback, "File", "readEntries", [
        path,
      ]);
    };
...
var LocalFileSystem =
  ...
  (function () {
     ...
     */
    var _resolveLocalFileSystemURI = function (
      uri,
      successCallback,
      errorCallback
    ) {
...
(function () {
  ...
  Accelerometer.prototype.watchAcceleration = function (
    ...
    navigator.accelerometer.timers[id] = setInterval(
      function () {
        PhoneGap.exec(
          successCallback,
          errorCallback,
...
(function () {
  ...
  App.prototype.clearCache = function () {
    if (
      typeof blackberry.widgetcache === "undefined" ||
      blackberry.widgetcache === null
    ) {
      console.log(
        "blackberry.widgetcache permission not found. Cache clear denied."
      );
      return;
    }
  ...
  App.prototype._eventHandler = function (eventType, handler, add) {
    ...
    if (add) {
      ...
      if (me._resumeListener.length === 0 && me._pauseListener.length === 0) {
        PhoneGap.exec(
          function (on) {
            if (on === true) {
              resumeApp();
...
(function () {
  ...
  PhoneGap.addConstructor(function () {
    if (typeof navigator.battery === "undefined") {
      ...
      PhoneGap.addWindowEventHandler(
        "batterystatus",
        navigator.battery.eventHandler
      );
      PhoneGap.addWindowEventHandler(
        "batterylow",
        navigator.battery.eventHandler
...
(function () {
  ...
  // required permission.
  if (
    typeof blackberry.system.event === "undefined" ||
...
var Camera =
  ...
  (function () {
     ...
     */
    Camera.prototype.getPicture = function (
      successCallback,
      errorCallback,
      options
    ) {
  ...
  function Capture() {
    var self = this,
      ...
      addCaptureModes = function (type, modes) {
        self[type] = modes;
        if (
          typeof self.supportedAudioModes !== "undefined" &&
      ...
      if (contact.photos && contact.photos instanceof Array) {
        ...
        for (var i = 0; i < contact.photos.length; i += 1) {
          ...
          PhoneGap.exec(
            ...
            "Contact",
            "setPicture",
            [bbContact.uid, photo.type, photo.value]
          );
          break;
        }
      }
...
var FileTransfer =
  ...
  (function () {
    ...
    FileTransfer.prototype.download = function (
      ...
      PhoneGap.exec(castSuccess, errorCallback, "FileTransfer", "download", [
        source,
        target,
      ]);
    };
  ...
  (function () {
    ...
    Geolocation.prototype.success = function (id, result) {
      ...
      try {
        ...
        console.log(
          "Geolocation Error: Error calling success callback function."
        );
      }
    ...
    Geolocation.prototype.fail = function (id, result) {
      ...
      try {
        ...
        console.log(
          "Geolocation Error: Error calling error callback function."
        );
      }
    ...
    var usePhoneGap = function () {
      ...
      navigator.geolocation.getCurrentPosition =
        navigator._geo.getCurrentPosition;
...
(function () {
  ...
  Notification.prototype.confirm = function (
    ...
    return PhoneGap.exec(resultCallback, null, "Notification", "confirm", [
      message,
      _title,
      _buttonLabels,
    ]);
  ...
  Notification.prototype.progressStart = function (title, message) {
    PhoneGap.exec(null, null, "Notification", "progressStart", [
      title,
      message,
    ]);
  };
