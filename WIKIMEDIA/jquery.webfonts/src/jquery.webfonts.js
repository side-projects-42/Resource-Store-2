...
(function ($, window, document, undefined) {
  ...
  WebFonts.prototype = {
    ...
    parse: function () {
      ...
      $elements.each(function (i, element) {
        ...
        if (elementLanguage && elementLanguage !== webfonts.language) {
          ...
          if (
            webfonts.hasExplicitFontStyle($element) &&
    ...
    hasExplicitFontStyle: function ($element) {
      ...
      return (
        this.$element.css("fontFamily") !== elementFontFamily &&
    ...
    getCSS: function (fontFamily, variant) {
      ...
      if (fontconfig.woff2) {
        fontFormats.push(
          "\t\turl('" + base + fontconfig.woff2 + "') format('woff2')"
        );
      }
