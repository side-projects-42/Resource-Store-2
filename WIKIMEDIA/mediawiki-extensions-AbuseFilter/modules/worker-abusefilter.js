/* eslint-disable */
// NOTE: everything until line 1426 is boilerplate needed to bootstrap ace, and was copied from worker-json.js
  ...
  function (require, exports) {
    ...
    parseCode = function (code) {
      ...
      xhr.open(
        "GET",
        self.mwapipath +
          "?action=abusefilterchecksyntax&format=json&filter=" +
    ...
    (function () {
      this.onUpdate = function () {
        ...
        for (warning in results.warnings || {}) {
          position = this.doc.indexToPosition(
            results.warnings[warning].character
          );
          errors.push({
            row: position.row,
