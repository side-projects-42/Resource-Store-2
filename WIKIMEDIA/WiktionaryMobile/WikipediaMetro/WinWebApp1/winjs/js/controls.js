...
(function (WinJS, undefined) {
    ...
    DatePicker: WinJS.Class.derive(
      ...
      },
      {
        ...
        _createControls: function () {
          ...
          yearSource.getLength = function () {
            return Math.max(0, that.maxYear - that.minYear + 1);
          };
          yearSource.getValue = function (index) {
            return that.minYear + index;
          };
        ...
        current: {
          get: function () {
            ...
            var y = d.getFullYear();
            return new Date(
              Math.max(Math.min(this.maxYear, y), this.minYear),
              d.getMonth(),
              d.getDate(),
              0,
              0,
        ...
        _getWeekDayName: function (date) {
          var now = new Date();
          now.setFullYear(
            this._yearControl.value,
            this._monthControl.index,
            date
          );
        ...
        _updateDisplay: function () {
          ...
          if (this._yearControl) {
            if (this.current.getFullYear() < this.minYear) {
              ...
              this._yearControl.displayIndex =
                this._yearControl.dataSource.getLength() - 1;
            } else {
              this._yearControl.displayIndex =
                this.current.getFullYear() - this.minYear;
            }
          }
        ...
        _wireupEvents: function () {
          ...
          var monthHandler = function () {
            var days = daysInMonth(
              that._monthControl.index,
              that._yearControl.value
            );
  ...
  WinJS.Class.mix(
    WinJS.UI.DatePicker,
    WinJS.Utilities.createEventProperties("change")
  );
})(WinJS);
    ...
    TimePicker: WinJS.Class.derive(
      ...
      },
      {
        ...
        current: {
          get: function () {
            ...
            if (cur) {
              ...
              time.setMinutes(
                this._getMinutesIndex(cur) * this.minuteIncrement
              );
              time.setSeconds(0);
          ...
          set: function (value) {
            ...
            if (typeof value === "string") {
              newTime = new Date();
              newTime.setTime(
                Date.parse(newTime.toLocaleDateString() + " " + value)
              );
            } else {
              newTime = value;
            }
        ...
        minuteIncrement: {
          ...
          get: function () {
            return Math.max(1, Math.abs(this._minuteIncrement | 0) % 60);
          },
          set: function (value) {
        ...
        _setElement: function (element) {
          ...
          minutesSource.getLength = function () {
            return 60 / that.minuteIncrement;
          };
        ...
        _updateDisplay: function () {
          ...
          if (this._hourControl) {
            this._hourControl.displayIndex = this._getHoursIndex(
              hoursAmpm.hours
            );
          }

          if (this._minuteControl) {
            this._minuteControl.displayIndex = this._getMinutesIndex(
              this.current
            );
          }
        },
      ...
      },
      {
        ...
        dataSource: {
          ...
          set: function (value) {
            ...
            if (!value.getValue) {
              value.getValue = function (index) {
                return value[index];
              };
            }

            if (!value.getLength) {
              value.getLength = function () {
                return value.length;
              };
            }
            ...
            if (!value.max) {
              value.max = function () {
                return value.getValue(value.getLength() - 1);
              };
            }
        ...
        _createSelectElement: function () {
          ...
          for (var i = 0; i < dataSourceLength; i++) {
            ...
            if (this.titleProvider) {
              option.text =
                "" + this.titleProvider(this._dataSource.getValue(i));
            } else {
        ...
        index: {
          get: function () {
            if (this._dataSource) {
              return Math.max(
                0,
                Math.min(this._index, this._dataSource.getLength() - 1)
              );
            }
            return this._index;
          },
...
(function (global) {
  ...
  // Error messages
  var elementIsInvalid =
      "Invalid argument: Rating control expects a valid DOM element as the first argument.",
    maxRatingIsInvalid =
      "Invalid argument: maxRating must be an integer number greater than zero.",
    maxRatingCannotBeUpdated =
      "Invalid argument: maxRating cannot be set after instantiation.",
    userRatingIsInvalid =
      "Invalid argument: userRating must be an integer number greater or equal to zero and less than or equal to maxRating.",
    averageRatingIsInvalid =
      "Invalid argument: averageRating must be zero or a number greater than or equal to one and less than or equal to maxRating.",
    readOnlyIsInvalid = "Invalid argument: readOnly must be a boolean value.",
    enableClearIsInvalid =
      "Invalid argument: enableClear must be a boolean value.",
    tooltipStringsIsInvalid =
      "Invalid argument: tooltipStrings must be null or an array of strings.",
    invalidCreation =
      'Invalid constructor call: Please use the "new" operator to create a rating control.',
    ...
    Rating: WinJS.Class.define(
      ...
      },
      {
        ...
        _hideAverageRating: function () {
          ...
          style.msBoxFlex = 0;
          style.display = "none";
          style.width = this._resizeStringValue(
            this._averageRatingElement.currentStyle.width,
            0
          );
        },
        ...
        _updateAccessibilityProperties: function () {
          ...
          if (this._tentativeRating > 0) {
            ...
            element.setAttribute(
              "aria-valuetext",
              this._tooltipStrings[this._tentativeRating - 1]
            );
            ...
            element.setAttribute(
              "aria-valuetext",
              this._tooltipStrings[this._userRating - 1]
            );
        ...
        _decrementRating: function () {
          ...
          if (
            ...
            (this._tentativeRating === -1 && this._userRating === 0)
          ) {
        ...
        _events: function () {
          ...
          for (i = 0; i < eventsRegisteredInLowerCase.length; ++i) {
            this._element.addEventListener(
              eventsRegisteredInLowerCase[i].lowerCaseName,
              eventsRegisteredInLowerCase[i].handler,
              false
            );
          }
        ...
        _incrementRating: function () {
          ...
          if (
            ...
            (this._tentativeRating === -1 &&
              this._userRating === this._maxRating)
          ) {
            firePreviewChange = false;
          }
        ...
        _onDOMAttrModified: function (eventObject) {
          if (
            eventObject.attrName === "dir" ||
            eventObject.attrName === "style.direction"
          ) {
          ...
          if (eventObject.pointerType === PT_TOUCH) {
            ...
            if (starNum >= 0) {
              ...
              if (!this._readOnly) {
                ...
                this._setStarClasses(
                  msRatingTentativeFull,
                  starNum,
                  msRatingTentativeEmpty
                );
                // hide help star
        ...
        _onPointerMove: function (eventObject, tooltipType) {
          ...
          var starNum =
            (offsetPointer - this._offsetFirstStar) / this._starWidth;
          if (this._element.currentStyle.direction === "rtl") {
            starNum *= -1;
          }
          if (starNum < 0) {
          ...
          var newTentativeRating = Math.min(
            Math.ceil(starNum),
            this._maxRating
          );
        ...
        _onMSPointerOut: function (eventObject) {
          ...
          if (
            !this._captured &&
            this._getStarNumber(eventObject.toElement) < 0 &&
            this._element !== eventObject.toElement
          ) {
            this._showCurrentRating();
            // do not fire cancel event if we are changing rating on the same control
            if (
              (this._getStarNumber(eventObject.fromElement) < 0 ||
                this._getStarNumber(eventObject.toElement) < 0) &&
              !this._lastEventWasChange
            ) {
              this._raiseEvent(CANCEL, null);
            }
          }
        ...
        _setControlSize: function (options) {
          if (options !== undefined) {
            if ("maxRating" in options) {
              if (
                typeof options.maxRating === "number" &&
                options.maxRating > 0 &&
                Math.floor(options.maxRating) === options.maxRating
              ) {
        ...
        _setCurrentStarClasses: function (
          classNameBeforeThreshold,
          threshold,
          classNameAfterThreshold
        ) {
          for (var i = 0; i < this._maxRating; i++) {
            if (i <= threshold) {
        ...
        _updateTooltips: function (value) {
          ...
          if (value !== null) {
            max =
              value.length <= this._maxRating + 1
                ? value.length
                : this._maxRating + 1;
            for (i = 0; i < max; i++) {
        ...
        _updateFloatingStar: function () {
          ...
          if (this._element.currentStyle.direction == "rtl") {
            ...
            nextStyle.textIndent =
              "-" +
              this._resizeStringValue(this._elementWidth, this._floatingValue);
          } else {
            style.backgroundPosition = "left";
          ...
          style.display =
            this._averageRatingElement.nextSibling.currentStyle.display;
          nextStyle.msBoxFlex = 1 - this._floatingValue;
          nextStyle.width = this._resizeStringValue(
            this._elementWidth,
            1 - this._floatingValue
          );
        ...
        _openTooltip: function (tooltipType) {
          ...
          if (this._tentativeRating > 0) {
            this._toolTips[this._tentativeRating - 1].innerHTML =
              this._tooltipStrings[this._tentativeRating - 1];
            ...
            var distance =
              this._elements[0].offsetWidth +
              parseInt(this._elementPadding, 10);
            if (this._element.currentStyle.direction === "rtl") {
            ...
            this._toolTips[this._maxRating] = new WinJS.UI.Tooltip(
              this._clearElement
            );
            this._toolTips[this._maxRating].innerHTML =
              this._tooltipStrings[this._maxRating];
        ...
        _updateControl: function () {
          ...
          if (this._averageRating !== 0 && this._userRating === 0) {
            if (
              this._averageRating >= 1 &&
              this._averageRating <= this._maxRating
            ) {
              for (i = 0; i < this._maxRating; i++) {
                ...
                if (i < this._averageRating && i + 1 >= this._averageRating) {
                  ...
                  this._element.insertBefore(
                    this._elements[this._maxRating],
                    this._elements[i]
                  );
                  ...
                  if (this._element.currentStyle.direction == "rtl") {
                    this._elementPadding =
                      this._elements[i].currentStyle.paddingRight;
                    this._elementBorder =
                      this._elements[i].currentStyle.borderRight;
                  } else {
                    this._elementPadding =
                      this._elements[i].currentStyle.paddingLeft;
                    this._elementBorder =
                      this._elements[i].currentStyle.borderLeft;
                  }
...
(function (global) {
  // Error messages
  var elementIsInvalid =
      "Invalid argument: Toggle control expects a valid DOM element as the first argument.",
    invalidCreation =
      'Invalid constructor call: Please use the "new" operator to create a toggle switch.';
      ...
      },
      {
        ...
        _wireupEvents: function () {
          ...
          var spaceDownHandler = function (event) {
            if (event.keyCode === utilities.Key.space && !that._spaceKeyDown) {
              // Spacebar
              that._switchElement.valueAsNumber =
                (that._switchElement.valueAsNumber + 1) % 2;
              that._spaceKeyDown = true;
            }
          };
          var keyUpHandler = function (event) {
            if (
              event.keyCode === utilities.Key.space ||
              (event.keyCode >= utilities.Key.end &&
                event.keyCode <= utilities.Key.downArrow)
            ) {
              // Spacebar and arrow, home/end key
              that._valueHandler(false);
              if (event.keyCode === 32) {
          ...
          this._switchElement.addEventListener(
            "MSPointerUp",
            touchUpHandler,
            false
          );
          ...
          this._switchElement.attachEvent(
            "onpropertychange",
            reloadChangeHandler
          );
          this._switchElement.addEventListener(
...
(function (global) {
  ...
  var outgoingElementTransition =
    "-ms-transform " +
    outgoingScaleTransitionDuration +
    "s ease-in, opacity " +
    outgoingOpacityTransitionDuration +
    "s ease-in";
  var incomingElementTransition =
    "-ms-transform " +
    incomingScaleTransitionDuration +
    "s ease-in, opacity " +
    incomingOpacityTransitionDuration +
    "s ease-in";
  var bounceInTransition = "-ms-transform " + bounceInDuration + "s ease-in";
  var bounceBackTransition =
    "-ms-transform " + bounceBackDuration + "s ease-in";
  var correctionTransition =
    "-ms-transform " + correctionTransitionDuration + "s ease-in";
  ...
  WinJS.Namespace.define("WinJS.UI", {
    ...
    SemanticZoom: WinJS.Class.define(
      function (element, options) {
        /// <summary locid="70">
        ...
        this._elementIn.style.height = this._elementOut.style.height =
        ...
        this._pansHorizontallyOut =
          axisOut === "horizontal" || axisOut === "both";
        ...
        this._viewIn.configureForZoom(
          false,
          !this._zoomedOut,
          function () {
            zoomFromCurrent(true);
          },
          pagesToPrefetchIn
        );
        this._viewOut.configureForZoom(
          true,
          this._zoomedOut,
          function () {
            zoomFromCurrent(false);
          },
          pagesToPrefetchOut
        );
        ...
        this._element.addEventListener(
          "keydown",
          function (ev) {
            return that._onKeyDown(ev);
          },
          true
        );
        this._element.addEventListener(
          "MSPointerDown",
          this._onPointerDownBubbling.bind(this),
          false
        );
        this._element.addEventListener(
          "MSPointerDown",
          this._onPointerDownCapturing.bind(this),
          true
        );
        this._element.addEventListener(
          "MSPointerMove",
        ...
        this._element.addEventListener(
          ...
          this._onLostPointerCapture.bind(this),
          false
        );
        this._element.addEventListener(
          "MSManipulationStateChanged",
          this._onManipulationStateChanged.bind(this),
          true
        );
        this._viewportIn.addEventListener(
          "MSTransitionEnd",
          function (ev) {
            return that._onViewportTransitionEnd(ev);
          },
          false
        );
        this._canvasIn.addEventListener(
          "MSTransitionEnd",
          function (ev) {
            return that._onCanvasTransitionEnd(ev);
          },
          false
        );
      ...
      },
      {
          ...
          msSetImmediate(
            function () {
              ...
              var multiplierIn = 2 * scaleFactor - 1,
                canvasInWidth = Math.min(
                  canvasSizeMax,
                  (this._pansHorizontallyIn ? multiplierIn : 1) * viewportWidth
                ),
                canvasInHeight = Math.min(
                  canvasSizeMax,
                  (this._pansVerticallyIn ? multiplierIn : 1) * viewportHeight
                );
              ...
              var multiplierOut = 2 * bounceFactor - 1,
                canvasOutWidth =
                  (this._pansHorizontallyOut ? multiplierOut : 1) *
                  viewportWidth,
                canvasOutHeight =
                  (this._pansVerticallyOut ? multiplierOut : 1) *
                  viewportHeight;
        ...
        _onPointerMove: function (ev) {
          ...
          if (this._pointerCount === 1) {
            if (
              distance(
                pointerRecord.startX,
                pointerRecord.startY,
                pointerRecord.currentX,
                pointerRecord.currentY
              ) >= abandonEventsDistance &&
              this._pinchedDirection === PinchDirection.none
            ) {
              this._ignoreGestures = true;
              (this.zoomedOut ? this._viewOut : this._viewIn).handlePointer(
                ev.pointerId
              );
            }
          } else {
            if (this._pointerCount === 2) {
              ...
              if (this._firstPinchDistance === -1) {
                ...
                function processPinchGesture(zoomingOut) {
                  var pinchDirection = zoomingOut
                      ? PinchDirection.zoomedOut
                      : PinchDirection.zoomedIn,
                    gestureReversed = zoomingOut
                      ? that._pinchedDirection === PinchDirection.zoomedIn &&
                        !that._zoomingOut
                      : that._pinchedDirection === PinchDirection.zoomedOut &&
                        that._zoomingOut,
                    canZoomInGesturedDirection = zoomingOut
                      ? !that._zoomedOut
                      : that._zoomedOut;
        ...
        _onPointerUp: function (ev) {
          ...
          if (this._pointerRecords[ev.pointerId]) {
            ...
            if (this._pointersCount === 1) {
              ...
              var pointerRecord =
                this._pointerRecords[Object.keys(this._pointerRecords)[0]];
        ...
        _zoom: function (zoomOut, zoomCenter, gesture, centerOnCurrent) {
          ...
          if (this._zoomInProgress) {
            ...
            if (zoomCenter) {
              (zoomOut ? this._viewIn : this._viewOut).setCurrentItem(
                zoomCenter.x,
                zoomCenter.y
              );
            }
            ...
            (zoomOut ? this._viewportOut : this._viewportIn).style.visibility =
              "visible";
        ...
        _prepareForZoom: function (zoomOut, zoomCenter, completedCurrentItem) {
          ...
          if (
            ...
            !this._pansVerticallyIn ||
            !this._pansVerticallyOut
          ) {
            centerY = 0.5 * this._element.clientHeight;
          }

          function setZoomCenters(adjustmentIn, adjustmentOut) {
            that._canvasIn.style["-ms-transform-origin"] =
              that._canvasLeftIn +
              centerX -
              adjustmentIn.x +
              "px " +
              (that._canvasTopIn + centerY - adjustmentIn.y) +
              "px";
            that._canvasOut.style["-ms-transform-origin"] =
              that._canvasLeftOut +
              centerX -
              adjustmentOut.x +
              "px " +
              (that._canvasTopOut + centerY - adjustmentOut.y) +
              "px";
          }
          ...
          this._alignViews(
            ...
            if (adjustment.x !== 0 || adjustment.y !== 0) {
              ...
              translateElement(
                zoomOut ? that._viewportOut : that._viewportIn,
                adjustment
              );
        ...
        _alignViews: function (
          ...
          var that = this;
          if (zoomOut) {
            return (completedCurrentItem || this._viewIn.getCurrentItem()).then(
              function (current) {
                ...
                return that._viewOut.positionItem(
                  that._zoomedOutItem(current.item),
                  positionOut
                );
              }
            );
            ...
            return (
              completedCurrentItem || this._viewOut.getCurrentItem()
            ).then(function (current) {
              ...
              return that._viewIn.positionItem(
                that._zoomedInItem(current.item),
                positionIn
              );
            });
          }
        ...
        _startAnimations: function (zoomOut) {
          this._zoomingOut = zoomOut;
          this._canvasIn.style["-ms-transition"] = zoomOut
            ? outgoingElementTransition
            : incomingElementTransition;
          this._canvasOut.style["-ms-transition"] = zoomOut
            ? incomingElementTransition
            : outgoingElementTransition;
        ...
        _onCanvasTransitionEnd: function (ev) {
          if (
            ev.srcElement === this._canvasIn &&
            ev.propertyName === "-ms-transform"
          ) {
            this._zooming = false;
        ...
        _onViewportTransitionEnd: function (ev) {
          if (
            ev.srcElement === this._viewportIn &&
            ev.propertyName === "-ms-transform"
          ) {
            this._correcting = false;
            this._gestureEnding = false;
        ...
        _completeZoom: function () {
          ...
          if (this._adjustment) {
            ...
            translateElement(
              this._zoomingOut ? this._viewportIn : this._viewportOut,
              origin
            );
          }
        ...
        _playBounce: function (beginBounce, center) {
          ...
          var targetElement = this._zoomedOut
              ? this._canvasOut
              : this._canvasIn,
            canvasLeft = this._zoomedOut
              ? this._canvasLeftIn
              : this._canvasLeftOut,
            canvasTop = this._zoomedOut
              ? this._canvasTopIn
              : this._canvasTopOut;

          targetElement.style["-ms-transform-origin"] =
            canvasLeft +
            this._bounceCenter.x +
            "px " +
            (canvasTop + this._bounceCenter.y) +
            "px";
          targetElement.style["-ms-transition"] = beginBounce
            ? bounceInTransition
            : bounceBackTransition;
          var scale = beginBounce
            ? this._zoomedOut
              ? 2 - bounceFactor
              : bounceFactor
            : 1;
...
(function (WinJS) {
  ...
  function _onDocumentMouseDown(mouseEvent) {
    ...
    for (var bar = 0; bar < len; bar++) {
      ...
      if (
        overlay &&
        overlay.lightDismiss &&
        !overlay.hidden &&
        (mouseEvent.button !== 2 ||
          !WinJS.Utilities.hasClass(elements[bar], "win-appbar"))
      ) {
        var clicked;
    ...
    _Overlay: WinJS.Class.define(
      ...
      },
      {
          ...
          if (immediate) {
            ...
            while (showElements.length > 0 || hideElements.length > 0) {
              ...
              for (i = 0; i < showElements.length; i++) {
                ...
                if (
                  showElements[i] &&
                  showElements[i].style &&
                  showElements[i].parentNode === parentDiv
                ) {
              ...
              for (i = 0; i < hideElements.length; i++) {
                ...
                if (
                  hideElements[i] &&
                  hideElements[i].style &&
                  hideElements[i].parentNode === parentDiv
                ) {
                  // Same parent, use this one
              ...
              if (!immediate) {
                showAnim = WinJS.UI.Animation.createAddToListAnimation(
                  toShow,
                  toHide.length == 0 ? siblings : undefined
                );
                hideAnim = WinJS.UI.Animation.createDeleteFromListAnimation(
                  toHide,
                  siblings
                );
              }
              ...
              if (!immediate) {
                for (i = 0; i < toHide.length; i++) {
                  ...
                  toHide[i].style.top =
                    rect.top - parseInt(style.marginTop) + "px";
                  toHide[i].style.left =
                    rect.left - parseInt(style.marginLeft) + "px";
                  toHide[i].style.opacity = 0;
        ...
        _baseAnimateIn: function () {
          ...
          return WinJS.UI.Animation.showPopup(this._element, {
            top: "20px",
            left: "20px",
          });
        },
        ...
        _baseAnimateOut: function () {
          this._element.style.opacity = 0;
          return WinJS.UI.Animation.hidePopup(this._element, {
            top: "20px",
            left: "20px",
          });
        },
  ...
  thisWinUI._Overlay._hideFlyouts = function (testElement) {
    var elements = testElement.querySelectorAll(
      ".win-flyout,.win-settingspane"
    );
    var len = elements.length;
    for (var i = 0; i < len; i++) {
  ...
  thisWinUI._Overlay._createClickEater = function () {
    ...
    if (!thisWinUI._Overlay._clickEatingDiv) {
      ...
      clickEatingDiv.addEventListener(
        "mousedown",
        thisWinUI._Overlay._hideClickEater,
        true
      );
      clickEatingDiv.addEventListener(
        "click",
  ...
  thisWinUI._Overlay._addFlyoutEventHandlers = function (event) {
    if (!thisWinUI._Overlay._flyoutAppBarCommandEvent) {
      ...
      try {
        ...
        var mqlPortrait = msMatchMedia(
          "all and (-ms-view-state: device-portrait)"
        );
  ...
  thisWinUI._Overlay.duplicateConstruction =
    "Invalid argument: Controls may only be instantiated one time for each DOM element";
  thisWinUI._Overlay.badLightDismiss =
    "Invalid argument: The lightDismiss property requires a true or false boolean";
  thisWinUI._Overlay.badAutoHide =
    "Invalid argument: An autoHide property must be a non-negative number";
  thisWinUI._Overlay.requiresElements =
    "Invalid argument: elements must not be empty";
})(WinJS);
...
(function (WinJS) {
    ...
    AppBar: WinJS.Class.derive(
      ...
      },
      {
        ...
        _assignAnimations: function () {
          ...
          if (
            this._position === appBarPositionTop ||
            this._position === appBarPositionBottom
          ) {
            // Top or Bottom
  ...
  // Errors
  thisWinUI.AppBar.badPosition =
    "Invalid argument: The position property must be 'top', 'bottom', or 'other'";
  thisWinUI.AppBar.badTransient =
    "Invalid argument: An transient property requires a true or false boolean";
})(WinJS);
...
(function (WinJS) {
    ...
    Flyout: WinJS.Class.derive(
      ...
      function (element, options) {
        ...
        this._element.addEventListener(
          "focusout",
          function (e) {
            thisWinUI._Overlay._hideIfLostFocus(that, e);
          },
          false
        );
      },
      {
        ...
        show: function (anchor, placement) {
          ...
          if (anchor) {
            ...
            flyoutRect.width =
              originalRect.right +
              parseInt(flyoutStyle.marginRight) -
              (originalRect.left - parseInt(flyoutStyle.marginLeft));
            flyoutRect.height =
              originalRect.bottom +
              parseInt(flyoutStyle.marginBottom) -
              (originalRect.top - parseInt(flyoutStyle.marginTop));

            // See if it's vertical
            if (placement === "top") {
              if (
                this._fitTop(anchorRect, flyoutRect) ||
                this._fitBottom(anchorRect, flyoutRect)
              ) {
                this._centerHorizontally(anchorRect, flyoutRect);
              } else if (
                this._fitLeft(anchorRect, flyoutRect) ||
                this._fitRight(anchorRect, flyoutRect)
              ) {
        ...
        _fitTop: function (anchorRect, flyoutRect) {
          ...
          return (
            this._nextTop >= 0 &&
            this._nextTop + flyoutRect.height < window.innerHeight
          );
        },
        ...
        _fitLeft: function (anchorRect, flyoutRect) {
          ...
          return (
            this._nextLeft >= 0 &&
            this._nextLeft + flyoutRect.width < window.innerWidth
          );
        },
        ...
        _centerVertically: function (anchorRect, flyoutRect) {
          this._nextTop =
            anchorRect.top + anchorRect.height / 2 - flyoutRect.height / 2;
          if (this._nextTop < 0) {
            this._nextTop = 0;
        ...
        _centerHorizontally: function (anchorRect, flyoutRect) {
          this._nextLeft =
            anchorRect.left + anchorRect.width / 2 - flyoutRect.width / 2;
          if (this._nextLeft < 0) {
            this._nextLeft = 0;
        ...
        _appbarFlyoutAnimateIn: function () {
          this._element.style.opacity = 1;
          this._element.style.visibility = "visible";
          return WinJS.UI.Animation.showPopup(
            this._element,
            this._nextAnimOffset
          );
        },

        _appbarFlyoutAnimateOut: function () {
          this._element.style.opacity = 0;
          return WinJS.UI.Animation.hidePopup(
            this._element,
            this._nextAnimOffset
          );
        },
  ...
  // Errors
  thisWinUI.Flyout._noAnchor =
    "Invalid argument: Showing flyout requires a DOM element as its first parameter.";
  thisWinUI.Flyout._noPlacement =
    "Invalid argument: Showing flyout requires 'top', 'bottom', 'left', or 'right' as its second parameter.";
})(WinJS);
...
(function (WinJS) {
  ...
  WinJS.Namespace.define("WinJS.UI", {
    ...
    /// <resource type="javascript" src="/winjs/js/controls.js" shared="true" />
    /// <resource type="css" src="/winjs/css/ui-dark.css" shared="true" />
    SettingsPane: WinJS.Class.derive(
      WinJS.UI._Overlay,
      function (element, options) {
        ...
        if (label == null || label == "" || label === undefined) {
          this._element.setAttribute(
            "aria-label",
            thisWinUI.SettingsPane._ariaLabel
          );
        }
        ...
        try {
          ...
          if (this._commandId === "KnownSettingsCommand.About") {
            ...
            command = new n.SettingsCommand(
              n.KnownSettingsCommand.termsOfUse,
              _onSettingsCommand
            );
          } else if (
            this._commandId === "KnownSettingsCommand.ConnectedServices"
          ) {
            command = new n.SettingsCommand(
              n.KnownSettingsCommand.connectedServices,
              _onSettingsCommand
            );
          } else if (this._commandId === "KnownSettingsCommand.Privacy") {
            command = new n.SettingsCommand(
              n.KnownSettingsCommand.privacy,
              _onSettingsCommand
            );
          } else {
          ...
          n.SettingsPane.getForCurrentView().applicationCommands.append(
            command
          );
        } catch (e) {}
        ...
        hide: function () {
          if (this._baseHide()) {
            ...
            if (
              ...
              this._anchor.setActive !== undefined
            ) {
  ...
  thisWinUI.SettingsPane.show = function () {
    ...
    var elements = document.querySelectorAll(
      'div[data-win-control="WinJS.UI.SettingsPane"]'
    );
    var len = elements.length;
    for (var i = 0; i < len; i++) {
  ...
  // Errors
  thisWinUI.SettingsPane.badCommandId =
    "Invalid argument: The commandId property must be a string";
  thisWinUI.SettingsPane.badLabel =
    "Invalid argument: The label property must be a string";
})(WinJS);
...
(function (global) {
  ...
  // Error messages
  var elementIsInvalid =
      "Invalid argument: Tooltip control expects a valid DOM element as the first argument.",
    invalidCreation = "Invalid creation: Tooltip control.",
    optionIsInvalid =
      "Invalid option: Tooltip placement only takes four possible values: top, bottom, left, right",
  ...
  if (window.Windows) {
    ...
    isLeftHanded =
      handedness == Windows.UI.ViewManagement.HandPreference.leftHanded;
  }
  ...
  WinJS.Namespace.defineWithParent(WinJS, "UI", {
    ...
    /// <resource type="javascript" src="/winjs/js/controls.js" shared="true" />
    /// <resource type="css" src="/winjs/css/ui-dark.css" shared="true" />
    Tooltip: WinJS.Class.define(
      function (anchorElement, options) {
        /// <summary locid="151">
      ...
      },
      {
        ...
        addEventListener: function (eventName, eventCallBack, capture) {
          if (this._anchorElement) {
            this._anchorElement.addEventListener(
              eventName,
              eventCallBack,
              capture
            );
        ...
        removeEventListener: function (eventName, eventCallBack, capture) {
          if (this._anchorElement) {
            this._anchorElement.removeEventListener(
              eventName,
              eventCallBack,
              capture
            );
        ...
        _createTooltipDOM: function () {
          ...
          var dir = document.defaultView.getComputedStyle(
            this._anchorElement,
            null
          ).direction;
          ...
          if (this._lastContentType === "element") {
            // Last update through contentElement option
            this._domElement.appendChild(this._contentElement);
          } else {
            // Last update through innerHTML option
            this._domElement.innerHTML = this._innerHTML;
          }

          // Add handler for animation events
          this._registerEventToListener(
            this._domElement,
            "MSAnimationEnd",
            this
          );
          ...
          var zIndex =
            document.defaultView.getComputedStyle(this._domElement, null)
              .zIndex + 1;
            ...
            case msAnimationNameAppear:
              ...
              if (this._domElement) {
                if (this._hideDelay !== "never") {
                  var that = this;
                  var delay = this._infotip
                    ? Math.min(3 * messageDuration, HIDE_DELAY_MAX)
                    : messageDuration;
        ...
        _decideOnDelay: function (type) {
          ...
          if (type == "nodelay") {
            ...
            if (curTime - lastCloseTime <= RESHOW_THRESHOLD) {
              ...
              value = this._infotip
                ? DELAY_INITIAL_TOUCH_LONG
                : DELAY_INITIAL_TOUCH_SHORT;
            }
          }
          return value;
        },
        ...
        _positionOnSide: function (placement, viewport, anchor, tip) {
          ...
          switch (placement) {
            ...
            case "bottom":
              ...
              left = Math.min(
                Math.max(left, 0),
                viewport.width - tip.width - SAFETY_NET_GAP
              );

              top =
                placement == "top"
                  ? anchor.y - tip.height - this._offset
                  : anchor.y + anchor.height + this._offset;
              break;
            case "left":
            case "right":
              ...
              top = Math.min(
                Math.max(top, 0),
                viewport.height - tip.height - SAFETY_NET_GAP
              );

              left =
                placement == "left"
                  ? anchor.x - tip.width - this._offset
                  : anchor.x + anchor.width + this._offset;
              break;
          }
        ...
        _position: function () {
          ...
          for (var i = 0; i < length; i++) {
            if (
              i == length - 1 ||
              this._canPositionOnSide(order[i], viewport, anchor, tip)
            ) {
    ...
    ViewBox: WinJS.Class.define(
      ...
      },
      {
        ...
        _updateLayout: function () {
          ...
          this._sizer.style["-ms-transform"] =
            "translate(" +
            transX +
            "px," +
            transY +
