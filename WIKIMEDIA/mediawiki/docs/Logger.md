MediaWiki.Logger.LoggerFactory implements a [PSR-3](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-3-logger-interface.md) compatible message logging system.
