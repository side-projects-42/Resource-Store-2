...
(function () {
	...
	$.fn.confirmable.handler = function (event, options) {
		...
		if ($element.hasClass("jquery-confirmable-element")) {
			...
			$wrapper = $("<span>").addClass("jquery-confirmable-wrapper");
			...
			$buttonYes = $elementClone
				.clone(true)
				.addClass(
					"jquery-confirmable-button jquery-confirmable-button-yes"
				)
			...
			$buttonNo = $elementClone
				.clone(false)
				.addClass(
					"jquery-confirmable-button jquery-confirmable-button-no"
				)
				.data("jquery-confirmable-button", true)
