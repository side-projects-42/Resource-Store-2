...
(function () {
	var warningConfig = mw.config.get("wgFileWarning"),
		...
		$header = $("<h3>").addClass("mediawiki-filewarning-header empty"),
		$main = $("<p>").addClass("mediawiki-filewarning-main empty"),
		$info = $("<a>").addClass("mediawiki-filewarning-info empty"),
		$footer = $("<p>").addClass("mediawiki-filewarning-footer empty"),
	...
	if (
		warningConfig &&
		warningConfig.messages &&
		warningConfig.messages.main
	) {
