...
(function () {
	...
	function commafyNumber(value, pattern, options) {
		...
		if (padLength !== -1) {
			...
			if (patternDigits.indexOf("#") === -1) {
				valueParts[0] = valueParts[0].slice(
	...
	function commafyInternal(value, pattern, minimumGroupingDigits) {
		...
		minimumGroupingDigits =
			minimumGroupingDigits !== undefined ? minimumGroupingDigits : null;
		...
		return pattern.replace(
			numberPatternRE,
			commafyNumber(value, numberPattern[0], {
	...
	mw.log.deprecate(
		...
		"commafy",
		commafyInternal,
		"Use mw.language.convertNumber instead",
		"mw.language.commafy"
	);
})();
