...
(function () {
	...
	mw.widgets.MediaUserUploadsProvider =
		function MwWidgetsMediaUserUploadsProvider(apiurl, config) {
			config = config || {};
			...
			// Parent constructor
			mw.widgets.MediaUserUploadsProvider.super.call(
				this,
				apiurl,
				config
			);
	 ...
	 * @inheritdoc
	 */
	mw.widgets.MediaUserUploadsProvider.prototype.getContinueData = function (
		howMany
	) {
		return {
	 ...
	 * @inheritdoc
	 */
	mw.widgets.MediaUserUploadsProvider.prototype.setContinue = function (
		continueData
	) {
	...
	mw.widgets.MediaUserUploadsProvider.prototype.isValid = function () {
		return (
			this.getUserParams().gaiuser &&
			mw.widgets.MediaUserUploadsProvider.super.prototype.isValid.call(
				this
			)
		);
	};
