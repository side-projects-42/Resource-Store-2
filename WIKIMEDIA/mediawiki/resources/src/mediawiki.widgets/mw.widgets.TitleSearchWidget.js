...
(function () {
	 ...
	 */
	mw.widgets.TitleSearchWidget.prototype.onTitleSearchResultsChoose =
		function (item) {
	...
	mw.widgets.TitleSearchWidget.prototype.onQueryChange = function () {
		...
		this.getRequestData().done(function (data) {
			...
			// Parent method
			mw.widgets.TitleSearchWidget.parent.prototype.onQueryChange.call(
				widget
			);
