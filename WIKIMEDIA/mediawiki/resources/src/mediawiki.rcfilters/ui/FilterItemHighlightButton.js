 ...
 */
var FilterItemHighlightButton = function MwRcfiltersUiFilterItemHighlightButton(
	controller,
	model,
	highlightPopup,
	config
	...
	// Parent
	FilterItemHighlightButton.parent.call(
		this,
		$.extend(true, {}, config, {
			icon: "highlight",
			indicator: "down",
	...
	this.$element.addClass("mw-rcfilters-ui-filterItemHighlightButton");
};
