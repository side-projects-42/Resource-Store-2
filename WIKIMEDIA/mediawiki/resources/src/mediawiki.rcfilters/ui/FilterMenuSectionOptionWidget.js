 ...
 */
var FilterMenuSectionOptionWidget =
	function MwRcfiltersUiFilterMenuSectionOptionWidget(
		controller,
		model,
		config
	) {
		var whatsThisMessages,
			...
			$popupContent = $("<div>").addClass(
				"mw-rcfilters-ui-filterMenuSectionOptionWidget-whatsThisButton-popup-content"
			);
		...
		// Parent
		FilterMenuSectionOptionWidget.parent.call(
			this,
			$.extend(
				{
		...
		if (this.model.hasWhatsThis()) {
			...
			$header.append(this.whatsThisButton.$element);
		}
		...
		this.$element
			...
			.addClass(
				"mw-rcfilters-ui-filterMenuSectionOptionWidget-name-" +
					this.model.getName()
			)
			.append($header);
