(function () {
	...
	OO.inheritClass(WikitextMessagePoster, mw.messagePoster.MessagePoster);
	...
	WikitextMessagePoster.prototype.post = function (subject, body, options) {
		...
		options = options || {};
		mw.messagePoster.WikitextMessagePoster.parent.prototype.post.call(
			this,
			subject,
			body,
			options
		...
		return this.api
			.newSection(this.title, subject, body, additionalParams)
			.then(
				function (resp, jqXHR) {
