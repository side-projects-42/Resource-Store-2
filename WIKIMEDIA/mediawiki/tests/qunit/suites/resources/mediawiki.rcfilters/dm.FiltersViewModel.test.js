...
(function () {
	var filterDefinition = [
			{
				...
				filters: [
					...
					{
						name: "filter3",
						label: "group1filter3-label",
						description: "group1filter3-desc",
						default: true,
					},
				],
			},
			{
				...
				filters: [
					{
						name: "filter4",
						label: "group2filter4-label",
						description: "group2filter4-desc",
						cssClass: "filter4class",
					},
					{
						name: "filter5",
						label: "group2filter5-label",
						description: "group2filter5-desc",
						default: true,
						cssClass: "filter5class",
					},
					{
						name: "filter6",
						label: "group2filter6-label",
						description: "group2filter6-desc",
						cssClass: "filter6class",
			...
			},
			{
				...
				filters: [
					{
						name: "filter7",
						label: "group3filter7-label",
						description: "group3filter7-desc",
						cssClass: "filter7class",
					},
					{
						name: "filter8",
						label: "group3filter8-label",
						description: "group3filter8-desc",
						cssClass: "filter8class",
					},
					{
						name: "filter9",
						label: "group3filter9-label",
						description: "group3filter9-desc",
						cssClass: "filter9class",
					},
				],
			},
			{
				...
				filters: [
					...
					{
						name: "option1",
						label: "group4option1-label",
						description: "group4option1-desc",
					},
					{
						name: "option2",
						label: "group4option2-label",
						description: "group4option2-desc",
					},
					{
						name: "option3",
						label: "group4option3-label",
						description: "group4option3-desc",
					},
				],
			},
			{
				...
				filters: [
					{
						name: "option1",
						label: "group5option1-label",
						description: "group5option1-desc",
						cssClass: "group5opt1class",
					},
					{
						name: "option2",
						label: "group5option2-label",
						description: "group5option2-desc",
						cssClass: "group5opt2class",
					},
					{
						name: "option3",
						label: "group5option3-label",
						description: "group5option3-desc",
						cssClass: "group5opt3class",
					},
				],
			},
			{
				...
				filters: [
					{
						name: "group6option1",
						label: "group6option1-label",
						description: "group6option1-desc",
						cssClass: "group6opt1class",
					},
					{
						name: "group6option2",
						label: "group6option2-label",
						description: "group6option2-desc",
						default: true,
						cssClass: "group6opt2class",
					},
					{
						name: "group6option3",
						label: "group6option3-label",
						description: "group6option3-desc",
						default: true,
						cssClass: "group6opt3class",
					},
				],
			},
			{
				...
				filters: [
					{
						name: "group7option1",
						label: "group7option1-label",
						description: "group7option1-desc",
						cssClass: "group7opt1class",
					},
					{
						name: "group7option2",
						label: "group7option2-label",
						description: "group7option2-desc",
						cssClass: "group7opt2class",
					},
					{
						name: "group7option3",
						label: "group7option3-label",
						description: "group7option3-desc",
						cssClass: "group7opt3class",
					},
				],
			},
		],
		...
		baseFullFilterState = {
			...
			group6__group6option1: {
				selected: false,
				conflicted: false,
				included: false,
			},
			group6__group6option2: {
				selected: true,
				conflicted: false,
				included: false,
			},
			group6__group6option3: {
				selected: true,
				conflicted: false,
				included: false,
			},
			group7__group7option1: {
				selected: false,
				conflicted: false,
				included: false,
			},
			group7__group7option2: {
				selected: true,
				conflicted: false,
				included: false,
			},
			group7__group7option3: {
				selected: false,
				conflicted: false,
				included: false,
			},
	...
	QUnit.test("Setting up filters", function (assert) {
		...
		assert.ok(
			Object.keys(baseFilterRepresentation).every(function (filterName) {
				return (
					model.getItemByName(filterName) instanceof
	...
	QUnit.test("Parameter states", function (assert) {
		...
		parametersWithoutExcluded = $.extend(
			true,
			{},
			appliedDefaultParameters
		);
			...
			definition = [
				...
				},
				{
					...
					filters: [
						{
							name: "filter10",
							label: "Hide filter 10",
							description: "",
						},
						{
							name: "filter11",
							label: "Hide filter 11",
							description: "",
						},
						{
							name: "filter12",
							label: "Hide filter 12",
							description: "",
						},
					],
				},
	...
	QUnit.test("sanitizeStringOptionGroup", function (assert) {
		...
		assert.deepEqual(
			model.sanitizeStringOptionGroup("group1", [
				"filter1",
				"filter1",
				"filter2",
			]),
	...
	QUnit.test("Filter interaction: subsets", function (assert) {
		...
		model.reassessFilterInteractions(
			model.getItemByName("group1__filter1")
		);
		assert.deepEqual(
			model.getFullState(),
		...
		model.reassessFilterInteractions(
			model.getItemByName("group1__filter2")
		);
		assert.deepEqual(
			model.getFullState(),
			baseFullFilterState,
		...
		var model = new mw.rcfilters.dm.FiltersViewModel(),
			isCapsuleItemMuted = function (filterName) {
				...
				return (
					...
					groupModel.isFullCoverage() &&
					groupModel.areAllSelected()
				);
			},
	...
	QUnit.test("Filter interaction: conflicts", function (assert) {
		...
		model.reassessFilterInteractions(
			model.getItemByName("group2__filter4")
		);
		...
		model.reassessFilterInteractions(
			model.getItemByName("group2__filter6")
		);
		...
		model.reassessFilterInteractions(
			model.getItemByName("group2__filter5")
		);
		...
		model.reassessFilterInteractions(
			model.getItemByName("group1__filter3")
		);
