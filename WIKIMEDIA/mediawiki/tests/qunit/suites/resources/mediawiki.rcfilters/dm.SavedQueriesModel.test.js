...
(function () {
			...
			cases = [
				...
				},
				{
					...
					input: $.extend(true, queriesFilterRepresentation, {
						queries: {
							1234: {
								data: { highlights: { highlight: false } },
							},
						},
					}),
	...
	QUnit.test("Adding new queries", function (assert) {
		...
		cases.forEach(function (testCase) {
			var itemID = queriesModel.addNewQuery.apply(
					queriesModel,
	...
	QUnit.test("Manipulating queries", function (assert) {
		...
		// Add items
		id1 = queriesModel.addNewQuery("New query 1", {
			group2: "filter5",
			group1__filter1_color: "c5",
			group3__group3option1_color: "c1",
		});
		id2 = queriesModel.addNewQuery("New query 2", {
			filter1: "1",
			filter2: "1",
			invert: "1",
		});
							...
							filters: [
								{
									name: 0,
									label: "Main",
									cssClass: "namespace-0",
								},
								{
									name: 1,
									label: "Talk",
									cssClass: "namespace-1",
								},
								{
									name: 2,
									label: "User",
									cssClass: "namespace-2",
								},
								{
									name: 3,
									label: "User talk",
