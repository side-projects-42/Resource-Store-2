(function () {
	QUnit.module(
		...
		QUnit.newMwEnvironment({
			setup: function () {
				...
				this.actionApi = new mw.ForeignApi(
					"http://test.example.com/api.php"
				);
			},
		})
	);
	...
	QUnit.test("get()", function (assert) {
		var api = new mw.ForeignRest(
			"http://test.example.com/rest.php",
			this.actionApi
		);
		...
		this.server.respond(function (request) {
			...
			assert.strictEqual(
				request.url,
				"http://test.example.com/rest.php/test/rest/path"
			);
	...
	QUnit.test("post()", function (assert) {
		...
		this.server.respond(function (request) {
			...
			assert.strictEqual(
				request.url,
				"http://test.example.com/rest.php/test/bla/bla/bla",
