		...
		var $fixture,
			cases = [
				...
				},
				{
					...
					highlight: "« L",
					expected:
						'<span class="highlight">«</span> <span class="highlight">L</span>\'oiseau est sur <span class="highlight">l</span>’île »',
				},
				{
					...
					expected:
						'<span class="highlight">Праведники</span> <span class="highlight">мира</span>',
				},
				{
				...
				},
				{
					...
					expected:
						'<span class="highlight">მთავარი</span> <span class="highlight">გვერდი</span>',
				},
				{
				...
				},
				{
					...
					expected:
						'<span class="highlight">Նոնա</span> <span class="highlight">Գափրինդաշվիլի</span>',
				},
				{
					...
					highlight: "Նոն",
					expected:
						'<span class="highlight">Նոն</span>ա Գափրինդաշվիլի',
				},
				{
					...
					expected:
						'<span class="highlight">พอล</span> <span class="highlight">แอร์ดิช</span>',
				},
				{
				...
				},
				{
					...
					expected:
						'<span class="highlight">بول</span> <span class="highlight">إيردوس</span>',
				},
				{
