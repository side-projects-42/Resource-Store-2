...
describe("Move action", function () {
	...
	it("should move a page with a redirect and its subpages and talkpages", async () => {
		...
		const redirectInfo = await mindy.action("query", {
			titles: page2,
			redirects: true,
		});
