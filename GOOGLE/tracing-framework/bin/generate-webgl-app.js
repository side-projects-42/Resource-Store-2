...
function runTool(platform, args, done) {
  ...
  var outputBaseFile = path.join(
    argv._[1] || argv["output"] || path.dirname(inputFile),
...
function processDatabase(argv, outputBaseFile, db, done) {
  ...
  // Static info.
  output.push(
    'const char* __trace_name = "' + path.basename(outputBaseFile) + '";'
  );
  output.push(
    'const char* __bin_name = "' + path.basename(outputBaseFile) + '.bin";'
  );
...
function build(argv, tempDir, outputBaseFile, ccFiles, done) {
  ...
  function buildWithVisualStudio() {
    var templates = {
      vcxproj: fs.readFileSync(
        path.join(templatePath, "msbuild.vcxproj"),
        "utf8"
      ),
    };
    ...
    if (platform == "x86") {
      exeOutputPath =
        path.join(tempDir, config, path.basename(outputBaseFile)) + ".exe";
    } else if (platform == "x64") {
      exeOutputPath =
        path.join(tempDir, "x64", config, path.basename(outputBaseFile)) +
        ".exe";
    }
    ...
    copyFile(
      path.join(depsPath, "angleproject", "lib", platform, "libEGL.dll"),
      path.join(outputBasePath, "libEGL.dll")
    );
    copyFile(
      path.join(depsPath, "angleproject", "lib", platform, "libGLESv2.dll"),
      path.join(outputBasePath, "libGLESv2.dll")
    );
    copyFile(
      path.join(depsPath, "d3d", platform, "d3dcompiler_46.dll"),
      path.join(outputBasePath, "d3dcompiler_46.dll")
    );
    copyFile(
      path.join(depsPath, "SDL2-2.0.0", "lib", platform, "SDL2.dll"),
...
var CALLS = {
  ...
  "WebGLRenderingContext#bindBuffer": function (it, args, output, binFile) {
    output.push(
      "glBindBuffer(" +
        [args["target"], "context->GetObject(" + args["buffer"] + ")"].join(
          ", "
        ) +
        ");"
    );
  ...
  "WebGLRenderingContext#bindTexture": function (it, args, output, binFile) {
    output.push(
      "glBindTexture(" +
        [args["target"], "context->GetObject(" + args["texture"] + ")"].join(
          ", "
        ) +
        ");"
    );
  ...
  "WebGLRenderingContext#blendColor": function (it, args, output, binFile) {
    output.push(
      "glBlendColor(" +
        [args["red"], args["green"], args["blue"], args["alpha"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#blendEquationSeparate": function (
    ...
    output.push(
      "glBlendEquationSeparate(" +
        [args["modeRGB"], args["modeAlpha"]].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#blendFunc": function (it, args, output, binFile) {
    output.push(
      "glBlendFunc(" + [args["sfactor"], args["dfactor"]].join(", ") + ");"
    );
  },
  ...
  "WebGLRenderingContext#checkFramebufferStatus": function (
    ...
    output.push(
      "glCheckFramebufferStatus(" + [args["target"]].join(", ") + ");"
    );
  },
  ...
  "WebGLRenderingContext#compileShader": function (it, args, output, binFile) {
    output.push(
      "glCompileShader(" +
        ["context->GetObject(" + args["shader"] + ")"].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#depthRange": function (it, args, output, binFile) {
    output.push(
      "glDepthRange(" + [args["zNear"], args["zFar"]].join(", ") + ");"
    );
  },
  ...
  "WebGLRenderingContext#disableVertexAttribArray": function (
    ...
    output.push(
      "glDisableVertexAttribArray(" + [args["index"]].join(", ") + ");"
    );
  },
  "WebGLRenderingContext#drawArrays": function (it, args, output, binFile) {
    output.push(
      "glDrawArrays(" +
        [args["mode"], args["first"], args["count"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#getBufferParameter": function (
    ...
    output.push(
      "glGetBufferParameteriv(" +
        [args["target"], args["pname"], "&scratch_data"].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#isBuffer": function (it, args, output, binFile) {
    output.push(
      "glIsBuffer(" +
        ["context->GetObject(" + args["buffer"] + ")"].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#isFramebuffer": function (it, args, output, binFile) {
    output.push(
      "glIsFramebuffer(" +
        ["context->GetObject(" + args["framebuffer"] + ")"].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#isProgram": function (it, args, output, binFile) {
    output.push(
      "glIsProgram(" +
        ["context->GetObject(" + args["program"] + ")"].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#isRenderbuffer": function (it, args, output, binFile) {
    output.push(
      "glIsRenderbuffer(" +
        ["context->GetObject(" + args["renderbuffer"] + ")"].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#isTexture": function (it, args, output, binFile) {
    output.push(
      "glIsTexture(" +
        ["context->GetObject(" + args["texture"] + ")"].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#pixelStorei": function (it, args, output, binFile) {
    output.push(
      "glPixelStorei(" + [args["pname"], args["param"]].join(", ") + ");"
    );
  },
  "WebGLRenderingContext#polygonOffset": function (it, args, output, binFile) {
    output.push(
      "glPolygonOffset(" + [args["factor"], args["units"]].join(", ") + ");"
    );
  },
  ...
  "WebGLRenderingContext#renderbufferStorage": function (
    ...
    output.push(
      "glRenderbufferStorage(" +
        [args["target"], internalformat, args["width"], args["height"]].join(
          ", "
        ) +
        ");"
    );
  ...
  "WebGLRenderingContext#sampleCoverage": function (it, args, output, binFile) {
    output.push(
      "glSampleCoverage(" + [args["value"], args["invert"]].join(", ") + ");"
    );
  },
  "WebGLRenderingContext#scissor": function (it, args, output, binFile) {
    output.push(
      "glScissor(" +
        [args["x"], args["y"], args["width"], args["height"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#stencilFunc": function (it, args, output, binFile) {
    output.push(
      "glStencilFunc(" +
        [args["func"], args["ref"], args["mask"]].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#stencilFuncSeparate": function (
    ...
    output.push(
      "glStencilFuncSeparate(" +
        [args["face"], args["func"], args["ref"], args["mask"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#stencilMaskSeparate": function (
    ...
    output.push(
      "glStencilMaskSeparate(" + [args["face"], args["mask"]].join(", ") + ");"
    );
  },
  "WebGLRenderingContext#stencilOp": function (it, args, output, binFile) {
    output.push(
      "glStencilOp(" +
        [args["fail"], args["zfail"], args["zpass"]].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#stencilOpSeparate": function (
    ...
    output.push(
      "glStencilOpSeparate(" +
        [args["face"], args["fail"], args["zfail"], args["zpass"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#texParameterf": function (it, args, output, binFile) {
    output.push(
      "glTexParameterf(" +
        [args["target"], args["pname"], args["param"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#uniform1f": function (it, args, output, binFile) {
    output.push(
      "glUniform1f(" +
        ["context->GetObject(" + args["location"] + ")", args["x"]].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#vertexAttrib1fv": function (
    ...
    output.push(
      "glVertexAttrib1fv(" +
        [args["indx"], embedArray(v, binFile)].join(", ") +
        ");"
    );
  },
  ...
  "WebGLRenderingContext#vertexAttrib3f": function (it, args, output, binFile) {
    output.push(
      "glVertexAttrib3f(" +
        [args["indx"], args["x"], args["y"], args["z"]].join(", ") +
        ");"
    );
  },
  "WebGLRenderingContext#vertexAttrib4f": function (it, args, output, binFile) {
    output.push(
      "glVertexAttrib4f(" +
        [args["indx"], args["x"], args["y"], args["z"], args["w"]].join(", ") +
        ");"
    );
  },
  ...
  "ANGLEInstancedArrays#drawArraysInstancedANGLE": function (
    ...
    output.push(
      "glDrawArraysInstancedWGL(" +
        [args["mode"], args["first"], args["count"], args["primcount"]].join(
          ", "
        ) +
        ");"
    );
