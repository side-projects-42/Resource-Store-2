...
wtf.trace.providers.ChromeDebugProvider = function (traceManager, options) {
  ...
  if (
    !options.getNumber("wtf.trace.provider.chromeDebug", 1) ||
    ...
    return [
      {
        ...
        widgets: [
          ...
          },
          {
            ...
            title: "",
            value:
              "Launch Chrome with --remote-debugging-port=9222 to use " +
              "chrome:tracing.",
          },
        ],
      },
 ...
 * @private
 */
wtf.trace.providers.ChromeDebugProvider.prototype.sendMessage_ = function (
  data
) {
  if (!this.extensionChannel_) {
    return;
 ...
 * @private
 */
wtf.trace.providers.ChromeDebugProvider.prototype.extensionMessage_ = function (
  rawData
) {
...
wtf.trace.providers.ChromeDebugProvider.prototype.setupTimelineDispatch_ =
  function () {
    ...
    var timeStamp =
      goog.global.console.timeStamp["raw"]["raw"] ||
      goog.global.console.timeStamp["raw"] ||
      goog.global.console.timeStamp;
    timeStamp.call(goog.global.console, "WTFTimeSync:" + wtf.now());
    timebase.intervalId = goog.global.setInterval["raw"].call(
      goog.global,
      function () {
        timeStamp.call(goog.global.console, "WTFTimeSync:" + wtf.now());
      },
 ...
 * @private
 */
wtf.trace.providers.ChromeDebugProvider.prototype.createTracingProgressElement_ =
  function () {
...
wtf.trace.providers.ChromeDebugProvider.prototype.toggleCapture_ = function () {
  ...
  var consoleTime = goog.global.console.time["raw"] || goog.global.console.time;
  var consoleTimeEnd =
  ...
  if (!this.isCapturingTracing_) {
    ...
    this.sendMessage_({
      ...
      include_threads: ["CrBrowserMain", "CrGpuMain"],
    });
  }
};
