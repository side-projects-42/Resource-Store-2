 ...
 * @private
 */
wtf.trace.providers.ReplayProvider.DEFAULT_FLAGS_ = wtf.trace.providers
  .ReplayProvider.HIDE_EVENTS_
 ...
 * @override
 */
wtf.trace.providers.ReplayProvider.prototype.sessionStarted = function (
  session
) {
 ...
 * @override
 */
wtf.trace.providers.ReplayProvider.prototype.sessionStopped = function (
  session
) {
...
wtf.trace.providers.ReplayProvider.prototype.injectEvents_ = function () {
  ...
  var allObjectNames = ["Document", "Window"];
 ...
 * @private
 */
wtf.trace.providers.ReplayProvider.prototype.injectCaptureEvents_ = function (
  target,
  eventTypes
) {
  for (var eventName in eventTypes) {
    ...
    target.addEventListener(
      eventName,
      wtf.trace.util.ignoreListener(listener),
      true
    );
  }
};
 ...
 * @private
 */
wtf.trace.providers.ReplayProvider.prototype.buildListener_ = function (
  eventName,
  eventType
) {
