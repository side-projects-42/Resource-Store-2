...
wtf.trace.providers.setup = function (traceManager) {
  ...
  traceManager.addProvider(new wtf.trace.providers.ConsoleProvider(options));
  traceManager.addProvider(new wtf.trace.providers.TimingProvider(options));
  ...
  if (!wtf.NODE) {
    ...
    traceManager.addProvider(new wtf.trace.providers.DomProvider(options));
    traceManager.addProvider(new wtf.trace.providers.ImageProvider(options));
    if (!wtf.MIN_BUILD) {
      traceManager.addProvider(
    ...
    traceManager.addProvider(new wtf.trace.providers.XhrProvider(options));
  }
