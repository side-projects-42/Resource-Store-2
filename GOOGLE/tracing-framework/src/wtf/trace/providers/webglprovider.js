...
wtf.trace.providers.WebGLProvider = function (traceManager, options) {
  ...
  var recordAtStartup = options.getBoolean(
    "wtf.trace.provider.webgl.recordAtStartup",
    false
  );
...
wtf.trace.providers.WebGLProvider.prototype.injectContextType_ = function () {
  ...
  var replayable = this.options.getBoolean(
    "wtf.trace.provider.webgl.replayable",
    true
  );
  ...
  function wrapInstancedArraysExtension(ctx, proto) {
    ...
    function wrapInstancedArraysMethod(signature, opt_generator) {
      wrapMethod(proto, "ANGLEInstancedArrays", signature, opt_generator);
    }
  ...
  function wrapVertexArrayObjectExtension(ctx, proto) {
    ...
    function wrapVertexArrayObjectMethod(signature, opt_generator) {
      wrapMethod(proto, "OESVertexArrayObject", signature, opt_generator);
    }
  ...
  function wrapLoseContextExtension(ctx, proto) {
    ...
    function wrapLoseContextMethod(signature, opt_generator) {
      wrapMethod(proto, "WebGLLoseContext", signature, opt_generator);
    }

    // http://www.khronos.org/registry/webgl/extensions/WEBGL_lose_context/

    wrapLoseContextMethod("loseContext()", function (fn, eventType) {
    ...
    wrapLoseContextMethod("restoreContext()", function (fn, eventType) {
  ...
  wrapContextMethod("getContextAttributes()");
  wrapContextMethod("isContextLost()");
  wrapContextMethod("getSupportedExtensions()", function (fn, eventType) {
  ...
  wrapContextMethod("activeTexture(uint32 texture)");
  wrapContextMethod(
  ...
  wrapContextMethod("blendEquation(uint32 mode)");
  wrapContextMethod("blendEquationSeparate(uint32 modeRGB, uint32 modeAlpha)");
  wrapContextMethod("blendFunc(uint32 sfactor, uint32 dfactor)");
  wrapContextMethod(
  ...
  wrapContextMethod("checkFramebufferStatus(uint32 target)");
  wrapContextMethod("clear(uint32 mask)");
  wrapContextMethod(
    "clearColor(float red, float green, float blue, float alpha)"
  );
  wrapContextMethod("clearDepth(float depth)");
  wrapContextMethod("clearStencil(int32 s)");
  wrapContextMethod(
    "colorMask(uint8 red, uint8 green, uint8 blue, uint8 alpha)"
  );
  wrapContextMethod("compileShader(uint32 shader)", function (fn, eventType) {
  ...
  function wrapCreateMethod(name, typeName, opt_arg) {
    var signature =
      name + "(" + (opt_arg ? opt_arg + ", " : "") + "uint32 " + typeName + ")";
  ...
  wrapCreateMethod("createBuffer", "buffer");
  wrapCreateMethod("createFramebuffer", "framebuffer");
  wrapCreateMethod("createProgram", "program");
  wrapCreateMethod("createRenderbuffer", "renderbuffer");
  wrapCreateMethod("createShader", "shader", "uint32 type");
  wrapCreateMethod("createTexture", "texture");
  wrapContextMethod("cullFace(uint32 mode)");
  ...
  wrapDeleteMethod("deleteBuffer", "buffer");
  wrapDeleteMethod("deleteFramebuffer", "framebuffer");
  wrapDeleteMethod("deleteProgram", "program");
  wrapDeleteMethod("deleteRenderbuffer", "renderbuffer");
  wrapDeleteMethod("deleteShader", "shader");
  wrapDeleteMethod("deleteTexture", "texture");
  wrapContextMethod("depthFunc(uint32 func)");
  wrapContextMethod("depthMask(uint8 flag)");
  wrapContextMethod("depthRange(float zNear, float zFar)");
  wrapContextMethod(
  ...
  wrapContextMethod("disable(uint32 cap)");
  wrapContextMethod("disableVertexAttribArray(uint8 index)");
  wrapContextMethod("drawArrays(uint32 mode, uint32 first, int32 count)");
  wrapContextMethod(
    "drawElements(uint32 mode, int32 count, uint32 type, uint32 offset)"
  );
  wrapContextMethod("enable(uint32 cap)");
  wrapContextMethod("enableVertexAttribArray(uint8 index)");
  wrapContextMethod("finish()");
  wrapContextMethod("flush()");
  wrapContextMethod(
  ...
  wrapContextMethod("frontFace(uint32 mode)");
  wrapContextMethod("generateMipmap(uint32 target)");
  wrapContextMethod(
  ...
  wrapContextMethod("getBufferParameter(uint32 target, uint32 pname)");
  wrapContextMethod("getParameter(uint32 pname)");
  wrapContextMethod("getError()");
  wrapContextMethod(
  ...
  wrapContextMethod("getRenderbufferParameter(uint32 target, uint32 pname)");
  wrapContextMethod(
  ...
  wrapContextMethod("getShaderSource(uint32 shader)", function (fn, eventType) {
  ...
  wrapContextMethod("getTexParameter(uint32 target, uint32 pname)");
  wrapContextMethod(
  ...
  wrapContextMethod("getVertexAttrib(uint32 index, uint32 pname)");
  wrapContextMethod("getVertexAttribOffset(uint32 index, uint32 pname)");
  wrapContextMethod("hint(uint32 target, uint32 mode)");
  wrapContextMethod("isEnabled(uint32 cap)");
  ...
  wrapContextMethod("lineWidth(float width)");
  wrapContextMethod("linkProgram(uint32 program)", function (fn, eventType) {
  ...
  wrapContextMethod("pixelStorei(uint32 pname, int32 param)");
  wrapContextMethod("polygonOffset(float factor, float units)");
  wrapContextMethod(
  ...
  wrapContextMethod("sampleCoverage(float value, uint8 invert)");
  wrapContextMethod("scissor(int32 x, int32 y, int32 width, int32 height)");
  wrapContextMethod(
  ...
  wrapContextMethod("stencilFunc(uint32 func, int32 ref, uint32 mask)");
  wrapContextMethod(
    "stencilFuncSeparate(uint32 face, uint32 func, int32 ref, uint32 mask)"
  );
  wrapContextMethod("stencilMask(uint32 mask)");
  wrapContextMethod("stencilMaskSeparate(uint32 face, uint32 mask)");
  wrapContextMethod("stencilOp(uint32 fail, uint32 zfail, uint32 zpass)");
  wrapContextMethod(
  ...
  wrapContextMethod("texParameterf(uint32 target, uint32 pname, float param)");
  wrapContextMethod("texParameteri(uint32 target, uint32 pname, int32 param)");
  wrapContextMethod(
  ...
  wrapUniformMethod("uniform1f", "float", 1);
  wrapUniformMethod("uniform1i", "int32", 1);
  wrapUniformMethod("uniform2f", "float", 2);
  wrapUniformMethod("uniform2i", "int32", 2);
  wrapUniformMethod("uniform3f", "float", 3);
  wrapUniformMethod("uniform3i", "int32", 3);
  wrapUniformMethod("uniform4f", "float", 4);
  wrapUniformMethod("uniform4i", "int32", 4);
  wrapUniformArrayMethod("uniform1fv", "float", 1);
  wrapUniformArrayMethod("uniform1iv", "int32", 1);
  wrapUniformArrayMethod("uniform2fv", "float", 2);
  wrapUniformArrayMethod("uniform2iv", "int32", 2);
  wrapUniformArrayMethod("uniform3fv", "float", 3);
  wrapUniformArrayMethod("uniform3iv", "int32", 3);
  wrapUniformArrayMethod("uniform4fv", "float", 4);
  wrapUniformArrayMethod("uniform4iv", "int32", 4);
  wrapUniformMatrixMethod("uniformMatrix2fv", "float", 4);
  wrapUniformMatrixMethod("uniformMatrix3fv", "float", 9);
  wrapUniformMatrixMethod("uniformMatrix4fv", "float", 16);
  wrapContextMethod("useProgram(uint32 program)", function (fn, eventType) {
  ...
  wrapContextMethod("vertexAttrib1f(uint8 indx, float x)");
  wrapContextMethod(
  ...
  wrapContextMethod("vertexAttrib2f(uint8 indx, float x, float y)");
  wrapContextMethod(
  ...
  wrapContextMethod("vertexAttrib3f(uint8 indx, float x, float y, float z)");
  wrapContextMethod(
  ...
  wrapContextMethod(
    ...
    function (fn, eventType) {
      return function vertexAttrib4fv(indx, values) {
        setCurrentContext(this);
        var scope = eventType(indx, values[0], values[1], values[2], values[3]);
        return leaveScope(scope, fn.apply(this, arguments));
      };
    }
  );
  ...
  wrapContextMethod("viewport(int32 x, int32 y, int32 width, int32 height)");
};
