...
wtf.trace.providers.XhrProvider.prototype.injectXhr_ = function () {
  ...
  ProxyXMLHttpRequest.prototype["setRequestHeader"] = function (header, value) {
    var props = this.props_;
  ...
  var abortEvent = wtf.trace.events.createScope("XMLHttpRequest#abort()");
