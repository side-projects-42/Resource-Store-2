...
wtf.app.Toolbar = function (documentView, parentElement) {
  ...
  db.addListener(wtf.events.EventType.INVALIDATED, this.updateDisplay_, this);
  this.updateDisplay_();
};
...
wtf.app.Toolbar.prototype.updateDisplay_ = function () {
  ...
  var titleEl = this.getChildElement(goog.getCssName("infoTitle"));
  var urlEl = this.getChildElement(goog.getCssName("infoUrl"));
...
wtf.app.Toolbar.prototype.refreshIcon_ = function (uri) {
  var dom = this.getDom();
  var iconEl = this.getChildElement(goog.getCssName("infoIcon"));
