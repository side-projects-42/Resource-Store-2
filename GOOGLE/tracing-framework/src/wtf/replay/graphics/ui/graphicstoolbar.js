...
wtf.replay.graphics.ui.GraphicsToolbar = function (
   ...
   * @private
   */
  this.resetButton_ = this.getChildElement(goog.getCssName("resetButton"));
   ...
   * @private
   */
  this.backButton_ = this.getChildElement(goog.getCssName("backButton"));
   ...
   * @private
   */
  this.playButton_ = this.getChildElement(goog.getCssName("playButton"));
   ...
   * @private
   */
  this.forwardButton_ = this.getChildElement(goog.getCssName("forwardButton"));
   ...
   * @private
   */
  this.resetVisualizersButton_ = this.getChildElement(
    goog.getCssName("resetVisualizersButton")
  );
...
wtf.replay.graphics.ui.GraphicsToolbar.prototype.createDom = function (dom) {
  return /** @type {!Element} */ (
    goog.soy.renderAsFragment(
      wtf.replay.graphics.ui.graphicsToolbar.controller,
      {},
      undefined,
      dom
    )
 ...
 * @private
 */
wtf.replay.graphics.ui.GraphicsToolbar.prototype.setReady_ = function () {
 ...
 * @private
 */
wtf.replay.graphics.ui.GraphicsToolbar.prototype.setEnabled_ = function (
  enabled
) {
 ...
 * @private
 */
wtf.replay.graphics.ui.GraphicsToolbar.prototype.setPlayButtonState_ =
  function (playing) {
    goog.dom.classes.enable(
      this.playButton_,
      goog.getCssName("playing"),
      playing
    );
  };
