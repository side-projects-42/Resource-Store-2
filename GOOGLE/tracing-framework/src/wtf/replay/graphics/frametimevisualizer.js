...
wtf.replay.graphics.FrameTimeVisualizer = function (playback) {
  ...
  playback.addListener(
    wtf.replay.graphics.Playback.EventType.STEP_STARTED,
    this.recordStart_,
    this
  );
...
goog.inherits(
  wtf.replay.graphics.FrameTimeVisualizer,
 ...
 */
wtf.replay.graphics.FrameTimeVisualizer.prototype.getExperimentIndex =
  function (state) {
