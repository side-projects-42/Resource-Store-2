    ...
    for (var m = 0; m < paneConfig["sections"].length; m++) {
      ...
      for (var i = 0; i < sectionConfig["widgets"].length; i++) {
        ...
        switch (widgetConfig["type"]) {
          case "label":
            section.addLabel(widgetConfig["title"], widgetConfig["value"]);
            break;
          case "checkbox":
            section.addCheckbox(
              widgetConfig["key"],
...
wtf.ui.SettingsDialog.prototype.addPane = function (title) {
  ...
  var navUlEl = /** @type {Element} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.UL, null, navRootEl)[0]
  );
...
wtf.ui.SettingsDialog.Pane_ = function (options, dom, title) {
   ...
   * @private
   */
  this.navLinkEl_ = /** @type {!Element} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.A, null, this.navEl_)[0]
  );
...
wtf.ui.SettingsDialog.Section_.prototype.addLabel = function (title, value) {
  ...
  // Add to section DOM.
  var p = /** @type {!Element} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.P, null, this.el_)[0]
  );
...
wtf.ui.SettingsDialog.CheckboxWidget_ = function (
  ...
  var inputEl = /** @type {HTMLInputElement} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.INPUT, null, this.el_)[0]
  );
  goog.asserts.assert(inputEl);
  inputEl.checked = value;

  var titleEl = /** @type {Element} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.SPAN, null, this.el_)[0]
  );
...
goog.inherits(
  wtf.ui.SettingsDialog.CheckboxWidget_,
  wtf.ui.SettingsDialog.Widget_
);
...
wtf.ui.SettingsDialog.DropdownWidget_ = function (
  ...
  var selectEl = /** @type {HTMLSelectElement} */ (
    dom.getElementsByTagNameAndClass(goog.dom.TagName.SELECT, null, this.el_)[0]
  );
...
goog.inherits(
  wtf.ui.SettingsDialog.DropdownWidget_,
  wtf.ui.SettingsDialog.Widget_
);
