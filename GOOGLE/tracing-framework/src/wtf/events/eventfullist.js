...
wtf.events.SimpleEventfulList.prototype.set = function (index, value) {
  ...
  this.emitEvent(wtf.events.ListEventType.VALUES_SET, [
...
wtf.events.SimpleEventfulList.prototype.push = function (value) {
  ...
  this.emitEvent(wtf.events.ListEventType.VALUES_ADDED, [
...
wtf.events.SimpleEventfulList.prototype.insertAt = function (index, value) {
  ...
  this.emitEvent(wtf.events.ListEventType.VALUES_ADDED, [[index, value]]);
};
...
wtf.events.SimpleEventfulList.prototype.removeAt = function (index) {
  ...
  this.emitEvent(wtf.events.ListEventType.VALUES_REMOVED, [[index, value]]);
  goog.dispose(value);
};
...
wtf.events.SimpleEventfulList.prototype.clear = function () {
  ...
  this.emitEvent(wtf.events.ListEventType.VALUES_REMOVED, changes);
