...
(function (global, exports) {
  ...
  WTF.hasHighResolutionTimes = WTF.PRESENT
    ? global["wtf"]["hasHighResolutionTimes"]
    : false;
  ...
  WTF.trace.reset = WTF.PRESENT
    ? global["wtf"]["trace"]["reset"]
    : nullFunction;

  /**
   * Stops the current session and disposes it.
   */
  WTF.trace.stop = WTF.PRESENT ? global["wtf"]["trace"]["stop"] : nullFunction;
  ...
  WTF.trace.enterTracingScope = WTF.PRESENT
    ? global["wtf"]["trace"]["enterTracingScope"]
    : nullFunction;
  ...
  WTF.trace.appendScopeData = WTF.PRESENT
    ? global["wtf"]["trace"]["appendScopeData"]
    : nullFunction;
  ...
  WTF.trace.terminateFlow = WTF.PRESENT
    ? global["wtf"]["trace"]["terminateFlow"]
    : nullFunction;
  ...
  WTF.trace.appendFlowData = WTF.PRESENT
    ? global["wtf"]["trace"]["appendFlowData"]
    : nullFunction;
   ...
   */
  WTF.trace.mark = WTF.PRESENT ? global["wtf"]["trace"]["mark"] : nullFunction;
  ...
  WTF.trace.beginTimeRange = WTF.PRESENT
    ? global["wtf"]["trace"]["beginTimeRange"]
    : nullFunction;
  ...
  WTF.trace.ignoreListener = WTF.PRESENT
    ? global["wtf"]["trace"]["ignoreListener"]
    : nullFunction;
  ...
  WTF.trace.ignoreDomTree = WTF.PRESENT
    ? global["wtf"]["trace"]["ignoreDomTree"]
    : nullFunction;
  ...
  WTF.trace.instrumentType = WTF.PRESENT
    ? global["wtf"]["trace"]["instrumentType"]
    : identityFunction;
  ...
  WTF.trace.instrumentTypeSimple = WTF.PRESENT
    ? global["wtf"]["trace"]["instrumentTypeSimple"]
    : nullFunction;
