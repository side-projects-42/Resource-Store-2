  ...
  (function (window, document, navigator, jQuery, undefined) {
    !(function (factory) {
      ...
      ko.utils = new (function () {
        ...
        var keyEventTypeName = /Firefox\/2/i.test(navigator.userAgent)
          ? "KeyboardEvent"
          : "UIEvents";
        ...
        return {
          ...
          arrayForEach: function (array, action) {
            for (var i = 0, j = array.length; i < j; i++) action(array[i]);
          },
          ...
          toggleDomNodeCssClass: function (node, classNames, shouldHaveClass) {
            if (classNames) {
              var cssClassNameRegex = /[\w-]+/g,
                currentClassNames =
                  node.className.match(cssClassNameRegex) || [];
              ko.utils.arrayForEach(
                classNames.match(cssClassNameRegex),
                function (className) {
                  var indexOfClass = ko.utils.arrayIndexOf(
                    currentClassNames,
                    className
                  );
                  if (indexOfClass >= 0) {
      ...
      ko.dependentObservable = function (
        ...
        function evaluateImmediate() {
          ...
          try {
            ...
            var disposalCandidates = ko.utils.arrayMap(
              _subscriptionsToDependencies,
              function (item) {
                return item.target;
              }
            ...
            dependentObservable["notifySubscribers"](
              _latestValue,
              "beforeChange"
            );
      ...
      (function () {
        ...
        function visitPropertiesOrArrayEntries(rootObject, visitorCallback) {
          if (rootObject instanceof Array) {
            ...
            for (var propertyName in rootObject) visitorCallback(propertyName);
          }
        }
            ...
            switch (ko.utils.tagNameLower(element)) {
              ...
              case "select":
                for (var i = element.options.length - 1; i >= 0; i--) {
                  if (
                    ko.selectExtensions.readValue(element.options[i]) == value
                  ) {
      ...
      ko.expressionRewriting = (function () {
        ...
        function restoreTokens(string, tokens) {
          ...
          while (string != prevValue) {
            // Keep restoring tokens until it no longer makes a difference (they may be nested)
            prevValue = string;
        ...
        function getWriteableValue(expression) {
          if (
            ko.utils.arrayIndexOf(
              ...
              ko.utils.stringTrim(expression).toLowerCase()
            ) >= 0
          )
            return false;
        ...
        return {
          ...
          parseObjectLiteral: function (objectLiteralString) {
            ...
            if (str.charAt(0) === "{")
              // Ignore any braces surrounding the whole object literal
          ...
          preProcessBindings: function (objectLiteralStringOrKeyValueArray) {
            var keyValueArray =
              typeof objectLiteralStringOrKeyValueArray === "string"
      ...
      (function () {
        ...
        function createBindingsStringEvaluator(bindingsString) {
          ...
          var rewrittenBindings =
              ko.expressionRewriting.preProcessBindings(bindingsString),
            functionBody =
      ...
      (function () {
        ...
        ko.bindingContext = function (
          ...
          if (parentBindingContext) {
            ...
            this["$parents"] = (parentBindingContext["$parents"] || []).slice(
              0
            );
            ...
            function () {
              ...
              var evaluatedBindings =
                typeof bindings == "function"
                  ? bindings(bindingContextInstance, node)
                  : bindings;
              parsedBindings =
                evaluatedBindings ||
          ...
          update: function (
            ...
            var withIfData = ko.utils.domData.get(element, withIfDomDataKey),
              ...
              needsRefresh =
                isFirstRender ||
                isWith ||
                shouldDisplay !== withIfData.didDisplayOnLastUpdate;

            if (needsRefresh) {
              if (isFirstRender) {
                withIfData.savedNodes = ko.utils.cloneNodes(
              ...
              if (shouldDisplay) {
                if (!isFirstRender) {
                  ko.virtualElements.setDomNodeChildren(
                    element,
                    ko.utils.cloneNodes(withIfData.savedNodes)
                  );
                }
                ko.applyBindingsToDescendants(
                  makeContextCallback
        ...
        update: function (element, valueAccessor, allBindingsAccessor) {
          ...
          var previousSelectedValues = ko.utils.arrayMap(
            ko.utils.arrayFilter(element.childNodes, function (node) {
              return (
                node.tagName &&
                ko.utils.tagNameLower(node) === "option" &&
                node.selected
              );
            }),
            function (node) {
          ...
          if (value) {
            ...
            for (var i = 0, j = newOptions.length; i < j; i++) {
              if (
                ko.utils.arrayIndexOf(
                  ...
                  ko.selectExtensions.readValue(newOptions[i])
                ) >= 0
              ) {
            ...
            if (selectWasPreviouslyEmpty && "value" in allBindings) {
              ...
              ensureDropdownSelectionIsConsistentWithModelValue(
                element,
                ko.utils.peekObservable(allBindings["value"]),
                /* preferModelValue */ true
              );
            }
            ...
            return htmlString
              .replace(memoizeDataBindingAttributeSyntaxRegex, function () {
                return constructMemoizedTagReplacement(
                  /* dataBindAttributeValue: */ arguments[6],
      ...
      (function () {
        ...
        function invokeForEachNodeOrCommentInContinuousRange(
          firstNode,
          lastNode,
          action
        ) {
        ...
        function activateBindingsOnContinuousNodeArray(
          ...
          if (continuousNodeArray.length) {
            ...
            invokeForEachNodeOrCommentInContinuousRange(
              firstNode,
              lastNode,
              function (node) {
        ...
        function executeTemplate(
          ...
          var templateDocument =
            firstTargetNode && firstTargetNode.ownerDocument;
        ...
        ko.bindingHandlers["template"] = {
          init: function (element, valueAccessor) {
            ...
            if (
              ...
              !bindingValue["name"] &&
              (element.nodeType == 1 || element.nodeType == 8)
            ) {
      ...
      ko.utils.compareArrays = (function () {
        ...
        function compareSmallArrayToBigArray(
          ...
          if (notInSml.length && notInBig.length) {
            ...
            for (
              failedCompares = a = 0;
              (dontLimitMoves || failedCompares < limitFailedCompares) &&
              (notInSmlItem = notInSml[a]);
              a++
            ) {
      ...
      (function () {
        ...
        function fixUpNodesToBeMovedOrRemoved(contiguousNodeArray) {
          ...
          // Rule [A]
          while (
            contiguousNodeArray.length &&
            !ko.utils.domNodeIsAttachedToDocument(contiguousNodeArray[0])
          )
          ...
          var dependentObservable = ko.dependentObservable(
            function () {
              ...
              if (mappedNodes.length > 0) {
                ko.utils.replaceDomNodes(
                  fixUpNodesToBeMovedOrRemoved(mappedNodes),
                  newMappedNodes
                );
        ...
        var lastMappingResultDomDataKey =
