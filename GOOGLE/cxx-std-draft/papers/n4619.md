...
- US 94, GB 13, FI 21: Class template deduction in explicit type conversion using a _braced-init-list_
...
- GB 64: Add limit for length of _initializer-list_
...
- [2679](http://wg21.link/lwg2679) Inconsistent use of "_Effects:_ Equivalent to"
...
- [2752](http://wg21.link/lwg2752) _Throws:_ clauses of `async` and `packaged_task` are unimplementable
...
- [2771](http://wg21.link/lwg2771) Broken _Effects:_ of some `basic_string::compare` functions in terms of `basic_string_view`
...
- Each algorithm _with_ a parallel form is now explicitly called out.
- Duplicate of US 91.
