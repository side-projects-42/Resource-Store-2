...
Fixed missing application of a portion of [P1032R1](http://wg21.link/p1032r1), originally applied by 2018-11 LWG Motion 11.

P1032R1 section 10 instructs that a set of changes be systematically applied to all `char_traits` specializations. As part of the same set of motions, [P0482R6](http://wg21.link/p0482r6) (2018-11 CWG Motion 11) added two new `char_traits` specializations. The intent was for P1032R1 to also apply to the new specializations, assuming both motions passed (which they did).
