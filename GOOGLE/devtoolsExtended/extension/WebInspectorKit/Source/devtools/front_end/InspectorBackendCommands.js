...
InspectorBackend.registerInspectorDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Inspector");
InspectorBackend.registerEvent("Inspector.evaluateForTestInFrontend", [
  "testCallId",
  "script",
]);
...
// Memory.
InspectorBackend.registerMemoryDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Memory");
...
InspectorBackend.registerPageDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Page");
...
InspectorBackend.registerCommand(
  ...
  [
    ...
    { name: "scriptPreprocessor", type: "string", optional: true },
  ],
  [],
  false
);
...
InspectorBackend.registerCommand(
  ...
  [
    ...
    { name: "fontScaleFactor", type: "number", optional: false },
    { name: "fitWindow", type: "boolean", optional: false },
  ],
  [],
  false
);
...
InspectorBackend.registerCommand(
  ...
  [{ name: "media", type: "string", optional: false }],
  [],
  false
);
InspectorBackend.registerCommand(
  ...
  ["data", "deviceScaleFactor", "pageScaleFactor", "viewport"],
  false
);
InspectorBackend.registerCommand(
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "show", type: "boolean", optional: false },
    { name: "showGrid", type: "boolean", optional: true },
  ],
  [],
  false
);
InspectorBackend.registerCommand(
  ...
  [{ name: "force", type: "boolean", optional: false }],
  [],
  false
);
...
InspectorBackend.registerRuntimeDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Runtime");
...
InspectorBackend.registerConsoleDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Console");
...
InspectorBackend.registerEvent("Console.messageRepeatCountUpdated", [
  "count",
  "timestamp",
]);
...
InspectorBackend.registerCommand(
  ...
  [{ name: "heapObjectId", type: "number", optional: false }],
  [],
  false
);
...
InspectorBackend.registerNetworkDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Network");
...
InspectorBackend.registerCommand(
  ...
  ["statusCode", "responseHeaders", "content"],
  false
);

// Database.
InspectorBackend.registerDatabaseDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Database");
...
// IndexedDB.
InspectorBackend.registerIndexedDBDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "IndexedDB");
...
InspectorBackend.registerDOMStorageDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(
    InspectorBackend,
    "DOMStorage"
  );
...
InspectorBackend.registerEvent("ApplicationCache.networkStateUpdated", [
  "isNowOnline",
]);
InspectorBackend.registerCommand(
...
// FileSystem.
InspectorBackend.registerFileSystemDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(
    InspectorBackend,
    "FileSystem"
  );
...
// DOM.
InspectorBackend.registerDOMDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "DOM");
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "enabled", type: "boolean", optional: false },
    { name: "inspectShadowDOM", type: "boolean", optional: true },
...
InspectorBackend.registerCommand(
  ...
  [{ name: "backendNodeId", type: "number", optional: false }],
  ["nodeId"],
  false
);
InspectorBackend.registerCommand(
  "DOM.releaseBackendNodeIds",
  [{ name: "nodeGroup", type: "string", optional: false }],
  [],
  false
);
InspectorBackend.registerCommand(
...
InspectorBackend.registerCSSDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "CSS");
...
InspectorBackend.registerEnum("CSS.CSSPropertyStatus", {
  Active: "active",
  Inactive: "inactive",
  Disabled: "disabled",
  Style: "style",
...
InspectorBackend.registerEnum("CSS.RegionRegionOverset", {
  Overset: "overset",
  Fit: "fit",
  Empty: "empty",
});
...
InspectorBackend.registerEvent("CSS.namedFlowRemoved", [
  "documentNodeId",
  "flowName",
]);
...
InspectorBackend.registerCommand(
  "CSS.setStyleText",
  [
    { name: "styleId", type: "object", optional: false },
    { name: "text", type: "string", optional: false },
  ],
  ["style"],
  false
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "styleId", type: "object", optional: false },
    { name: "propertyIndex", type: "number", optional: false },
    { name: "text", type: "string", optional: false },
    { name: "overwrite", type: "boolean", optional: false },
  ],
  ["style"],
  false
);
...
InspectorBackend.registerCommand(
  "CSS.setRuleSelector",
  [
    { name: "ruleId", type: "object", optional: false },
    { name: "selector", type: "string", optional: false },
  ],
  ["rule"],
  false
...
InspectorBackend.registerCommand(
  "CSS.addRule",
  [
    { name: "contextNodeId", type: "number", optional: false },
    { name: "selector", type: "string", optional: false },
  ],
  ["rule"],
  false
...
InspectorBackend.registerCommand(
  ...
  [{ name: "documentNodeId", type: "number", optional: false }],
  ["namedFlows"],
  false
);

// Timeline.
InspectorBackend.registerTimelineDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Timeline");
...
InspectorBackend.registerCommand(
  "Timeline.start",
  [
    { name: "maxCallStackDepth", type: "number", optional: true },
...
InspectorBackend.registerDebuggerDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Debugger");
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "skipped", type: "boolean", optional: false },
    { name: "untilReload", type: "boolean", optional: true },
  ],
  [],
  false
);
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "location", type: "object", optional: false },
    { name: "interstatementLocation", type: "boolean", optional: true },
  ],
  [],
  false
);
InspectorBackend.registerCommand(
  "Debugger.stepOver",
  [{ name: "callFrameId", type: "string", optional: true }],
  [],
  false
);
...
InspectorBackend.registerCommand(
  ...
  [{ name: "functionId", type: "string", optional: false }],
  ["details"],
  false
);
InspectorBackend.registerCommand(
...
InspectorBackend.registerCommand(
  ...
  [
    ...
    { name: "callFrameId", type: "string", optional: true },
    { name: "functionObjectId", type: "string", optional: true },
  ],
  [],
  false
);
...
// DOMDebugger.
InspectorBackend.registerDOMDebuggerDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(
    InspectorBackend,
    "DOMDebugger"
  );
...
InspectorBackend.registerProfilerDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Profiler");
...
// HeapProfiler.
InspectorBackend.registerHeapProfilerDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(
    InspectorBackend,
    "HeapProfiler"
  );
...
InspectorBackend.registerWorkerDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Worker");
InspectorBackend.registerEvent("Worker.workerCreated", [
  "workerId",
  "url",
  "inspectorConnected",
]);
InspectorBackend.registerEvent("Worker.workerTerminated", ["workerId"]);
InspectorBackend.registerEvent("Worker.dispatchMessageFromWorker", [
  "workerId",
  "message",
]);
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "workerId", type: "number", optional: false },
    { name: "message", type: "object", optional: false },
  ],
  [],
  false
);
...
InspectorBackend.registerCanvasDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Canvas");
...
InspectorBackend.registerEvent("Canvas.traceLogsRemoved", [
  "frameId",
  "traceLogId",
]);
...
InspectorBackend.registerCommand(
  "Canvas.dropTraceLog",
  [{ name: "traceLogId", type: "string", optional: false }],
  [],
  false
);
InspectorBackend.registerCommand(
...
InspectorBackend.registerCommand(
  ...
  [
    { name: "traceLogId", type: "string", optional: false },
    { name: "stepNo", type: "number", optional: false },
  ],
  ["resourceState", "replayTime"],
  false
);
InspectorBackend.registerCommand(
  ...
  [
    { name: "traceLogId", type: "string", optional: false },
    { name: "resourceId", type: "string", optional: false },
  ],
  ["resourceState"],
  false
);
InspectorBackend.registerCommand(
  ...
  [
    { name: "traceLogId", type: "string", optional: false },
    { name: "callIndex", type: "number", optional: false },
    { name: "argumentIndex", type: "number", optional: false },
    { name: "objectGroup", type: "string", optional: true },
  ],
...
// Input.
InspectorBackend.registerInputDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Input");
...
InspectorBackend.registerCommand(
  ...
  [
    ...
    { name: "pinchScale", type: "number", optional: true },
  ],
  [],
  false
);
...
InspectorBackend.registerLayerTreeDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "LayerTree");
...
InspectorBackend.registerTracingDispatcher =
  InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "Tracing");
InspectorBackend.registerEvent("Tracing.dataCollected", ["value"]);
InspectorBackend.registerEvent("Tracing.tracingComplete", []);
InspectorBackend.registerCommand(
  "Tracing.start",
  [{ name: "categories", type: "string", optional: false }],
  [],
  false
);
