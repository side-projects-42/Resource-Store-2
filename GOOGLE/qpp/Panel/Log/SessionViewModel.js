...
(function () {
  ...
  QuerypointPanel.SessionViewModel = {
    initialize: function (project, tracequeries) {
      ...
      this.turnScrubberViewModel =
        QuerypointPanel.TurnScrubberViewModel.initialize(
          project,
          tracequeries,
          this
        );
    ...
    pageWasReloaded: function (runtimeInitialized, runtimeInstalling) {
      this.loadListViewModel.pageWasReloaded(
        runtimeInitialized,
        runtimeInstalling
      );
      this.turnScrubberViewModel.pageWasReloaded(
        runtimeInitialized,
        runtimeInstalling
      );
