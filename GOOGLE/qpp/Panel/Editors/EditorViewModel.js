...
(function () {
  ...
  QuerypointPanel.EditorViewModel.prototype = {
    ...
    saveFile: function () {
      ...
      _saveFileThruDevtoolsSave(
        url,
        content,
        this.status.bind(this, "saved"),
        onError
      );
      return false;
    },
    ...
    _saveFileThruDAV: function (url, content, on) {
      ...
      xhr.addEventListener("load", function (e) {
        if (xhr.status == 200 || xhr.status == 0) on.success(xhr.responseText);
      });
