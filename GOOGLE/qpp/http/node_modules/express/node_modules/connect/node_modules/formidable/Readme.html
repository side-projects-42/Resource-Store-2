...
<p>This module was developed for <a href="http://transloadit.com/">Transloadit</a>, a service focused on uploading and encoding images and videos. It has been battle-tested against hundreds of GB of file uploads from a large variety of clients and is considered production-ready.</p>
...
<ul>
<li>Do not default to the default to the field name for file uploads where filename="".</li>
</ul>
...
<p><strong>Note:</strong> Starting with this version, formidable emits ‘file’ events for empty file input fields. Previously those were incorrectly emitted as regular file input fields with value = "".</p>
...
<p>This marks the beginning of development on version 2.0 which will include several architectural improvements.</p>
...
<p><strong>Important:</strong> The old property names of the File class will be removed in a future release.</p>
...
vim my.js
# var formidable = require(&#39;./formidable&#39;);</code></pre>
...
<p><strong>new formidable.IncomingForm()</strong></p>
<p>Creates a new incoming form.</p>
<p><strong>incomingForm.encoding = ‘utf-8’</strong></p>
<p>The encoding to use for incoming form fields.</p>
<p><strong>incomingForm.uploadDir = process.env.TMP || ‘/tmp’ || process.cwd()</strong></p>
<p>The directory for placing file uploads in. You can move them later on using <code>fs.rename()</code>. The default directory is picked at module load time depending on the first existing directory from those listed above.</p>
<p><strong>incomingForm.keepExtensions = false</strong></p>
<p>If you want the files written to <code>incomingForm.uploadDir</code> to include the extensions of the original files, set this property to <code>true</code>.</p>
<p><strong>incomingForm.type</strong></p>
<p>Either ‘multipart’ or ‘urlencoded’ depending on the incoming request.</p>
<p><strong>incomingForm.maxFieldsSize = 2 * 1024 * 1024</strong></p>
<p>Limits the amount of memory a field (not file) can allocate in bytes. If this value is exceeded, an <code>'error'</code> event is emitted. The default size is 2MB.</p>
<p><strong>incomingForm.hash = false</strong></p>
<p>If you want checksums calculated for incoming files, set this to either <code>'sha1'</code> or <code>'md5'</code>.</p>
<p><strong>incomingForm.bytesReceived</strong></p>
<p>The amount of bytes received for this form so far.</p>
<p><strong>incomingForm.bytesExpected</strong></p>
<p>The expected number of bytes in this form.</p>
<p><strong>incomingForm.parse(request, [cb])</strong></p>
...
<pre><code>incomingForm.parse(req, function(err, fields, files) {
  // ...
});</code></pre>
<p><strong>incomingForm.onPart(part)</strong></p>
...
<pre><code>incomingForm.onPart = function(part) {
...
<p><strong>Event: ‘progress’ (bytesReceived, bytesExpected)</strong></p>
<p>Emitted after each incoming chunk of data that has been parsed. Can be used to roll your own progress bar.</p>
<p><strong>Event: ‘field’ (name, value)</strong></p>
<p>Emitted whenever a field / value pair has been received.</p>
<p><strong>Event: ‘fileBegin’ (name, file)</strong></p>
<p>Emitted whenever a new file is detected in the upload stream. Use this even if you want to stream the file to somewhere else while buffering the upload on the file system.</p>
<p><strong>Event: ‘file’ (name, file)</strong></p>
<p>Emitted whenever a field / file pair has been received. <code>file</code> is an instance of <code>File</code>.</p>
<p><strong>Event: ‘error’ (err)</strong></p>
...
<p><strong>Event: ‘aborted’</strong></p>
...
<p><strong>file.path = null</strong></p>
<p>The path this file is being written to. You can modify this in the <code>'fileBegin'</code> event in case you are unhappy with the way formidable generates a temporary path for your files.</p>
<p><strong>file.name = null</strong></p>
<p>The name this file had according to the uploading client.</p>
<p><strong>file.type = null</strong></p>
<p>The mime type of this file, according to the uploading client.</p>
<p><strong>file.lastModifiedDate = null</strong></p>
<p>A date object (or <code>null</code>) containing the time this file was last written to. Mostly here for compatibility with the <a href="http://dev.w3.org/2006/webapi/FileAPI/">W3C File API Draft</a>.</p>
<p><strong>file.hash = null</strong></p>
