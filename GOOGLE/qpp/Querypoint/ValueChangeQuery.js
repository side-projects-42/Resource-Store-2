...
(function () {
  ...
  (Querypoint.ValueChangeQuery.ifAvailableFor = function (tree, project) {
    ...
    if (identifierTree) {
      var query = Querypoint.ValueChangeQuery.prototype.getQueryOnTree(
        tree,
        Querypoint.ValueChangeQuery
      );
      return (
        query || new Querypoint.ValueChangeQuery(identifierTree, tree, project)
      );
    }
  }),
    (Querypoint.ValueChangeQuery.prototype = {
      ...
      activate: function (queryIndex) {
        ...
        this._setTracedPropertyObjectTransformer =
          new Querypoint.SetTracedPropertyObjectTransformer(transformData);
      ...
      matches: function (ctor, queryData) {
        ...
        return (
          ctor === Querypoint.ValueChangeQuery &&
