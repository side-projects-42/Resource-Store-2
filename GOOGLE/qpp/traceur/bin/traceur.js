var $__getDescriptors = function (object) {
  ...
  $__superGet = function (self, proto, name) {
    ...
    if (descriptor) {
      ...
      else if ("value" in descriptor) return descriptor.value;
    }
    return undefined;
  },
...
var $___src_semantics_symbols_ExportSymbol_js = function () {
  ...
  var ExportSymbol = (function ($__super) {
    ...
    var $ExportSymbol = $__createClass(
      {
        constructor: function (tree, name, relatedTree) {
...
var $___src_syntax_Token_js = function () {
  "use strict";
  var $__17 = $___src_syntax_TokenType_js,
...
var $___src_syntax_trees_ParseTree_js = function () {
  ...
  var $__17 = ParseTreeType,
    ...
    AT_NAME_DECLARATION = $__17.AT_NAME_DECLARATION,
    AT_NAME_EXPRESSION = $__17.AT_NAME_EXPRESSION,
    ...
    CASCADE_EXPRESSION = $__17.CASCADE_EXPRESSION,
    ...
    EXPORT_MAPPING = $__17.EXPORT_MAPPING,
    EXPORT_MAPPING_LIST = $__17.EXPORT_MAPPING_LIST,
    ...
    IMPORT_BINDING = $__17.IMPORT_BINDING,
    ...
    MODULE_DEFINITION = $__17.MODULE_DEFINITION,
    MODULE_EXPRESSION = $__17.MODULE_EXPRESSION,
    MODULE_REQUIRE = $__17.MODULE_REQUIRE,
    MODULE_SPECIFIER = $__17.MODULE_SPECIFIER,
    NAME_STATEMENT = $__17.NAME_STATEMENT,
    ...
    var $ParseTree = $__createClassNoExtends(
      {
        ...
        isExpression: function () {
          return (
            this.isArrowFunctionExpression() || this.type == COMMA_EXPRESSION
          );
        },
        isAssignmentOrSpread: function () {
          return (
            this.isArrowFunctionExpression() || this.type == SPREAD_EXPRESSION
          );
        },
    ...
    var $ParseTreeVisitor = $__createClassNoExtends(
      {
        ...
        visitStateMachine: function (tree) {
          throw Error(
            "State machines should not live outside of the GeneratorTransformer."
          );
        },
...
var $___src_codegeneration_module_ModuleVisitor_js = function () {
  "use strict";
  var $__17 = $___src_syntax_trees_ParseTree_js,
    ParseTree = $__17.ParseTree,
    ParseTreeType = $__17.ParseTreeType;
    ...
    var $ModuleVisitor = $__createClass(
      {
        ...
        reportError_: function (symbolOrTree, format) {
          for (var args = [], $__6 = 2; $__6 < arguments.length; $__6++)
          ...
          ($__21 = this.reporter_).reportError.apply(
            $__21,
            $__spread([tree.location.start, format], args)
          );
        },
        reportRelatedError_: function (symbolOrTree) {
          if (symbolOrTree instanceof ParseTree) {
            this.reportError_(
              symbolOrTree,
              "Location related to previous error"
            );
          } else {
...
var $___src_codegeneration_module_ExportVisitor_js = function () {
  ...
  var IDENTIFIER_EXPRESSION =
    $___src_syntax_trees_ParseTreeType_js.IDENTIFIER_EXPRESSION;
  var ModuleVisitor =
    $___src_codegeneration_module_ModuleVisitor_js.ModuleVisitor;
    ...
    var $ExportVisitor = $__createClass(
      {
        ...
        addExport_: function (name, tree) {
          ...
          parent.addExport(
            name,
            new ExportSymbol(tree, name, this.relatedTree_)
          );
        },
        visitClassDeclaration: function (tree) {
...
var $___src_codegeneration_module_ImportStarVisitor_js = function () {
  "use strict";
  var IMPORT_SPECIFIER_SET =
    $___src_syntax_trees_ParseTreeType_js.IMPORT_SPECIFIER_SET;
  var ModuleVisitor =
    $___src_codegeneration_module_ModuleVisitor_js.ModuleVisitor;
    ...
    var $ImportStarVisitor = $__createClass(
      {
        ...
        visitImportBinding: function (tree) {
          ...
          if (
            importSpecifierSet.type === IMPORT_SPECIFIER_SET &&
    ...
    var $ValidationVisitor = $__createClass(
      {
        ...
        checkExport_: function (tree, name) {
          if (
            this.validatingModule_ &&
            !this.validatingModule_.hasExport(name)
          ) {
            this.reportError_(
              tree,
              "'%s' is not exported by %s",
...
var $___src_semantics_ModuleAnalyzer_js = function () {
  "use strict";
  var ExportVisitor =
    $___src_codegeneration_module_ExportVisitor_js.ExportVisitor;
  var ImportStarVisitor =
    $___src_codegeneration_module_ImportStarVisitor_js.ImportStarVisitor;
  var ModuleDeclarationVisitor =
    $___src_codegeneration_module_ModuleDeclarationVisitor_js.ModuleDeclarationVisitor;
  var ModuleDefinitionVisitor =
    $___src_codegeneration_module_ModuleDefinitionVisitor_js.ModuleDefinitionVisitor;
  var ValidationVisitor =
    $___src_codegeneration_module_ValidationVisitor_js.ValidationVisitor;
...
var $___src_syntax_trees_ParseTrees_js = function () {
  ...
  var $__18 = ParseTreeType,
    ...
    AT_NAME_DECLARATION = $__18.AT_NAME_DECLARATION,
    AT_NAME_EXPRESSION = $__18.AT_NAME_EXPRESSION,
    ...
    CASCADE_EXPRESSION = $__18.CASCADE_EXPRESSION,
    ...
    EXPORT_MAPPING = $__18.EXPORT_MAPPING,
    EXPORT_MAPPING_LIST = $__18.EXPORT_MAPPING_LIST,
    ...
    IMPORT_BINDING = $__18.IMPORT_BINDING,
    ...
    MODULE_DEFINITION = $__18.MODULE_DEFINITION,
    MODULE_EXPRESSION = $__18.MODULE_EXPRESSION,
    MODULE_REQUIRE = $__18.MODULE_REQUIRE,
    MODULE_SPECIFIER = $__18.MODULE_SPECIFIER,
    NAME_STATEMENT = $__18.NAME_STATEMENT,
...
var $___src_codegeneration_ParseTreeTransformer_js = function () {
  "use strict";
  var $__18 = $___src_syntax_trees_ParseTrees_js,
    ArgumentList = $__18.ArgumentList,
    ArrayComprehension = $__18.ArrayComprehension,
    ArrayLiteralExpression = $__18.ArrayLiteralExpression,
    ArrayPattern = $__18.ArrayPattern,
    ArrowFunctionExpression = $__18.ArrowFunctionExpression,
    AtNameDeclaration = $__18.AtNameDeclaration,
    AtNameExpression = $__18.AtNameExpression,
    AwaitStatement = $__18.AwaitStatement,
    BinaryOperator = $__18.BinaryOperator,
    BindingElement = $__18.BindingElement,
    BindingIdentifier = $__18.BindingIdentifier,
    Block = $__18.Block,
    BreakStatement = $__18.BreakStatement,
    CallExpression = $__18.CallExpression,
    CascadeExpression = $__18.CascadeExpression,
    CaseClause = $__18.CaseClause,
    Catch = $__18.Catch,
    ClassDeclaration = $__18.ClassDeclaration,
    ClassExpression = $__18.ClassExpression,
    CommaExpression = $__18.CommaExpression,
    ComprehensionFor = $__18.ComprehensionFor,
    ComprehensionIf = $__18.ComprehensionIf,
    ConditionalExpression = $__18.ConditionalExpression,
    ContinueStatement = $__18.ContinueStatement,
    CoverFormals = $__18.CoverFormals,
    DebuggerStatement = $__18.DebuggerStatement,
    DefaultClause = $__18.DefaultClause,
    DoWhileStatement = $__18.DoWhileStatement,
    EmptyStatement = $__18.EmptyStatement,
    ExportDeclaration = $__18.ExportDeclaration,
    ExportMapping = $__18.ExportMapping,
    ExportMappingList = $__18.ExportMappingList,
    ExportSpecifier = $__18.ExportSpecifier,
    ExportSpecifierSet = $__18.ExportSpecifierSet,
    ExportStar = $__18.ExportStar,
    ExpressionStatement = $__18.ExpressionStatement,
    Finally = $__18.Finally,
    ForInStatement = $__18.ForInStatement,
    ForOfStatement = $__18.ForOfStatement,
    ForStatement = $__18.ForStatement,
    FormalParameterList = $__18.FormalParameterList,
    FunctionDeclaration = $__18.FunctionDeclaration,
    FunctionExpression = $__18.FunctionExpression,
    GeneratorComprehension = $__18.GeneratorComprehension,
    GetAccessor = $__18.GetAccessor,
    IdentifierExpression = $__18.IdentifierExpression,
    IfStatement = $__18.IfStatement,
    ImportBinding = $__18.ImportBinding,
    ImportDeclaration = $__18.ImportDeclaration,
    ImportSpecifier = $__18.ImportSpecifier,
    ImportSpecifierSet = $__18.ImportSpecifierSet,
    LabelledStatement = $__18.LabelledStatement,
    LiteralExpression = $__18.LiteralExpression,
    MemberExpression = $__18.MemberExpression,
    MemberLookupExpression = $__18.MemberLookupExpression,
    ModuleDeclaration = $__18.ModuleDeclaration,
    ModuleDefinition = $__18.ModuleDefinition,
    ModuleExpression = $__18.ModuleExpression,
    ModuleRequire = $__18.ModuleRequire,
    ModuleSpecifier = $__18.ModuleSpecifier,
    NameStatement = $__18.NameStatement,
    NewExpression = $__18.NewExpression,
    ObjectLiteralExpression = $__18.ObjectLiteralExpression,
    ObjectPattern = $__18.ObjectPattern,
    ObjectPatternField = $__18.ObjectPatternField,
    ParenExpression = $__18.ParenExpression,
    PostfixExpression = $__18.PostfixExpression,
    PredefinedType = $__18.PredefinedType,
    Program = $__18.Program,
    PropertyMethodAssignment = $__18.PropertyMethodAssignment,
    PropertyNameAssignment = $__18.PropertyNameAssignment,
    PropertyNameShorthand = $__18.PropertyNameShorthand,
    RestParameter = $__18.RestParameter,
    ReturnStatement = $__18.ReturnStatement,
    SetAccessor = $__18.SetAccessor,
    SpreadExpression = $__18.SpreadExpression,
    SpreadPatternElement = $__18.SpreadPatternElement,
    SuperExpression = $__18.SuperExpression,
    SwitchStatement = $__18.SwitchStatement,
    SyntaxErrorTree = $__18.SyntaxErrorTree,
    TemplateLiteralExpression = $__18.TemplateLiteralExpression,
    TemplateLiteralPortion = $__18.TemplateLiteralPortion,
    TemplateSubstitution = $__18.TemplateSubstitution,
    ThisExpression = $__18.ThisExpression,
    ThrowStatement = $__18.ThrowStatement,
    TryStatement = $__18.TryStatement,
    TypeName = $__18.TypeName,
    UnaryExpression = $__18.UnaryExpression,
    VariableDeclaration = $__18.VariableDeclaration,
    VariableDeclarationList = $__18.VariableDeclarationList,
    VariableStatement = $__18.VariableStatement,
    WhileStatement = $__18.WhileStatement,
    WithStatement = $__18.WithStatement,
    YieldExpression = $__18.YieldExpression;
    ...
    var $ParseTreeTransformer = $__createClassNoExtends(
      {
        ...
        transformArrayComprehension: function (tree) {
          ...
          if (
            comprehensionList === tree.comprehensionList &&
            expression === tree.expression
          ) {
            return tree;
          }
          return new ArrayComprehension(
            tree.location,
            comprehensionList,
            expression
          );
        ...
        transformArrowFunctionExpression: function (tree) {
          ...
          if (
            formalParameters === tree.formalParameters &&
        ...
        transformExportMapping: function (tree) {
          ...
          if (
            moduleExpression === tree.moduleExpression &&
            specifierSet === tree.specifierSet
          ) {
            return tree;
          }
          return new ExportMapping(
            tree.location,
            moduleExpression,
            specifierSet
          );
        ...
        transformGeneratorComprehension: function (tree) {
          ...
          return new GeneratorComprehension(
            tree.location,
            comprehensionList,
            expression
          );
        ...
        transformMemberLookupExpression: function (tree) {
          ...
          return new MemberLookupExpression(
            tree.location,
            operand,
            memberExpression
          );
        ...
        transformObjectLiteralExpression: function (tree) {
          var propertyNameAndValues = this.transformList(
            tree.propertyNameAndValues
          );
...
var $___src_codegeneration_AssignmentPatternTransformer_js = function () {
  "use strict";
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var $__18 = $___src_syntax_trees_ParseTrees_js,
    ArrayPattern = $__18.ArrayPattern,
    BindingElement = $__18.BindingElement,
    IdentifierExpression = $__18.IdentifierExpression,
  ...
  var AssignmentPatternTransformerError = (function ($__super) {
    "use strict";
    var $__proto = $__getProtoParent($__super);
    var $AssignmentPatternTransformerError = $__createClass(
      {
        constructor: function () {
          $__superCall(this, $__proto, "constructor", arguments);
        },
...
var $___src_codegeneration_CoverFormalsTransformer_js = function () {
  ...
  var $__18 = $___src_syntax_trees_ParseTrees_js,
    ...
    SpreadPatternElement = $__18.SpreadPatternElement;
  var EQUAL = $___src_syntax_TokenType_js.EQUAL;
  var $__18 = $___src_syntax_trees_ParseTreeType_js,
    IDENTIFIER_EXPRESSION = $__18.IDENTIFIER_EXPRESSION,
    SPREAD_PATTERN_ELEMENT = $__18.SPREAD_PATTERN_ELEMENT;
  var AssignmentPatternTransformerError =
    $___src_codegeneration_AssignmentPatternTransformer_js.AssignmentPatternTransformerError;
  var CoverFormalsTransformerError = (function ($__super) {
    "use strict";
    var $__proto = $__getProtoParent($__super);
    var $CoverFormalsTransformerError = $__createClass(
      {
        constructor: function () {
          $__superCall(this, $__proto, "constructor", arguments);
        },
...
var $___src_syntax_LiteralToken_js = function () {
  "use strict";
  var Token = $___src_syntax_Token_js.Token;
  var $__18 = $___src_syntax_TokenType_js,
    NULL = $__18.NULL,
    NUMBER = $__18.NUMBER,
    STRING = $__18.STRING;
...
var $___src_syntax_Scanner_js = function () {
  ...
  var $__18 = $___src_syntax_TokenType_js,
    AMPERSAND = $__18.AMPERSAND,
    AMPERSAND_EQUAL = $__18.AMPERSAND_EQUAL,
    AND = $__18.AND,
    ARROW = $__18.ARROW,
    AT_NAME = $__18.AT_NAME,
    AWAIT = $__18.AWAIT,
    BACK_QUOTE = $__18.BACK_QUOTE,
    BANG = $__18.BANG,
    BAR = $__18.BAR,
    ...
    CATCH = $__18.CATCH,
    CLASS = $__18.CLASS,
    CLOSE_ANGLE = $__18.CLOSE_ANGLE,
    CLOSE_CURLY = $__18.CLOSE_CURLY,
    CLOSE_PAREN = $__18.CLOSE_PAREN,
    CLOSE_SQUARE = $__18.CLOSE_SQUARE,
    COLON = $__18.COLON,
    COMMA = $__18.COMMA,
    CONST = $__18.CONST,
    CONTINUE = $__18.CONTINUE,
    DEBUGGER = $__18.DEBUGGER,
    DEFAULT = $__18.DEFAULT,
    DELETE = $__18.DELETE,
    DO = $__18.DO,
    DOLLAR = $__18.DOLLAR,
    DOT_DOT_DOT = $__18.DOT_DOT_DOT,
    ELSE = $__18.ELSE,
    END_OF_FILE = $__18.END_OF_FILE,
    ENUM = $__18.ENUM,
    EQUAL = $__18.EQUAL,
    EQUAL_EQUAL = $__18.EQUAL_EQUAL,
    EQUAL_EQUAL_EQUAL = $__18.EQUAL_EQUAL_EQUAL,
    ERROR = $__18.ERROR,
    EXPORT = $__18.EXPORT,
    EXTENDS = $__18.EXTENDS,
    FALSE = $__18.FALSE,
    FINALLY = $__18.FINALLY,
    FOR = $__18.FOR,
    FUNCTION = $__18.FUNCTION,
    GREATER_EQUAL = $__18.GREATER_EQUAL,
    IDENTIFIER = $__18.IDENTIFIER,
    IF = $__18.IF,
    IMPLEMENTS = $__18.IMPLEMENTS,
    IMPORT = $__18.IMPORT,
    IN = $__18.IN,
    INSTANCEOF = $__18.INSTANCEOF,
    INTERFACE = $__18.INTERFACE,
    LEFT_SHIFT = $__18.LEFT_SHIFT,
    LEFT_SHIFT_EQUAL = $__18.LEFT_SHIFT_EQUAL,
    LESS_EQUAL = $__18.LESS_EQUAL,
    LET = $__18.LET,
    MINUS = $__18.MINUS,
    MINUS_EQUAL = $__18.MINUS_EQUAL,
    MINUS_MINUS = $__18.MINUS_MINUS,
    NEW = $__18.NEW,
    NO_SUBSTITUTION_TEMPLATE = $__18.NO_SUBSTITUTION_TEMPLATE,
    NOT_EQUAL = $__18.NOT_EQUAL,
    NOT_EQUAL_EQUAL = $__18.NOT_EQUAL_EQUAL,
    NULL = $__18.NULL,
    NUMBER = $__18.NUMBER,
    OPEN_ANGLE = $__18.OPEN_ANGLE,
    OPEN_CURLY = $__18.OPEN_CURLY,
    OPEN_PAREN = $__18.OPEN_PAREN,
    OPEN_SQUARE = $__18.OPEN_SQUARE,
    OR = $__18.OR,
    PACKAGE = $__18.PACKAGE,
    PERCENT = $__18.PERCENT,
    PERCENT_EQUAL = $__18.PERCENT_EQUAL,
    PERIOD = $__18.PERIOD,
    PERIOD_OPEN_CURLY = $__18.PERIOD_OPEN_CURLY,
    PLUS = $__18.PLUS,
    PLUS_EQUAL = $__18.PLUS_EQUAL,
    PLUS_PLUS = $__18.PLUS_PLUS,
    PRIVATE = $__18.PRIVATE,
    PROTECTED = $__18.PROTECTED,
    PUBLIC = $__18.PUBLIC,
    QUESTION = $__18.QUESTION,
    REGULAR_EXPRESSION = $__18.REGULAR_EXPRESSION,
    RETURN = $__18.RETURN,
    RIGHT_SHIFT = $__18.RIGHT_SHIFT,
    RIGHT_SHIFT_EQUAL = $__18.RIGHT_SHIFT_EQUAL,
    SEMI_COLON = $__18.SEMI_COLON,
    SLASH = $__18.SLASH,
    ...
    SUPER = $__18.SUPER,
    SWITCH = $__18.SWITCH,
    TEMPLATE_HEAD = $__18.TEMPLATE_HEAD,
    TEMPLATE_MIDDLE = $__18.TEMPLATE_MIDDLE,
    TEMPLATE_TAIL = $__18.TEMPLATE_TAIL,
    THIS = $__18.THIS,
    THROW = $__18.THROW,
    TILDE = $__18.TILDE,
    TRUE = $__18.TRUE,
    TRY = $__18.TRY,
    TYPEOF = $__18.TYPEOF,
    UNSIGNED_RIGHT_SHIFT = $__18.UNSIGNED_RIGHT_SHIFT,
  ...
  for (var i = 0; i < 128; i++) {
    isIdentifierStartArray[i] =
      i === 36 || (i >= 65 && i <= 90) || i === 95 || (i >= 97 && i <= 122);
  }
  ...
  var unicodeLetterTable = [
    ...
    2042, 2048, 2069, 2074, 2074, 2084, 2084, 2088, 2088, 2112, 2136, 2308,
    2361, 2365, 2365, 2384, 2384, 2392, 2401, 2417, 2423, 2425, 2431, 2437,
    ...
    3123, 3125, 3129, 3133, 3133, 3160, 3161, 3168, 3169, 3205, 3212, 3214,
    3216, 3218, 3240, 3242, 3251, 3253, 3257, 3261, 3261, 3294, 3294, 3296,
    3297, 3313, 3314, 3333, 3340, 3342, 3344, 3346, 3386, 3389, 3389, 3406,
    3406, 3424, 3425, 3450, 3455, 3461, 3478, 3482, 3505, 3507, 3515, 3517,
    ...
    3948, 3976, 3980, 4096, 4138, 4159, 4159, 4176, 4181, 4186, 4189, 4193,
    4193, 4197, 4198, 4206, 4208, 4213, 4225, 4238, 4238, 4256, 4293, 4304,
    4346, 4348, 4348, 4352, 4680, 4682, 4685, 4688, 4694, 4696, 4696, 4698,
    4701, 4704, 4744, 4746, 4749, 4752, 4784, 4786, 4789, 4792, 4798, 4800,
    4800, 4802, 4805, 4808, 4822, 4824, 4880, 4882, 4885, 4888, 4954, 4992,
    5007, 5024, 5108, 5121, 5740, 5743, 5759, 5761, 5786, 5792, 5866, 5870,
    5872, 5888, 5900, 5902, 5905, 5920, 5937, 5952, 5969, 5984, 5996, 5998,
    6000, 6016, 6067, 6103, 6103, 6108, 6108, 6176, 6263, 6272, 6312, 6314,
    6314, 6320, 6389, 6400, 6428, 6480, 6509, 6512, 6516, 6528, 6571, 6593,
    6599, 6656, 6678, 6688, 6740, 6823, 6823, 6917, 6963, 6981, 6987, 7043,
    7072, 7086, 7087, 7104, 7141, 7168, 7203, 7245, 7247, 7258, 7293, 7401,
    7404, 7406, 7409, 7424, 7615, 7680, 7957, 7960, 7965, 7968, 8005, 8008,
    ...
    11499, 11502, 11520, 11557, 11568, 11621, 11631, 11631, 11648, 11670, 11680,
    ...
    12549, 12589, 12593, 12686, 12704, 12730, 12784, 12799, 13312, 13312, 19893,
    19893, 19968, 19968, 40907, 40907, 40960, 42124, 42192, 42237, 42240, 42508,
    42512, 42527, 42538, 42539, 42560, 42606, 42623, 42647, 42656, 42735, 42775,
    42783, 42786, 42888, 42891, 42894, 42896, 42897, 42912, 42921, 43002, 43009,
    43011, 43013, 43015, 43018, 43020, 43042, 43072, 43123, 43138, 43187, 43250,
    43255, 43259, 43259, 43274, 43301, 43312, 43334, 43360, 43388, 43396, 43442,
    43471, 43471, 43520, 43560, 43584, 43586, 43588, 43595, 43616, 43638, 43642,
    43642, 43648, 43695, 43697, 43697, 43701, 43702, 43705, 43709, 43712, 43712,
    43714, 43714, 43739, 43741, 43777, 43782, 43785, 43790, 43793, 43798, 43808,
    43814, 43816, 43822, 43968, 44002, 44032, 44032, 55203, 55203, 55216, 55238,
    55243, 55291, 63744, 64045, 64048, 64109, 64112, 64217, 64256, 64262, 64275,
    ...
    65664, 65786, 65856, 65908, 66176, 66204, 66208, 66256, 66304, 66334, 66352,
    66378, 66432, 66461, 66464, 66499, 66504, 66511, 66513, 66517, 66560, 66717,
    67584, 67589, 67592, 67592, 67594, 67637, 67639, 67640, 67644, 67644, 67647,
    67669, 67840, 67861, 67872, 67897, 68096, 68096, 68112, 68115, 68117, 68119,
    68121, 68147, 68192, 68220, 68352, 68405, 68416, 68437, 68448, 68466, 68608,
    68680, 69635, 69687, 69763, 69807, 73728, 74606, 74752, 74850, 77824, 78894,
    92160, 92728, 110592, 110593, 119808, 119892, 119894, 119964, 119966,
    ...
    120779, 131072, 131072, 173782, 173782, 173824, 173824, 177972, 177972,
  ...
  function nextTemplateLiteralTokenShared(endType, middleType) {
    ...
    switch (currentCharCode) {
      case 96:
        next();
        return (lastToken = new LiteralToken(
          endType,
          value,
...
var $___src_util_SourceRange_js = function () {
  ...
  var SourceRange = (function () {
    "use strict";
    var $SourceRange = $__createClassNoExtends(
      {
...
var $___src_syntax_Parser_js = function () {
  "use strict";
  var $__18 = $___src_codegeneration_AssignmentPatternTransformer_js,
    AssignmentPatternTransformer = $__18.AssignmentPatternTransformer,
    AssignmentPatternTransformerError = $__18.AssignmentPatternTransformerError;
  var $__18 = $___src_codegeneration_CoverFormalsTransformer_js,
    CoverFormalsTransformer = $__18.CoverFormalsTransformer,
    CoverFormalsTransformerError = $__18.CoverFormalsTransformerError;
  var IdentifierToken = $___src_syntax_IdentifierToken_js.IdentifierToken;
  var $__18 = $___src_syntax_trees_ParseTreeType_js,
    ARRAY_LITERAL_EXPRESSION = $__18.ARRAY_LITERAL_EXPRESSION,
    BINARY_OPERATOR = $__18.BINARY_OPERATOR,
  ...
  var $__18 = $___src_syntax_Token_js,
    Token = $__18.Token,
    isAssignmentOperator = $__18.isAssignmentOperator;
  var $__18 = $___src_options_js,
    parseOptions = $__18.parseOptions,
    options = $__18.options;
  var $__18 = $___src_syntax_TokenType_js,
    AMPERSAND = $__18.AMPERSAND,
    AMPERSAND_EQUAL = $__18.AMPERSAND_EQUAL,
    AND = $__18.AND,
    ...
    var $Parser = $__createClassNoExtends(
      {
        ...
        parseFunctionDeclaration_: function () {
          ...
          return this.parseFunctionDeclarationTail_(
            start,
            isGenerator,
        ...
        parseVariableDeclarationList_: function () {
          var expressionIn =
            arguments[0] !== void 0 ? arguments[0] : Expression.NORMAL;
          var initializer =
            arguments[1] !== void 0
              ? arguments[1]
              : DestructuringInitializer.REQUIRED;
          var type = this.peekType_();
          switch (type) {
            case CONST:
            case LET:
          ...
          var declarations = [];
          declarations.push(
            this.parseVariableDeclaration_(type, expressionIn, initializer)
          );
          while (this.eatIf_(COMMA)) {
            declarations.push(
              this.parseVariableDeclaration_(type, expressionIn, initializer)
        ...
        parseForStatement_: function () {
          ...
          if (this.peekVariableDeclarationList_(type)) {
            var variables = this.parseVariableDeclarationList_(
              Expression.NO_IN,
              DestructuringInitializer.OPTIONAL
            );
            type = this.peekType_();
            if (type === IN) {
          ...
          type = this.peekType_();
          if (
            initializer.isLeftHandSideExpression() &&
        ...
        parseCatch_: function () {
          ...
          else binding = this.parseBindingIdentifier_();
          this.eat_(CLOSE_PAREN);
        ...
        parsePropertyDefinition: function () {
          ...
          var isStatic = false;
          if (
            parseOptions.generators &&
            parseOptions.propertyMethods &&
            this.peek_(STAR)
          ) {
        ...
        parseExpression: function () {
          var expressionIn =
            arguments[0] !== void 0 ? arguments[0] : Expression.IN;
          var start = this.getTreeStartLocation_();
        ...
        parseAssignmentExpression: function () {
          ...
          if (this.peekAssignmentOperator_(type)) {
            ...
            if (!left.isLeftHandSideExpression() && !left.isPattern()) {
              this.reportError_(
                "Left hand side of assignment must be new, call, member, function, primary expressions or destructuring pattern"
              );
            }
        ...
        transformLeftHandSideExpression_: function (tree) {
          switch (tree.type) {
            ...
            case OBJECT_LITERAL_EXPRESSION:
              ...
              break;
            case PAREN_EXPRESSION:
              var expression = this.transformLeftHandSideExpression_(
                tree.expression
              );
              if (expression !== tree.expression)
                return new ParenExpression(tree.location, expression);
            ...
            loop: while (true) {
              switch (this.peekType_()) {
                ...
                case OPEN_SQUARE:
                  ...
                  this.eat_(CLOSE_SQUARE);
                  operand = new MemberLookupExpression(
                    this.getTreeLocation_(start),
                    operand,
                    member
                  );
        ...
        parseCascadeExpressions_: function () {
          ...
          var type;
          while (
            this.peekId_((type = this.peekType_())) &&
        ...
        parseArrowFunction_: function (expressionIn) {
          ...
          if (!formals) {
            ...
            if (expressions.length > 1)
              expression = new CommaExpression(
                coverFormals.location,
                expressions
              );
            else expression = expressions[0];
        ...
        peekPattern_: function (type) {
          return (
            parseOptions.destructuring &&
            (this.peekObjectPattern_(type) || this.peekArrayPattern_(type))
          );
        },
        ...
        parseBindingElement_: function () {
          var initializer =
            arguments[0] !== void 0 ? arguments[0] : Initializer.OPTIONAL;
          var start = this.getTreeStartLocation_();
          var binding;
          if (this.peekPattern_(this.peekType_()))
            binding = this.parseBindingPattern_();
        ...
        peekBindingProperty_: function (type) {
          return (
            this.peekBindingIdentifier_(type) || this.peekPropertyName_(type)
          );
        },
        ...
        parseTemplateLiteral_: function (operand) {
          ...
          var expression = this.parseExpression();
          elements.push(
            new TemplateSubstitution(expression.location, expression)
          );
          ...
          if (input.charCodeAt((start += 2)) === 58 && !options.ignoreNolint) {
            ...
            if (text.search(/^(?:no)?lint\b/) === 0) {
              ...
              if (noLint !== this.noLint) {
                ...
                this.noLint = noLint;
                this.strictSemicolons_ =
                  options.strictSemicolons && !this.noLint;
              }
            }
          }
        },
        ...
        reportError_: function (var_args) {
          if (arguments.length == 1) {
            this.errorReporter_.reportError(
              this.scanner_.getPosition(),
              arguments[0]
            );
          } else {
...
var $___src_codegeneration_ParseTreeFactory_js = function () {
  ...
  var IdentifierToken = $___src_syntax_IdentifierToken_js.IdentifierToken;
  var LiteralToken = $___src_syntax_LiteralToken_js.LiteralToken;
  var $__18 = $___src_syntax_trees_ParseTree_js,
    ParseTree = $__18.ParseTree,
    ParseTreeType = $__18.ParseTreeType;
  var $__18 = $___src_syntax_PredefinedName_js,
    BIND = $__18.BIND,
    CALL = $__18.CALL,
    CREATE = $__18.CREATE,
    DEFINE_PROPERTY = $__18.DEFINE_PROPERTY,
    FREEZE = $__18.FREEZE,
    OBJECT = $__18.OBJECT,
    PREVENT_EXTENSIONS = $__18.PREVENT_EXTENSIONS,
    STATE = $__18.STATE,
    UNDEFINED = $__18.UNDEFINED,
    getParameterName = $__18.getParameterName;
  var Token = $___src_syntax_Token_js.Token;
  var $__18 = $___src_syntax_TokenType_js,
    EQUAL = $__18.EQUAL,
    FALSE = $__18.FALSE,
  ...
  function createStatementList(statementsOrHead) {
    for (var args = [], $__7 = 1; $__7 < arguments.length; $__7++)
      args[$__7 - 1] = arguments[$__7];
    if (statementsOrHead instanceof Array)
      return $__spread(statementsOrHead, args);
  ...
  function createArgumentList(numberListOrFirst, var_args) {
    ...
    var list;
    if (numberListOrFirst instanceof Array) list = numberListOrFirst;
    else list = slice(arguments);
    ...
    var builder = formalParameterList.parameters.map(function (parameter) {
      if (parameter.isRestParameter()) {
        return createSpreadExpression(
          createIdentifierExpression(parameter.identifier)
        );
      } else {
        return parameter;
      }
  ...
  function createCallExpression(operand) {
    var args =
      arguments[1] !== void 0 ? arguments[1] : createEmptyArgumentList();
  ...
  function createCallCallStatement(func, thisExpression) {
    for (var args = [], $__8 = 2; $__8 < arguments.length; $__8++)
      args[$__8 - 2] = arguments[$__8];
  ...
  function createObjectPreventExtensions(value) {
    return createCallExpression(
      createMemberExpression(OBJECT, PREVENT_EXTENSIONS),
      createArgumentList(value)
    );
  }
  ...
  function createDefineProperty(tree, name, descr) {
    ...
    return createCallExpression(
      ...
      createArgumentList(tree, name, createPropertyDescriptor(descr))
    );
  }
  ...
  function createYieldStatement(expression, isYieldFor) {
    return createExpressionStatement(
      new YieldExpression(null, expression, isYieldFor)
    );
  }
    ...
    var $VariableBinder = $__createClass(
      {
        ...
        visitVariableDeclarationList: function (tree) {
          if (
            ...
            $__superCall(this, $__proto, "visitVariableDeclarationList", [
              tree,
            ]);
          } else {
...
var $___src_codegeneration_AlphaRenamer_js = function () {
  ...
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var $__18 = $___src_syntax_PredefinedName_js,
    ARGUMENTS = $__18.ARGUMENTS,
    THIS = $__18.THIS;
  var createIdentifierExpression =
    $___src_codegeneration_ParseTreeFactory_js.createIdentifierExpression;
  var $__18 = $___src_semantics_VariableBinder_js,
    variablesInBlock = $__18.variablesInBlock,
    variablesInFunction = $__18.variablesInFunction;
    ...
    var $AlphaRenamer = $__createClass(
      {
        ...
        transformFunctionDeclaration: function (tree) {
          ...
          return $__superCall(this, $__proto, "transformFunctionDeclaration", [
            tree,
          ]);
        },
        transformFunctionExpression: function (tree) {
          ...
          if (this.getDoNotRecurse(tree)) return tree;
          return $__superCall(this, $__proto, "transformFunctionExpression", [
            tree,
          ]);
        },
...
var $___src_codegeneration_PrependStatements_js = function () {
  ...
  function prependStatements(statements) {
    for (
      var statementsToPrepend = [], $__9 = 1;
      $__9 < arguments.length;
      $__9++
    )
      statementsToPrepend[$__9 - 1] = arguments[$__9];
    ...
    statements.forEach(function (statement) {
      if (inProlog && !isStringExpressionStatement(statement)) {
        ($__23 = transformed).push.apply(
          $__23,
          $__toObject(statementsToPrepend)
        );
        inProlog = false;
      }
...
var $___src_codegeneration_TempVarTransformer_js = function () {
  ...
  var $__18 = $___src_syntax_trees_ParseTrees_js,
    ...
    Program = $__18.Program;
  var VAR = $___src_syntax_TokenType_js.VAR;
  var $__18 = $___src_codegeneration_ParseTreeFactory_js,
    createBlock = $__18.createBlock,
    createVariableDeclaration = $__18.createVariableDeclaration,
    createVariableDeclarationList = $__18.createVariableDeclarationList,
    createVariableStatement = $__18.createVariableStatement;
  var prependStatements =
    $___src_codegeneration_PrependStatements_js.prependStatements;
  ...
  var TempVarStatement = (function () {
    "use strict";
    var $TempVarStatement = $__createClassNoExtends(
      {
        constructor: function (name, initializer) {
          this.name = name;
          this.initializer = initializer;
        },
      },
    ...
    var $TempVarTransformer = $__createClass(
      {
        ...
        transformStatements_: function (statements) {
          ...
          vars = vars.filter(function (tempVarStatement) {
            var $__18 = tempVarStatement,
              name = $__18.name,
              initializer = $__18.initializer;
        ...
        getTempIdentifier: function () {
          ...
          this.tempIdentifierStack_[this.tempIdentifierStack_.length - 1].push(
            name
          );
          return name;
        },
...
var $___src_codegeneration_ComprehensionTransformer_js = function () {
  "use strict";
  var $__19 = $___src_syntax_PredefinedName_js,
    ARGUMENTS = $__19.ARGUMENTS,
    THIS = $__19.THIS;
  var AlphaRenamer = $___src_codegeneration_AlphaRenamer_js.AlphaRenamer;
  var FindInFunctionScope =
    $___src_codegeneration_FindInFunctionScope_js.FindInFunctionScope;
  var FunctionExpression =
    $___src_syntax_trees_ParseTrees_js.FunctionExpression;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__19 = $___src_syntax_TokenType_js,
    LET = $__19.LET,
    VAR = $__19.VAR;
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createForOfStatement = $__19.createForOfStatement,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createIfStatement = $__19.createIfStatement,
    createParenExpression = $__19.createParenExpression,
    createThisExpression = $__19.createThisExpression,
    ...
    var $ComprehensionTransformer = $__createClass(
      {
        ...
        transformComprehension: function (
          tree,
          statement,
          isGenerator,
          returnStatement
          ...
          for (var i = tree.comprehensionList.length - 1; i >= 0; i--) {
            ...
            switch (item.type) {
              ...
              case COMPREHENSION_FOR:
                ...
                statement = createForOfStatement(
                  initializer,
                  iterator,
                  statement
                );
...
var $___src_codegeneration_ArrayComprehensionTransformer_js = function () {
  "use strict";
  var ComprehensionTransformer =
    $___src_codegeneration_ComprehensionTransformer_js.ComprehensionTransformer;
  var PLUS_PLUS = $___src_syntax_TokenType_js.PLUS_PLUS;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createArrayLiteralExpression = $__19.createArrayLiteralExpression,
    createAssignmentStatement = $__19.createAssignmentStatement,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createMemberLookupExpression = $__19.createMemberLookupExpression,
    createNumberLiteral = $__19.createNumberLiteral,
    createPostfixExpression = $__19.createPostfixExpression,
    createReturnStatement = $__19.createReturnStatement;
...
var $___src_codegeneration_ArrowFunctionTransformer_js = function () {
  ...
  var FormalParameterList =
    $___src_syntax_trees_ParseTrees_js.FormalParameterList;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var BLOCK = $___src_syntax_trees_ParseTreeType_js.BLOCK;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__19.createArgumentList,
    createBlock = $__19.createBlock,
    createCallExpression = $__19.createCallExpression,
...
var $___src_codegeneration_OperatorExpander_js = function () {
  ...
  var $__19 = $___src_syntax_TokenType_js,
    AMPERSAND = $__19.AMPERSAND,
    AMPERSAND_EQUAL = $__19.AMPERSAND_EQUAL,
    BAR = $__19.BAR,
    BAR_EQUAL = $__19.BAR_EQUAL,
    CARET = $__19.CARET,
    CARET_EQUAL = $__19.CARET_EQUAL,
    LEFT_SHIFT = $__19.LEFT_SHIFT,
    LEFT_SHIFT_EQUAL = $__19.LEFT_SHIFT_EQUAL,
    MINUS = $__19.MINUS,
    MINUS_EQUAL = $__19.MINUS_EQUAL,
    PERCENT = $__19.PERCENT,
    PERCENT_EQUAL = $__19.PERCENT_EQUAL,
    PLUS = $__19.PLUS,
    PLUS_EQUAL = $__19.PLUS_EQUAL,
    RIGHT_SHIFT = $__19.RIGHT_SHIFT,
    RIGHT_SHIFT_EQUAL = $__19.RIGHT_SHIFT_EQUAL,
    SLASH = $__19.SLASH,
    SLASH_EQUAL = $__19.SLASH_EQUAL,
    STAR = $__19.STAR,
    STAR_EQUAL = $__19.STAR_EQUAL,
    UNSIGNED_RIGHT_SHIFT = $__19.UNSIGNED_RIGHT_SHIFT,
    UNSIGNED_RIGHT_SHIFT_EQUAL = $__19.UNSIGNED_RIGHT_SHIFT_EQUAL;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createMemberExpression = $__19.createMemberExpression,
    createMemberLookupExpression = $__19.createMemberLookupExpression,
    createOperatorToken = $__19.createOperatorToken,
    createParenExpression = $__19.createParenExpression;
...
var $___src_codegeneration_AtNameMemberTransformer_js = function () {
  ...
  var $__19 = $___src_syntax_PredefinedName_js,
    DELETE_PROPERTY = $__19.DELETE_PROPERTY,
    GET_PROPERTY = $__19.GET_PROPERTY,
    RUNTIME = $__19.RUNTIME,
    SET_PROPERTY = $__19.SET_PROPERTY,
    TRACEUR_RUNTIME = $__19.TRACEUR_RUNTIME;
  var MEMBER_EXPRESSION =
    $___src_syntax_trees_ParseTreeType_js.MEMBER_EXPRESSION;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__19 = $___src_syntax_TokenType_js,
    AT_NAME = $__19.AT_NAME,
    DELETE = $__19.DELETE,
    EQUAL = $__19.EQUAL;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__19.createArgumentList,
    createAssignmentExpression = $__19.createAssignmentExpression,
    createCallCall = $__19.createCallCall,
    createCallExpression = $__19.createCallExpression,
    createCommaExpression = $__19.createCommaExpression,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createMemberExpression = $__19.createMemberExpression,
    createParenExpression = $__19.createParenExpression;
  var expandMemberExpression =
    $___src_codegeneration_OperatorExpander_js.expandMemberExpression;
    ...
    var $AtNameMemberTransformer = $__createClass(
      {
        ...
        transformBinaryOperator: function (tree) {
          ...
          return $__superCall(this, $__proto, "transformBinaryOperator", [
            tree,
          ]);
        },
        transformCallExpression: function (tree) {
          if (
            ...
            return $__superCall(this, $__proto, "transformCallExpression", [
              tree,
            ]);
        ...
        transformMemberExpression: function (tree) {
          if (tree.memberName.type !== AT_NAME)
            return $__superCall(this, $__proto, "transformMemberExpression", [
              tree,
            ]);
          var atNameExpression = new AtNameExpression(
        ...
        transformUnaryExpression: function (tree) {
          if (
            ...
            return $__superCall(this, $__proto, "transformUnaryExpression", [
              tree,
            ]);
          }
          var operand = this.transformAny(tree.operand.operand);
      ...
      },
      {
        transformTree: function (identifierGenerator, tree) {
          return new AtNameMemberTransformer(identifierGenerator).transformAny(
            tree
          );
        },
      },
...
var $___src_codegeneration_BlockBindingTransformer_js = function () {
  ...
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    FunctionDeclaration = $__19.FunctionDeclaration,
    FunctionExpression = $__19.FunctionExpression;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var $__19 = $___src_syntax_TokenType_js,
    CONST = $__19.CONST,
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createBlock = $__19.createBlock,
    createCatch = $__19.createCatch,
    createEmptyStatement = $__19.createEmptyStatement,
    createExpressionStatement = $__19.createExpressionStatement,
    createFinally = $__19.createFinally,
    createForInStatement = $__19.createForInStatement,
    createForStatement = $__19.createForStatement,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createIdentifierToken = $__19.createIdentifierToken,
    createThrowStatement = $__19.createThrowStatement,
    createTryStatement = $__19.createTryStatement,
    createUndefinedExpression = $__19.createUndefinedExpression,
  ...
  var Rename = (function () {
    "use strict";
    var $Rename = $__createClassNoExtends(
      {
        constructor: function (oldName, newName) {
    ...
    var $BlockBindingTransformer = $__createClass(
      {
        ...
        rewriteAsCatch_: function (blockVariables, statement) {
          for (var variable in blockVariables) {
            statement = createTryStatement(
              createBlock(createThrowStatement(createUndefinedExpression())),
              createCatch(
        ...
        transformForLet_: function (tree, variables) {
          ...
          var transformedForLoop = createBlock(
            createVariableStatement(
              createVariableDeclarationList(LET, hoisted)
            ),
            createForStatement(
              null,
              condition,
        ...
        transformVariables_: function (tree) {
          ...
          if (transformed != null || tree.declarationType != VAR) {
            var declarations =
              transformed != null ? transformed : tree.declarations;
            var declarationType =
...
var $___src_codegeneration_CascadeExpressionTransformer_js = function () {
  ...
  var $__19 = $___src_syntax_trees_ParseTreeType_js,
    ...
    CALL_EXPRESSION = $__19.CALL_EXPRESSION,
    CASCADE_EXPRESSION = $__19.CASCADE_EXPRESSION,
    CASCADE_EXPRESSION = $__19.CASCADE_EXPRESSION,
    IDENTIFIER_EXPRESSION = $__19.IDENTIFIER_EXPRESSION,
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createBinaryOperator = $__19.createBinaryOperator,
    createCallExpression = $__19.createCallExpression,
    createCascadeExpression = $__19.createCascadeExpression,
    createCommaExpression = $__19.createCommaExpression,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createMemberExpression = $__19.createMemberExpression,
    createMemberLookupExpression = $__19.createMemberLookupExpression,
    ...
    var $ErrorReporter = $__createClassNoExtends(
      {
        ...
        reportError: function (location, format) {
          for (var args = [], $__10 = 2; $__10 < arguments.length; $__10++)
...
var $___src_syntax_SourceFile_js = function () {
  ...
  var SourceFile = (function () {
    "use strict";
    var $SourceFile = $__createClassNoExtends(
      {
...
var $___src_codegeneration_PlaceholderParser_js = function () {
  ...
  var MutedErrorReporter =
    $___src_util_MutedErrorReporter_js.MutedErrorReporter;
  var ParseTree = $___src_syntax_trees_ParseTree_js.ParseTree;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var Parser = $___src_syntax_Parser_js.Parser;
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    PropertyMethodAssignment = $__19.PropertyMethodAssignment,
    PropertyNameAssignment = $__19.PropertyNameAssignment,
    PropertyNameShorthand = $__19.PropertyNameShorthand;
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createBindingIdentifier = $__19.createBindingIdentifier,
    createBlock = $__19.createBlock,
    createBooleanLiteral = $__19.createBooleanLiteral,
    createCommaExpression = $__19.createCommaExpression,
    createExpressionStatement = $__19.createExpressionStatement,
    createGetAccessor = $__19.createGetAccessor,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createIdentifierToken = $__19.createIdentifierToken,
    createMemberExpression = $__19.createMemberExpression,
    createNullLiteral = $__19.createNullLiteral,
    createNumberLiteral = $__19.createNumberLiteral,
    createParenExpression = $__19.createParenExpression,
    createSetAccessor = $__19.createSetAccessor,
    createStringLiteral = $__19.createStringLiteral,
    createVoid0 = $__19.createVoid0;
  var NOT_FOUND = {};
  var PREFIX = "$__placeholder__";
  var cache = new ArrayMap();
  function parseExpression(sourceLiterals) {
    for (var values = [], $__11 = 1; $__11 < arguments.length; $__11++)
      values[$__11 - 1] = arguments[$__11];
  ...
  function parseStatement(sourceLiterals) {
    for (var values = [], $__12 = 1; $__12 < arguments.length; $__12++)
      values[$__12 - 1] = arguments[$__12];
    return parse(sourceLiterals, values, function () {
      return new PlaceholderParser().parseStatement(sourceLiterals);
    });
  }
  function parsePropertyDefinition(sourceLiterals) {
    for (var values = [], $__13 = 1; $__13 < arguments.length; $__13++)
    ...
    var $PlaceholderTransformer = $__createClass(
      {
        ...
        transformExpressionStatement: function (tree) {
          ...
          return $__superCall(this, $__proto, "transformExpressionStatement", [
            tree,
          ]);
        },
        transformBlock: function (tree) {
        ...
        transformPropertyNameAssignment: function (tree) {
          ...
          return $__superCall(
            this,
            $__proto,
            "transformPropertyNameAssignment",
            [tree]
          );
        },
        transformPropertyNameShorthand: function (tree) {
          ...
          return $__superCall(
            this,
            $__proto,
            "transformPropertyNameShorthand",
            [tree]
          );
        },
        transformSetAccessor: function (tree) {
...
var $___src_codegeneration_SuperTransformer_js = function () {
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createStringLiteral = $__19.createStringLiteral,
    createThisExpression = $__19.createThisExpression;
  var $__19 = $___src_codegeneration_OperatorExpander_js,
    expandMemberExpression = $__19.expandMemberExpression,
    expandMemberLookupExpression = $__19.expandMemberLookupExpression;
  var parseExpression =
    $___src_codegeneration_PlaceholderParser_js.parseExpression;
    ...
    var $SuperTransformer = $__createClass(
      {
        ...
        transformFunction_: function (tree, constructor) {
          ...
          var transformedTree =
            constructor === FunctionExpression
              ? $__superCall(this, $__proto, "transformFunctionExpression", [
                  tree,
                ])
              : $__superCall(this, $__proto, "transformFunctionDeclaration", [
                  tree,
                ]);
          this.inNestedFunc_--;
        ...
        createSuperCallExpression: function (
          thisExpr,
          protoName,
          methodName,
          args
        ...
        get superGet_() {
          this.runtimeInliner_.register(
            "superDescriptor",
            SUPER_DESCRIPTOR_CODE
          );
        ...
        transformMemberLookupExpression: function (tree) {
          ...
          return $__superCall(
            this,
            $__proto,
            "transformMemberLookupExpression",
            [tree]
          );
        },
        transformBinaryOperator: function (tree) {
          if (
            ...
            if (tree.operator.type !== EQUAL) {
              if (tree.left.type === MEMBER_LOOKUP_EXPRESSION) {
                tree = expandMemberLookupExpression(
                  tree,
        ...
        reportError_: function (tree) {
          for (var args = [], $__14 = 1; $__14 < arguments.length; $__14++)
            args[$__14 - 1] = arguments[$__14];
          ($__25 = this.reporter_).reportError.apply(
            $__25,
            $__spread([tree.location.start], args)
          );
        },
      },
      {},
...
var $___src_codegeneration_ClassTransformer_js = function () {
  ...
  var $__2 = Object.freeze(
    ...
    $__0 = Object.freeze(
      Object.defineProperties(["constructor: function() {}"], {
  ...
  var SuperTransformer =
    $___src_codegeneration_SuperTransformer_js.SuperTransformer;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__19 = $___src_syntax_TokenType_js,
    LET = $__19.LET,
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createIdentifierExpression = $__19.createIdentifierExpression,
    createMemberExpression = $__19.createMemberExpression,
    createObjectLiteralExpression = $__19.createObjectLiteralExpression,
    createThisExpression = $__19.createThisExpression,
    createVariableStatement = $__19.createVariableStatement;
  var parseOptions = $___src_options_js.parseOptions;
  var $__19 = $___src_codegeneration_PlaceholderParser_js,
    ...
    var $ClassTransformer = $__createClass(
      {
        ...
        transformClassShared_: function (tree, name) {
          ...
          if (!hasConstructor) {
            protoElements.unshift(
              this.getDefaultConstructor_(tree, superClass, protoName)
            );
          }
        ...
        get getProtoParent_() {
          return this.runtimeInliner_.get(
            "getProtoParent",
            GET_PROTO_PARENT_CODE
          );
        },
        get createClassNoExtends_() {
          return this.runtimeInliner_.get(
            "createClassNoExtends",
        ...
        transformSuperInBlock_: function (methodTree, tree, protoName) {
          ...
          var thisDecl = createVariableStatement(
            VAR,
            thisName,
            createThisExpression()
          );
          var superTransformer = new SuperTransformer(
            this,
          ...
          var transformedTree = superTransformer.transformBlock(
            this.transformBlock(tree)
          );
          this.popTempVarState();
...
var $___src_codegeneration_CollectionTransformer_js = function () {
  "use strict";
  var $__19 = $___src_syntax_PredefinedName_js,
    ELEMENT_DELETE = $__19.ELEMENT_DELETE,
    ELEMENT_GET = $__19.ELEMENT_GET,
    ELEMENT_HAS = $__19.ELEMENT_HAS,
    ELEMENT_SET = $__19.ELEMENT_SET,
    RUNTIME = $__19.RUNTIME,
    TRACEUR_RUNTIME = $__19.TRACEUR_RUNTIME;
  var MEMBER_LOOKUP_EXPRESSION =
    $___src_syntax_trees_ParseTreeType_js.MEMBER_LOOKUP_EXPRESSION;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__19 = $___src_syntax_TokenType_js,
    DELETE = $__19.DELETE,
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createMemberExpression = $__19.createMemberExpression,
    createParenExpression = $__19.createParenExpression;
  var expandMemberLookupExpression =
    $___src_codegeneration_OperatorExpander_js.expandMemberLookupExpression;
    ...
    var $CollectionTransformer = $__createClass(
      {
        ...
        transformBinaryOperator: function (tree) {
          ...
          if (
            ...
            var operand = this.transformAny(tree.left.operand);
            var memberExpression = this.transformAny(
              tree.left.memberExpression
            );
            var value = this.transformAny(tree.right);
            return createCallExpression(
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new CollectionTransformer(identifierGenerator).transformAny(
            tree
          );
        },
      },
...
var $___src_codegeneration_DefaultParametersTransformer_js = function () {
  "use strict";
  var $__19 = $___src_semantics_util_js,
    isUndefined = $__19.isUndefined,
    isVoidExpression = $__19.isVoidExpression,
    isLiteralExpression = $__19.isLiteralExpression;
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    FormalParameterList = $__19.FormalParameterList,
    FunctionDeclaration = $__19.FunctionDeclaration,
    FunctionExpression = $__19.FunctionExpression;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  ...
  var $__19 = $___src_syntax_trees_ParseTreeType_js,
    ...
    UNARY_EXPRESSION = $__19.UNARY_EXPRESSION;
  var $__19 = $___src_syntax_TokenType_js,
    NOT_EQUAL_EQUAL = $__19.NOT_EQUAL_EQUAL,
    VAR = $__19.VAR,
    VOID = $__19.VOID;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createBinaryOperator = $__19.createBinaryOperator,
    createBlock = $__19.createBlock,
    createConditionalExpression = $__19.createConditionalExpression,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createMemberLookupExpression = $__19.createMemberLookupExpression,
    createNumberLiteral = $__19.createNumberLiteral,
    createOperatorToken = $__19.createOperatorToken,
  ...
  function createDefaultAssignment(index, binding, initializer) {
    var argumentsExpression = createMemberLookupExpression(
      createIdentifierExpression(ARGUMENTS),
    ...
    var $DefaultParametersTransformer = $__createClass(
      {
        ...
        transformFunction_: function (tree, constructor) {
          ...
          statements = prependStatements.apply(
            null,
            $__spread([transformedTree.functionBody.statements], statements)
          );
...
var $___src_codegeneration_DestructuringTransformer_js = function () {
  ...
  var $__19 = $___src_syntax_trees_ParseTreeType_js,
    ...
    VARIABLE_DECLARATION_LIST = $__19.VARIABLE_DECLARATION_LIST;
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    BindingElement = $__19.BindingElement,
    Catch = $__19.Catch,
    ForInStatement = $__19.ForInStatement,
    ForOfStatement = $__19.ForOfStatement,
    FunctionDeclaration = $__19.FunctionDeclaration,
    FunctionExpression = $__19.FunctionExpression,
  ...
  var Desugaring = (function () {
    "use strict";
    var $Desugaring = $__createClassNoExtends(
      {
        ...
        assign: function (lvalue, rvalue) {
          if (lvalue.type === BINDING_ELEMENT) {
            this.declarations.push(
              createVariableDeclaration(lvalue.binding, rvalue)
            );
            return;
          }
    ...
    var $DestructuringTransformer = $__createClass(
      {
        ...
        transformBinaryOperator: function (tree) {
          if (tree.operator.type == EQUAL && tree.left.isPattern()) {
            return this.transformAny(
              this.desugarAssignment_(tree.left, tree.right)
            );
          } else {
            return $__superCall(this, $__proto, "transformBinaryOperator", [
              tree,
        ...
        transformVariableDeclarationList: function (tree) {
          ...
          tree.declarations.forEach(
            function (declaration) {
              if (declaration.lvalue.isPattern()) {
                ($__26 = desugaredDeclarations).push.apply(
                  $__26,
                  $__toObject(this.desugarVariableDeclaration_(declaration))
                );
              } else {
        ...
        transformForInStatement: function (tree) {
          return this.transformForInOrOf_(
            tree,
            $__superGet(this, $__proto, "transformForInStatement"),
            ForInStatement
          );
        },
        transformForOfStatement: function (tree) {
          return this.transformForInOrOf_(
            tree,
            $__superGet(this, $__proto, "transformForOfStatement"),
            ForOfStatement
          );
        },
        transformForInOrOf_: function (tree, superMethod, constr) {
          ...
          var statements = [];
          var binding = this.desugarBinding_(
            lvalue,
            statements,
            declarationType
          );
        ...
        transformSetAccessor: function (tree) {
          stack.push([]);
          var transformedTree = $__superCall(
            this,
            $__proto,
          ...
          var statements = stack.pop();
          if (!statements.length) return transformedTree;
          ($__28 = statements).push.apply(
            $__28,
            $__toObject(transformedTree.body.statements)
          );
          return new SetAccessor(
            transformedTree.location,
        ...
        desugarVariableDeclaration_: function (tree) {
          ...
          switch (tree.initializer.type) {
            ...
            default:
              ...
              var initializerFound = this.desugarPattern_(
                desugaring,
                tree.lvalue
              );
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new DestructuringTransformer(identifierGenerator).transformAny(
            tree
          );
        },
      },
...
var $___src_codegeneration_ForOfTransformer_js = function () {
  ...
  var $__19 = $___src_syntax_PredefinedName_js,
    CLOSE = $__19.CLOSE,
    CURRENT = $__19.CURRENT,
    GET_ITERATOR = $__19.GET_ITERATOR,
    MOVE_NEXT = $__19.MOVE_NEXT,
    RUNTIME = $__19.RUNTIME,
    TRACEUR_RUNTIME = $__19.TRACEUR_RUNTIME;
  var VARIABLE_DECLARATION_LIST =
    $___src_syntax_trees_ParseTreeType_js.VARIABLE_DECLARATION_LIST;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var VAR = $___src_syntax_TokenType_js.VAR;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createBlock = $__19.createBlock,
    createCallExpression = $__19.createCallExpression,
    createCallStatement = $__19.createCallStatement,
    createExpressionStatement = $__19.createExpressionStatement,
    createFinally = $__19.createFinally,
    createIfStatement = $__19.createIfStatement,
    createIdentifierExpression = $__19.createIdentifierExpression,
    ...
    createTryStatement = $__19.createTryStatement,
    createVariableStatement = $__19.createVariableStatement,
    createWhileStatement = $__19.createWhileStatement;
  var parseStatement =
    $___src_codegeneration_PlaceholderParser_js.parseStatement;
    ...
    var $ForOfTransformer = $__createClass(
      {
        ...
        transformForOfStatement: function (original) {
          var tree = $__superCall(this, $__proto, "transformForOfStatement", [
            original,
          ]);
...
var $___src_semantics_FreeVariableChecker_js = function () {
  ...
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    ...
    IdentifierExpression = $__19.IdentifierExpression;
  var IdentifierToken = $___src_syntax_IdentifierToken_js.IdentifierToken;
  var IDENTIFIER_EXPRESSION =
    $___src_syntax_trees_ParseTreeType_js.IDENTIFIER_EXPRESSION;
  var ParseTreeVisitor = $___src_syntax_ParseTreeVisitor_js.ParseTreeVisitor;
    ...
    var $FreeVariableChecker = $__createClass(
      {
          ...
          for (var name in scope.references) {
            if (!(name in scope.declarations)) {
              ...
              if (!scope.parent) {
                if (!location) {
                  throw new Error(
                    "generated variable " + name + " is not defined"
                  );
                }
        ...
        reportError_: function () {
          for (var args = [], $__15 = 0; $__15 < arguments.length; $__15++)
...
var $___src_codegeneration_GeneratorComprehensionTransformer_js = function () {
  ...
  var ComprehensionTransformer =
    $___src_codegeneration_ComprehensionTransformer_js.ComprehensionTransformer;
  var createYieldStatement =
    $___src_codegeneration_ParseTreeFactory_js.createYieldStatement;
  ...
  GeneratorComprehensionTransformer.transformTree = function (
    identifierGenerator,
    tree
  ) {
    return new GeneratorComprehensionTransformer(
      identifierGenerator
    ).transformAny(tree);
  };
  return Object.preventExtensions(
...
var $___src_codegeneration_generator_State_js = function () {
  "use strict";
  var FINALLY_FALL_THROUGH =
    $___src_syntax_PredefinedName_js.FINALLY_FALL_THROUGH;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createAssignStateStatement = $__19.createAssignStateStatement,
    createAssignmentStatement = $__19.createAssignmentStatement,
    createBreakStatement = $__19.createBreakStatement,
    createCaseClause = $__19.createCaseClause,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createNumberLiteral = $__19.createNumberLiteral,
    createStatementList = $__19.createStatementList;
  var State = (function () {
    "use strict";
    var $State = $__createClassNoExtends(
      {
        ...
        transformMachineState: function (
          enclosingFinally,
          machineEndState,
          reporter
        ) {
        ...
        transformBreakOrContinue: function (
          labelSet,
          breakState,
          continueState
        ) {
  ...
  State.generateAssignStateOutOfFinally_ = function (
    destination,
    finallyState
  ) {
    return createStatementList(
...
var $___src_codegeneration_generator_BreakState_js = function () {
  ...
  var FallThroughState =
    $___src_codegeneration_generator_FallThroughState_js.FallThroughState;
  var State = $___src_codegeneration_generator_State_js.State;
  var createStatementList =
    $___src_codegeneration_ParseTreeFactory_js.createStatementList;
...
var $___src_codegeneration_generator_BreakContinueTransformer_js = function () {
  ...
  var ContinueState =
    $___src_codegeneration_generator_ContinueState_js.ContinueState;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
    ...
    var $FinallyFallThroughState = $__createClass(
      {
        ...
        transform: function (enclosingFinally, machineEndState, reporter) {
          throw new Error(
            "these are generated in addFinallyFallThroughDispatches"
          );
        },
      },
      {},
...
var $___src_codegeneration_generator_SwitchState_js = function () {
  "use strict";
  var $__19 = $___src_syntax_trees_ParseTrees_js,
    CaseClause = $__19.CaseClause,
    DefaultClause = $__19.DefaultClause,
    SwitchStatement = $__19.SwitchStatement;
  var State = $___src_codegeneration_generator_State_js.State;
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    createBreakStatement = $__19.createBreakStatement,
    createStatementList = $__19.createStatementList;
  var SwitchClause = (function () {
    "use strict";
    var $SwitchClause = $__createClassNoExtends(
      {
...
var $___src_codegeneration_generator_CPSTransformer_js = function () {
  ...
  var BreakContinueTransformer =
    $___src_codegeneration_generator_BreakContinueTransformer_js.BreakContinueTransformer;
  var $__19 = $___src_syntax_trees_ParseTreeType_js,
  ...
  var ConditionalState =
    $___src_codegeneration_generator_ConditionalState_js.ConditionalState;
  var FallThroughState =
    $___src_codegeneration_generator_FallThroughState_js.FallThroughState;
  var FinallyFallThroughState =
    $___src_codegeneration_generator_FinallyFallThroughState_js.FinallyFallThroughState;
  var FinallyState =
    $___src_codegeneration_generator_FinallyState_js.FinallyState;
  var IdentifierToken = $___src_syntax_IdentifierToken_js.IdentifierToken;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var parseStatement =
  ...
  var $__19 = $___src_syntax_PredefinedName_js,
    ...
    $THAT = $__19.$THAT,
    ARGUMENTS = $__19.ARGUMENTS,
    CAUGHT_EXCEPTION = $__19.CAUGHT_EXCEPTION,
    FINALLY_FALL_THROUGH = $__19.FINALLY_FALL_THROUGH,
    INNER_FUNCTION = $__19.INNER_FUNCTION,
    STATE = $__19.STATE,
    STORED_EXCEPTION = $__19.STORED_EXCEPTION,
    YIELD_ACTION = $__19.YIELD_ACTION,
    YIELD_SENT = $__19.YIELD_SENT;
  var State = $___src_codegeneration_generator_State_js.State;
  var StateAllocator =
    $___src_codegeneration_generator_StateAllocator_js.StateAllocator;
  var StateMachine = $___src_syntax_trees_StateMachine_js.StateMachine;
  var $__19 = $___src_codegeneration_generator_SwitchState_js,
  ...
  var $__19 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createCatch = $__19.createCatch,
    createCommaExpression = $__19.createCommaExpression,
    createDefaultClause = $__19.createDefaultClause,
    createEmptyStatement = $__19.createEmptyStatement,
    createExpressionStatement = $__19.createExpressionStatement,
    createFunctionExpression = $__19.createFunctionExpression,
    createIdentifierExpression = $__19.createIdentifierExpression,
    createNumberLiteral = $__19.createNumberLiteral,
    createOperatorToken = $__19.createOperatorToken,
    createParameterList = $__19.createParameterList,
    createStatementList = $__19.createStatementList,
    createStringLiteral = $__19.createStringLiteral,
    createSwitchStatement = $__19.createSwitchStatement,
    createThisExpression = $__19.createThisExpression,
    createThrowStatement = $__19.createThrowStatement,
    createTrueLiteral = $__19.createTrueLiteral,
    createTryStatement = $__19.createTryStatement,
    createVariableStatement = $__19.createVariableStatement,
    createWhileStatement = $__19.createWhileStatement;
    ...
    var $CPSTransformer = $__createClass(
      {
        ...
        transformBlock: function (tree) {
          this.clearLabels_();
          var transformedTree = $__superCall(this, $__proto, "transformBlock", [
            tree,
          ]);
          var machine = this.transformStatementList_(
            transformedTree.statements
          );
        ...
        transformStatementList_: function (someTransformed) {
          ...
          for (var index = 1; index < someTransformed.length; index++) {
            currentMachine = this.createSequence_(
              currentMachine,
        ...
        transformCaseClause: function (tree) {
          var result = $__superCall(this, $__proto, "transformCaseClause", [
            tree,
          ]);
        ...
        transformForStatement: function (tree) {
          var labels = this.clearLabels_();
          var result = $__superCall(this, $__proto, "transformForStatement", [
            tree,
          ]);
          if (result.body.type != STATE_MACHINE) {
            return result;
          ...
          var conditionState =
            result.increment == null && result.condition != null
              ...
              : this.allocateState();
          var startState =
            result.initializer == null ? conditionState : this.allocateState();
          var fallThroughState = this.allocateState();
          var states = [];
          ...
          if (result.increment != null) {
            states.push(
              new FallThroughState(
                incrementState,
                conditionState,
                createStatementList(createExpressionStatement(result.increment))
              )
            );
          }
          this.addLoopBodyStates_(
        ...
        transformIfStatement: function (tree) {
          this.clearLabels_();
          var result = $__superCall(this, $__proto, "transformIfStatement", [
            tree,
          ]);
          if (
            result.ifClause.type != STATE_MACHINE &&
          ...
          ($__33 = exceptionBlocks).push.apply(
            $__33,
            $__toObject(ifClause.exceptionBlocks)
          );
          if (elseClause != null) {
            ...
            ($__34 = exceptionBlocks).push.apply(
              $__34,
              $__toObject(
        ...
        removeEmptyStates: function (oldStates) {
          ...
          for (i = 0; i < newStates.length; i++) {
            newStates[i] = emptyStates.reduce(function (state, $__19) {
              var id = $__19.id,
                fallThroughState = $__19.fallThroughState;
              return state.replaceState(id, fallThroughState);
            }, newStates[i]);
          }
          return newStates;
        },
        replaceAndAddStates_: function (
          oldStates,
          oldState,
          newState,
          newStates
        ...
        addSwitchClauseStates_: function (
          nextState,
          fallThroughState,
          labels,
          statements,
          ...
          for (var i = 0; i < machine.states.length; i++) {
            ...
            var transformedState = state.transformBreak(
              labels,
              fallThroughState
            );
            states.push(
          ...
          ($__35 = tryStates).push.apply(
            $__35,
            $__toObject(machine.exceptionBlocks)
          );
          return machine.startState;
        },
        transformTryStatement: function (tree) {
          this.clearLabels_();
          var result = $__superCall(this, $__proto, "transformTryStatement", [
            tree,
          ]);
          if (
            result.body.type != STATE_MACHINE &&
          ...
          if (result.finallyBlock != null) {
            ...
            var startState = tryMachine.startState;
            var fallThroughState = tryMachine.fallThroughState;
            var states = $__spread(tryMachine.states, finallyMachine.states, [
        ...
        transformVariableStatement: function (tree) {
          var declarations = this.transformVariableDeclarationList(
            tree.declarations
          );
          if (declarations == tree.declarations) {
            return tree;
        ...
        transformWhileStatement: function (tree) {
          var labels = this.clearLabels_();
          var result = $__superCall(this, $__proto, "transformWhileStatement", [
            tree,
          ]);
          if (result.body.type != STATE_MACHINE) {
            return result;
        ...
        transformWithStatement: function (tree) {
          var result = $__superCall(this, $__proto, "transformWithStatement", [
            tree,
          ]);
          if (result.body.type != STATE_MACHINE) {
            return result;
        ...
        generateMachine: function (machine) {
          ...
          caseClauses.push(
            createDefaultClause(
              this.machineUncaughtExceptionStatements(
                State.RETHROW_STATE,
                State.END_STATE
              )
            )
        ...
        transformMachineStates: function (
          machine,
          machineEndState,
          rethrowState,
          enclosingFinallyState
        ...
        addFinallyFallThroughDispatches: function (
          enclosingFinallyState,
          tryStates,
          cases
        ) {
          for (var i = 0; i < tryStates.length; i++) {
            ...
            if (tryState.kind == TryState.Kind.FINALLY) {
              ...
              if (enclosingFinallyState != null) {
                ...
                for (
                  var j = 0;
                  j < enclosingFinallyState.tryStates.length;
                  j++
                ) {
        ...
        maybeTransformStatement_: function (maybeTransformedStatement) {
          if (
            maybeTransformedStatement.type == VARIABLE_STATEMENT &&
            maybeTransformedStatement.declarations.declarationType != VAR
          ) {
          ...
          var breakContinueTransformed = new BreakContinueTransformer(
            this.stateAllocator_
          ).transformAny(maybeTransformedStatement);
          if (breakContinueTransformed != maybeTransformedStatement) {
            breakContinueTransformed = this.transformAny(
              breakContinueTransformed
            );
          }
        ...
        ensureTransformedList_: function (statements) {
          ...
          for (var i = 0; i < statements.length; i++) {
            ...
            var maybeTransformedStatement =
              this.maybeTransformStatement_(statement);
...
var $___src_codegeneration_generator_AsyncTransformer_js = function () {
  ...
  var CPSTransformer =
    $___src_codegeneration_generator_CPSTransformer_js.CPSTransformer;
  var EndState = $___src_codegeneration_generator_EndState_js.EndState;
  var FallThroughState =
    $___src_codegeneration_generator_FallThroughState_js.FallThroughState;
  var $__20 = $___src_syntax_PredefinedName_js,
    $VALUE = $__20.$VALUE,
    CALLBACK = $__20.CALLBACK,
    CONTINUATION = $__20.CONTINUATION,
    CREATE_CALLBACK = $__20.CREATE_CALLBACK,
    CREATE_ERRBACK = $__20.CREATE_ERRBACK,
    CREATE_PROMISE = $__20.CREATE_PROMISE,
    DEFERRED = $__20.DEFERRED,
    ERR = $__20.ERR,
    ERRBACK = $__20.ERRBACK,
    NEW_STATE = $__20.NEW_STATE,
    RESULT = $__20.RESULT,
    STATE = $__20.STATE,
    STORED_EXCEPTION = $__20.STORED_EXCEPTION,
    THEN = $__20.THEN,
    WAIT_TASK = $__20.WAIT_TASK;
  var STATE_MACHINE = $___src_syntax_trees_ParseTreeType_js.STATE_MACHINE;
  var parseStatement =
    $___src_codegeneration_PlaceholderParser_js.parseStatement;
  var StateMachine = $___src_syntax_trees_StateMachine_js.StateMachine;
  var VAR = $___src_syntax_TokenType_js.VAR;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    createAssignStateStatement = $__20.createAssignStateStatement,
    createAssignmentStatement = $__20.createAssignmentStatement,
    createBlock = $__20.createBlock,
    createBreakStatement = $__20.createBreakStatement,
    createCallExpression = $__20.createCallExpression,
    createCallStatement = $__20.createCallStatement,
    createEmptyArgumentList = $__20.createEmptyArgumentList,
    createFunctionExpression = $__20.createFunctionExpression,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createMemberExpression = $__20.createMemberExpression,
    createNewExpression = $__20.createNewExpression,
    createNumberLiteral = $__20.createNumberLiteral,
    createParameterList = $__20.createParameterList,
    createParameterReference = $__20.createParameterReference,
    createReturnStatement = $__20.createReturnStatement,
    createStatementList = $__20.createStatementList,
    createThrowStatement = $__20.createThrowStatement,
    createUndefinedExpression = $__20.createUndefinedExpression,
    createVariableStatement = $__20.createVariableStatement;
    ...
    var $AsyncTransformer = $__createClass(
      {
        ...
        transformAwaitStatement: function (tree) {
            ...
            new FallThroughState(
              ...
              createStatementList(
                ...
                createCallStatement(
                  ...
                  createArgumentList(
                    createCallExpression(
                      createIdentifierExpression(CREATE_CALLBACK),
                      createArgumentList(createNumberLiteral(callbackState))
                    ),
                    createCallExpression(
                      createIdentifierExpression(CREATE_ERRBACK),
          ...
          states.push(
            new FallThroughState(callbackState, fallThroughState, assignment)
          );
          states.push(
            new FallThroughState(
              errbackState,
        ...
        transformReturnStatement: function (tree) {
          ...
          var completeState = new FallThroughState(
            startState,
            endState,
        ...
        createCompleteTask_: function (result) {
          return createCallStatement(
            createMemberExpression(RESULT, CALLBACK),
        ...
        transformAsyncBody: function (tree) {
          ...
          ($__36 = statements).push.apply(
            $__36,
            $__toObject(this.getMachineVariables(tree, machine))
          );
        ...
        machineUncaughtExceptionStatements: function (
          rethrowState,
          machineEndState
        ) {
          return createStatementList(
...
var $___src_codegeneration_generator_ForInTransformPass_js = function () {
  "use strict";
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    BLOCK = $__20.BLOCK,
    VARIABLE_DECLARATION_LIST = $__20.VARIABLE_DECLARATION_LIST,
    IDENTIFIER_EXPRESSION = $__20.IDENTIFIER_EXPRESSION;
  var $__20 = $___src_syntax_PredefinedName_js,
    LENGTH = $__20.LENGTH,
    PUSH = $__20.PUSH;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__20 = $___src_syntax_TokenType_js,
    BANG = $__20.BANG,
    IN = $__20.IN,
    OPEN_ANGLE = $__20.OPEN_ANGLE,
    PLUS_PLUS = $__20.PLUS_PLUS,
    VAR = $__20.VAR;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    createAssignmentStatement = $__20.createAssignmentStatement,
    createBinaryOperator = $__20.createBinaryOperator,
    createBlock = $__20.createBlock,
    createCallStatement = $__20.createCallStatement,
    createContinueStatement = $__20.createContinueStatement,
    createEmptyArrayLiteralExpression = $__20.createEmptyArrayLiteralExpression,
    createForInStatement = $__20.createForInStatement,
    createForStatement = $__20.createForStatement,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createIfStatement = $__20.createIfStatement,
    createMemberExpression = $__20.createMemberExpression,
    createMemberLookupExpression = $__20.createMemberLookupExpression,
    createNumberLiteral = $__20.createNumberLiteral,
    createOperatorToken = $__20.createOperatorToken,
    createParenExpression = $__20.createParenExpression,
    createPostfixExpression = $__20.createPostfixExpression,
    createUnaryExpression = $__20.createUnaryExpression,
    createVariableDeclarationList = $__20.createVariableDeclarationList,
    createVariableStatement = $__20.createVariableStatement;
    ...
    var $ForInTransformPass = $__createClass(
      {
        ...
        transformForInStatement: function (original) {
          ...
          var body = this.transformAny(tree.body);
          if (body.type == BLOCK) {
            ($__37 = bodyStatements).push.apply(
              $__37,
              $__toObject(body.statements)
            );
          } else {
          ...
          elements.push(
            createVariableStatement(VAR, collection, tree.collection)
          );
          ...
          if (tree.initializer.type == VARIABLE_DECLARATION_LIST) {
            ...
            originalKey = createIdentifierExpression(
              decList.declarations[0].lvalue
            );
            ...
            assignOriginalKey = createAssignmentStatement(
              tree.initializer,
              lookup
            );
          } else {
...
var $___src_codegeneration_generator_YieldState_js = function () {
  ...
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createMemberExpression = $__20.createMemberExpression,
    createReturnStatement = $__20.createReturnStatement,
    createThisExpression = $__20.createThisExpression,
    createTrueLiteral = $__20.createTrueLiteral;
...
var $___src_codegeneration_generator_ReturnState_js = function () {
  "use strict";
  var $__20 = $___src_semantics_util_js,
    isUndefined = $__20.isUndefined,
    isVoidExpression = $__20.isVoidExpression;
  var $__20 = $___src_syntax_PredefinedName_js,
    CURRENT = $__20.CURRENT,
    RESULT = $__20.RESULT,
    UNDEFINED = $__20.UNDEFINED,
    YIELD_RETURN = $__20.YIELD_RETURN;
  var IDENTIFIER_EXPRESSION =
    $___src_syntax_trees_ParseTreeType_js.IDENTIFIER_EXPRESSION;
...
var $___src_codegeneration_generator_GeneratorTransformer_js = function () {
  ...
  var $__0 = Object.freeze(
    ...
    $__3 = Object.freeze(
      Object.defineProperties(["return ", "(", ");"], {
  ...
  var EndState = $___src_codegeneration_generator_EndState_js.EndState;
  var $__20 = $___src_syntax_PredefinedName_js,
    ACTION_SEND = $__20.ACTION_SEND,
    ACTION_THROW = $__20.ACTION_THROW,
    ACTION_CLOSE = $__20.ACTION_CLOSE,
    ADD_ITERATOR = $__20.ADD_ITERATOR,
    CURRENT = $__20.CURRENT,
    MOVE_NEXT = $__20.MOVE_NEXT,
    RESULT = $__20.RESULT,
    RUNTIME = $__20.RUNTIME,
    STORED_EXCEPTION = $__20.STORED_EXCEPTION,
    TRACEUR_RUNTIME = $__20.TRACEUR_RUNTIME,
    YIELD_RETURN = $__20.YIELD_RETURN;
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    STATE_MACHINE = $__20.STATE_MACHINE,
    YIELD_EXPRESSION = $__20.YIELD_EXPRESSION;
  var parseStatement =
    $___src_codegeneration_PlaceholderParser_js.parseStatement;
  var StateMachine = $___src_syntax_trees_StateMachine_js.StateMachine;
  var VAR = $___src_syntax_TokenType_js.VAR;
  ...
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    ...
    createAssignmentStatement = $__20.createAssignmentStatement,
    createBlock = $__20.createBlock,
    createExpressionStatement = $__20.createExpressionStatement,
    createFalseLiteral = $__20.createFalseLiteral,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createMemberExpression = $__20.createMemberExpression,
    createNumberLiteral = $__20.createNumberLiteral,
...
var $___src_codegeneration_GeneratorTransformPass_js = function () {
  ...
  var AsyncTransformer =
    $___src_codegeneration_generator_AsyncTransformer_js.AsyncTransformer;
  var ForInTransformPass =
    $___src_codegeneration_generator_ForInTransformPass_js.ForInTransformPass;
  var ForOfTransformer =
    $___src_codegeneration_ForOfTransformer_js.ForOfTransformer;
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    GetAccessor = $__20.GetAccessor,
    SetAccessor = $__20.SetAccessor;
  var GeneratorTransformer =
    $___src_codegeneration_generator_GeneratorTransformer_js.GeneratorTransformer;
  var ParseTreeVisitor = $___src_syntax_ParseTreeVisitor_js.ParseTreeVisitor;
  var parseStatement =
    $___src_codegeneration_PlaceholderParser_js.parseStatement;
  var TempVarTransformer =
  ...
  var $__20 = $___src_syntax_TokenType_js,
    ...
    VAR = $__20.VAR;
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    BINARY_OPERATOR = $__20.BINARY_OPERATOR,
    COMMA_EXPRESSION = $__20.COMMA_EXPRESSION,
    IDENTIFIER_EXPRESSION = $__20.IDENTIFIER_EXPRESSION,
    PAREN_EXPRESSION = $__20.PAREN_EXPRESSION,
    YIELD_EXPRESSION = $__20.YIELD_EXPRESSION;
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    FunctionDeclaration = $__20.FunctionDeclaration,
    FunctionExpression = $__20.FunctionExpression;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createAssignmentExpression = $__20.createAssignmentExpression,
    createAssignmentStatement = $__20.createAssignmentStatement,
    createBlock = $__20.createBlock,
    createCommaExpression = $__20.createCommaExpression,
    createExpressionStatement = $__20.createExpressionStatement,
    createForOfStatement = $__20.createForOfStatement,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createVariableDeclaration = $__20.createVariableDeclaration,
    createVariableDeclarationList = $__20.createVariableDeclarationList,
    createVariableStatement = $__20.createVariableStatement,
    createYieldStatement = $__20.createYieldStatement;
  var $__20 = $___src_syntax_PredefinedName_js,
    ACTION_SEND = $__20.ACTION_SEND,
    ACTION_THROW = $__20.ACTION_THROW,
    ACTION_CLOSE = $__20.ACTION_CLOSE,
    TRACEUR_RUNTIME = $__20.TRACEUR_RUNTIME,
    YIELD_ACTION = $__20.YIELD_ACTION,
    YIELD_SENT = $__20.YIELD_SENT;
  var $__20 = $___src_options_js,
    transformOptions = $__20.transformOptions,
    options = $__20.options;
    ...
    var $YieldExpressionTransformer = $__createClass(
      {
        ...
        transformExpressionStatement: function (tree) {
          ...
          function commaWrap(lhs, rhs) {
            return createExpressionStatement(
              createCommaExpression(
                $__spread([createAssignmentExpression(lhs, rhs)], ex.slice(1))
              )
            );
          }
          switch (e.type) {
        ...
        transformVariableStatement: function (tree) {
          ...
          function isYieldVarAssign(tree) {
            return (
              tree.initializer && tree.initializer.type === YIELD_EXPRESSION
            );
          }
          function varWrap(lhs, rhs) {
            return createVariableStatement(
              createVariableDeclarationList(
                ...
                $__spread([createVariableDeclaration(lhs, rhs)], tdd.slice(1))
              )
            );
          }
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new YieldExpressionTransformer(
            identifierGenerator
          ).transformAny(tree);
        },
      },
    ...
    var $GeneratorTransformPass = $__createClass(
      {
        ...
        transformBody_: function (tree, isGenerator) {
          ...
          if (
            ...
            body = ForInTransformPass.transformTree(
...
var $___src_codegeneration_ModuleTransformer_js = function () {
  "use strict";
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    BindingElement = $__20.BindingElement,
    BindingIdentifier = $__20.BindingIdentifier,
    LiteralExpression = $__20.LiteralExpression,
    ObjectPattern = $__20.ObjectPattern,
    ObjectPatternField = $__20.ObjectPatternField,
    Program = $__20.Program;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var $__20 = $___src_syntax_PredefinedName_js,
    GET_MODULE_INSTANCE_BY_URL = $__20.GET_MODULE_INSTANCE_BY_URL,
    TRACEUR_MODULES = $__20.TRACEUR_MODULES;
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    CLASS_DECLARATION = $__20.CLASS_DECLARATION,
    EXPORT_DECLARATION = $__20.EXPORT_DECLARATION,
    EXPORT_MAPPING_LIST = $__20.EXPORT_MAPPING_LIST,
    EXPORT_SPECIFIER = $__20.EXPORT_SPECIFIER,
    EXPORT_STAR = $__20.EXPORT_STAR,
    FUNCTION_DECLARATION = $__20.FUNCTION_DECLARATION,
    IDENTIFIER_EXPRESSION = $__20.IDENTIFIER_EXPRESSION,
    IMPORT_DECLARATION = $__20.IMPORT_DECLARATION,
    MODULE_DECLARATION = $__20.MODULE_DECLARATION,
    MODULE_DEFINITION = $__20.MODULE_DEFINITION,
    MODULE_REQUIRE = $__20.MODULE_REQUIRE,
    VARIABLE_STATEMENT = $__20.VARIABLE_STATEMENT;
  var $__20 = $___src_syntax_TokenType_js,
    STAR = $__20.STAR,
    VAR = $__20.VAR;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    createBindingIdentifier = $__20.createBindingIdentifier,
    createBlock = $__20.createBlock,
    createCallExpression = $__20.createCallExpression,
    createEmptyParameterList = $__20.createEmptyParameterList,
    createExpressionStatement = $__20.createExpressionStatement,
    createFunctionExpression = $__20.createFunctionExpression,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createIdentifierToken = $__20.createIdentifierToken,
    createMemberExpression = $__20.createMemberExpression,
    createNullLiteral = $__20.createNullLiteral,
    createObjectCreate = $__20.createObjectCreate,
    createObjectLiteralExpression = $__20.createObjectLiteralExpression,
    createObjectPreventExtensions = $__20.createObjectPreventExtensions,
    createProgram = $__20.createProgram,
    createPropertyDescriptor = $__20.createPropertyDescriptor,
    createPropertyNameAssignment = $__20.createPropertyNameAssignment,
    createReturnStatement = $__20.createReturnStatement,
    createScopedExpression = $__20.createScopedExpression,
    createUseStrictDirective = $__20.createUseStrictDirective,
    createVariableDeclaration = $__20.createVariableDeclaration,
    createVariableDeclarationList = $__20.createVariableDeclarationList,
    createVariableStatement = $__20.createVariableStatement;
  ...
  function getGetterExport(project, symbol) {
    ...
    switch (tree.type) {
      case EXPORT_SPECIFIER:
        returnExpression = transformSpecifier(
          project,
          tree.lhs,
          symbol.relatedTree
        );
      ...
      case EXPORT_STAR:
        ...
        returnExpression = transformSpecifier(
          project,
          createIdentifierToken(symbol.name),
          symbol.relatedTree
        );
        break;
      case IDENTIFIER_EXPRESSION:
    ...
    var fun = createFunctionExpression(
      createEmptyParameterList(),
      createBlock(createReturnStatement(returnExpression))
    );
  ...
  function transformSpecifier(project, identifierToken, moduleExpression) {
    if (moduleExpression) {
      var operand = new ModuleTransformer(project).transformAny(
        moduleExpression
      );
    ...
    var $ModuleTransformer = $__createClass(
      {
        ...
        transformModuleExpression: function (tree) {
          ...
          if (reference.type == MODULE_REQUIRE) {
            return createCallExpression(
              ...
              createArgumentList(new LiteralExpression(null, reference.url))
            );
          }
        ...
        transformImportSpecifierSet: function (tree) {
          ...
          if (tree.specifiers.type === STAR) {
            ...
            var fields = module.getExports().map(function (exportSymbol) {
              return new BindingElement(
                tree.location,
                createBindingIdentifier(exportSymbol.name),
                null
              );
            });
          } else {
        ...
        transformImportSpecifier: function (tree) {
          ...
          return new BindingElement(
            tree.location,
            createBindingIdentifier(tree.lhs),
            null
          );
        },
      },
  ...
  ModuleTransformer.transformAsModule = function (project, module, tree) {
    var callExpression = transformModuleElements(
      project,
      module,
  ...
  function transformModuleElements(project, module, elements, useStrictCount) {
    ...
    elements.forEach(function (element) {
      switch (element.type) {
        ...
        case MODULE_DEFINITION:
          statements.push(
            transformDefinition(project, module, element, useStrictCount + 1)
          );
          break;
        case EXPORT_DECLARATION:
          ...
          switch (declaration.type) {
            ...
            case MODULE_DECLARATION:
              statements.push(
                transformDeclaration(project, module, declaration)
              );
              break;
...
var $___src_codegeneration_ObjectLiteralTransformer_js = function () {
  ...
  var FindVisitor = $___src_codegeneration_FindVisitor_js.FindVisitor;
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    FormalParameterList = $__20.FormalParameterList,
    FunctionExpression = $__20.FunctionExpression,
    IdentifierExpression = $__20.IdentifierExpression,
    LiteralExpression = $__20.LiteralExpression;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__20 = $___src_syntax_TokenType_js,
    AT_NAME = $__20.AT_NAME,
    IDENTIFIER = $__20.IDENTIFIER,
    STRING = $__20.STRING;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createAssignmentExpression = $__20.createAssignmentExpression,
    createCommaExpression = $__20.createCommaExpression,
    createDefineProperty = $__20.createDefineProperty,
    createEmptyParameterList = $__20.createEmptyParameterList,
    createFunctionExpression = $__20.createFunctionExpression,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createObjectCreate = $__20.createObjectCreate,
    ...
    createParenExpression = $__20.createParenExpression,
    createPropertyNameAssignment = $__20.createPropertyNameAssignment,
    createStringLiteral = $__20.createStringLiteral;
    ...
    var $ObjectLiteralTransformer = $__createClass(
      {
        ...
        transformObjectLiteralExpression: function (tree) {
          ...
          try {
            ...
            var tempVar = this.addTempVar();
            var tempVarIdentifierExpression =
              createIdentifierExpression(tempVar);
            var expressions = properties.map(
              function (property) {
                var name = property[0];
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new ObjectLiteralTransformer(identifierGenerator).transformAny(
            tree
          );
        },
      },
    ...
    var $ObjectMap = $__createClassNoExtends(
      {
        ...
        keys: function () {
          return Object.keys(this.keys_).map(
            function (uid) {
        ...
        values: function () {
          return Object.keys(this.values_).map(
            function (uid) {
...
var $___src_outputgeneration_ParseTreeWriter_js = function () {
  ...
  var $__20 = $___src_syntax_PredefinedName_js,
    ...
    OF = $__20.OF,
    MODULE = $__20.MODULE,
    REQUIRES = $__20.REQUIRES,
    SET = $__20.SET;
  var Token = $___src_syntax_Token_js.Token;
  var getKeywordType = $___src_syntax_Keywords_js.getKeywordType;
  var $__20 = $___src_syntax_TokenType_js,
    AMPERSAND = $__20.AMPERSAND,
    AMPERSAND_EQUAL = $__20.AMPERSAND_EQUAL,
    AND = $__20.AND,
    ARROW = $__20.ARROW,
    AT_NAME = $__20.AT_NAME,
    AWAIT = $__20.AWAIT,
    BACK_QUOTE = $__20.BACK_QUOTE,
    BANG = $__20.BANG,
    BAR = $__20.BAR,
    BAR_EQUAL = $__20.BAR_EQUAL,
    BREAK = $__20.BREAK,
    CARET = $__20.CARET,
    CARET_EQUAL = $__20.CARET_EQUAL,
    CASE = $__20.CASE,
    CATCH = $__20.CATCH,
    CLASS = $__20.CLASS,
    CLOSE_ANGLE = $__20.CLOSE_ANGLE,
    CLOSE_CURLY = $__20.CLOSE_CURLY,
    CLOSE_PAREN = $__20.CLOSE_PAREN,
    CLOSE_SQUARE = $__20.CLOSE_SQUARE,
    COLON = $__20.COLON,
    COMMA = $__20.COMMA,
    CONST = $__20.CONST,
    CONTINUE = $__20.CONTINUE,
    DEBUGGER = $__20.DEBUGGER,
    DEFAULT = $__20.DEFAULT,
    DELETE = $__20.DELETE,
    DO = $__20.DO,
    DOLLAR = $__20.DOLLAR,
    DOT_DOT_DOT = $__20.DOT_DOT_DOT,
    ELSE = $__20.ELSE,
    END_OF_FILE = $__20.END_OF_FILE,
    ENUM = $__20.ENUM,
    EQUAL = $__20.EQUAL,
    EQUAL_EQUAL = $__20.EQUAL_EQUAL,
    EQUAL_EQUAL_EQUAL = $__20.EQUAL_EQUAL_EQUAL,
    ERROR = $__20.ERROR,
    EXPORT = $__20.EXPORT,
    EXTENDS = $__20.EXTENDS,
    FALSE = $__20.FALSE,
    FINALLY = $__20.FINALLY,
    FOR = $__20.FOR,
    FUNCTION = $__20.FUNCTION,
    GREATER_EQUAL = $__20.GREATER_EQUAL,
    IDENTIFIER = $__20.IDENTIFIER,
    IF = $__20.IF,
    IMPLEMENTS = $__20.IMPLEMENTS,
    IMPORT = $__20.IMPORT,
    IN = $__20.IN,
    INSTANCEOF = $__20.INSTANCEOF,
    INTERFACE = $__20.INTERFACE,
    LEFT_SHIFT = $__20.LEFT_SHIFT,
    LEFT_SHIFT_EQUAL = $__20.LEFT_SHIFT_EQUAL,
    LESS_EQUAL = $__20.LESS_EQUAL,
    LET = $__20.LET,
    MINUS = $__20.MINUS,
    MINUS_EQUAL = $__20.MINUS_EQUAL,
    MINUS_MINUS = $__20.MINUS_MINUS,
    NEW = $__20.NEW,
    NO_SUBSTITUTION_TEMPLATE = $__20.NO_SUBSTITUTION_TEMPLATE,
    NOT_EQUAL = $__20.NOT_EQUAL,
    NOT_EQUAL_EQUAL = $__20.NOT_EQUAL_EQUAL,
    NULL = $__20.NULL,
    NUMBER = $__20.NUMBER,
    OPEN_ANGLE = $__20.OPEN_ANGLE,
    OPEN_CURLY = $__20.OPEN_CURLY,
    OPEN_PAREN = $__20.OPEN_PAREN,
    OPEN_SQUARE = $__20.OPEN_SQUARE,
    OR = $__20.OR,
    PACKAGE = $__20.PACKAGE,
    PERCENT = $__20.PERCENT,
    PERCENT_EQUAL = $__20.PERCENT_EQUAL,
    PERIOD = $__20.PERIOD,
    PERIOD_OPEN_CURLY = $__20.PERIOD_OPEN_CURLY,
    PLUS = $__20.PLUS,
    PLUS_EQUAL = $__20.PLUS_EQUAL,
    PLUS_PLUS = $__20.PLUS_PLUS,
    PRIVATE = $__20.PRIVATE,
    PROTECTED = $__20.PROTECTED,
    PUBLIC = $__20.PUBLIC,
    QUESTION = $__20.QUESTION,
    REGULAR_EXPRESSION = $__20.REGULAR_EXPRESSION,
    RETURN = $__20.RETURN,
    RIGHT_SHIFT = $__20.RIGHT_SHIFT,
    RIGHT_SHIFT_EQUAL = $__20.RIGHT_SHIFT_EQUAL,
    SEMI_COLON = $__20.SEMI_COLON,
    SLASH = $__20.SLASH,
    SLASH_EQUAL = $__20.SLASH_EQUAL,
    STAR = $__20.STAR,
    STAR_EQUAL = $__20.STAR_EQUAL,
    STATIC = $__20.STATIC,
    STRING = $__20.STRING,
    SUPER = $__20.SUPER,
    SWITCH = $__20.SWITCH,
    TEMPLATE_HEAD = $__20.TEMPLATE_HEAD,
    TEMPLATE_MIDDLE = $__20.TEMPLATE_MIDDLE,
    TEMPLATE_TAIL = $__20.TEMPLATE_TAIL,
    THIS = $__20.THIS,
    THROW = $__20.THROW,
    TILDE = $__20.TILDE,
    TRUE = $__20.TRUE,
    TRY = $__20.TRY,
    TYPEOF = $__20.TYPEOF,
    UNSIGNED_RIGHT_SHIFT = $__20.UNSIGNED_RIGHT_SHIFT,
    UNSIGNED_RIGHT_SHIFT_EQUAL = $__20.UNSIGNED_RIGHT_SHIFT_EQUAL,
    VAR = $__20.VAR,
    VOID = $__20.VOID,
    WHILE = $__20.WHILE,
    WITH = $__20.WITH,
    ...
    var $ParseTreeWriter = $__createClass(
      {
        ...
        visitAny: function (tree) {
          ...
          if (
            tree.location !== null &&
            tree.location.start !== null &&
            this.showLineNumbers_
          ) {
        ...
        needsSpace_: function (token) {
          ...
          if (
            this.lastToken_.type === REGULAR_EXPRESSION &&
          ...
          if (
            ((lastValue == PLUS || lastValue == PLUS_PLUS) &&
...
var $___src_outputgeneration_ParseTreeMapWriter_js = function () {
  "use strict";
  var ParseTreeWriter =
    $___src_outputgeneration_ParseTreeWriter_js.ParseTreeWriter;
...
var $___src_outputgeneration_TreeWriter_js = function () {
  "use strict";
  var ParseTreeMapWriter =
    $___src_outputgeneration_ParseTreeMapWriter_js.ParseTreeMapWriter;
  var ParseTreeWriter =
    $___src_outputgeneration_ParseTreeWriter_js.ParseTreeWriter;
  var TreeWriter = (function () {
    "use strict";
    var $TreeWriter = $__createClassNoExtends(
      { constructor: function () {} },
      {}
    );
    return $TreeWriter;
...
var $___src_syntax_ParseTreeValidator_js = function () {
  ...
  var $__20 = $___src_syntax_TokenType_js,
    ...
    UNSIGNED_RIGHT_SHIFT_EQUAL = $__20.UNSIGNED_RIGHT_SHIFT_EQUAL;
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    ARRAY_PATTERN = $__20.ARRAY_PATTERN,
    BINDING_ELEMENT = $__20.BINDING_ELEMENT,
    BINDING_IDENTIFIER = $__20.BINDING_IDENTIFIER,
    BLOCK = $__20.BLOCK,
    CASE_CLAUSE = $__20.CASE_CLAUSE,
    CATCH = $__20.CATCH,
    CLASS_DECLARATION = $__20.CLASS_DECLARATION,
    DEFAULT_CLAUSE = $__20.DEFAULT_CLAUSE,
    EXPORT_DECLARATION = $__20.EXPORT_DECLARATION,
    EXPORT_MAPPING = $__20.EXPORT_MAPPING,
    EXPORT_MAPPING_LIST = $__20.EXPORT_MAPPING_LIST,
    EXPORT_SPECIFIER = $__20.EXPORT_SPECIFIER,
    EXPORT_SPECIFIER_SET = $__20.EXPORT_SPECIFIER_SET,
    EXPORT_STAR = $__20.EXPORT_STAR,
    FINALLY = $__20.FINALLY,
    FORMAL_PARAMETER_LIST = $__20.FORMAL_PARAMETER_LIST,
    FUNCTION_DECLARATION = $__20.FUNCTION_DECLARATION,
    GET_ACCESSOR = $__20.GET_ACCESSOR,
    IDENTIFIER_EXPRESSION = $__20.IDENTIFIER_EXPRESSION,
    IMPORT_DECLARATION = $__20.IMPORT_DECLARATION,
    MODULE_DECLARATION = $__20.MODULE_DECLARATION,
    MODULE_DEFINITION = $__20.MODULE_DEFINITION,
    MODULE_EXPRESSION = $__20.MODULE_EXPRESSION,
    MODULE_SPECIFIER = $__20.MODULE_SPECIFIER,
    OBJECT_PATTERN = $__20.OBJECT_PATTERN,
    OBJECT_PATTERN_FIELD = $__20.OBJECT_PATTERN_FIELD,
    PROPERTY_METHOD_ASSIGNMENT = $__20.PROPERTY_METHOD_ASSIGNMENT,
    PROPERTY_NAME_ASSIGNMENT = $__20.PROPERTY_NAME_ASSIGNMENT,
    PROPERTY_NAME_SHORTHAND = $__20.PROPERTY_NAME_SHORTHAND,
    REST_PARAMETER = $__20.REST_PARAMETER,
    SET_ACCESSOR = $__20.SET_ACCESSOR,
    TEMPLATE_LITERAL_PORTION = $__20.TEMPLATE_LITERAL_PORTION,
    TEMPLATE_SUBSTITUTION = $__20.TEMPLATE_SUBSTITUTION,
    VARIABLE_DECLARATION_LIST = $__20.VARIABLE_DECLARATION_LIST,
    VARIABLE_STATEMENT = $__20.VARIABLE_STATEMENT;
  var ValidationError = (function ($__super) {
    "use strict";
    var $__proto = $__getProtoParent($__super);
    var $ValidationError = $__createClass(
      {
        constructor: function (tree, message) {
          this.tree = tree;
          this.message = message;
        },
      },
    ...
    var $ParseTreeValidator = $__createClass(
      {
        ...
        visitArrayLiteralExpression: function (tree) {
          for (var i = 0; i < tree.elements.length; i++) {
            ...
            this.checkVisit_(
              element === null || element.isAssignmentOrSpread(),
              element,
              "assignment or spread expected"
            );
          }
        ...
        visitBinaryOperator: function (tree) {
          switch (tree.operator.type) {
            ...
            case BAR_EQUAL:
              this.check_(
                tree.left.isLeftHandSideExpression() || tree.left.isPattern(),
                tree.left,
                "left hand side expression or pattern expected"
              );
              this.check_(
                tree.right.isArrowFunctionExpression(),
                tree.right,
            ...
            case PERCENT:
              this.check_(
                tree.left.isArrowFunctionExpression(),
                tree.left,
                "assignment expression expected"
              );
              this.check_(
        ...
        visitCatch: function (tree) {
          this.checkVisit_(
            tree.binding.isPattern() || tree.binding.type == BINDING_IDENTIFIER,
            tree.binding,
            "binding identifier expected"
          );
          this.checkVisit_(
            tree.catchBody.type === BLOCK,
            tree.catchBody,
            "block expected"
          );
        },
        ...
        visitConditionalExpression: function (tree) {
          this.checkVisit_(
            tree.condition.isArrowFunctionExpression(),
            tree.condition,
            "expression expected"
          );
          this.checkVisit_(
        ...
        visitDoWhileStatement: function (tree) {
          this.checkVisit_(
            tree.body.isStatement(),
            tree.body,
            "statement expected"
          );
          this.checkVisit_(
            tree.condition.isExpression(),
            tree.condition,
            "expression expected"
          );
        },
        ...
        visitForInStatement: function (tree) {
          if (tree.initializer.type === VARIABLE_DECLARATION_LIST) {
            ...
            this.checkVisit_(
              tree.initializer.isPattern() || tree.initializer.isExpression(),
              tree.initializer,
              "variable declaration, expression or " + "pattern expected"
            );
          }
          this.checkVisit_(
            tree.collection.isExpression(),
          ...
          for (var i = 0; i < tree.parameters.length; i++) {
            ...
            switch (parameter.type) {
              ...
              default:
                this.fail_(
                  parameter,
                  "parameters must be identifiers or rest" +
        ...
        visitIfStatement: function (tree) {
          ...
          this.checkVisit_(
            tree.ifClause.isStatement(),
            tree.ifClause,
            "statement expected"
          );
          if (tree.elseClause !== null) {
            this.checkVisit_(
              tree.elseClause.isStatement(),
              tree.elseClause,
              "statement expected"
            );
          }
        ...
        visitObjectPattern: function (tree) {
          for (var i = 0; i < tree.fields.length; i++) {
            ...
            this.checkVisit_(
              field.type === OBJECT_PATTERN_FIELD ||
        ...
        visitPostfixExpression: function (tree) {
          this.checkVisit_(
            tree.operand.isArrowFunctionExpression(),
            tree.operand,
            "assignment expression expected"
          );
        },
        ...
        visitProgram: function (tree) {
          for (var i = 0; i < tree.programElements.length; i++) {
            ...
            this.checkVisit_(
              programElement.isProgramElement(),
              programElement,
        ...
        visitPropertyNameAssignment: function (tree) {
          this.checkVisit_(
            tree.value.isArrowFunctionExpression(),
            tree.value,
            "assignment expression expected"
          );
        },
        ...
        visitSpreadExpression: function (tree) {
          this.checkVisit_(
            tree.expression.isArrowFunctionExpression(),
            tree.expression,
            "assignment expression expected"
          );
        },
        visitStateMachine: function (tree) {
          this.fail_(
            tree,
            "State machines are never valid outside of the " +
          ...
          for (var i = 0; i < tree.caseClauses.length; i++) {
            ...
            if (caseClause.type === DEFAULT_CLAUSE) {
              ...
              this.checkType_(
                CASE_CLAUSE,
                caseClause,
                "case or default clause expected"
              );
            }
          }
        },
        ...
        visitVariableDeclaration: function (tree) {
          this.checkVisit_(
            tree.lvalue.isPattern() || tree.lvalue.type == BINDING_IDENTIFIER,
            tree.lvalue,
            "binding identifier expected, found: " + tree.lvalue.type
          );
          if (tree.initializer !== null) {
            this.checkVisit_(
              tree.initializer.isArrowFunctionExpression(),
              tree.initializer,
              "assignment expression expected"
            );
          }
  ...
  ParseTreeValidator.validate = function (tree) {
    ...
    try {
      ...
      var locationString =
        location !== null ? location.start.toString() : "(unknown)";
      throw new Error(
        "Parse tree validation failure '" +
          e.message +
          "' at " +
          locationString +
          ":" +
...
var $___src_codegeneration_PrivateNameSyntaxTransformer_js = function () {
  "use strict";
  var $__20 = $___src_syntax_PredefinedName_js,
    ASSERT_NAME = $__20.ASSERT_NAME,
    CREATE_NAME = $__20.CREATE_NAME,
    RUNTIME = $__20.RUNTIME,
    TRACEUR_RUNTIME = $__20.TRACEUR_RUNTIME;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  ...
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    VariableDeclarationList = $__20.VariableDeclarationList,
    VariableStatement = $__20.VariableStatement;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    createCallExpression = $__20.createCallExpression,
    createEmptyArgumentList = $__20.createEmptyArgumentList,
  ...
  var PrivateNameSyntaxTransformer = (function ($__super) {
    ...
    var $PrivateNameSyntaxTransformer = $__createClass(
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new PrivateNameSyntaxTransformer(
            identifierGenerator
          ).transformAny(tree);
        },
      },
...
var $___src_codegeneration_PropertyNameShorthandTransformer_js = function () {
  ...
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    IdentifierExpression = $__20.IdentifierExpression,
    PropertyNameAssignment = $__20.PropertyNameAssignment;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
...
var $___src_codegeneration_TemplateLiteralTransformer_js = function () {
  ...
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    BINARY_OPERATOR = $__20.BINARY_OPERATOR,
    COMMA_EXPRESSION = $__20.COMMA_EXPRESSION,
    CONDITIONAL_EXPRESSION = $__20.CONDITIONAL_EXPRESSION,
    TEMPLATE_LITERAL_PORTION = $__20.TEMPLATE_LITERAL_PORTION;
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    LiteralExpression = $__20.LiteralExpression,
    ParenExpression = $__20.ParenExpression;
  var LiteralToken = $___src_syntax_LiteralToken_js.LiteralToken;
  var $__20 = $___src_syntax_PredefinedName_js,
    DEFINE_PROPERTIES = $__20.DEFINE_PROPERTIES,
    OBJECT = $__20.OBJECT,
    RAW = $__20.RAW;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  ...
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    createArrayLiteralExpression = $__20.createArrayLiteralExpression,
    createBinaryOperator = $__20.createBinaryOperator,
    createCallExpression = $__20.createCallExpression,
    createIdentifierExpression = $__20.createIdentifierExpression,
    createMemberExpression = $__20.createMemberExpression,
    createObjectFreeze = $__20.createObjectFreeze,
    createObjectLiteralExpression = $__20.createObjectLiteralExpression,
    createOperatorToken = $__20.createOperatorToken,
    createPropertyDescriptor = $__20.createPropertyDescriptor,
    createPropertyNameAssignment = $__20.createPropertyNameAssignment,
  ...
  var TemplateLiteralTransformer = (function ($__super) {
    ...
    var $TemplateLiteralTransformer = $__createClass(
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new TemplateLiteralTransformer(
            identifierGenerator
          ).transformAny(tree);
        },
      },
    ...
    var $RestParameterTransformer = $__createClass(
      {
        ...
        desugarRestParameters_: function (tree) {
          ...
          var statements = prependStatements(
      ...
      {
        transformTree: function (identifierGenerator, tree) {
          return new RestParameterTransformer(identifierGenerator).transformAny(
            tree
          );
        },
      },
...
var $___src_codegeneration_SpreadTransformer_js = function () {
  ...
  var $__20 = $___src_syntax_PredefinedName_js,
    ...
    BIND = $__20.BIND,
    FUNCTION = $__20.FUNCTION,
    PROTOTYPE = $__20.PROTOTYPE;
  var $__20 = $___src_syntax_trees_ParseTreeType_js,
    MEMBER_EXPRESSION = $__20.MEMBER_EXPRESSION,
    MEMBER_LOOKUP_EXPRESSION = $__20.MEMBER_LOOKUP_EXPRESSION,
    SPREAD_EXPRESSION = $__20.SPREAD_EXPRESSION;
  var TempVarTransformer =
    $___src_codegeneration_TempVarTransformer_js.TempVarTransformer;
  var $__20 = $___src_codegeneration_ParseTreeFactory_js,
    createArgumentList = $__20.createArgumentList,
    ...
    var $SpreadTransformer = $__createClass(
      {
        ...
        desugarCallSpread_: function (tree) {
          ...
          var arrayExpression = this.createArrayFromElements_(
            tree.args.args,
            false
          );
          return createCallExpression(
        ...
        desugarNewSpread_: function (tree) {
          var arrayExpression = $__spread(
            [createNullLiteral()],
            tree.args.args
          );
          arrayExpression = this.createArrayFromElements_(
            arrayExpression,
            false
          );
          return createNewExpression(
...
var $___src_codegeneration_TypeTransformer_js = function () {
  ...
  var VariableDeclaration =
    $___src_syntax_trees_ParseTrees_js.VariableDeclaration;
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
    ...
    var $TypeTransformer = $__createClass(
      {
        ...
        transformVariableDeclaration: function (tree) {
          ...
          return $__superCall(this, $__proto, "transformVariableDeclaration", [
            tree,
          ]);
        },
      },
...
var $___src_codegeneration_ProgramTransformer_js = function () {
  "use strict";
  var ArrayComprehensionTransformer =
    $___src_codegeneration_ArrayComprehensionTransformer_js.ArrayComprehensionTransformer;
  var ArrowFunctionTransformer =
    $___src_codegeneration_ArrowFunctionTransformer_js.ArrowFunctionTransformer;
  var AtNameMemberTransformer =
    $___src_codegeneration_AtNameMemberTransformer_js.AtNameMemberTransformer;
  var BlockBindingTransformer =
    $___src_codegeneration_BlockBindingTransformer_js.BlockBindingTransformer;
  var CascadeExpressionTransformer =
    $___src_codegeneration_CascadeExpressionTransformer_js.CascadeExpressionTransformer;
  var ClassTransformer =
    $___src_codegeneration_ClassTransformer_js.ClassTransformer;
  var CollectionTransformer =
    $___src_codegeneration_CollectionTransformer_js.CollectionTransformer;
  var DefaultParametersTransformer =
    $___src_codegeneration_DefaultParametersTransformer_js.DefaultParametersTransformer;
  var DestructuringTransformer =
    $___src_codegeneration_DestructuringTransformer_js.DestructuringTransformer;
  var ForOfTransformer =
    $___src_codegeneration_ForOfTransformer_js.ForOfTransformer;
  var FreeVariableChecker =
    $___src_semantics_FreeVariableChecker_js.FreeVariableChecker;
  var GeneratorComprehensionTransformer =
    $___src_codegeneration_GeneratorComprehensionTransformer_js.GeneratorComprehensionTransformer;
  var GeneratorTransformPass =
    $___src_codegeneration_GeneratorTransformPass_js.GeneratorTransformPass;
  var ModuleTransformer =
    $___src_codegeneration_ModuleTransformer_js.ModuleTransformer;
  var ObjectLiteralTransformer =
    $___src_codegeneration_ObjectLiteralTransformer_js.ObjectLiteralTransformer;
  var ObjectMap = $___src_util_ObjectMap_js.ObjectMap;
  var ParseTreeValidator =
    $___src_syntax_ParseTreeValidator_js.ParseTreeValidator;
  var PrivateNameSyntaxTransformer =
    $___src_codegeneration_PrivateNameSyntaxTransformer_js.PrivateNameSyntaxTransformer;
  var PropertyNameShorthandTransformer =
    $___src_codegeneration_PropertyNameShorthandTransformer_js.PropertyNameShorthandTransformer;
  var TemplateLiteralTransformer =
    $___src_codegeneration_TemplateLiteralTransformer_js.TemplateLiteralTransformer;
  var RestParameterTransformer =
    $___src_codegeneration_RestParameterTransformer_js.RestParameterTransformer;
  var SpreadTransformer =
    $___src_codegeneration_SpreadTransformer_js.SpreadTransformer;
  var TypeTransformer =
    $___src_codegeneration_TypeTransformer_js.TypeTransformer;
  var $__20 = $___src_options_js,
    options = $__20.options,
    transformOptions = $__20.transformOptions;
    ...
    var $ProgramTransformer = $__createClassNoExtends(
      {
        ...
        transform_: function () {
          this.project_.getSourceFiles().forEach(
            function (file) {
        ...
        transformFileAsModule_: function (module, file) {
          var result = this.transformTree_(
        ...
        transformTree_: function (tree) {
          ...
          function transform(enabled, transformer) {
            for (var args = [], $__16 = 2; $__16 < arguments.length; $__16++)
              args[$__16 - 2] = arguments[$__16];
            return chain(enabled, function () {
              return ($__40 = transformer).transformTree.apply(
                $__40,
                $__spread(args, [tree])
              );
            });
          ...
          transform(
            transformOptions.defaultParameters,
            DefaultParametersTransformer
          );
          transform(
        ...
        transformModules_: function (tree) {
          var module = arguments[1];
          if (module)
            return ModuleTransformer.transformAsModule(
              this.project_,
              module,
              tree
            );
...
var $___src_semantics_symbols_Project_js = function () {
  ...
  var UniqueIdentifierGenerator =
    $___src_codegeneration_UniqueIdentifierGenerator_js.UniqueIdentifierGenerator;
  var resolveUrl = $___src_util_url_js.resolveUrl;
...
var $___src_codegeneration_Compiler_js = function () {
  ...
  var ProgramTransformer =
    $___src_codegeneration_ProgramTransformer_js.ProgramTransformer;
    ...
    var $Compiler = $__createClassNoExtends(
      {
        ...
        transform_: function () {
          ...
          this.results_ = ProgramTransformer.transform(
            this.reporter_,
            this.project_
          );
        },
        ...
        run: function () {
          document.addEventListener(
            ...
            function () {
              ...
              this.addFilesFromScriptElements(
                scripts,
                function () {
...
var $___src_outputgeneration_ProjectWriter_js = function () {
  ...
  var ProjectWriter = (function () {
    "use strict";
    var $ProjectWriter = $__createClassNoExtends(
      { constructor: function () {} },
      {}
    );
...
var $___src_codegeneration_CloneTreeTransformer_js = function () {
  ...
  var ParseTreeTransformer =
    $___src_codegeneration_ParseTreeTransformer_js.ParseTreeTransformer;
  var $__20 = $___src_syntax_trees_ParseTrees_js,
    AtNameExpression = $__20.AtNameExpression,
    BindingIdentifier = $__20.BindingIdentifier,
    BreakStatement = $__20.BreakStatement,
    ContinueStatement = $__20.ContinueStatement,
    DebuggerStatement = $__20.DebuggerStatement,
    EmptyStatement = $__20.EmptyStatement,
    ExportSpecifier = $__20.ExportSpecifier,
    ExportStar = $__20.ExportStar,
    IdentifierExpression = $__20.IdentifierExpression,
    ImportSpecifier = $__20.ImportSpecifier,
    LiteralExpression = $__20.LiteralExpression,
    ModuleRequire = $__20.ModuleRequire,
    PredefinedType = $__20.PredefinedType,
    PropertyNameShorthand = $__20.PropertyNameShorthand,
    TemplateLiteralPortion = $__20.TemplateLiteralPortion,
    RestParameter = $__20.RestParameter,
    SuperExpression = $__20.SuperExpression,
...
var $___src_runtime_modules_js = function () {
  ...
  var ArrayMap = $___src_util_ArrayMap_js.ArrayMap;
  var ModuleAnalyzer = $___src_semantics_ModuleAnalyzer_js.ModuleAnalyzer;
  var ModuleRequireVisitor =
    $___src_codegeneration_module_ModuleRequireVisitor_js.ModuleRequireVisitor;
  var ModuleSymbol = $___src_semantics_symbols_ModuleSymbol_js.ModuleSymbol;
  var ObjectMap = $___src_util_ObjectMap_js.ObjectMap;
  var Parser = $___src_syntax_Parser_js.Parser;
  var ProgramTransformer =
  ...
  var getUid = $___src_util_uid_js.getUid;
  var resolveUrl = $___src_util_url_js.resolveUrl;
  var $__20 = $___src_runtime_get_module_js,
    standardModuleUrlRegExp = $__20.standardModuleUrlRegExp,
    getModuleInstanceByUrl = $__20.getModuleInstanceByUrl,
    getCurrentCodeUnit = $__20.getCurrentCodeUnit,
    setCurrentCodeUnit = $__20.setCurrentCodeUnit;
    ...
    var $CodeUnit = $__createClassNoExtends(
      {
        ...
        transform: function () {
          return ProgramTransformer.transformFile(
            this.reporter,
            this.project,
            this.file
          );
    ...
    var $LoadCodeUnit = $__createClass(
      {
        ...
        transform: function () {
          return ProgramTransformer.transformFileAsModule(
            this.reporter,
            this.project,
            this.moduleSymbol,
            this.file
  ...
  var EvalCodeUnit = (function ($__super) {
    "use strict";
    var $__proto = $__getProtoParent($__super);
    var $EvalCodeUnit = $__createClass(
      {
        constructor: function (loader, code) {
          $__superCall(this, $__proto, "constructor", [
            loader,
            loader.url,
            LOADED,
  ...
  var EvalLoadCodeUnit = (function ($__super) {
    "use strict";
    var $__proto = $__getProtoParent($__super);
    var $EvalLoadCodeUnit = $__createClass(
      {
        constructor: function (loader, code) {
    ...
    var $InternalLoader = $__createClassNoExtends(
      {
        ...
        load: function (url) {
          ...
          var loader = this;
          codeUnit.xhr = this.loadTextFile(
            url,
            function (text) {
              codeUnit.text = text;
              codeUnit.state = LOADED;
        ...
        handleCodeUnitLoaded: function (codeUnit) {
          ...
          codeUnit.dependencies = requireVisitor.requireUrls.map(
            function (url) {
              url = resolveUrl(baseUrl, url);
              return this.getCodeUnit(url);
            }.bind(this)
          );
          codeUnit.dependencies.forEach(
            function (dependency) {
        ...
        evalCodeUnit: function (codeUnit) {
          return ("global", eval)(
            "'use strict';" + TreeWriter.write(codeUnit.transformedTree)
          );
        },
      },
      {}
