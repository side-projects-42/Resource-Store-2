CodeMirror.validate = (function () {
  ...
  function parseOptions(options) {
    ...
    else if (!options || !options.getAnnotations)
  ...
  function startLinting(cm) {
    ...
    if (options.async) options.getAnnotations(cm, updateLinting, options);
    else updateLinting(cm, options.getAnnotations(cm.getValue()));
  }
