...
require("../module-server").from(
  "./fixtures/build",
  "./fixtures/sample-module/module-graph.json",
  function (err, server) {
    test("module server", function (t) {
      ...
      server(
        ["module$sub_app", "module$module$foo"],
        [],
      ...
      var expectedJs =
        subApp + getJs(["module$module$bar", "module$module$foo"]);
      server(
        ["module$sub_app", "module$module$foo"],
        ["module$module$baz$foo"],
        function (err, length, js) {
      ...
      server(
        ["not found", "module$sub_app", "module$module$foo"],
        ["module$module$baz$foo"],
        function (err, length, js) {
