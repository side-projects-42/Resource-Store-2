...
require("./module-server").from(
  SOURCE_DIR + "/../build",
  SOURCE_DIR + "/module-graph.json",
  run
);
  ...
  http
    .createServer(function (req, res) {
      ...
      switch (url.pathname) {
        case "/demo.html":
          fs.readFile(
            __dirname + "/clients/test/demo.html",
            "utf8",
            function (err, html) {
              if (err) {
                throw err;
        ...
        case "/third-party/LABjs/LAB.src.js":
          fs.readFile(
            __dirname + "/clients/third-party/LABjs/LAB.src.js",
            "utf8",
            function (err, js) {
              if (err) {
                throw err;
        ...
        case "/module-client.js":
          fs.readFile(
            __dirname + "/clients/module-client.js",
            "utf8",
            function (err, js) {
              if (err) {
                throw err;
      ...
      if (ORIGINAL_SOURCE_PATH_PREFIX_REGEX.test(url.pathname)) {
        var filename =
          SOURCE_DIR +
          "/" +
          url.pathname.replace(ORIGINAL_SOURCE_PATH_PREFIX_REGEX, "");
      ...
      jsForPath(
        url.pathname,
        isSourceMapRequest,
        function (err, length, js, sourceMap) {
          if (err) {
