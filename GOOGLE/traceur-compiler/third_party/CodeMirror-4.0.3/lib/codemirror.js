...
(function (mod) {
  ...
  function leftButtonDown(cm, e, start) {
    ...
    else leftButtonSelect(cm, e, start, type, addNew);
  }
    ...
    function extendTo(pos) {
      ...
      if (type == "rect") {
        ...
        var anchor = oldRange.anchor,
          head = pos;
        if (type != "single") {
          if (type == "double") var range = findWordAt(doc, pos);
          else
            var range = new Range(
              Pos(pos.line, 0),
    ...
    function prepareSelectAllHack() {
      if (display.input.selectionStart != null) {
        var extval = (display.input.value =
          "\u200b" + (cm.somethingSelected() ? display.input.value : ""));
        display.prevInput = "\u200b";
  ...
  CodeMirror.prototype = {
    ...
    toggleOverwrite: function (value) {
      ...
      if ((this.state.overwrite = !this.state.overwrite))
        ...
        this.display.cursorDiv.className =
          this.display.cursorDiv.className.replace(" CodeMirror-overwrite", "");
  ...
  function interpretTokenStyle(style, builder) {
    ...
    var cache = builder.cm.options.addModeClass
      ? styleToClassCacheWithMode
      : styleToClassCache;
