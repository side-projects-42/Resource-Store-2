...
suite("FreeVariableChecker.js", function () {
  function makeTest(name, code, expectedErrors, global, mode) {
    test(name, function () {
      ...
      var tree =
        mode === "module" ? parser.parseModule() : parser.parseScript();
  ...
  makeTest("new args", "new f(x, 2);", ["CODE:1:7: x is not defined"], {
    f: 1,
  });
  ...
  makeTest(
    "module",
    'import {x as y} from "x"; x',
    ["CODE:1:27: x is not defined"],
    undefined,
    "module"
  );
