...
suite("BlockBindingTransformer.js", function () {
  ...
  makeTest("Let to Var In Block", "1; { 2; let x; }", "1; { 2; var x; }");
  makeTest(
    "Let to Var In Block",
    "1; if (true) { 2; let x = 5; }",
    "1; if (true) { 2; var x = 5; }"
  ...
  makeTest(
    "Let to Var In ForLoop",
    "for (let i = 0; i < 5; i++);",
    "for (var i = 0; i < 5; i++);"
  );
  makeTest(
    "Let to Var In ForLoop 2",
  ...
  makeTest(
    "Let to Var In ForLoop with Fn using local var",
    "for (let i = 0; i < 5; i++) {" +
  ...
  makeTest(
    "Let to Var with name collisions",
    "if (true) { let x = 5; }" + "if (true) { let x = 5; }",
    // =======
    "if (true) {" +
      "  var x = 5;" +
      "}" +
  ...
  suite("Loops with Fns using block variables", function () {
    ...
    makeTest(
      "Loop with Var initializer remains untouched",
      "for(var i = 0; i < 5; i++){" +
        "  let x = 10;" +
  ...
  suite("Hoisting", function () {
    ...
    makeTest(
      "Function are untouched when outside block",
      "f(); function f() { other() }",
      "f(); function f() { other() }"
    );
  });
  ...
  makeTest(
    "Rename in destructuring 2",
    "let x = 1; { let {y, x} = {}; }",
    "var x = 1; { var {y, x: x$__0} = {}; }"
  );

  makeTest(
    "Rename in destructuring 3",
    "let x = 1; { let {x: x, y} = {}; }",
    "var x = 1; { var {x: x$__0, y} = {}; }"
  );
  makeTest(
    "Rename in destructuring 4",
    "let x = 1; { let {y, x: x} = {}; }",
    "var x = 1; { var {y, x: x$__0} = {}; }"
  );

  makeTest(
    "Rename in destructuring with initializer",
    "let x = 1; { let {x, y = x} = {}; }",
    "var x = 1; { var {x: x$__0, y = x$__0} = {}; }"
  );
  makeTest(
    "Rename in destructuring with initializer with binding",
  ...
  makeTest(
    "Rename in destructuring with reference in initializer",
    "let x = 1; { let {x = () => x} = {}; }",
  ...
  makeTest(
    "Rename in nested destructuring 2",
    "let x = 1; { let {x: {x = function x() {}}} = {}; }",
    "var x = 1; { var {x: {x: x$__0 = function x() {}}} = {}; }"
  );

  makeTest(
    "Rename, make sure function name in initializer is not renamed",
    "let x = 1; { let y = function x() {}; }",
    "var x = 1; { var y = function x() {}; }"
  );

  makeTest(
    "Rename, make sure function name in initializer is not renamed 2",
  ...
  makeTest(
    ...
    // ======
    "{ var x$__0 = 1; x$__0; }" + "{ var x$__1 = 2; x$__1; }" + "x;"
  );
